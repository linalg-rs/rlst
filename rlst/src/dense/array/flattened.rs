    ...
    for ArrayFlatView<ArrayImpl, NDIM>
{
    ...
    unsafe fn get_value_unchecked(&self, multi_index: [usize; 1]) -> Self::Item {
        self.0.inner().get_value_1d_unchecked(multi_index[0])
    }
}
    ...
    for ArrayFlatView<ArrayImpl, NDIM>
{
    ...
    unsafe fn get_unchecked(&self, multi_index: [usize; 1]) -> &Self::Item {
        self.0.inner().get_1d_unchecked(multi_index[0])
    }
}
    ...
    for ArrayFlatView<ArrayImpl, NDIM>
{
    ...
    unsafe fn get_unchecked_mut(&mut self, multi_index: [usize; 1]) -> &mut Self::Item {
        self.0.inner_mut().get_1d_unchecked_mut(multi_index[0])
    }
}
    ...
    for ArrayFlatView<ArrayImpl, NDIM>
{
    ...
    unsafe fn get_value_1d_unchecked(&self, index: usize) -> Self::Item {
        self.0.inner().get_value_1d_unchecked(index)
    }
}
    ...
    for ArrayFlatView<ArrayImpl, NDIM>
{
    ...
    unsafe fn get_1d_unchecked(&self, index: usize) -> &Self::Item {
        self.0.inner().get_1d_unchecked(index)
    }
}
    ...
    for ArrayFlatView<ArrayImpl, NDIM>
{
    ...
    unsafe fn get_1d_unchecked_mut(&mut self, index: usize) -> &mut Self::Item {
        self.0.inner_mut().get_1d_unchecked_mut(index)
    }
}
