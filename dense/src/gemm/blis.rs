...
fn convert_trans_mode(trans: TransMode) -> u32 {
    match trans {
        TransMode::ConjNoTrans => raw::trans_t_BLIS_CONJ_NO_TRANSPOSE,
        TransMode::NoTrans => raw::trans_t_BLIS_NO_TRANSPOSE,
        TransMode::Trans => raw::trans_t_BLIS_TRANSPOSE,
        TransMode::ConjTrans => raw::trans_t_BLIS_CONJ_TRANSPOSE,
    }
}
