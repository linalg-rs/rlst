...
extern "C" {
    ...
    pub fn rlst_avx_sin_f32(a: *const f32) -> f32x8;
    pub fn rlst_avx_sin_f64(a: *const f64) -> f64x4;

    pub fn rlst_avx_cos_f32(a: *const f32) -> f32x8;
    pub fn rlst_avx_cos_f64(a: *const f64) -> f64x4;
