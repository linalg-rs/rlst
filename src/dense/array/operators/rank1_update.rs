...
impl<
        ...
        ArrayImplU: UnsafeRandomAccessByValue<1, Item = Item> + Shape<1>,
        ArrayImplV: UnsafeRandomAccessByValue<1, Item = Item> + Shape<1>,
    > Rank1Update<Item, ArrayImpl, ArrayImplU, ArrayImplV>
{
...
impl<
        ...
        ArrayImplU: UnsafeRandomAccessByValue<1, Item = Item> + Shape<1>,
        ArrayImplV: UnsafeRandomAccessByValue<1, Item = Item> + Shape<1>,
    > UnsafeRandomAccessByValue<2> for Rank1Update<Item, ArrayImpl, ArrayImplU, ArrayImplV>
{
    type Item = Item;
...
impl<
        ...
        ArrayImplU: UnsafeRandomAccessByValue<1, Item = Item> + Shape<1>,
        ArrayImplV: UnsafeRandomAccessByValue<1, Item = Item> + Shape<1>,
    > Shape<2> for Rank1Update<Item, ArrayImpl, ArrayImplU, ArrayImplV>
{
...
impl<
        ...
        ArrayImplV: UnsafeRandomAccessByValue<1, Item = Item> + Shape<1>,
        const N: usize,
    > ChunkedAccess<N> for Rank1Update<Item, ArrayImpl, ArrayImplU, ArrayImplV>
{
    type Item = Item;
    ...
    Array<Item, ArrayImpl, 2>
{
    ...
    >(
        ...
        u: Array<Item, ArrayImplU, 1>,
        v: Array<Item, ArrayImplV, 1>,
    ) -> Array<Item, Rank1Update<Item, ArrayImpl, ArrayImplU, ArrayImplV>, 2> {
        Array::new(Rank1Update::new(self, u, v))
    }
}
...
mod test {
    ...
    fn test_rank1_update_f32() {
        ...
        actual_nonchunked.fill_from(arr.view().rank1_update(u.view(), v.view()));

        actual_chunked.fill_from_chunked::<_, 16>(arr.view().rank1_update(u.view(), v.view()));

        actual_inplace.fill_from(arr.view());
        actual_inplace.rank1_update_inplace(u.view(), v.view());
