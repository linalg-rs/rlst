...
/* > \verbatim */
/* > */
/* > DGEBD2 reduces a doublereal general m by n matrix A to upper or lower */
...
/* > */
/*  ===================================================================== */
void  hgebd2_(integer *m, integer *n, halfreal *a, integer *
	lda, halfreal *d__, halfreal *e, halfreal *tauq, halfreal *
	taup, halfreal *work, integer *info)
{
...
/* Computing MIN */
	    i__3 = i__ + 1;
	    hlarfg_(&i__2, &a[i__ + i__ * a_dim1], &a[f2cmin(i__3,*m) + i__ * 
...
/*           Apply H(i) to A(i:m,i+1:n) from the left */
		...
		i__2 = *m - i__ + 1;
		i__3 = *n - i__;
		hlarf_("Left", &i__2, &i__3, &a[i__ + i__ * a_dim1], &c__1, &
...
/* Computing MIN */
		i__3 = i__ + 2;
		hlarfg_(&i__2, &a[i__ + (i__ + 1) * a_dim1], &a[i__ + f2cmin(
...
/*              Apply G(i) to A(i+1:m,i+1:n) from the right */
		...
		i__2 = *m - i__;
		i__3 = *n - i__;
		hlarf_("Right", &i__2, &i__3, &a[i__ + (i__ + 1) * a_dim1], 
...
/* Computing MIN */
	    i__3 = i__ + 1;
	    hlarfg_(&i__2, &a[i__ + i__ * a_dim1], &a[i__ + f2cmin(i__3,*n) * 
		    a_dim1], lda, &taup[i__]);
	    d__[i__] = a[i__ + i__ * a_dim1];
	    a[i__ + i__ * a_dim1] = 1.;
...
/*           Apply G(i) to A(i+1:m,i:n) from the right */
		...
		i__2 = *m - i__;
		i__3 = *n - i__ + 1;
		hlarf_("Right", &i__2, &i__3, &a[i__ + i__ * a_dim1], lda, &
...
/* Computing MIN */
		i__3 = i__ + 2;
		hlarfg_(&i__2, &a[i__ + 1 + i__ * a_dim1], &a[f2cmin(i__3,*m) + 
...
/*              Apply H(i) to A(i+1:m,i+1:n) from the left */
		...
		i__2 = *m - i__;
		i__3 = *n - i__;
		hlarf_("Left", &i__2, &i__3, &a[i__ + 1 + i__ * a_dim1], &
