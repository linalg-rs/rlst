...
/* > \verbatim */
/* > */
/* > DORMTR overwrites the general doublereal M-by-N matrix C with */
/* > */
/* >                 SIDE = 'L'     SIDE = 'R' */
/* > TRANS = 'N':      Q * C          C * Q */
/* > TRANS = 'T':      Q**T * C       C * Q**T */
...
/*  ===================================================================== */
void  hormtr_(char *side, char *uplo, char *trans, integer *m, 
	integer *n, halfreal *a, integer *lda, halfreal *tau, halfreal *
	c__, integer *ldc, halfreal *work, integer *lwork, integer *info)
{
    ...
    extern void  hormql_(char *, char *, integer *, integer *, 
...
/*        Q was determined by a call to DSYTRD with UPLO = 'U' */
	...
	i__2 = nq - 1;
	hormql_(side, trans, &mi, &ni, &i__2, &a[(a_dim1 << 1) + 1], lda, &
...
/*        Q was determined by a call to DSYTRD with UPLO = 'L' */
	...
	i__2 = nq - 1;
	hormqr_(side, trans, &mi, &ni, &i__2, &a[a_dim1 + 2], lda, &tau[1], &
