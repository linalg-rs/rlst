...
/*  ===================================================================== */
void  qormqr_(char *side, char *trans, integer *m, integer *n, 
	...
	c__, integer *ldc, quadreal *work, integer *lwork, integer *info)
{
    ...
    integer nbmin, iinfo;
    extern void  qorm2r_(char *, char *, integer *, integer *, 
...
/*        Use unblocked code */
	...
	qorm2r_(side, trans, m, n, k, &a[a_offset], lda, &tau[1], &c__[
...
/*           H = H(i) H(i+1) . . . H(i+ib-1) */
	    ...
	    i__4 = nq - i__ + 1;
	    qlarft_("Forward", "Columnwise", &i__4, &ib, &a[i__ + i__ * 
...
/*           Apply H or H**T */
	    ...
	    qlarfb_(side, trans, "Forward", "Columnwise", &mi, &ni, &ib, &a[
