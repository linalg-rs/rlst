...
/* >          = 1:  doublereal and imaginary parts each uniform (0,1) */
/* >          = 2:  doublereal and imaginary parts each uniform (-1,1) */
/* >          = 3:  doublereal and imaginary parts each normal (0,1) */
...
/* > */
/*  ===================================================================== */
void  klarnv_(integer *idist, integer *iseed, integer *n, 
	halfcomplex *x)
{
    ...
    halfreal u[128];
    integer il, iv;
    extern void  hlaruv_(integer *, integer *, halfreal *);
...
/*        Call DLARUV to generate 2*IL doublereal numbers from a uniform (0,1) */
/*        distribution (2*IL <= LV) */

	i__2 = il << 1;
	hlaruv_(&iseed[1], &i__2, u);
