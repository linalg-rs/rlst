...
/*  ===================================================================== */
void  kpstf2_(char *uplo, integer *n, halfcomplex *a, 
...
/*              Pivot OK, so can now swap pivot rows and columns */
		...
		i__2 = j - 1;
		kswap_(&i__2, &a[j * a_dim1 + 1], &c__1, &a[pvt * a_dim1 + 1],
			 &c__1);
		if (pvt < *n) {
		    i__2 = *n - pvt;
		    kswap_(&i__2, &a[j + (pvt + 1) * a_dim1], lda, &a[pvt + (
			    pvt + 1) * a_dim1], lda);
		}
		i__2 = pvt - 1;
...
/*           Compute elements J+1:N of row J */
	    ...
	    if (j < *n) {
		i__2 = j - 1;
		klacgv_(&i__2, &a[j * a_dim1 + 1], &c__1);
		i__2 = j - 1;
		i__3 = *n - j;
		z__1.r = -1., z__1.i = -0.;
		kgemv_("Trans", &i__2, &i__3, &z__1, &a[(j + 1) * a_dim1 + 1],
		...
		i__2 = *n - j;
		d__1 = 1. / ajj;
		whscal_(&i__2, &d__1, &a[j + (j + 1) * a_dim1], lda);
	    }
...
/*              Pivot OK, so can now swap pivot rows and columns */
		...
		a[i__2].r = a[i__3].r, a[i__2].i = a[i__3].i;
		i__2 = j - 1;
		kswap_(&i__2, &a[j + a_dim1], lda, &a[pvt + a_dim1], lda);
		if (pvt < *n) {
		    i__2 = *n - pvt;
		    kswap_(&i__2, &a[pvt + 1 + j * a_dim1], &c__1, &a[pvt + 1 
			    + pvt * a_dim1], &c__1);
		}
		i__2 = pvt - 1;
		for (i__ = j + 1; i__ <= i__2; ++i__) {
...
/*           Compute elements J+1:N of column J */
	    ...
	    if (j < *n) {
		i__2 = j - 1;
		klacgv_(&i__2, &a[j + a_dim1], lda);
		i__2 = *n - j;
		i__3 = j - 1;
		z__1.r = -1., z__1.i = -0.;
		kgemv_("No Trans", &i__2, &i__3, &z__1, &a[j + 1 + a_dim1], 
		...
		i__2 = *n - j;
		d__1 = 1. / ajj;
		whscal_(&i__2, &d__1, &a[j + 1 + j * a_dim1], &c__1);
	    }
