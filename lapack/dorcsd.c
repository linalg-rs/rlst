...
/*  ===================================================================== */
void  dorcsd_(char *jobu1, char *jobu2, char *jobv1t, char *
	...
	integer *info)
{
    ...
    extern void  dbbcsd_(char *, char *, char *, char *, char *
    ...
    extern void  dorbdb_(char *, char *, integer *, integer *, 
    ...
    extern void  dlacpy_(char *, integer *, integer *, 
	    ...
	    xerbla_(char *, integer *), dlapmr_(logical *, integer *, 
	    integer *, doublereal *, integer *, integer *), dlapmt_(logical *,
	     integer *, integer *, doublereal *, integer *, integer *);
    integer lorglqworkopt;
    extern void  dorglq_(integer *, integer *, integer *, 
