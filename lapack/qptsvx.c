...
/*  ===================================================================== */
void  qptsvx_(char *fact, integer *n, integer *nrhs, 
	quadreal *d__, quadreal *e, quadreal *df, quadreal *ef, 
	...
	info)
{
    ...
    extern void  qptcon_(integer *, quadreal *, quadreal *,
	     quadreal *, quadreal *, quadreal *, integer *), qptrfs_(
	    integer *, integer *, quadreal *, quadreal *, quadreal *, 
	    quadreal *, quadreal *, integer *, quadreal *, integer *, 
	    quadreal *, quadreal *, quadreal *, integer *), qpttrf_(
	    integer *, quadreal *, quadreal *, integer *), qpttrs_(
	    integer *, integer *, quadreal *, quadreal *, quadreal *, 
	    integer *, integer *);
...
/*     Compute the solution vectors X. */
    ...
    qpttrs_(n, nrhs, &df[1], &ef[1], &x[x_offset], ldx, info);

/*     Use iterative refinement to improve the computed solutions and */
/*     compute error bounds and backward error estimates for them. */

    qptrfs_(n, nrhs, &d__[1], &e[1], &df[1], &ef[1], &b[b_offset], ldb, &x[
