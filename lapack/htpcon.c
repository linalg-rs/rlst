...
/*  ===================================================================== */
void  htpcon_(char *norm, char *uplo, char *diag, integer *n, 
	halfreal *ap, halfreal *rcond, halfreal *work, integer *iwork, 
	integer *info)
{
    ...
    extern halfreal hlantp_(char *, char *, char *, integer *, halfreal *,
	     halfreal *);
    halfreal ainvnm;
    extern void  hlatps_(char *, char *, char *, char *, 
...
/*     Compute the norm of the triangular matrix A. */
    ...
    anorm = hlantp_(norm, uplo, diag, n, &ap[1], &work[1]);
...
/*              Multiply by inv(A). */
		...
		hlatps_(uplo, "No transpose", diag, normin, n, &ap[1], &work[
			1], &scale, &work[(*n << 1) + 1], info);
	    } else {

/*              Multiply by inv(A**T). */

		hlatps_(uplo, "Transpose", diag, normin, n, &ap[1], &work[1], 
