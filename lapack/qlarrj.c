...
/*  ===================================================================== */
void  qlarrj_(integer *n, quadreal *d__, quadreal *e2, 
	integer *ifirst, integer *ilast, quadreal *rtol, integer *offset, 
	quadreal *w, quadreal *werr, quadreal *work, integer *iwork, 
	quadreal *pivmin, quadreal *spdiam, integer *info)
{
