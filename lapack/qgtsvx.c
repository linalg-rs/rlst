...
/*  ===================================================================== */
void  qgtsvx_(char *fact, char *trans, integer *n, integer *
	nrhs, quadreal *dl, quadreal *d__, quadreal *du, quadreal *
	dlf, quadreal *df, quadreal *duf, quadreal *du2, integer *ipiv, 
...
/*     Compute the norm of the matrix A. */
	...
	*(unsigned char *)norm = 'I';
    ...
    anorm = qlangt_(norm, n, &dl[1], &d__[1], &du[1]);
...
/*     Compute the solution vectors X. */
    ...
    qgttrs_(trans, n, nrhs, &dlf[1], &df[1], &duf[1], &du2[1], &ipiv[1], &x[
	    x_offset], ldx, info);

/*     Use iterative refinement to improve the computed solutions and */
/*     compute error bounds and backward error estimates for them. */

    qgtrfs_(trans, n, nrhs, &dl[1], &d__[1], &du[1], &dlf[1], &df[1], &duf[1],
