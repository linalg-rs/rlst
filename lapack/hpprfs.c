...
/*  ===================================================================== */
void  hpprfs_(char *uplo, integer *n, integer *nrhs, 
	halfreal *ap, halfreal *afp, halfreal *b, integer *ldb, 
...
/*        Compute residual R = B - A * X */
	...
	hspmv_(uplo, n, &c_b12, &ap[1], &x[j * x_dim1 + 1], &c__1, &c_b14, &
		work[*n + 1], &c__1);
...
/*           Update solution and try again. */
	    ...
	    hpptrs_(uplo, n, &c__1, &afp[1], &work[*n + 1], n, info);
