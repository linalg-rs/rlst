...
/*  ===================================================================== */
void  qpbtrf_(char *uplo, integer *n, integer *kd, quadreal *
	ab, integer *ldab, integer *info)
{
    ...
    extern void  qtrsm_(char *, char *, char *, char *, 
	    ...
	    integer *, quadreal *, quadreal *, integer *),
	     qpbtf2_(char *, integer *, integer *, quadreal *, integer *, 
	    integer *), qpotf2_(char *, integer *, quadreal *, 
...
/*        Use unblocked code */
	...
	qpbtf2_(uplo, n, kd, &ab[ab_offset], ldab, info);
    } else {
...
/*              Factorize the diagonal block */
		...
		i__3 = *ldab - 1;
		qpotf2_(uplo, &ib, &ab[*kd + 1 + i__ * ab_dim1], &i__3, &ii);
		if (ii != 0) {
		    *info = i__ + ii - 1;
		    goto L150;
		}
...
/*                    Update A22 */
			...
			i__3 = *ldab - 1;
			i__4 = *ldab - 1;
			qsyrk_("Upper", "Transpose", &i2, &ib, &c_b21, &ab[*
...
/*              Factorize the diagonal block */
		...
		i__3 = *ldab - 1;
		qpotf2_(uplo, &ib, &ab[i__ * ab_dim1 + 1], &i__3, &ii);
		if (ii != 0) {
		    *info = i__ + ii - 1;
		    goto L150;
		}
...
/*                    Update A22 */
			...
			i__3 = *ldab - 1;
			i__4 = *ldab - 1;
			qsyrk_("Lower", "No Transpose", &i2, &ib, &c_b21, &ab[
