...
/* > \verbatim */
/* > */
/* > DGEBRD reduces a general doublereal M-by-N matrix A to upper or lower */
...
/* > */
/*  ===================================================================== */
void  hgebrd_(integer *m, integer *n, halfreal *a, integer *
	lda, halfreal *d__, halfreal *e, halfreal *tauq, halfreal *
	taup, halfreal *work, integer *lwork, integer *info)
{
    ...
    extern void  hgebd2_(integer *, integer *, halfreal *, 
	    integer *, halfreal *, halfreal *, halfreal *, halfreal *,
	     halfreal *, integer *), hlabrd_(integer *, integer *, integer *
...
/*        part of the matrix */
	...
	i__3 = *m - i__ + 1;
	i__4 = *n - i__ + 1;
	hlabrd_(&i__3, &i__4, &nb, &a[i__ + i__ * a_dim1], lda, &d__[i__], &e[
...
/*        of the form  A := A - V*Y**T - X*U**T */
	...
	i__3 = *m - i__ - nb + 1;
	i__4 = *n - i__ - nb + 1;
	hgemm_("No transpose", "Transpose", &i__3, &i__4, &nb, &c_b21, &a[i__ 
		+ nb + i__ * a_dim1], lda, &work[ldwrkx * nb + nb + 1], &
		ldwrky, &c_b22, &a[i__ + nb + (i__ + nb) * a_dim1], lda);
	i__3 = *m - i__ - nb + 1;
	i__4 = *n - i__ - nb + 1;
	hgemm_("No transpose", "No transpose", &i__3, &i__4, &nb, &c_b21, &
...
/*     Use unblocked code to reduce the remainder of the matrix */
    ...
    i__2 = *m - i__ + 1;
    i__1 = *n - i__ + 1;
    hgebd2_(&i__2, &i__1, &a[i__ + i__ * a_dim1], lda, &d__[i__], &e[i__], &
