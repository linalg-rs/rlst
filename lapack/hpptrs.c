...
/*  ===================================================================== */
void  hpptrs_(char *uplo, integer *n, integer *nrhs, 
	halfreal *ap, halfreal *b, integer *ldb, integer *info)
{
...
/*           Solve U**T *X = B, overwriting B with X. */
	    ...
	    htpsv_("Upper", "Transpose", "Non-unit", n, &ap[1], &b[i__ * 
		    b_dim1 + 1], &c__1);

/*           Solve U*X = B, overwriting B with X. */

	    htpsv_("Upper", "No transpose", "Non-unit", n, &ap[1], &b[i__ * 
		    b_dim1 + 1], &c__1);
/* L10: */
	}
    } else {
...
/*           Solve L*Y = B, overwriting B with X. */
	    ...
	    htpsv_("Lower", "No transpose", "Non-unit", n, &ap[1], &b[i__ * 
		    b_dim1 + 1], &c__1);

/*           Solve L**T *X = Y, overwriting B with X. */

	    htpsv_("Lower", "Transpose", "Non-unit", n, &ap[1], &b[i__ * 
		    b_dim1 + 1], &c__1);
/* L20: */
	}
    }
