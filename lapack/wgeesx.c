...
/*  ===================================================================== */
void  wgeesx_(char *jobvs, char *sort, L_fp select, char *
	sense, integer *n, quadcomplex *a, integer *lda, integer *sdim, 
	quadcomplex *w, quadcomplex *vs, integer *ldvs, quadreal *
	rconde, quadreal *rcondv, quadcomplex *work, integer *lwork, 
...
/* Computing MAX */
	...
	work[1].r = (quadreal) lwrk, work[1].i = 0.;
...
/*        (RWorkspace: none) */
	...
	i__1 = *lwork - iwrk + 1;
	wtrsen_(sense, jobvs, &bwork[1], n, &a[a_offset], lda, &vs[vs_offset],
