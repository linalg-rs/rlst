...
/*  ===================================================================== */
void  kunmhr_(char *side, char *trans, integer *m, integer *n, 
	integer *ilo, integer *ihi, halfcomplex *a, integer *lda, 
	halfcomplex *tau, halfcomplex *c__, integer *ldc, halfcomplex *
...
/*     Quick return if possible */
    ...
    kunmqr_(side, trans, &mi, &ni, &nh, &a[*ilo + 1 + *ilo * a_dim1], lda, &
