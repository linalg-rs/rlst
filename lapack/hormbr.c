...
/*  ===================================================================== */
void  hormbr_(char *vect, char *side, char *trans, integer *m, 
	integer *n, integer *k, halfreal *a, integer *lda, halfreal *tau, 
...
/*           Q was determined by a call to DGEBRD with nq >= k */
	    ...
	    hormqr_(side, trans, m, n, k, &a[a_offset], lda, &tau[1], &c__[
...
/*           Q was determined by a call to DGEBRD with nq < k */
	    ...
	    i__1 = nq - 1;
	    hormqr_(side, trans, &mi, &ni, &i__1, &a[a_dim1 + 2], lda, &tau[1]
...
/*           P was determined by a call to DGEBRD with nq > k */
	    ...
	    hormlq_(side, transt, m, n, k, &a[a_offset], lda, &tau[1], &c__[
		    c_offset], ldc, &work[1], lwork, &iinfo);
	} else if (nq > 1) {
...
/*           P was determined by a call to DGEBRD with nq <= k */
	    ...
	    i__1 = nq - 1;
	    hormlq_(side, transt, &mi, &ni, &i__1, &a[(a_dim1 << 1) + 1], lda,
