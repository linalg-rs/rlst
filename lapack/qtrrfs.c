...
/*  ===================================================================== */
void  qtrrfs_(char *uplo, char *trans, char *diag, integer *n, 
	integer *nrhs, quadreal *a, integer *lda, quadreal *b, integer *
	ldb, quadreal *x, integer *ldx, quadreal *ferr, quadreal *berr, 
	quadreal *work, integer *iwork, integer *info)
{
    ...
    extern void  qtrmv_(char *, char *, char *, integer *, 
	    ...
	    qlacn2_(integer *, quadreal *, quadreal *, integer *, 
...
/*        where op(A) = A or A**T, depending on TRANS. */
	...
	qtrmv_(uplo, trans, diag, n, &a[a_offset], lda, &work[*n + 1], &c__1);
...
/*              Multiply by diag(W)*inv(op(A)**T). */
		...
		qtrsv_(uplo, transt, diag, n, &a[a_offset], lda, &work[*n + 1]
			, &c__1);
		i__2 = *n;
		for (i__ = 1; i__ <= i__2; ++i__) {
...
/* L230: */
		...
		qtrsv_(uplo, trans, diag, n, &a[a_offset], lda, &work[*n + 1],
			 &c__1);
	    }
	    goto L210;
	}
