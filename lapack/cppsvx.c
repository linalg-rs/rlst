...
/* > */
/*  ===================================================================== */
void  cppsvx_(char *fact, char *uplo, integer *n, integer *
	...
	*berr, complex *work, real *rwork, integer *info)
{
    ...
    extern void  claqhp_(char *, integer *, complex *, real *, 
	    real *, real *, char *);
    logical nofact;
    extern void  clacpy_(char *, integer *, integer *, complex 
	    *, integer *, complex *, integer *), xerbla_(char *, 
	    integer *);
    real bignum;
    extern void  cppcon_(char *, integer *, complex *, real *, 
	    real *, complex *, real *, integer *);
    integer infequ;
    extern void  cppequ_(char *, integer *, complex *, real *, 
    ...
    real smlnum;
    extern void  cpptrs_(char *, integer *, integer *, complex 
