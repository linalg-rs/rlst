...
/*  ===================================================================== */
void  qlagtm_(char *trans, integer *n, integer *nrhs, 
	quadreal *alpha, quadreal *dl, quadreal *d__, quadreal *du, 
	quadreal *x, integer *ldx, quadreal *beta, quadreal *b, integer 
	*ldb)
{
