...
/* > */
/*  ===================================================================== */
void  sormrz_(char *side, char *trans, integer *m, integer *n, 
	...
	integer *ldc, real *work, integer *lwork, integer *info)
{
    ...
    integer nbmin, iinfo;
    extern void  sormr3_(char *, char *, integer *, integer *, 
	    integer *, integer *, real *, integer *, real *, real *, integer *
	    , real *, integer *), xerbla_(char *, integer *);
    extern integer ilaenv_(integer *, char *, char *, integer *, integer *, 
	    integer *, integer *, ftnlen, ftnlen);
    extern void  slarzb_(char *, char *, char *, char *, 
	    integer *, integer *, integer *, integer *, real *, integer *, 
	    real *, integer *, real *, integer *, real *, integer *);
    logical notran;
    integer ldwork;
    char transt[1];
    extern void  slarzt_(char *, char *, integer *, integer *, 
