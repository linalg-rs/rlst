...
/* > */
/*  ===================================================================== */
void  ssytrd_sy2sb__(char *uplo, integer *n, integer *kd, real 
	...
	integer *lwork, integer *info)
{
    ...
    extern void  scopy_(integer *, real *, integer *, real *, 
	    ...
	    real *, integer *, real *, integer *, real *, real *, integer *), ssyr2k_(char *, char *, integer *, integer *, 
    ...
    extern void  sgelqf_(integer *, integer *, real *, integer 
	    *, real *, real *, integer *, integer *), sgeqrf_(integer *, 
	    ...
	    , real *, real *, integer *), slaset_(char *, 
