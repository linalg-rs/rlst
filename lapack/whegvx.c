...
/*  ===================================================================== */
void  whegvx_(integer *itype, char *jobz, char *range, char *
	uplo, integer *n, quadcomplex *a, integer *lda, quadcomplex *b, 
	integer *ldb, quadreal *vl, quadreal *vu, integer *il, integer *
	 ...
	 integer *iwork, integer *ifail, integer *info)
{
    ...
    extern void  whegst_(integer *, char *, integer *, 
	    quadcomplex *, integer *, quadcomplex *, integer *, integer *), wheevx_(char *, char *, char *, integer *, 
	    quadcomplex *, integer *, quadreal *, quadreal *, integer *,
	     integer *, quadreal *, integer *, quadreal *, quadcomplex *
...
/*     Transform problem to standard eigenvalue problem and solve. */
    ...
    wheevx_(jobz, range, uplo, n, &a[a_offset], lda, vl, vu, il, iu, abstol, 
...
/*           backtransform eigenvectors: x = inv(L)**H *y or inv(U)*y */
		...
		*(unsigned char *)trans = 'C';
	    ...
	    wtrsm_("Left", uplo, trans, "Non-unit", n, m, &c_b1, &b[b_offset],
...
/*           backtransform eigenvectors: x = L*y or U**H *y */
		...
		*(unsigned char *)trans = 'N';
	    ...
	    wtrmm_("Left", uplo, trans, "Non-unit", n, m, &c_b1, &b[b_offset],
		     ldb, &z__[z_offset], ldz);
	}
    }
