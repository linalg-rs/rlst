...
/* > */
/*  ===================================================================== */
void  hlasv2_(halfreal *f, halfreal *g, halfreal *h__, 
	halfreal *ssmin, halfreal *ssmax, halfreal *snr, halfreal *
	csr, halfreal *snl, halfreal *csl)
{
    /* System generated locals */
    halfreal d__1;

    /* Local variables */
    halfreal a, d__, l, m, r__, s, t, fa, ga, ha, ft, gt, ht, mm, tt, clt, 
	    crt, slt, srt;
    integer pmax;
    halfreal temp;
    logical swap;
