...
/* > */
/*  ===================================================================== */
void  hsytrd_(char *uplo, integer *n, halfreal *a, integer *
	lda, halfreal *d__, halfreal *e, halfreal *tau, halfreal *
	work, integer *lwork, integer *info)
{
    ...
    integer nbmin, iinfo;
    logical upper;
    extern void  hsytd2_(char *, integer *, halfreal *, 
	    integer *, halfreal *, halfreal *, halfreal *, integer *), hsyr2k_(char *, char *, integer *, integer *, halfreal 
	    *, halfreal *, integer *, halfreal *, integer *, halfreal *,
	     halfreal *, integer *), hlatrd_(char *, 
...
/*           the matrix */
	    ...
	    i__3 = i__ + nb - 1;
	    hlatrd_(uplo, &i__3, &nb, &a[a_offset], lda, &e[1], &tau[1], &
		    work[1], &ldwork);
...
/*           update of the form:  A := A - V*W**T - W*V**T */
	    ...
	    i__3 = i__ - 1;
	    hsyr2k_(uplo, "No transpose", &i__3, &nb, &c_b22, &a[i__ * a_dim1 
...
/*        Use unblocked code to reduce the last or only block */
	...
	hsytd2_(uplo, &kk, &a[a_offset], lda, &d__[1], &e[1], &tau[1], &iinfo);
    } else {
...
/*           the matrix */
	    ...
	    i__3 = *n - i__ + 1;
	    hlatrd_(uplo, &i__3, &nb, &a[i__ + i__ * a_dim1], lda, &e[i__], &
...
/*           an update of the form:  A := A - V*W**T - W*V**T */
	    ...
	    i__3 = *n - i__ - nb + 1;
	    hsyr2k_(uplo, "No transpose", &i__3, &nb, &c_b22, &a[i__ + nb + 
...
/*        Use unblocked code to reduce the last or only block */
	...
	i__1 = *n - i__ + 1;
	hsytd2_(uplo, &i__1, &a[i__ + i__ * a_dim1], lda, &d__[i__], &e[i__], 
		&tau[i__], &iinfo);
    }
