...
/*  ===================================================================== */
void  wlacrm_(integer *m, integer *n, quadcomplex *a, 
	integer *lda, quadreal *b, integer *ldb, quadcomplex *c__, 
	integer *ldc, quadreal *rwork)
{
...
/* L20: */
    ...
    l = *m * *n + 1;
    qgemm_("N", "N", m, n, n, &c_b6, &rwork[1], m, &b[b_offset], ldb, &c_b7, &
	    rwork[l], m);
    i__1 = *n;
    for (j = 1; j <= i__1; ++j) {
	i__2 = *m;
