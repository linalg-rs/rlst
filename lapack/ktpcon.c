...
/*  ===================================================================== */
void  ktpcon_(char *norm, char *uplo, char *diag, integer *n, 
	halfcomplex *ap, halfreal *rcond, halfcomplex *work, halfreal 
	*rwork, integer *info)
{
    ...
    extern void  whrscl_(integer *, halfreal *, 
	    halfcomplex *, integer *);
    char normin[1];
    extern halfreal klantp_(char *, char *, char *, integer *, 
	    halfcomplex *, halfreal *);
    halfreal smlnum;
    logical nounit;
...
/*     Compute the norm of the triangular matrix A. */
    ...
    anorm = klantp_(norm, uplo, diag, n, &ap[1], &rwork[1]);
...
/*              Multiply by inv(A). */
		...
		klatps_(uplo, "No transpose", diag, normin, n, &ap[1], &work[
			1], &scale, &rwork[1], info);
	    } else {

/*              Multiply by inv(A**H). */

		klatps_(uplo, "Conjugate transpose", diag, normin, n, &ap[1], 
