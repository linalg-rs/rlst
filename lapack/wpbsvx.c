...
/* > */
/*  ===================================================================== */
void  wpbsvx_(char *fact, char *uplo, integer *n, integer *kd, 
	integer *nrhs, quadcomplex *ab, integer *ldab, quadcomplex *afb, 
	integer *ldafb, char *equed, quadreal *s, quadcomplex *b, integer 
	*ldb, quadcomplex *x, integer *ldx, quadreal *rcond, quadreal *
	ferr, quadreal *berr, quadcomplex *work, quadreal *rwork, 
	integer *info)
{
    ...
    extern quadreal wlanhb_(char *, char *, integer *, integer *, 
	    quadcomplex *, integer *, quadreal *);
    quadreal bignum;
    extern void  wlaqhb_(char *, integer *, integer *, 
	    quadcomplex *, integer *, quadreal *, quadreal *, 
	    quadreal *, char *);
    integer infequ;
    extern void  wpbcon_(char *, integer *, integer *, 
	    quadcomplex *, integer *, quadreal *, quadreal *, 
	    quadcomplex *, quadreal *, integer *), wlacpy_(char *,
	     integer *, integer *, quadcomplex *, integer *, quadcomplex *
	    , integer *), wpbequ_(char *, integer *, integer *, 
	    quadcomplex *, integer *, quadreal *, quadreal *, 
	    quadreal *, integer *), wpbrfs_(char *, integer *, 
	    integer *, integer *, quadcomplex *, integer *, quadcomplex *,
	     integer *, quadcomplex *, integer *, quadcomplex *, integer *
	    , quadreal *, quadreal *, quadcomplex *, quadreal *, 
	    integer *), wpbtrf_(char *, integer *, integer *, 
	    quadcomplex *, integer *, integer *);
    quadreal smlnum;
    extern void  wpbtrs_(char *, integer *, integer *, integer 
...
/*        Compute row and column scalings to equilibrate the matrix A. */
	...
	wpbequ_(uplo, n, kd, &ab[ab_offset], ldab, &s[1], &scond, &amax, &
		infequ);
	if (infequ == 0) {

/*           Equilibrate the matrix. */

	    wlaqhb_(uplo, n, kd, &ab[ab_offset], ldab, &s[1], &scond, &amax, 
		    equed);
	    rcequ = lsame_(equed, "Y");
	}
    }
...
/* Computing MAX */
		...
		j1 = f2cmax(i__2,1);
		i__2 = j - j1 + 1;
		wcopy_(&i__2, &ab[*kd + 1 - j + j1 + j * ab_dim1], &c__1, &
...
/* Computing MIN */
		...
		j2 = f2cmin(i__2,*n);
		i__2 = j2 - j + 1;
		wcopy_(&i__2, &ab[j * ab_dim1 + 1], &c__1, &afb[j * afb_dim1 
			+ 1], &c__1);
/* L50: */
	    }
	}

	wpbtrf_(uplo, n, kd, &afb[afb_offset], ldafb, info);
...
/*     Compute the norm of the matrix A. */
    ...
    anorm = wlanhb_("1", uplo, n, kd, &ab[ab_offset], ldab, &rwork[1]);

/*     Compute the reciprocal of the condition number of A. */

    wpbcon_(uplo, n, kd, &afb[afb_offset], ldafb, &anorm, rcond, &work[1], &
	    rwork[1], info);

/*     Compute the solution matrix X. */

    wlacpy_("Full", n, nrhs, &b[b_offset], ldb, &x[x_offset], ldx);
    wpbtrs_(uplo, n, kd, nrhs, &afb[afb_offset], ldafb, &x[x_offset], ldx, 
	    info);

/*     Use iterative refinement to improve the computed solution and */
/*     compute error bounds and backward error estimates for it. */

    wpbrfs_(uplo, n, kd, nrhs, &ab[ab_offset], ldab, &afb[afb_offset], ldafb, 
