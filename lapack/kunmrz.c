...
/* > */
/*  ===================================================================== */
void  kunmrz_(char *side, char *trans, integer *m, integer *n, 
	integer *k, integer *l, halfcomplex *a, integer *lda, halfcomplex 
	...
	lwork, integer *info)
{
    ...
    integer nbmin, iinfo;
    extern void  kunmr3_(char *, char *, integer *, integer *, 
    ...
    logical notran;
    integer ldwork;
    extern void  klarzb_(char *, char *, char *, char *, 
    ...
    integer lwkopt;
    logical lquery;
    extern void  klarzt_(char *, char *, integer *, integer *, 
...
/*        Use unblocked code */
	...
	kunmr3_(side, trans, m, n, k, l, &a[a_offset], lda, &tau[1], &c__[
...
/*           H = H(i+ib-1) . . . H(i+1) H(i) */
	    ...
	    klarzt_("Backward", "Rowwise", l, &ib, &a[i__ + ja * a_dim1], lda,
...
/*           Apply H or H**H */
	    ...
	    klarzb_(side, transt, "Backward", "Rowwise", &mi, &ni, &ib, l, &a[
