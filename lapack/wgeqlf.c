...
/* > */
/*  ===================================================================== */
void  wgeqlf_(integer *m, integer *n, quadcomplex *a, 
	 ...
	 integer *info)
{
    ...
    extern void  wgeql2_(integer *, integer *, quadcomplex *,
...
/*           A(1:m-k+i+ib-1,n-k+i:n-k+i+ib-1) */
	    ...
	    i__3 = *m - k + i__ + ib - 1;
	    wgeql2_(&i__3, &ib, &a[(*n - k + i__) * a_dim1 + 1], lda, &tau[
		    i__], &work[1], &iinfo);
	    if (*n - k + i__ > 1) {
...
/*              Apply H**H to A(1:m-k+i+ib-1,1:n-k+i-1) from the left */
		...
		i__3 = *m - k + i__ + ib - 1;
		i__4 = *n - k + i__ - 1;
		wlarfb_("Left", "Conjugate transpose", "Backward", "Columnwi"
...
/*     Use unblocked code to factor the last or only block */
    ...
    if (mu > 0 && nu > 0) {
	wgeql2_(&mu, &nu, &a[a_offset], lda, &tau[1], &work[1], &iinfo);
    }
