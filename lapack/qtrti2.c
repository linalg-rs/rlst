...
/*  ===================================================================== */
void  qtrti2_(char *uplo, char *diag, integer *n, quadreal *
	a, integer *lda, integer *info)
{
    ...
    extern void  qtrmv_(char *, char *, char *, integer *, 
	    quadreal *, integer *, quadreal *, integer *), xerbla_(char *, integer *);
    logical nounit;
...
/*           Compute elements 1:j-1 of j-th column. */
	    ...
	    i__2 = j - 1;
	    qtrmv_("Upper", "No transpose", diag, &i__2, &a[a_offset], lda, &
		    a[j * a_dim1 + 1], &c__1);
	    i__2 = j - 1;
	    qscal_(&i__2, &ajj, &a[j * a_dim1 + 1], &c__1);
/* L10: */
	}
    } else {
...
/*              Compute elements j+1:n of j-th column. */
		...
		i__1 = *n - j;
		qtrmv_("Lower", "No transpose", diag, &i__1, &a[j + 1 + (j + 
			1) * a_dim1], lda, &a[j + 1 + j * a_dim1], &c__1);
		i__1 = *n - j;
		qscal_(&i__1, &ajj, &a[j + 1 + j * a_dim1], &c__1);
	    }
/* L20: */
	}
    }
