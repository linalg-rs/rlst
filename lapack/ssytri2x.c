...
/*  ===================================================================== */
void  ssytri2x_(char *uplo, integer *n, real *a, integer *lda, 
	integer *ipiv, real *work, integer *nb, integer *info)
{
    ...
    real d__;
    integer i__, j, k;
    extern void  ssyswapr_(char *, integer *, real *, integer *
	    , integer *, integer *);
    real t, ak;
    ...
    extern void  xerbla_(char *, integer *), strtri_(
	    char *, char *, integer *, real *, integer *, integer *);
    real u01_ip1_j__, u11_ip1_j__;
    extern void  ssyconv_(char *, char *, integer *, real *, 
