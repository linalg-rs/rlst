...
/*  ===================================================================== */
void  qstebz_(char *range, char *order, integer *n, quadreal 
	*vl, quadreal *vu, integer *il, integer *iu, quadreal *abstol, 
	quadreal *d__, quadreal *e, integer *m, integer *nsplit, 
	quadreal *w, integer *iblock, integer *isplit, quadreal *work, 
	integer *iwork, integer *info)
{
    ...
    quadreal bnorm;
    integer itmax;
    quadreal wkill, rtoli, tnorm;
    extern quadreal qlamch_(char *);
    integer ibegin;
    extern void  qlaebz_(integer *, integer *, integer *, 
