...
/*  ===================================================================== */
void  qtrtri_(char *uplo, char *diag, integer *n, quadreal *
	a, integer *lda, integer *info)
{
    ...
    extern void  qtrmm_(char *, char *, char *, char *, 
	    ...
	    quadreal *, integer *), qtrsm_(
	    char *, char *, char *, char *, integer *, integer *, quadreal *
	    , quadreal *, integer *, quadreal *, integer *);
    logical upper;
    extern void  qtrti2_(char *, char *, integer *, quadreal 
...
/*        Use unblocked code */
	...
	qtrti2_(uplo, diag, n, &a[a_offset], lda, info);
    } else {
...
/*              Compute inverse of current diagonal block */
		...
		qtrti2_("Upper", diag, &jb, &a[j + j * a_dim1], lda, info);
/* L20: */
	    }
	} else {
...
/*              Compute inverse of current diagonal block */
		...
		qtrti2_("Lower", diag, &jb, &a[j + j * a_dim1], lda, info);
/* L30: */
	    }
	}
    }
