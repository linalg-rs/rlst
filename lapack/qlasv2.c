...
/* > */
/*  ===================================================================== */
void  qlasv2_(quadreal *f, quadreal *g, quadreal *h__, 
	quadreal *ssmin, quadreal *ssmax, quadreal *snr, quadreal *
	csr, quadreal *snl, quadreal *csl)
{
    /* System generated locals */
    quadreal d__1;

    /* Local variables */
    quadreal a, d__, l, m, r__, s, t, fa, ga, ha, ft, gt, ht, mm, tt, clt, 
	    crt, slt, srt;
    integer pmax;
    quadreal temp;
    logical swap;
