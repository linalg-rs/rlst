...
/* > */
/*  ===================================================================== */
void  kggsvd3_(char *jobu, char *jobv, char *jobq, integer *m, 
	integer *n, integer *p, integer *k, integer *l, halfcomplex *a, 
	integer *lda, halfcomplex *b, integer *ldb, halfreal *alpha, 
	halfreal *beta, halfcomplex *u, integer *ldu, halfcomplex *v, 
	integer *ldv, halfcomplex *q, integer *ldq, halfcomplex *work, 
	integer *lwork, halfreal *rwork, integer *iwork, integer *info)
{
    ...
    extern halfreal klange_(char *, integer *, integer *, halfcomplex *, 
	    integer *, halfreal *);
    extern void  ktgsja_(char *, char *, char *, integer *, 
    ...
    integer lwkopt;
    logical lquery;
    extern void  kggsvp3_(char *, char *, char *, integer *, 
...
/*     Compute workspace */
    ...
    if (*info == 0) {
	kggsvp3_(jobu, jobv, jobq, m, p, n, &a[a_offset], lda, &b[b_offset], 
...
/*     Compute the Frobenius norm of matrices A and B */
    ...
    anorm = klange_("1", m, n, &a[a_offset], lda, &rwork[1]);
    bnorm = klange_("1", p, n, &b[b_offset], ldb, &rwork[1]);
...
/*     the effective numerical rank of the matrices A and B. */
    ...
    i__1 = *lwork - *n;
    kggsvp3_(jobu, jobv, jobq, m, p, n, &a[a_offset], lda, &b[b_offset], ldb, 
...
/*     Compute the GSVD of two upper "triangular" matrices */
    ...
    ktgsja_(jobu, jobv, jobq, m, p, n, k, l, &a[a_offset], lda, &b[b_offset], 
...
/*     Copy ALPHA to RWORK, then sort ALPHA in RWORK */
    ...
    hcopy_(n, &alpha[1], &c__1, &rwork[1], &c__1);
/* Computing MIN */
    i__1 = *l, i__2 = *m - *k;
