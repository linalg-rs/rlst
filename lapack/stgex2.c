...
/* > */
/*  ===================================================================== */
void  stgex2_(logical *wantq, logical *wantz, integer *n, real 
	...
	integer *lwork, integer *info)
{
    ...
    real taul[4], dsum, taur[4], scpy[16]	/* was [4][4] */, tcpy[16]	
	    /* was [4][4] */;
    extern void  srot_(integer *, real *, integer *, real *, 
	    integer *, real *, real *);
    ...
    integer iwork[4];
    extern void  slagv2_(real *, integer *, real *, integer *, 
    ...
    real dscale;
    extern void  stgsy2_(char *, integer *, integer *, integer 
