...
/* > */
/*  ===================================================================== */
void  horbdb2_(integer *m, integer *p, integer *q, halfreal *
...
/*     Reduce rows 1, ..., P of X11 and X21 */
	...
	if (i__ > 1) {
	    i__2 = *q - i__ + 1;
	    hrot_(&i__2, &x11[i__ + i__ * x11_dim1], ldx11, &x21[i__ - 1 + 
...
/* Computing 2nd power */
	...
	i__3 = *m - *p - i__ + 1;
/* Computing 2nd power */
	d__2 = hnrm2_(&i__3, &x21[i__ + i__ * x21_dim1], &c__1);
	...
	if (i__ < *p) {
	    ...
	    i__2 = *p - i__;
	    i__3 = *q - i__;
	    hlarf_("L", &i__2, &i__3, &x11[i__ + 1 + i__ * x11_dim1], &c__1, &
