...
/*  ===================================================================== */
void  chesv_(char *uplo, integer *n, integer *nrhs, complex *a,
	 ...
	 integer *lwork, integer *info)
{
    ...
    extern void  chetrf_(char *, integer *, complex *, integer 
	    *, integer *, complex *, integer *, integer *), xerbla_(
	    char *, integer *);
    extern integer ilaenv_(integer *, char *, char *, integer *, integer *, 
	    integer *, integer *, ftnlen, ftnlen);
    extern void  chetrs_(char *, integer *, integer *, complex 
	    *, integer *, integer *, complex *, integer *, integer *);
    integer lwkopt;
    logical lquery;
    extern void  chetrs2_(char *, integer *, integer *, 
