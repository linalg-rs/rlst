...
/*  ===================================================================== */
void  ktprfs_(char *uplo, char *trans, char *diag, integer *n, 
	integer *nrhs, halfcomplex *ap, halfcomplex *b, integer *ldb, 
	...
	halfcomplex *work, halfreal *rwork, integer *info)
{
    ...
    extern void  kcopy_(integer *, halfcomplex *, integer *, 
	    ...
	    halfcomplex *, integer *, halfcomplex *, integer *), ktpmv_(
	    char *, char *, char *, integer *, halfcomplex *, halfcomplex 
	    *, integer *), ktpsv_(char *, char *, 
	    char *, integer *, halfcomplex *, halfcomplex *, integer *), klacn2_(integer *, halfcomplex *, 
...
/*        where op(A) = A, A**T, or A**H, depending on TRANS. */
	...
	ktpmv_(uplo, trans, diag, n, &ap[1], &work[1], &c__1);
	z__1.r = -1., z__1.i = -0.;
...
/*              Multiply by diag(W)*inv(op(A)**H). */
		...
		ktpsv_(uplo, transt, diag, n, &ap[1], &work[1], &c__1);
		i__2 = *n;
		for (i__ = 1; i__ <= i__2; ++i__) {
		    i__3 = i__;
		    i__4 = i__;
...
/* L230: */
		...
		ktpsv_(uplo, transn, diag, n, &ap[1], &work[1], &c__1);
	    }
	    goto L210;
	}
