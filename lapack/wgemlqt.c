...
/* > \verbatim */
/* > */
/* > ZGEMLQT overwrites the general doublereal M-by-N matrix C with */
/* > */
/* >                 SIDE = 'L'     SIDE = 'R' */
/* > TRANS = 'N':      Q C            C Q */
/* > TRANS = 'C':   Q**H C            C Q**H */
...
/*  ===================================================================== */
void  wgemlqt_(char *side, char *trans, integer *m, integer *n,
	 integer *k, integer *mb, quadcomplex *v, integer *ldv, 
	quadcomplex *t, integer *ldt, quadcomplex *c__, integer *ldc, 
	quadcomplex *work, integer *info)
{
    ...
    logical right;
    extern void  xerbla_(char *, integer *), wlarfb_(
...
/* Computing MIN */
	    ...
	    ib = f2cmin(i__3,i__4);
	    i__3 = *m - i__ + 1;
	    wlarfb_("L", "C", "F", "R", &i__3, n, &ib, &v[i__ + i__ * v_dim1],
...
/* Computing MIN */
	    ...
	    ib = f2cmin(i__3,i__4);
	    i__3 = *n - i__ + 1;
	    wlarfb_("R", "N", "F", "R", m, &i__3, &ib, &v[i__ + i__ * v_dim1],
...
/* Computing MIN */
	    ...
	    ib = f2cmin(i__2,i__3);
	    i__2 = *m - i__ + 1;
	    wlarfb_("L", "N", "F", "R", &i__2, n, &ib, &v[i__ + i__ * v_dim1],
		     ldv, &t[i__ * t_dim1 + 1], ldt, &c__[i__ + c_dim1], ldc, 
		    &work[1], &ldwork);
	}
...
/* Computing MIN */
	    ...
	    ib = f2cmin(i__2,i__3);
	    i__2 = *n - i__ + 1;
	    wlarfb_("R", "C", "F", "R", m, &i__2, &ib, &v[i__ + i__ * v_dim1],
		     ldv, &t[i__ * t_dim1 + 1], ldt, &c__[i__ * c_dim1 + 1], 
		    ldc, &work[1], &ldwork);
	}
