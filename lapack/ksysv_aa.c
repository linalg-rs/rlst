...
/*  ===================================================================== */
void  zsysv_aa__(char *uplo, integer *n, integer *nrhs, 
	...
	integer *ldb, halfcomplex *work, integer *lwork, integer *info)
{
    ...
    /* Local variables */
    extern void  zsytrf_aa__(char *, integer *, halfcomplex *
	    , integer *, integer *, halfcomplex *, integer *, integer *), zsytrs_aa__(char *, integer *, integer *, halfcomplex *
