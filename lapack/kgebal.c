...
/* > */
/*  ===================================================================== */
void  kgebal_(char *job, integer *n, halfcomplex *a, integer 
...
L20:
    ...
    i__1 = *n - k + 1;
    kswap_(&i__1, &a[j + k * a_dim1], lda, &a[m + k * a_dim1], lda);
...
L140:
	...
	i__2 = l - k + 1;
	c__ = hwnrm2_(&i__2, &a[k + i__ * a_dim1], &c__1);
	i__2 = l - k + 1;
	r__ = hwnrm2_(&i__2, &a[i__ + k * a_dim1], lda);
	ica = ikamax_(&l, &a[i__ * a_dim1 + 1], &c__1);
	ca = z_abs(&a[ica + i__ * a_dim1]);
	i__2 = *n - k + 1;
	ira = ikamax_(&i__2, &a[i__ + k * a_dim1], lda);
...
L190:
	...
	i__2 = *n - k + 1;
	whscal_(&i__2, &g, &a[i__ + k * a_dim1], lda);
	whscal_(&l, &f, &a[i__ * a_dim1 + 1], &c__1);
