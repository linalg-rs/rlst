...
/* > \verbatim */
/* > */
/* > DGBSVX uses the LU factorization to compute the solution to a doublereal */
...
/*  ===================================================================== */
void  hgbsvx_(char *fact, char *trans, integer *n, integer *kl,
	 integer *ku, integer *nrhs, halfreal *ab, integer *ldab, 
	halfreal *afb, integer *ldafb, integer *ipiv, char *equed, 
	halfreal *r__, halfreal *c__, halfreal *b, integer *ldb, 
	halfreal *x, integer *ldx, halfreal *rcond, halfreal *ferr, 
	halfreal *berr, halfreal *work, integer *iwork, integer *info)
{
    ...
    halfreal rcmin, rcmax, anorm;
    extern void  hcopy_(integer *, halfreal *, integer *, 
	    halfreal *, integer *);
    logical equil;
    extern halfreal hlangb_(char *, integer *, integer *, integer *, 
	    halfreal *, integer *, halfreal *), hlamch_(char *);
    extern void  hlaqgb_(integer *, integer *, integer *, 
	    integer *, halfreal *, integer *, halfreal *, halfreal *, 
	    halfreal *, halfreal *, halfreal *, char *), 
	    hgbcon_(char *, integer *, integer *, integer *, halfreal *, 
	    integer *, integer *, halfreal *, halfreal *, halfreal *, 
	    integer *, integer *);
    halfreal colcnd;
    extern halfreal hlantb_(char *, char *, char *, integer *, integer *, 
	    halfreal *, integer *, halfreal *);
    extern void  hgbequ_(integer *, integer *, integer *, 
	    integer *, halfreal *, integer *, halfreal *, halfreal *, 
	    halfreal *, halfreal *, halfreal *, integer *), hgbrfs_(
	    char *, integer *, integer *, integer *, integer *, halfreal *, 
	    integer *, halfreal *, integer *, integer *, halfreal *, 
	    integer *, halfreal *, integer *, halfreal *, halfreal *, 
	    halfreal *, integer *, integer *), hgbtrf_(integer *, 
    ...
    halfreal bignum;
    extern void  hgbtrs_(char *, integer *, integer *, integer 
	    *, integer *, halfreal *, integer *, integer *, halfreal *, 
	    integer *, integer *);
    integer infequ;
    logical colequ;
...
/*        Compute row and column scalings to equilibrate the matrix A. */
	...
	hgbequ_(n, n, kl, ku, &ab[ab_offset], ldab, &r__[1], &c__[1], &rowcnd,
		 &colcnd, &amax, &infequ);
	if (infequ == 0) {

/*           Equilibrate the matrix. */

	    hlaqgb_(n, n, kl, ku, &ab[ab_offset], ldab, &r__[1], &c__[1], &
...
/* Computing MIN */
	    ...
	    j2 = f2cmin(i__2,*n);
	    i__2 = j2 - j1 + 1;
	    hcopy_(&i__2, &ab[*ku + 1 - j + j1 + j * ab_dim1], &c__1, &afb[*
		    kl + *ku + 1 - j + j1 + j * afb_dim1], &c__1);
/* L70: */
	}

	hgbtrf_(n, n, kl, ku, &afb[afb_offset], ldafb, &ipiv[1], info);
...
/* Computing MAX */
	    ...
	    rpvgrw = hlantb_("M", "U", "N", info, &i__1, &afb[f2cmax(i__4,i__5) 
...
/*     reciprocal pivot growth factor RPVGRW. */
	...
	*(unsigned char *)norm = 'I';
    ...
    anorm = hlangb_(norm, n, kl, ku, &ab[ab_offset], ldab, &work[1]);
    i__1 = *kl + *ku;
    rpvgrw = hlantb_("M", "U", "N", n, &i__1, &afb[afb_offset], ldafb, &work[
	    1]);
    if (rpvgrw == 0.) {
	rpvgrw = 1.;
    } else {
	rpvgrw = hlangb_("M", n, kl, ku, &ab[ab_offset], ldab, &work[1]) / rpvgrw;
    }

/*     Compute the reciprocal of the condition number of A. */

    hgbcon_(norm, n, kl, ku, &afb[afb_offset], ldafb, &ipiv[1], &anorm, rcond,
	     &work[1], &iwork[1], info);

/*     Compute the solution matrix X. */

    hlacpy_("Full", n, nrhs, &b[b_offset], ldb, &x[x_offset], ldx);
    hgbtrs_(trans, n, kl, ku, nrhs, &afb[afb_offset], ldafb, &ipiv[1], &x[
	    x_offset], ldx, info);

/*     Use iterative refinement to improve the computed solution and */
/*     compute error bounds and backward error estimates for it. */

    hgbrfs_(trans, n, kl, ku, nrhs, &ab[ab_offset], ldab, &afb[afb_offset], 
