...
/* > */
/*  ===================================================================== */
void  cgelsy_(integer *m, integer *n, integer *nrhs, complex *
	...
	info)
{
    ...
    extern void  ctrsm_(char *, char *, char *, char *, 
	    ...
	    complex *, complex *);
    real wsize;
    extern void  cgeqp3_(integer *, integer *, complex *, 
    ...
    extern void  cunmrz_(char *, char *, integer *, integer *, 
	    integer *, integer *, complex *, integer *, complex *, complex *, 
	    integer *, complex *, integer *, integer *);
    integer lwkopt;
    logical lquery;
    extern void  ctzrzf_(integer *, integer *, complex *, 
