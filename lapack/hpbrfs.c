...
/*  ===================================================================== */
void  hpbrfs_(char *uplo, integer *n, integer *kd, integer *
	nrhs, halfreal *ab, integer *ldab, halfreal *afb, integer *ldafb, 
	halfreal *b, integer *ldb, halfreal *x, integer *ldx, halfreal *
	ferr, halfreal *berr, halfreal *work, integer *iwork, integer *
	info)
{
    ...
    integer isave[3];
    extern void  hsbmv_(char *, integer *, integer *, 
    ...
    halfreal safmin;
    extern void  xerbla_(char *, integer *), hpbtrs_(
...
/*        Compute residual R = B - A * X */
	...
	hsbmv_(uplo, n, kd, &c_b12, &ab[ab_offset], ldab, &x[j * x_dim1 + 1], 
...
/*           Update solution and try again. */
	    ...
	    hpbtrs_(uplo, n, kd, &c__1, &afb[afb_offset], ldafb, &work[*n + 1]
		    , n, info);
...
/*              Multiply by diag(W)*inv(A**T). */
		...
		hpbtrs_(uplo, n, kd, &c__1, &afb[afb_offset], ldafb, &work[*n 
			+ 1], n, info);
		i__2 = *n;
		for (i__ = 1; i__ <= i__2; ++i__) {
		    work[*n + i__] *= work[i__];
