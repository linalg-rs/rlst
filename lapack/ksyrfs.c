...
/*  ===================================================================== */
void  ksyrfs_(char *uplo, integer *n, integer *nrhs, 
	 ...
	 halfreal *rwork, integer *info)
{
    ...
    extern void  kcopy_(integer *, halfcomplex *, integer *, 
	    ...
	    halfcomplex *, integer *, halfcomplex *, integer *), ksymv_(
	    char *, integer *, halfcomplex *, halfcomplex *, integer *, 
    ...
    halfreal lstres;
    extern void  ksytrs_(char *, integer *, integer *, 
...
/*        Compute residual R = B - A * X */
	...
	z__1.r = -1., z__1.i = -0.;
	ksymv_(uplo, n, &z__1, &a[a_offset], lda, &x[j * x_dim1 + 1], &c__1, &
		c_b1, &work[1], &c__1);
...
/*           Update solution and try again. */
	    ...
	    ksytrs_(uplo, n, &c__1, &af[af_offset], ldaf, &ipiv[1], &work[1], 
		    n, info);
...
/*              Multiply by diag(W)*inv(A**T). */
		...
		ksytrs_(uplo, n, &c__1, &af[af_offset], ldaf, &ipiv[1], &work[
			1], n, info);
		i__2 = *n;
		for (i__ = 1; i__ <= i__2; ++i__) {
		    i__3 = i__;
