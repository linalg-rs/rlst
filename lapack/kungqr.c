...
/*  ===================================================================== */
void  kungqr_(integer *m, integer *n, integer *k, 
	...
	work, integer *lwork, integer *info)
{
    ...
    extern void  kung2r_(integer *, integer *, integer *, 
...
/*     Use unblocked code for the last or only block. */
	...
	i__2 = *n - kk;
	i__3 = *k - kk;
	kung2r_(&i__1, &i__2, &i__3, &a[kk + 1 + (kk + 1) * a_dim1], lda, &
...
/*              H = H(i) H(i+1) . . . H(i+ib-1) */
		...
		i__2 = *m - i__ + 1;
		klarft_("Forward", "Columnwise", &i__2, &ib, &a[i__ + i__ * 
...
/*              Apply H to A(i:m,i+ib:n) from the left */
		...
		i__2 = *m - i__ + 1;
		i__3 = *n - i__ - ib + 1;
		klarfb_("Left", "No transpose", "Forward", "Columnwise", &
...
/*           Apply H to rows i:m of current block */
	    ...
	    i__2 = *m - i__ + 1;
	    kung2r_(&i__2, &ib, &ib, &a[i__ + i__ * a_dim1], lda, &tau[i__], &
		    work[1], &iinfo);
