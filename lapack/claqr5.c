...
/* > */
/*  ===================================================================== */
void  claqr5_(logical *wantt, logical *wantz, integer *kacc22, 
...
/*              .    unnecessary. ==== */
		...
		if (h__[i__5].r != 0.f || h__[i__5].i != 0.f) {
		    i__5 = k + k * h_dim1;
		    i__7 = k + 1 + (k + 1) * h_dim1;
		    tst1 = (r__1 = h__[i__5].r, abs(r__1)) + (r__2 = r_imag(&
			    h__[k + k * h_dim1]), abs(r__2)) + ((r__3 = h__[
			    i__7].r, abs(r__3)) + (r__4 = r_imag(&h__[k + 1 + 
			    (k + 1) * h_dim1]), abs(r__4)));
		    if (tst1 == 0.f) {
			if (k >= *ktop + 1) {
			    i__5 = k + (k - 1) * h_dim1;
			    tst1 += (r__1 = h__[i__5].r, abs(r__1)) + (r__2 = 
...
/* Computing MAX */
		    ...
		    if ((r__1 = h__[i__5].r, abs(r__1)) + (r__2 = r_imag(&h__[
			    k + 1 + k * h_dim1]), abs(r__2)) <= f2cmax(r__3,r__4)
			    ) {
/* Computing MAX */
			i__5 = k + 1 + k * h_dim1;
			i__7 = k + (k + 1) * h_dim1;
			r__5 = (r__1 = h__[i__5].r, abs(r__1)) + (r__2 = 
				r_imag(&h__[k + 1 + k * h_dim1]), abs(r__2)), 
				r__6 = (r__3 = h__[i__7].r, abs(r__3)) + (
