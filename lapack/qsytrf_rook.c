...
/* > \verbatim */
/* > */
/* > DSYTRF_ROOK computes the factorization of a doublereal symmetric matrix A */
...
/*  ===================================================================== */
void  dsytrf_rook__(char *uplo, integer *n, quadreal *a, 
	...
	integer *info)
{
    ...
    extern void  dsytf2_rook__(char *, integer *, quadreal *,
	     integer *, integer *, integer *), dlasyf_rook__(char *, 
