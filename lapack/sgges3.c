...
/*  ===================================================================== */
void  sgges3_(char *jobvsl, char *jobvsr, char *sort, L_fp 
	 ...
	 logical *bwork, integer *info)
{
    ...
    integer irows;
    extern void  sgghd3_(char *, char *, integer *, integer *, 
	    integer *, real *, integer *, real *, integer *, real *, integer *
	    , real *, integer *, real *, integer *, integer *)
	    ;
    logical lst2sl;
    extern void  slabad_(real *, real *), sggbak_(char *, char 
    ...
    extern void  sgeqrf_(integer *, integer *, real *, integer 
    ...
    real anrmto, bnrmto;
    logical lastsl;
    extern void  shgeqz_(char *, char *, char *, integer *, 
