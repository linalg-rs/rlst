...
/*  ===================================================================== */
void  hstebz_(char *range, char *order, integer *n, halfreal 
	*vl, halfreal *vu, integer *il, integer *iu, halfreal *abstol, 
	halfreal *d__, halfreal *e, integer *m, integer *nsplit, 
	halfreal *w, integer *iblock, integer *isplit, halfreal *work, 
...
/*        Compute Iteration parameters */
	...
	itmax = (integer) ((M(log)(tnorm + pivmin) - M(log)(pivmin)) / M(log)(2.)) + 2;
	if (*abstol <= 0.) {
	    atoli = ulp * tnorm;
	} else {
	    atoli = *abstol;
...
/*           Compute Eigenvalues */
	    ...
	    itmax = (integer) ((M(log)(gu - gl + pivmin) - M(log)(pivmin)) / M(log)(2.)
		    ) + 2;
