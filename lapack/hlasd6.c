...
/* > */
/*  ===================================================================== */
void  hlasd6_(integer *icompq, integer *nl, integer *nr, 
	integer *sqre, halfreal *d__, halfreal *vf, halfreal *vl, 
	halfreal *alpha, halfreal *beta, integer *idxq, integer *perm, 
	integer *givptr, integer *givcol, integer *ldgcol, halfreal *givnum,
	 integer *ldgnum, halfreal *poles, halfreal *difl, halfreal *
	difr, halfreal *z__, integer *k, halfreal *c__, halfreal *s, 
	halfreal *work, integer *iwork, integer *info)
{
    ...
    extern void  hcopy_(integer *, halfreal *, integer *, 
	    halfreal *, integer *), hlasd7_(integer *, integer *, integer *,
	    ...
	    *, integer *, halfreal *, halfreal *, integer *), hlasd8_(
	    integer *, integer *, halfreal *, halfreal *, halfreal *, 
	    ...
	    integer *, integer *), hlamrg_(integer *, integer *, 
...
/* L10: */
    ...
    hlascl_("G", &c__0, &c__0, &orgnrm, &c_b7, &n, &c__1, &d__[1], &n, info);
    *alpha /= orgnrm;
    *beta /= orgnrm;

/*     Sort and Deflate singular values. */

    hlasd7_(icompq, nl, nr, sqre, k, &d__[1], &z__[1], &work[iw], &vf[1], &
...
/*     Solve Secular Equation, compute DIFL, DIFR, and update VF, VL. */
    ...
    hlasd8_(icompq, k, &d__[1], &z__[1], &vf[1], &vl[1], &difl[1], &difr[1], 
...
/*     Save the poles if ICOMPQ = 1. */
    ...
    if (*icompq == 1) {
	hcopy_(k, &d__[1], &c__1, &poles[poles_dim1 + 1], &c__1);
	hcopy_(k, &work[isigma], &c__1, &poles[(poles_dim1 << 1) + 1], &c__1);
    }

/*     Unscale. */

    hlascl_("G", &c__0, &c__0, &c_b7, &orgnrm, &n, &c__1, &d__[1], &n, info);

/*     Prepare the IDXQ sorting permutation. */

    n1 = *k;
    n2 = n - *k;
    hlamrg_(&n1, &n2, &d__[1], &c__1, &c_n1, &idxq[1]);
