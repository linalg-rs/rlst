...
/* > \brief \b DLARTV applies a vector of plane rotations with doublereal cosines and doublereal sines to the elements of 
a pair of vectors. */
...
/* > \verbatim */
/* > */
/* > DLARTV applies a vector of doublereal plane rotations to elements of the */
/* > doublereal vectors x and y. For i = 1,2,...,n */
/* > */
/* >    ( x(i) ) := (  c(i)  s(i) ) ( x(i) ) */
/* >    ( y(i) )    ( -s(i)  c(i) ) ( y(i) ) */
/* > \endverbatim */
...
/*  ===================================================================== */
void  hlartv_(integer *n, halfreal *x, integer *incx, 
	halfreal *y, integer *incy, halfreal *c__, halfreal *s, integer 
	*incc)
{
