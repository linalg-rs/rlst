...
/* > */
/*  ===================================================================== */
void  slarre_(char *range, integer *n, real *vl, real *vu, 
	...
	real *gers, real *pivmin, real *work, integer *iwork, integer *info)
{
    ...
    integer wbegin;
    real safmin, spdiam;
    extern void  slarra_(integer *, real *, real *, real *, 
	    real *, real *, integer *, integer *, integer *);
    logical usedqd;
    real clwdth, isleft;
    extern void  slarrb_(integer *, real *, real *, integer *, 
    ...
    extern void  slarnv_(integer *, integer *, integer *, real 
	    *);
