...
/*  ===================================================================== */
void  wsysvx_(char *fact, char *uplo, integer *n, integer *
	nrhs, quadcomplex *a, integer *lda, quadcomplex *af, integer *
	ldaf, integer *ipiv, quadcomplex *b, integer *ldb, quadcomplex *x,
	 integer *ldx, quadreal *rcond, quadreal *ferr, quadreal *berr, 
	quadcomplex *work, integer *lwork, quadreal *rwork, integer *info)
{
    ...
    extern quadreal wlansy_(char *, char *, integer *, quadcomplex *, 
	    integer *, quadreal *);
    extern void  wsycon_(char *, integer *, quadcomplex *, 
	    integer *, integer *, quadreal *, quadreal *, quadcomplex *,
	     integer *), wsyrfs_(char *, integer *, integer *, 
	    quadcomplex *, integer *, quadcomplex *, integer *, integer *,
	     quadcomplex *, integer *, quadcomplex *, integer *, 
	    quadreal *, quadreal *, quadcomplex *, quadreal *, 
	    integer *), wsytrf_(char *, integer *, quadcomplex *, 
	    integer *, integer *, quadcomplex *, integer *, integer *), wsytrs_(char *, integer *, integer *, quadcomplex *, 
...
/*        Compute the factorization A = U*D*U**T or A = L*D*L**T. */
	...
	wlacpy_(uplo, n, n, &a[a_offset], lda, &af[af_offset], ldaf);
	wsytrf_(uplo, n, &af[af_offset], ldaf, &ipiv[1], &work[1], lwork, 
		info);
...
/*     Compute the norm of the matrix A. */
    ...
    anorm = wlansy_("I", uplo, n, &a[a_offset], lda, &rwork[1]);

/*     Compute the reciprocal of the condition number of A. */

    wsycon_(uplo, n, &af[af_offset], ldaf, &ipiv[1], &anorm, rcond, &work[1], 
	    info);

/*     Compute the solution vectors X. */

    wlacpy_("Full", n, nrhs, &b[b_offset], ldb, &x[x_offset], ldx);
    wsytrs_(uplo, n, nrhs, &af[af_offset], ldaf, &ipiv[1], &x[x_offset], ldx, 
	    info);

/*     Use iterative refinement to improve the computed solutions and */
/*     compute error bounds and backward error estimates for them. */

    wsyrfs_(uplo, n, nrhs, &a[a_offset], lda, &af[af_offset], ldaf, &ipiv[1], 
