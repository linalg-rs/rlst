...
/* > \endverbatim */
/*  ===================================================================== */
void  ksyconvf_(char *uplo, char *way, integer *n, 
	halfcomplex *a, integer *lda, halfcomplex *e, integer *ipiv, 
	integer *info)
{
...
/*                 Swap rows i and IPIV(i) in A(1:i,N-i:N) */
			...
			if (ip != i__) {
			    i__1 = *n - i__;
			    kswap_(&i__1, &a[i__ + (i__ + 1) * a_dim1], lda, &
...
/*                 Swap rows i-1 and IPIV(i) in A(1:i,N-i:N) */
			...
			if (ip != i__ - 1) {
			    i__1 = *n - i__;
			    kswap_(&i__1, &a[i__ - 1 + (i__ + 1) * a_dim1], 
...
/*                 Swap rows i and IPIV(i) in A(1:i,N-i:N) */
			...
			if (ip != i__) {
			    i__1 = *n - i__;
			    kswap_(&i__1, &a[ip + (i__ + 1) * a_dim1], lda, &
...
/*                 Swap rows i and IPIV(i) in A(i:N,1:i-1) */
			...
			if (ip != i__) {
			    i__1 = i__ - 1;
			    kswap_(&i__1, &a[i__ + a_dim1], lda, &a[ip + 
				    a_dim1], lda);
			}
		    }
...
/*                 Swap rows i+1 and IPIV(i) in A(i:N,1:i-1) */
			...
			if (ip != i__ + 1) {
			    i__1 = i__ - 1;
			    kswap_(&i__1, &a[i__ + 1 + a_dim1], lda, &a[ip + 
				    a_dim1], lda);
			}
		    }
...
/*                 Swap rows i and IPIV(i) in A(i:N,1:i-1) */
			...
			if (ip != i__) {
			    i__1 = i__ - 1;
			    kswap_(&i__1, &a[ip + a_dim1], lda, &a[i__ + 
				    a_dim1], lda);
			}
		    }
...
/*                 Swap rows i+1 and IPIV(i) in A(i:N,1:i-1) */
			...
			if (ip != i__ + 1) {
			    i__1 = i__ - 1;
			    kswap_(&i__1, &a[ip + a_dim1], lda, &a[i__ + 1 + 
				    a_dim1], lda);
			}
		    }
