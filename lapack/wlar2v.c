...
/*  ===================================================================== */
void  wlar2v_(integer *n, quadcomplex *x, quadcomplex *y, 
	quadcomplex *z__, integer *incx, quadreal *c__, quadcomplex *s, 
	integer *incc)
{
    ...
    quadreal xi, yi;
    quadcomplex zi;
    quadreal t1i, t1r, sii, zii, sir, zir;
