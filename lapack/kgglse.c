...
/*  ===================================================================== */
void  kgglse_(integer *m, integer *n, integer *p, 
	halfcomplex *a, integer *lda, halfcomplex *b, integer *ldb, 
	halfcomplex *c__, halfcomplex *d__, halfcomplex *x, 
	halfcomplex *work, integer *lwork, integer *info)
{
    ...
    extern void  kgemv_(char *, integer *, integer *, 
	    ...
	    integer *), kaxpy_(integer *, halfcomplex *, halfcomplex *, 
	    integer *, halfcomplex *, integer *), ktrmv_(char *, char *, 
	    char *, integer *, halfcomplex *, integer *, halfcomplex *, 
	    integer *), xerbla_(char *, integer *);
    extern integer ilaenv_(integer *, char *, char *, integer *, integer *, 
	    integer *, integer *, ftnlen, ftnlen);
    extern void  kggrqf_(integer *, integer *, integer *, 
    ...
    extern void  kunmqr_(char *, char *, integer *, integer *, 
	    ...
	    halfcomplex *, integer *, halfcomplex *, integer *, integer *), kunmrq_(char *, char *, integer *, integer *, 
	    integer *, halfcomplex *, integer *, halfcomplex *, 
...
/*     unitary. */
    ...
    i__1 = *lwork - *p - mn;
    kggrqf_(p, m, n, &b[b_offset], ldb, &work[1], &a[a_offset], lda, &work[*p 
...
/*                       ( c2 ) M+P-N */
    ...
    i__1 = f2cmax(1,*m);
    i__2 = *lwork - *p - mn;
    kunmqr_("Left", "Conjugate Transpose", m, &c__1, &mn, &a[a_offset], lda, &
...
/*     Solve T12*x2 = d for x2 */
    ...
    if (*p > 0) {
	ktrtrs_("Upper", "No transpose", "Non-unit", p, &c__1, &b[(*n - *p + 
...
/*        Put the solution in X */
	...
	kcopy_(p, &d__[1], &c__1, &x[*n - *p + 1], &c__1);

/*        Update c1 */

	i__1 = *n - *p;
	z__1.r = -1., z__1.i = -0.;
	kgemv_("No transpose", &i__1, p, &z__1, &a[(*n - *p + 1) * a_dim1 + 1]
...
/*     Solve R11*x1 = c1 for x1 */
	...
	i__1 = *n - *p;
	i__2 = *n - *p;
	ktrtrs_("Upper", "No transpose", "Non-unit", &i__1, &c__1, &a[
...
/*        Put the solutions in X */
	...
	i__1 = *n - *p;
	kcopy_(&i__1, &c__[1], &c__1, &x[1], &c__1);
    }
...
/*     Compute the residual vector: */
	...
	if (nr > 0) {
	    i__1 = *n - *m;
	    z__1.r = -1., z__1.i = -0.;
	    kgemv_("No transpose", &nr, &i__1, &z__1, &a[*n - *p + 1 + (*m + 
    ...
    if (nr > 0) {
	ktrmv_("Upper", "No transpose", "Non unit", &nr, &a[*n - *p + 1 + (*n 
		- *p + 1) * a_dim1], lda, &d__[1], &c__1);
	z__1.r = -1., z__1.i = -0.;
	kaxpy_(&nr, &z__1, &d__[1], &c__1, &c__[*n - *p + 1], &c__1);
    }

/*     Backward transformation x = Q**H*x */

    i__1 = *lwork - *p - mn;
    kunmrq_("Left", "Conjugate Transpose", n, &c__1, p, &b[b_offset], ldb, &
