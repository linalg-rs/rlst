...
/* > \verbatim */
/* > */
/* > DSYTRD reduces a doublereal symmetric matrix A to doublereal symmetric */
...
/* > */
/*  ===================================================================== */
void  qsytrd_(char *uplo, integer *n, quadreal *a, integer *
	lda, quadreal *d__, quadreal *e, quadreal *tau, quadreal *
	work, integer *lwork, integer *info)
{
    ...
    integer nbmin, iinfo;
    logical upper;
    extern void  qsytd2_(char *, integer *, quadreal *, 
	    integer *, quadreal *, quadreal *, quadreal *, integer *), qsyr2k_(char *, char *, integer *, integer *, quadreal 
	    *, quadreal *, integer *, quadreal *, integer *, quadreal *,
	     quadreal *, integer *), qlatrd_(char *, 
...
/*           the matrix */
	    ...
	    i__3 = i__ + nb - 1;
	    qlatrd_(uplo, &i__3, &nb, &a[a_offset], lda, &e[1], &tau[1], &
		    work[1], &ldwork);
...
/*           update of the form:  A := A - V*W**T - W*V**T */
	    ...
	    i__3 = i__ - 1;
	    qsyr2k_(uplo, "No transpose", &i__3, &nb, &c_b22, &a[i__ * a_dim1 
...
/*        Use unblocked code to reduce the last or only block */
	...
	qsytd2_(uplo, &kk, &a[a_offset], lda, &d__[1], &e[1], &tau[1], &iinfo);
    } else {
...
/*           the matrix */
	    ...
	    i__3 = *n - i__ + 1;
	    qlatrd_(uplo, &i__3, &nb, &a[i__ + i__ * a_dim1], lda, &e[i__], &
...
/*           an update of the form:  A := A - V*W**T - W*V**T */
	    ...
	    i__3 = *n - i__ - nb + 1;
	    qsyr2k_(uplo, "No transpose", &i__3, &nb, &c_b22, &a[i__ + nb + 
...
/*        Use unblocked code to reduce the last or only block */
	...
	i__1 = *n - i__ + 1;
	qsytd2_(uplo, &i__1, &a[i__ + i__ * a_dim1], lda, &d__[i__], &e[i__], 
		&tau[i__], &iinfo);
    }
