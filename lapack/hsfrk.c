...
/* > */
/* > where alpha and beta are doublereal scalars, C is an n--by--n symmetric */
...
/*  ===================================================================== */
void  hsfrk_(char *transr, char *uplo, char *trans, integer *n,
	 integer *k, halfreal *alpha, halfreal *a, integer *lda, 
	halfreal *beta, halfreal *c__)
{
...
/*                 N is odd, TRANSR = 'N', UPLO = 'L', and TRANS = 'N' */
		    ...
		    hsyrk_("L", "N", &n1, k, alpha, &a[a_dim1 + 1], lda, beta,
			     &c__[1], n);
		    hsyrk_("U", "N", &n2, k, alpha, &a[n1 + 1 + a_dim1], lda, 
			    beta, &c__[*n + 1], n);
		    hgemm_("N", "T", &n2, &n1, k, alpha, &a[n1 + 1 + a_dim1], 
...
/*                 N is odd, TRANSR = 'N', UPLO = 'L', and TRANS = 'T' */
		    ...
		    hsyrk_("L", "T", &n1, k, alpha, &a[a_dim1 + 1], lda, beta,
			     &c__[1], n);
		    hsyrk_("U", "T", &n2, k, alpha, &a[(n1 + 1) * a_dim1 + 1],
			     lda, beta, &c__[*n + 1], n)
			    ;
		    hgemm_("T", "N", &n2, &n1, k, alpha, &a[(n1 + 1) * a_dim1 
...
/*                 N is odd, TRANSR = 'N', UPLO = 'U', and TRANS = 'N' */
		    ...
		    hsyrk_("L", "N", &n1, k, alpha, &a[a_dim1 + 1], lda, beta,
			     &c__[n2 + 1], n);
		    hsyrk_("U", "N", &n2, k, alpha, &a[n2 + a_dim1], lda, 
			    beta, &c__[n1 + 1], n);
		    hgemm_("N", "T", &n1, &n2, k, alpha, &a[a_dim1 + 1], lda, 
...
/*                 N is odd, TRANSR = 'N', UPLO = 'U', and TRANS = 'T' */
		    ...
		    hsyrk_("L", "T", &n1, k, alpha, &a[a_dim1 + 1], lda, beta,
			     &c__[n2 + 1], n);
		    hsyrk_("U", "T", &n2, k, alpha, &a[n2 * a_dim1 + 1], lda, 
			    beta, &c__[n1 + 1], n);
		    hgemm_("T", "N", &n1, &n2, k, alpha, &a[a_dim1 + 1], lda, 
...
/*                 N is odd, TRANSR = 'T', UPLO = 'L', and TRANS = 'N' */
		    ...
		    hsyrk_("U", "N", &n1, k, alpha, &a[a_dim1 + 1], lda, beta,
			     &c__[1], &n1);
		    hsyrk_("L", "N", &n2, k, alpha, &a[n1 + 1 + a_dim1], lda, 
			    beta, &c__[2], &n1);
		    hgemm_("N", "T", &n1, &n2, k, alpha, &a[a_dim1 + 1], lda, 
...
/*                 N is odd, TRANSR = 'T', UPLO = 'L', and TRANS = 'T' */
		    ...
		    hsyrk_("U", "T", &n1, k, alpha, &a[a_dim1 + 1], lda, beta,
			     &c__[1], &n1);
		    hsyrk_("L", "T", &n2, k, alpha, &a[(n1 + 1) * a_dim1 + 1],
			     lda, beta, &c__[2], &n1);
		    hgemm_("T", "N", &n1, &n2, k, alpha, &a[a_dim1 + 1], lda, 
...
/*                 N is even, TRANSR = 'N', UPLO = 'L', and TRANS = 'N' */
		    ...
		    i__1 = *n + 1;
		    hsyrk_("L", "N", &nk, k, alpha, &a[a_dim1 + 1], lda, beta,
			     &c__[2], &i__1);
		    i__1 = *n + 1;
		    hsyrk_("U", "N", &nk, k, alpha, &a[nk + 1 + a_dim1], lda, 
			    beta, &c__[1], &i__1);
		    i__1 = *n + 1;
		    hgemm_("N", "T", &nk, &nk, k, alpha, &a[nk + 1 + a_dim1], 
...
/*                 N is even, TRANSR = 'N', UPLO = 'L', and TRANS = 'T' */
		    ...
		    i__1 = *n + 1;
		    hsyrk_("L", "T", &nk, k, alpha, &a[a_dim1 + 1], lda, beta,
			     &c__[2], &i__1);
		    i__1 = *n + 1;
		    hsyrk_("U", "T", &nk, k, alpha, &a[(nk + 1) * a_dim1 + 1],
			     lda, beta, &c__[1], &i__1);
		    i__1 = *n + 1;
		    hgemm_("T", "N", &nk, &nk, k, alpha, &a[(nk + 1) * a_dim1 
...
/*                 N is even, TRANSR = 'N', UPLO = 'U', and TRANS = 'N' */
		    ...
		    hsyrk_("U", "N", &nk, k, alpha, &a[nk + 1 + a_dim1], lda, 
			    beta, &c__[nk + 1], &i__1);
		    i__1 = *n + 1;
		    hgemm_("N", "T", &nk, &nk, k, alpha, &a[a_dim1 + 1], lda, 
...
/*                 N is even, TRANSR = 'N', UPLO = 'U', and TRANS = 'T' */
		    ...
		    i__1 = *n + 1;
		    hgemm_("T", "N", &nk, &nk, k, alpha, &a[a_dim1 + 1], lda, 
...
/*                 N is even, TRANSR = 'T', UPLO = 'L', and TRANS = 'N' */
		    ...
		    hsyrk_("U", "N", &nk, k, alpha, &a[a_dim1 + 1], lda, beta,
			     &c__[nk + 1], &nk);
		    hsyrk_("L", "N", &nk, k, alpha, &a[nk + 1 + a_dim1], lda, 
			    beta, &c__[1], &nk);
		    hgemm_("N", "T", &nk, &nk, k, alpha, &a[a_dim1 + 1], lda, 
...
/*                 N is even, TRANSR = 'T', UPLO = 'L', and TRANS = 'T' */
		    ...
		    hsyrk_("U", "T", &nk, k, alpha, &a[a_dim1 + 1], lda, beta,
			     &c__[nk + 1], &nk);
		    hsyrk_("L", "T", &nk, k, alpha, &a[(nk + 1) * a_dim1 + 1],
			     lda, beta, &c__[1], &nk);
		    hgemm_("T", "N", &nk, &nk, k, alpha, &a[a_dim1 + 1], lda, 
