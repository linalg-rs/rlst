...
/*  ===================================================================== */
void  kgeesx_(char *jobvs, char *sort, L_fp select, char *
	sense, integer *n, halfcomplex *a, integer *lda, integer *sdim, 
	halfcomplex *w, halfcomplex *vs, integer *ldvs, halfreal *
	rconde, halfreal *rcondv, halfcomplex *work, integer *lwork, 
	halfreal *rwork, logical *bwork, integer *info)
{
    ...
    integer hswork;
    extern void  kunghr_(integer *, integer *, integer *, 
	    halfcomplex *, integer *, halfcomplex *, halfcomplex *, 
	    integer *, integer *);
    logical wantst, lquery, wantsv, wantvs;
    extern void  ktrsen_(char *, char *, logical *, integer *, 
	    halfcomplex *, integer *, halfcomplex *, integer *, 
...
/*       in the code.) */
	...
	if (*n == 0) {
	    ...
	    khseqr_("S", jobvs, n, &c__1, n, &a[a_offset], lda, &w[1], &vs[
...
/*     (RWorkspace: need N) */
    ...
    ibal = 1;
    kgebal_("P", n, &a[a_offset], lda, &ilo, &ihi, &rwork[ibal], &ierr);
...
/*        Copy Householder vectors to VS */
	...
	klacpy_("L", n, n, &a[a_offset], lda, &vs[vs_offset], ldvs)
		;
...
/*        (RWorkspace: none) */
	...
	i__1 = *lwork - iwrk + 1;
	kunghr_(n, &ilo, &ihi, &vs[vs_offset], ldvs, &work[itau], &work[iwrk],
		 &i__1, &ierr);
    }
...
/*     (RWorkspace: none) */
    ...
    iwrk = itau;
    i__1 = *lwork - iwrk + 1;
    khseqr_("S", jobvs, n, &ilo, &ihi, &a[a_offset], lda, &w[1], &vs[
...
/*     Sort eigenvalues if desired */
    ...
    if (wantst && *info == 0) {
	if (scalea) {
	    klascl_("G", &c__0, &c__0, &cscale, &anrm, n, &c__1, &w[1], n, &
		    ierr);
	}
	i__1 = *n;
...
/*        (RWorkspace: none) */
	...
	i__1 = *lwork - iwrk + 1;
	ktrsen_(sense, jobvs, &bwork[1], n, &a[a_offset], lda, &vs[vs_offset],
...
/*        (RWorkspace: need N) */
	...
	kgebak_("P", "R", n, &ilo, &ihi, &rwork[ibal], n, &vs[vs_offset], 
		ldvs, &ierr);
    }
...
/*        Undo scaling for the Schur form of A */
	...
	klascl_("U", &c__0, &c__0, &cscale, &anrm, n, n, &a[a_offset], lda, &
		ierr);
	i__1 = *lda + 1;
	kcopy_(n, &a[a_offset], &i__1, &w[1], &c__1);
