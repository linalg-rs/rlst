...
/* > */
/*  ===================================================================== */
void  qppsv_(char *uplo, integer *n, integer *nrhs, quadreal 
	*ap, quadreal *b, integer *ldb, integer *info)
{
    ...
    extern void  xerbla_(char *, integer *), qpptrf_(
	    char *, integer *, quadreal *, integer *), qpptrs_(char 
...
/*        Solve the system A*X = B, overwriting B with X. */
	...
	qpptrs_(uplo, n, nrhs, &ap[1], &b[b_offset], ldb, info);
