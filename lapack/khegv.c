...
/*  ===================================================================== */
void  khegv_(integer *itype, char *jobz, char *uplo, integer *
	 ...
	 integer *info)
{
    ...
    extern void  kheev_(char *, char *, integer *, 
...
/*     Transform problem to standard eigenvalue problem and solve. */
    ...
    kheev_(jobz, uplo, n, &a[a_offset], lda, &w[1], &work[1], lwork, &rwork[1]
	    , info);
...
/*           backtransform eigenvectors: x = inv(L)**H *y or inv(U)*y */
		...
		*(unsigned char *)trans = 'C';
	    ...
	    ktrsm_("Left", uplo, trans, "Non-unit", n, &neig, &c_b1, &b[
...
/*           backtransform eigenvectors: x = L*y or U**H *y */
		...
		*(unsigned char *)trans = 'N';
	    ...
	    ktrmm_("Left", uplo, trans, "Non-unit", n, &neig, &c_b1, &b[
		    b_offset], ldb, &a[a_offset], lda);
	}
    }
