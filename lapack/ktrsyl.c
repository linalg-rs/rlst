...
/*  ===================================================================== */
void  ktrsyl_(char *trana, char *tranb, integer *isgn, integer 
	*m, integer *n, halfcomplex *a, integer *lda, halfcomplex *b, 
	integer *ldb, halfcomplex *c__, integer *ldc, halfreal *scale, 
	integer *info)
{
    ...
    halfreal da11;
    halfcomplex vec;
    halfreal dum[1], eps, sgn, smin;
    halfcomplex suml, sumr;
    extern logical lsame_(char *, char *);
    extern /* Double Complex */ VOID whotc_(halfcomplex *, integer *, 
	    halfcomplex *, integer *, halfcomplex *, integer *), whotu_(
...
/*     Set constants to control overflow */
    ...
    bignum = 1. / smlnum;
/* Computing MAX */
    d__1 = smlnum, d__2 = eps * klange_("M", m, m, &a[a_offset], lda, dum), d__1 = f2cmax(d__1,d__2), d__2 = eps * klange_("M", n, n, 
	    &b[b_offset], ldb, dum);
...
/* Computing MIN */
		i__4 = k + 1;
		whotu_(&z__1, &i__2, &a[k + f2cmin(i__3,*m) * a_dim1], lda, &c__[
			f2cmin(i__4,*m) + l * c_dim1], &c__1);
		suml.r = z__1.r, suml.i = z__1.i;
		i__2 = l - 1;
		whotu_(&z__1, &i__2, &c__[k + c_dim1], ldc, &b[l * b_dim1 + 1]
			, &c__1);
		...
		z__2.r = vec.r * z__3.r - vec.i * z__3.i, z__2.i = vec.r * 
			z__3.i + vec.i * z__3.r;
		kladiv_(&z__1, &z__2, &a11);
		x11.r = z__1.r, x11.i = z__1.i;

		if (scaloc != 1.) {
		    i__2 = *n;
		    for (j = 1; j <= i__2; ++j) {
			whscal_(m, &scaloc, &c__[j * c_dim1 + 1], &c__1);
/* L10: */
		    }
		    *scale *= scaloc;
		}
...
/*                   I=1                           J=1 */
	...
	for (l = 1; l <= i__1; ++l) {
		...
		i__3 = k - 1;
		whotc_(&z__1, &i__3, &a[k * a_dim1 + 1], &c__1, &c__[l * 
			c_dim1 + 1], &c__1);
		suml.r = z__1.r, suml.i = z__1.i;
		i__3 = l - 1;
		whotu_(&z__1, &i__3, &c__[k + c_dim1], ldc, &b[l * b_dim1 + 1]
			, &c__1);
		sumr.r = z__1.r, sumr.i = z__1.i;
		i__3 = k + l * c_dim1;
		z__3.r = sgn * sumr.r, z__3.i = sgn * sumr.i;
...
/*                          J=L+1 */
	...
	for (l = *n; l >= 1; --l) {
		...
		i__2 = k - 1;
		whotc_(&z__1, &i__2, &a[k * a_dim1 + 1], &c__1, &c__[l * 
			c_dim1 + 1], &c__1);
		suml.r = z__1.r, suml.i = z__1.i;
		i__2 = *n - l;
/* Computing MIN */
...
/* Computing MIN */
		i__4 = l + 1;
		whotc_(&z__1, &i__2, &c__[k + f2cmin(i__3,*n) * c_dim1], ldc, &b[
...
/* Computing MIN */
		i__3 = k + 1;
		whotu_(&z__1, &i__1, &a[k + f2cmin(i__2,*m) * a_dim1], lda, &c__[
...
/* Computing MIN */
		i__3 = l + 1;
		whotc_(&z__1, &i__1, &c__[k + f2cmin(i__2,*n) * c_dim1], ldc, &b[
