...
/* > \verbatim */
/* > */
/* > DGEQRT computes a blocked QR factorization of a doublereal M-by-N matrix A */
...
/* > */
/*  ===================================================================== */
void  qgeqrt_(integer *m, integer *n, integer *nb, quadreal *
	a, integer *lda, quadreal *t, integer *ldt, quadreal *work, 
	integer *info)
{
    ...
    extern void  qlarfb_(char *, char *, char *, char *, 
	    ...
	    integer *), qgeqrt2_(integer *, integer *, quadreal *, 
	    integer *, quadreal *, integer *, integer *), qgeqrt3_(integer *
...
/*     Compute the QR factorization of the current block A(I:M,I:I+IB-1) */
	...
	if (TRUE_) {
	    i__3 = *m - i__ + 1;
	    qgeqrt3_(&i__3, &ib, &a[i__ + i__ * a_dim1], lda, &t[i__ * t_dim1 
		    + 1], ldt, &iinfo);
	} else {
	    i__3 = *m - i__ + 1;
	    qgeqrt2_(&i__3, &ib, &a[i__ + i__ * a_dim1], lda, &t[i__ * t_dim1 
		    + 1], ldt, &iinfo);
	}
	if (i__ + ib <= *n) {
...
/*     Update by applying H**T to A(I:M,I+IB:N) from the left */
	    ...
	    i__4 = *n - i__ - ib + 1;
	    i__5 = *n - i__ - ib + 1;
	    qlarfb_("L", "T", "F", "C", &i__3, &i__4, &ib, &a[i__ + i__ * 
