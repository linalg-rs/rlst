...
/*  ===================================================================== */
void  kgbtrs_(char *trans, integer *n, integer *kl, integer *
	ku, integer *nrhs, halfcomplex *ab, integer *ldab, integer *ipiv, 
	halfcomplex *b, integer *ldb, integer *info)
{
    ...
    extern void  kgemv_(char *, integer *, integer *, 
	    ...
	    kgeru_(integer *, integer *, halfcomplex *, halfcomplex *, 
	    integer *, halfcomplex *, integer *, halfcomplex *, integer *)
	    , kswap_(integer *, halfcomplex *, integer *, halfcomplex *, 
	    integer *), ktbsv_(char *, char *, char *, integer *, integer *, 
	    halfcomplex *, integer *, halfcomplex *, integer *), xerbla_(char *, integer *), klacgv_(
...
/* Computing MIN */
		...
		l = ipiv[j];
		if (l != j) {
		    kswap_(nrhs, &b[l + b_dim1], ldb, &b[j + b_dim1], ldb);
		}
		z__1.r = -1., z__1.i = -0.;
		kgeru_(&lm, nrhs, &z__1, &ab[kd + 1 + j * ab_dim1], &c__1, &b[
...
/*           Solve U*X = B, overwriting B with X. */
	    ...
	    i__2 = *kl + *ku;
	    ktbsv_("Upper", "No transpose", "Non-unit", n, &i__2, &ab[
...
/*           Solve U**T * X = B, overwriting B with X. */
	    ...
	    i__2 = *kl + *ku;
	    ktbsv_("Upper", "Transpose", "Non-unit", n, &i__2, &ab[ab_offset],
...
/* Computing MIN */
		...
		lm = f2cmin(i__1,i__2);
		z__1.r = -1., z__1.i = -0.;
		kgemv_("Transpose", &lm, nrhs, &z__1, &b[j + 1 + b_dim1], ldb,
...
/*           Solve U**H * X = B, overwriting B with X. */
	    ...
	    i__2 = *kl + *ku;
	    ktbsv_("Upper", "Conjugate transpose", "Non-unit", n, &i__2, &ab[
		    ab_offset], ldab, &b[i__ * b_dim1 + 1], &c__1);
/* L50: */
	}
...
/* Computing MIN */
		i__1 = *kl, i__2 = *n - j;
		lm = f2cmin(i__1,i__2);
		klacgv_(nrhs, &b[j + b_dim1], ldb);
		z__1.r = -1., z__1.i = -0.;
		kgemv_("Conjugate transpose", &lm, nrhs, &z__1, &b[j + 1 + 
