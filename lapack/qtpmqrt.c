...
/* > */
/*  ===================================================================== */
void  qtpmqrt_(char *side, char *trans, integer *m, integer *n,
	 integer *k, integer *l, integer *nb, quadreal *v, integer *ldv, 
	quadreal *t, integer *ldt, quadreal *a, integer *lda, quadreal *
	b, integer *ldb, quadreal *work, integer *info)
{
    ...
    logical right;
    extern void  xerbla_(char *, integer *), qtprfb_(
...
/* Computing MIN */
	    ...
	    qtprfb_("L", "T", "F", "C", &mb, n, &ib, &lb, &v[i__ * v_dim1 + 1]
...
/* Computing MIN */
	    ...
	    qtprfb_("R", "N", "F", "C", m, &mb, &ib, &lb, &v[i__ * v_dim1 + 1]
...
/* Computing MIN */
	    ...
	    qtprfb_("L", "N", "F", "C", &mb, n, &ib, &lb, &v[i__ * v_dim1 + 1]
		    , ldv, &t[i__ * t_dim1 + 1], ldt, &a[i__ + a_dim1], lda, &
		    b[b_offset], ldb, &work[1], &ib);
	}
...
/* Computing MIN */
	    ...
	    qtprfb_("R", "T", "F", "C", m, &mb, &ib, &lb, &v[i__ * v_dim1 + 1]
		    , ldv, &t[i__ * t_dim1 + 1], ldt, &a[i__ * a_dim1 + 1], 
		    lda, &b[b_offset], ldb, &work[1], m);
	}
