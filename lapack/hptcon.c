...
/* > 1-norm) of a doublereal symmetric positive definite tridiagonal matrix */
...
/* > */
/*  ===================================================================== */
void  hptcon_(integer *n, halfreal *d__, halfreal *e, 
	halfreal *anorm, halfreal *rcond, halfreal *work, integer *info)
{
