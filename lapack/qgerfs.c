...
/*  ===================================================================== */
void  qgerfs_(char *trans, integer *n, integer *nrhs, 
	quadreal *a, integer *lda, quadreal *af, integer *ldaf, integer *
	ipiv, quadreal *b, integer *ldb, quadreal *x, integer *ldx, 
	...
	integer *info)
{
    ...
    quadreal safmin;
    extern void  xerbla_(char *, integer *), qgetrs_(
	    char *, integer *, integer *, quadreal *, integer *, integer *, 
...
/*        where op(A) = A, A**T, or A**H, depending on TRANS. */
	...
	qgemv_(trans, n, n, &c_b15, &a[a_offset], lda, &x[j * x_dim1 + 1], &
...
/*           Update solution and try again. */
	    ...
	    qgetrs_(trans, n, &c__1, &af[af_offset], ldaf, &ipiv[1], &work[*n 
		    + 1], n, info);
...
/*              Multiply by diag(W)*inv(op(A)**T). */
		...
		qgetrs_(transt, n, &c__1, &af[af_offset], ldaf, &ipiv[1], &
			work[*n + 1], n, info);
		i__2 = *n;
		for (i__ = 1; i__ <= i__2; ++i__) {
...
/* L120: */
		...
		qgetrs_(trans, n, &c__1, &af[af_offset], ldaf, &ipiv[1], &
			work[*n + 1], n, info);
	    }
	    goto L100;
	}
