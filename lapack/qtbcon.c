...
/*  ===================================================================== */
void  qtbcon_(char *norm, char *uplo, char *diag, integer *n, 
	integer *kd, quadreal *ab, integer *ldab, quadreal *rcond, 
...
/*     Compute the norm of the triangular matrix A. */
    ...
    anorm = qlantb_(norm, uplo, diag, n, kd, &ab[ab_offset], ldab, &work[1]);
...
/*              Multiply by inv(A). */
		...
		qlatbs_(uplo, "No transpose", diag, normin, n, kd, &ab[
...
/*              Multiply by inv(A**T). */
		...
		qlatbs_(uplo, "Transpose", diag, normin, n, kd, &ab[ab_offset]
