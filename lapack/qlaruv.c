...
/* > \brief \b DLARUV returns a vector of n random doublereal numbers from a uniform distribution. */
...
/* > \verbatim */
/* > */
/* > DLARUV returns a vector of n random doublereal numbers from a uniform (0,1) */
/* > distribution (n <= 128). */
/* > */
...
/* > */
/*  ===================================================================== */
void  qlaruv_(integer *iseed, integer *n, quadreal *x)
{
    /* Initialized data */
...
/*        Convert 48-bit integer to a doublereal number in the interval (0,1) */

	x[i__] = ((quadreal) it1 + ((quadreal) it2 + ((quadreal) it3 + (
		quadreal) it4 * 2.44140625e-4) * 2.44140625e-4) * 
		2.44140625e-4) * 2.44140625e-4;

	if (x[i__] == 1.) {
/*           If a doublereal number has n bits of precision, and the first */
