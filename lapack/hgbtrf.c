...
/* > \verbatim */
/* > */
/* > DGBTRF computes an LU factorization of a doublereal m-by-n band matrix A */
...
/* > */
/*  ===================================================================== */
void  hgbtrf_(integer *m, integer *n, integer *kl, integer *ku,
	 halfreal *ab, integer *ldab, integer *ipiv, integer *info)
{
    ...
    extern void  hscal_(integer *, halfreal *, halfreal *, 
	    ...
	    halfreal *, halfreal *, integer *), hcopy_(
	    integer *, halfreal *, integer *, halfreal *, integer *), 
	    hswap_(integer *, halfreal *, integer *, halfreal *, integer *
	    );
    halfreal work13[4160]	/* was [65][64] */, work31[4160]	/* 
	    was [65][64] */;
    extern void  htrsm_(char *, char *, char *, char *, 
	    integer *, integer *, halfreal *, halfreal *, integer *, 
	    halfreal *, integer *), hgbtf2_(
	    integer *, integer *, integer *, integer *, halfreal *, integer 
	    *, integer *, integer *);
    extern integer ihamax_(integer *, halfreal *, integer *);
    extern void  xerbla_(char *, integer *);
    extern integer ilaenv_(integer *, char *, char *, integer *, integer *, 
	    integer *, integer *, ftnlen, ftnlen);
    extern void  hlaswp_(integer *, halfreal *, integer *, 
...
/*        Use unblocked code */
	...
	hgbtf2_(m, n, kl, ku, &ab[ab_offset], ldab, &ipiv[1], info);
    } else {
...
/* Computing MIN */
		...
		km = f2cmin(i__4,i__5);
		i__4 = km + 1;
		jp = ihamax_(&i__4, &ab[kv + 1 + jj * ab_dim1], &c__1);
		ipiv[jj] = jp + jj - j;
...
/*                    Apply interchange to columns J to J+JB-1 */
			...
			if (jp + jj - 1 < j + *kl) {
			    ...
			    i__4 = *ldab - 1;
			    i__5 = *ldab - 1;
			    hswap_(&jb, &ab[kv + 1 + jj - j + j * ab_dim1], &
...
/*                       which are stored in the work array WORK31 */
			    ...
			    i__4 = jj - j;
			    i__5 = *ldab - 1;
			    hswap_(&i__4, &ab[kv + 1 + jj - j + j * ab_dim1], 
				    &i__5, &work31[jp + jj - j - *kl - 1], &
				    c__65);
			    i__4 = j + jb - jj;
			    i__5 = *ldab - 1;
			    i__6 = *ldab - 1;
			    hswap_(&i__4, &ab[kv + 1 + jj * ab_dim1], &i__5, &
...
/*                 Compute multipliers */
		    ...
		    hscal_(&km, &d__1, &ab[kv + 2 + jj * ab_dim1], &c__1);
...
/* Computing MIN */
			...
			i__5 = *ldab - 1;
			i__6 = *ldab - 1;
			hger_(&km, &i__4, &c_b18, &ab[kv + 2 + jj * ab_dim1], 
...
/* Computing MIN */
		...
		nw = f2cmin(i__4,i3);
		if (nw > 0) {
		    hcopy_(&nw, &ab[kv + *kl + 1 - jj + j + jj * ab_dim1], &
...
/*              A32. */
		...
		i__3 = *ldab - 1;
		hlaswp_(&j2, &ab[kv + 1 - jb + (j + jb) * ab_dim1], &i__3, &
			c__1, &jb, &ipiv[j], &c__1);
...
/*                 Update A12 */
		    ...
		    i__3 = *ldab - 1;
		    i__4 = *ldab - 1;
		    htrsm_("Left", "Lower", "No transpose", "Unit", &jb, &j2, 
...
/*                    Update A22 */
			...
			i__4 = *ldab - 1;
			i__5 = *ldab - 1;
			hgemm_("No transpose", "No transpose", &i2, &j2, &jb, 
...
/*                    Update A32 */
			...
			i__3 = *ldab - 1;
			i__4 = *ldab - 1;
			hgemm_("No transpose", "No transpose", &i3, &j2, &jb, 
...
/*                 Update A13 in the work array */
		    ...
		    i__3 = *ldab - 1;
		    htrsm_("Left", "Lower", "No transpose", "Unit", &jb, &j3, 
...
/*                    Update A23 */
			...
			i__3 = *ldab - 1;
			i__4 = *ldab - 1;
			hgemm_("No transpose", "No transpose", &i2, &j3, &jb, 
				&c_b18, &ab[kv + 1 + jb + j * ab_dim1], &i__3,
...
/*                    Update A33 */
			...
			i__3 = *ldab - 1;
			hgemm_("No transpose", "No transpose", &i3, &j3, &jb, 
...
/* Computing MIN */
		...
		nw = f2cmin(i__4,i__5);
		if (nw > 0) {
		    hcopy_(&nw, &work31[(jj - j + 1) * 65 - 65], &c__1, &ab[
