...
/*  ===================================================================== */
void  hsytri2_(char *uplo, integer *n, halfreal *a, integer *
	lda, integer *ipiv, halfreal *work, integer *lwork, integer *info)
{
    ...
    /* Local variables */
    extern void  hsytri2x_(char *, integer *, halfreal *, 
    ...
    extern void  hsytri_(char *, integer *, halfreal *, 
...
/*     Quick return if possible */
    ...
    if (nbmax >= *n) {
	hsytri_(uplo, n, &a[a_offset], lda, &ipiv[1], &work[1], info);
    } else {
	hsytri2x_(uplo, n, &a[a_offset], lda, &ipiv[1], &work[1], &nbmax, 
		info);
    }
    return;
