...
/*  ===================================================================== */
void  hlalsa_(integer *icompq, integer *smlsiz, integer *n, 
	integer *nrhs, halfreal *b, integer *ldb, halfreal *bx, integer *
	ldbx, halfreal *u, integer *ldu, halfreal *vt, integer *k, 
	halfreal *difl, halfreal *difr, halfreal *z__, halfreal *
	poles, integer *givptr, integer *givcol, integer *ldgcol, integer *
	perm, halfreal *givnum, halfreal *c__, halfreal *s, halfreal *
...
/*        NRF: starting row of the right  subproblem */
	...
	nlf = ic - nl;
	nrf = ic + 1;
	hgemm_("T", "N", &nl, nrhs, &nl, &c_b7, &u[nlf + u_dim1], ldu, &b[nlf 
		+ b_dim1], ldb, &c_b8, &bx[nlf + bx_dim1], ldbx);
	hgemm_("T", "N", &nr, nrhs, &nr, &c_b7, &u[nrf + u_dim1], ldu, &b[nrf 
...
/*     in the bidiagonal matrix to BX. */
	...
	hcopy_(nrhs, &b[ic + b_dim1], ldb, &bx[ic + bx_dim1], ldbx);
/* L20: */
    }
...
/*        the current level LVL */
	...
	for (i__ = lf; i__ <= i__1; ++i__) {
	    ...
	    nrf = ic + 1;
	    --j;
	    hlals0_(icompq, &nl, &nr, &sqre, nrhs, &bx[nlf + bx_dim1], ldbx, &
...
/*        the current level LVL. */
	...
	for (i__ = ll; i__ >= i__2; --i__) {
	    ...
	    ++j;
	    hlals0_(icompq, &nl, &nr, &sqre, nrhs, &b[nlf + b_dim1], ldb, &bx[
...
/*     matrices are in explicit form. Apply them back. */
	...
	nlf = ic - nl;
	nrf = ic + 1;
	hgemm_("T", "N", &nlp1, nrhs, &nlp1, &c_b7, &vt[nlf + vt_dim1], ldu, &
		b[nlf + b_dim1], ldb, &c_b8, &bx[nlf + bx_dim1], ldbx);
	hgemm_("T", "N", &nrp1, nrhs, &nrp1, &c_b7, &vt[nrf + vt_dim1], ldu, &
