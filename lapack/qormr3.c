...
/* > */
/*  ===================================================================== */
void  qormr3_(char *side, char *trans, integer *m, integer *n, 
	integer *k, integer *l, quadreal *a, integer *lda, quadreal *tau, 
	quadreal *c__, integer *ldc, quadreal *work, integer *info)
{
    ...
    extern void  qlarz_(char *, integer *, integer *, integer *
...
/*        Apply H(i) or H(i)**T */
	...
	qlarz_(side, &mi, &ni, l, &a[i__ + ja * a_dim1], lda, &tau[i__], &c__[
