...
/* > \verbatim */
/* > */
/* > DSPSV computes the solution to a doublereal system of linear equations */
/* >    A * X = B, */
...
/* > */
/*  ===================================================================== */
void  hspsv_(char *uplo, integer *n, integer *nrhs, halfreal 
	*ap, integer *ipiv, halfreal *b, integer *ldb, integer *info)
{
    ...
    extern void  xerbla_(char *, integer *), hsptrf_(
	    char *, integer *, halfreal *, integer *, integer *), 
	    hsptrs_(char *, integer *, integer *, halfreal *, integer *, 
...
/*     Compute the factorization A = U*D*U**T or A = L*D*L**T. */
    ...
    hsptrf_(uplo, n, &ap[1], &ipiv[1], info);
    if (*info == 0) {

/*        Solve the system A*X = B, overwriting B with X. */

	hsptrs_(uplo, n, nrhs, &ap[1], &ipiv[1], &b[b_offset], ldb, info);
