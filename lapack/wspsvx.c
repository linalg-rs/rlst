...
/* > */
/*  ===================================================================== */
void  wspsvx_(char *fact, char *uplo, integer *n, integer *
	nrhs, quadcomplex *ap, quadcomplex *afp, integer *ipiv, 
	...
	work, quadreal *rwork, integer *info)
{
    ...
    logical nofact;
    extern void  xerbla_(char *, integer *), wlacpy_(
	    char *, integer *, integer *, quadcomplex *, integer *, 
	    quadcomplex *, integer *);
    extern quadreal wlansp_(char *, char *, integer *, quadcomplex *, 
	    quadreal *);
    extern void  wspcon_(char *, integer *, quadcomplex *, 
	    integer *, quadreal *, quadreal *, quadcomplex *, integer *), wsprfs_(char *, integer *, integer *, quadcomplex *, 
	    quadcomplex *, integer *, quadcomplex *, integer *, 
	    quadcomplex *, integer *, quadreal *, quadreal *, 
	    quadcomplex *, quadreal *, integer *), wsptrf_(char *,
	     integer *, quadcomplex *, integer *, integer *), 
	    wsptrs_(char *, integer *, integer *, quadcomplex *, integer *, 
...
/*        Compute the factorization A = U*D*U**T or A = L*D*L**T. */
	...
	wsptrf_(uplo, n, &afp[1], &ipiv[1], info);
...
/*     Compute the norm of the matrix A. */
    ...
    anorm = wlansp_("I", uplo, n, &ap[1], &rwork[1]);

/*     Compute the reciprocal of the condition number of A. */

    wspcon_(uplo, n, &afp[1], &ipiv[1], &anorm, rcond, &work[1], info);

/*     Compute the solution vectors X. */

    wlacpy_("Full", n, nrhs, &b[b_offset], ldb, &x[x_offset], ldx);
    wsptrs_(uplo, n, nrhs, &afp[1], &ipiv[1], &x[x_offset], ldx, info);

/*     Use iterative refinement to improve the computed solutions and */
/*     compute error bounds and backward error estimates for them. */

    wsprfs_(uplo, n, nrhs, &ap[1], &afp[1], &ipiv[1], &b[b_offset], ldb, &x[
