...
/* > */
/*  ===================================================================== */
void  qlaev2_(quadreal *a, quadreal *b, quadreal *c__, 
	quadreal *rt1, quadreal *rt2, quadreal *cs1, quadreal *sn1)
{
    /* System generated locals */
    quadreal d__1;

    /* Local variables */
    quadreal ab, df, cs, ct, tb, sm, tn, rt, adf, acs;
    integer sgn1, sgn2;
    quadreal acmn, acmx;
...
/* Computing 2nd power */
	d__1 = ab / adf;
	rt = adf * M(sqrt)(d__1 * d__1 + 1.);
    } else if (adf < ab) {
/* Computing 2nd power */
	d__1 = adf / ab;
	rt = ab * M(sqrt)(d__1 * d__1 + 1.);
    } else {
