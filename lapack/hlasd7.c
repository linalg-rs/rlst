...
/* > */
/*  ===================================================================== */
void  hlasd7_(integer *icompq, integer *nl, integer *nr, 
	integer *sqre, integer *k, halfreal *d__, halfreal *z__, 
	halfreal *zw, halfreal *vf, halfreal *vfw, halfreal *vl, 
	halfreal *vlw, halfreal *alpha, halfreal *beta, halfreal *
	dsigma, integer *idx, integer *idxp, integer *idxq, integer *perm, 
	integer *givptr, integer *givcol, integer *ldgcol, halfreal *givnum,
	 integer *ldgnum, halfreal *c__, halfreal *s, integer *info)
{
...
/*           Record the appropriate Givens rotation */
	    ...
	    hrot_(&c__1, &vf[jprev], &c__1, &vf[j], &c__1, c__, s);
	    hrot_(&c__1, &vl[jprev], &c__1, &vl[j], &c__1, c__, s);
	    --k2;
	    idxp[k2] = jprev;
	    jprev = j;
	} else {
...
/*     VL(M). */
	...
	hrot_(&c__1, &vf[m], &c__1, &vf[1], &c__1, c__, s);
	hrot_(&c__1, &vl[m], &c__1, &vl[1], &c__1, c__, s);
    } else {
	if (abs(z1) <= tol) {
	    z__[1] = tol;
	} else {
...
/*     Restore Z, VF, and VL. */
    ...
    i__1 = *k - 1;
    hcopy_(&i__1, &zw[2], &c__1, &z__[2], &c__1);
    i__1 = n - 1;
    hcopy_(&i__1, &vfw[2], &c__1, &vf[2], &c__1);
    i__1 = n - 1;
    hcopy_(&i__1, &vlw[2], &c__1, &vl[2], &c__1);
