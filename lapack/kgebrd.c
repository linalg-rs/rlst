...
/* > */
/*  ===================================================================== */
void  kgebrd_(integer *m, integer *n, halfcomplex *a, 
	integer *lda, halfreal *d__, halfreal *e, halfcomplex *tauq, 
	halfcomplex *taup, halfcomplex *work, integer *lwork, integer *
	info)
{
...
/*        part of the matrix */
	...
	i__3 = *m - i__ + 1;
	i__4 = *n - i__ + 1;
	klabrd_(&i__3, &i__4, &nb, &a[i__ + i__ * a_dim1], lda, &d__[i__], &e[
...
/*        an update of the form  A := A - V*Y**H - X*U**H */
	...
	i__4 = *n - i__ - nb + 1;
	z__1.r = -1., z__1.i = -0.;
	kgemm_("No transpose", "Conjugate transpose", &i__3, &i__4, &nb, &
	...
	i__4 = *n - i__ - nb + 1;
	z__1.r = -1., z__1.i = -0.;
	kgemm_("No transpose", "No transpose", &i__3, &i__4, &nb, &z__1, &
...
/*     Use unblocked code to reduce the remainder of the matrix */
    ...
    i__2 = *m - i__ + 1;
    i__1 = *n - i__ + 1;
    kgebd2_(&i__2, &i__1, &a[i__ + i__ * a_dim1], lda, &d__[i__], &e[i__], &
	    tauq[i__], &taup[i__], &work[1], &iinfo);
    work[1].r = (halfreal) ws, work[1].i = 0.;
    return;
