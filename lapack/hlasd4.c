...
/* > */
/*  ===================================================================== */
void  hlasd4_(integer *n, integer *i__, halfreal *d__, 
	halfreal *z__, halfreal *delta, halfreal *rho, halfreal *
	sigma, halfreal *work, integer *info)
{
    ...
    halfreal dw, zz[3];
    integer ip1;
    halfreal sq2, eta, phi, eps, tau, psi;
    integer iim1, iip1;
    halfreal tau2, dphi, sglb, dpsi, sgub;
    integer iter;
    halfreal temp, prew, temp1, temp2, dtiim, delsq, dtiip;
    integer niter;
    halfreal dtisq;
    logical swtch;
    halfreal dtnsq;
    extern void  hlaed6_(integer *, logical *, halfreal *, 
	    halfreal *, halfreal *, halfreal *, halfreal *, integer *)
	    , hlasd5_(integer *, halfreal *, halfreal *, halfreal *, 
	    halfreal *, halfreal *, halfreal *);
    halfreal delsq2, dtnsq1;
    logical swtch3;
    extern halfreal hlamch_(char *);
    logical orgati;
    halfreal erretm, dtipsq, rhoinv;
    logical geomavg;
...
/*        Presumably, I=1 upon entry */
	...
	*sigma = M(sqrt)(d__[1] * d__[1] + *rho * z__[1] * z__[1]);
    ...
    if (*n == 2) {
	hlasd5_(i__, &d__[1], &z__[1], &delta[1], rho, sigma, &work[1]);
	return;
    }
...
/*           Interpolation using THREE most relevant poles */
	    ...
	    dd[2] = dtiip;
	    hlaed6_(&niter, &orgati, &c__, dd, zz, &w, &eta, info);
