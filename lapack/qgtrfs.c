...
/*  ===================================================================== */
void  qgtrfs_(char *trans, integer *n, integer *nrhs, 
	quadreal *dl, quadreal *d__, quadreal *du, quadreal *dlf, 
	quadreal *df, quadreal *duf, quadreal *du2, integer *ipiv, 
	...
	info)
{
    ...
    extern void  qlagtm_(char *, integer *, integer *, 
...
/*        where op(A) = A, A**T, or A**H, depending on TRANS. */
	...
	qlagtm_(trans, n, &c__1, &c_b18, &dl[1], &d__[1], &du[1], &x[j * 
...
/*           Update solution and try again. */
	    ...
	    qgttrs_(trans, n, &c__1, &dlf[1], &df[1], &duf[1], &du2[1], &ipiv[
		    1], &work[*n + 1], n, info);
	    qaxpy_(n, &c_b19, &work[*n + 1], &c__1, &x[j * x_dim1 + 1], &c__1)
		    ;
	    lstres = berr[j];
	    ++count;
	    goto L20;
