...
/*  ===================================================================== */
void  qorgrq_(integer *m, integer *n, integer *k, quadreal *
	a, integer *lda, quadreal *tau, quadreal *work, integer *lwork, 
	integer *info)
{
    ...
    extern void  qorgr2_(integer *, integer *, integer *, 
	    quadreal *, integer *, quadreal *, quadreal *, integer *), 
	    qlarfb_(char *, char *, char *, char *, integer *, integer *, 
	    integer *, quadreal *, integer *, quadreal *, integer *, 
	    quadreal *, integer *, quadreal *, integer *), qlarft_(char *, char *, integer *, integer *, 
	    quadreal *, integer *, quadreal *, quadreal *, integer *), xerbla_(char *, integer *);
...
/*     Use unblocked code for the first or only block. */
    ...
    i__2 = *n - kk;
    i__3 = *k - kk;
    qorgr2_(&i__1, &i__2, &i__3, &a[a_offset], lda, &tau[1], &work[1], &iinfo)
	    ;
...
/*              H = H(i+ib-1) . . . H(i+1) H(i) */
		...
		i__3 = *n - *k + i__ + ib - 1;
		qlarft_("Backward", "Rowwise", &i__3, &ib, &a[ii + a_dim1], 
...
/*           Apply H**T to columns 1:n-k+i+ib-1 of current block */
	    ...
	    i__3 = *n - *k + i__ + ib - 1;
	    qorgr2_(&ib, &i__3, &ib, &a[ii + a_dim1], lda, &tau[i__], &work[1]
		    , &iinfo);
