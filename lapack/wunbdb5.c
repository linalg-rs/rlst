...
/*  ===================================================================== */
void  wunbdb5_(integer *m1, integer *m2, integer *n, 
	...
	quadcomplex *work, integer *lwork, integer *info)
{
    ...
    extern void  xerbla_(char *, integer *), wunbdb6_(
...
/*     Project X onto the orthogonal complement of Q */
    ...
    wunbdb6_(m1, m2, n, &x1[1], incx1, &x2[1], incx2, &q1[q1_offset], ldq1, &
	    q2[q2_offset], ldq2, &work[1], lwork, &childinfo);

/*     If the projection is nonzero, then return */

    d__1 = qwnrm2_(m1, &x1[1], incx1);
    d__2 = qwnrm2_(m2, &x2[1], incx2);
    if (d__1 != 0. || d__2 != 0.) {
	return;
    }
...
/*     when a nonzero projection is found */
	...
	wunbdb6_(m1, m2, n, &x1[1], incx1, &x2[1], incx2, &q1[q1_offset], 
