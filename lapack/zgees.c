...
/*  ===================================================================== */
void  zgees_(char *jobvs, char *sort, L_fp select, integer *n, 
	 ...
	 doublereal *rwork, logical *bwork, integer *info)
{
    ...
    doublereal cscale;
    extern void  zgebak_(char *, char *, integer *, integer *, 
    ...
    extern doublereal zlange_(char *, integer *, integer *, doublecomplex *, 
	    integer *, doublereal *);
    doublereal bignum;
    extern void  zgehrd_(integer *, integer *, integer *, 
    ...
    doublereal smlnum;
    extern void  zhseqr_(char *, char *, integer *, integer *, 
	    integer *, doublecomplex *, integer *, doublecomplex *, 
	    doublecomplex *, integer *, doublecomplex *, integer *, integer *);
    integer hswork;
    extern void  zunghr_(integer *, integer *, integer *, 
	    doublecomplex *, integer *, doublecomplex *, doublecomplex *, 
	    integer *, integer *);
    logical wantst, lquery, wantvs;
    extern void  ztrsen_(char *, char *, logical *, integer *, 
