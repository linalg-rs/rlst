...
static halfreal c_b16 = -.5;
static halfreal c_b19 = -1.;
static halfreal c_b52 = .5;
...
/* > \verbatim */
/* > */
/* > DSYGST reduces a doublereal symmetric-definite generalized eigenproblem */
/* > to standard form. */
/* > */
...
/*  ===================================================================== */
void  hsygst_(integer *itype, char *uplo, integer *n, 
	halfreal *a, integer *lda, halfreal *b, integer *ldb, integer *
	info)
{
    ...
    extern void  htrsm_(char *, char *, char *, char *, 
	    integer *, integer *, halfreal *, halfreal *, integer *, 
	    halfreal *, integer *), hsygs2_(
	    integer *, char *, integer *, halfreal *, integer *, halfreal 
	    *, integer *, integer *), hsyr2k_(char *, char *, integer 
...
/*        Use unblocked code */
	...
	hsygs2_(itype, uplo, n, &a[a_offset], lda, &b[b_offset], ldb, info);
    } else {
...
/*                 Update the upper triangle of A(k:n,k:n) */
		    ...
		    hsygs2_(itype, uplo, &kb, &a[k + k * a_dim1], lda, &b[k + 
			    k * b_dim1], ldb, info);
		    if (k + kb <= *n) {
			i__3 = *n - k - kb + 1;
			htrsm_("Left", uplo, "Transpose", "Non-unit", &kb, &
				i__3, &c_b14, &b[k + k * b_dim1], ldb, &a[k + 
				(k + kb) * a_dim1], lda);
			i__3 = *n - k - kb + 1;
			hsymm_("Left", uplo, &kb, &i__3, &c_b16, &a[k + k * 
				a_dim1], lda, &b[k + (k + kb) * b_dim1], ldb, 
				&c_b14, &a[k + (k + kb) * a_dim1], lda);
			i__3 = *n - k - kb + 1;
			hsyr2k_(uplo, "Transpose", &i__3, &kb, &c_b19, &a[k + 
			...
			hsymm_("Left", uplo, &kb, &i__3, &c_b16, &a[k + k * 
				...
				&c_b14, &a[k + (k + kb) * a_dim1], lda);
			i__3 = *n - k - kb + 1;
			htrsm_("Right", uplo, "No transpose", "Non-unit", &kb,
...
/*                 Update the lower triangle of A(k:n,k:n) */
		    ...
		    if (k + kb <= *n) {
			i__3 = *n - k - kb + 1;
			htrsm_("Right", uplo, "Transpose", "Non-unit", &i__3, 
				&kb, &c_b14, &b[k + k * b_dim1], ldb, &a[k + 
				kb + k * a_dim1], lda);
			i__3 = *n - k - kb + 1;
			hsymm_("Right", uplo, &i__3, &kb, &c_b16, &a[k + k * 
				a_dim1], lda, &b[k + kb + k * b_dim1], ldb, &
				c_b14, &a[k + kb + k * a_dim1], lda);
			i__3 = *n - k - kb + 1;
			hsyr2k_(uplo, "No transpose", &i__3, &kb, &c_b19, &a[
			...
			hsymm_("Right", uplo, &i__3, &kb, &c_b16, &a[k + k * 
				...
				c_b14, &a[k + kb + k * a_dim1], lda);
			i__3 = *n - k - kb + 1;
			htrsm_("Left", uplo, "No transpose", "Non-unit", &
...
/*                 Update the upper triangle of A(1:k+kb-1,1:k+kb-1) */
		    ...
		    i__3 = k - 1;
		    htrmm_("Left", uplo, "No transpose", "Non-unit", &i__3, &
			    kb, &c_b14, &b[b_offset], ldb, &a[k * a_dim1 + 1],
			     lda)
			    ;
		    i__3 = k - 1;
		    hsymm_("Right", uplo, &i__3, &kb, &c_b52, &a[k + k * 
			    a_dim1], lda, &b[k * b_dim1 + 1], ldb, &c_b14, &a[
			    k * a_dim1 + 1], lda);
		    i__3 = k - 1;
		    hsyr2k_(uplo, "No transpose", &i__3, &kb, &c_b14, &a[k * 
		    ...
		    hsymm_("Right", uplo, &i__3, &kb, &c_b52, &a[k + k * 
			    ...
			    k * a_dim1 + 1], lda);
		    i__3 = k - 1;
		    htrmm_("Right", uplo, "Transpose", "Non-unit", &i__3, &kb,
...
/*                 Update the lower triangle of A(1:k+kb-1,1:k+kb-1) */
		    ...
		    i__3 = k - 1;
		    htrmm_("Right", uplo, "No transpose", "Non-unit", &kb, &
			    i__3, &c_b14, &b[b_offset], ldb, &a[k + a_dim1], 
			    lda);
		    i__3 = k - 1;
		    hsymm_("Left", uplo, &kb, &i__3, &c_b52, &a[k + k * 
			    a_dim1], lda, &b[k + b_dim1], ldb, &c_b14, &a[k + 
			    a_dim1], lda);
		    i__3 = k - 1;
		    hsyr2k_(uplo, "Transpose", &i__3, &kb, &c_b14, &a[k + 
		    ...
		    hsymm_("Left", uplo, &kb, &i__3, &c_b52, &a[k + k * 
			    ...
			    a_dim1], lda);
		    i__3 = k - 1;
		    htrmm_("Left", uplo, "Transpose", "Non-unit", &kb, &i__3, 
			    &c_b14, &b[k + k * b_dim1], ldb, &a[k + a_dim1], 
			    lda);
		    hsygs2_(itype, uplo, &kb, &a[k + k * a_dim1], lda, &b[k + 
			    k * b_dim1], ldb, info);
