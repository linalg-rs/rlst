...
/* > \brief \b DLASCL multiplies a general rectangular matrix by a doublereal scalar defined as cto/cfrom. */
...
/* > \verbatim */
/* > */
/* > DLASCL multiplies the M by N doublereal matrix A by the doublereal scalar */
...
/*  ===================================================================== */
void  qlascl_(char *type__, integer *kl, integer *ku, 
	quadreal *cfrom, quadreal *cto, integer *m, integer *n, 
	quadreal *a, integer *lda, integer *info)
{
