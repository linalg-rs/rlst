...
/*  ===================================================================== */
void  hlasq5_(integer *i0, integer *n0, halfreal *z__, 
	integer *pp, halfreal *tau, halfreal *sigma, halfreal *dmin__, 
	halfreal *dmin1, halfreal *dmin2, halfreal *dn, halfreal *
	dnm1, halfreal *dnm2, logical *ieee, halfreal *eps)
{
