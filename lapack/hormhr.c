...
/* > \verbatim */
/* > */
/* > DORMHR overwrites the general doublereal M-by-N matrix C with */
/* > */
/* >                 SIDE = 'L'     SIDE = 'R' */
/* > TRANS = 'N':      Q * C          C * Q */
/* > TRANS = 'T':      Q**T * C       C * Q**T */
...
/*  ===================================================================== */
void  hormhr_(char *side, char *trans, integer *m, integer *n, 
	integer *ilo, integer *ihi, halfreal *a, integer *lda, halfreal *
	tau, halfreal *c__, integer *ldc, halfreal *work, integer *lwork, 
	integer *info)
{
...
/*     Quick return if possible */
    ...
    hormqr_(side, trans, &mi, &ni, &nh, &a[*ilo + 1 + *ilo * a_dim1], lda, &
