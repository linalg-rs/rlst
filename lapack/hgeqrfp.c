...
/* > \verbatim */
/* > */
/* > DGEQRFP computes a QR factorization of a doublereal M-by-N matrix A: */
...
/* > */
/*  ===================================================================== */
void  hgeqrfp_(integer *m, integer *n, halfreal *a, integer *
	lda, halfreal *tau, halfreal *work, integer *lwork, integer *info)
{
    ...
    logical lquery;
    extern void  hgeqr2p_(integer *, integer *, halfreal *, 
...
/*           A(i:m,i:i+ib-1) */
	    ...
	    i__3 = *m - i__ + 1;
	    hgeqr2p_(&i__3, &ib, &a[i__ + i__ * a_dim1], lda, &tau[i__], &
		    work[1], &iinfo);
	    if (i__ + ib <= *n) {
...
/*     Use unblocked code to factor the last or only block. */
	...
	i__2 = *m - i__ + 1;
	i__1 = *n - i__ + 1;
	hgeqr2p_(&i__2, &i__1, &a[i__ + i__ * a_dim1], lda, &tau[i__], &work[
		1], &iinfo);
    }
