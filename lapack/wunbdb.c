...
/* > */
/*  ===================================================================== */
void  wunbdb_(char *trans, char *signs, integer *m, integer *p,
	 integer *q, quadcomplex *x11, integer *ldx11, quadcomplex *x12, 
	integer *ldx12, quadcomplex *x21, integer *ldx21, quadcomplex *
	x22, integer *ldx22, quadreal *theta, quadreal *phi, 
	quadcomplex *taup1, quadcomplex *taup2, quadcomplex *tauq1, 
	quadcomplex *tauq2, quadcomplex *work, integer *lwork, integer *
	info)
{
...
/*        Reduce columns 1, ..., Q of X11, X12, X21, and X22 */
	...
	for (i__ = 1; i__ <= i__1; ++i__) {
		...
		i__2 = *p - i__ + 1;
		z__1.r = z1, z__1.i = 0.;
		wscal_(&i__2, &z__1, &x11[i__ + i__ * x11_dim1], &c__1);
	    } else {
		i__2 = *p - i__ + 1;
		d__1 = z1 * M(cos)(phi[i__ - 1]);
		z__1.r = d__1, z__1.i = 0.;
		wscal_(&i__2, &z__1, &x11[i__ + i__ * x11_dim1], &c__1);
		i__2 = *p - i__ + 1;
		d__1 = -z1 * z3 * z4 * M(sin)(phi[i__ - 1]);
		z__1.r = d__1, z__1.i = 0.;
		waxpy_(&i__2, &z__1, &x12[i__ + (i__ - 1) * x12_dim1], &c__1, 
			&x11[i__ + i__ * x11_dim1], &c__1);
	    }
	    if (i__ == 1) {
		i__2 = *m - *p - i__ + 1;
		z__1.r = z2, z__1.i = 0.;
		wscal_(&i__2, &z__1, &x21[i__ + i__ * x21_dim1], &c__1);
	    } else {
		i__2 = *m - *p - i__ + 1;
		d__1 = z2 * M(cos)(phi[i__ - 1]);
		z__1.r = d__1, z__1.i = 0.;
		wscal_(&i__2, &z__1, &x21[i__ + i__ * x21_dim1], &c__1);
		i__2 = *m - *p - i__ + 1;
		d__1 = -z2 * z3 * z4 * M(sin)(phi[i__ - 1]);
		z__1.r = d__1, z__1.i = 0.;
		waxpy_(&i__2, &z__1, &x22[i__ + (i__ - 1) * x22_dim1], &c__1, 
			&x21[i__ + i__ * x21_dim1], &c__1);
	    }

	    i__2 = *m - *p - i__ + 1;
	    i__3 = *p - i__ + 1;
	    theta[i__] = atan2(qwnrm2_(&i__2, &x21[i__ + i__ * x21_dim1], &
		    c__1), qwnrm2_(&i__3, &x11[i__ + i__ * x11_dim1], &c__1));

	    if (*p > i__) {
		i__2 = *p - i__ + 1;
		wlarfgp_(&i__2, &x11[i__ + i__ * x11_dim1], &x11[i__ + 1 + 
			i__ * x11_dim1], &c__1, &taup1[i__]);
	    } else if (*p == i__) {
		i__2 = *p - i__ + 1;
		wlarfgp_(&i__2, &x11[i__ + i__ * x11_dim1], &x11[i__ + i__ * 
	    ...
	    if (*m - *p > i__) {
		i__2 = *m - *p - i__ + 1;
		wlarfgp_(&i__2, &x21[i__ + i__ * x21_dim1], &x21[i__ + 1 + 
			i__ * x21_dim1], &c__1, &taup2[i__]);
	    } else if (*m - *p == i__) {
		i__2 = *m - *p - i__ + 1;
		wlarfgp_(&i__2, &x21[i__ + i__ * x21_dim1], &x21[i__ + i__ * 
		...
		wlarf_("L", &i__2, &i__3, &x11[i__ + i__ * x11_dim1], &c__1, &
			z__1, &x11[i__ + (i__ + 1) * x11_dim1], ldx11, &work[
			1]);
		i__2 = *m - *p - i__ + 1;
		i__3 = *q - i__;
		d_cnjg(&z__1, &taup2[i__]);
		wlarf_("L", &i__2, &i__3, &x21[i__ + i__ * x21_dim1], &c__1, &
	    ...
	    if (i__ < *q) {
		i__2 = *q - i__;
		d__1 = -z1 * z3 * M(sin)(theta[i__]);
		z__1.r = d__1, z__1.i = 0.;
		wscal_(&i__2, &z__1, &x11[i__ + (i__ + 1) * x11_dim1], ldx11);
		i__2 = *q - i__;
		d__1 = z2 * z3 * M(cos)(theta[i__]);
		z__1.r = d__1, z__1.i = 0.;
		waxpy_(&i__2, &z__1, &x21[i__ + (i__ + 1) * x21_dim1], ldx21, 
			&x11[i__ + (i__ + 1) * x11_dim1], ldx11);
	    }
	    i__2 = *m - *q - i__ + 1;
	    d__1 = -z1 * z4 * M(sin)(theta[i__]);
	    z__1.r = d__1, z__1.i = 0.;
	    wscal_(&i__2, &z__1, &x12[i__ + i__ * x12_dim1], ldx12);
	    i__2 = *m - *q - i__ + 1;
	    d__1 = z2 * z4 * M(cos)(theta[i__]);
	    z__1.r = d__1, z__1.i = 0.;
	    waxpy_(&i__2, &z__1, &x22[i__ + i__ * x22_dim1], ldx22, &x12[i__ 
		    + i__ * x12_dim1], ldx12);

	    if (i__ < *q) {
		i__2 = *q - i__;
		i__3 = *m - *q - i__ + 1;
		phi[i__] = atan2(qwnrm2_(&i__2, &x11[i__ + (i__ + 1) * 
			x11_dim1], ldx11), qwnrm2_(&i__3, &x12[i__ + i__ * 
			x12_dim1], ldx12));
	    }

	    if (i__ < *q) {
		i__2 = *q - i__;
		wlacgv_(&i__2, &x11[i__ + (i__ + 1) * x11_dim1], ldx11);
		if (i__ == *q - 1) {
		    i__2 = *q - i__;
		    wlarfgp_(&i__2, &x11[i__ + (i__ + 1) * x11_dim1], &x11[
	    ...
	    if (*m - *q + 1 > i__) {
		i__2 = *m - *q - i__ + 1;
		wlacgv_(&i__2, &x12[i__ + i__ * x12_dim1], ldx12);
		if (*m - *q == i__) {
		    i__2 = *m - *q - i__ + 1;
		    wlarfgp_(&i__2, &x12[i__ + i__ * x12_dim1], &x12[i__ + 
		...
		i__2 = *p - i__;
		i__3 = *q - i__;
		wlarf_("R", &i__2, &i__3, &x11[i__ + (i__ + 1) * x11_dim1], 
		...
		i__2 = *p - i__;
		i__3 = *m - *q - i__ + 1;
		wlarf_("R", &i__2, &i__3, &x12[i__ + i__ * x12_dim1], ldx12, &
...
/*        Reduce columns Q + 1, ..., P of X12, X22 */
	...
	for (i__ = *q + 1; i__ <= i__1; ++i__) {
	    ...
	    if (i__ >= *m - *q) {
		i__2 = *m - *q - i__ + 1;
		wlarfgp_(&i__2, &x12[i__ + i__ * x12_dim1], &x12[i__ + i__ * 
...
/*        Reduce columns P + 1, ..., M - Q of X12, X22 */
	...
	for (i__ = 1; i__ <= i__1; ++i__) {
	    ...
	    d__1 = z2 * z4;
	    z__1.r = d__1, z__1.i = 0.;
	    wscal_(&i__2, &z__1, &x22[*q + i__ + (*p + i__) * x22_dim1], 
		    ldx22);
	    i__2 = *m - *p - *q - i__ + 1;
	    wlacgv_(&i__2, &x22[*q + i__ + (*p + i__) * x22_dim1], ldx22);
	    i__2 = *m - *p - *q - i__ + 1;
	    wlarfgp_(&i__2, &x22[*q + i__ + (*p + i__) * x22_dim1], &x22[*q + 
	    ...
	    i__2 = *m - *p - *q - i__;
	    i__3 = *m - *p - *q - i__ + 1;
	    wlarf_("R", &i__2, &i__3, &x22[*q + i__ + (*p + i__) * x22_dim1], 
...
/*        Reduce columns 1, ..., Q of X11, X12, X21, X22 */
	...
	for (i__ = 1; i__ <= i__1; ++i__) {
		...
		i__2 = *p - i__ + 1;
		z__1.r = z1, z__1.i = 0.;
		wscal_(&i__2, &z__1, &x11[i__ + i__ * x11_dim1], ldx11);
	    } else {
		i__2 = *p - i__ + 1;
		d__1 = z1 * M(cos)(phi[i__ - 1]);
		z__1.r = d__1, z__1.i = 0.;
		...
		d__1 = -z1 * z3 * z4 * M(sin)(phi[i__ - 1]);
		z__1.r = d__1, z__1.i = 0.;
		waxpy_(&i__2, &z__1, &x12[i__ - 1 + i__ * x12_dim1], ldx12, &
			x11[i__ + i__ * x11_dim1], ldx11);
	    }
	    if (i__ == 1) {
		i__2 = *m - *p - i__ + 1;
		z__1.r = z2, z__1.i = 0.;
		wscal_(&i__2, &z__1, &x21[i__ + i__ * x21_dim1], ldx21);
	    } else {
		i__2 = *m - *p - i__ + 1;
		d__1 = z2 * M(cos)(phi[i__ - 1]);
		z__1.r = d__1, z__1.i = 0.;
		...
		d__1 = -z2 * z3 * z4 * M(sin)(phi[i__ - 1]);
		z__1.r = d__1, z__1.i = 0.;
		waxpy_(&i__2, &z__1, &x22[i__ - 1 + i__ * x22_dim1], ldx22, &
	    ...
	    i__3 = *p - i__ + 1;
	    theta[i__] = atan2(qwnrm2_(&i__2, &x21[i__ + i__ * x21_dim1], 
		    ldx21), qwnrm2_(&i__3, &x11[i__ + i__ * x11_dim1], ldx11))
		    ;

	    i__2 = *p - i__ + 1;
	    wlacgv_(&i__2, &x11[i__ + i__ * x11_dim1], ldx11);
	    i__2 = *m - *p - i__ + 1;
	    wlacgv_(&i__2, &x21[i__ + i__ * x21_dim1], ldx21);

	    i__2 = *p - i__ + 1;
	    wlarfgp_(&i__2, &x11[i__ + i__ * x11_dim1], &x11[i__ + (i__ + 1) *
	    ...
	    i__2 = *q - i__;
	    i__3 = *p - i__ + 1;
	    wlarf_("R", &i__2, &i__3, &x11[i__ + i__ * x11_dim1], ldx11, &
	    ...
	    i__2 = *q - i__;
	    i__3 = *m - *p - i__ + 1;
	    wlarf_("R", &i__2, &i__3, &x21[i__ + i__ * x21_dim1], ldx21, &
		...
		d__1 = -z1 * z3 * M(sin)(theta[i__]);
		z__1.r = d__1, z__1.i = 0.;
		wscal_(&i__2, &z__1, &x11[i__ + 1 + i__ * x11_dim1], &c__1);
		i__2 = *q - i__;
		d__1 = z2 * z3 * M(cos)(theta[i__]);
		z__1.r = d__1, z__1.i = 0.;
		waxpy_(&i__2, &z__1, &x21[i__ + 1 + i__ * x21_dim1], &c__1, &
			x11[i__ + 1 + i__ * x11_dim1], &c__1);
	    }
	    i__2 = *m - *q - i__ + 1;
	    d__1 = -z1 * z4 * M(sin)(theta[i__]);
	    z__1.r = d__1, z__1.i = 0.;
	    wscal_(&i__2, &z__1, &x12[i__ + i__ * x12_dim1], &c__1);
	    i__2 = *m - *q - i__ + 1;
	    d__1 = z2 * z4 * M(cos)(theta[i__]);
	    z__1.r = d__1, z__1.i = 0.;
	    waxpy_(&i__2, &z__1, &x22[i__ + i__ * x22_dim1], &c__1, &x12[i__ 
		    + i__ * x12_dim1], &c__1);

	    if (i__ < *q) {
		i__2 = *q - i__;
		i__3 = *m - *q - i__ + 1;
		phi[i__] = atan2(qwnrm2_(&i__2, &x11[i__ + 1 + i__ * x11_dim1]
			, &c__1), qwnrm2_(&i__3, &x12[i__ + i__ * x12_dim1], &
			c__1));
	    }

	    if (i__ < *q) {
		i__2 = *q - i__;
		wlarfgp_(&i__2, &x11[i__ + 1 + i__ * x11_dim1], &x11[i__ + 2 
			+ i__ * x11_dim1], &c__1, &tauq1[i__]);
		i__2 = i__ + 1 + i__ * x11_dim1;
		x11[i__2].r = 1., x11[i__2].i = 0.;
	    }
	    i__2 = *m - *q - i__ + 1;
	    wlarfgp_(&i__2, &x12[i__ + i__ * x12_dim1], &x12[i__ + 1 + i__ * 
		...
		wlarf_("L", &i__2, &i__3, &x11[i__ + 1 + i__ * x11_dim1], &
	    ...
	    wlarf_("L", &i__2, &i__3, &x12[i__ + i__ * x12_dim1], &c__1, &
...
/*        Reduce columns P + 1, ..., M - Q of X12, X22 */
	...
	for (i__ = 1; i__ <= i__1; ++i__) {
	    ...
	    d__1 = z2 * z4;
	    z__1.r = d__1, z__1.i = 0.;
	    wscal_(&i__2, &z__1, &x22[*p + i__ + (*q + i__) * x22_dim1], &
		    c__1);
	    i__2 = *m - *p - *q - i__ + 1;
	    wlarfgp_(&i__2, &x22[*p + i__ + (*q + i__) * x22_dim1], &x22[*p + 
		...
		wlarf_("L", &i__2, &i__3, &x22[*p + i__ + (*q + i__) * 
