...
/* > */
/*  ===================================================================== */
void  khetd2_(char *uplo, integer *n, halfcomplex *a, 
	...
	integer *info)
{
    ...
    extern void  kaxpy_(integer *, halfcomplex *, 
	    halfcomplex *, integer *, halfcomplex *, integer *), xerbla_(
	    char *, integer *), klarfg_(integer *, halfcomplex *, 
...
/*           to annihilate A(1:i-1,i+1) */
	    ...
	    klarfg_(&i__, &alpha, &a[(i__ + 1) * a_dim1 + 1], &c__1, &taui);
	    i__1 = i__;
	    e[i__1] = alpha.r;
...
/*              Compute  x := tau * A * v  storing x in TAU(1:i) */
		...
		khemv_(uplo, &i__, &taui, &a[a_offset], lda, &a[(i__ + 1) * 
...
/*              Compute  w := x - 1/2 * tau * (x**H * v) * v */
		...
		whotc_(&z__4, &i__, &tau[1], &c__1, &a[(i__ + 1) * a_dim1 + 1]
			, &c__1);
		z__1.r = z__2.r * z__4.r - z__2.i * z__4.i, z__1.i = z__2.r * 
			z__4.i + z__2.i * z__4.r;
		alpha.r = z__1.r, alpha.i = z__1.i;
		kaxpy_(&i__, &alpha, &a[(i__ + 1) * a_dim1 + 1], &c__1, &tau[
			1], &c__1);
...
/*                 A := A - v * w**H - w * v**H */
		...
		z__1.r = -1., z__1.i = -0.;
		kher2_(uplo, &i__, &z__1, &a[(i__ + 1) * a_dim1 + 1], &c__1, &
...
/*              Compute  x := tau * A * v  storing y in TAU(i:n-1) */
		...
		i__2 = *n - i__;
		khemv_(uplo, &i__2, &taui, &a[i__ + 1 + (i__ + 1) * a_dim1], 
...
/*              Compute  w := x - 1/2 * tau * (x**H * v) * v */
		...
		z__2.r = z__3.r * taui.r - z__3.i * taui.i, z__2.i = z__3.r * 
			taui.i + z__3.i * taui.r;
		i__2 = *n - i__;
		whotc_(&z__4, &i__2, &tau[i__], &c__1, &a[i__ + 1 + i__ * 
			a_dim1], &c__1);
		z__1.r = z__2.r * z__4.r - z__2.i * z__4.i, z__1.i = z__2.r * 
			z__4.i + z__2.i * z__4.r;
		alpha.r = z__1.r, alpha.i = z__1.i;
		i__2 = *n - i__;
		kaxpy_(&i__2, &alpha, &a[i__ + 1 + i__ * a_dim1], &c__1, &tau[
			i__], &c__1);
...
/*                 A := A - v * w**H - w * v**H */
		...
		i__2 = *n - i__;
		z__1.r = -1., z__1.i = -0.;
		kher2_(uplo, &i__2, &z__1, &a[i__ + 1 + i__ * a_dim1], &c__1, 
