...
/* > */
/*  ===================================================================== */
void  khsein_(char *side, char *eigsrc, char *initv, logical *
	select, integer *n, halfcomplex *h__, integer *ldh, halfcomplex *
	w, halfcomplex *vl, integer *ldvl, halfcomplex *vr, integer *ldvr,
	 integer *mm, integer *m, halfcomplex *work, halfreal *rwork, 
	integer *ifaill, integer *ifailr, integer *info)
{
    ...
    extern void  xerbla_(char *, integer *), klaein_(
	    logical *, logical *, integer *, halfcomplex *, integer *, 
...
/*              has not ben computed before. */
		...
		i__2 = kr - kl + 1;
		hnorm = klanhs_("I", &i__2, &h__[kl + kl * h_dim1], ldh, &
			rwork[1]);
		if (hisnan_(&hnorm)) {
		    *info = -6;
		    return;
...
/*              Compute left eigenvector. */
		...
		i__2 = *n - kl + 1;
		klaein_(&c_false, &noinit, &i__2, &h__[kl + kl * h_dim1], ldh,
...
/*              Compute right eigenvector. */
		...
		klaein_(&c_true, &noinit, &kr, &h__[h_offset], ldh, &wk, &vr[
