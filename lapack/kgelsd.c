...
/*  ===================================================================== */
void  kgelsd_(integer *m, integer *n, integer *nrhs, 
	...
	integer *lwork, halfreal *rwork, integer *iwork, integer *info)
{
    ...
    extern void  kgelqf_(integer *, integer *, halfcomplex *,
	    ...
	    ), klalsd_(char *, integer *, integer *, integer *, halfreal *, 
...
/*     following subroutine, as returned by ILAENV.) */
	...
	if (minmn > 0) {
	    ...
	    mnthr = ilaenv_(&c__6, "ZGELSD", " ", m, n, nrhs, &c_n1, (ftnlen)
		    6, (ftnlen)1);
/* Computing MAX */
	    i__1 = (integer) (M(log)((halfreal) minmn / (halfreal) (smlsiz + 
		    1)) / M(log)(2.)) + 1;
	    nlvl = f2cmax(i__1,0);
...
/*        Matrix all zero. Return zero solution. */
	...
	hlaset_("F", &minmn, &c__1, &c_b80, &c_b80, &s[1], &c__1);
	*rank = 0;
	goto L10;
    }
...
/*           (CWorkspace: need N, prefer N*NB) */
	    ...
	    i__1 = *lwork - nwork + 1;
	    kgeqrf_(m, n, &a[a_offset], lda, &work[itau], &work[nwork], &i__1,
		     info);
...
/*        Solve the bidiagonal least squares problem. */
	...
	klalsd_("U", &smlsiz, n, nrhs, &s[1], &rwork[ie], &b[b_offset], ldb, 
...
/*        Multiply B by right bidiagonalizing vectors of R. */
	...
	i__1 = *lwork - nwork + 1;
	kunmbr_("P", "L", "N", n, nrhs, n, &a[a_offset], lda, &work[itaup], &
		b[b_offset], ldb, &work[nwork], &i__1, info);
...
/*        (CWorkspace: need 2*M, prefer M+M*NB) */
	    ...
	    i__1 = *lwork - nwork + 1;
	    kgelqf_(m, n, &a[a_offset], lda, &work[itau], &work[nwork], &i__1,
		     info);
	    il = nwork;
...
/*        Copy L to WORK(IL), zeroing out above its diagonal. */
	    ...
	    i__1 = *m - 1;
	    i__2 = *m - 1;
	    klaset_("U", &i__1, &i__2, &c_b1, &c_b1, &work[il + ldwork], &
		    ldwork);
	    itauq = il + ldwork * *m;
	    itaup = itauq + *m;
	    nwork = itaup + *m;
...
/*        Solve the bidiagonal least squares problem. */
	    ...
	    klalsd_("U", &smlsiz, m, nrhs, &s[1], &rwork[ie], &b[b_offset], 
...
/*        Multiply B by right bidiagonalizing vectors of L. */
	    ...
	    i__1 = *lwork - nwork + 1;
	    kunmbr_("P", "L", "N", m, nrhs, m, &work[il], &ldwork, &work[
...
/*        Solve the bidiagonal least squares problem. */
	    ...
	    klalsd_("L", &smlsiz, m, nrhs, &s[1], &rwork[ie], &b[b_offset], 
		    ldb, rcond, rank, &work[nwork], &rwork[nrwork], &iwork[1],
		     info);
	    if (*info != 0) {
		goto L10;
...
/*        Multiply B by right bidiagonalizing vectors of A. */
	    ...
	    i__1 = *lwork - nwork + 1;
	    kunmbr_("P", "L", "N", n, nrhs, m, &a[a_offset], lda, &work[itaup]
		    , &b[b_offset], ldb, &work[nwork], &i__1, info);
