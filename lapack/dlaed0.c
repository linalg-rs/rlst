...
/*  ===================================================================== */
void  dlaed0_(integer *icompq, integer *qsiz, integer *n, 
	...
	integer *info)
{
    ...
    extern void  dcopy_(integer *, doublereal *, integer *, 
	    doublereal *, integer *);
    integer indxq, iwrem;
    extern void  dlaed1_(integer *, doublereal *, doublereal *,
	     integer *, integer *, doublereal *, integer *, doublereal *, 
	    integer *, integer *);
    integer iqptr;
    extern void  dlaed7_(integer *, integer *, integer *, 
...
/*        routine */
	...
	temp = M(log)((doublereal) (*n)) / M(log)(2.);
	lgn = (integer) temp;
