...
/*  ===================================================================== */
void  hgels_(char *trans, integer *m, integer *n, integer *
	...
	halfreal *work, integer *lwork, integer *info)
{
    ...
    extern void  hgelqf_(integer *, integer *, halfreal *, 
	    ...
	    halfreal *, halfreal *, integer *, integer *), hlaset_(char *,
    ...
    extern void  hormlq_(char *, char *, integer *, integer *, 
	    ...
	    hormqr_(char *, char *, integer *, integer *, integer *, 
...
/* Computing MIN */
	...
	i__1 = f2cmax(*m,*n);
	hlaset_("Full", &i__1, nrhs, &c_b33, &c_b33, &b[b_offset], ldb);
	return;
    }
...
/*     Scale A, B if f2cmax element outside range [SMLNUM,BIGNUM] */
    ...
    anrm = hlange_("M", m, n, &a[a_offset], lda, rwork);
    iascl = 0;
...
/*        Matrix all zero. Return zero solution. */
	...
	i__1 = f2cmax(*m,*n);
	hlaset_("F", &i__1, nrhs, &c_b33, &c_b33, &b[b_offset], ldb);
	goto L50;
    }
    ...
    bnrm = hlange_("M", &brow, nrhs, &b[b_offset], ldb, rwork);
    ibscl = 0;
...
/*        compute QR factorization of A */
	...
	i__1 = *lwork - mn;
	hgeqrf_(m, n, &a[a_offset], lda, &work[1], &work[mn + 1], &i__1, info)
		;
...
/*           B(1:M,1:NRHS) := Q**T * B(1:M,1:NRHS) */
	    ...
	    i__1 = *lwork - mn;
	    hormqr_("Left", "Transpose", m, nrhs, n, &a[a_offset], lda, &work[
...
/*           B(1:N,1:NRHS) := inv(R) * B(1:N,1:NRHS) */
	    ...
	    htrtrs_("Upper", "No transpose", "Non-unit", n, nrhs, &a[a_offset]
...
/*           B(1:N,1:NRHS) := inv(R**T) * B(1:N,1:NRHS) */
	    ...
	    htrtrs_("Upper", "Transpose", "Non-unit", n, nrhs, &a[a_offset], 
		    lda, &b[b_offset], ldb, info);
...
/*           B(1:M,1:NRHS) := Q(1:N,:) * B(1:N,1:NRHS) */
	    ...
	    i__1 = *lwork - mn;
	    hormqr_("Left", "No transpose", m, nrhs, n, &a[a_offset], lda, &
...
/*        Compute LQ factorization of A */
	...
	i__1 = *lwork - mn;
	hgelqf_(m, n, &a[a_offset], lda, &work[1], &work[mn + 1], &i__1, info)
		;
...
/*           B(1:M,1:NRHS) := inv(L) * B(1:M,1:NRHS) */
	    ...
	    htrtrs_("Lower", "No transpose", "Non-unit", m, nrhs, &a[a_offset]
		    , lda, &b[b_offset], ldb, info);
...
/*           B(1:N,1:NRHS) := Q(1:N,:)**T * B(1:M,1:NRHS) */
	    ...
	    i__1 = *lwork - mn;
	    hormlq_("Left", "Transpose", n, nrhs, m, &a[a_offset], lda, &work[
		    1], &b[b_offset], ldb, &work[mn + 1], &i__1, info);
...
/*           B(1:N,1:NRHS) := Q * B(1:N,1:NRHS) */
	    ...
	    i__1 = *lwork - mn;
	    hormlq_("Left", "No transpose", n, nrhs, m, &a[a_offset], lda, &
		    work[1], &b[b_offset], ldb, &work[mn + 1], &i__1, info);
