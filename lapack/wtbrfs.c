...
/*  ===================================================================== */
void  wtbrfs_(char *uplo, char *trans, char *diag, integer *n, 
	integer *kd, integer *nrhs, quadcomplex *ab, integer *ldab, 
	quadcomplex *b, integer *ldb, quadcomplex *x, integer *ldx, 
	quadreal *ferr, quadreal *berr, quadcomplex *work, quadreal *
	rwork, integer *info)
{
    ...
    integer isave[3];
    logical upper;
    extern void  wtbmv_(char *, char *, char *, integer *, 
	    integer *, quadcomplex *, integer *, quadcomplex *, integer *), wcopy_(integer *, quadcomplex *, 
	    integer *, quadcomplex *, integer *), wtbsv_(char *, char *, 
	    char *, integer *, integer *, quadcomplex *, integer *, 
	    quadcomplex *, integer *), waxpy_(
	    integer *, quadcomplex *, quadcomplex *, integer *, 
	    quadcomplex *, integer *), wlacn2_(integer *, quadcomplex *, 
...
/*        where op(A) = A, A**T, or A**H, depending on TRANS. */
	...
	wtbmv_(uplo, trans, diag, n, kd, &ab[ab_offset], ldab, &work[1], &
		c__1);
	z__1.r = -1., z__1.i = -0.;
...
/*              Multiply by diag(W)*inv(op(A)**H). */
		...
		wtbsv_(uplo, transt, diag, n, kd, &ab[ab_offset], ldab, &work[
			1], &c__1);
		i__2 = *n;
		for (i__ = 1; i__ <= i__2; ++i__) {
		    i__5 = i__;
...
/* L230: */
		...
		wtbsv_(uplo, transn, diag, n, kd, &ab[ab_offset], ldab, &work[
			1], &c__1);
	    }
	    goto L210;
	}
