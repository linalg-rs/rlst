...
/*  ===================================================================== */
void  wgetrf2_(integer *m, integer *n, quadcomplex *a, 
	integer *lda, integer *ipiv, integer *info)
{
    ...
    extern void  wscal_(integer *, quadcomplex *, 
	    ...
	    integer *), wtrsm_(char *, char *, char *, char *,
	     integer *, integer *, quadcomplex *, quadcomplex *, integer *
	    , quadcomplex *, integer *);
...
/*           Compute elements 2:M of the column */
		...
		wscal_(&i__1, &z__1, &a[a_dim1 + 2], &c__1);
	    } else {
		i__1 = *m - 1;
...
/*               [ A21 ] */
	...
	wgetrf2_(m, &n1, &a[a_offset], lda, &ipiv[1], &iinfo);
	if (*info == 0 && iinfo > 0) {
	    *info = iinfo;
	}
...
/*                              [ A22 ] */
	...
	wlaswp_(&n2, &a[(n1 + 1) * a_dim1 + 1], lda, &c__1, &n1, &ipiv[1], &
		c__1);

/*        Solve A12 */

	wtrsm_("L", "L", "N", "U", &n1, &n2, &c_b1, &a[a_offset], lda, &a[(n1 
		+ 1) * a_dim1 + 1], lda);
...
/*        Update A22 */
	...
	i__1 = *m - n1;
	z__1.r = -1., z__1.i = -0.;
	wgemm_("N", "N", &i__1, &n2, &n1, &z__1, &a[n1 + 1 + a_dim1], lda, &a[
...
/*        Factor A22 */
	...
	i__1 = *m - n1;
	wgetrf2_(&i__1, &n2, &a[n1 + 1 + (n1 + 1) * a_dim1], lda, &ipiv[n1 + 
		1], &iinfo);
...
/*        Apply interchanges to A21 */
	...
	i__1 = n1 + 1;
	i__2 = f2cmin(*m,*n);
	wlaswp_(&n1, &a[a_dim1 + 1], lda, &i__1, &i__2, &ipiv[1], &c__1);
