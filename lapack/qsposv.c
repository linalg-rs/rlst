...
/*  ===================================================================== */
void  qsposv_(char *uplo, integer *n, integer *nrhs, 
	...
	integer *info)
{
    ...
    extern void  qaxpy_(integer *, quadreal *, quadreal *, 
	    integer *, quadreal *, integer *), qsymm_(char *, char *, 
	    integer *, integer *, quadreal *, quadreal *, integer *, 
	    quadreal *, integer *, quadreal *, quadreal *, integer *), qlag2s_(integer *, integer *, quadreal *, 
	    integer *, doublereal *, integer *, integer *), slag2d_(integer *, 
	    integer *, doublereal *, integer *, quadreal *, integer *, integer *),
	     qlat2s_(char *, integer *, quadreal *, integer *, doublereal *, 
	    integer *, integer *);
    ...
    extern void  qpotrf_(char *, integer *, quadreal *, 
	    integer *, integer *), qpotrs_(char *, integer *, integer 
	    *, quadreal *, integer *, quadreal *, integer *, integer *), spotrf_(char *, integer *, doublereal *, integer *, integer *), spotrs_(char *, integer *, integer *, doublereal *, integer *, 
...
/*     Compute some constants. */
    ...
    anrm = qlansy_("I", uplo, n, &a[a_offset], lda, &work[work_offset]);
    eps = qlamch_("Epsilon");
...
/*     result in SA. */
    ...
    qlat2s_(uplo, n, &a[a_offset], lda, &swork[ptsa], n, info);
...
/*     Compute R = B - AX (R is WORK). */
    ...
    qsymm_("Left", uplo, n, nrhs, &c_b10, &a[a_offset], lda, &x[x_offset], 
...
/*        Compute R = B - AX (R is WORK). */
	...
	qsymm_("L", uplo, n, nrhs, &c_b10, &a[a_offset], lda, &x[x_offset], 
		ldx, &c_b11, &work[work_offset], n);
...
/*     satisfactory solution, so we resort to double precision. */
    ...
    qpotrs_(uplo, n, nrhs, &a[a_offset], lda, &x[x_offset], ldx, info);
