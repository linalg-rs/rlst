...
/* > */
/*  ===================================================================== */
void  qlaed1_(integer *n, quadreal *d__, quadreal *q, 
	integer *ldq, integer *indxq, quadreal *rho, integer *cutpnt, 
	quadreal *work, integer *iwork, integer *info)
{
    ...
    extern void  qcopy_(integer *, quadreal *, integer *, 
	    quadreal *, integer *);
    integer indxp;
    extern void  qlaed2_(integer *, integer *, integer *, 
	    quadreal *, quadreal *, integer *, integer *, quadreal *, 
	    quadreal *, quadreal *, quadreal *, quadreal *, integer *,
	     integer *, integer *, integer *, integer *), qlaed3_(integer *, 
...
/*     first row of Q_2. */
    ...
    qcopy_(cutpnt, &q[*cutpnt + q_dim1], ldq, &work[iz], &c__1);
    zpp1 = *cutpnt + 1;
    i__1 = *n - *cutpnt;
    qcopy_(&i__1, &q[zpp1 + zpp1 * q_dim1], ldq, &work[iz + *cutpnt], &c__1);

/*     Deflate eigenvalues. */

    qlaed2_(&k, n, cutpnt, &d__[1], &q[q_offset], ldq, &indxq[1], rho, &work[
...
/*     Solve Secular Equation. */
	...
	qlaed3_(&k, n, cutpnt, &d__[1], &q[q_offset], ldq, rho, &work[idlmda],
