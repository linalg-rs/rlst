...
/*  ===================================================================== */
void  hspgvd_(integer *itype, char *jobz, char *uplo, integer *
	n, halfreal *ap, halfreal *bp, halfreal *w, halfreal *z__, 
	...
	integer *liwork, integer *info)
{
    ...
    extern void  htpmv_(char *, char *, char *, integer *, 
	    ...
	    halfreal *, integer *);
    logical wantz;
    extern void  xerbla_(char *, integer *), hspevd_(
	    char *, char *, integer *, halfreal *, halfreal *, halfreal 
	    *, integer *, halfreal *, integer *, integer *, integer *, 
	    integer *);
    integer liwmin;
    extern void  hpptrf_(char *, integer *, halfreal *, 
	    integer *), hspgst_(integer *, char *, integer *, 
	    halfreal *, halfreal *, integer *);
    logical lquery;
...
/*     Transform problem to standard eigenvalue problem and solve. */
    ...
    hspevd_(jobz, uplo, n, &ap[1], &w[1], &z__[z_offset], ldz, &work[1], 
