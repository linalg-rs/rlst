...
/* > of a doublereal symmetric matrix A in packed storage. If eigenvectors are */
...
/*  ===================================================================== */
void  hspevd_(char *jobz, char *uplo, integer *n, halfreal *
	ap, halfreal *w, halfreal *z__, integer *ldz, halfreal *work, 
	integer *lwork, integer *iwork, integer *liwork, integer *info)
{
    ...
    extern void  hsptrd_(char *, integer *, halfreal *, 
	    halfreal *, halfreal *, halfreal *, integer *), 
	    hopmtr_(char *, char *, char *, integer *, integer *, halfreal *
	    , halfreal *, halfreal *, integer *, halfreal *, integer *);
    integer llwork;
    halfreal smlnum;
    logical lquery;
...
/*     Call DSPTRD to reduce symmetric packed matrix to tridiagonal form. */
    ...
    inde = 1;
    indtau = inde + *n;
    hsptrd_(uplo, n, &ap[1], &w[1], &work[inde], &work[indtau], &iinfo);
...
/*     Householder transformations represented in AP. */
	...
	hstedc_("I", n, &w[1], &work[inde], &z__[z_offset], ldz, &work[indwrk]
		, &llwork, &iwork[1], liwork, info);
	hopmtr_("L", uplo, "N", n, n, &ap[1], &work[indtau], &z__[z_offset], 
