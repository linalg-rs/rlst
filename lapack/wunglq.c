...
/*  ===================================================================== */
void  wunglq_(integer *m, integer *n, integer *k, 
	...
	work, integer *lwork, integer *info)
{
    ...
    extern void  wungl2_(integer *, integer *, integer *, 
...
/*     Use unblocked code for the last or only block. */
	...
	i__2 = *n - kk;
	i__3 = *k - kk;
	wungl2_(&i__1, &i__2, &i__3, &a[kk + 1 + (kk + 1) * a_dim1], lda, &
...
/*              H = H(i) H(i+1) . . . H(i+ib-1) */
		...
		i__2 = *n - i__ + 1;
		wlarft_("Forward", "Rowwise", &i__2, &ib, &a[i__ + i__ * 
...
/*              Apply H**H to A(i+ib:m,i:n) from the right */
		...
		i__2 = *m - i__ - ib + 1;
		i__3 = *n - i__ + 1;
		wlarfb_("Right", "Conjugate transpose", "Forward", "Rowwise", 
...
/*           Apply H**H to columns i:n of current block */
	    ...
	    i__2 = *n - i__ + 1;
	    wungl2_(&ib, &i__2, &ib, &a[i__ + i__ * a_dim1], lda, &tau[i__], &
		    work[1], &iinfo);
