...
/*  ===================================================================== */
void  wgetrs_(char *trans, integer *n, integer *nrhs, 
...
/*        Apply row interchanges to the right hand sides. */
	...
	wlaswp_(nrhs, &b[b_offset], ldb, &c__1, n, &ipiv[1], &c__1);

/*        Solve L*X = B, overwriting B with X. */

	wtrsm_("Left", "Lower", "No transpose", "Unit", n, nrhs, &c_b1, &a[
...
/*        Solve U**T *X = B or U**H *X = B, overwriting B with X. */
	...
	wtrsm_("Left", "Upper", trans, "Non-unit", n, nrhs, &c_b1, &a[
		a_offset], lda, &b[b_offset], ldb);

/*        Solve L**T *X = B, or L**H *X = B overwriting B with X. */

	wtrsm_("Left", "Lower", trans, "Unit", n, nrhs, &c_b1, &a[a_offset], 
		lda, &b[b_offset], ldb);

/*        Apply row interchanges to the solution vectors. */

	wlaswp_(nrhs, &b[b_offset], ldb, &c__1, n, &ipiv[1], &c_n1);
    }
