...
/*  ===================================================================== */
void  whpevx_(char *jobz, char *range, char *uplo, integer *n, 
	quadcomplex *ap, quadreal *vl, quadreal *vu, integer *il, 
	integer *iu, quadreal *abstol, integer *m, quadreal *w, 
	quadcomplex *z__, integer *ldz, quadcomplex *work, quadreal *
	rwork, integer *iwork, integer *ifail, integer *info)
{
    ...
    quadreal smlnum;
    extern void  whptrd_(char *, integer *, quadcomplex *, 
	    quadreal *, quadreal *, quadcomplex *, integer *), 
	    wstein_(integer *, quadreal *, quadreal *, integer *, 
	    quadreal *, integer *, integer *, quadcomplex *, integer *, 
	    quadreal *, integer *, integer *, integer *), wsteqr_(char *, 
	    integer *, quadreal *, quadreal *, quadcomplex *, integer *,
	     quadreal *, integer *), wupgtr_(char *, integer *, 
	    quadcomplex *, quadcomplex *, quadcomplex *, integer *, 
	    quadcomplex *, integer *), wupmtr_(char *, char *, char 
...
/*     Scale matrix to allowable range, if necessary. */
    ...
    anrm = wlanhp_("M", uplo, n, &ap[1], &rwork[1]);
    if (anrm > 0. && anrm < rmin) {
	iscale = 1;
	sigma = rmin / anrm;
    } else if (anrm > rmax) {
...
/*     Call ZHPTRD to reduce Hermitian packed matrix to tridiagonal form. */
    ...
    indtau = 1;
    indwrk = indtau + *n;
    whptrd_(uplo, n, &ap[1], &rwork[indd], &rwork[inde], &work[indtau], &
	    iinfo);
...
/*     for some eigenvalue, then try DSTEBZ. */
	...
	if (! wantz) {
	    ...
	    wupgtr_(uplo, n, &ap[1], &work[indtau], &z__[z_offset], ldz, &
		    work[indwrk], &iinfo);
	    i__1 = *n - 1;
	    qcopy_(&i__1, &rwork[inde], &c__1, &rwork[indee], &c__1);
...
/*        form to eigenvectors returned by ZSTEIN. */
	...
	indwrk = indtau + *n;
	wupmtr_("L", uplo, "N", n, m, &ap[1], &work[indtau], &z__[z_offset], 
