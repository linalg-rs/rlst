...
/*  ===================================================================== */
void  zhetrs_aa__(char *uplo, integer *n, integer *nrhs, 
	halfcomplex *a, integer *lda, integer *ipiv, halfcomplex *b, 
	integer *ldb, halfcomplex *work, integer *lwork, integer *info)
{
    ...
    extern void  kswap_(integer *, halfcomplex *, integer *, 
	    halfcomplex *, integer *), kgtsv_(integer *, integer *, 
	    halfcomplex *, halfcomplex *, halfcomplex *, halfcomplex *
	    , integer *, integer *), ktrsm_(char *, char *, char *, char *, 
	    integer *, integer *, halfcomplex *, halfcomplex *, integer *,
	     halfcomplex *, integer *), 
	    xerbla_(char *, integer *), klacgv_(integer *, 
...
/*        Compute (U \P**T * B) -> B    [ (U \P**T * B) ] */
	...
	i__1 = *n - 1;
	ktrsm_("L", "U", "C", "U", &i__1, nrhs, &c_b9, &a[(a_dim1 << 1) + 1], 
		lda, &b[b_dim1 + 2], ldb);

/*        Compute T \ B -> B   [ T \ (U \P**T * B) ] */

	i__1 = *lda + 1;
	klacpy_("F", &c__1, n, &a[a_dim1 + 1], &i__1, &work[*n], &c__1);
	if (*n > 1) {
	    i__1 = *n - 1;
	    i__2 = *lda + 1;
	    klacpy_("F", &c__1, &i__1, &a[(a_dim1 << 1) + 1], &i__2, &work[*n 
		    * 2], &c__1);
	    i__1 = *n - 1;
	    i__2 = *lda + 1;
	    klacpy_("F", &c__1, &i__1, &a[(a_dim1 << 1) + 1], &i__2, &work[1],
		     &c__1);
	    i__1 = *n - 1;
	    klacgv_(&i__1, &work[1], &c__1);
	}
	kgtsv_(n, nrhs, &work[1], &work[*n], &work[*n * 2], &b[b_offset], ldb,
		 info);

/*        Compute (U**T \ B) -> B   [ U**T \ (T \ (U \P**T * B) ) ] */

	i__1 = *n - 1;
	ktrsm_("L", "U", "N", "U", &i__1, nrhs, &c_b9, &a[(a_dim1 << 1) + 1], 
		lda, &b[b_dim1 + 2], ldb);
...
/*        Compute (L \P**T * B) -> B    [ (L \P**T * B) ] */
	...
	i__1 = *n - 1;
	ktrsm_("L", "L", "N", "U", &i__1, nrhs, &c_b9, &a[a_dim1 + 2], lda, &
		b[b_dim1 + 2], ldb);
...
/*        Compute T \ B -> B   [ T \ (L \P**T * B) ] */
	...
	if (*n > 1) {
	    i__1 = *n - 1;
	    i__2 = *lda + 1;
	    klacpy_("F", &c__1, &i__1, &a[a_dim1 + 2], &i__2, &work[1], &c__1);
	    i__1 = *n - 1;
	    i__2 = *lda + 1;
	    klacpy_("F", &c__1, &i__1, &a[a_dim1 + 2], &i__2, &work[*n * 2], &
		    c__1);
	    i__1 = *n - 1;
	    klacgv_(&i__1, &work[*n * 2], &c__1);
	}
	kgtsv_(n, nrhs, &work[1], &work[*n], &work[*n * 2], &b[b_offset], ldb,
		 info);
...
/*        Compute (L**T \ B) -> B   [ L**T \ (T \ (L \P**T * B) ) ] */
	...
	i__1 = *n - 1;
	ktrsm_("L", "L", "C", "U", &i__1, nrhs, &c_b9, &a[a_dim1 + 2], lda, &
		b[b_dim1 + 2], ldb);
