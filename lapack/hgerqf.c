...
/* > \verbatim */
/* > */
/* > DGERQF computes an RQ factorization of a doublereal M-by-N matrix A: */
/* > A = R * Q. */
/* > \endverbatim */
...
/* > */
/*  ===================================================================== */
void  hgerqf_(integer *m, integer *n, halfreal *a, integer *
	lda, halfreal *tau, halfreal *work, integer *lwork, integer *info)
{
    ...
    extern void  hgerq2_(integer *, integer *, halfreal *, 
...
/*           A(m-k+i:m-k+i+ib-1,1:n-k+i+ib-1) */
	    ...
	    i__3 = *n - k + i__ + ib - 1;
	    hgerq2_(&ib, &i__3, &a[*m - k + i__ + a_dim1], lda, &tau[i__], &
		    work[1], &iinfo);
	    if (*m - k + i__ > 1) {
...
/*              H = H(i+ib-1) . . . H(i+1) H(i) */
		...
		i__3 = *n - k + i__ + ib - 1;
		hlarft_("Backward", "Rowwise", &i__3, &ib, &a[*m - k + i__ + 
...
/*              Apply H to A(1:m-k+i-1,1:n-k+i+ib-1) from the right */
		...
		i__3 = *m - k + i__ - 1;
		i__4 = *n - k + i__ + ib - 1;
		hlarfb_("Right", "No transpose", "Backward", "Rowwise", &i__3,
...
/*     Use unblocked code to factor the last or only block */
    ...
    if (mu > 0 && nu > 0) {
	hgerq2_(&mu, &nu, &a[a_offset], lda, &tau[1], &work[1], &iinfo);
    }
