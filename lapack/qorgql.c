...
/*  ===================================================================== */
void  qorgql_(integer *m, integer *n, integer *k, quadreal *
	...
	integer *info)
{
    ...
    extern void  qorg2l_(integer *, integer *, integer *, 
...
/*     Use unblocked code for the first or only block. */
    ...
    i__2 = *n - kk;
    i__3 = *k - kk;
    qorg2l_(&i__1, &i__2, &i__3, &a[a_offset], lda, &tau[1], &work[1], &iinfo)
	    ;
...
/*              H = H(i+ib-1) . . . H(i+1) H(i) */
		...
		i__3 = *m - *k + i__ + ib - 1;
		qlarft_("Backward", "Columnwise", &i__3, &ib, &a[(*n - *k + 
...
/*           Apply H to rows 1:m-k+i+ib-1 of current block */
	    ...
	    i__3 = *m - *k + i__ + ib - 1;
	    qorg2l_(&i__3, &ib, &ib, &a[(*n - *k + i__) * a_dim1 + 1], lda, &
