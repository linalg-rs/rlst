...
/* > */
/*  ===================================================================== */
void  klaqr0_(logical *wantt, logical *wantz, integer *n, 
	integer *ilo, integer *ihi, halfcomplex *h__, integer *ldh, 
	halfcomplex *w, integer *iloz, integer *ihiz, halfcomplex *z__, 
	integer *ldz, halfcomplex *work, integer *lwork, integer *info)
{
    ...
    extern void  klaqr3_(logical *, logical *, integer *, 
	    ...
	    , halfcomplex *, integer *), klaqr4_(logical *, logical *, 
	    integer *, integer *, integer *, halfcomplex *, integer *, 
	    halfcomplex *, integer *, integer *, halfcomplex *, integer *,
	     halfcomplex *, integer *, integer *), klaqr5_(logical *, 
	    logical *, integer *, integer *, integer *, integer *, integer *, 
	    halfcomplex *, halfcomplex *, integer *, integer *, integer *,
...
/*        ==== Workspace query call to ZLAQR3 ==== */
	...
	i__1 = nwr + 1;
	klaqr3_(wantt, wantz, n, ilo, ihi, &i__1, &h__[h_offset], ldh, iloz, 
...
/*           ==== Aggressive early deflation ==== */
	    ...
	    klaqr3_(wantt, wantz, n, &ktop, &kbot, &nw, &h__[h_offset], ldh, 
...
/*                 .    to fit an NS-by-NS scratch array.) ==== */
			...
			ks = kbot - ns + 1;
			kt = *n - ns + 1;
			klacpy_("A", &ns, &ns, &h__[ks + ks * h_dim1], ldh, &
				h__[kt + h_dim1], ldh);
			if (ns > nmin) {
			    klaqr4_(&c_false, &c_false, &ns, &c__1, &ns, &h__[
				    kt + h_dim1], ldh, &w[ks], &c__1, &c__1, 
				    zdum, &c__1, &work[1], lwork, &inf);
			} else {
			    klahqr_(&c_false, &c_false, &ns, &c__1, &ns, &h__[
				    kt + h_dim1], ldh, &w[ks], &c__1, &c__1, 
				    zdum, &c__1, &inf);
			}
			ks += inf;
...
/*              ==== Small-bulge multi-shift QR sweep ==== */
		...
		klaqr5_(wantt, wantz, &kacc22, n, &ktop, &kbot, &ns, &w[ks], &
