...
/*  ===================================================================== */
void  kporfs_(char *uplo, integer *n, integer *nrhs, 
	...
	rwork, integer *info)
{
    ...
    halfreal lstres;
    extern void  kpotrs_(char *, integer *, integer *, 
...
/*           Update solution and try again. */
	    ...
	    kpotrs_(uplo, n, &c__1, &af[af_offset], ldaf, &work[1], n, info);
...
/*              Multiply by diag(W)*inv(A**H). */
		...
		kpotrs_(uplo, n, &c__1, &af[af_offset], ldaf, &work[1], n, 
			info);
		i__2 = *n;
		for (i__ = 1; i__ <= i__2; ++i__) {
		    i__3 = i__;
