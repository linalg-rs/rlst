...
/* >          (The two forms are equivalent if A is doublereal.) */
/* > \endverbatim */
/* > */
/* > \param[in] N */
/* > \verbatim */
...
/* >          The n doublereal diagonal elements of the tridiagonal matrix A. */
/* > \endverbatim */
/* > */
/* > \param[in] E */
/* > \verbatim */
...
/*  ===================================================================== */
void  kptrfs_(char *uplo, integer *n, integer *nrhs, 
	...
	rwork, integer *info)
{
    ...
    integer i__, j;
    halfreal s;
    halfcomplex bi, cx, dx, ex;
    integer ix, nz;
    halfreal eps, safe1, safe2;
    ...
    halfreal lstres;
    extern void  kpttrs_(char *, integer *, integer *, 
...
/*           Update solution and try again. */
	    ...
	    kpttrs_(uplo, n, &c__1, &df[1], &ef[1], &work[1], n, info);
	    kaxpy_(n, &c_b16, &work[1], &c__1, &x[j * x_dim1 + 1], &c__1);
	    lstres = berr[j];
	    ++count;
	    goto L20;
	}
