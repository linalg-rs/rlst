...
/*  ===================================================================== */
void  dlarrv_(integer *n, doublereal *vl, doublereal *vu, 
	...
	integer *iwork, integer *info)
{
    ...
    extern void  dlar1v_(integer *, integer *, integer *, 
    ...
    extern void  dlarrb_(integer *, doublereal *, doublereal *,
    ...
    doublereal spdiam;
    integer negcnt;
    extern void  dlarrf_(integer *, doublereal *, doublereal *,
