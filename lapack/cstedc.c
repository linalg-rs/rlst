...
/*  ===================================================================== */
void  cstedc_(char *compz, integer *n, real *d__, real *e, 
	...
	info)
{
    ...
    extern void  cswap_(integer *, complex *, integer *, 
	    complex *, integer *);
    integer lwmin;
    extern void  claed0_(integer *, integer *, real *, real *, 
    ...
    logical lquery;
    integer smlsiz;
    extern void  ssteqr_(char *, integer *, real *, real *, 
...
/*        Compute the workspace requirements */
	...
	if (*n <= 1 || icompz == 0) {
	    ...
	    lgn = (integer) (M(log)((real) (*n)) / M(log)(2.f));
...
L40:
	    if (finish < *n) {
		tiny = eps * M(sqrt)((r__1 = d__[finish], abs(r__1))) * M(sqrt)((
