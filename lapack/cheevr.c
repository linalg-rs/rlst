...
/* > */
/*  ===================================================================== */
void  cheevr_(char *jobz, char *range, char *uplo, integer *n, 
	...
	lrwork, integer *iwork, integer *liwork, integer *info)
{
    ...
    extern void  cstein_(integer *, real *, real *, integer *, 
