...
/* > */
/*  ===================================================================== */
void  qgelq_(integer *m, integer *n, quadreal *a, integer *
	lda, quadreal *t, integer *tsize, quadreal *work, integer *lwork, 
	integer *info)
{
    ...
    extern void  qgelqt_(integer *, integer *, integer *, 
	    quadreal *, integer *, quadreal *, integer *, quadreal *, 
	    integer *);
    logical lminws, lquery;
    integer mintsz;
    extern void  qlaswlq_(integer *, integer *, integer *, 
...
/*     The LQ Decomposition */
    ...
    if (*n <= *m || nb <= *m || nb >= *n) {
	qgelqt_(m, n, &mb, &a[a_offset], lda, &t[6], &mb, &work[1], info);
    } else {
	qlaswlq_(m, n, &mb, &nb, &a[a_offset], lda, &t[6], &mb, &work[1], 
		lwork, info);
    }
