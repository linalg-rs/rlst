...
/*  ===================================================================== */
void  cgeev_(char *jobvl, char *jobvr, integer *n, complex *a, 
	...
	info)
{
    ...
    extern void  cgebak_(char *, char *, integer *, integer *, 
    ...
    extern real clange_(char *, integer *, integer *, complex *, integer *, 
	    real *);
    real cscale;
    extern void  cgehrd_(integer *, integer *, integer *, 
    ...
    extern void  chseqr_(char *, char *, integer *, integer *, 
    ...
    extern void  ctrevc3_(char *, char *, logical *, integer *,
