...
/*  ===================================================================== */
void  qopgtr_(char *uplo, integer *n, quadreal *ap, 
	quadreal *tau, quadreal *q, integer *ldq, quadreal *work, 
	integer *info)
{
    ...
    extern void  qorg2l_(integer *, integer *, integer *, 
	    ...
	    qorg2r_(integer *, integer *, integer *, quadreal *, integer *, 
...
/*        Generate Q(1:n-1,1:n-1) */
	...
	i__2 = *n - 1;
	i__3 = *n - 1;
	qorg2l_(&i__1, &i__2, &i__3, &q[q_offset], ldq, &tau[1], &work[1], &
		iinfo);
...
/*           Generate Q(2:n,2:n) */
	    ...
	    i__2 = *n - 1;
	    i__3 = *n - 1;
	    qorg2r_(&i__1, &i__2, &i__3, &q[(q_dim1 << 1) + 2], ldq, &tau[1], 
		    &work[1], &iinfo);
	}
    }
    return;
