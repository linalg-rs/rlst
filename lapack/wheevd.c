...
/* > */
/*  ===================================================================== */
void  wheevd_(char *jobz, char *uplo, integer *n, 
	quadcomplex *a, integer *lda, quadreal *w, quadcomplex *work, 
	...
	integer *liwork, integer *info)
{
    ...
    extern void  whetrd_(char *, integer *, quadcomplex *, 
	    ...
	    quadcomplex *, integer *, integer *), wlacpy_(char *, 
	    integer *, integer *, quadcomplex *, integer *, quadcomplex *,
	     integer *);
    integer lrwmin, llwork;
    quadreal smlnum;
    logical lquery;
    extern void  wunmtr_(char *, char *, char *, integer *, 
...
/* Computing MAX */
	...
	work[1].r = (quadreal) lopt, work[1].i = 0.;
	rwork[1] = (quadreal) lropt;
	iwork[1] = liopt;
...
/*     Scale matrix to allowable range, if necessary. */
    ...
    if (iscale == 1) {
	wlascl_(uplo, &c__0, &c__0, &c_b18, &sigma, n, n, &a[a_offset], lda, 
		info);
    }
...
/*     Call ZHETRD to reduce Hermitian matrix to tridiagonal form. */
    ...
    whetrd_(uplo, n, &a[a_offset], lda, &w[1], &rwork[inde], &work[indtau], &
...
/*     A. */
	...
	wstedc_("I", n, &w[1], &rwork[inde], &work[indwrk], n, &work[indwk2], 
		&llwrk2, &rwork[indrwk], &llrwk, &iwork[1], liwork, info);
	wunmtr_("L", uplo, "N", n, n, &a[a_offset], lda, &work[indtau], &work[
		indwrk], n, &work[indwk2], &llwrk2, &iinfo);
	wlacpy_("A", n, n, &work[indwrk], n, &a[a_offset], lda);
    }
