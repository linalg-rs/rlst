...
/* >          will always be positive.  If the eigenvalues are doublereal, then */
/* >          the first (doublereal) eigenvalue is  WR1 / SCALE1 , but this may */
...
/* >          eigenvalues are doublereal, then the second (doublereal) eigenvalue is */
...
/* >          If the eigenvalue is doublereal, then WR1 is SCALE1 times the */
/* >          eigenvalue closest to the (2,2) element of A B**(-1).  If the */
/* >          eigenvalue is complex, then WR1=WR2 is SCALE1 times the doublereal */
...
/* >          If the eigenvalue is doublereal, then WR2 is SCALE2 times the */
/* >          other eigenvalue.  If the eigenvalue is complex, then */
/* >          WR1=WR2 is SCALE1 times the doublereal part of the eigenvalues. */
/* > \endverbatim */
/* > */
/* > \param[out] WI */
/* > \verbatim */
/* >          WI is DOUBLE PRECISION */
/* >          If the eigenvalue is doublereal, then WI is zero.  If the */
...
/*  ===================================================================== */
void  hlag2_(halfreal *a, integer *lda, halfreal *b, 
	integer *ldb, halfreal *safmin, halfreal *scale1, halfreal *
	scale2, halfreal *wr1, halfreal *wr2, halfreal *wi)
{
    ...
    /* Local variables */
    halfreal r__, c1, c2, c3, c4, c5, s1, s2, a11, a12, a21, a22, b11, b12, 
...
/*        Choose (doublereal) eigenvalue closest to 2,2 element of A*B**(-1) */
/*        for WR1. */
...
/*     Scale second eigenvalue (if doublereal) */
