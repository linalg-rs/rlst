...
/*  ===================================================================== */
void  kheevx_(char *jobz, char *range, char *uplo, integer *n, 
	halfcomplex *a, integer *lda, halfreal *vl, halfreal *vu, 
	integer *il, integer *iu, halfreal *abstol, integer *m, halfreal *
	w, halfcomplex *z__, integer *ldz, halfcomplex *work, integer *
	lwork, halfreal *rwork, integer *iwork, integer *ifail, integer *
	info)
{
    ...
    extern void  ksteqr_(char *, integer *, halfreal *, 
	    ...
	    kunmtr_(char *, char *, char *, integer *, integer *, 
...
/*     Test the input parameters. */
	...
	*info = -6;
	...
	if (*n <= 1) {
	    lwkmin = 1;
	    work[1].r = (halfreal) lwkmin, work[1].i = 0.;
	} else {
	    lwkmin = *n << 1;
...
/*     Call ZHETRD to reduce Hermitian matrix to tridiagonal form. */
    ...
    khetrd_(uplo, n, &a[a_offset], lda, &rwork[indd], &rwork[inde], &work[
...
/*     some eigenvalue, then try DSTEBZ. */
	...
	if (! wantz) {
	    ...
	    klacpy_("A", n, n, &a[a_offset], lda, &z__[z_offset], ldz);
	    kungtr_(uplo, n, &z__[z_offset], ldz, &work[indtau], &work[indwrk]
		    , &llwork, &iinfo);
	    i__1 = *n - 1;
	    hcopy_(&i__1, &rwork[inde], &c__1, &rwork[indee], &c__1);
...
/*     Otherwise, call DSTEBZ and, if eigenvectors are desired, ZSTEIN. */
	...
	*(unsigned char *)order = 'E';
    ...
    indisp = indibl + *n;
    indiwk = indisp + *n;
    hstebz_(range, order, n, &vll, &vuu, il, iu, &abstll, &rwork[indd], &
