...
/* > */
/*  ===================================================================== */
void  whegvd_(integer *itype, char *jobz, char *uplo, integer *
	 ...
	 integer *lrwork, integer *iwork, integer *liwork, integer *info)
{
    ...
    extern void  wtrmm_(char *, char *, char *, char *, 
	    ...
	    integer *), wheevd_(char *, char *, integer *, 
...
/*     Transform problem to standard eigenvalue problem and solve. */
    ...
    wheevd_(jobz, uplo, n, &a[a_offset], lda, &w[1], &work[1], lwork, &rwork[
	    1], lrwork, &iwork[1], liwork, info);
/* Computing MAX */
    d__1 = (quadreal) lopt, d__2 = work[1].r;
...
/*           backtransform eigenvectors: x = inv(L)**H *y or inv(U)*y */
		...
		*(unsigned char *)trans = 'C';
	    ...
	    wtrsm_("Left", uplo, trans, "Non-unit", n, n, &c_b1, &b[b_offset],
		     ldb, &a[a_offset], lda);
...
/*           backtransform eigenvectors: x = L*y or U**H *y */
		...
		*(unsigned char *)trans = 'N';
	    ...
	    wtrmm_("Left", uplo, trans, "Non-unit", n, n, &c_b1, &b[b_offset],
		     ldb, &a[a_offset], lda);
	}
    }
