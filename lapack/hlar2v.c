...
/* > \brief \b DLAR2V applies a vector of plane rotations with doublereal cosines and doublereal sines from both sides to 
...
/* > \verbatim */
/* > */
/* > DLAR2V applies a vector of doublereal plane rotations from both sides to */
/* > a sequence of 2-by-2 doublereal symmetric matrices, defined by the elements */
...
/*  ===================================================================== */
void  hlar2v_(integer *n, halfreal *x, halfreal *y, 
	halfreal *z__, integer *incx, halfreal *c__, halfreal *s, 
	integer *incc)
{
