...
/* > */
/*  ===================================================================== */
void  dtgsen_(integer *ijob, logical *wantq, logical *wantz, 
	...
	integer *info)
{
    ...
    doublereal dsum;
    logical swap;
    extern void  dlag2_(doublereal *, integer *, doublereal *, 
    ...
    integer lwmin;
    logical wantp;
    extern void  dlacn2_(integer *, doublereal *, doublereal *,
    ...
    integer liwmin;
    extern void  dtgsyl_(char *, integer *, integer *, integer 
