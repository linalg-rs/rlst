...
/*  ===================================================================== */
void  qlagts_(integer *job, integer *n, quadreal *a, 
	quadreal *b, quadreal *c__, quadreal *d__, integer *in, 
	quadreal *y, quadreal *tol, integer *info)
{
    ...
    /* Local variables */
    integer k;
    quadreal ak, eps, temp, pert, absak, sfmin;
