...
/*  ===================================================================== */
void  hopmtr_(char *side, char *uplo, char *trans, integer *m, 
	integer *n, halfreal *ap, halfreal *tau, halfreal *c__, integer 
...
/*           Apply H(i) */
	    ...
	    aii = ap[ii];
	    ap[ii] = 1.;
	    hlarf_(side, &mi, &ni, &ap[ii - i__ + 1], &c__1, &tau[i__], &c__[
		    c_offset], ldc, &work[1]);
	    ap[ii] = aii;
...
/*           Apply H(i) */
	    ...
	    hlarf_(side, &mi, &ni, &ap[ii], &c__1, &tau[i__], &c__[ic + jc * 
		    c_dim1], ldc, &work[1]);
	    ap[ii] = aii;
