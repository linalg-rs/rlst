...
/* > \verbatim */
/* > */
/* > DPPTRF computes the Cholesky factorization of a doublereal symmetric */
...
/* > */
/*  ===================================================================== */
void  hpptrf_(char *uplo, integer *n, halfreal *ap, integer *
	info)
{
...
/*           Compute elements 1:J-1 of column J. */
	    ...
	    if (j > 1) {
		i__2 = j - 1;
		htpsv_("Upper", "Transpose", "Non-unit", &i__2, &ap[1], &ap[
			jc], &c__1);
	    }
...
/*           Compute U(J,J) and test for non-positive-definiteness. */
	    ...
	    i__2 = j - 1;
	    ajj = ap[jj] - hdot_(&i__2, &ap[jc], &c__1, &ap[jc], &c__1);
	    if (ajj <= 0.) {
		ap[jj] = ajj;
		goto L30;
	    }
...
/*           submatrix. */
		...
		i__2 = *n - j;
		d__1 = 1. / ajj;
		hscal_(&i__2, &d__1, &ap[jj + 1], &c__1);
		i__2 = *n - j;
		hspr_("Lower", &i__2, &c_b16, &ap[jj + 1], &c__1, &ap[jj + *n 
			- j + 1]);
		jj = jj + *n - j + 1;
	    }
/* L20: */
