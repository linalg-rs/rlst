...
/*  ===================================================================== */
void  zgges3_(char *jobvsl, char *jobvsr, char *sort, L_fp 
	...
	logical *bwork, integer *info)
{
    ...
    integer irwrk, irows;
    extern void  zgghd3_(char *, char *, integer *, integer *, 
	    integer *, doublecomplex *, integer *, doublecomplex *, integer *,
	     doublecomplex *, integer *, doublecomplex *, integer *, 
	    doublecomplex *, integer *, integer *), dlabad_(
	    doublereal *, doublereal *);
    extern doublereal dlamch_(char *);
    extern void  zggbak_(char *, char *, integer *, integer *, 
    ...
    extern void  zlascl_(char *, integer *, integer *, 
	    doublereal *, doublereal *, integer *, integer *, doublecomplex *,
	     integer *, integer *);
    integer ijobvr;
    extern void  zgeqrf_(integer *, integer *, doublecomplex *,
