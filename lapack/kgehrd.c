...
/* > */
/*  ===================================================================== */
void  kgehrd_(integer *n, integer *ilo, integer *ihi, 
	...
	work, integer *lwork, integer *info)
{
    ...
    extern void  kgemm_(char *, char *, integer *, integer *, 
	    ...
	    halfcomplex *, integer *), kgehd2_(integer *, integer *, 
	    integer *, halfcomplex *, integer *, halfcomplex *, 
	    halfcomplex *, integer *), klahr2_(integer *, integer *, 
	    integer *, halfcomplex *, integer *, halfcomplex *, 
...
/*           which performs the reduction, and also the matrix Y = A*V*T */
	    ...
	    klahr2_(ihi, &i__, &ib, &a[i__ * a_dim1 + 1], lda, &tau[i__], &
...
/*           to 1 */
	    ...
	    i__3 = *ihi - i__ - ib + 1;
	    z__1.r = -1., z__1.i = -0.;
	    kgemm_("No transpose", "Conjugate transpose", ihi, &i__3, &ib, &
...
/*           right */
	    ...
	    i__3 = ib - 1;
	    ktrmm_("Right", "Lower", "Conjugate transpose", "Unit", &i__, &
		    i__3, &c_b2, &a[i__ + 1 + i__ * a_dim1], lda, &work[1], &
		    ldwork);
	    i__3 = ib - 2;
	    for (j = 0; j <= i__3; ++j) {
		z__1.r = -1., z__1.i = -0.;
		kaxpy_(&i__, &z__1, &work[ldwork * j + 1], &c__1, &a[(i__ + j 
			+ 1) * a_dim1 + 1], &c__1);
/* L30: */
	    }
...
/*     Use unblocked code to reduce the rest of the matrix */
    ...
    kgehd2_(n, &i__, ihi, &a[a_offset], lda, &tau[1], &work[1], &iinfo);
    work[1].r = (halfreal) lwkopt, work[1].i = 0.;
