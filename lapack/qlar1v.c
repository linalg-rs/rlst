...
/*  ===================================================================== */
void  qlar1v_(integer *n, integer *b1, integer *bn, quadreal 
	*lambda, quadreal *d__, quadreal *l, quadreal *ld, quadreal *
	lld, quadreal *pivmin, quadreal *gaptol, quadreal *z__, logical 
	*wantnc, integer *negcnt, quadreal *ztz, quadreal *mingma, 
