...
/* > */
/*  ===================================================================== */
void  qpbtf2_(char *uplo, integer *n, integer *kd, quadreal *
...
/* Computing MIN */
	    ...
	    if (kn > 0) {
		d__1 = 1. / ajj;
		qscal_(&kn, &d__1, &ab[*kd + (j + 1) * ab_dim1], &kld);
		qsyr_("Upper", &kn, &c_b8, &ab[*kd + (j + 1) * ab_dim1], &kld,
...
/* Computing MIN */
	    ...
	    if (kn > 0) {
		d__1 = 1. / ajj;
		qscal_(&kn, &d__1, &ab[j * ab_dim1 + 2], &c__1);
		qsyr_("Lower", &kn, &c_b8, &ab[j * ab_dim1 + 2], &c__1, &ab[(
			j + 1) * ab_dim1 + 1], &kld);
	    }
/* L20: */
	}
