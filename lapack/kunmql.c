...
/*  ===================================================================== */
void  kunmql_(char *side, char *trans, integer *m, integer *n, 
	integer *k, halfcomplex *a, integer *lda, halfcomplex *tau, 
	 ...
	 integer *info)
{
    ...
    integer nbmin, iinfo;
    extern void  kunm2l_(char *, char *, integer *, integer *, 
...
/*        Use unblocked code */
	...
	kunm2l_(side, trans, m, n, k, &a[a_offset], lda, &tau[1], &c__[
...
/*           H = H(i+ib-1) . . . H(i+1) H(i) */
	    ...
	    i__4 = nq - *k + i__ + ib - 1;
	    klarft_("Backward", "Columnwise", &i__4, &ib, &a[i__ * a_dim1 + 1]
...
/*           Apply H or H**H */
	    ...
	    klarfb_(side, trans, "Backward", "Columnwise", &mi, &ni, &ib, &a[
