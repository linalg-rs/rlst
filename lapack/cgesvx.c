...
/*  ===================================================================== */
void  cgesvx_(char *fact, char *trans, integer *n, integer *
	...
	complex *work, real *rwork, integer *info)
{
    ...
    extern real clange_(char *, integer *, integer *, complex *, integer *, 
	    real *);
    extern void  claqge_(integer *, integer *, complex *, 
	    integer *, real *, real *, real *, real *, real *, char *)
	    , cgecon_(char *, integer *, complex *, integer *, real *, real *,
	     complex *, real *, integer *);
    real colcnd;
    extern real slamch_(char *);
    extern void  cgeequ_(integer *, integer *, complex *, 
	    integer *, real *, real *, real *, real *, real *, integer *);
    logical nofact;
    extern void  cgerfs_(char *, integer *, integer *, complex 
