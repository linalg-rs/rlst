...
/*  ===================================================================== */
void  hgetrf_(integer *m, integer *n, halfreal *a, integer *
	lda, integer *ipiv, integer *info)
{
    ...
    extern void  hlaswp_(integer *, halfreal *, integer *, 
	    integer *, integer *, integer *, integer *), hgetrf2_(integer *, 
...
/*        Use unblocked code. */
	...
	hgetrf2_(m, n, &a[a_offset], lda, &ipiv[1], info);
    } else {
...
/*           singularity. */
	    ...
	    i__3 = *m - j + 1;
	    hgetrf2_(&i__3, &jb, &a[j + j * a_dim1], lda, &ipiv[j], &iinfo);
...
/*           Apply interchanges to columns 1:J-1. */
	    ...
	    i__3 = j - 1;
	    i__4 = j + jb - 1;
	    hlaswp_(&i__3, &a[a_offset], lda, &j, &i__4, &ipiv[1], &c__1);
...
/*              Apply interchanges to columns J+JB:N. */
		...
		i__3 = *n - j - jb + 1;
		i__4 = j + jb - 1;
		hlaswp_(&i__3, &a[(j + jb) * a_dim1 + 1], lda, &j, &i__4, &
			ipiv[1], &c__1);

/*              Compute block row of U. */

		i__3 = *n - j - jb + 1;
		htrsm_("Left", "Lower", "No transpose", "Unit", &jb, &i__3, &
...
/*                 Update trailing submatrix. */
		    ...
		    i__3 = *m - j - jb + 1;
		    i__4 = *n - j - jb + 1;
		    hgemm_("No transpose", "No transpose", &i__3, &i__4, &jb, 
