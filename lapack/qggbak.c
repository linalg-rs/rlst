...
/* > \verbatim */
/* > */
/* > DGGBAK forms the right or left eigenvectors of a doublereal generalized */
...
/* > */
/*  ===================================================================== */
void  qggbak_(char *job, char *side, integer *n, integer *ilo, 
	integer *ihi, quadreal *lscale, quadreal *rscale, integer *m, 
	quadreal *v, integer *ldv, integer *info)
{
...
/*        Backward transformation on right eigenvectors */
	...
	if (rightv) {
		...
		qscal_(m, &rscale[i__], &v[i__ + v_dim1], ldv);
/* L10: */
	    }
	}
...
/*        Backward transformation on left eigenvectors */
	...
	if (leftv) {
	    i__1 = *ihi;
	    for (i__ = *ilo; i__ <= i__1; ++i__) {
		qscal_(m, &lscale[i__], &v[i__ + v_dim1], ldv);
/* L20: */
	    }
	}
    }
...
/*        Backward permutation on right eigenvectors */
	...
	if (rightv) {
		...
		qswap_(m, &v[i__ + v_dim1], ldv, &v[k + v_dim1], ldv);
L40:
		;
	    }
