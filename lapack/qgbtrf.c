...
/* > */
/*  ===================================================================== */
void  qgbtrf_(integer *m, integer *n, integer *kl, integer *ku,
	 quadreal *ab, integer *ldab, integer *ipiv, integer *info)
{
    ...
    extern void  qscal_(integer *, quadreal *, quadreal *, 
	    ...
	    quadreal *, quadreal *, integer *), qcopy_(
	    integer *, quadreal *, integer *, quadreal *, integer *), 
	    qswap_(integer *, quadreal *, integer *, quadreal *, integer *
	    );
    quadreal work13[4160]	/* was [65][64] */, work31[4160]	/* 
	    was [65][64] */;
    extern void  qtrsm_(char *, char *, char *, char *, 
	    integer *, integer *, quadreal *, quadreal *, integer *, 
	    quadreal *, integer *), qgbtf2_(
	    integer *, integer *, integer *, integer *, quadreal *, integer 
	    *, integer *, integer *);
    extern integer iqamax_(integer *, quadreal *, integer *);
    extern void  xerbla_(char *, integer *);
    extern integer ilaenv_(integer *, char *, char *, integer *, integer *, 
	    integer *, integer *, ftnlen, ftnlen);
    extern void  qlaswp_(integer *, quadreal *, integer *, 
...
/*        Use unblocked code */
	...
	qgbtf2_(m, n, kl, ku, &ab[ab_offset], ldab, &ipiv[1], info);
    } else {
...
/* Computing MIN */
		...
		km = f2cmin(i__4,i__5);
		i__4 = km + 1;
		jp = iqamax_(&i__4, &ab[kv + 1 + jj * ab_dim1], &c__1);
		ipiv[jj] = jp + jj - j;
...
/*                    Apply interchange to columns J to J+JB-1 */
			...
			if (jp + jj - 1 < j + *kl) {
			    ...
			    i__4 = *ldab - 1;
			    i__5 = *ldab - 1;
			    qswap_(&jb, &ab[kv + 1 + jj - j + j * ab_dim1], &
...
/*                       which are stored in the work array WORK31 */
			    ...
			    i__4 = jj - j;
			    i__5 = *ldab - 1;
			    qswap_(&i__4, &ab[kv + 1 + jj - j + j * ab_dim1], 
				    &i__5, &work31[jp + jj - j - *kl - 1], &
				    c__65);
			    i__4 = j + jb - jj;
			    i__5 = *ldab - 1;
			    i__6 = *ldab - 1;
			    qswap_(&i__4, &ab[kv + 1 + jj * ab_dim1], &i__5, &
...
/*                 Compute multipliers */
		    ...
		    qscal_(&km, &d__1, &ab[kv + 2 + jj * ab_dim1], &c__1);
...
/* Computing MIN */
			...
			i__5 = *ldab - 1;
			i__6 = *ldab - 1;
			qger_(&km, &i__4, &c_b18, &ab[kv + 2 + jj * ab_dim1], 
...
/* Computing MIN */
		...
		nw = f2cmin(i__4,i3);
		if (nw > 0) {
		    qcopy_(&nw, &ab[kv + *kl + 1 - jj + j + jj * ab_dim1], &
...
/*              A32. */
		...
		i__3 = *ldab - 1;
		qlaswp_(&j2, &ab[kv + 1 - jb + (j + jb) * ab_dim1], &i__3, &
			c__1, &jb, &ipiv[j], &c__1);
...
/* Computing MIN */
		...
		nw = f2cmin(i__4,i__5);
		if (nw > 0) {
		    qcopy_(&nw, &work31[(jj - j + 1) * 65 - 65], &c__1, &ab[
