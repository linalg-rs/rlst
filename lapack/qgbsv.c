...
/* > */
/*  ===================================================================== */
void  qgbsv_(integer *n, integer *kl, integer *ku, integer *
	nrhs, quadreal *ab, integer *ldab, integer *ipiv, quadreal *b, 
	integer *ldb, integer *info)
{
    ...
    /* Local variables */
    extern void  qgbtrf_(integer *, integer *, integer *, 
	    integer *, quadreal *, integer *, integer *, integer *), 
	    xerbla_(char *, integer *), qgbtrs_(char *, integer *, 
...
/*     Compute the LU factorization of the band matrix A. */
    ...
    qgbtrf_(n, n, kl, ku, &ab[ab_offset], ldab, &ipiv[1], info);
    if (*info == 0) {

/*        Solve the system A*X = B, overwriting B with X. */

	qgbtrs_("No transpose", n, kl, ku, nrhs, &ab[ab_offset], ldab, &ipiv[
