...
/* > */
/*  ===================================================================== */
void  zunmrz_(char *side, char *trans, integer *m, integer *n, 
	...
	lwork, integer *info)
{
    ...
    integer nbmin, iinfo;
    extern void  zunmr3_(char *, char *, integer *, integer *, 
    ...
    logical notran;
    integer ldwork;
    extern void  zlarzb_(char *, char *, char *, char *, 
    ...
    integer lwkopt;
    logical lquery;
    extern void  zlarzt_(char *, char *, integer *, integer *, 
