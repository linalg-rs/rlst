...
/*  ===================================================================== */
void  hsygv_(integer *itype, char *jobz, char *uplo, integer *
	n, halfreal *a, integer *lda, halfreal *b, integer *ldb, 
	halfreal *w, halfreal *work, integer *lwork, integer *info)
{
    ...
    extern void  htrsm_(char *, char *, char *, char *, 
	    ...
	    halfreal *, integer *);
    logical upper;
    extern void  hsyev_(char *, char *, integer *, halfreal *
...
/*     Transform problem to standard eigenvalue problem and solve. */
    ...
    hsyev_(jobz, uplo, n, &a[a_offset], lda, &w[1], &work[1], lwork, info);
...
/*           backtransform eigenvectors: x = inv(L)**T*y or inv(U)*y */
		...
		*(unsigned char *)trans = 'T';
	    ...
	    htrsm_("Left", uplo, trans, "Non-unit", n, &neig, &c_b16, &b[
...
/*           backtransform eigenvectors: x = L*y or U**T*y */
		...
		*(unsigned char *)trans = 'N';
	    ...
	    htrmm_("Left", uplo, trans, "Non-unit", n, &neig, &c_b16, &b[
		    b_offset], ldb, &a[a_offset], lda);
	}
    }
