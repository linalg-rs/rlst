...
/*  ===================================================================== */
void  cstein_(integer *n, real *d__, real *e, integer *m, real 
	...
	real *work, integer *iwork, integer *ifail, integer *info)
{
    ...
    extern void  xerbla_(char *, integer *), slagtf_(
	    integer *, real *, real *, real *, real *, real *, real *, 
	    integer *, integer *);
    integer nrmchk;
    extern integer isamax_(integer *, real *, integer *);
    extern void  slagts_(integer *, integer *, real *, real *, 
