...
/* > */
/*  ===================================================================== */
void  wlatsqr_(integer *m, integer *n, integer *mb, integer *
	...
	quadcomplex *work, integer *lwork, integer *info)
{
    ...
    extern void  xerbla_(char *, integer *), wgeqrt_(
	    integer *, integer *, integer *, quadcomplex *, integer *, 
	    quadcomplex *, integer *, quadcomplex *, integer *);
    logical lquery;
    extern void  wtpqrt_(integer *, integer *, integer *, 
...
/*     The QR Decomposition */
    ...
    if (*mb <= *n || *mb >= *m) {
	wgeqrt_(m, n, nb, &a[a_offset], lda, &t[t_offset], ldt, &work[1], 
		info);
	return;
    }
    kk = (*m - *n) % (*mb - *n);
...
/*      Compute the QR factorization of the first block A(1:MB,1:N) */
    ...
    wgeqrt_(mb, n, nb, &a[a_dim1 + 1], lda, &t[t_offset], ldt, &work[1], info)
	    ;
    ctr = 1;
...
/*      Compute the QR factorization of the current block A(I:I+MB-N,1:N) */
	...
	i__3 = *mb - *n;
	wtpqrt_(&i__3, n, &c__0, nb, &a[a_dim1 + 1], lda, &a[i__ + a_dim1], 
...
/*      Compute the QR factorization of the last block A(II:M,1:N) */
    ...
    if (ii <= *m) {
	wtpqrt_(&kk, n, &c__0, nb, &a[a_dim1 + 1], lda, &a[ii + a_dim1], lda, 
