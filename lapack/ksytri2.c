...
/*  ===================================================================== */
void  ksytri2_(char *uplo, integer *n, halfcomplex *a, 
	...
	integer *info)
{
    ...
    /* Local variables */
    extern void  ksytri2x_(char *, integer *, halfcomplex *, 
    ...
    logical lquery;
    extern void  ksytri_(char *, integer *, halfcomplex *, 
...
/*     Quick return if possible */
    ...
    if (nbmax >= *n) {
	ksytri_(uplo, n, &a[a_offset], lda, &ipiv[1], &work[1], info);
    } else {
	ksytri2x_(uplo, n, &a[a_offset], lda, &ipiv[1], &work[1], &nbmax, 
		info);
    }
    return;
