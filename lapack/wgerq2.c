...
/* > */
/*  ===================================================================== */
void  wgerq2_(integer *m, integer *n, quadcomplex *a, 
...
/*        A(m-k+i,1:n-k+i-1) */
	...
	i__1 = *n - k + i__;
	wlacgv_(&i__1, &a[*m - k + i__ + a_dim1], lda);
	i__1 = *m - k + i__ + (*n - k + i__) * a_dim1;
	alpha.r = a[i__1].r, alpha.i = a[i__1].i;
	i__1 = *n - k + i__;
	wlarfg_(&i__1, &alpha, &a[*m - k + i__ + a_dim1], lda, &tau[i__]);
...
/*        Apply H(i) to A(1:m-k+i-1,1:n-k+i) from the right */
	...
	i__1 = *m - k + i__ - 1;
	i__2 = *n - k + i__;
	wlarf_("Right", &i__1, &i__2, &a[*m - k + i__ + a_dim1], lda, &tau[
