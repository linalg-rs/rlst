...
/* > \verbatim */
/* > */
/* > DORMQL overwrites the general doublereal M-by-N matrix C with */
/* > */
/* >                 SIDE = 'L'     SIDE = 'R' */
/* > TRANS = 'N':      Q * C          C * Q */
/* > TRANS = 'T':      Q**T * C       C * Q**T */
/* > */
/* > where Q is a doublereal orthogonal matrix defined as the product of k */
...
/*  ===================================================================== */
void  hormql_(char *side, char *trans, integer *m, integer *n, 
	integer *k, halfreal *a, integer *lda, halfreal *tau, halfreal *
	c__, integer *ldc, halfreal *work, integer *lwork, integer *info)
{
    ...
    integer nbmin, iinfo;
    extern void  horm2l_(char *, char *, integer *, integer *, 
	    integer *, halfreal *, integer *, halfreal *, halfreal *, 
	    integer *, halfreal *, integer *), hlarfb_(char 
	    *, char *, char *, char *, integer *, integer *, integer *, 
	    halfreal *, integer *, halfreal *, integer *, halfreal *, 
	    integer *, halfreal *, integer *), hlarft_(char *, char *, integer *, integer *, halfreal 
	    *, integer *, halfreal *, halfreal *, integer *), xerbla_(char *, integer *);
...
/*        Use unblocked code */
	...
	horm2l_(side, trans, m, n, k, &a[a_offset], lda, &tau[1], &c__[
...
/*           H = H(i+ib-1) . . . H(i+1) H(i) */
	    ...
	    i__4 = nq - *k + i__ + ib - 1;
	    hlarft_("Backward", "Columnwise", &i__4, &ib, &a[i__ * a_dim1 + 1]
...
/*           Apply H or H**T */
	    ...
	    hlarfb_(side, trans, "Backward", "Columnwise", &mi, &ni, &ib, &a[
