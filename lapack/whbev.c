...
/*  ===================================================================== */
void  whbev_(char *jobz, char *uplo, integer *n, integer *kd, 
	quadcomplex *ab, integer *ldab, quadreal *w, quadcomplex *z__, 
	integer *ldz, quadcomplex *work, quadreal *rwork, integer *info)
{
    ...
    extern void  qsterf_(integer *, quadreal *, quadreal *,
	    ...
	    integer *), whbtrd_(char *, char *, integer *, integer *, 
...
/*     Scale matrix to allowable range, if necessary. */
    ...
    if (iscale == 1) {
	if (lower) {
	    wlascl_("B", kd, kd, &c_b11, &sigma, n, n, &ab[ab_offset], ldab, 
		    info);
	} else {
	    wlascl_("Q", kd, kd, &c_b11, &sigma, n, n, &ab[ab_offset], ldab, 
		    info);
	}
    }
