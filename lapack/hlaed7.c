...
/*  ===================================================================== */
void  hlaed7_(integer *icompq, integer *n, integer *qsiz, 
	integer *tlvls, integer *curlvl, integer *curpbm, halfreal *d__, 
	halfreal *q, integer *ldq, integer *indxq, halfreal *rho, integer 
	*cutpnt, halfreal *qstore, integer *qptr, integer *prmptr, integer *
	perm, integer *givptr, integer *givcol, halfreal *givnum, 
	halfreal *work, integer *iwork, integer *info)
{
    ...
    integer indxc, indxp;
    extern void  hlaed8_(integer *, integer *, integer *, 
	    ...
	    halfreal *, integer *, integer *, integer *), hlaed9_(integer *,
	     integer *, integer *, integer *, halfreal *, halfreal *, 
	    integer *, halfreal *, halfreal *, halfreal *, halfreal *,
	     integer *, integer *), hlaeda_(integer *, integer *, integer *, 
...
/*     Sort and Deflate eigenvalues. */
    ...
    hlaed8_(icompq, &k, n, qsiz, &d__[1], &q[q_offset], ldq, &indxq[1], rho, 
...
/*     Solve Secular Equation. */
    ...
    if (k != 0) {
	hlaed9_(&k, &c__1, &k, n, &d__[1], &work[is], &k, rho, &work[idlmda], 
		&work[iw], &qstore[qptr[curr]], &k, info);
	if (*info != 0) {
	    goto L30;
	}
	if (*icompq == 1) {
	    hgemm_("N", "N", qsiz, &k, &k, &c_b10, &work[iq2], &ldq2, &qstore[
