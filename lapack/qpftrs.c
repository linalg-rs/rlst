...
/* > */
/*  ===================================================================== */
void  qpftrs_(char *transr, char *uplo, integer *n, integer *
	nrhs, quadreal *a, quadreal *b, integer *ldb, integer *info)
{
    ...
    extern void  qtfsm_(char *, char *, char *, char *, char *,
...
/*     start execution: there are two triangular solves */
    ...
    if (lower) {
	qtfsm_(transr, "L", uplo, "N", "N", n, nrhs, &c_b10, a, &b[b_offset], 
		ldb);
	qtfsm_(transr, "L", uplo, "T", "N", n, nrhs, &c_b10, a, &b[b_offset], 
		ldb);
    } else {
	qtfsm_(transr, "L", uplo, "T", "N", n, nrhs, &c_b10, a, &b[b_offset], 
		ldb);
