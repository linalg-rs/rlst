...
/* > */
/*  ===================================================================== */
void  wtgexc_(logical *wantq, logical *wantz, integer *n, 
	quadcomplex *a, integer *lda, quadcomplex *b, integer *ldb, 
	quadcomplex *q, integer *ldq, quadcomplex *z__, integer *ldz, 
	integer *ifst, integer *ilst, integer *info)
{
    ...
    /* Local variables */
    integer here;
    extern void  wtgex2_(logical *, logical *, integer *, 
...
/*        Swap with next one below */
	...
	wtgex2_(wantq, wantz, n, &a[a_offset], lda, &b[b_offset], ldb, &q[
