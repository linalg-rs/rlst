...
/*  ===================================================================== */
void  dsytri_3x__(char *uplo, integer *n, quadreal *a, 
	integer *lda, quadreal *e, integer *ipiv, quadreal *work, integer 
	*nb, integer *info)
{
...
/*           U11**T * invD1 * U11 -> U11 */
	    ...
	    i__1 = *n + *nb + 1;
	    qtrmm_("L", "U", "T", "U", &nnb, &nnb, &c_b10, &a[cut + 1 + (cut 
...
/*           U01**T * invD * U01 -> A( CUT+I, CUT+J ) */
	    ...
	    i__1 = *n + *nb + 1;
	    i__2 = *n + *nb + 1;
	    qgemm_("T", "N", &nnb, &nnb, &cut, &c_b10, &a[(cut + 1) * a_dim1 
...
/*           U01 =  U00**T * invD0 * U01 */
	    ...
	    i__1 = *n + *nb + 1;
	    qtrmm_("L", uplo, "T", "U", &cut, &nnb, &c_b10, &a[a_offset], lda,
...
/*           L11**T * invD1 * L11 -> L11 */
	    ...
	    i__1 = *n + *nb + 1;
	    qtrmm_("L", uplo, "T", "U", &nnb, &nnb, &c_b10, &a[cut + 1 + (cut 
		    + 1) * a_dim1], lda, &work[u11 + 1 + work_dim1], &i__1);
...
/*              L21**T * invD2*L21 -> A( CUT+I, CUT+J ) */
		...
		i__2 = *n + *nb + 1;
		i__3 = *n + *nb + 1;
		qgemm_("T", "N", &nnb, &nnb, &i__1, &c_b10, &a[cut + nnb + 1 
...
/*              L01 =  L22**T * invD2 * L21 */
		...
		i__1 = *n - nnb - cut;
		i__2 = *n + *nb + 1;
		qtrmm_("L", uplo, "T", "U", &i__1, &nnb, &c_b10, &a[cut + nnb 
