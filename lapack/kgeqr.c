...
/* > */
/*  ===================================================================== */
void  kgeqr_(integer *m, integer *n, halfcomplex *a, integer 
	*lda, halfcomplex *t, integer *tsize, halfcomplex *work, integer *
	lwork, integer *info)
{
    ...
    logical lminws;
    extern void  kgeqrt_(integer *, integer *, integer *, 
	    halfcomplex *, integer *, halfcomplex *, integer *, 
	    halfcomplex *, integer *);
    logical lquery;
    integer mintsz;
    extern void  klatsqr_(integer *, integer *, integer *, 
...
/* Computing MAX */
    ...
    if (*info == 0) {
	if (mint) {
	    t[1].r = (halfreal) mintsz, t[1].i = 0.;
	} else {
	    i__1 = nb * *n * nblcks + 5;
	    t[1].r = (halfreal) i__1, t[1].i = 0.;
	}
	t[2].r = (halfreal) mb, t[2].i = 0.;
	t[3].r = (halfreal) nb, t[3].i = 0.;
	if (minw) {
	    i__1 = f2cmax(1,*n);
...
/*     The QR Decomposition */
    ...
    if (*m <= *n || mb <= *n || mb >= *m) {
	kgeqrt_(m, n, &nb, &a[a_offset], lda, &t[6], &nb, &work[1], info);
    } else {
	klatsqr_(m, n, &mb, &nb, &a[a_offset], lda, &t[6], &nb, &work[1], 
		lwork, info);
    }
