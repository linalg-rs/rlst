...
/*  ===================================================================== */
void  klaein_(logical *rightv, logical *noinit, integer *n, 
	halfcomplex *h__, integer *ldh, halfcomplex *w, halfcomplex *v, 
	halfcomplex *b, integer *ldb, halfreal *rwork, halfreal *eps3, 
	halfreal *smlnum, integer *info)
{
...
/*        Scale supplied initial vector. */
	...
	vnorm = hwnrm2_(n, &v[1], &c__1);
	d__1 = *eps3 * rootn / f2cmax(vnorm,nrmsml);
	whscal_(n, &d__1, &v[1], &c__1);
    }
...
/*              Interchange rows and eliminate. */
		...
		kladiv_(&z__1, &b[i__ + i__ * b_dim1], &ei);
...
/*              Eliminate without interchange. */
		...
		kladiv_(&z__1, &ei, &b[i__ + i__ * b_dim1]);
		x.r = z__1.r, x.i = z__1.i;
		if (x.r != 0. || x.i != 0.) {
		    i__2 = *n;
		    for (j = i__ + 1; j <= i__2; ++j) {
...
/*        overwriting x on v. */
	...
	klatrs_("Upper", trans, "Nonunit", normin, n, &b[b_offset], ldb, &v[1]
		, &scale, &rwork[1], &ierr);
	*(unsigned char *)normin = 'Y';

/*        Test for sufficient growth in the norm of v. */

	vnorm = hwasum_(n, &v[1], &c__1);
