...
/* > */
/*  ===================================================================== */
void  wgelqf_(integer *m, integer *n, quadcomplex *a, 
	 ...
	 integer *info)
{
    ...
    extern void  wgelq2_(integer *, integer *, quadcomplex *,
	     integer *, quadcomplex *, quadcomplex *, integer *), xerbla_(
	    char *, integer *);
...
/*           A(i:i+ib-1,i:n) */
	    ...
	    i__3 = *n - i__ + 1;
	    wgelq2_(&ib, &i__3, &a[i__ + i__ * a_dim1], lda, &tau[i__], &work[
		    1], &iinfo);
	    if (i__ + ib <= *m) {
...
/*              H = H(i) H(i+1) . . . H(i+ib-1) */
		...
		i__3 = *n - i__ + 1;
		wlarft_("Forward", "Rowwise", &i__3, &ib, &a[i__ + i__ * 
...
/*              Apply H to A(i+ib:m,i:n) from the right */
		...
		i__3 = *m - i__ - ib + 1;
		i__4 = *n - i__ + 1;
		wlarfb_("Right", "No transpose", "Forward", "Rowwise", &i__3, 
...
/*     Use unblocked code to factor the last or only block. */
	...
	i__2 = *m - i__ + 1;
	i__1 = *n - i__ + 1;
	wgelq2_(&i__2, &i__1, &a[i__ + i__ * a_dim1], lda, &tau[i__], &work[1]
		, &iinfo);
    }
