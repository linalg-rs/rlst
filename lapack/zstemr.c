...
/*  ===================================================================== */
void  zstemr_(char *jobz, char *range, integer *n, doublereal *
	 ...
	 integer *lwork, integer *iwork, integer *liwork, integer *info)
{
    ...
    integer itmp;
    doublereal tnrm;
    extern void  dlae2_(doublereal *, doublereal *, doublereal 
    ...
    integer lwmin;
    logical wantz;
    extern void  zswap_(integer *, doublecomplex *, integer *, 
    ...
    integer iindbl;
    logical valeig;
    extern void  dlarrc_(char *, integer *, doublereal *, 
    ...
    integer wbegin;
    doublereal safmin;
    extern void  dlarrj_(integer *, doublereal *, doublereal *,
    ...
    extern void  dlarrr_(integer *, doublereal *, doublereal *,
    ...
    integer nsplit;
    doublereal smlnum;
    extern void  zlarrv_(integer *, doublereal *, doublereal *,
	     doublereal *, doublereal *, doublereal *, integer *, integer *, 
