...
/*  ===================================================================== */
void  zsytri_rook__(char *uplo, integer *n, halfcomplex *a, 
	integer *lda, integer *ipiv, halfcomplex *work, integer *info)
{
    ...
    extern void  kswap_(integer *, halfcomplex *, integer *, 
	    halfcomplex *, integer *), ksymv_(char *, integer *, 
...
/*           Compute column K of the inverse. */
		...
		i__1 = k - 1;
		z__1.r = -1., z__1.i = -0.;
		ksymv_(uplo, &i__1, &z__1, &a[a_offset], lda, &work[1], &c__1,
			 &c_b2, &a[k * a_dim1 + 1], &c__1);
		i__1 = k + k * a_dim1;
		i__2 = k + k * a_dim1;
		i__3 = k - 1;
		whotu_(&z__2, &i__3, &work[1], &c__1, &a[k * a_dim1 + 1], &
			c__1);
...
/*           Compute columns K and K+1 of the inverse. */
		...
		i__2 = k + (k + 1) * a_dim1;
		i__3 = k - 1;
		whotu_(&z__2, &i__3, &a[k * a_dim1 + 1], &c__1, &a[(k + 1) * 
			a_dim1 + 1], &c__1);
		z__1.r = a[i__2].r - z__2.r, z__1.i = a[i__2].i - z__2.i;
		a[i__1].r = z__1.r, a[i__1].i = z__1.i;
		i__1 = k - 1;
		...
		i__2 = k + 1 + (k + 1) * a_dim1;
		i__3 = k - 1;
		whotu_(&z__2, &i__3, &work[1], &c__1, &a[(k + 1) * a_dim1 + 1]
			, &c__1);
		z__1.r = a[i__2].r - z__2.r, z__1.i = a[i__2].i - z__2.i;
		a[i__1].r = z__1.r, a[i__1].i = z__1.i;
	    }
...
/*           submatrix A(1:k+1,1:k+1) */
		...
		if (kp > 1) {
		    i__1 = kp - 1;
		    kswap_(&i__1, &a[k * a_dim1 + 1], &c__1, &a[kp * a_dim1 + 
			    1], &c__1);
		}
		i__1 = k - kp - 1;
		kswap_(&i__1, &a[kp + 1 + k * a_dim1], &c__1, &a[kp + (kp + 1)
			 * a_dim1], lda);
		i__1 = k + k * a_dim1;
...
/*           Compute column K of the inverse. */
		...
		i__1 = *n - k;
		z__1.r = -1., z__1.i = -0.;
		ksymv_(uplo, &i__1, &z__1, &a[k + 1 + (k + 1) * a_dim1], lda, 
			&work[1], &c__1, &c_b2, &a[k + 1 + k * a_dim1], &c__1);
		i__1 = k + k * a_dim1;
		i__2 = k + k * a_dim1;
		i__3 = *n - k;
		whotu_(&z__2, &i__3, &work[1], &c__1, &a[k + 1 + k * a_dim1], 
			&c__1);
		z__1.r = a[i__2].r - z__2.r, z__1.i = a[i__2].i - z__2.i;
		a[i__1].r = z__1.r, a[i__1].i = z__1.i;
	    }
...
/*           Compute columns K-1 and K of the inverse. */
		...
		i__2 = k + (k - 1) * a_dim1;
		i__3 = *n - k;
		whotu_(&z__2, &i__3, &a[k + 1 + k * a_dim1], &c__1, &a[k + 1 
			+ (k - 1) * a_dim1], &c__1);
		z__1.r = a[i__2].r - z__2.r, z__1.i = a[i__2].i - z__2.i;
		a[i__1].r = z__1.r, a[i__1].i = z__1.i;
		i__1 = *n - k;
		...
		i__2 = k - 1 + (k - 1) * a_dim1;
		i__3 = *n - k;
		whotu_(&z__2, &i__3, &work[1], &c__1, &a[k + 1 + (k - 1) * 
			a_dim1], &c__1);
		z__1.r = a[i__2].r - z__2.r, z__1.i = a[i__2].i - z__2.i;
		a[i__1].r = z__1.r, a[i__1].i = z__1.i;
	    }
...
/*           submatrix A(k-1:n,k-1:n) */
		...
		if (kp < *n) {
		    i__1 = *n - kp;
		    kswap_(&i__1, &a[kp + 1 + k * a_dim1], &c__1, &a[kp + 1 + 
			    kp * a_dim1], &c__1);
		}
		i__1 = kp - k - 1;
		kswap_(&i__1, &a[k + 1 + k * a_dim1], &c__1, &a[kp + (k + 1) *
			 a_dim1], lda);
		i__1 = k + k * a_dim1;
		temp.r = a[i__1].r, temp.i = a[i__1].i;
		i__1 = k + k * a_dim1;
