...
/*  ===================================================================== */
void  horbdb6_(integer *m1, integer *m2, integer *n, 
	halfreal *x1, integer *incx1, halfreal *x2, integer *incx2, 
	halfreal *q1, integer *ldq1, halfreal *q2, integer *ldq2, 
...
/*     space */
    ...
    scl1 = 0.;
    ssq1 = 1.;
    hlassq_(m1, &x1[1], incx1, &scl1, &ssq1);
    scl2 = 0.;
    ssq2 = 1.;
    hlassq_(m2, &x2[1], incx2, &scl2, &ssq2);
/* Computing 2nd power */
    d__1 = scl1;
/* Computing 2nd power */
    d__2 = scl2;
	...
	hgemv_("C", m1, n, &c_b4, &q1[q1_offset], ldq1, &x1[1], incx1, &c_b5, 
		&work[1], &c__1);
    }

    hgemv_("C", m2, n, &c_b4, &q2[q2_offset], ldq2, &x2[1], incx2, &c_b4, &
	    work[1], &c__1);

    hgemv_("N", m1, n, &c_b12, &q1[q1_offset], ldq1, &work[1], &c__1, &c_b4, &
	    x1[1], incx1);
    hgemv_("N", m2, n, &c_b12, &q2[q2_offset], ldq2, &work[1], &c__1, &c_b4, &
	    x2[1], incx2);
