...
/*  ===================================================================== */
void  whseqr_(char *job, char *compz, integer *n, integer *ilo,
	 integer *ihi, quadcomplex *h__, integer *ldh, quadcomplex *w, 
	quadcomplex *z__, integer *ldz, quadcomplex *work, integer *lwork,
	 integer *info)
{
...
/*        ==== Quick return in case of a workspace query ==== */
	...
	wlaqr0_(&wantt, &wantz, n, ilo, ihi, &h__[h_offset], ldh, &w[1], ilo, 
		ihi, &z__[z_offset], ldz, &work[1], lwork, info);
/*        ==== Ensure reported workspace size is backward-compatible with */
/*        .    previous LAPACK versions. ==== */
/* Computing MAX */
	d__2 = work[1].r, d__3 = (quadreal) f2cmax(1,*n);
...
/*        ==== copy eigenvalues isolated by ZGEBAL ==== */
	...
	if (*ilo > 1) {
	    i__1 = *ilo - 1;
	    i__2 = *ldh + 1;
	    wcopy_(&i__1, &h__[h_offset], &i__2, &w[1], &c__1);
	}
	if (*ihi < *n) {
	    i__1 = *n - *ihi;
	    i__2 = *ldh + 1;
	    wcopy_(&i__1, &h__[*ihi + 1 + (*ihi + 1) * h_dim1], &i__2, &w[*
		    ihi + 1], &c__1);
	}
...
/*        ==== Initialize Z, if requested ==== */
	...
	if (initz) {
	    wlaset_("A", n, n, &c_b1, &c_b2, &z__[z_offset], ldz);
	}
...
/*        ==== ZLAQR0 for big matrices; ZLAHQR for small ones ==== */
	...
	if (*n > nmin) {
	    wlaqr0_(&wantt, &wantz, n, ilo, ihi, &h__[h_offset], ldh, &w[1], 
		    ilo, ihi, &z__[z_offset], ldz, &work[1], lwork, info);
	} else {

/*           ==== Small matrix ==== */

	    wlahqr_(&wantt, &wantz, n, ilo, ihi, &h__[h_offset], ldh, &w[1], 
...
/*                 .    space to call ZLAQR0 directly. ==== */
		    ...
		    wlaqr0_(&wantt, &wantz, n, ilo, &kbot, &h__[h_offset], 
...
/*                 .    array before calling ZLAQR0. ==== */
		    ...
		    wlacpy_("A", n, n, &h__[h_offset], ldh, hl, &c__49);
		    i__1 = *n + 1 + *n * 49 - 50;
		    hl[i__1].r = 0., hl[i__1].i = 0.;
		    i__1 = 49 - *n;
		    wlaset_("A", &c__49, &i__1, &c_b1, &c_b1, &hl[(*n + 1) * 
			    49 - 49], &c__49);
		    wlaqr0_(&wantt, &wantz, &c__49, ilo, &kbot, hl, &c__49, &
			    w[1], ilo, ihi, &z__[z_offset], ldz, workl, &
			    c__49, info);
		    if (wantt || *info != 0) {
			wlacpy_("A", n, n, hl, &c__49, &h__[h_offset], ldh);
		    }
		}
	    }
	}
...
/*        ==== Clear out the trash, if necessary. ==== */
	...
	if ((wantt || *info != 0) && *n > 2) {
	    i__1 = *n - 2;
	    i__2 = *n - 2;
	    wlaset_("L", &i__1, &i__2, &c_b1, &c_b1, &h__[h_dim1 + 3], ldh);
	}
...
/* Computing MAX */
	d__2 = (quadreal) f2cmax(1,*n), d__3 = work[1].r;
	d__1 = f2cmax(d__2,d__3);
	z__1.r = d__1, z__1.i = 0.;
	work[1].r = z__1.r, work[1].i = z__1.i;
    }
