...
/*  ===================================================================== */
void  wpteqr_(char *compz, integer *n, quadreal *d__, 
	...
	integer *info)
{
    ...
    /* Local variables */
    quadcomplex c__[1]	/* was [1][1] */;
    integer i__;
    quadcomplex vt[1]	/* was [1][1] */;
    integer nru;
    extern logical lsame_(char *, char *);
    extern void  xerbla_(char *, integer *);
    integer icompz;
    extern void  wlaset_(char *, integer *, integer *, 
	    quadcomplex *, quadcomplex *, quadcomplex *, integer *), qpttrf_(integer *, quadreal *, quadreal *, integer *)
	    , wbdsqr_(char *, integer *, integer *, integer *, integer *, 
...
/*     bidiagonal factor. */
    ...
    wbdsqr_("Lower", n, &c__0, &nru, &c__0, &d__[1], &e[1], vt, &c__1, &z__[
