...
static quadreal c_b25 = 1.;
static quadreal c_b27 = 0.;
...
/* > of a doublereal generalized symmetric-definite banded eigenproblem, of */
...
/*  ===================================================================== */
void  qsbgvx_(char *jobz, char *range, char *uplo, integer *n, 
	integer *ka, integer *kb, quadreal *ab, integer *ldab, quadreal *
	bb, integer *ldbb, quadreal *q, integer *ldq, quadreal *vl, 
	quadreal *vu, integer *il, integer *iu, quadreal *abstol, integer 
	*m, quadreal *w, quadreal *z__, integer *ldz, quadreal *work, 
	integer *iwork, integer *ifail, integer *info)
{
    ...
    extern void  qlacpy_(char *, integer *, integer *, 
	    ...
	    xerbla_(char *, integer *), qpbstf_(char *, integer *, 
	    integer *, quadreal *, integer *, integer *), qsbtrd_(
	    char *, char *, integer *, integer *, quadreal *, integer *, 
	    quadreal *, quadreal *, quadreal *, integer *, quadreal *,
	     integer *);
    integer indisp;
    extern void  qsbgst_(char *, char *, integer *, integer *, 
	    integer *, quadreal *, integer *, quadreal *, integer *, 
	    quadreal *, integer *, quadreal *, integer *),
	     qstein_(integer *, quadreal *, quadreal *, integer *, 
...
/*     Form a split Cholesky factorization of B. */
    ...
    qpbstf_(uplo, n, kb, &bb[bb_offset], ldbb, info);
    if (*info != 0) {
	*info = *n + *info;
	return;
    }
...
/*     Transform problem to standard eigenvalue problem. */
    ...
    qsbgst_(jobz, uplo, n, ka, kb, &ab[ab_offset], ldab, &bb[bb_offset], ldbb,
...
/*     Reduce symmetric band matrix to tridiagonal form. */
	...
	*(unsigned char *)vect = 'N';
    ...
    qsbtrd_(vect, uplo, n, ka, &ab[ab_offset], ldab, &work[indd], &work[inde],
...
/*     eigenvalue, then try DSTEBZ. */
	...
	if (! wantz) {
	    ...
	    qlacpy_("A", n, n, &q[q_offset], ldq, &z__[z_offset], ldz);
...
/*     call DSTEIN. */
	...
	*(unsigned char *)order = 'E';
    ...
    indisp = indibl + *n;
    indiwo = indisp + *n;
    qstebz_(range, order, n, vl, vu, il, iu, abstol, &work[indd], &work[inde],
...
/*        form to eigenvectors returned by DSTEIN. */
	...
	i__1 = *m;
	for (j = 1; j <= i__1; ++j) {
	    qcopy_(n, &z__[j * z_dim1 + 1], &c__1, &work[1], &c__1);
	    qgemv_("N", n, n, &c_b25, &q[q_offset], ldq, &work[1], &c__1, &
