...
/*  ===================================================================== */
void  kpprfs_(char *uplo, integer *n, integer *nrhs, 
	halfcomplex *ap, halfcomplex *afp, halfcomplex *b, integer *ldb,
	...
	halfcomplex *work, halfreal *rwork, integer *info)
{
    ...
    halfreal lstres;
    extern void  kpptrs_(char *, integer *, integer *, 
...
/*           Update solution and try again. */
	    ...
	    kpptrs_(uplo, n, &c__1, &afp[1], &work[1], n, info);
