...
/* > */
/*  ===================================================================== */
void  wgeqrt_(integer *m, integer *n, integer *nb, 
	quadcomplex *a, integer *lda, quadcomplex *t, integer *ldt, 
	quadcomplex *work, integer *info)
{
    ...
    extern void  xerbla_(char *, integer *), wlarfb_(
	    ...
	    quadcomplex *, integer *, quadcomplex *, integer *), wgeqrt2_(integer *, integer *, 
	    quadcomplex *, integer *, quadcomplex *, integer *, integer *)
	    , wgeqrt3_(integer *, integer *, quadcomplex *, integer *, 
...
/*     Compute the QR factorization of the current block A(I:M,I:I+IB-1) */
	...
	if (TRUE_) {
	    i__3 = *m - i__ + 1;
	    wgeqrt3_(&i__3, &ib, &a[i__ + i__ * a_dim1], lda, &t[i__ * t_dim1 
		    + 1], ldt, &iinfo);
	} else {
	    i__3 = *m - i__ + 1;
	    wgeqrt2_(&i__3, &ib, &a[i__ + i__ * a_dim1], lda, &t[i__ * t_dim1 
		    + 1], ldt, &iinfo);
	}
	if (i__ + ib <= *n) {
...
/*     Update by applying H**H to A(I:M,I+IB:N) from the left */
	    ...
	    i__4 = *n - i__ - ib + 1;
	    i__5 = *n - i__ - ib + 1;
	    wlarfb_("L", "C", "F", "C", &i__3, &i__4, &ib, &a[i__ + i__ * 
