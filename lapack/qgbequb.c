...
/*  ===================================================================== */
void  qgbequb_(integer *m, integer *n, integer *kl, integer *
	ku, quadreal *ab, integer *ldab, quadreal *r__, quadreal *c__, 
	quadreal *rowcnd, quadreal *colcnd, quadreal *amax, integer *
	info)
{
    ...
    /* Local variables */
    integer i__, j, kd;
    quadreal radix, rcmin, rcmax;
    extern quadreal qlamch_(char *);
    extern void  xerbla_(char *, integer *);
    quadreal bignum, logrdx, smlnum;
