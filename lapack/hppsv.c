...
/* > \verbatim */
/* > */
/* > DPPSV computes the solution to a doublereal system of linear equations */
/* >    A * X = B, */
...
/* > */
/*  ===================================================================== */
void  hppsv_(char *uplo, integer *n, integer *nrhs, halfreal 
	*ap, halfreal *b, integer *ldb, integer *info)
{
    ...
    extern void  xerbla_(char *, integer *), hpptrf_(
	    char *, integer *, halfreal *, integer *), hpptrs_(char 
...
/*     Compute the Cholesky factorization A = U**T*U or A = L*L**T. */
    ...
    hpptrf_(uplo, n, &ap[1], info);
    if (*info == 0) {

/*        Solve the system A*X = B, overwriting B with X. */

	hpptrs_(uplo, n, nrhs, &ap[1], &b[b_offset], ldb, info);
