...
/* > 1-norm) of a doublereal symmetric packed matrix A using the factorization */
...
/*  ===================================================================== */
void  qspcon_(char *uplo, integer *n, quadreal *ap, integer *
	ipiv, quadreal *anorm, quadreal *rcond, quadreal *work, integer 
	*iwork, integer *info)
{
