...
/* > */
/*  ===================================================================== */
void  hsyevr_(char *jobz, char *range, char *uplo, integer *n, 
	halfreal *a, integer *lda, halfreal *vl, halfreal *vu, integer *
	il, integer *iu, halfreal *abstol, integer *m, halfreal *w, 
	...
	integer *lwork, integer *iwork, integer *liwork, integer *info)
{
    ...
    extern void  hstebz_(char *, char *, integer *, halfreal 
	    *, halfreal *, integer *, integer *, halfreal *, halfreal *,
	    ...
	    hstemr_(char *, char *, integer *, halfreal *, halfreal *, 
	    halfreal *, halfreal *, integer *, integer *, integer *, 
	    halfreal *, halfreal *, integer *, integer *, integer *, 
	    logical *, halfreal *, integer *, integer *, integer *, integer 
	    *);
    integer liwmin;
    logical tryrac;
    extern void  hormtr_(char *, char *, char *, integer *, 
	    integer *, halfreal *, integer *, halfreal *, halfreal *, 
	    integer *, halfreal *, integer *, integer *);
    integer llwrkn, llwork, nsplit;
    halfreal smlnum;
    extern void  hsytrd_(char *, integer *, halfreal *, 
...
/*     Scale matrix to allowable range, if necessary. */
	...
	if (lower) {
	    ...
	    for (j = 1; j <= i__1; ++j) {
		i__2 = *n - j + 1;
		hscal_(&i__2, &sigma, &a[j + j * a_dim1], &c__1);
/* L10: */
	    }
	} else {
	    i__1 = *n;
	    for (j = 1; j <= i__1; ++j) {
		hscal_(&j, &sigma, &a[j * a_dim1 + 1], &c__1);
/* L20: */
	    }
	}
	if (*abstol > 0.) {
...
/*     Call DSYTRD to reduce symmetric matrix to tridiagonal form. */
    ...
    hsytrd_(uplo, n, &a[a_offset], lda, &work[indd], &work[inde], &work[
...
/*     then call DSTERF or DSTEMR and DORMTR. */
	...
	if (! wantz) {
	    ...
	    i__1 = *n - 1;
	    hcopy_(&i__1, &work[inde], &c__1, &work[indee], &c__1);
	    hcopy_(n, &work[indd], &c__1, &work[inddd], &c__1);
	    ...
	    hstemr_(jobz, "A", n, &work[inddd], &work[indee], vl, vu, il, iu, 
...
/*        form to eigenvectors returned by DSTEMR. */
		...
		hormtr_("L", uplo, "N", n, m, &a[a_offset], lda, &work[indtau]
...
/*        form to eigenvectors returned by DSTEIN. */
	...
	indwkn = inde;
	llwrkn = *lwork - indwkn + 1;
	hormtr_("L", uplo, "N", n, m, &a[a_offset], lda, &work[indtau], &z__[
