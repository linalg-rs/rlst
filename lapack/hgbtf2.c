...
/* > \verbatim */
/* > */
/* > DGBTF2 computes an LU factorization of a doublereal m-by-n band matrix A */
...
/* > */
/*  ===================================================================== */
void  hgbtf2_(integer *m, integer *n, integer *kl, integer *ku,
	 halfreal *ab, integer *ldab, integer *ipiv, integer *info)
{
    ...
    extern void  hger_(integer *, integer *, halfreal *, 
	    ...
	    integer *), hscal_(integer *, halfreal *, halfreal *, integer 
	    *), hswap_(integer *, halfreal *, integer *, halfreal *, 
	    integer *);
...
/* Computing MIN */
	...
	km = f2cmin(i__2,i__3);
	i__2 = km + 1;
	jp = ihamax_(&i__2, &ab[kv + 1 + j * ab_dim1], &c__1);
	ipiv[j] = jp + j - 1;
...
/*           Apply interchange to columns J to JU. */
		...
		i__3 = *ldab - 1;
		i__4 = *ldab - 1;
		hswap_(&i__2, &ab[kv + jp + j * ab_dim1], &i__3, &ab[kv + 1 + 
			j * ab_dim1], &i__4);
	    }
...
/*              Compute multipliers. */
		...
		hscal_(&km, &d__1, &ab[kv + 2 + j * ab_dim1], &c__1);
...
/*              Update trailing submatrix within the band. */
		...
		if (ju > j) {
		    ...
		    i__3 = *ldab - 1;
		    i__4 = *ldab - 1;
		    hger_(&km, &i__2, &c_b9, &ab[kv + 2 + j * ab_dim1], &c__1,
