...
/*  ===================================================================== */
void  qpteqr_(char *compz, integer *n, quadreal *d__, 
...
/*     Quick return if possible */
    ...
    if (icompz == 2) {
	qlaset_("Full", n, n, &c_b7, &c_b8, &z__[z_offset], ldz);
    }
...
/*     bidiagonal factor. */
    ...
    qbdsqr_("Lower", n, &c__0, &nru, &c__0, &d__[1], &e[1], vt, &c__1, &z__[
