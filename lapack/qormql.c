...
/*  ===================================================================== */
void  qormql_(char *side, char *trans, integer *m, integer *n, 
	integer *k, quadreal *a, integer *lda, quadreal *tau, quadreal *
	c__, integer *ldc, quadreal *work, integer *lwork, integer *info)
{
    ...
    integer nbmin, iinfo;
    extern void  qorm2l_(char *, char *, integer *, integer *, 
	    integer *, quadreal *, integer *, quadreal *, quadreal *, 
	    integer *, quadreal *, integer *), qlarfb_(char 
	    *, char *, char *, char *, integer *, integer *, integer *, 
	    quadreal *, integer *, quadreal *, integer *, quadreal *, 
	    integer *, quadreal *, integer *), qlarft_(char *, char *, integer *, integer *, quadreal 
	    *, integer *, quadreal *, quadreal *, integer *), xerbla_(char *, integer *);
...
/*        Use unblocked code */
	...
	qorm2l_(side, trans, m, n, k, &a[a_offset], lda, &tau[1], &c__[
...
/*           H = H(i+ib-1) . . . H(i+1) H(i) */
	    ...
	    i__4 = nq - *k + i__ + ib - 1;
	    qlarft_("Backward", "Columnwise", &i__4, &ib, &a[i__ * a_dim1 + 1]
...
/*           Apply H or H**T */
	    ...
	    qlarfb_(side, trans, "Backward", "Columnwise", &mi, &ni, &ib, &a[
