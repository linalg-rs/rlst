...
/*  ===================================================================== */
void  hgetf2_(integer *m, integer *n, halfreal *a, integer *
...
/*        Find pivot and test for singularity. */
	...
	i__2 = *m - j + 1;
	jp = j - 1 + ihamax_(&i__2, &a[j + j * a_dim1], &c__1);
	ipiv[j] = jp;
	if (a[jp + j * a_dim1] != 0.) {
...
/*           Apply the interchange to columns 1:N. */
	    ...
	    if (jp != j) {
		hswap_(n, &a[j + a_dim1], lda, &a[jp + a_dim1], lda);
	    }
...
/*           Update trailing submatrix. */
	    ...
	    i__2 = *m - j;
	    i__3 = *n - j;
	    hger_(&i__2, &i__3, &c_b8, &a[j + 1 + j * a_dim1], &c__1, &a[j + (
