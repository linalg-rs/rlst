...
/*  ===================================================================== */
void  kggev_(char *jobvl, char *jobvr, integer *n, 
	halfcomplex *a, integer *lda, halfcomplex *b, integer *ldb, 
	halfcomplex *alpha, halfcomplex *beta, halfcomplex *vl, integer 
	*ldvl, halfcomplex *vr, integer *ldvr, halfcomplex *work, integer 
	*lwork, halfreal *rwork, integer *info)
{
    ...
    extern void  klacpy_(char *, integer *, integer *, 
	    ...
	    halfcomplex *, halfcomplex *, integer *), ktgevc_(
	    char *, char *, logical *, integer *, halfcomplex *, integer *, 
	    halfcomplex *, integer *, halfcomplex *, integer *, 
	    halfcomplex *, integer *, integer *, integer *, halfcomplex *,
	     halfreal *, integer *), khgeqz_(char *, char *,
	     char *, integer *, integer *, integer *, halfcomplex *, 
...
/*     (Complex Workspace: need N, prefer N*NB) */
    ...
    if (ilvl) {
	klaset_("Full", n, n, &c_b1, &c_b2, &vl[vl_offset], ldvl);
	if (irows > 1) {
	    i__1 = irows - 1;
	    i__2 = irows - 1;
	    klacpy_("L", &i__1, &i__2, &b[ilo + 1 + ilo * b_dim1], ldb, &vl[
		    ilo + 1 + ilo * vl_dim1], ldvl);
	}
	i__1 = *lwork + 1 - iwrk;
	kungqr_(&irows, &irows, &irows, &vl[ilo + ilo * vl_dim1], ldvl, &work[
...
/*     Initialize VR */
    ...
    if (ilvr) {
	klaset_("Full", n, n, &c_b1, &c_b2, &vr[vr_offset], ldvr);
    }
...
/*        Eigenvectors requested -- work on whole matrix. */
	...
	kgghrd_(jobvl, jobvr, n, &ilo, &ihi, &a[a_offset], lda, &b[b_offset], 
		ldb, &vl[vl_offset], ldvl, &vr[vr_offset], ldvr, &ierr);
    } else {
	kgghrd_("N", "N", &irows, &c__1, &irows, &a[ilo + ilo * a_dim1], lda, 
...
/*     (Real Workspace: need N) */
	...
	*(unsigned char *)chtemp = 'E';
    ...
    i__1 = *lwork + 1 - iwrk;
    khgeqz_(chtemp, jobvl, jobvr, n, &ilo, &ihi, &a[a_offset], lda, &b[
...
/*     (Complex Workspace: need 2*N) */
	...
	ktgevc_(chtemp, "B", ldumma, n, &a[a_offset], lda, &b[b_offset], ldb, 
