...
/*  ===================================================================== */
void  wungtr_(char *uplo, integer *n, quadcomplex *a, 
	 ...
	 integer *info)
{
    ...
    integer lwkopt;
    logical lquery;
    extern void  wungql_(integer *, integer *, integer *, 
...
/*        Generate Q(1:n-1,1:n-1) */
	...
	i__2 = *n - 1;
	i__3 = *n - 1;
	wungql_(&i__1, &i__2, &i__3, &a[a_offset], lda, &tau[1], &work[1], 
		lwork, &iinfo);
...
/*           Generate Q(2:n,2:n) */
	    ...
	    i__2 = *n - 1;
	    i__3 = *n - 1;
	    wungqr_(&i__1, &i__2, &i__3, &a[(a_dim1 << 1) + 2], lda, &tau[1], 
		    &work[1], lwork, &iinfo);
	}
    }
    work[1].r = (quadreal) lwkopt, work[1].i = 0.;
