...
/*  ===================================================================== */
void  wgttrs_(char *trans, integer *n, integer *nrhs, 
	...
	integer *info)
{
    ...
    /* Local variables */
    integer j, jb, nb;
    extern void  wgtts2_(integer *, integer *, integer *, 
...
/* Computing MAX */
    ...
    if (nb >= *nrhs) {
	wgtts2_(&itrans, n, nrhs, &dl[1], &d__[1], &du[1], &du2[1], &ipiv[1], 
		&b[b_offset], ldb);
    } else {
	i__1 = *nrhs;
	i__2 = nb;
...
/* Computing MIN */
	    i__3 = *nrhs - j + 1;
	    jb = f2cmin(i__3,nb);
	    wgtts2_(&itrans, n, &jb, &dl[1], &d__[1], &du[1], &du2[1], &ipiv[
		    1], &b[j * b_dim1 + 1], ldb);
/* L10: */
	}
    }
