...
/*  ===================================================================== */
void  hgtrfs_(char *trans, integer *n, integer *nrhs, 
	halfreal *dl, halfreal *d__, halfreal *du, halfreal *dlf, 
	halfreal *df, halfreal *duf, halfreal *du2, integer *ipiv, 
	...
	info)
{
    ...
    extern void  hlagtm_(char *, integer *, integer *, 
...
/*        where op(A) = A, A**T, or A**H, depending on TRANS. */
	...
	hlagtm_(trans, n, &c__1, &c_b18, &dl[1], &d__[1], &du[1], &x[j * 
...
/*           Update solution and try again. */
	    ...
	    hgttrs_(trans, n, &c__1, &dlf[1], &df[1], &duf[1], &du2[1], &ipiv[
		    1], &work[*n + 1], n, info);
	    haxpy_(n, &c_b19, &work[*n + 1], &c__1, &x[j * x_dim1 + 1], &c__1)
		    ;
	    lstres = berr[j];
	    ++count;
	    goto L20;
...
/*              Multiply by diag(W)*inv(op(A)**T). */
		...
		hgttrs_(transt, n, &c__1, &dlf[1], &df[1], &duf[1], &du2[1], &
...
/* L90: */
		...
		hgttrs_(transn, n, &c__1, &dlf[1], &df[1], &duf[1], &du2[1], &
			ipiv[1], &work[*n + 1], n, info);
	    }
	    goto L70;
	}
