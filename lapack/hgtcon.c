...
/* > \verbatim */
/* > */
/* > DGTCON estimates the reciprocal of the condition number of a doublereal */
...
/*  ===================================================================== */
void  hgtcon_(char *norm, integer *n, halfreal *dl, 
	halfreal *d__, halfreal *du, halfreal *du2, integer *ipiv, 
	...
	iwork, integer *info)
{
    ...
    extern void  hlacn2_(integer *, halfreal *, halfreal *,
	     integer *, halfreal *, integer *, integer *), xerbla_(char *, 
	    integer *);
    halfreal ainvnm;
    logical onenrm;
...
/*           Multiply by inv(U)*inv(L). */
	    ...
	    hgttrs_("No transpose", n, &c__1, &dl[1], &d__[1], &du[1], &du2[1]
		    , &ipiv[1], &work[1], n, info);
	} else {

/*           Multiply by inv(L**T)*inv(U**T). */

	    hgttrs_("Transpose", n, &c__1, &dl[1], &d__[1], &du[1], &du2[1], &
		    ipiv[1], &work[1], n, info);
	}
	goto L20;
    }
