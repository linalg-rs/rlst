...
/*  ===================================================================== */
void  wsptri_(char *uplo, integer *n, quadcomplex *ap, 
	integer *ipiv, quadcomplex *work, integer *info)
{
    ...
    extern void  wswap_(integer *, quadcomplex *, integer *, 
	    quadcomplex *, integer *), wspmv_(char *, integer *, 
	    quadcomplex *, quadcomplex *, quadcomplex *, integer *, 
	    quadcomplex *, quadcomplex *, integer *), xerbla_(
	    char *, integer *);
    integer kcnext;
...
/*           Compute column K of the inverse. */
	    ...
	    if (k > 1) {
		i__1 = k - 1;
		wcopy_(&i__1, &ap[kc], &c__1, &work[1], &c__1);
		i__1 = k - 1;
		z__1.r = -1., z__1.i = -0.;
		wspmv_(uplo, &i__1, &z__1, &ap[1], &work[1], &c__1, &c_b2, &
			ap[kc], &c__1);
		i__1 = kc + k - 1;
		i__2 = kc + k - 1;
		i__3 = k - 1;
		wqotu_(&z__2, &i__3, &work[1], &c__1, &ap[kc], &c__1);
...
/*           Compute columns K and K+1 of the inverse. */
		...
		i__2 = kcnext + k - 1;
		i__3 = k - 1;
		wqotu_(&z__2, &i__3, &ap[kc], &c__1, &ap[kcnext], &c__1);
		z__1.r = ap[i__2].r - z__2.r, z__1.i = ap[i__2].i - z__2.i;
		ap[i__1].r = z__1.r, ap[i__1].i = z__1.i;
		i__1 = k - 1;
		wcopy_(&i__1, &ap[kcnext], &c__1, &work[1], &c__1);
		i__1 = k - 1;
		z__1.r = -1., z__1.i = -0.;
		wspmv_(uplo, &i__1, &z__1, &ap[1], &work[1], &c__1, &c_b2, &
			ap[kcnext], &c__1);
		...
		i__2 = kcnext + k;
		i__3 = k - 1;
		wqotu_(&z__2, &i__3, &work[1], &c__1, &ap[kcnext], &c__1);
		z__1.r = ap[i__2].r - z__2.r, z__1.i = ap[i__2].i - z__2.i;
		ap[i__1].r = z__1.r, ap[i__1].i = z__1.i;
	    }
	    kstep = 2;
...
/*           submatrix A(1:k+1,1:k+1) */
	    ...
	    kpc = (kp - 1) * kp / 2 + 1;
	    i__1 = kp - 1;
	    wswap_(&i__1, &ap[kc], &c__1, &ap[kpc], &c__1);
	    kx = kpc + kp - 1;
	    i__1 = k - 1;
	    for (j = kp + 1; j <= i__1; ++j) {
		kx = kx + j - 1;
...
/*           Compute column K of the inverse. */
	    ...
	    if (k < *n) {
		i__1 = *n - k;
		wcopy_(&i__1, &ap[kc + 1], &c__1, &work[1], &c__1);
		i__1 = *n - k;
		z__1.r = -1., z__1.i = -0.;
		wspmv_(uplo, &i__1, &z__1, &ap[kc + *n - k + 1], &work[1], &
			c__1, &c_b2, &ap[kc + 1], &c__1);
		i__1 = kc;
		i__2 = kc;
		i__3 = *n - k;
		wqotu_(&z__2, &i__3, &work[1], &c__1, &ap[kc + 1], &c__1);
		z__1.r = ap[i__2].r - z__2.r, z__1.i = ap[i__2].i - z__2.i;
		ap[i__1].r = z__1.r, ap[i__1].i = z__1.i;
	    }
	    kstep = 1;
...
/*           Compute columns K-1 and K of the inverse. */
		...
		i__2 = kcnext + 1;
		i__3 = *n - k;
		wqotu_(&z__2, &i__3, &ap[kc + 1], &c__1, &ap[kcnext + 2], &
			c__1);
		z__1.r = ap[i__2].r - z__2.r, z__1.i = ap[i__2].i - z__2.i;
		ap[i__1].r = z__1.r, ap[i__1].i = z__1.i;
		i__1 = *n - k;
		wcopy_(&i__1, &ap[kcnext + 2], &c__1, &work[1], &c__1);
		i__1 = *n - k;
		z__1.r = -1., z__1.i = -0.;
		wspmv_(uplo, &i__1, &z__1, &ap[kc + (*n - k + 1)], &work[1], &
		...
		i__2 = kcnext;
		i__3 = *n - k;
		wqotu_(&z__2, &i__3, &work[1], &c__1, &ap[kcnext + 2], &c__1);
		z__1.r = ap[i__2].r - z__2.r, z__1.i = ap[i__2].i - z__2.i;
		ap[i__1].r = z__1.r, ap[i__1].i = z__1.i;
	    }
	    kstep = 2;
...
/*           submatrix A(k-1:n,k-1:n) */
	    ...
	    if (kp < *n) {
		i__1 = *n - kp;
		wswap_(&i__1, &ap[kc + kp - k + 1], &c__1, &ap[kpc + 1], &
			c__1);
	    }
	    kx = kc + kp - k;
	    i__1 = kp - 1;
