...
/*  ===================================================================== */
void  khbevd_(char *jobz, char *uplo, integer *n, integer *kd, 
	...
	integer *lrwork, integer *iwork, integer *liwork, integer *info)
{
    ...
    extern void  hsterf_(integer *, halfreal *, halfreal *,
	    ...
	    *), khbtrd_(char *, char *, integer *, integer *, 
...
/*     Scale matrix to allowable range, if necessary. */
    ...
    if (iscale == 1) {
	if (lower) {
	    klascl_("B", kd, kd, &c_b13, &sigma, n, n, &ab[ab_offset], ldab, 
		    info);
	} else {
	    klascl_("Q", kd, kd, &c_b13, &sigma, n, n, &ab[ab_offset], ldab, 
		    info);
	}
    }
...
/*     For eigenvalues only, call DSTERF.  For eigenvectors, call ZSTEDC. */
	...
	kgemm_("N", "N", n, n, n, &c_b2, &z__[z_offset], ldz, &work[1], n, &
		c_b1, &work[indwk2], n);
