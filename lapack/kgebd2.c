...
/* > */
/*  ===================================================================== */
void  kgebd2_(integer *m, integer *n, halfcomplex *a, 
	integer *lda, halfreal *d__, halfreal *e, halfcomplex *tauq, 
	halfcomplex *taup, halfcomplex *work, integer *info)
{
...
/*           Apply H(i)**H to A(i:m,i+1:n) from the left */
		...
		klarf_("Left", &i__2, &i__3, &a[i__ + i__ * a_dim1], &c__1, &
...
/*              Apply G(i) to A(i+1:m,i+1:n) from the right */
		...
		i__2 = *m - i__;
		i__3 = *n - i__;
		klarf_("Right", &i__2, &i__3, &a[i__ + (i__ + 1) * a_dim1], 
...
/*           Apply G(i) to A(i+1:m,i:n) from the right */
		...
		i__2 = *m - i__;
		i__3 = *n - i__ + 1;
		klarf_("Right", &i__2, &i__3, &a[i__ + i__ * a_dim1], lda, &
...
/*              Apply H(i)**H to A(i+1:m,i+1:n) from the left */
		...
		i__3 = *n - i__;
		d_cnjg(&z__1, &tauq[i__]);
		klarf_("Left", &i__2, &i__3, &a[i__ + 1 + i__ * a_dim1], &
