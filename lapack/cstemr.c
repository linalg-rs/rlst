...
/*  ===================================================================== */
void  cstemr_(char *jobz, char *range, integer *n, real *d__, 
	...
	liwork, integer *info)
{
    ...
    real tnrm;
    integer inde2;
    extern void  slae2_(real *, real *, real *, real *, real *)
	    ;
    integer itmp2;
    ...
    extern void  scopy_(integer *, real *, integer *, real *, 
	    integer *);
    logical wantz;
    extern void  slaev2_(real *, real *, real *, real *, real *
	    , real *, real *);
    logical alleig;
    integer ibegin;
    logical indeig;
    ...
    extern void  slarrc_(char *, integer *, real *, real *, 
    ...
    extern void  slarrj_(integer *, real *, real *, integer *, 
	    integer *, real *, integer *, real *, real *, real *, integer *, 
	    real *, real *, integer *);
    integer nsplit;
    extern void  slarrr_(integer *, real *, real *, integer *);
    real smlnum;
    extern void  slasrt_(char *, integer *, real *, integer *);
...
/*     Get machine constants. */
    ...
    rmin = M(sqrt)(smlnum);
/* Computing MIN */
    r__1 = M(sqrt)(bignum), r__2 = 1.f / M(sqrt)(sqrt(safmin));
...
/* Computing MAX */
	    r__1 = M(sqrt)(eps) * .05f, r__2 = eps * 4.f;
	    rtol1 = f2cmax(r__1,r__2);
/* Computing MAX */
	    r__1 = M(sqrt)(eps) * .005f, r__2 = eps * 4.f;
