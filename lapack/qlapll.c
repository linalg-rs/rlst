...
/*  ===================================================================== */
void  qlapll_(integer *n, quadreal *x, integer *incx, 
	quadreal *y, integer *incy, quadreal *ssmin)
{
    /* System generated locals */
    integer i__1;

    /* Local variables */
    quadreal c__, a11, a12, a22, tau;
    extern quadreal qdot_(integer *, quadreal *, integer *, quadreal *, 
	    integer *);
    extern void  qlas2_(quadreal *, quadreal *, quadreal 
	    *, quadreal *, quadreal *), qaxpy_(integer *, quadreal *, 
...
/*     Compute the QR factorization of the N-by-2 matrix ( X Y ) */
    ...
    c__ = -tau * qdot_(n, &x[1], incx, &y[1], incy);
    qaxpy_(n, &c__, &x[1], incx, &y[1], incy);
