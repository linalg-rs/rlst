...
/*  ===================================================================== */
void  khpgvd_(integer *itype, char *jobz, char *uplo, integer *
	n, halfcomplex *ap, halfcomplex *bp, halfreal *w, halfcomplex 
	*z__, integer *ldz, halfcomplex *work, integer *lwork, halfreal *
	...
	info)
{
    ...
    extern void  ktpmv_(char *, char *, char *, integer *, 
	    ...
	    char *, integer *);
    integer liwmin;
    extern void  khpevd_(char *, char *, integer *, 
	    halfcomplex *, halfreal *, halfcomplex *, integer *, 
	    halfcomplex *, integer *, halfreal *, integer *, integer *, 
	    integer *, integer *);
    integer lrwmin;
    extern void  khpgst_(integer *, char *, integer *, 
	    halfcomplex *, halfcomplex *, integer *);
    logical lquery;
    extern void  kpptrf_(char *, integer *, halfcomplex *, 
	    integer *);
...
/*     Transform problem to standard eigenvalue problem and solve. */
    ...
    khpevd_(jobz, uplo, n, &ap[1], &w[1], &z__[z_offset], ldz, &work[1], 
	    lwork, &rwork[1], lrwork, &iwork[1], liwork, info);
/* Computing MAX */
    d__1 = (halfreal) lwmin, d__2 = work[1].r;
    lwmin = (integer) f2cmax(d__1,d__2);
/* Computing MAX */
    d__1 = (halfreal) lrwmin;
    lrwmin = (integer) f2cmax(d__1,rwork[1]);
/* Computing MAX */
    d__1 = (halfreal) liwmin, d__2 = (halfreal) iwork[1];
