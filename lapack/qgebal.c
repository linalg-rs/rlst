...
/* > \verbatim */
/* > */
/* > DGEBAL balances a general doublereal matrix A.  This involves, first, */
...
/* > */
/*  ===================================================================== */
void  qgebal_(char *job, integer *n, quadreal *a, integer *
	lda, integer *ilo, integer *ihi, quadreal *scale, integer *info)
{
    ...
    extern void  qswap_(integer *, quadreal *, integer *, 
	    quadreal *, integer *);
    quadreal sfmin1, sfmin2, sfmax1, sfmax2;
...
L20:
    ...
    i__1 = *n - k + 1;
    qswap_(&i__1, &a[j + k * a_dim1], lda, &a[m + k * a_dim1], lda);
...
L140:
	...
	i__2 = l - k + 1;
	c__ = qnrm2_(&i__2, &a[k + i__ * a_dim1], &c__1);
	i__2 = l - k + 1;
	r__ = qnrm2_(&i__2, &a[i__ + k * a_dim1], lda);
	ica = iqamax_(&l, &a[i__ * a_dim1 + 1], &c__1);
	ca = (d__1 = a[ica + i__ * a_dim1], abs(d__1));
	i__2 = *n - k + 1;
	ira = iqamax_(&i__2, &a[i__ + k * a_dim1], lda);
...
L190:
	...
	i__2 = *n - k + 1;
	qscal_(&i__2, &g, &a[i__ + k * a_dim1], lda);
	qscal_(&l, &f, &a[i__ * a_dim1 + 1], &c__1);
