...
/* > \verbatim */
/* > */
/* > DLARFT forms the triangular factor T of a doublereal block reflector H */
...
/* > */
/*  ===================================================================== */
void  hlarft_(char *direct, char *storev, integer *n, integer *
	k, halfreal *v, integer *ldv, halfreal *tau, halfreal *t, 
	integer *ldt)
{
    ...
    extern void  htrmv_(char *, char *, char *, integer *, 
	    halfreal *, integer *, halfreal *, integer *), mecago_();
...
/*                 T(1:i-1,i) := - tau(i) * V(i:j,1:i-1)**T * V(i:j,i) */
		    ...
		    i__3 = i__ - 1;
		    d__1 = -tau[i__];
		    hgemv_("Transpose", &i__2, &i__3, &d__1, &v[i__ + 1 + 
...
/*                 T(1:i-1,i) := - tau(i) * V(1:i-1,i:j) * V(i,i:j)**T */
		    ...
		    i__3 = j - i__;
		    d__1 = -tau[i__];
		    hgemv_("No transpose", &i__2, &i__3, &d__1, &v[(i__ + 1) *
...
/*              T(1:i-1,i) := T(1:i-1,1:i-1) * T(1:i-1,i) */
		...
		i__2 = i__ - 1;
		htrmv_("Upper", "No transpose", "Non-unit", &i__2, &t[
...
/*                    T(i+1:k,i) = -tau(i) * V(j:n-k+i,i+1:k)**T * V(j:n-k+i,i) */
			...
			i__2 = *k - i__;
			d__1 = -tau[i__];
			hgemv_("Transpose", &i__1, &i__2, &d__1, &v[j + (i__ 
...
/*                    T(i+1:k,i) = -tau(i) * V(i+1:k,j:n-k+i) * V(i,j:n-k+i)**T */
			...
			i__2 = *n - *k + i__ - j;
			d__1 = -tau[i__];
			hgemv_("No transpose", &i__1, &i__2, &d__1, &v[i__ + 
...
/*                 T(i+1:k,i) := T(i+1:k,i+1:k) * T(i+1:k,i) */
		    ...
		    i__1 = *k - i__;
		    htrmv_("Lower", "No transpose", "Non-unit", &i__1, &t[i__ 
