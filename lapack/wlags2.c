...
/*  ===================================================================== */
void  wlags2_(logical *upper, quadreal *a1, quadcomplex *
	a2, quadreal *a3, quadreal *b1, quadcomplex *b2, quadreal *b3,
	 quadreal *csu, quadcomplex *snu, quadreal *csv, quadcomplex *
	snv, quadreal *csq, quadcomplex *snq)
{
    ...
    quadreal d__;
    quadcomplex r__, d1;
    quadreal s1, s2, fb, fc;
    quadcomplex ua11, ua12, ua21, ua22, vb11, vb12, vb21, vb22;
    quadreal csl, csr, snl, snr, aua11, aua12, aua21, aua22, avb12, avb11, 
	    avb21, avb22, ua11r, ua22r, vb11r, vb22r;
    extern void  qlasv2_(quadreal *, quadreal *, 
	    quadreal *, quadreal *, quadreal *, quadreal *, 
	    quadreal *, quadreal *, quadreal *), wlartg_(quadcomplex *
...
/*         ( SNL  CSL ) ( 0 D ) ( -SNR  CSR )   ( 0 T ) */
	...
	qlasv2_(&a, &fb, &d__, &s1, &s2, &snr, &csr, &snl, &csl);
...
/*         ( SNL  CSL ) ( C D ) ( -SNR  CSR )   ( 0 T ) */
	...
	qlasv2_(&a, &fc, &d__, &s1, &s2, &snr, &csr, &snl, &csl);
...
/*           zero (2,1) elements of U**H *A and V**H *B. */
		...
		wlartg_(&z__1, &vb21, csq, snq, &r__);
	    } else if ((d__1 = vb21.r, abs(d__1)) + (d__2 = d_imag(&vb21), 
		    abs(d__2)) + abs(vb22r) == 0.) {
		z__1.r = ua22r, z__1.i = 0.;
		wlartg_(&z__1, &ua21, csq, snq, &r__);
