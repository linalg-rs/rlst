...
/*  ===================================================================== */
void  hpstf2_(char *uplo, integer *n, halfreal *a, integer *
...
/*              Pivot OK, so can now swap pivot rows and columns */
		...
		i__2 = j - 1;
		hswap_(&i__2, &a[j * a_dim1 + 1], &c__1, &a[pvt * a_dim1 + 1],
			 &c__1);
		if (pvt < *n) {
		    i__2 = *n - pvt;
		    hswap_(&i__2, &a[j + (pvt + 1) * a_dim1], lda, &a[pvt + (
			    pvt + 1) * a_dim1], lda);
		}
		i__2 = pvt - j - 1;
		hswap_(&i__2, &a[j + (j + 1) * a_dim1], lda, &a[j + 1 + pvt * 
			a_dim1], &c__1);
...
/*           Compute elements J+1:N of row J */
		...
		i__2 = j - 1;
		i__3 = *n - j;
		hgemv_("Trans", &i__2, &i__3, &c_b17, &a[(j + 1) * a_dim1 + 1]
			, lda, &a[j * a_dim1 + 1], &c__1, &c_b19, &a[j + (j + 
			1) * a_dim1], lda);
		i__2 = *n - j;
		d__1 = 1. / ajj;
		hscal_(&i__2, &d__1, &a[j + (j + 1) * a_dim1], lda);
	    }
...
/*              Pivot OK, so can now swap pivot rows and columns */
		...
		a[pvt + pvt * a_dim1] = a[j + j * a_dim1];
		i__2 = j - 1;
		hswap_(&i__2, &a[j + a_dim1], lda, &a[pvt + a_dim1], lda);
		if (pvt < *n) {
		    i__2 = *n - pvt;
		    hswap_(&i__2, &a[pvt + 1 + j * a_dim1], &c__1, &a[pvt + 1 
			    + pvt * a_dim1], &c__1);
		}
		i__2 = pvt - j - 1;
		hswap_(&i__2, &a[j + 1 + j * a_dim1], &c__1, &a[pvt + (j + 1) 
			* a_dim1], lda);
...
/*           Compute elements J+1:N of column J */
		...
		i__2 = *n - j;
		i__3 = j - 1;
		hgemv_("No Trans", &i__2, &i__3, &c_b17, &a[j + 1 + a_dim1], 
			lda, &a[j + a_dim1], lda, &c_b19, &a[j + 1 + j * 
			a_dim1], &c__1);
		i__2 = *n - j;
		d__1 = 1. / ajj;
		hscal_(&i__2, &d__1, &a[j + 1 + j * a_dim1], &c__1);
	    }
