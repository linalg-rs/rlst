...
/*  ===================================================================== */
void  wuncsd_(char *jobu1, char *jobu2, char *jobv1t, char *
	jobv2t, char *trans, char *signs, integer *m, integer *p, integer *q, 
	quadcomplex *x11, integer *ldx11, quadcomplex *x12, integer *
	ldx12, quadcomplex *x21, integer *ldx21, quadcomplex *x22, 
	integer *ldx22, quadreal *theta, quadcomplex *u1, integer *ldu1, 
	quadcomplex *u2, integer *ldu2, quadcomplex *v1t, integer *ldv1t, 
	quadcomplex *v2t, integer *ldv2t, quadcomplex *work, integer *
	...
	info)
{
    ...
    /* Local variables */
    logical colmajor;
    integer lworkmin, lworkopt, i__, j, childinfo, p1, q1, lrworkmin, 
    ...
    extern void  wunbdb_(char *, char *, integer *, integer *, 
...
/* Computing MIN */
	...
	wuncsd_(jobv1t, jobv2t, jobu1, jobu2, transt, signst, m, q, p, &x11[
...
/*     convenient */
	...
	i__1 = *m - *p;
	i__2 = *m - *q;
	wuncsd_(jobu2, jobu1, jobv2t, jobv1t, trans, signst, m, &i__1, &i__2, 
...
/* Computing MAX */
	...
	wbbcsd_(jobu1, jobu2, jobv1t, jobv2t, trans, m, p, q, &theta[1], &
...
/* Computing MAX */
	...
	wungqr_(&i__1, &i__2, &i__3, &u1[u1_offset], &i__4, &u1[u1_offset], &
...
/* Computing MAX */
	i__5 = 1, i__6 = *m - *q;
	i__4 = f2cmax(i__5,i__6);
	wunglq_(&i__1, &i__2, &i__3, &u1[u1_offset], &i__4, &u1[u1_offset], &
		work[1], &c_n1, &childinfo);
...
/* Computing MAX */
	...
	wunbdb_(trans, signs, m, p, q, &x11[x11_offset], ldx11, &x12[
...
/*     Transform to bidiagonal block form */
    ...
    wunbdb_(trans, signs, m, p, q, &x11[x11_offset], ldx11, &x12[x12_offset], 
...
/*     Accumulate Householder reflectors */
	...
	if (wantv1t && *q > 0) {
	    i__1 = *q - 1;
	    i__2 = *q - 1;
	    wlacpy_("U", &i__1, &i__2, &x11[(x11_dim1 << 1) + 1], ldx11, &v1t[
		    (v1t_dim1 << 1) + 2], ldv1t);
	    i__1 = v1t_dim1 + 1;
	...
	if (wantv2t && *m - *q > 0) {
	    i__1 = *m - *q;
	    wlacpy_("U", p, &i__1, &x12[x12_offset], ldx12, &v2t[v2t_offset], 
		    ldv2t);
	    if (*m - *p > *q) {
		i__1 = *m - *p - *q;
		i__2 = *m - *p - *q;
		wlacpy_("U", &i__1, &i__2, &x22[*q + 1 + (*p + 1) * x22_dim1],
		...
		i__2 = *m - *q;
		i__3 = *m - *q;
		wunglq_(&i__1, &i__2, &i__3, &v2t[v2t_offset], ldv2t, &work[
			itauq2], &work[iorglq], &lorglqwork, info);
	    }
	}
    } else {
	if (wantu1 && *p > 0) {
	    wlacpy_("U", q, p, &x11[x11_offset], ldx11, &u1[u1_offset], ldu1);
	    wunglq_(p, p, q, &u1[u1_offset], ldu1, &work[itaup1], &work[
		    iorglq], &lorglqwork, info);
	}
	if (wantu2 && *m - *p > 0) {
	    i__1 = *m - *p;
	    wlacpy_("U", q, &i__1, &x21[x21_offset], ldx21, &u2[u2_offset], 
		    ldu2);
	    i__1 = *m - *p;
	    i__2 = *m - *p;
	    wunglq_(&i__1, &i__2, q, &u2[u2_offset], ldu2, &work[itaup2], &
		    work[iorglq], &lorglqwork, info);
	}
	if (wantv1t && *q > 0) {
	    i__1 = *q - 1;
	    i__2 = *q - 1;
	    wlacpy_("L", &i__1, &i__2, &x11[x11_dim1 + 2], ldx11, &v1t[(
		    v1t_dim1 << 1) + 2], ldv1t);
	    i__1 = v1t_dim1 + 1;
	    v1t[i__1].r = 1., v1t[i__1].i = 0.;
	    i__1 = *q;
	    ...
	    i__2 = *q - 1;
	    i__3 = *q - 1;
	    wungqr_(&i__1, &i__2, &i__3, &v1t[(v1t_dim1 << 1) + 2], ldv1t, &
...
/* Computing MIN */
	    ...
	    q1 = f2cmin(i__1,*m);
	    i__1 = *m - *q;
	    wlacpy_("L", &i__1, p, &x12[x12_offset], ldx12, &v2t[v2t_offset], 
		    ldv2t);
	    if (*m > *p + *q) {
		i__1 = *m - *p - *q;
		i__2 = *m - *p - *q;
		wlacpy_("L", &i__1, &i__2, &x22[p1 + q1 * x22_dim1], ldx22, &
			v2t[*p + 1 + (*p + 1) * v2t_dim1], ldv2t);
	    }
	    i__1 = *m - *q;
	    i__2 = *m - *q;
	    i__3 = *m - *q;
	    wungqr_(&i__1, &i__2, &i__3, &v2t[v2t_offset], ldv2t, &work[
...
/*     Compute the CSD of the matrix in bidiagonal-block form */
    ...
    wbbcsd_(jobu1, jobu2, jobv1t, jobv2t, trans, m, p, q, &theta[1], &rwork[
...
/*     corner of (2,2)-block */
	...
	if (colmajor) {
	    ...
	    i__1 = *m - *p;
	    i__2 = *m - *p;
	    wlapmr_(&c_false, &i__1, &i__2, &u2[u2_offset], ldu2, &iwork[1]);
	}
    }
    if (*m > 0 && wantv2t) {
	i__1 = *p;
	...
	if (! colmajor) {
	    i__1 = *m - *q;
	    i__2 = *m - *q;
	    wlapmt_(&c_false, &i__1, &i__2, &v2t[v2t_offset], ldv2t, &iwork[1]
		    );
	} else {
	    i__1 = *m - *q;
	    i__2 = *m - *q;
	    wlapmr_(&c_false, &i__1, &i__2, &v2t[v2t_offset], ldv2t, &iwork[1]
		    );
	}
    }
