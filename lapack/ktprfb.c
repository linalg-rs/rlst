...
static halfcomplex c_b14 = {1.,0.};
static halfcomplex c_b22 = {0.,0.};
static halfcomplex c_b29 = {-1.,-0.};
...
/* > */
/*  ===================================================================== */
void  ktprfb_(char *side, char *trans, char *direct, char *
	storev, integer *m, integer *n, integer *k, integer *l, halfcomplex 
	*v, integer *ldv, halfcomplex *t, integer *ldt, halfcomplex *a, 
	integer *lda, halfcomplex *b, integer *ldb, halfcomplex *work, 
	integer *ldwork)
{
...
/* Computing MIN */
	...
	ktrmm_("L", "U", "C", "N", l, n, &c_b14, &v[mp + v_dim1], ldv, &work[
		work_offset], ldwork);
	i__1 = *m - *l;
	kgemm_("C", "N", l, n, &i__1, &c_b14, &v[v_offset], ldv, &b[b_offset],
		 ldb, &c_b14, &work[work_offset], ldwork);
	i__1 = *k - *l;
	kgemm_("C", "N", &i__1, n, m, &c_b14, &v[kp * v_dim1 + 1], ldv, &b[
	...
	ktrmm_("L", "U", trans, "N", k, n, &c_b14, &t[t_offset], ldt, &work[
		work_offset], ldwork);
	...
	i__1 = *m - *l;
	kgemm_("N", "N", &i__1, n, k, &c_b29, &v[v_offset], ldv, &work[
		work_offset], ldwork, &c_b14, &b[b_offset], ldb);
	i__1 = *k - *l;
	kgemm_("N", "N", l, n, &i__1, &c_b29, &v[mp + kp * v_dim1], ldv, &
		work[kp + work_dim1], ldwork, &c_b14, &b[mp + b_dim1], ldb);
	ktrmm_("L", "U", "N", "N", l, n, &c_b14, &v[mp + v_dim1], ldv, &work[
		work_offset], ldwork);
	i__1 = *n;
	for (j = 1; j <= i__1; ++j) {
	    i__2 = *l;
...
/* Computing MIN */
	...
	ktrmm_("R", "U", "N", "N", m, l, &c_b14, &v[np + v_dim1], ldv, &work[
		work_offset], ldwork);
	i__1 = *n - *l;
	kgemm_("N", "N", m, l, &i__1, &c_b14, &b[b_offset], ldb, &v[v_offset],
		 ldv, &c_b14, &work[work_offset], ldwork);
	i__1 = *k - *l;
	kgemm_("N", "N", m, &i__1, n, &c_b14, &b[b_offset], ldb, &v[kp * 
	...
	ktrmm_("R", "U", trans, "N", m, k, &c_b14, &t[t_offset], ldt, &work[
		work_offset], ldwork);
	...
	i__1 = *n - *l;
	kgemm_("N", "C", m, &i__1, k, &c_b29, &work[work_offset], ldwork, &v[
		v_offset], ldv, &c_b14, &b[b_offset], ldb);
	i__1 = *k - *l;
	kgemm_("N", "C", m, l, &i__1, &c_b29, &work[kp * work_dim1 + 1], 
		ldwork, &v[np + kp * v_dim1], ldv, &c_b14, &b[np * b_dim1 + 1]
		, ldb);
	ktrmm_("R", "U", "C", "N", m, l, &c_b14, &v[np + v_dim1], ldv, &work[
		work_offset], ldwork);
	i__1 = *l;
	for (j = 1; j <= i__1; ++j) {
	    i__2 = *m;
...
/* Computing MIN */
	...
	ktrmm_("L", "L", "C", "N", l, n, &c_b14, &v[kp * v_dim1 + 1], ldv, &
		work[kp + work_dim1], ldwork);
	i__1 = *m - *l;
	kgemm_("C", "N", l, n, &i__1, &c_b14, &v[mp + kp * v_dim1], ldv, &b[
		mp + b_dim1], ldb, &c_b14, &work[kp + work_dim1], ldwork);
	i__1 = *k - *l;
	kgemm_("C", "N", &i__1, n, m, &c_b14, &v[v_offset], ldv, &b[b_offset],
	...
	ktrmm_("L", "L", trans, "N", k, n, &c_b14, &t[t_offset], ldt, &work[
		work_offset], ldwork);
	...
	i__1 = *m - *l;
	kgemm_("N", "N", &i__1, n, k, &c_b29, &v[mp + v_dim1], ldv, &work[
		work_offset], ldwork, &c_b14, &b[mp + b_dim1], ldb);
	i__1 = *k - *l;
	kgemm_("N", "N", l, n, &i__1, &c_b29, &v[v_offset], ldv, &work[
		work_offset], ldwork, &c_b14, &b[b_offset], ldb);
	ktrmm_("L", "L", "N", "N", l, n, &c_b14, &v[kp * v_dim1 + 1], ldv, &
		work[kp + work_dim1], ldwork);
	i__1 = *n;
	for (j = 1; j <= i__1; ++j) {
	    i__2 = *l;
...
/* Computing MIN */
	...
	ktrmm_("R", "L", "N", "N", m, l, &c_b14, &v[kp * v_dim1 + 1], ldv, &
		work[kp * work_dim1 + 1], ldwork);
	i__1 = *n - *l;
	kgemm_("N", "N", m, l, &i__1, &c_b14, &b[np * b_dim1 + 1], ldb, &v[np 
		+ kp * v_dim1], ldv, &c_b14, &work[kp * work_dim1 + 1], 
		ldwork);
	i__1 = *k - *l;
	kgemm_("N", "N", m, &i__1, n, &c_b14, &b[b_offset], ldb, &v[v_offset],
	...
	ktrmm_("R", "L", trans, "N", m, k, &c_b14, &t[t_offset], ldt, &work[
		work_offset], ldwork);
	...
	i__1 = *k - *l;
	kgemm_("N", "C", m, l, &i__1, &c_b29, &work[work_offset], ldwork, &v[
		v_offset], ldv, &c_b14, &b[b_offset], ldb);
	ktrmm_("R", "L", "C", "N", m, l, &c_b14, &v[kp * v_dim1 + 1], ldv, &
		work[kp * work_dim1 + 1], ldwork);
	i__1 = *l;
	for (j = 1; j <= i__1; ++j) {
	    i__2 = *m;
...
/* Computing MIN */
	...
	ktrmm_("L", "L", "N", "N", l, n, &c_b14, &v[mp * v_dim1 + 1], ldv, &
		work[work_offset], ldb);
	i__1 = *m - *l;
	kgemm_("N", "N", l, n, &i__1, &c_b14, &v[v_offset], ldv, &b[b_offset],
		 ldb, &c_b14, &work[work_offset], ldwork);
	i__1 = *k - *l;
	kgemm_("N", "N", &i__1, n, m, &c_b14, &v[kp + v_dim1], ldv, &b[
		b_offset], ldb, &c_b22, &work[kp + work_dim1], ldwork);
	...
	i__1 = *m - *l;
	kgemm_("C", "N", &i__1, n, k, &c_b29, &v[v_offset], ldv, &work[
		work_offset], ldwork, &c_b14, &b[b_offset], ldb);
	i__1 = *k - *l;
	kgemm_("C", "N", l, n, &i__1, &c_b29, &v[kp + mp * v_dim1], ldv, &
		work[kp + work_dim1], ldwork, &c_b14, &b[mp + b_dim1], ldb);
	ktrmm_("L", "L", "C", "N", l, n, &c_b14, &v[mp * v_dim1 + 1], ldv, &
...
/* Computing MIN */
	...
	ktrmm_("R", "L", "C", "N", m, l, &c_b14, &v[np * v_dim1 + 1], ldv, &
		work[work_offset], ldwork);
	i__1 = *n - *l;
	kgemm_("N", "C", m, l, &i__1, &c_b14, &b[b_offset], ldb, &v[v_offset],
		 ldv, &c_b14, &work[work_offset], ldwork);
	i__1 = *k - *l;
	kgemm_("N", "C", m, &i__1, n, &c_b14, &b[b_offset], ldb, &v[kp + 
	...
	i__1 = *n - *l;
	kgemm_("N", "N", m, &i__1, k, &c_b29, &work[work_offset], ldwork, &v[
		v_offset], ldv, &c_b14, &b[b_offset], ldb);
	i__1 = *k - *l;
	kgemm_("N", "N", m, l, &i__1, &c_b29, &work[kp * work_dim1 + 1], 
		ldwork, &v[kp + np * v_dim1], ldv, &c_b14, &b[np * b_dim1 + 1]
		, ldb);
	ktrmm_("R", "L", "N", "N", m, l, &c_b14, &v[np * v_dim1 + 1], ldv, &
		work[work_offset], ldwork);
	i__1 = *l;
	for (j = 1; j <= i__1; ++j) {
	    i__2 = *m;
...
/* Computing MIN */
	...
	ktrmm_("L", "U", "N", "N", l, n, &c_b14, &v[kp + v_dim1], ldv, &work[
		kp + work_dim1], ldwork);
	i__1 = *m - *l;
	kgemm_("N", "N", l, n, &i__1, &c_b14, &v[kp + mp * v_dim1], ldv, &b[
		mp + b_dim1], ldb, &c_b14, &work[kp + work_dim1], ldwork);
	i__1 = *k - *l;
	kgemm_("N", "N", &i__1, n, m, &c_b14, &v[v_offset], ldv, &b[b_offset],
		 ldb, &c_b22, &work[work_offset], ldwork);
	...
	i__1 = *m - *l;
	kgemm_("C", "N", &i__1, n, k, &c_b29, &v[mp * v_dim1 + 1], ldv, &work[
		work_offset], ldwork, &c_b14, &b[mp + b_dim1], ldb);
	i__1 = *k - *l;
	kgemm_("C", "N", l, n, &i__1, &c_b29, &v[v_offset], ldv, &work[
		work_offset], ldwork, &c_b14, &b[b_offset], ldb);
	ktrmm_("L", "U", "C", "N", l, n, &c_b14, &v[kp + v_dim1], ldv, &work[
		kp + work_dim1], ldwork);
	i__1 = *n;
	for (j = 1; j <= i__1; ++j) {
	    i__2 = *l;
...
/* Computing MIN */
	...
	ktrmm_("R", "U", "C", "N", m, l, &c_b14, &v[kp + v_dim1], ldv, &work[
		kp * work_dim1 + 1], ldwork);
	i__1 = *n - *l;
	kgemm_("N", "C", m, l, &i__1, &c_b14, &b[np * b_dim1 + 1], ldb, &v[kp 
		+ np * v_dim1], ldv, &c_b14, &work[kp * work_dim1 + 1], 
		ldwork);
	i__1 = *k - *l;
	kgemm_("N", "C", m, &i__1, n, &c_b14, &b[b_offset], ldb, &v[v_offset],
		 ldv, &c_b22, &work[work_offset], ldwork);
	...
	i__1 = *k - *l;
	kgemm_("N", "N", m, l, &i__1, &c_b29, &work[work_offset], ldwork, &v[
		v_offset], ldv, &c_b14, &b[b_offset], ldb);
	ktrmm_("R", "U", "N", "N", m, l, &c_b14, &v[kp + v_dim1], ldv, &work[
		kp * work_dim1 + 1], ldwork);
	i__1 = *l;
	for (j = 1; j <= i__1; ++j) {
	    i__2 = *m;
