...
/*  ===================================================================== */
void  dsytri_rook__(char *uplo, integer *n, quadreal *a, 
	integer *lda, integer *ipiv, quadreal *work, integer *info)
{
...
/*           submatrix A(1:k+1,1:k+1) */
		...
		if (kp > 1) {
		    i__1 = kp - 1;
		    qswap_(&i__1, &a[k * a_dim1 + 1], &c__1, &a[kp * a_dim1 + 
			    1], &c__1);
		}
		i__1 = k - kp - 1;
...
/*           submatrix A(k-1:n,k-1:n) */
		...
		if (kp < *n) {
		    i__1 = *n - kp;
		    qswap_(&i__1, &a[kp + 1 + k * a_dim1], &c__1, &a[kp + 1 + 
			    kp * a_dim1], &c__1);
		}
		i__1 = kp - k - 1;
