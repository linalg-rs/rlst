...
/* > */
/*  ===================================================================== */
void  hsygvd_(integer *itype, char *jobz, char *uplo, integer *
	n, halfreal *a, integer *lda, halfreal *b, integer *ldb, 
	halfreal *w, halfreal *work, integer *lwork, integer *iwork, 
	integer *liwork, integer *info)
{
    ...
    extern void  htrsm_(char *, char *, char *, char *, 
	    ...
	    halfreal *, integer *);
    logical upper, wantz;
    extern void  xerbla_(char *, integer *), hpotrf_(
	    char *, integer *, halfreal *, integer *, integer *);
    integer liwmin;
    extern void  hsyevd_(char *, char *, integer *, halfreal 
	    *, integer *, halfreal *, halfreal *, integer *, integer *, 
	    integer *, integer *), hsygst_(integer *, char *, 
...
/*     Form a Cholesky factorization of B. */
    ...
    hpotrf_(uplo, n, &b[b_offset], ldb, info);
    if (*info != 0) {
	*info = *n + *info;
	return;
    }
...
/*     Transform problem to standard eigenvalue problem and solve. */
    ...
    hsygst_(itype, uplo, n, &a[a_offset], lda, &b[b_offset], ldb, info);
    hsyevd_(jobz, uplo, n, &a[a_offset], lda, &w[1], &work[1], lwork, &iwork[
	    1], liwork, info);
/* Computing MAX */
    d__1 = (halfreal) lopt;
...
/*           backtransform eigenvectors: x = inv(L)**T*y or inv(U)*y */
		...
		*(unsigned char *)trans = 'T';
	    ...
	    htrsm_("Left", uplo, trans, "Non-unit", n, n, &c_b11, &b[b_offset]
		    , ldb, &a[a_offset], lda);
...
/*           backtransform eigenvectors: x = L*y or U**T*y */
		...
		*(unsigned char *)trans = 'N';
	    ...
	    htrmm_("Left", uplo, trans, "Non-unit", n, n, &c_b11, &b[b_offset]
		    , ldb, &a[a_offset], lda);
	}
    }
