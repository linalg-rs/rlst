...
/* > \verbatim */
/* > */
/* > DGEBAK forms the right or left eigenvectors of a doublereal general matrix */
...
/*  ===================================================================== */
void  qgebak_(char *job, char *side, integer *n, integer *ilo, 
	integer *ihi, quadreal *scale, integer *m, quadreal *v, integer *
	ldv, integer *info)
{
