...
/*  ===================================================================== */
void  qormhr_(char *side, char *trans, integer *m, integer *n, 
	integer *ilo, integer *ihi, quadreal *a, integer *lda, quadreal *
	tau, quadreal *c__, integer *ldc, quadreal *work, integer *lwork, 
	integer *info)
{
...
/*     Quick return if possible */
    ...
    qormqr_(side, trans, &mi, &ni, &nh, &a[*ilo + 1 + *ilo * a_dim1], lda, &
