...
/* > */
/*  ===================================================================== */
void  hgeqr_(integer *m, integer *n, halfreal *a, integer *
	lda, halfreal *t, integer *tsize, halfreal *work, integer *lwork, 
	integer *info)
{
    ...
    extern void  hgeqrt_(integer *, integer *, integer *, 
	    halfreal *, integer *, halfreal *, integer *, halfreal *, 
	    integer *);
    logical lminws, lquery;
    integer mintsz;
    extern void  hlatsqr_(integer *, integer *, integer *, 
...
/*     The QR Decomposition */
    ...
    if (*m <= *n || mb <= *n || mb >= *m) {
	hgeqrt_(m, n, &nb, &a[a_offset], lda, &t[6], &nb, &work[1], info);
    } else {
	hlatsqr_(m, n, &mb, &nb, &a[a_offset], lda, &t[6], &nb, &work[1], 
		lwork, info);
    }
