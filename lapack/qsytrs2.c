...
/*  ===================================================================== */
void  qsytrs2_(char *uplo, integer *n, integer *nrhs, 
	quadreal *a, integer *lda, integer *ipiv, quadreal *b, integer *
	ldb, quadreal *work, integer *info)
{
    ...
    extern void  qswap_(integer *, quadreal *, integer *, 
	    ...
	    quadreal *, integer *);
    logical upper;
    extern void  xerbla_(char *, integer *), qsyconv_(
	    char *, char *, integer *, quadreal *, integer *, integer *, 
	    quadreal *, integer *);
...
/*     Convert A */
    ...
    qsyconv_(uplo, "C", n, &a[a_offset], lda, &ipiv[1], &work[1], &iinfo);
...
/*           Interchange rows K-1 and -IPIV(K). */
		kp = -ipiv[k];
		if (kp == -ipiv[k - 1]) {
		    qswap_(nrhs, &b[k - 1 + b_dim1], ldb, &b[kp + b_dim1], 
			    ldb);
		}
		k += -2;
	    }
...
/*  Compute (U \P**T * B) -> B    [ (U \P**T * B) ] */
	...
	qtrsm_("L", "U", "N", "U", n, nrhs, &c_b10, &a[a_offset], lda, &b[
		b_offset], ldb);
...
/*      Compute (U**T \ B) -> B   [ U**T \ (D \ (U \P**T * B) ) ] */
	...
	qtrsm_("L", "U", "T", "U", n, nrhs, &c_b10, &a[a_offset], lda, &b[
		b_offset], ldb);
...
/*  Compute (L \P**T * B) -> B    [ (L \P**T * B) ] */
	...
	qtrsm_("L", "L", "N", "U", n, nrhs, &c_b10, &a[a_offset], lda, &b[
		b_offset], ldb);
...
/*  Compute (L**T \ B) -> B   [ L**T \ (D \ (L \P**T * B) ) ] */
	...
	qtrsm_("L", "L", "T", "U", n, nrhs, &c_b10, &a[a_offset], lda, &b[
		b_offset], ldb);
...
/*     Revert A */
    ...
    qsyconv_(uplo, "R", n, &a[a_offset], lda, &ipiv[1], &work[1], &iinfo);
