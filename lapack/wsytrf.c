...
/* > */
/*  ===================================================================== */
void  wsytrf_(char *uplo, integer *n, quadcomplex *a, 
	...
	integer *info)
{
    ...
    integer nbmin, iinfo;
    logical upper;
    extern void  wsytf2_(char *, integer *, quadcomplex *, 
	    integer *, integer *, integer *), xerbla_(char *, integer 
	    *);
    extern integer ilaenv_(integer *, char *, char *, integer *, integer *, 
	    integer *, integer *, ftnlen, ftnlen);
    integer ldwork;
    extern void  wlasyf_(char *, integer *, integer *, integer 
	    *, quadcomplex *, integer *, integer *, quadcomplex *, 
	    integer *, integer *);
    integer lwkopt;
    logical lquery;
...
/*           update columns 1:k-kb */
	    ...
	    wlasyf_(uplo, &k, &nb, &kb, &a[a_offset], lda, &ipiv[1], &work[1],
		     n, &iinfo);
	} else {

/*           Use unblocked code to factorize columns 1:k of A */

	    wsytf2_(uplo, &k, &a[a_offset], lda, &ipiv[1], &iinfo);
	    kb = k;
	}
...
/*           update columns k+kb:n */
	    ...
	    i__1 = *n - k + 1;
	    wlasyf_(uplo, &i__1, &nb, &kb, &a[k + k * a_dim1], lda, &ipiv[k], 
		    &work[1], n, &iinfo);
	} else {
...
/*           Use unblocked code to factorize columns k:n of A */
	    ...
	    i__1 = *n - k + 1;
	    wsytf2_(uplo, &i__1, &a[k + k * a_dim1], lda, &ipiv[k], &iinfo);
	    kb = *n - k + 1;
	}
