...
/* > \verbatim */
/* > */
/* > DORMQR overwrites the general doublereal M-by-N matrix C with */
/* > */
/* >                 SIDE = 'L'     SIDE = 'R' */
/* > TRANS = 'N':      Q * C          C * Q */
/* > TRANS = 'T':      Q**T * C       C * Q**T */
...
/*  ===================================================================== */
void  hormqr_(char *side, char *trans, integer *m, integer *n, 
	...
	c__, integer *ldc, halfreal *work, integer *lwork, integer *info)
{
    ...
    integer nbmin, iinfo;
    extern void  horm2r_(char *, char *, integer *, integer *, 
...
/*        Use unblocked code */
	...
	horm2r_(side, trans, m, n, k, &a[a_offset], lda, &tau[1], &c__[
...
/*           H = H(i) H(i+1) . . . H(i+ib-1) */
	    ...
	    i__4 = nq - i__ + 1;
	    hlarft_("Forward", "Columnwise", &i__4, &ib, &a[i__ + i__ * 
...
/*           Apply H or H**T */
	    ...
	    hlarfb_(side, trans, "Forward", "Columnwise", &mi, &ni, &ib, &a[
