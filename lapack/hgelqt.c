...
/* > \verbatim */
/* > */
/* > DGELQT computes a blocked LQ factorization of a doublereal M-by-N matrix A */
...
/* > */
/*  ===================================================================== */
void  hgelqt_(integer *m, integer *n, integer *mb, halfreal *
	...
	integer *info)
{
    ...
    extern void  hlarfb_(char *, char *, char *, char *, 
	    ...
	    integer *), hgelqt3_(integer *, integer *, halfreal *, 
...
/*     Compute the LQ factorization of the current block A(I:M,I:I+IB-1) */
	...
	i__3 = *n - i__ + 1;
	hgelqt3_(&ib, &i__3, &a[i__ + i__ * a_dim1], lda, &t[i__ * t_dim1 + 1]
		, ldt, &iinfo);
	if (i__ + ib <= *m) {
...
/*     Update by applying H**T to A(I:M,I+IB:N) from the right */
	    ...
	    i__4 = *n - i__ + 1;
	    i__5 = *m - i__ - ib + 1;
	    hlarfb_("R", "N", "F", "R", &i__3, &i__4, &ib, &a[i__ + i__ * 
