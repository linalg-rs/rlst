...
/*  ===================================================================== */
void  clarrv_(integer *n, real *vl, real *vu, real *d__, real *
	...
	integer *info)
{
    ...
    extern void  clar1v_(integer *, integer *, integer *, real 
    ...
    logical tryrqc;
    integer isupmx;
    extern void  slarrf_(integer *, real *, real *, real *, 
