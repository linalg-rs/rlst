...
/*  ===================================================================== */
void  kgels_(char *trans, integer *m, integer *n, integer *
	...
	halfcomplex *work, integer *lwork, integer *info)
{
    ...
    extern void  kgelqf_(integer *, integer *, halfcomplex *,
	    ...
	    *, integer *, integer *, halfcomplex *, integer *, integer *), kgeqrf_(integer *, integer *, halfcomplex *, integer *,
	     halfcomplex *, halfcomplex *, integer *, integer *), klaset_(
    ...
    extern void  kunmlq_(char *, char *, integer *, integer *, 
	    ...
	    integer *, halfcomplex *, integer *, halfcomplex *, 
	    halfcomplex *, integer *, halfcomplex *, integer *, integer *), ktrtrs_(char *, char *, char *, integer *, 
...
/*     Scale A, B if f2cmax element outside range [SMLNUM,BIGNUM] */
    ...
    anrm = klange_("M", m, n, &a[a_offset], lda, rwork);
    iascl = 0;
...
/*        Matrix all zero. Return zero solution. */
    ...
    bnrm = klange_("M", &brow, nrhs, &b[b_offset], ldb, rwork);
    ibscl = 0;
...
/*        compute QR factorization of A */
	...
	i__1 = *lwork - mn;
	kgeqrf_(m, n, &a[a_offset], lda, &work[1], &work[mn + 1], &i__1, info)
		;
...
/*           B(1:M,1:NRHS) := Q**H * B(1:M,1:NRHS) */
	    ...
	    i__1 = *lwork - mn;
	    kunmqr_("Left", "Conjugate transpose", m, nrhs, n, &a[a_offset], 
...
/*           B(1:N,1:NRHS) := inv(R) * B(1:N,1:NRHS) */
	    ...
	    ktrtrs_("Upper", "No transpose", "Non-unit", n, nrhs, &a[a_offset]
...
/*           B(1:N,1:NRHS) := inv(R**H) * B(1:N,1:NRHS) */
	    ...
	    ktrtrs_("Upper", "Conjugate transpose", "Non-unit", n, nrhs, &a[
...
/*           B(1:M,1:NRHS) := Q(1:N,:) * B(1:N,1:NRHS) */
	    ...
	    i__1 = *lwork - mn;
	    kunmqr_("Left", "No transpose", m, nrhs, n, &a[a_offset], lda, &
...
/*        Compute LQ factorization of A */
	...
	i__1 = *lwork - mn;
	kgelqf_(m, n, &a[a_offset], lda, &work[1], &work[mn + 1], &i__1, info)
		;
...
/*           B(1:M,1:NRHS) := inv(L) * B(1:M,1:NRHS) */
	    ...
	    ktrtrs_("Lower", "No transpose", "Non-unit", m, nrhs, &a[a_offset]
		    , lda, &b[b_offset], ldb, info);
...
/*           B(1:N,1:NRHS) := Q(1:N,:)**H * B(1:M,1:NRHS) */
	    ...
	    i__1 = *lwork - mn;
	    kunmlq_("Left", "Conjugate transpose", n, nrhs, m, &a[a_offset], 
		    lda, &work[1], &b[b_offset], ldb, &work[mn + 1], &i__1, 
		    info);
...
/*           B(1:N,1:NRHS) := Q * B(1:N,1:NRHS) */
	    ...
	    i__1 = *lwork - mn;
	    kunmlq_("Left", "No transpose", n, nrhs, m, &a[a_offset], lda, &
		    work[1], &b[b_offset], ldb, &work[mn + 1], &i__1, info);
...
/*           B(1:M,1:NRHS) := inv(L**H) * B(1:M,1:NRHS) */
	    ...
	    ktrtrs_("Lower", "Conjugate transpose", "Non-unit", m, nrhs, &a[
		    a_offset], lda, &b[b_offset], ldb, info);
