...
/*  ===================================================================== */
void  wptrfs_(char *uplo, integer *n, integer *nrhs, 
	...
	rwork, integer *info)
{
    ...
    integer i__, j;
    quadreal s;
    quadcomplex bi, cx, dx, ex;
    integer ix, nz;
    quadreal eps, safe1, safe2;
    ...
    quadreal lstres;
    extern void  wpttrs_(char *, integer *, integer *, 
...
/*           Update solution and try again. */
	    ...
	    wpttrs_(uplo, n, &c__1, &df[1], &ef[1], &work[1], n, info);
	    waxpy_(n, &c_b16, &work[1], &c__1, &x[j * x_dim1 + 1], &c__1);
	    lstres = berr[j];
	    ++count;
	    goto L20;
	}
