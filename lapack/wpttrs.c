...
/*  ===================================================================== */
void  wpttrs_(char *uplo, integer *n, integer *nrhs, 
	quadreal *d__, quadcomplex *e, quadcomplex *b, integer *ldb, 
	integer *info)
{
    ...
    logical upper;
    extern void  wptts2_(integer *, integer *, integer *, 
...
/*     Decode UPLO */
    ...
    if (nb >= *nrhs) {
	wptts2_(&iuplo, n, nrhs, &d__[1], &e[1], &b[b_offset], ldb);
    } else {
	i__1 = *nrhs;
	i__2 = nb;
...
/* Computing MIN */
	    i__3 = *nrhs - j + 1;
	    jb = f2cmin(i__3,nb);
	    wptts2_(&iuplo, n, &jb, &d__[1], &e[1], &b[j * b_dim1 + 1], ldb);
/* L10: */
	}
    }
