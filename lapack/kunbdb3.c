...
/* > */
/*  ===================================================================== */
void  kunbdb3_(integer *m, integer *p, integer *q, 
...
/*     Reduce rows 1, ..., M-P of X11 and X21 */
	...
	if (i__ > 1) {
	    i__2 = *q - i__ + 1;
	    whrot_(&i__2, &x11[i__ - 1 + i__ * x11_dim1], ldx11, &x21[i__ + 
	...
	i__2 = *p - i__ + 1;
/* Computing 2nd power */
	d__1 = hwnrm2_(&i__2, &x11[i__ + i__ * x11_dim1], &c__1);
	i__3 = *m - *p - i__;
/* Computing 2nd power */
	...
	i__3 = *m - *p - i__;
	i__4 = *q - i__;
	kunbdb5_(&i__2, &i__3, &i__4, &x11[i__ + i__ * x11_dim1], &c__1, &x21[
	...
	if (i__ < *m - *p) {
	    i__2 = *m - *p - i__;
	    klarfgp_(&i__2, &x21[i__ + 1 + i__ * x21_dim1], &x21[i__ + 2 + 
		    i__ * x21_dim1], &c__1, &taup2[i__]);
	    phi[i__] = atan2((halfreal) x21[i__ + 1 + i__ * x21_dim1].r, (
	    ...
	    klarf_("L", &i__2, &i__3, &x21[i__ + 1 + i__ * x21_dim1], &c__1, &
