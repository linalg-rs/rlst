...
/*  ===================================================================== */
halfreal klanht_(char *norm, integer *n, halfreal *d__, halfcomplex *e)
{
    ...
    extern void  hlassq_(integer *, halfreal *, integer *, 
	    halfreal *, halfreal *), klassq_(integer *, halfcomplex *, 
	    integer *, halfreal *, halfreal *);
...
/*        Find normF(A). */
	...
	if (*n > 1) {
	    i__1 = *n - 1;
	    klassq_(&i__1, &e[1], &c__1, &scale, &sum);
	    sum *= 2;
	}
