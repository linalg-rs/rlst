...
/*  ===================================================================== */
void  qsysvx_(char *fact, char *uplo, integer *n, integer *
	nrhs, quadreal *a, integer *lda, quadreal *af, integer *ldaf, 
	integer *ipiv, quadreal *b, integer *ldb, quadreal *x, integer *
	ldx, quadreal *rcond, quadreal *ferr, quadreal *berr, 
	quadreal *work, integer *lwork, integer *iwork, integer *info)
{
...
/*        Compute the factorization A = U*D*U**T or A = L*D*L**T. */
	...
	qsytrf_(uplo, n, &af[af_offset], ldaf, &ipiv[1], &work[1], lwork, 
		info);
...
/*     Compute the norm of the matrix A. */
    ...
    anorm = qlansy_("I", uplo, n, &a[a_offset], lda, &work[1]);

/*     Compute the reciprocal of the condition number of A. */

    qsycon_(uplo, n, &af[af_offset], ldaf, &ipiv[1], &anorm, rcond, &work[1], 
	    &iwork[1], info);

/*     Compute the solution vectors X. */

    qlacpy_("Full", n, nrhs, &b[b_offset], ldb, &x[x_offset], ldx);
    qsytrs_(uplo, n, nrhs, &af[af_offset], ldaf, &ipiv[1], &x[x_offset], ldx, 
	    info);

/*     Use iterative refinement to improve the computed solutions and */
/*     compute error bounds and backward error estimates for them. */

    qsyrfs_(uplo, n, nrhs, &a[a_offset], lda, &af[af_offset], ldaf, &ipiv[1], 
