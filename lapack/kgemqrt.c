...
/*  ===================================================================== */
void  kgemqrt_(char *side, char *trans, integer *m, integer *n,
	 integer *k, integer *nb, halfcomplex *v, integer *ldv, 
...
/* Computing MIN */
	    ...
	    ib = f2cmin(i__3,i__4);
	    i__3 = *m - i__ + 1;
	    klarfb_("L", "C", "F", "C", &i__3, n, &ib, &v[i__ + i__ * v_dim1],
...
/* Computing MIN */
	    ...
	    ib = f2cmin(i__3,i__4);
	    i__3 = *n - i__ + 1;
	    klarfb_("R", "N", "F", "C", m, &i__3, &ib, &v[i__ + i__ * v_dim1],
...
/* Computing MIN */
	    ...
	    ib = f2cmin(i__2,i__3);
	    i__2 = *m - i__ + 1;
	    klarfb_("L", "N", "F", "C", &i__2, n, &ib, &v[i__ + i__ * v_dim1],
		     ldv, &t[i__ * t_dim1 + 1], ldt, &c__[i__ + c_dim1], ldc, 
		    &work[1], &ldwork);
	}
...
/* Computing MIN */
	    ...
	    ib = f2cmin(i__2,i__3);
	    i__2 = *n - i__ + 1;
	    klarfb_("R", "C", "F", "C", m, &i__2, &ib, &v[i__ + i__ * v_dim1],
		     ldv, &t[i__ * t_dim1 + 1], ldt, &c__[i__ * c_dim1 + 1], 
		    ldc, &work[1], &ldwork);
	}
