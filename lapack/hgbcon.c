...
/*  ===================================================================== */
void  hgbcon_(char *norm, integer *n, integer *kl, integer *ku,
	 halfreal *ab, integer *ldab, integer *ipiv, halfreal *anorm, 
	halfreal *rcond, halfreal *work, integer *iwork, integer *info)
{
    ...
    extern void  haxpy_(integer *, halfreal *, halfreal *, 
	    integer *, halfreal *, integer *), hlacn2_(integer *, 
...
/* Computing MIN */
		    ...
		    d__1 = -t;
		    haxpy_(&lm, &d__1, &ab[kd + 1 + j * ab_dim1], &c__1, &
			    work[j + 1], &c__1);
/* L20: */
		}
	    }
...
/*           Multiply by inv(U). */
	    ...
	    i__1 = *kl + *ku;
	    hlatbs_("Upper", "No transpose", "Non-unit", normin, n, &i__1, &
...
/*           Multiply by inv(U**T). */
	    ...
	    i__1 = *kl + *ku;
	    hlatbs_("Upper", "Transpose", "Non-unit", normin, n, &i__1, &ab[
...
/* Computing MIN */
		    i__1 = *kl, i__2 = *n - j;
		    lm = f2cmin(i__1,i__2);
		    work[j] -= hdot_(&lm, &ab[kd + 1 + j * ab_dim1], &c__1, &
			    work[j + 1], &c__1);
		    jp = ipiv[j];
		    if (jp != j) {
			t = work[jp];
