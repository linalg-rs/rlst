...
/* > */
/*  ===================================================================== */
void  wspsv_(char *uplo, integer *n, integer *nrhs, 
	...
	integer *info)
{
    ...
    extern void  xerbla_(char *, integer *), wsptrf_(
...
/*     Compute the factorization A = U*D*U**T or A = L*D*L**T. */
    ...
    wsptrf_(uplo, n, &ap[1], &ipiv[1], info);
    if (*info == 0) {

/*        Solve the system A*X = B, overwriting B with X. */

	wsptrs_(uplo, n, nrhs, &ap[1], &ipiv[1], &b[b_offset], ldb, info);
