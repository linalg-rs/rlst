...
/* > */
/*  ===================================================================== */
void  ktpmlqt_(char *side, char *trans, integer *m, integer *n,
	 integer *k, integer *l, integer *mb, halfcomplex *v, integer *ldv, 
	halfcomplex *t, integer *ldt, halfcomplex *a, integer *lda, 
	halfcomplex *b, integer *ldb, halfcomplex *work, integer *info)
{
    ...
    logical notran;
    extern void  ktprfb_(char *, char *, char *, char *, 
...
/* Computing MIN */
	    ...
	    ktprfb_("L", "C", "F", "R", &nb, n, &ib, &lb, &v[i__ + v_dim1], 
...
/* Computing MIN */
	    ...
	    ktprfb_("R", "N", "F", "R", m, &nb, &ib, &lb, &v[i__ + v_dim1], 
...
/* Computing MIN */
	    ...
	    ktprfb_("L", "N", "F", "R", &nb, n, &ib, &lb, &v[i__ + v_dim1], 
		    ldv, &t[i__ * t_dim1 + 1], ldt, &a[i__ + a_dim1], lda, &b[
		    b_offset], ldb, &work[1], &ib);
	}
...
/* Computing MIN */
	    ...
	    ktprfb_("R", "C", "F", "R", m, &nb, &ib, &lb, &v[i__ + v_dim1], 
		    ldv, &t[i__ * t_dim1 + 1], ldt, &a[i__ * a_dim1 + 1], lda,
		     &b[b_offset], ldb, &work[1], m);
	}
