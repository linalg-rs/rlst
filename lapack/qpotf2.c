...
/*  ===================================================================== */
void  qpotf2_(char *uplo, integer *n, quadreal *a, integer *
	lda, integer *info)
{
...
/*           Compute U(J,J) and test for non-positive-definiteness. */
	    ...
	    i__2 = j - 1;
	    ajj = a[j + j * a_dim1] - qdot_(&i__2, &a[j * a_dim1 + 1], &c__1, 
		    &a[j * a_dim1 + 1], &c__1);
...
/*           Compute elements J+1:N of row J. */
		...
		i__2 = j - 1;
		i__3 = *n - j;
		qgemv_("Transpose", &i__2, &i__3, &c_b10, &a[(j + 1) * a_dim1 
...
/*           Compute L(J,J) and test for non-positive-definiteness. */
	    ...
	    i__2 = j - 1;
	    ajj = a[j + j * a_dim1] - qdot_(&i__2, &a[j + a_dim1], lda, &a[j 
		    + a_dim1], lda);
	    if (ajj <= 0. || qisnan_(&ajj)) {
		a[j + j * a_dim1] = ajj;
		goto L30;
...
/*           Compute elements J+1:N of column J. */
		...
		i__2 = *n - j;
		i__3 = j - 1;
		qgemv_("No transpose", &i__2, &i__3, &c_b10, &a[j + 1 + 
