...
/* > \verbatim */
/* > */
/* > DSYTRS solves a system of linear equations A*X = B with a doublereal */
...
/*  ===================================================================== */
void  hsytrs_(char *uplo, integer *n, integer *nrhs, 
...
/*           stored in columns K-1 and K of A. */
	    ...
	    hger_(&i__1, nrhs, &c_b7, &a[k * a_dim1 + 1], &c__1, &b[k + 
		    b_dim1], ldb, &b[b_dim1 + 1], ldb);
	    i__1 = k - 2;
	    hger_(&i__1, nrhs, &c_b7, &a[(k - 1) * a_dim1 + 1], &c__1, &b[k - 
...
/*           stored in column K of A. */
	    ...
	    i__1 = k - 1;
	    hgemv_("Transpose", &i__1, nrhs, &c_b7, &b[b_offset], ldb, &a[k * 
