...
/*  ===================================================================== */
void  klarfy_(char *uplo, integer *n, halfcomplex *v, 
	integer *incv, halfcomplex *tau, halfcomplex *c__, integer *ldc, 
	halfcomplex *work)
{
...
/*     Form  w:= C * v */
    ...
    khemv_(uplo, n, &c_b1, &c__[c_offset], ldc, &v[1], incv, &c_b2, &work[1], 
	    &c__1);

    z__3.r = -.5, z__3.i = -0.;
    z__2.r = z__3.r * tau->r - z__3.i * tau->i, z__2.i = z__3.r * tau->i + 
	    z__3.i * tau->r;
    whotc_(&z__4, n, &work[1], &c__1, &v[1], incv);
    z__1.r = z__2.r * z__4.r - z__2.i * z__4.i, z__1.i = z__2.r * z__4.i + 
	    z__2.i * z__4.r;
    alpha.r = z__1.r, alpha.i = z__1.i;
    kaxpy_(n, &alpha, &v[1], incv, &work[1], &c__1);

/*     C := C - v * w' - w * v' */

    z__1.r = -tau->r, z__1.i = -tau->i;
    kher2_(uplo, n, &z__1, &v[1], incv, &work[1], &c__1, &c__[c_offset], ldc);
