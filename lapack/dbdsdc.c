...
/* > */
/*  ===================================================================== */
void  dbdsdc_(char *uplo, char *compq, integer *n, doublereal *
	...
	iwork, integer *info)
{
    ...
    extern void  dlasd0_(integer *, integer *, doublereal *, 
...
/*     Scale. */
    ...
    mlvl = (integer) (M(log)((doublereal) (*n) / (doublereal) (smlsiz + 1)) / 
	    M(log)(2.)) + 1;
    smlszp = smlsiz + 1;
