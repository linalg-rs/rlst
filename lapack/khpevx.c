...
/*  ===================================================================== */
void  khpevx_(char *jobz, char *range, char *uplo, integer *n, 
	halfcomplex *ap, halfreal *vl, halfreal *vu, integer *il, 
	integer *iu, halfreal *abstol, integer *m, halfreal *w, 
	halfcomplex *z__, integer *ldz, halfcomplex *work, halfreal *
	rwork, integer *iwork, integer *ifail, integer *info)
{
    ...
    extern void  khptrd_(char *, integer *, halfcomplex *, 
	    ...
	    kstein_(integer *, halfreal *, halfreal *, integer *, 
	    halfreal *, integer *, integer *, halfcomplex *, integer *, 
	    halfreal *, integer *, integer *, integer *), ksteqr_(char *, 
	    integer *, halfreal *, halfreal *, halfcomplex *, integer *,
	     halfreal *, integer *), kupgtr_(char *, integer *, 
	    halfcomplex *, halfcomplex *, halfcomplex *, integer *, 
	    halfcomplex *, integer *), kupmtr_(char *, char *, char 
...
/*     Call ZHPTRD to reduce Hermitian packed matrix to tridiagonal form. */
    ...
    indtau = 1;
    indwrk = indtau + *n;
    khptrd_(uplo, n, &ap[1], &rwork[indd], &rwork[inde], &work[indtau], &
	    iinfo);
...
/*     for some eigenvalue, then try DSTEBZ. */
	...
	if (! wantz) {
	    ...
	    kupgtr_(uplo, n, &ap[1], &work[indtau], &z__[z_offset], ldz, &
		    work[indwrk], &iinfo);
	    i__1 = *n - 1;
	    hcopy_(&i__1, &rwork[inde], &c__1, &rwork[indee], &c__1);
...
/*        form to eigenvectors returned by ZSTEIN. */
	...
	indwrk = indtau + *n;
	kupmtr_("L", uplo, "N", n, m, &ap[1], &work[indtau], &z__[z_offset], 
