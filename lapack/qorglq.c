...
/*  ===================================================================== */
void  qorglq_(integer *m, integer *n, integer *k, quadreal *
	...
	integer *info)
{
    ...
    extern void  qorgl2_(integer *, integer *, integer *, 
...
/*     Use unblocked code for the last or only block. */
	...
	i__2 = *n - kk;
	i__3 = *k - kk;
	qorgl2_(&i__1, &i__2, &i__3, &a[kk + 1 + (kk + 1) * a_dim1], lda, &
...
/*              H = H(i) H(i+1) . . . H(i+ib-1) */
		...
		i__2 = *n - i__ + 1;
		qlarft_("Forward", "Rowwise", &i__2, &ib, &a[i__ + i__ * 
...
/*           Apply H**T to columns i:n of current block */
	    ...
	    i__2 = *n - i__ + 1;
	    qorgl2_(&ib, &i__2, &ib, &a[i__ + i__ * a_dim1], lda, &tau[i__], &
		    work[1], &iinfo);
