...
/*  ===================================================================== */
void  whbgvx_(char *jobz, char *range, char *uplo, integer *n, 
	integer *ka, integer *kb, quadcomplex *ab, integer *ldab, 
	quadcomplex *bb, integer *ldbb, quadcomplex *q, integer *ldq, 
	quadreal *vl, quadreal *vu, integer *il, integer *iu, quadreal *
	abstol, integer *m, quadreal *w, quadcomplex *z__, integer *ldz, 
	quadcomplex *work, quadreal *rwork, integer *iwork, integer *
	ifail, integer *info)
{
    ...
    extern void  qcopy_(integer *, quadreal *, integer *, 
	    quadreal *, integer *), wgemv_(char *, integer *, integer *, 
    ...
    extern void  qsterf_(integer *, quadreal *, quadreal *,
	    ...
	    whbtrd_(char *, char *, integer *, integer *, quadcomplex *, 
	    integer *, quadreal *, quadreal *, quadcomplex *, integer *,
	     quadcomplex *, integer *);
    integer indrwk, indwrk;
    extern void  whbgst_(char *, char *, integer *, integer *, 
    ...
    integer nsplit;
    extern void  wpbstf_(char *, integer *, integer *, 
	    quadcomplex *, integer *, integer *), wstein_(integer *,
	     quadreal *, quadreal *, integer *, quadreal *, integer *, 
	    integer *, quadcomplex *, integer *, quadreal *, integer *, 
	    integer *, integer *), wsteqr_(char *, integer *, quadreal *, 
...
/*     Form a split Cholesky factorization of B. */
    ...
    wpbstf_(uplo, n, kb, &bb[bb_offset], ldbb, info);
    if (*info != 0) {
	*info = *n + *info;
	return;
    }
...
/*     Transform problem to standard eigenvalue problem. */
    ...
    whbgst_(jobz, uplo, n, ka, kb, &ab[ab_offset], ldab, &bb[bb_offset], ldbb,
...
/*     Reduce Hermitian band matrix to tridiagonal form. */
	...
	*(unsigned char *)vect = 'N';
    ...
    whbtrd_(vect, uplo, n, ka, &ab[ab_offset], ldab, &rwork[indd], &rwork[
...
/*     eigenvalue, then try DSTEBZ. */
	...
	if (! wantz) {
	    ...
	    wlacpy_("A", n, n, &q[q_offset], ldq, &z__[z_offset], ldz);
...
/*     call ZSTEIN. */
	...
	*(unsigned char *)order = 'E';
    ...
    indisp = indibl + *n;
    indiwk = indisp + *n;
    qstebz_(range, order, n, vl, vu, il, iu, abstol, &rwork[indd], &rwork[
...
/*        form to eigenvectors returned by ZSTEIN. */
	...
	i__1 = *m;
	for (j = 1; j <= i__1; ++j) {
	    wcopy_(n, &z__[j * z_dim1 + 1], &c__1, &work[1], &c__1);
	    wgemv_("N", n, n, &c_b2, &q[q_offset], ldq, &work[1], &c__1, &
