...
/*  ===================================================================== */
void  qptrfs_(integer *n, integer *nrhs, quadreal *d__, 
	quadreal *e, quadreal *df, quadreal *ef, quadreal *b, integer 
	 ...
	 quadreal *work, integer *info)
{
    ...
    quadreal lstres;
    extern void  qpttrs_(integer *, integer *, quadreal *, 
...
/*           Update solution and try again. */
	    ...
	    qaxpy_(n, &c_b11, &work[*n + 1], &c__1, &x[j * x_dim1 + 1], &c__1)
		    ;
	    lstres = berr[j];
	    ++count;
	    goto L20;
