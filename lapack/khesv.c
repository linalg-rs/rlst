...
/*  ===================================================================== */
void  khesv_(char *uplo, integer *n, integer *nrhs, 
	...
	integer *ldb, halfcomplex *work, integer *lwork, integer *info)
{
    ...
    extern void  khetrf_(char *, integer *, halfcomplex *, 
	    integer *, integer *, halfcomplex *, integer *, integer *), khetrs_(char *, integer *, integer *, halfcomplex *, 
	    integer *, integer *, halfcomplex *, integer *, integer *);
    integer lwkopt;
    logical lquery;
    extern void  khetrs2_(char *, integer *, integer *, 
...
/*     Compute the factorization A = U*D*U**H or A = L*D*L**H. */
    ...
    khetrf_(uplo, n, &a[a_offset], lda, &ipiv[1], &work[1], lwork, info);
    if (*info == 0) {
...
/*        Solve with TRS ( Use Level BLAS 2) */
	    ...
	    khetrs_(uplo, n, nrhs, &a[a_offset], lda, &ipiv[1], &b[b_offset], 
		    ldb, info);
...
/*        Solve with TRS2 ( Use Level BLAS 3) */
	    ...
	    khetrs2_(uplo, n, nrhs, &a[a_offset], lda, &ipiv[1], &b[b_offset],
		     ldb, &work[1], info);
