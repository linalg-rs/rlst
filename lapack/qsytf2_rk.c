...
/*  ===================================================================== */
void  dsytf2_rk__(char *uplo, integer *n, quadreal *a, 
	integer *lda, quadreal *e, integer *ipiv, integer *info)
{
...
/*              the interchanges in columns k+1:N. */
		...
		if (k < *n) {
		    i__1 = *n - k;
		    qswap_(&i__1, &a[k + (k + 1) * a_dim1], lda, &a[p + (k + 
			    1) * a_dim1], lda);
		}
...
/*              the interchanges in columns 1:k-1. */
		...
		if (k > 1) {
		    i__1 = k - 1;
		    qswap_(&i__1, &a[k + a_dim1], lda, &a[p + a_dim1], lda);
		}
