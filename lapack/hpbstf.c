...
/* > \verbatim */
/* > */
/* > DPBSTF computes a split Cholesky factorization of a doublereal */
...
/* > */
/*  ===================================================================== */
void  hpbstf_(char *uplo, integer *n, integer *kd, halfreal *
	ab, integer *ldab, integer *info)
{
    ...
    extern void  hsyr_(char *, integer *, halfreal *, 
	    halfreal *, integer *, halfreal *, integer *), hscal_(
...
/*           the leading submatrix within the band. */
	    ...
	    d__1 = 1. / ajj;
	    hscal_(&km, &d__1, &ab[*kd + 1 - km + j * ab_dim1], &c__1);
	    hsyr_("Upper", &km, &c_b9, &ab[*kd + 1 - km + j * ab_dim1], &c__1,
...
/*           trailing submatrix within the band. */
	    ...
	    if (km > 0) {
		d__1 = 1. / ajj;
		hscal_(&km, &d__1, &ab[*kd + (j + 1) * ab_dim1], &kld);
		hsyr_("Upper", &km, &c_b9, &ab[*kd + (j + 1) * ab_dim1], &kld,
...
/*           trailing submatrix within the band. */
	    ...
	    d__1 = 1. / ajj;
	    hscal_(&km, &d__1, &ab[km + 1 + (j - km) * ab_dim1], &kld);
	    hsyr_("Lower", &km, &c_b9, &ab[km + 1 + (j - km) * ab_dim1], &kld,
...
/*           trailing submatrix within the band. */
	    ...
	    if (km > 0) {
		d__1 = 1. / ajj;
		hscal_(&km, &d__1, &ab[j * ab_dim1 + 2], &c__1);
		hsyr_("Lower", &km, &c_b9, &ab[j * ab_dim1 + 2], &c__1, &ab[(
			j + 1) * ab_dim1 + 1], &kld);
	    }
/* L40: */
	}
