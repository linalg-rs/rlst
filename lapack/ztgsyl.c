...
/* > */
/*  ===================================================================== */
void  ztgsyl_(char *trans, integer *ijob, integer *m, integer *
	...
	lwork, integer *iwork, integer *info)
{
    ...
    extern void  ztgsy2_(char *, integer *, integer *, integer 
...
/*        Use unblocked Level 2 solver */
	...
	for (iround = 1; iround <= i__1; ++iround) {
	    ...
	    *scale = 1.;
	    ...
	    if (dscale != 0.) {
		if (*ijob == 1 || *ijob == 3) {
		    *dif = M(sqrt)((doublereal) ((*m << 1) * *n)) / (dscale * 
			    M(sqrt)(dsum));
		} else {
		    *dif = M(sqrt)((doublereal) pq) / (dscale * M(sqrt)(dsum));
		}
	    }
