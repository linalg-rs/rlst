...
/* > */
/*  ===================================================================== */
void  zpbsvx_(char *fact, char *uplo, integer *n, integer *kd, 
	...
	integer *info)
{
    ...
    doublereal bignum;
    extern void  zlaqhb_(char *, integer *, integer *, 
	    doublecomplex *, integer *, doublereal *, doublereal *, 
	    doublereal *, char *);
    integer infequ;
    extern void  zpbcon_(char *, integer *, integer *, 
	    doublecomplex *, integer *, doublereal *, doublereal *, 
    ...
    doublereal smlnum;
    extern void  zpbtrs_(char *, integer *, integer *, integer 
