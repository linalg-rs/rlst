...
/* > */
/*  ===================================================================== */
void  hgeqrt_(integer *m, integer *n, integer *nb, halfreal *
	a, integer *lda, halfreal *t, integer *ldt, halfreal *work, 
	integer *info)
{
    ...
    extern void  hlarfb_(char *, char *, char *, char *, 
	    ...
	    integer *), hgeqrt2_(integer *, integer *, halfreal *, 
	    integer *, halfreal *, integer *, integer *), hgeqrt3_(integer *
...
/*     Compute the QR factorization of the current block A(I:M,I:I+IB-1) */
	...
	if (TRUE_) {
	    i__3 = *m - i__ + 1;
	    hgeqrt3_(&i__3, &ib, &a[i__ + i__ * a_dim1], lda, &t[i__ * t_dim1 
		    + 1], ldt, &iinfo);
	} else {
	    i__3 = *m - i__ + 1;
	    hgeqrt2_(&i__3, &ib, &a[i__ + i__ * a_dim1], lda, &t[i__ * t_dim1 
		    + 1], ldt, &iinfo);
	}
	if (i__ + ib <= *n) {
...
/*     Update by applying H**T to A(I:M,I+IB:N) from the left */
	    ...
	    i__4 = *n - i__ - ib + 1;
	    i__5 = *n - i__ - ib + 1;
	    hlarfb_("L", "T", "F", "C", &i__3, &i__4, &ib, &a[i__ + i__ * 
