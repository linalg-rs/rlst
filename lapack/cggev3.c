...
/*  ===================================================================== */
void  cggev3_(char *jobvl, char *jobvr, integer *n, complex *a,
	...
	*work, integer *lwork, real *rwork, integer *info)
{
    ...
    extern void  cgghd3_(char *, char *, integer *, integer *, 
	    integer *, complex *, integer *, complex *, integer *, complex *, 
	    integer *, complex *, integer *, complex *, integer *, integer *);
    integer irows;
    extern void  cggbak_(char *, char *, integer *, integer *, 
    ...
    char chtemp[1];
    real bignum;
    extern void  chgeqz_(char *, char *, char *, integer *, 
