...
/*  ===================================================================== */
void  ktbrfs_(char *uplo, char *trans, char *diag, integer *n, 
	integer *kd, integer *nrhs, halfcomplex *ab, integer *ldab, 
	halfcomplex *b, integer *ldb, halfcomplex *x, integer *ldx, 
	halfreal *ferr, halfreal *berr, halfcomplex *work, halfreal *
	rwork, integer *info)
{
    ...
    integer isave[3];
    logical upper;
    extern void  ktbmv_(char *, char *, char *, integer *, 
	    integer *, halfcomplex *, integer *, halfcomplex *, integer *), kcopy_(integer *, halfcomplex *, 
	    integer *, halfcomplex *, integer *), ktbsv_(char *, char *, 
	    char *, integer *, integer *, halfcomplex *, integer *, 
	    halfcomplex *, integer *), kaxpy_(
	    integer *, halfcomplex *, halfcomplex *, integer *, 
	    halfcomplex *, integer *), klacn2_(integer *, halfcomplex *, 
...
/*        where op(A) = A, A**T, or A**H, depending on TRANS. */
	...
	ktbmv_(uplo, trans, diag, n, kd, &ab[ab_offset], ldab, &work[1], &
		c__1);
	z__1.r = -1., z__1.i = -0.;
...
/*              Multiply by diag(W)*inv(op(A)**H). */
		...
		ktbsv_(uplo, transt, diag, n, kd, &ab[ab_offset], ldab, &work[
			1], &c__1);
		i__2 = *n;
		for (i__ = 1; i__ <= i__2; ++i__) {
		    i__5 = i__;
...
/* L230: */
		...
		ktbsv_(uplo, transn, diag, n, kd, &ab[ab_offset], ldab, &work[
			1], &c__1);
	    }
	    goto L210;
	}
