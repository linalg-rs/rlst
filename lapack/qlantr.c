...
/*  ===================================================================== */
quadreal qlantr_(char *norm, char *uplo, char *diag, integer *m, integer *n,
	 quadreal *a, integer *lda, quadreal *work)
{
...
/* Computing MIN */
		    i__3 = *m, i__4 = j + 1;
		    qlassq_(&i__2, &a[f2cmin(i__3,i__4) + j * a_dim1], &c__1, &
			    scale, &sum);
/* L310: */
		}
	    } else {
		...
		for (j = 1; j <= i__1; ++j) {
		    i__2 = *m - j + 1;
		    qlassq_(&i__2, &a[j + j * a_dim1], &c__1, &scale, &sum);
/* L320: */
		}
	    }
	}
