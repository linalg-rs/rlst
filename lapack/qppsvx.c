...
/* > */
/*  ===================================================================== */
void  qppsvx_(char *fact, char *uplo, integer *n, integer *
	nrhs, quadreal *ap, quadreal *afp, char *equed, quadreal *s, 
	...
	iwork, integer *info)
{
    ...
    quadreal bignum;
    extern quadreal qlansp_(char *, char *, integer *, quadreal *, 
	    quadreal *);
    extern void  qppcon_(char *, integer *, quadreal *, 
	    quadreal *, quadreal *, quadreal *, integer *, integer *), qlaqsp_(char *, integer *, quadreal *, quadreal *, 
	    quadreal *, quadreal *, char *);
    integer infequ;
    extern void  qppequ_(char *, integer *, quadreal *, 
	    quadreal *, quadreal *, quadreal *, integer *), 
	    qpprfs_(char *, integer *, integer *, quadreal *, quadreal *, 
	    quadreal *, integer *, quadreal *, integer *, quadreal *, 
	    quadreal *, quadreal *, integer *, integer *), 
	    qpptrf_(char *, integer *, quadreal *, integer *);
    quadreal smlnum;
    extern void  qpptrs_(char *, integer *, integer *, 
	    quadreal *, quadreal *, integer *, integer *);
...
/*     Compute the solution matrix X. */
    ...
    qpptrs_(uplo, n, nrhs, &afp[1], &x[x_offset], ldx, info);

/*     Use iterative refinement to improve the computed solution and */
/*     compute error bounds and backward error estimates for it. */

    qpprfs_(uplo, n, nrhs, &ap[1], &afp[1], &b[b_offset], ldb, &x[x_offset], 
