...
/*  ===================================================================== */
void  wunmqr_(char *side, char *trans, integer *m, integer *n, 
	 ...
	 integer *info)
{
    ...
    integer nbmin, iinfo;
    extern void  wunm2r_(char *, char *, integer *, integer *, 
...
/*        Use unblocked code */
	...
	wunm2r_(side, trans, m, n, k, &a[a_offset], lda, &tau[1], &c__[
...
/*           H = H(i) H(i+1) . . . H(i+ib-1) */
	    ...
	    i__4 = nq - i__ + 1;
	    wlarft_("Forward", "Columnwise", &i__4, &ib, &a[i__ + i__ * 
...
/*           Apply H or H**H */
	    ...
	    wlarfb_(side, trans, "Forward", "Columnwise", &mi, &ni, &ib, &a[
