...
/*  ===================================================================== */
void  wupgtr_(char *uplo, integer *n, quadcomplex *ap, 
	quadcomplex *tau, quadcomplex *q, integer *ldq, quadcomplex *
	work, integer *info)
{
    ...
    extern void  wung2l_(integer *, integer *, integer *, 
	    ...
	    integer *), wung2r_(integer *, integer *, integer *, 
	    quadcomplex *, integer *, quadcomplex *, quadcomplex *, 
...
/*        Generate Q(1:n-1,1:n-1) */
	...
	i__2 = *n - 1;
	i__3 = *n - 1;
	wung2l_(&i__1, &i__2, &i__3, &q[q_offset], ldq, &tau[1], &work[1], &
		iinfo);
...
/*           Generate Q(2:n,2:n) */
	    ...
	    i__2 = *n - 1;
	    i__3 = *n - 1;
	    wung2r_(&i__1, &i__2, &i__3, &q[(q_dim1 << 1) + 2], ldq, &tau[1], 
		    &work[1], &iinfo);
	}
    }
    return;
