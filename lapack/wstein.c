...
/* > \verbatim */
/* > */
/* > ZSTEIN computes the eigenvectors of a doublereal symmetric tridiagonal */
...
/* > */
/* > Although the eigenvectors are doublereal, they are stored in a complex */
...
/*  ===================================================================== */
void  wstein_(integer *n, quadreal *d__, quadreal *e, 
	integer *m, quadreal *w, integer *iblock, integer *isplit, 
	quadcomplex *z__, integer *ldz, quadreal *work, integer *iwork, 
	integer *ifail, integer *info)
{
    ...
    quadreal xj, scl, eps, sep, nrm, tol;
    integer its;
    quadreal xjm, ztr, eps1;
...
/*           Copy the matrix T so it won't be destroyed in factorization. */
	    ...
	    qcopy_(&blksiz, &d__[b1], &c__1, &work[indrv4 + 1], &c__1);
	    i__3 = blksiz - 1;
