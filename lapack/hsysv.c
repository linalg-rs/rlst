...
/* > \verbatim */
/* > */
/* > DSYSV computes the solution to a doublereal system of linear equations */
/* >    A * X = B, */
...
/*  ===================================================================== */
void  hsysv_(char *uplo, integer *n, integer *nrhs, halfreal 
	*a, integer *lda, integer *ipiv, halfreal *b, integer *ldb, 
	halfreal *work, integer *lwork, integer *info)
{
    ...
    extern void  xerbla_(char *, integer *), hsytrf_(
	    char *, integer *, halfreal *, integer *, integer *, halfreal 
	    *, integer *, integer *);
    integer lwkopt;
    logical lquery;
    extern void  hsytrs_(char *, integer *, integer *, 
	    halfreal *, integer *, integer *, halfreal *, integer *, 
	    integer *), hsytrs2_(char *, integer *, integer *, 
	    halfreal *, integer *, integer *, halfreal *, integer *, 
	    halfreal *, integer *);
...
/*     Test the input parameters. */
	...
	*info = -10;
	...
	if (*n == 0) {
	    ...
	    hsytrf_(uplo, n, &a[a_offset], lda, &ipiv[1], &work[1], &c_n1, 
		    info);
...
/*     Compute the factorization A = U*D*U**T or A = L*D*L**T. */
    ...
    hsytrf_(uplo, n, &a[a_offset], lda, &ipiv[1], &work[1], lwork, info);
    if (*info == 0) {
...
/*        Solve with TRS ( Use Level BLAS 2) */
	    ...
	    hsytrs_(uplo, n, nrhs, &a[a_offset], lda, &ipiv[1], &b[b_offset], 
		    ldb, info);
...
/*        Solve with TRS2 ( Use Level BLAS 3) */
	    ...
	    hsytrs2_(uplo, n, nrhs, &a[a_offset], lda, &ipiv[1], &b[b_offset],
		     ldb, &work[1], info);
