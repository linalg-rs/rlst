...
/*  ===================================================================== */
void  htrrfs_(char *uplo, char *trans, char *diag, integer *n, 
	integer *nrhs, halfreal *a, integer *lda, halfreal *b, integer *
	ldb, halfreal *x, integer *ldx, halfreal *ferr, halfreal *berr, 
	halfreal *work, integer *iwork, integer *info)
{
    ...
    extern void  htrmv_(char *, char *, char *, integer *, 
	    ...
	    hlacn2_(integer *, halfreal *, halfreal *, integer *, 
...
/*        where op(A) = A or A**T, depending on TRANS. */
	...
	htrmv_(uplo, trans, diag, n, &a[a_offset], lda, &work[*n + 1], &c__1);
...
/*              Multiply by diag(W)*inv(op(A)**T). */
		...
		htrsv_(uplo, transt, diag, n, &a[a_offset], lda, &work[*n + 1]
			, &c__1);
		i__2 = *n;
		for (i__ = 1; i__ <= i__2; ++i__) {
...
/* L230: */
		...
		htrsv_(uplo, trans, diag, n, &a[a_offset], lda, &work[*n + 1],
			 &c__1);
	    }
	    goto L210;
	}
