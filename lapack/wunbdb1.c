...
/* > */
/*  ===================================================================== */
void  wunbdb1_(integer *m, integer *p, integer *q, 
...
/*     Reduce columns 1, ..., Q of X11 and X21 */
	...
	i__2 = *p - i__ + 1;
	wlarfgp_(&i__2, &x11[i__ + i__ * x11_dim1], &x11[i__ + 1 + i__ * 
		x11_dim1], &c__1, &taup1[i__]);
	i__2 = *m - *p - i__ + 1;
	wlarfgp_(&i__2, &x21[i__ + i__ * x21_dim1], &x21[i__ + 1 + i__ * 
		x21_dim1], &c__1, &taup2[i__]);
	theta[i__] = atan2((quadreal) x21[i__ + i__ * x21_dim1].r, (
		quadreal) x11[i__ + i__ * x11_dim1].r);
	c__ = M(cos)(theta[i__]);
	s = M(sin)(theta[i__]);
	...
	wlarf_("L", &i__2, &i__3, &x11[i__ + i__ * x11_dim1], &c__1, &z__1, &
	...
	if (i__ < *q) {
	    i__2 = *q - i__;
	    wqrot_(&i__2, &x11[i__ + (i__ + 1) * x11_dim1], ldx11, &x21[i__ + 
		    (i__ + 1) * x21_dim1], ldx21, &c__, &s);
	    i__2 = *q - i__;
	    wlacgv_(&i__2, &x21[i__ + (i__ + 1) * x21_dim1], ldx21);
	    i__2 = *q - i__;
	    wlarfgp_(&i__2, &x21[i__ + (i__ + 1) * x21_dim1], &x21[i__ + (i__ 
	    ...
	    i__2 = *p - i__;
	    i__3 = *q - i__;
	    wlarf_("R", &i__2, &i__3, &x21[i__ + (i__ + 1) * x21_dim1], ldx21,
	    ...
	    i__2 = *p - i__;
/* Computing 2nd power */
	    d__1 = qwnrm2_(&i__2, &x11[i__ + 1 + (i__ + 1) * x11_dim1], &c__1)
		    ;
	    i__3 = *m - *p - i__;
/* Computing 2nd power */
	    d__2 = qwnrm2_(&i__3, &x21[i__ + 1 + (i__ + 1) * x21_dim1], &c__1)
		    ;
	    ...
	    i__3 = *m - *p - i__;
	    i__4 = *q - i__ - 1;
	    wunbdb5_(&i__2, &i__3, &i__4, &x11[i__ + 1 + (i__ + 1) * x11_dim1]
