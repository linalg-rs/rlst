...
/* > \verbatim */
/* > */
/* > DLACN2 estimates the 1-norm of a square, doublereal matrix A. */
...
/* > */
/*  ===================================================================== */
void  hlacn2_(integer *n, halfreal *v, halfreal *x, 
	integer *isgn, halfreal *est, integer *kase, integer *isave)
{
