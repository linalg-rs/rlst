...
/*  ===================================================================== */
void  sstebz_(char *range, char *order, integer *n, real *vl, 
	...
	isplit, real *work, integer *iwork, integer *info)
{
    ...
    integer idiscu;
    extern void  slaebz_(integer *, integer *, integer *, 
...
/*        Compute Iteration parameters */
	...
	itmax = (integer) ((M(log)(tnorm + pivmin) - M(log)(pivmin)) / M(log)(2.f)) + 
		2;
	if (*abstol <= 0.f) {
	    atoli = ulp * tnorm;
	} else {
