...
/* > */
/*  ===================================================================== */
void  wggsvd3_(char *jobu, char *jobv, char *jobq, integer *m, 
	integer *n, integer *p, integer *k, integer *l, quadcomplex *a, 
	integer *lda, quadcomplex *b, integer *ldb, quadreal *alpha, 
	quadreal *beta, quadcomplex *u, integer *ldu, quadcomplex *v, 
	integer *ldv, quadcomplex *q, integer *ldq, quadcomplex *work, 
	integer *lwork, quadreal *rwork, integer *iwork, integer *info)
{
    ...
    extern quadreal wlange_(char *, integer *, integer *, quadcomplex *, 
	    integer *, quadreal *);
    extern void  wtgsja_(char *, char *, char *, integer *, 
    ...
    integer lwkopt;
    logical lquery;
    extern void  wggsvp3_(char *, char *, char *, integer *, 
...
/*     Compute workspace */
    ...
    if (*info == 0) {
	wggsvp3_(jobu, jobv, jobq, m, p, n, &a[a_offset], lda, &b[b_offset], 
...
/*     Compute the Frobenius norm of matrices A and B */
    ...
    anorm = wlange_("1", m, n, &a[a_offset], lda, &rwork[1]);
    bnorm = wlange_("1", p, n, &b[b_offset], ldb, &rwork[1]);
...
/*     the effective numerical rank of the matrices A and B. */
    ...
    i__1 = *lwork - *n;
    wggsvp3_(jobu, jobv, jobq, m, p, n, &a[a_offset], lda, &b[b_offset], ldb, 
...
/*     Compute the GSVD of two upper "triangular" matrices */
    ...
    wtgsja_(jobu, jobv, jobq, m, p, n, k, l, &a[a_offset], lda, &b[b_offset], 
...
/*     Copy ALPHA to RWORK, then sort ALPHA in RWORK */
    ...
    qcopy_(n, &alpha[1], &c__1, &rwork[1], &c__1);
/* Computing MIN */
    i__1 = *l, i__2 = *m - *k;
