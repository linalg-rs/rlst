...
/* > */
/*  ===================================================================== */
void  klaswlq_(integer *m, integer *n, integer *mb, integer *
	nb, halfcomplex *a, integer *lda, halfcomplex *t, integer *ldt, 
	halfcomplex *work, integer *lwork, integer *info)
{
    ...
    extern void  xerbla_(char *, integer *), kgelqt_(
	    integer *, integer *, integer *, halfcomplex *, integer *, 
	    halfcomplex *, integer *, halfcomplex *, integer *);
    logical lquery;
    extern void  ktplqt_(integer *, integer *, integer *, 
...
/*     The LQ Decomposition */
    ...
    if (*m >= *n || *nb <= *m || *nb >= *n) {
	kgelqt_(m, n, mb, &a[a_offset], lda, &t[t_offset], ldt, &work[1], 
		info);
	return;
    }
...
/*      Compute the LQ factorization of the first block A(1:M,1:NB) */
    ...
    kgelqt_(m, nb, mb, &a[a_dim1 + 1], lda, &t[t_offset], ldt, &work[1], info)
	    ;
    ctr = 1;
...
/*      Compute the QR factorization of the current block A(1:M,I:I+NB-M) */
	...
	i__3 = *nb - *m;
	ktplqt_(m, &i__3, &c__0, mb, &a[a_dim1 + 1], lda, &a[i__ * a_dim1 + 1]
...
/*     Compute the QR factorization of the last block A(1:M,II:N) */
    ...
    if (ii <= *n) {
	ktplqt_(m, &kk, &c__0, mb, &a[a_dim1 + 1], lda, &a[ii * a_dim1 + 1], 
		lda, &t[(ctr * *m + 1) * t_dim1 + 1], ldt, &work[1], info);
    }

    i__2 = *m * *mb;
    work[1].r = (halfreal) i__2, work[1].i = 0.;
    return;
