...
/* > */
/*  ===================================================================== */
void  wlatrd_(char *uplo, integer *n, integer *nb, 
	quadcomplex *a, integer *lda, quadreal *e, quadcomplex *tau, 
	quadcomplex *w, integer *ldw)
{
    ...
    extern void  wgemv_(char *, integer *, integer *, 
	    ...
	    whemv_(char *, integer *, quadcomplex *, quadcomplex *, 
	    integer *, quadcomplex *, integer *, quadcomplex *, 
	    quadcomplex *, integer *), waxpy_(integer *, 
	    quadcomplex *, quadcomplex *, integer *, quadcomplex *, 
	    integer *), wlarfg_(integer *, quadcomplex *, quadcomplex *, 
...
/*              Update A(1:i,i) */
		...
		i__2 = *n - i__;
		wlacgv_(&i__2, &w[i__ + (iw + 1) * w_dim1], ldw);
		i__2 = *n - i__;
		z__1.r = -1., z__1.i = -0.;
		wgemv_("No transpose", &i__, &i__2, &z__1, &a[(i__ + 1) * 
		...
		i__2 = *n - i__;
		z__1.r = -1., z__1.i = -0.;
		wgemv_("No transpose", &i__, &i__2, &z__1, &w[(iw + 1) * 
...
/*              A(1:i-2,i) */
		...
		i__2 = i__ - 1;
		wlarfg_(&i__2, &alpha, &a[i__ * a_dim1 + 1], &c__1, &tau[i__ 
			- 1]);
		i__2 = i__ - 1;
		e[i__2] = alpha.r;
		i__2 = i__ - 1 + i__ * a_dim1;
...
/*              Compute W(1:i-1,i) */
		...
		i__2 = i__ - 1;
		whemv_("Upper", &i__2, &c_b2, &a[a_offset], lda, &a[i__ * 
			a_dim1 + 1], &c__1, &c_b1, &w[iw * w_dim1 + 1], &c__1);
		if (i__ < *n) {
		    i__2 = i__ - 1;
		    i__3 = *n - i__;
		    wgemv_("Conjugate transpose", &i__2, &i__3, &c_b2, &w[(iw 
		    ...
		    i__2 = i__ - 1;
		    i__3 = *n - i__;
		    wgemv_("Conjugate transpose", &i__2, &i__3, &c_b2, &a[(
			    i__ + 1) * a_dim1 + 1], lda, &a[i__ * a_dim1 + 1],
			     &c__1, &c_b1, &w[i__ + 1 + iw * w_dim1], &c__1);
		    i__2 = i__ - 1;
		    i__3 = *n - i__;
		    z__1.r = -1., z__1.i = -0.;
		    wgemv_("No transpose", &i__2, &i__3, &z__1, &w[(iw + 1) * 
			    w_dim1 + 1], ldw, &w[i__ + 1 + iw * w_dim1], &
			    c__1, &c_b2, &w[iw * w_dim1 + 1], &c__1);
		}
		i__2 = i__ - 1;
		wscal_(&i__2, &tau[i__ - 1], &w[iw * w_dim1 + 1], &c__1);
		z__3.r = -.5, z__3.i = -0.;
		i__2 = i__ - 1;
		z__2.r = z__3.r * tau[i__2].r - z__3.i * tau[i__2].i, z__2.i =
			 z__3.r * tau[i__2].i + z__3.i * tau[i__2].r;
		i__3 = i__ - 1;
		wqotc_(&z__4, &i__3, &w[iw * w_dim1 + 1], &c__1, &a[i__ * 
			a_dim1 + 1], &c__1);
		z__1.r = z__2.r * z__4.r - z__2.i * z__4.i, z__1.i = z__2.r * 
			z__4.i + z__2.i * z__4.r;
		alpha.r = z__1.r, alpha.i = z__1.i;
		i__2 = i__ - 1;
		waxpy_(&i__2, &alpha, &a[i__ * a_dim1 + 1], &c__1, &w[iw * 
			w_dim1 + 1], &c__1);
	    }
...
/*           Update A(i:n,i) */
	    ...
	    i__3 = i__ - 1;
	    z__1.r = -1., z__1.i = -0.;
	    wgemv_("No transpose", &i__2, &i__3, &z__1, &w[i__ + w_dim1], ldw,
...
/*              Compute W(i+1:n,i) */
		...
		i__2 = *n - i__;
		whemv_("Lower", &i__2, &c_b2, &a[i__ + 1 + (i__ + 1) * a_dim1]
			, lda, &a[i__ + 1 + i__ * a_dim1], &c__1, &c_b1, &w[
			i__ + 1 + i__ * w_dim1], &c__1);
		i__2 = *n - i__;
		i__3 = i__ - 1;
		wgemv_("Conjugate transpose", &i__2, &i__3, &c_b2, &w[i__ + 1 
		...
		i__3 = i__ - 1;
		z__1.r = -1., z__1.i = -0.;
		wgemv_("No transpose", &i__2, &i__3, &z__1, &w[i__ + 1 + 
			w_dim1], ldw, &w[i__ * w_dim1 + 1], &c__1, &c_b2, &w[
			i__ + 1 + i__ * w_dim1], &c__1);
		i__2 = *n - i__;
		wscal_(&i__2, &tau[i__], &w[i__ + 1 + i__ * w_dim1], &c__1);
		z__3.r = -.5, z__3.i = -0.;
		i__2 = i__;
		z__2.r = z__3.r * tau[i__2].r - z__3.i * tau[i__2].i, z__2.i =
			 z__3.r * tau[i__2].i + z__3.i * tau[i__2].r;
		i__3 = *n - i__;
		wqotc_(&z__4, &i__3, &w[i__ + 1 + i__ * w_dim1], &c__1, &a[
			i__ + 1 + i__ * a_dim1], &c__1);
		z__1.r = z__2.r * z__4.r - z__2.i * z__4.i, z__1.i = z__2.r * 
			z__4.i + z__2.i * z__4.r;
		alpha.r = z__1.r, alpha.i = z__1.i;
		i__2 = *n - i__;
		waxpy_(&i__2, &alpha, &a[i__ + 1 + i__ * a_dim1], &c__1, &w[
			i__ + 1 + i__ * w_dim1], &c__1);
	    }
