...
/* > */
/*  ===================================================================== */
void  csytrf_(char *uplo, integer *n, complex *a, integer *lda,
	 integer *ipiv, complex *work, integer *lwork, integer *info)
{
    ...
    integer nbmin, iinfo;
    logical upper;
    extern void  csytf2_(char *, integer *, complex *, integer 
	    *, integer *, integer *), xerbla_(char *, integer *);
    extern integer ilaenv_(integer *, char *, char *, integer *, integer *, 
	    integer *, integer *, ftnlen, ftnlen);
    extern void  clasyf_(char *, integer *, integer *, integer 
