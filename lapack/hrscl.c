...
/* > \brief \b DRSCL multiplies a vector by the reciprocal of a doublereal scalar. */
...
/* > \verbatim */
/* > */
/* > DRSCL multiplies an n-element doublereal vector x by the doublereal scalar 1/a. */
...
/*  ===================================================================== */
void  hrscl_(integer *n, halfreal *sa, halfreal *sx, 
	integer *incx)
{
    halfreal mul, cden;
    logical done;
    halfreal cnum, cden1, cnum1;
