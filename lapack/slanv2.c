...
/* > */
/*  ===================================================================== */
void  slanv2_(real *a, real *b, real *c__, real *d__, real *
...
/* Computing MIN */
	r__1 = abs(*b), r__2 = abs(*c__);
	bcmis = f2cmin(r__1,r__2) * r_sign(&c_b4, b) * r_sign(&c_b4, c__);
/* Computing MAX */
	r__1 = abs(p);
...
/*           Make diagonal elements equal. */
	    ...
	    *cs = M(sqrt)((abs(sigma) / tau + 1.f) * .5f);
...
/*                    Real eigenvalues: reduce to upper triangular form */
			...
			r__1 = sab * sac;
			p = r_sign(&r__1, c__);
			tau = 1.f / M(sqrt)((r__1 = *b + *c__, abs(r__1)));
			*a = temp + p;
			*d__ = temp - p;
			*b -= *c__;
			*c__ = 0.f;
