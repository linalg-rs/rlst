...
/* > */
/*  ===================================================================== */
void  ktrsna_(char *job, char *howmny, logical *select, 
	integer *n, halfcomplex *t, integer *ldt, halfcomplex *vl, 
	integer *ldvl, halfcomplex *vr, integer *ldvr, halfreal *s, 
	halfreal *sep, integer *mm, integer *m, halfcomplex *work, 
	integer *ldwork, halfreal *rwork, integer *info)
{
    ...
    extern void  klacn2_(integer *, halfcomplex *, 
	    halfcomplex *, halfreal *, integer *, integer *), hlabad_(
	    halfreal *, halfreal *);
    ...
    extern void  klatrs_(char *, char *, char *, char *, 
	    ...
	    halfreal *, halfreal *, integer *), ktrexc_(char *, integer *, halfcomplex *, integer *, 
...
/*           eigenvalue. */
	    ...
	    whotc_(&z__1, n, &vr[ks * vr_dim1 + 1], &c__1, &vl[ks * vl_dim1 + 
		    1], &c__1);
...
/*           diagonal element to the (1,1) position. */
	    ...
	    klacpy_("Full", n, n, &t[t_offset], ldt, &work[work_offset], 
		    ldwork);
	    ktrexc_("No Q", n, &work[work_offset], ldwork, dummy, &c__1, &k, &
		    c__1, &ierr);
...
L30:
	    i__2 = *n - 1;
	    klacn2_(&i__2, &work[(*n + 1) * work_dim1 + 1], &work[work_offset]
		    , &est, &kase, isave);
...
/*                 Solve C**H*x = scale*b */
		    ...
		    i__2 = *n - 1;
		    klatrs_("Upper", "Conjugate transpose", "Nonunit", normin,
...
/*                 Solve C*x = scale*b */
		    ...
		    i__2 = *n - 1;
		    klatrs_("Upper", "No transpose", "Nonunit", normin, &i__2,
...
/*                 overflow. */
		    ...
		    i__2 = *n - 1;
		    ix = ikamax_(&i__2, &work[work_offset], &c__1);
		    i__2 = ix + work_dim1;
		    ...
		    whrscl_(n, &scale, &work[work_offset], &c__1);
		}
		goto L30;
	    }
