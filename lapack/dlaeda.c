...
/*  ===================================================================== */
void  dlaeda_(integer *n, integer *tlvls, integer *curlvl, 
...
/*     roots. */
    ...
    bsiz1 = (integer) (M(sqrt)((doublereal) (qptr[curr + 1] - qptr[curr])) + .5);
    bsiz2 = (integer) (M(sqrt)((doublereal) (qptr[curr + 2] - qptr[curr + 1])) + 
	    .5);
    i__1 = mid - bsiz1 - 1;
    for (k = 1; k <= i__1; ++k) {
	z__[k] = 0.;
...
/*        square roots. */
	...
	bsiz1 = (integer) (M(sqrt)((doublereal) (qptr[curr + 1] - qptr[curr])) + 
		.5);
	bsiz2 = (integer) (M(sqrt)((doublereal) (qptr[curr + 2] - qptr[curr + 1])
		) + .5);
	if (bsiz1 > 0) {
