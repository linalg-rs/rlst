...
/*  ===================================================================== */
void  kgetrf_(integer *m, integer *n, halfcomplex *a, 
	integer *lda, integer *ipiv, integer *info)
{
    ...
    extern void  kgemm_(char *, char *, integer *, integer *, 
	    ...
	    integer *), ktrsm_(char *, char *, char *, char *,
    ...
    extern void  klaswp_(integer *, halfcomplex *, integer *,
	     integer *, integer *, integer *, integer *), kgetrf2_(integer *, 
...
/*        Use unblocked code. */
	...
	kgetrf2_(m, n, &a[a_offset], lda, &ipiv[1], info);
    } else {
...
/*           singularity. */
	    ...
	    i__3 = *m - j + 1;
	    kgetrf2_(&i__3, &jb, &a[j + j * a_dim1], lda, &ipiv[j], &iinfo);
...
/*           Apply interchanges to columns 1:J-1. */
	    ...
	    i__3 = j - 1;
	    i__4 = j + jb - 1;
	    klaswp_(&i__3, &a[a_offset], lda, &j, &i__4, &ipiv[1], &c__1);
...
/*              Apply interchanges to columns J+JB:N. */
		...
		i__3 = *n - j - jb + 1;
		i__4 = j + jb - 1;
		klaswp_(&i__3, &a[(j + jb) * a_dim1 + 1], lda, &j, &i__4, &
			ipiv[1], &c__1);

/*              Compute block row of U. */

		i__3 = *n - j - jb + 1;
		ktrsm_("Left", "Lower", "No transpose", "Unit", &jb, &i__3, &
...
/*                 Update trailing submatrix. */
		    ...
		    i__4 = *n - j - jb + 1;
		    z__1.r = -1., z__1.i = -0.;
		    kgemm_("No transpose", "No transpose", &i__3, &i__4, &jb, 
