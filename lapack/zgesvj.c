...
/* > */
/*  ===================================================================== */
void  zgesvj_(char *joba, char *jobu, char *jobv, integer *m, 
	...
	lwork, doublereal *rwork, integer *lrwork, integer *info)
{
    ...
    integer ierr;
    doublecomplex ompq;
    extern void  zrot_(integer *, doublecomplex *, integer *, 
    ...
    extern void  zgsvj0_(char *, integer *, integer *, 
    ...
    integer blskip;
    doublereal mxaapq;
    extern void  zlascl_(char *, integer *, integer *, 
