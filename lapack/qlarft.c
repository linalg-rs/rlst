...
/* > */
/*  ===================================================================== */
void  qlarft_(char *direct, char *storev, integer *n, integer *
	k, quadreal *v, integer *ldv, quadreal *tau, quadreal *t, 
	integer *ldt)
{
    ...
    extern void  qtrmv_(char *, char *, char *, integer *, 
	    quadreal *, integer *, quadreal *, integer *), mecago_();
...
/*                 T(1:i-1,i) := - tau(i) * V(i:j,1:i-1)**T * V(i:j,i) */
		    ...
		    i__3 = i__ - 1;
		    d__1 = -tau[i__];
		    qgemv_("Transpose", &i__2, &i__3, &d__1, &v[i__ + 1 + 
...
/*                 T(1:i-1,i) := - tau(i) * V(1:i-1,i:j) * V(i,i:j)**T */
		    ...
		    i__3 = j - i__;
		    d__1 = -tau[i__];
		    qgemv_("No transpose", &i__2, &i__3, &d__1, &v[(i__ + 1) *
...
/*              T(1:i-1,i) := T(1:i-1,1:i-1) * T(1:i-1,i) */
		...
		i__2 = i__ - 1;
		qtrmv_("Upper", "No transpose", "Non-unit", &i__2, &t[
...
/*                    T(i+1:k,i) = -tau(i) * V(j:n-k+i,i+1:k)**T * V(j:n-k+i,i) */
			...
			i__2 = *k - i__;
			d__1 = -tau[i__];
			qgemv_("Transpose", &i__1, &i__2, &d__1, &v[j + (i__ 
...
/*                    T(i+1:k,i) = -tau(i) * V(i+1:k,j:n-k+i) * V(i,j:n-k+i)**T */
			...
			i__2 = *n - *k + i__ - j;
			d__1 = -tau[i__];
			qgemv_("No transpose", &i__1, &i__2, &d__1, &v[i__ + 
...
/*                 T(i+1:k,i) := T(i+1:k,i+1:k) * T(i+1:k,i) */
		    ...
		    i__1 = *k - i__;
		    qtrmv_("Lower", "No transpose", "Non-unit", &i__1, &t[i__ 
