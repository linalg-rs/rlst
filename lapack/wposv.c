...
/*  ===================================================================== */
void  wposv_(char *uplo, integer *n, integer *nrhs, 
	...
	integer *info)
{
    ...
    extern void  xerbla_(char *, integer *), wpotrf_(
	    char *, integer *, quadcomplex *, integer *, integer *),
	     wpotrs_(char *, integer *, integer *, quadcomplex *, integer *,
...
/*        Solve the system A*X = B, overwriting B with X. */
	...
	wpotrs_(uplo, n, nrhs, &a[a_offset], lda, &b[b_offset], ldb, info);
