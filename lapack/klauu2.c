...
/*  ===================================================================== */
void  klauu2_(char *uplo, integer *n, halfcomplex *a, 
...
/*        Compute the product U * U**H. */
	...
	for (i__ = 1; i__ <= i__1; ++i__) {
		...
		i__2 = i__ + i__ * a_dim1;
		i__3 = *n - i__;
		whotc_(&z__1, &i__3, &a[i__ + (i__ + 1) * a_dim1], lda, &a[
		...
		i__3 = *n - i__;
		z__1.r = aii, z__1.i = 0.;
		kgemv_("No transpose", &i__2, &i__3, &c_b1, &a[(i__ + 1) * 
			a_dim1 + 1], lda, &a[i__ + (i__ + 1) * a_dim1], lda, &
			z__1, &a[i__ * a_dim1 + 1], &c__1);
		i__2 = *n - i__;
		klacgv_(&i__2, &a[i__ + (i__ + 1) * a_dim1], lda);
	    } else {
		whscal_(&i__, &aii, &a[i__ * a_dim1 + 1], &c__1);
	    }
/* L10: */
	}
...
/*        Compute the product L**H * L. */
	...
	for (i__ = 1; i__ <= i__1; ++i__) {
		...
		i__2 = i__ + i__ * a_dim1;
		i__3 = *n - i__;
		whotc_(&z__1, &i__3, &a[i__ + 1 + i__ * a_dim1], &c__1, &a[
		...
		i__3 = i__ - 1;
		z__1.r = aii, z__1.i = 0.;
		kgemv_("Conjugate transpose", &i__2, &i__3, &c_b1, &a[i__ + 1 
			+ a_dim1], lda, &a[i__ + 1 + i__ * a_dim1], &c__1, &
			z__1, &a[i__ + a_dim1], lda);
		i__2 = i__ - 1;
		klacgv_(&i__2, &a[i__ + a_dim1], lda);
	    } else {
		whscal_(&i__, &aii, &a[i__ + a_dim1], lda);
	    }
/* L20: */
	}
    }
