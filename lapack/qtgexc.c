...
/* > \verbatim */
/* > */
/* > DTGEXC reorders the generalized doublereal Schur decomposition of a doublereal */
...
/* >          On entry, the matrix A in generalized doublereal Schur canonical */
/* >          form. */
/* >          On exit, the updated matrix A, again in generalized */
/* >          doublereal Schur canonical form. */
/* > \endverbatim */
/* > */
/* > \param[in] LDA */
/* > \verbatim */
...
/* >          On entry, the matrix B in generalized doublereal Schur canonical */
/* >          form (A,B). */
/* >          On exit, the updated matrix B, again in generalized */
/* >          doublereal Schur canonical form (A,B). */
/* > \endverbatim */
/* > */
/* > \param[in] LDB */
/* > \verbatim */
...
/* > */
/*  ===================================================================== */
void  qtgexc_(logical *wantq, logical *wantz, integer *n, 
	quadreal *a, integer *lda, quadreal *b, integer *ldb, quadreal *
	q, integer *ldq, quadreal *z__, integer *ldz, integer *ifst, 
	integer *ilst, quadreal *work, integer *lwork, integer *info)
{
    ...
    extern void  qtgex2_(logical *, logical *, integer *, 
	    quadreal *, integer *, quadreal *, integer *, quadreal *, 
	    integer *, quadreal *, integer *, integer *, integer *, integer 
...
/*           Current block either 1-by-1 or 2-by-2. */
	    ...
	    qtgex2_(wantq, wantz, n, &a[a_offset], lda, &b[b_offset], ldb, &q[
...
/*              Swap two 1-by-1 blocks. */
		...
		qtgex2_(wantq, wantz, n, &a[a_offset], lda, &b[b_offset], ldb,
...
/*                 2-by-2 block did not split. */
		    ...
		    qtgex2_(wantq, wantz, n, &a[a_offset], lda, &b[b_offset], 
