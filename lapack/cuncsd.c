...
/*  ===================================================================== */
void  cuncsd_(char *jobu1, char *jobu2, char *jobv1t, char *
	...
	lwork, real *rwork, integer *lrwork, integer *iwork, integer *info)
{
    ...
    extern void  cunglq_(integer *, integer *, integer *, 
	    complex *, integer *, complex *, complex *, integer *, integer *);
    integer lorgqrworkopt, iorglq;
    extern void  cungqr_(integer *, integer *, integer *, 
	    complex *, integer *, complex *, complex *, integer *, integer *);
    integer iorgqr;
