...
/* > doublereal bidiagonal form B by a unitary transformation: Q**H * A * P = B. */
/* > */
...
/* > */
/*  ===================================================================== */
void  wgebd2_(integer *m, integer *n, quadcomplex *a, 
	integer *lda, quadreal *d__, quadreal *e, quadcomplex *tauq, 
	quadcomplex *taup, quadcomplex *work, integer *info)
{
...
/*           Apply H(i)**H to A(i:m,i+1:n) from the left */
		...
		wlarf_("Left", &i__2, &i__3, &a[i__ + i__ * a_dim1], &c__1, &
...
/*              Apply G(i) to A(i+1:m,i+1:n) from the right */
		...
		i__2 = *m - i__;
		i__3 = *n - i__;
		wlarf_("Right", &i__2, &i__3, &a[i__ + (i__ + 1) * a_dim1], 
...
/*           Apply G(i) to A(i+1:m,i:n) from the right */
		...
		i__2 = *m - i__;
		i__3 = *n - i__ + 1;
		wlarf_("Right", &i__2, &i__3, &a[i__ + i__ * a_dim1], lda, &
...
/*              Apply H(i)**H to A(i+1:m,i+1:n) from the left */
		...
		i__3 = *n - i__;
		d_cnjg(&z__1, &tauq[i__]);
		wlarf_("Left", &i__2, &i__3, &a[i__ + 1 + i__ * a_dim1], &
