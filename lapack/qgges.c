...
/* > \verbatim */
/* > */
/* > DGGES computes for a pair of N-by-N doublereal nonsymmetric matrices (A,B), */
...
/*  ===================================================================== */
void  qgges_(char *jobvsl, char *jobvsr, char *sort, L_fp 
...
/*     (Workspace: need N, prefer N*NB) */
    ...
    if (ilvsl) {
	qlaset_("Full", n, n, &c_b38, &c_b39, &vsl[vsl_offset], ldvsl);
	if (irows > 1) {
	    i__1 = irows - 1;
	    i__2 = irows - 1;
...
/*     Initialize VSR */
    ...
    if (ilvsr) {
	qlaset_("Full", n, n, &c_b38, &c_b39, &vsr[vsr_offset], ldvsr);
    }
