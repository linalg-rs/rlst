...
/*  ===================================================================== */
void  cgbsvx_(char *fact, char *trans, integer *n, integer *kl,
	...
	*ferr, real *berr, complex *work, real *rwork, integer *info)
{
    ...
    extern real clangb_(char *, integer *, integer *, integer *, complex *, 
	    integer *, real *);
    extern void  claqgb_(integer *, integer *, integer *, 
    ...
    extern real clantb_(char *, char *, char *, integer *, integer *, complex 
	    *, integer *, real *);
    extern void  cgbequ_(integer *, integer *, integer *, 
	    integer *, complex *, integer *, real *, real *, real *, real *, 
	    real *, integer *);
    extern real slamch_(char *);
    extern void  cgbrfs_(char *, integer *, integer *, integer 
    ...
    extern void  clacpy_(char *, integer *, integer *, complex 
	    *, integer *, complex *, integer *), xerbla_(char *, 
	    integer *);
    real bignum;
    extern void  cgbtrs_(char *, integer *, integer *, integer 
