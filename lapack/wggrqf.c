...
/* > */
/*  ===================================================================== */
void  wggrqf_(integer *m, integer *p, integer *n, 
	quadcomplex *a, integer *lda, quadcomplex *taua, quadcomplex *b,
	 integer *ldb, quadcomplex *taub, quadcomplex *work, integer *
	lwork, integer *info)
{
    ...
    extern void  wgeqrf_(integer *, integer *, quadcomplex *,
	    ...
	    ), wgerqf_(integer *, integer *, quadcomplex *, integer *, 
	    quadcomplex *, quadcomplex *, integer *, integer *);
    integer lwkopt;
    logical lquery;
    extern void  wunmrq_(char *, char *, integer *, integer *, 
...
/*     RQ factorization of M-by-N matrix A: A = R*Q */
    ...
    wgerqf_(m, n, &a[a_offset], lda, &taua[1], &work[1], lwork, info);
...
/* Computing MAX */
    i__2 = 1, i__3 = *m - *n + 1;
    wunmrq_("Right", "Conjugate Transpose", p, n, &i__1, &a[f2cmax(i__2,i__3) + 
...
/*     QR factorization of P-by-N matrix B: B = Z*T */
    ...
    wgeqrf_(p, n, &b[b_offset], ldb, &taub[1], &work[1], lwork, info);
/* Computing MAX */
