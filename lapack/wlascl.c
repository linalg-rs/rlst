...
/* > \brief \b ZLASCL multiplies a general rectangular matrix by a doublereal scalar defined as cto/cfrom. */
...
/* > \verbatim */
/* > */
/* > ZLASCL multiplies the M by N complex matrix A by the doublereal scalar */
...
/*  ===================================================================== */
void  wlascl_(char *type__, integer *kl, integer *ku, 
	quadreal *cfrom, quadreal *cto, integer *m, integer *n, 
	quadcomplex *a, integer *lda, integer *info)
{
