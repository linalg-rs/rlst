...
/*  ===================================================================== */
void  hstemr_(char *jobz, char *range, integer *n, halfreal *
	d__, halfreal *e, halfreal *vl, halfreal *vu, integer *il, 
	integer *iu, integer *m, halfreal *w, halfreal *z__, integer *ldz,
	 integer *nzc, integer *isuppz, logical *tryrac, halfreal *work, 
	integer *lwork, integer *iwork, integer *liwork, integer *info)
{
    ...
    integer lwmin;
    logical wantz;
    extern void  hlaev2_(halfreal *, halfreal *, 
    ...
    extern void  hlarrr_(integer *, halfreal *, halfreal *,
	     integer *), hlarrv_(integer *, halfreal *, halfreal *, 
	    halfreal *, halfreal *, halfreal *, integer *, integer *, 
	    integer *, integer *, halfreal *, halfreal *, halfreal *, 
	    halfreal *, halfreal *, halfreal *, integer *, integer *, 
	    halfreal *, halfreal *, integer *, integer *, halfreal *, 
	    integer *, integer *), hlasrt_(char *, integer *, halfreal *, 
	    integer *);
    halfreal thresh;
...
/*           eigenvalues */
	    ...
	    hlarrv_(n, &wl, &wu, &d__[1], &e[1], &pivmin, &iwork[iinspl], m, &
...
/* L50: */
		...
		if (i__ != 0) {
		    ...
		    w[j] = tmp;
		    if (wantz) {
			hswap_(n, &z__[i__ * z_dim1 + 1], &c__1, &z__[j * 
				z_dim1 + 1], &c__1);
			itmp = isuppz[(i__ << 1) - 1];
