...
/*  ===================================================================== */
void  clalsd_(char *uplo, integer *smlsiz, integer *n, integer 
	...
	info)
{
    ...
    extern void  csrot_(integer *, complex *, integer *, 
	    complex *, integer *, real *, real *);
    integer irwvt, icmpq1, icmpq2;
    extern void  clalsa_(integer *, integer *, integer *, 
    ...
    extern void  slasda_(integer *, integer *, integer *, 
    ...
    integer givcol;
    extern void  slasdq_(char *, integer *, integer *, integer 
...
/*     Book-keeping and setting up some constants. */
    ...
    nlvl = (integer) (M(log)((real) (*n) / (real) (*smlsiz + 1)) / M(log)(2.f)) + 1;
