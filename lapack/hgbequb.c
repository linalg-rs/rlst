...
/*  ===================================================================== */
void  hgbequb_(integer *m, integer *n, integer *kl, integer *
	ku, halfreal *ab, integer *ldab, halfreal *r__, halfreal *c__, 
	halfreal *rowcnd, halfreal *colcnd, halfreal *amax, integer *
	info)
{
    ...
    /* Local variables */
    integer i__, j, kd;
    halfreal radix, rcmin, rcmax;
    extern halfreal hlamch_(char *);
    extern void  xerbla_(char *, integer *);
    halfreal bignum, logrdx, smlnum;
