...
/*  ===================================================================== */
void  hlagtm_(char *trans, integer *n, integer *nrhs, 
	halfreal *alpha, halfreal *dl, halfreal *d__, halfreal *du, 
	halfreal *x, integer *ldx, halfreal *beta, halfreal *b, integer 
	*ldb)
{
