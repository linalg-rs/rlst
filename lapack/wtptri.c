...
/* > */
/*  ===================================================================== */
void  wtptri_(char *uplo, char *diag, integer *n, 
	quadcomplex *ap, integer *info)
{
...
/*           Compute elements 1:j-1 of j-th column. */
	    ...
	    i__2 = j - 1;
	    wtpmv_("Upper", "No transpose", diag, &i__2, &ap[1], &ap[jc], &
		    c__1);
	    i__2 = j - 1;
	    wscal_(&i__2, &ajj, &ap[jc], &c__1);
	    jc += j;
/* L30: */
	}
...
/*              Compute elements j+1:n of j-th column. */
		...
		i__1 = *n - j;
		wtpmv_("Lower", "No transpose", diag, &i__1, &ap[jclast], &ap[
			jc + 1], &c__1);
		i__1 = *n - j;
		wscal_(&i__1, &ajj, &ap[jc + 1], &c__1);
	    }
	    jclast = jc;
	    jc = jc - *n + j - 2;
/* L40: */
