...
/* > \verbatim */
/* > */
/* > DORGTR generates a doublereal orthogonal matrix Q which is defined as the */
...
/*  ===================================================================== */
void  horgtr_(char *uplo, integer *n, halfreal *a, integer *
	lda, halfreal *tau, halfreal *work, integer *lwork, integer *info)
{
    ...
    extern void  horgql_(integer *, integer *, integer *, 
...
/*        Generate Q(1:n-1,1:n-1) */
	...
	i__2 = *n - 1;
	i__3 = *n - 1;
	horgql_(&i__1, &i__2, &i__3, &a[a_offset], lda, &tau[1], &work[1], 
		lwork, &iinfo);
...
/*           Generate Q(2:n,2:n) */
	    ...
	    i__2 = *n - 1;
	    i__3 = *n - 1;
	    horgqr_(&i__1, &i__2, &i__3, &a[(a_dim1 << 1) + 2], lda, &tau[1], 
		    &work[1], lwork, &iinfo);
	}
    }
    work[1] = (halfreal) lwkopt;
