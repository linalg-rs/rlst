...
/* > \verbatim */
/* > */
/* > DORGHR generates a doublereal orthogonal matrix Q which is defined as the */
...
/*  ===================================================================== */
void  qorghr_(integer *n, integer *ilo, integer *ihi, 
...
/*        Generate Q(ilo+1:ihi,ilo+1:ihi) */
	...
	qorgqr_(&nh, &nh, &nh, &a[*ilo + 1 + (*ilo + 1) * a_dim1], lda, &tau[*
