...
/*  ===================================================================== */
void  qspgv_(integer *itype, char *jobz, char *uplo, integer *
	...
	integer *ldz, quadreal *work, integer *info)
{
    ...
    extern void  qspev_(char *, char *, integer *, quadreal *
...
/*     Transform problem to standard eigenvalue problem and solve. */
    ...
    qspev_(jobz, uplo, n, &ap[1], &w[1], &z__[z_offset], ldz, &work[1], info);
