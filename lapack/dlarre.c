...
/* > */
/*  ===================================================================== */
void  dlarre_(char *range, integer *n, doublereal *vl, 
	...
	iwork, integer *info)
{
    ...
    extern void  dcopy_(integer *, doublereal *, integer *, 
	    doublereal *, integer *);
    logical norep;
    extern void  dlasq2_(integer *, doublereal *, integer *);
    extern doublereal dlamch_(char *);
    integer ibegin;
    logical forceb;
    integer irange;
    doublereal sgndef;
    extern void  dlarra_(integer *, doublereal *, doublereal *,
    ...
    integer wbegin;
    extern void  dlarrd_(char *, char *, integer *, doublereal 
    ...
    extern void  dlarrk_(integer *, integer *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, integer *);
    logical usedqd;
    doublereal clwdth, isleft;
    extern void  dlarnv_(integer *, integer *, integer *, 
	    doublereal *);
...
/*           done by bisection when computing the eigenvectors */
	    rtol = M(log)((doublereal) in) * 4. * eps;
	    j = ibegin;
	    i__2 = in - 1;
	    for (i__ = 1; i__ <= i__2; ++i__) {
