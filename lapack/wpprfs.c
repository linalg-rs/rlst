...
/*  ===================================================================== */
void  wpprfs_(char *uplo, integer *n, integer *nrhs, 
	quadcomplex *ap, quadcomplex *afp, quadcomplex *b, integer *ldb,
	...
	quadcomplex *work, quadreal *rwork, integer *info)
{
    ...
    quadreal lstres;
    extern void  wpptrs_(char *, integer *, integer *, 
...
/*           Update solution and try again. */
	    ...
	    wpptrs_(uplo, n, &c__1, &afp[1], &work[1], n, info);
