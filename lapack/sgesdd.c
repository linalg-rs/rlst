...
/* > */
/*  ===================================================================== */
void  sgesdd_(char *jobz, integer *m, integer *n, real *a, 
	 ...
	 real *work, integer *lwork, integer *iwork, integer *info)
{
    ...
    /* Local variables */
    integer lwork_sgelqf_mn__, lwork_sgeqrf_mn__, lwork_sorglq_mn__, 
    ...
    integer idum[1], ierr, itau, lwork_sormbr_qln_mm__, lwork_sormbr_qln_mn__,
	    ...
	    lwork_sormbr_prt_mn__, lwork_sormbr_prt_nn__;
    extern logical lsame_(char *, char *);
    integer chunk;
    extern void  sgemm_(char *, char *, integer *, integer *, 
    ...
    integer bdspac;
    extern void  sbdsdc_(char *, char *, integer *, real *, 
    ...
    integer ldwrkl;
    extern void  sormbr_(char *, char *, char *, integer *, 
	    integer *, integer *, real *, integer *, real *, real *, integer *
	    , real *, integer *, integer *);
    integer ldwrkr, minwrk, ldwrku, maxwrk;
    extern void  sorglq_(integer *, integer *, integer *, real 
	    *, integer *, real *, real *, integer *, integer *);
    integer ldwkvt;
    real smlnum;
    logical wntqas;
    extern void  sorgqr_(integer *, integer *, integer *, real 
	    *, integer *, real *, real *, integer *, integer *);
    logical lquery;
