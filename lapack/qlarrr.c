...
/*  ===================================================================== */
void  qlarrr_(integer *n, quadreal *d__, quadreal *e, 
	integer *info)
{
    ...
    /* Local variables */
    integer i__;
    quadreal eps, tmp, tmp2, rmin;
    extern quadreal qlamch_(char *);
    quadreal offdig, safmin;
    logical yesrel;
    quadreal smlnum, offdig2;
...
/*     instead of the current OFFDIG + OFFDIG2 < 1 */
	...
	tmp2 = M(sqrt)((d__1 = d__[i__], abs(d__1)));
	if (tmp2 < rmin) {
	    yesrel = FALSE_;
	}
	if (! yesrel) {
