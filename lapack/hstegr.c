...
/*  ===================================================================== */
void  hstegr_(char *jobz, char *range, integer *n, halfreal *
	...
	integer *lwork, integer *iwork, integer *liwork, integer *info)
{
    ...
    /* Local variables */
    extern void  hstemr_(char *, char *, integer *, halfreal 
...
/*  ===================================================================== */
    ...
    *info = 0;
    tryrac = FALSE_;
    hstemr_(jobz, range, n, &d__[1], &e[1], vl, vu, il, iu, m, &w[1], &z__[
