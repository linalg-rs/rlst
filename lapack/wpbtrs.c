...
/*  ===================================================================== */
void  wpbtrs_(char *uplo, integer *n, integer *kd, integer *
	nrhs, quadcomplex *ab, integer *ldab, quadcomplex *b, integer *
	ldb, integer *info)
{
    ...
    extern void  wtbsv_(char *, char *, char *, integer *, 
	    integer *, quadcomplex *, integer *, quadcomplex *, integer *), xerbla_(char *, integer *);
...
/*           Solve U**H *X = B, overwriting B with X. */
	    ...
	    wtbsv_("Upper", "Conjugate transpose", "Non-unit", n, kd, &ab[
		    ab_offset], ldab, &b[j * b_dim1 + 1], &c__1);

/*           Solve U*X = B, overwriting B with X. */

	    wtbsv_("Upper", "No transpose", "Non-unit", n, kd, &ab[ab_offset],
...
/*           Solve L*X = B, overwriting B with X. */
	    ...
	    wtbsv_("Lower", "No transpose", "Non-unit", n, kd, &ab[ab_offset],
		     ldab, &b[j * b_dim1 + 1], &c__1);

/*           Solve L**H *X = B, overwriting B with X. */

	    wtbsv_("Lower", "Conjugate transpose", "Non-unit", n, kd, &ab[
		    ab_offset], ldab, &b[j * b_dim1 + 1], &c__1);
/* L20: */
	}
    }
