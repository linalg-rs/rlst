...
/* > \verbatim */
/* > */
/* > DPOTRI computes the inverse of a doublereal symmetric positive definite */
...
/*  ===================================================================== */
void  hpotri_(char *uplo, integer *n, halfreal *a, integer *
	lda, integer *info)
{
    ...
    extern void  xerbla_(char *, integer *), hlauum_(
	    char *, integer *, halfreal *, integer *, integer *), 
	    htrtri_(char *, char *, integer *, halfreal *, integer *, 
	    integer *);
...
/*     Invert the triangular Cholesky factor U or L. */
    ...
    htrtri_(uplo, "Non-unit", n, &a[a_offset], lda, info);
    if (*info > 0) {
	return;
    }
...
/*     Form inv(U) * inv(U)**T or inv(L)**T * inv(L). */
    ...
    hlauum_(uplo, n, &a[a_offset], lda, info);
