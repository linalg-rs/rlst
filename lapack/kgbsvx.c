...
/*  ===================================================================== */
void  kgbsvx_(char *fact, char *trans, integer *n, integer *kl,
	 integer *ku, integer *nrhs, halfcomplex *ab, integer *ldab, 
	halfcomplex *afb, integer *ldafb, integer *ipiv, char *equed, 
	halfreal *r__, halfreal *c__, halfcomplex *b, integer *ldb, 
	...
	info)
{
    ...
    halfreal colcnd;
    logical nofact;
    extern halfreal klangb_(char *, integer *, integer *, integer *, 
	    halfcomplex *, integer *, halfreal *);
    extern void  xerbla_(char *, integer *), klaqgb_(
	    integer *, integer *, integer *, integer *, halfcomplex *, 
	    integer *, halfreal *, halfreal *, halfreal *, halfreal *,
	     halfreal *, char *);
    halfreal bignum;
    extern void  kgbcon_(char *, integer *, integer *, integer 
	    *, halfcomplex *, integer *, integer *, halfreal *, 
	    halfreal *, halfcomplex *, halfreal *, integer *);
    integer infequ;
    logical colequ;
    extern halfreal klantb_(char *, char *, char *, integer *, integer *, 
	    halfcomplex *, integer *, halfreal *);
    halfreal rowcnd;
    extern void  kgbequ_(integer *, integer *, integer *, 
	    integer *, halfcomplex *, integer *, halfreal *, halfreal *,
	     halfreal *, halfreal *, halfreal *, integer *), kgbrfs_(
	    char *, integer *, integer *, integer *, integer *, halfcomplex 
	    *, integer *, halfcomplex *, integer *, integer *, 
	    halfcomplex *, integer *, halfcomplex *, integer *, 
	    halfreal *, halfreal *, halfcomplex *, halfreal *, 
	    integer *), kgbtrf_(integer *, integer *, integer *, 
	    integer *, halfcomplex *, integer *, integer *, integer *);
    logical notran;
    extern void  klacpy_(char *, integer *, integer *, 
	    halfcomplex *, integer *, halfcomplex *, integer *);
    halfreal smlnum;
    extern void  kgbtrs_(char *, integer *, integer *, integer 
	    *, integer *, halfcomplex *, integer *, integer *, 
...
/*        Compute row and column scalings to equilibrate the matrix A. */
	...
	kgbequ_(n, n, kl, ku, &ab[ab_offset], ldab, &r__[1], &c__[1], &rowcnd,
		 &colcnd, &amax, &infequ);
	if (infequ == 0) {

/*           Equilibrate the matrix. */

	    klaqgb_(n, n, kl, ku, &ab[ab_offset], ldab, &r__[1], &c__[1], &
...
/* Computing MIN */
	    ...
	    j2 = f2cmin(i__2,*n);
	    i__2 = j2 - j1 + 1;
	    kcopy_(&i__2, &ab[*ku + 1 - j + j1 + j * ab_dim1], &c__1, &afb[*
		    kl + *ku + 1 - j + j1 + j * afb_dim1], &c__1);
/* L70: */
	}

	kgbtrf_(n, n, kl, ku, &afb[afb_offset], ldafb, &ipiv[1], info);
...
/* Computing MAX */
	    ...
	    rpvgrw = klantb_("M", "U", "N", info, &i__1, &afb[f2cmax(i__4,i__5) 
...
/*     reciprocal pivot growth factor RPVGRW. */
	...
	*(unsigned char *)norm = 'I';
    ...
    anorm = klangb_(norm, n, kl, ku, &ab[ab_offset], ldab, &rwork[1]);
    i__1 = *kl + *ku;
    rpvgrw = klantb_("M", "U", "N", n, &i__1, &afb[afb_offset], ldafb, &rwork[
	    1]);
    if (rpvgrw == 0.) {
	rpvgrw = 1.;
    } else {
	rpvgrw = klangb_("M", n, kl, ku, &ab[ab_offset], ldab, &rwork[1]) / rpvgrw;
    }

/*     Compute the reciprocal of the condition number of A. */

    kgbcon_(norm, n, kl, ku, &afb[afb_offset], ldafb, &ipiv[1], &anorm, rcond,
	     &work[1], &rwork[1], info);

/*     Compute the solution matrix X. */

    klacpy_("Full", n, nrhs, &b[b_offset], ldb, &x[x_offset], ldx);
    kgbtrs_(trans, n, kl, ku, nrhs, &afb[afb_offset], ldafb, &ipiv[1], &x[
	    x_offset], ldx, info);

/*     Use iterative refinement to improve the computed solution and */
/*     compute error bounds and backward error estimates for it. */

    kgbrfs_(trans, n, kl, ku, nrhs, &ab[ab_offset], ldab, &afb[afb_offset], 
