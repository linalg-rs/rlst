...
/*  ===================================================================== */
void  qsbgv_(char *jobz, char *uplo, integer *n, integer *ka, 
	...
	integer *info)
{
    ...
    integer iinfo;
    logical upper, wantz;
    extern void  xerbla_(char *, integer *), qpbstf_(
	    char *, integer *, integer *, quadreal *, integer *, integer *), qsbtrd_(char *, char *, integer *, integer *, quadreal 
...
/*     For eigenvalues only, call DSTERF.  For eigenvectors, call SSTEQR. */
	...
	qsteqr_(jobz, n, &w[1], &work[inde], &z__[z_offset], ldz, &work[
		indwrk], info);
    }
    return;
