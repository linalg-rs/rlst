...
/*  ===================================================================== */
void  qorgqr_(integer *m, integer *n, integer *k, quadreal *
	...
	integer *info)
{
    ...
    extern void  qorg2r_(integer *, integer *, integer *, 
...
/*     Use unblocked code for the last or only block. */
	...
	i__2 = *n - kk;
	i__3 = *k - kk;
	qorg2r_(&i__1, &i__2, &i__3, &a[kk + 1 + (kk + 1) * a_dim1], lda, &
...
/*              H = H(i) H(i+1) . . . H(i+ib-1) */
		...
		i__2 = *m - i__ + 1;
		qlarft_("Forward", "Columnwise", &i__2, &ib, &a[i__ + i__ * 
...
/*           Apply H to rows i:m of current block */
	    ...
	    i__2 = *m - i__ + 1;
	    qorg2r_(&i__2, &ib, &ib, &a[i__ + i__ * a_dim1], lda, &tau[i__], &
		    work[1], &iinfo);
