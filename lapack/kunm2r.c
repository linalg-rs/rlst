...
/*  ===================================================================== */
void  kunm2r_(char *side, char *trans, integer *m, integer *n, 
	integer *k, halfcomplex *a, integer *lda, halfcomplex *tau, 
	halfcomplex *c__, integer *ldc, halfcomplex *work, integer *info)
{
    ...
    extern void  klarf_(char *, integer *, integer *, 
	    ...
	    integer *, halfcomplex *), xerbla_(char *, integer *);
    logical notran;
...
/*        Apply H(i) or H(i)**H */
	...
	klarf_(side, &mi, &ni, &a[i__ + i__ * a_dim1], &c__1, &taui, &c__[ic 
