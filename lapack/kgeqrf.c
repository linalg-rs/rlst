...
/* > */
/*  ===================================================================== */
void  kgeqrf_(integer *m, integer *n, halfcomplex *a, 
	 ...
	 integer *info)
{
    ...
    extern void  kgeqr2_(integer *, integer *, halfcomplex *,
...
/*           A(i:m,i:i+ib-1) */
	    ...
	    i__3 = *m - i__ + 1;
	    kgeqr2_(&i__3, &ib, &a[i__ + i__ * a_dim1], lda, &tau[i__], &work[
		    1], &iinfo);
	    if (i__ + ib <= *n) {
...
/*     Use unblocked code to factor the last or only block. */
	...
	i__2 = *m - i__ + 1;
	i__1 = *n - i__ + 1;
	kgeqr2_(&i__2, &i__1, &a[i__ + i__ * a_dim1], lda, &tau[i__], &work[1]
		, &iinfo);
    }
