...
/*  ===================================================================== */
void  chesvx_(char *fact, char *uplo, integer *n, integer *
	...
	integer *info)
{
    ...
    extern real clanhe_(char *, char *, integer *, complex *, integer *, real 
	    *);
    extern void  checon_(char *, integer *, complex *, integer 
	    *, integer *, real *, real *, complex *, integer *);
    extern real slamch_(char *);
    logical nofact;
    extern void  cherfs_(char *, integer *, integer *, complex 
    ...
    extern void  xerbla_(char *, integer *), chetrs_(
