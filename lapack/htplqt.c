...
/* > */
/*  ===================================================================== */
void  htplqt_(integer *m, integer *n, integer *l, integer *mb, 
	halfreal *a, integer *lda, halfreal *b, integer *ldb, halfreal *
	t, integer *ldt, halfreal *work, integer *info)
{
...
/* Computing MIN */
	...
	htplqt2_(&ib, &nb, &lb, &a[i__ + i__ * a_dim1], lda, &b[i__ + b_dim1],
...
/*     Update by applying H**T to B(I+IB:M,:) from the right */
	...
	if (i__ + ib <= *m) {
	    i__3 = *m - i__ - ib + 1;
	    i__4 = *m - i__ - ib + 1;
	    htprfb_("R", "N", "F", "R", &i__3, &nb, &ib, &lb, &b[i__ + b_dim1]
