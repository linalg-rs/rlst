...
/* > \verbatim */
/* > */
/* > DSYSV_ROOK computes the solution to a doublereal system of linear */
/* > equations */
/* >    A * X = B, */
...
/* > */
/* > DSYTRF_ROOK is called to compute the factorization of a doublereal */
...
/*  ===================================================================== */
void  dsysv_rook__(char *uplo, integer *n, integer *nrhs, 
	...
	ldb, quadreal *work, integer *lwork, integer *info)
{
    ...
    /* Local variables */
    extern void  dsytrf_rook__(char *, integer *, quadreal *,
	     integer *, integer *, quadreal *, integer *, integer *)
	    , dsytrs_rook__(char *, integer *, integer *, quadreal *, 
	    integer *, integer *, quadreal *, integer *, integer *);
