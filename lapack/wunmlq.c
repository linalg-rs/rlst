...
/*  ===================================================================== */
void  wunmlq_(char *side, char *trans, integer *m, integer *n, 
	 ...
	 integer *info)
{
    ...
    integer nbmin, iinfo;
    extern void  wunml2_(char *, char *, integer *, integer *, 
...
/*        Use unblocked code */
	...
	wunml2_(side, trans, m, n, k, &a[a_offset], lda, &tau[1], &c__[
...
/*           H = H(i) H(i+1) . . . H(i+ib-1) */
	    ...
	    i__4 = nq - i__ + 1;
	    wlarft_("Forward", "Rowwise", &i__4, &ib, &a[i__ + i__ * a_dim1], 
...
/*           Apply H or H**H */
	    ...
	    wlarfb_(side, transt, "Forward", "Rowwise", &mi, &ni, &ib, &a[i__ 
