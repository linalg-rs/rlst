...
/* > */
/*  ===================================================================== */
void  wlamswlq_(char *side, char *trans, integer *m, integer *
...
/* Computing MAX */
	...
	wgemlqt_(side, trans, m, n, k, mb, &a[a_offset], lda, &t[t_offset], 
...
/*         Multiply Q to the last block of C */
	...
	if (kk > 0) {
	    ii = *m - kk + 1;
	    wtpmlqt_("L", "C", &kk, n, k, &c__0, mb, &a[ii * a_dim1 + 1], lda,
...
/*         Multiply Q to the current block of C (1:M,I:I+NB) */
	    ...
	    --ctr;
	    i__3 = *nb - *k;
	    wtpmlqt_("L", "C", &i__3, n, k, &c__0, mb, &a[i__ * a_dim1 + 1], 
...
/*         Multiply Q to the first block of C (1:M,1:NB) */
	...
	wgemlqt_("L", "C", nb, n, k, mb, &a[a_dim1 + 1], lda, &t[t_offset], 
...
/*         Multiply Q to the first block of C */
	...
	ii = *m - kk + 1;
	ctr = 1;
	wgemlqt_("L", "N", nb, n, k, mb, &a[a_dim1 + 1], lda, &t[t_offset], 
		ldt, &c__[c_dim1 + 1], ldc, &work[1], info);
...
/*         Multiply Q to the current block of C (I:I+NB,1:N) */
	    ...
	    i__3 = *nb - *k;
	    wtpmlqt_("L", "N", &i__3, n, k, &c__0, mb, &a[i__ * a_dim1 + 1], 
		    lda, &t[(ctr * *k + 1) * t_dim1 + 1], ldt, &c__[c_dim1 + 
		    1], ldc, &c__[i__ + c_dim1], ldc, &work[1], info);
	    ++ctr;
...
/*         Multiply Q to the last block of C */
	    ...
	    wtpmlqt_("L", "N", &kk, n, k, &c__0, mb, &a[ii * a_dim1 + 1], lda,
		     &t[(ctr * *k + 1) * t_dim1 + 1], ldt, &c__[c_dim1 + 1], 
		    ldc, &c__[ii + c_dim1], ldc, &work[1], info);
...
/*         Multiply Q to the last block of C */
	...
	if (kk > 0) {
	    ii = *n - kk + 1;
	    wtpmlqt_("R", "N", m, &kk, k, &c__0, mb, &a[ii * a_dim1 + 1], lda,
		     &t[(ctr * *k + 1) * t_dim1 + 1], ldt, &c__[c_dim1 + 1], 
...
/*         Multiply Q to the current block of C (1:M,I:I+MB) */
	    ...
	    --ctr;
	    i__3 = *nb - *k;
	    wtpmlqt_("R", "N", m, &i__3, k, &c__0, mb, &a[i__ * a_dim1 + 1], 
		    lda, &t[(ctr * *k + 1) * t_dim1 + 1], ldt, &c__[c_dim1 + 
...
/*         Multiply Q to the first block of C (1:M,1:MB) */
	...
	wgemlqt_("R", "N", m, nb, k, mb, &a[a_dim1 + 1], lda, &t[t_offset], 
		ldt, &c__[c_dim1 + 1], ldc, &work[1], info);
...
/*       Multiply Q to the first block of C */
	...
	kk = (*n - *k) % (*nb - *k);
	ii = *n - kk + 1;
	wgemlqt_("R", "C", m, nb, k, mb, &a[a_dim1 + 1], lda, &t[t_offset], 
		ldt, &c__[c_dim1 + 1], ldc, &work[1], info);
	ctr = 1;
...
/*         Multiply Q to the current block of C (1:M,I:I+MB) */
	    ...
	    i__3 = *nb - *k;
	    wtpmlqt_("R", "C", m, &i__3, k, &c__0, mb, &a[i__ * a_dim1 + 1], 
		    lda, &t[(ctr * *k + 1) * t_dim1 + 1], ldt, &c__[c_dim1 + 
		    1], ldc, &c__[i__ * c_dim1 + 1], ldc, &work[1], info);
	    ++ctr;
...
/*       Multiply Q to the last block of C */
	    ...
	    wtpmlqt_("R", "C", m, &kk, k, &c__0, mb, &a[ii * a_dim1 + 1], lda,
		     &t[(ctr * *k + 1) * t_dim1 + 1], ldt, &c__[c_dim1 + 1], 
		    ldc, &c__[ii * c_dim1 + 1], ldc, &work[1], info);
