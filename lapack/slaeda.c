...
/*  ===================================================================== */
void  slaeda_(integer *n, integer *tlvls, integer *curlvl, 
...
/*     roots. */
    ...
    bsiz1 = (integer) (M(sqrt)((real) (qptr[curr + 1] - qptr[curr])) + .5f);
    bsiz2 = (integer) (M(sqrt)((real) (qptr[curr + 2] - qptr[curr + 1])) + .5f);
    i__1 = mid - bsiz1 - 1;
    for (k = 1; k <= i__1; ++k) {
	z__[k] = 0.f;
/* L10: */
...
/*        square roots. */
	...
	bsiz1 = (integer) (M(sqrt)((real) (qptr[curr + 1] - qptr[curr])) + .5f);
	bsiz2 = (integer) (M(sqrt)((real) (qptr[curr + 2] - qptr[curr + 1])) + 
		.5f);
	if (bsiz1 > 0) {
