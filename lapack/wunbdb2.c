...
/*     Reduce rows 1, ..., P of X11 and X21 */
	...
	if (i__ > 1) {
	    i__2 = *q - i__ + 1;
	    wqrot_(&i__2, &x11[i__ + i__ * x11_dim1], ldx11, &x21[i__ - 1 + 
...
/* Computing 2nd power */
	...
	i__3 = *m - *p - i__ + 1;
/* Computing 2nd power */
	d__2 = qwnrm2_(&i__3, &x21[i__ + i__ * x21_dim1], &c__1);
	...
	i__3 = *m - *p - i__ + 1;
	i__4 = *q - i__;
	wunbdb5_(&i__2, &i__3, &i__4, &x11[i__ + 1 + i__ * x11_dim1], &c__1, &
		x21[i__ + i__ * x21_dim1], &c__1, &x11[i__ + 1 + (i__ + 1) * 
		x11_dim1], ldx11, &x21[i__ + (i__ + 1) * x21_dim1], ldx21, &
		work[iorbdb5], &lorbdb5, &childinfo);
	i__2 = *p - i__;
	wscal_(&i__2, &c_b1, &x11[i__ + 1 + i__ * x11_dim1], &c__1);
	i__2 = *m - *p - i__ + 1;
	wlarfgp_(&i__2, &x21[i__ + i__ * x21_dim1], &x21[i__ + 1 + i__ * 
		x21_dim1], &c__1, &taup2[i__]);
	if (i__ < *p) {
	    i__2 = *p - i__;
	    wlarfgp_(&i__2, &x11[i__ + 1 + i__ * x11_dim1], &x11[i__ + 2 + 
		    i__ * x11_dim1], &c__1, &taup1[i__]);
	    phi[i__] = atan2((quadreal) x11[i__ + 1 + i__ * x11_dim1].r, (
		    quadreal) x21[i__ + i__ * x21_dim1].r);
	    c__ = M(cos)(phi[i__]);
	    s = M(sin)(phi[i__]);
	    ...
	    wlarf_("L", &i__2, &i__3, &x11[i__ + 1 + i__ * x11_dim1], &c__1, &
	...
	wlarf_("L", &i__2, &i__3, &x21[i__ + i__ * x21_dim1], &c__1, &z__1, &
