...
/*  ===================================================================== */
void  qlaed8_(integer *icompq, integer *k, integer *n, integer 
	*qsiz, quadreal *d__, quadreal *q, integer *ldq, integer *indxq, 
	quadreal *rho, integer *cutpnt, quadreal *z__, quadreal *dlamda,
	 quadreal *q2, integer *ldq2, quadreal *w, integer *perm, integer 
	*givptr, integer *givcol, quadreal *givnum, integer *indxp, integer 
	*indx, integer *info)
{
    ...
    extern void  qrot_(integer *, quadreal *, integer *, 
	    quadreal *, integer *, quadreal *, quadreal *), qscal_(
	    integer *, quadreal *, quadreal *, integer *), qcopy_(integer 
