...
/*  ===================================================================== */
void  hormlq_(char *side, char *trans, integer *m, integer *n, 
	...
	c__, integer *ldc, halfreal *work, integer *lwork, integer *info)
{
    ...
    integer nbmin, iinfo;
    extern void  horml2_(char *, char *, integer *, integer *, 
...
/*        Use unblocked code */
	...
	horml2_(side, trans, m, n, k, &a[a_offset], lda, &tau[1], &c__[
...
/*           H = H(i) H(i+1) . . . H(i+ib-1) */
	    ...
	    i__4 = nq - i__ + 1;
	    hlarft_("Forward", "Rowwise", &i__4, &ib, &a[i__ + i__ * a_dim1], 
...
/*           Apply H or H**T */
	    ...
	    hlarfb_(side, transt, "Forward", "Rowwise", &mi, &ni, &ib, &a[i__ 
