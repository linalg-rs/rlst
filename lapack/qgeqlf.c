...
/* > */
/*  ===================================================================== */
void  qgeqlf_(integer *m, integer *n, quadreal *a, integer *
	lda, quadreal *tau, quadreal *work, integer *lwork, integer *info)
{
    ...
    extern void  qgeql2_(integer *, integer *, quadreal *, 
...
/*           A(1:m-k+i+ib-1,n-k+i:n-k+i+ib-1) */
	    ...
	    i__3 = *m - k + i__ + ib - 1;
	    qgeql2_(&i__3, &ib, &a[(*n - k + i__) * a_dim1 + 1], lda, &tau[
		    i__], &work[1], &iinfo);
	    if (*n - k + i__ > 1) {
...
/*     Use unblocked code to factor the last or only block */
    ...
    if (mu > 0 && nu > 0) {
	qgeql2_(&mu, &nu, &a[a_offset], lda, &tau[1], &work[1], &iinfo);
    }
