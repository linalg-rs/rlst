...
/* > */
/*  ===================================================================== */
void  wppsv_(char *uplo, integer *n, integer *nrhs, 
	quadcomplex *ap, quadcomplex *b, integer *ldb, integer *info)
{
    ...
    extern void  xerbla_(char *, integer *), wpptrf_(
	    char *, integer *, quadcomplex *, integer *), wpptrs_(
...
/*     Compute the Cholesky factorization A = U**H *U or A = L*L**H. */
    ...
    wpptrf_(uplo, n, &ap[1], info);
    if (*info == 0) {

/*        Solve the system A*X = B, overwriting B with X. */

	wpptrs_(uplo, n, nrhs, &ap[1], &b[b_offset], ldb, info);
