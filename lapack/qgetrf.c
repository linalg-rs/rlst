...
/*  ===================================================================== */
void  qgetrf_(integer *m, integer *n, quadreal *a, integer *
	lda, integer *ipiv, integer *info)
{
    ...
    extern void  qlaswp_(integer *, quadreal *, integer *, 
	    integer *, integer *, integer *, integer *), qgetrf2_(integer *, 
...
/*        Use unblocked code. */
	...
	qgetrf2_(m, n, &a[a_offset], lda, &ipiv[1], info);
    } else {
...
/*           singularity. */
	    ...
	    i__3 = *m - j + 1;
	    qgetrf2_(&i__3, &jb, &a[j + j * a_dim1], lda, &ipiv[j], &iinfo);
...
/*           Apply interchanges to columns 1:J-1. */
	    ...
	    i__3 = j - 1;
	    i__4 = j + jb - 1;
	    qlaswp_(&i__3, &a[a_offset], lda, &j, &i__4, &ipiv[1], &c__1);
...
/*              Apply interchanges to columns J+JB:N. */
		...
		i__3 = *n - j - jb + 1;
		i__4 = j + jb - 1;
		qlaswp_(&i__3, &a[(j + jb) * a_dim1 + 1], lda, &j, &i__4, &
			ipiv[1], &c__1);
