...
/*        Compute (U \P**T * B) -> B    [ (U \P**T * B) ] */
	...
	htrsm_("L", "U", "N", "U", n, nrhs, &c_b9, &a[a_offset], lda, &b[
		b_offset], ldb);
...
/*        Compute (U**T \ B) -> B   [ U**T \ (D \ (U \P**T * B) ) ] */
	...
	htrsm_("L", "U", "T", "U", n, nrhs, &c_b9, &a[a_offset], lda, &b[
		b_offset], ldb);
...
/*        Compute (L \P**T * B) -> B    [ (L \P**T * B) ] */
	...
	htrsm_("L", "L", "N", "U", n, nrhs, &c_b9, &a[a_offset], lda, &b[
		b_offset], ldb);
...
/*        Compute (L**T \ B) -> B   [ L**T \ (D \ (L \P**T * B) ) ] */
	...
	htrsm_("L", "L", "T", "U", n, nrhs, &c_b9, &a[a_offset], lda, &b[
		b_offset], ldb);
