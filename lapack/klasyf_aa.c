...
static halfcomplex c_b6 = {-1.,-0.};
static integer c__1 = 1;
static halfcomplex c_b8 = {1.,0.};
static halfcomplex c_b19 = {0.,0.};
...
/*  ===================================================================== */
void  zlasyf_aa__(char *uplo, integer *j1, integer *m, integer 
...
/*           first column */
	    ...
	    i__1 = j - k1;
	    kgemv_("No transpose", &mj, &i__1, &c_b6, &h__[j + k1 * h_dim1], 
...
/*            where A(J, J+1) = T(J, J+1) and A(J+2:M, J) = L(J+2:M, J+1) */
		...
		i__1 = *m - j - 1;
		klaset_("Full", &c__1, &i__1, &c_b19, &c_b19, &a[k + (j + 2) *
			 a_dim1], lda);
	    }
	}
	++j;
...
/*            where A(J, J+1) = T(J, J+1) and A(J+2:M, J) = L(J+2:M, J+1) */
		...
		i__1 = *m - j - 1;
		klaset_("Full", &i__1, &c__1, &c_b19, &c_b19, &a[j + 2 + k * 
			a_dim1], lda);
	    }
	}
	++j;
