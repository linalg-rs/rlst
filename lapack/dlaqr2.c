...
/* > */
/*  ===================================================================== */
void  dlaqr2_(logical *wantt, logical *wantz, integer *n, 
	...
	nv, doublereal *wv, integer *ldwv, doublereal *work, integer *lwork)
{
    ...
    extern void  dcopy_(integer *, doublereal *, integer *, 
	    doublereal *, integer *);
    integer infqr, kwtop;
    extern void  dlanv2_(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *), dlabad_(
	    doublereal *, doublereal *);
    extern doublereal dlamch_(char *);
    extern void  dgehrd_(integer *, integer *, integer *, 
	    doublereal *, integer *, doublereal *, doublereal *, integer *, 
    ...
    doublereal safmax;
    extern void  dtrexc_(char *, integer *, doublereal *, 
