...
/* > */
/*  ===================================================================== */
void  qgeqr_(integer *m, integer *n, quadreal *a, integer *
	...
	integer *info)
{
    ...
    extern void  qgeqrt_(integer *, integer *, integer *, 
	    quadreal *, integer *, quadreal *, integer *, quadreal *, 
	    integer *);
    logical lminws, lquery;
    integer mintsz;
    extern void  qlatsqr_(integer *, integer *, integer *, 
...
/*     The QR Decomposition */
    ...
    if (*m <= *n || mb <= *n || mb >= *m) {
	qgeqrt_(m, n, &nb, &a[a_offset], lda, &t[6], &nb, &work[1], info);
    } else {
	qlatsqr_(m, n, &mb, &nb, &a[a_offset], lda, &t[6], &nb, &work[1], 
		lwork, info);
    }
