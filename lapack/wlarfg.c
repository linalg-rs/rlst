...
/*  ===================================================================== */
void  wlarfg_(integer *n, quadcomplex *alpha, quadcomplex *
	x, integer *incx, quadcomplex *tau)
{
    ...
    extern void  wscal_(integer *, quadcomplex *, 
	    quadcomplex *, integer *);
    quadreal xnorm;
    extern quadreal qlapy3_(quadreal *, quadreal *, quadreal *), 
	    qwnrm2_(integer *, quadcomplex *, integer *), qlamch_(char *);
    quadreal safmin;
