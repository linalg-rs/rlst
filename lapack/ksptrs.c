...
/*  ===================================================================== */
void  ksptrs_(char *uplo, integer *n, integer *nrhs, 
...
/*           Multiply by the inverse of the diagonal block. */
	    ...
	    kscal_(nrhs, &z__1, &b[k + b_dim1], ldb);
	    --k;
	} else {
...
/*           stored in column K of A. */
	    ...
	    i__1 = k - 1;
	    z__1.r = -1., z__1.i = -0.;
	    kgemv_("Transpose", &i__1, nrhs, &z__1, &b[b_offset], ldb, &ap[kc]
...
/*           stored in column K of A. */
		...
		i__1 = *n - k;
		z__1.r = -1., z__1.i = -0.;
		kgemv_("Transpose", &i__1, nrhs, &z__1, &b[k + 1 + b_dim1], 
