...
/*  ===================================================================== */
void  khegvx_(integer *itype, char *jobz, char *range, char *
	uplo, integer *n, halfcomplex *a, integer *lda, halfcomplex *b, 
	integer *ldb, halfreal *vl, halfreal *vu, integer *il, integer *
	iu, halfreal *abstol, integer *m, halfreal *w, halfcomplex *z__,
	 integer *ldz, halfcomplex *work, integer *lwork, halfreal *rwork,
	 integer *iwork, integer *ifail, integer *info)
{
    ...
    extern void  khegst_(integer *, char *, integer *, 
	    halfcomplex *, integer *, halfcomplex *, integer *, integer *), kheevx_(char *, char *, char *, integer *, 
	    halfcomplex *, integer *, halfreal *, halfreal *, integer *,
	     integer *, halfreal *, integer *, halfreal *, halfcomplex *
...
/*     Form a Cholesky factorization of B. */
    ...
    kpotrf_(uplo, n, &b[b_offset], ldb, info);
    if (*info != 0) {
	*info = *n + *info;
	return;
    }
...
/*     Transform problem to standard eigenvalue problem and solve. */
    ...
    khegst_(itype, uplo, n, &a[a_offset], lda, &b[b_offset], ldb, info);
    kheevx_(jobz, range, uplo, n, &a[a_offset], lda, vl, vu, il, iu, abstol, 
...
/*           backtransform eigenvectors: x = inv(L)**H *y or inv(U)*y */
		...
		*(unsigned char *)trans = 'C';
	    ...
	    ktrsm_("Left", uplo, trans, "Non-unit", n, m, &c_b1, &b[b_offset],
...
/*           backtransform eigenvectors: x = L*y or U**H *y */
		...
		*(unsigned char *)trans = 'N';
	    ...
	    ktrmm_("Left", uplo, trans, "Non-unit", n, m, &c_b1, &b[b_offset],
		     ldb, &z__[z_offset], ldz);
	}
    }
