...
/*  ===================================================================== */
void  chetri2x_(char *uplo, integer *n, complex *a, integer *
	lda, integer *ipiv, complex *work, integer *nb, integer *info)
{
    ...
    extern void  xerbla_(char *, integer *), ctrtri_(
	    char *, char *, integer *, complex *, integer *, integer *), csyconv_(char *, char *, integer *, complex *, 
