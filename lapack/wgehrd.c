...
/* > */
/*  ===================================================================== */
void  wgehrd_(integer *n, integer *ilo, integer *ihi, 
	quadcomplex *a, integer *lda, quadcomplex *tau, quadcomplex *
	work, integer *lwork, integer *info)
{
    ...
    extern void  wgemm_(char *, char *, integer *, integer *, 
	    ...
	    quadcomplex *, integer *), wgehd2_(integer *, integer *, 
	    integer *, quadcomplex *, integer *, quadcomplex *, 
	    quadcomplex *, integer *), wlahr2_(integer *, integer *, 
	    integer *, quadcomplex *, integer *, quadcomplex *, 
	    quadcomplex *, integer *, quadcomplex *, integer *), xerbla_(
	    char *, integer *);
    extern integer ilaenv_(integer *, char *, char *, integer *, integer *, 
	    integer *, integer *, ftnlen, ftnlen);
    extern void  wlarfb_(char *, char *, char *, char *, 
...
/*           which performs the reduction, and also the matrix Y = A*V*T */
	    ...
	    wlahr2_(ihi, &i__, &ib, &a[i__ * a_dim1 + 1], lda, &tau[i__], &
...
/*           to 1 */
	    ...
	    i__3 = *ihi - i__ - ib + 1;
	    z__1.r = -1., z__1.i = -0.;
	    wgemm_("No transpose", "Conjugate transpose", ihi, &i__3, &ib, &
...
/*           right */
	    ...
	    i__3 = ib - 1;
	    wtrmm_("Right", "Lower", "Conjugate transpose", "Unit", &i__, &
		    i__3, &c_b2, &a[i__ + 1 + i__ * a_dim1], lda, &work[1], &
		    ldwork);
	    i__3 = ib - 2;
	    for (j = 0; j <= i__3; ++j) {
		z__1.r = -1., z__1.i = -0.;
		waxpy_(&i__, &z__1, &work[ldwork * j + 1], &c__1, &a[(i__ + j 
			+ 1) * a_dim1 + 1], &c__1);
/* L30: */
	    }
...
/*           left */
	    ...
	    i__3 = *ihi - i__;
	    i__4 = *n - i__ - ib + 1;
	    wlarfb_("Left", "Conjugate transpose", "Forward", "Columnwise", &
...
/*     Use unblocked code to reduce the rest of the matrix */
    ...
    wgehd2_(n, &i__, ihi, &a[a_offset], lda, &tau[1], &work[1], &iinfo);
    work[1].r = (quadreal) lwkopt, work[1].i = 0.;
