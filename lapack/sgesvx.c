...
/*  ===================================================================== */
void  sgesvx_(char *fact, char *trans, integer *n, integer *
	...
	integer *iwork, integer *info)
{
    ...
    extern real slamch_(char *), slange_(char *, integer *, integer *,
	     real *, integer *, real *);
    logical nofact;
    extern void  slaqge_(integer *, integer *, real *, integer 
    ...
    integer infequ;
    logical colequ;
    extern void  sgeequ_(integer *, integer *, real *, integer 
    ...
    extern real slantr_(char *, char *, char *, integer *, integer *, real *, 
	    integer *, real *);
    extern void  sgetrs_(char *, integer *, integer *, real *, 
