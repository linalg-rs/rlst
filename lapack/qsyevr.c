...
/* > */
/*  ===================================================================== */
void  qsyevr_(char *jobz, char *range, char *uplo, integer *n, 
...
/*     then call DSTERF or DSTEMR and DORMTR. */
	...
	if (! wantz) {
	    ...
	    i__1 = *n - 1;
	    qcopy_(&i__1, &work[inde], &c__1, &work[indee], &c__1);
	    qcopy_(n, &work[indd], &c__1, &work[inddd], &c__1);
	    ...
	    qstemr_(jobz, "A", n, &work[inddd], &work[indee], vl, vu, il, iu, 
...
/*        form to eigenvectors returned by DSTEMR. */
		...
		qormtr_("L", uplo, "N", n, m, &a[a_offset], lda, &work[indtau]
