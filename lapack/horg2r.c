...
/* > \verbatim */
/* > */
/* > DORG2R generates an m by n doublereal matrix Q with orthonormal columns, */
...
/*  ===================================================================== */
void  horg2r_(integer *m, integer *n, integer *k, halfreal *
	a, integer *lda, halfreal *tau, halfreal *work, integer *info)
{
    ...
    extern void  hscal_(integer *, halfreal *, halfreal *, 
	    ...
	    integer *, halfreal *, halfreal *, integer *, halfreal *), xerbla_(char *, integer *);
...
/*        Apply H(i) to A(i:m,i:n) from the left */
	...
	if (i__ < *n) {
	    ...
	    i__1 = *m - i__ + 1;
	    i__2 = *n - i__;
	    hlarf_("Left", &i__1, &i__2, &a[i__ + i__ * a_dim1], &c__1, &tau[
		    i__], &a[i__ + (i__ + 1) * a_dim1], lda, &work[1]);
	}
	if (i__ < *m) {
	    i__1 = *m - i__;
	    d__1 = -tau[i__];
	    hscal_(&i__1, &d__1, &a[i__ + 1 + i__ * a_dim1], &c__1);
	}
