...
/*  ===================================================================== */
void  hgemlqt_(char *side, char *trans, integer *m, integer *n,
	 integer *k, integer *mb, halfreal *v, integer *ldv, halfreal *t, 
	integer *ldt, halfreal *c__, integer *ldc, halfreal *work, 
	integer *info)
{
    ...
    logical right;
    extern void  hlarfb_(char *, char *, char *, char *, 
...
/* Computing MIN */
	    ...
	    ib = f2cmin(i__3,i__4);
	    i__3 = *m - i__ + 1;
	    hlarfb_("L", "T", "F", "R", &i__3, n, &ib, &v[i__ + i__ * v_dim1],
...
/* Computing MIN */
	    ...
	    ib = f2cmin(i__3,i__4);
	    i__3 = *n - i__ + 1;
	    hlarfb_("R", "N", "F", "R", m, &i__3, &ib, &v[i__ + i__ * v_dim1],
...
/* Computing MIN */
	    ...
	    ib = f2cmin(i__2,i__3);
	    i__2 = *m - i__ + 1;
	    hlarfb_("L", "N", "F", "R", &i__2, n, &ib, &v[i__ + i__ * v_dim1],
		     ldv, &t[i__ * t_dim1 + 1], ldt, &c__[i__ + c_dim1], ldc, 
		    &work[1], &ldwork);
	}
...
/* Computing MIN */
	    ...
	    ib = f2cmin(i__2,i__3);
	    i__2 = *n - i__ + 1;
	    hlarfb_("R", "T", "F", "R", m, &i__2, &ib, &v[i__ + i__ * v_dim1],
		     ldv, &t[i__ * t_dim1 + 1], ldt, &c__[i__ * c_dim1 + 1], 
		    ldc, &work[1], &ldwork);
	}
