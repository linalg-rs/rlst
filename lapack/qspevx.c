...
/*  ===================================================================== */
void  qspevx_(char *jobz, char *range, char *uplo, integer *n, 
	quadreal *ap, quadreal *vl, quadreal *vu, integer *il, integer *
	iu, quadreal *abstol, integer *m, quadreal *w, quadreal *z__, 
	...
	integer *info)
{
    ...
    integer indwrk;
    extern void  qopgtr_(char *, integer *, quadreal *, 
	    quadreal *, quadreal *, integer *, quadreal *, integer *), qsptrd_(char *, integer *, quadreal *, quadreal *, 
	    quadreal *, quadreal *, integer *), qsteqr_(char *, 
	    integer *, quadreal *, quadreal *, quadreal *, integer *, 
	    quadreal *, integer *), qopmtr_(char *, char *, char *, 
...
/*     for some eigenvalue, then try DSTEBZ. */
	...
	if (! wantz) {
	    ...
	    qopgtr_(uplo, n, &ap[1], &work[indtau], &z__[z_offset], ldz, &
		    work[indwrk], &iinfo);
	    i__1 = *n - 1;
	    qcopy_(&i__1, &work[inde], &c__1, &work[indee], &c__1);
...
/*        form to eigenvectors returned by DSTEIN. */
	...
	qopmtr_("L", uplo, "N", n, m, &ap[1], &work[indtau], &z__[z_offset], 
