...
/*  ===================================================================== */
void  hsygvx_(integer *itype, char *jobz, char *range, char *
	uplo, integer *n, halfreal *a, integer *lda, halfreal *b, integer 
	*ldb, halfreal *vl, halfreal *vu, integer *il, integer *iu, 
	...
	integer *ifail, integer *info)
{
    ...
    extern void  hpotrf_(char *, integer *, halfreal *, 
	    integer *, integer *);
    integer lwkmin;
    extern void  hsygst_(integer *, char *, integer *, 
	    halfreal *, integer *, halfreal *, integer *, integer *);
    integer lwkopt;
    logical lquery;
    extern void  hsyevx_(char *, char *, char *, integer *, 
...
/*     Transform problem to standard eigenvalue problem and solve. */
    ...
    hsyevx_(jobz, range, uplo, n, &a[a_offset], lda, vl, vu, il, iu, abstol, 
...
/*           backtransform eigenvectors: x = inv(L)**T*y or inv(U)*y */
		...
		*(unsigned char *)trans = 'T';
	    ...
	    htrsm_("Left", uplo, trans, "Non-unit", n, m, &c_b19, &b[b_offset]
...
/*           backtransform eigenvectors: x = L*y or U**T*y */
		...
		*(unsigned char *)trans = 'N';
	    ...
	    htrmm_("Left", uplo, trans, "Non-unit", n, m, &c_b19, &b[b_offset]
		    , ldb, &z__[z_offset], ldz);
	}
    }
