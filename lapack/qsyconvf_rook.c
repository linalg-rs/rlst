...
/* > \endverbatim */
/*  ===================================================================== */
void  dsyconvf_rook__(char *uplo, char *way, integer *n, 
	quadreal *a, integer *lda, quadreal *e, integer *ipiv, integer *
	info)
{
...
/*                 Swap rows i and IPIV(i) in A(1:i,N-i:N) */
			...
			if (ip != i__) {
			    i__1 = *n - i__;
			    qswap_(&i__1, &a[i__ + (i__ + 1) * a_dim1], lda, &
...
/*                 in A(1:i,N-i:N) */
			...
			if (ip2 != i__ - 1) {
			    i__1 = *n - i__;
			    qswap_(&i__1, &a[i__ - 1 + (i__ + 1) * a_dim1], 
...
/*                 Swap rows i and IPIV(i) in A(1:i,N-i:N) */
			...
			if (ip != i__) {
			    i__1 = *n - i__;
			    qswap_(&i__1, &a[ip + (i__ + 1) * a_dim1], lda, &
...
/*                 in A(1:i,N-i:N) */
			...
			if (ip2 != i__ - 1) {
			    i__1 = *n - i__;
			    qswap_(&i__1, &a[ip2 + (i__ + 1) * a_dim1], lda, &
...
/*                 Swap rows i and IPIV(i) in A(i:N,1:i-1) */
			...
			if (ip != i__) {
			    i__1 = i__ - 1;
			    qswap_(&i__1, &a[i__ + a_dim1], lda, &a[ip + 
				    a_dim1], lda);
			}
		    }
...
/*                 in A(i:N,1:i-1) */
			...
			if (ip2 != i__ + 1) {
			    i__1 = i__ - 1;
			    qswap_(&i__1, &a[i__ + 1 + a_dim1], lda, &a[ip2 + 
				    a_dim1], lda);
			}
		    }
		    ++i__;
...
/*                 Swap rows i and IPIV(i) in A(i:N,1:i-1) */
			...
			if (ip != i__) {
			    i__1 = i__ - 1;
			    qswap_(&i__1, &a[ip + a_dim1], lda, &a[i__ + 
				    a_dim1], lda);
			}
		    }
...
/*                 in A(i:N,1:i-1) */
			...
			if (ip2 != i__ + 1) {
			    i__1 = i__ - 1;
			    qswap_(&i__1, &a[ip2 + a_dim1], lda, &a[i__ + 1 + 
				    a_dim1], lda);
			}
			if (ip != i__) {
			    i__1 = i__ - 1;
