...
/* > */
/*  ===================================================================== */
void  htptri_(char *uplo, char *diag, integer *n, halfreal *
	ap, integer *info)
{
...
/*           Compute elements 1:j-1 of j-th column. */
	    ...
	    i__2 = j - 1;
	    htpmv_("Upper", "No transpose", diag, &i__2, &ap[1], &ap[jc], &
		    c__1);
	    i__2 = j - 1;
	    hscal_(&i__2, &ajj, &ap[jc], &c__1);
	    jc += j;
/* L30: */
	}
...
/*              Compute elements j+1:n of j-th column. */
		...
		i__1 = *n - j;
		htpmv_("Lower", "No transpose", diag, &i__1, &ap[jclast], &ap[
			jc + 1], &c__1);
		i__1 = *n - j;
		hscal_(&i__1, &ajj, &ap[jc + 1], &c__1);
	    }
	    jclast = jc;
	    jc = jc - *n + j - 2;
/* L40: */
