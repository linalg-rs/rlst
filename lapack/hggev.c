...
/*  ===================================================================== */
void  hggev_(char *jobvl, char *jobvr, integer *n, halfreal *
...
/*     (Workspace: need N, prefer N*NB) */
    ...
    if (ilvl) {
	hlaset_("Full", n, n, &c_b36, &c_b37, &vl[vl_offset], ldvl)
		;
	if (irows > 1) {
	    i__1 = irows - 1;
	    i__2 = irows - 1;
...
/*     Initialize VR */
    ...
    if (ilvr) {
	hlaset_("Full", n, n, &c_b36, &c_b37, &vr[vr_offset], ldvr)
		;
    }
...
/*        Eigenvectors requested -- work on whole matrix. */
	...
	hgghrd_("N", "N", &irows, &c__1, &irows, &a[ilo + ilo * a_dim1], lda, 
