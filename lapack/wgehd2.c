...
/* > */
/*  ===================================================================== */
void  wgehd2_(integer *n, integer *ilo, integer *ihi, 
...
/* Computing MIN */
	i__3 = i__ + 2;
	wlarfg_(&i__2, &alpha, &a[f2cmin(i__3,*n) + i__ * a_dim1], &c__1, &tau[
		i__]);
	i__2 = i__ + 1 + i__ * a_dim1;
...
/*        Apply H(i) to A(1:ihi,i+1:ihi) from the right */
	...
	i__2 = *ihi - i__;
	wlarf_("Right", ihi, &i__2, &a[i__ + 1 + i__ * a_dim1], &c__1, &tau[
...
/*        Apply H(i)**H to A(i+1:ihi,i+1:n) from the left */
	...
	i__3 = *n - i__;
	d_cnjg(&z__1, &tau[i__]);
	wlarf_("Left", &i__2, &i__3, &a[i__ + 1 + i__ * a_dim1], &c__1, &z__1,
