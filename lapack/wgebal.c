...
/* > */
/*  ===================================================================== */
void  wgebal_(char *job, integer *n, quadcomplex *a, integer 
...
L20:
    ...
    i__1 = *n - k + 1;
    wswap_(&i__1, &a[j + k * a_dim1], lda, &a[m + k * a_dim1], lda);
...
L140:
	...
	i__2 = l - k + 1;
	c__ = qwnrm2_(&i__2, &a[k + i__ * a_dim1], &c__1);
	i__2 = l - k + 1;
	r__ = qwnrm2_(&i__2, &a[i__ + k * a_dim1], lda);
	ica = iwamax_(&l, &a[i__ * a_dim1 + 1], &c__1);
	ca = z_abs(&a[ica + i__ * a_dim1]);
	i__2 = *n - k + 1;
	ira = iwamax_(&i__2, &a[i__ + k * a_dim1], lda);
...
L190:
	...
	i__2 = *n - k + 1;
	wqscal_(&i__2, &g, &a[i__ + k * a_dim1], lda);
	wqscal_(&l, &f, &a[i__ * a_dim1 + 1], &c__1);
