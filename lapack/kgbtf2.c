...
/* > */
/*  ===================================================================== */
void  kgbtf2_(integer *m, integer *n, integer *kl, integer *ku,
	 halfcomplex *ab, integer *ldab, integer *ipiv, integer *info)
{
    ...
    extern void  kscal_(integer *, halfcomplex *, 
	    halfcomplex *, integer *), kgeru_(integer *, integer *, 
...
/* Computing MIN */
	...
	km = f2cmin(i__2,i__3);
	i__2 = km + 1;
	jp = ikamax_(&i__2, &ab[kv + 1 + j * ab_dim1], &c__1);
	ipiv[j] = jp + j - 1;
...
/*           Apply interchange to columns J to JU. */
		...
		i__3 = *ldab - 1;
		i__4 = *ldab - 1;
		kswap_(&i__2, &ab[kv + jp + j * ab_dim1], &i__3, &ab[kv + 1 + 
			j * ab_dim1], &i__4);
	    }
	    if (km > 0) {
...
/*              Compute multipliers. */
		...
		kscal_(&km, &z__1, &ab[kv + 2 + j * ab_dim1], &c__1);
...
/*              Update trailing submatrix within the band. */
		...
		if (ju > j) {
		    ...
		    i__3 = *ldab - 1;
		    i__4 = *ldab - 1;
		    kgeru_(&km, &i__2, &z__1, &ab[kv + 2 + j * ab_dim1], &
