...
/* > */
/*  ===================================================================== */
void  whetrd_(char *uplo, integer *n, quadcomplex *a, 
	...
	quadcomplex *work, integer *lwork, integer *info)
{
    ...
    integer nbmin, iinfo;
    logical upper;
    extern void  whetd2_(char *, integer *, quadcomplex *, 
	    integer *, quadreal *, quadreal *, quadcomplex *, integer *), wher2k_(char *, char *, integer *, integer *, 
	    quadcomplex *, quadcomplex *, integer *, quadcomplex *, 
	    integer *, quadreal *, quadcomplex *, integer *), xerbla_(char *, integer *);
    extern integer ilaenv_(integer *, char *, char *, integer *, integer *, 
	    integer *, integer *, ftnlen, ftnlen);
    extern void  wlatrd_(char *, integer *, integer *, 
...
/*           the matrix */
	    ...
	    i__3 = i__ + nb - 1;
	    wlatrd_(uplo, &i__3, &nb, &a[a_offset], lda, &e[1], &tau[1], &
		    work[1], &ldwork);
...
/*           update of the form:  A := A - V*W**H - W*V**H */
	    ...
	    i__3 = i__ - 1;
	    z__1.r = -1., z__1.i = -0.;
	    wher2k_(uplo, "No transpose", &i__3, &nb, &z__1, &a[i__ * a_dim1 
...
/*        Use unblocked code to reduce the last or only block */
	...
	whetd2_(uplo, &kk, &a[a_offset], lda, &d__[1], &e[1], &tau[1], &iinfo);
    } else {
...
/*           the matrix */
	    ...
	    i__3 = *n - i__ + 1;
	    wlatrd_(uplo, &i__3, &nb, &a[i__ + i__ * a_dim1], lda, &e[i__], &
...
/*           an update of the form:  A := A - V*W**H - W*V**H */
	    ...
	    i__3 = *n - i__ - nb + 1;
	    z__1.r = -1., z__1.i = -0.;
	    wher2k_(uplo, "No transpose", &i__3, &nb, &z__1, &a[i__ + nb + 
...
/*        Use unblocked code to reduce the last or only block */
	...
	i__1 = *n - i__ + 1;
	whetd2_(uplo, &i__1, &a[i__ + i__ * a_dim1], lda, &d__[i__], &e[i__], 
		&tau[i__], &iinfo);
    }
