...
/*  ===================================================================== */
void  khbgvd_(char *jobz, char *uplo, integer *n, integer *ka, 
	integer *kb, halfcomplex *ab, integer *ldab, halfcomplex *bb, 
	integer *ldbb, halfreal *w, halfcomplex *z__, integer *ldz, 
	...
	lrwork, integer *iwork, integer *liwork, integer *info)
{
    ...
    logical wantz;
    integer indwk2;
    extern void  xerbla_(char *, integer *), hsterf_(
	    integer *, halfreal *, halfreal *, integer *), kstedc_(char *,
	     integer *, halfreal *, halfreal *, halfcomplex *, integer *
	    , halfcomplex *, integer *, halfreal *, integer *, integer *, 
	    integer *, integer *), khbtrd_(char *, char *, integer *, 
...
/*     Reduce Hermitian band matrix to tridiagonal form. */
	...
	*(unsigned char *)vect = 'N';
    ...
    khbtrd_(vect, uplo, n, ka, &ab[ab_offset], ldab, &w[1], &rwork[inde], &
...
/*     For eigenvalues only, call DSTERF.  For eigenvectors, call ZSTEDC. */
	...
	kstedc_("I", n, &w[1], &rwork[inde], &work[1], n, &work[indwk2], &
		llwk2, &rwork[indwrk], &llrwk, &iwork[1], liwork, info);
	kgemm_("N", "N", n, n, n, &c_b1, &z__[z_offset], ldz, &work[1], n, &
		c_b2, &work[indwk2], n);
	klacpy_("A", n, n, &work[indwk2], n, &z__[z_offset], ldz);
    }
