...
/* > */
/*  ===================================================================== */
void  hsytrf_(char *uplo, integer *n, halfreal *a, integer *
	lda, integer *ipiv, halfreal *work, integer *lwork, integer *info)
{
    ...
    integer nbmin, iinfo;
    logical upper;
    extern void  hsytf2_(char *, integer *, halfreal *, 
	    integer *, integer *, integer *), xerbla_(char *, integer 
	    *);
    extern integer ilaenv_(integer *, char *, char *, integer *, integer *, 
	    integer *, integer *, ftnlen, ftnlen);
    extern void  hlasyf_(char *, integer *, integer *, integer 
...
/*           update columns 1:k-kb */
	    ...
	    hlasyf_(uplo, &k, &nb, &kb, &a[a_offset], lda, &ipiv[1], &work[1],
		     &ldwork, &iinfo);
	} else {

/*           Use unblocked code to factorize columns 1:k of A */

	    hsytf2_(uplo, &k, &a[a_offset], lda, &ipiv[1], &iinfo);
	    kb = k;
	}
...
/*           update columns k+kb:n */
	    ...
	    i__1 = *n - k + 1;
	    hlasyf_(uplo, &i__1, &nb, &kb, &a[k + k * a_dim1], lda, &ipiv[k], 
		    &work[1], &ldwork, &iinfo);
	} else {
...
/*           Use unblocked code to factorize columns k:n of A */
	    ...
	    i__1 = *n - k + 1;
	    hsytf2_(uplo, &i__1, &a[k + k * a_dim1], lda, &ipiv[k], &iinfo);
	    kb = *n - k + 1;
	}
