...
/*  ===================================================================== */
void  qtprfs_(char *uplo, char *trans, char *diag, integer *n, 
	integer *nrhs, quadreal *ap, quadreal *b, integer *ldb, 
	...
	quadreal *work, integer *iwork, integer *info)
{
    ...
    extern void  qcopy_(integer *, quadreal *, integer *, 
	    ...
	    quadreal *, integer *, quadreal *, integer *), qtpmv_(char *, 
	    char *, char *, integer *, quadreal *, quadreal *, integer *);
    logical upper;
    extern void  qtpsv_(char *, char *, char *, integer *, 
