...
/* > */
/*  ===================================================================== */
void  kspsv_(char *uplo, integer *n, integer *nrhs, 
	...
	integer *info)
{
    ...
    extern void  xerbla_(char *, integer *), ksptrf_(
...
/*     Compute the factorization A = U*D*U**T or A = L*D*L**T. */
    ...
    ksptrf_(uplo, n, &ap[1], &ipiv[1], info);
    if (*info == 0) {

/*        Solve the system A*X = B, overwriting B with X. */

	ksptrs_(uplo, n, nrhs, &ap[1], &ipiv[1], &b[b_offset], ldb, info);
