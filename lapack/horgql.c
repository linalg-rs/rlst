...
/* > \verbatim */
/* > */
/* > DORGQL generates an M-by-N doublereal matrix Q with orthonormal columns, */
...
/*  ===================================================================== */
void  horgql_(integer *m, integer *n, integer *k, halfreal *
...
/*     Use unblocked code for the first or only block. */
    ...
    i__2 = *n - kk;
    i__3 = *k - kk;
    horg2l_(&i__1, &i__2, &i__3, &a[a_offset], lda, &tau[1], &work[1], &iinfo)
	    ;
...
/*              Apply H to A(1:m-k+i+ib-1,1:n-k+i-1) from the left */
		...
		i__3 = *m - *k + i__ + ib - 1;
		i__4 = *n - *k + i__ - 1;
		hlarfb_("Left", "No transpose", "Backward", "Columnwise", &
...
/*           Apply H to rows 1:m-k+i+ib-1 of current block */
	    ...
	    i__3 = *m - *k + i__ + ib - 1;
	    horg2l_(&i__3, &ib, &ib, &a[(*n - *k + i__) * a_dim1 + 1], lda, &
