...
/*  ===================================================================== */
void  hlarrv_(integer *n, halfreal *vl, halfreal *vu, 
	halfreal *d__, halfreal *l, halfreal *pivmin, integer *isplit, 
	integer *m, integer *dol, integer *dou, halfreal *minrgp, 
	halfreal *rtol1, halfreal *rtol2, halfreal *w, halfreal *werr,
	 halfreal *wgap, integer *iblock, integer *indexw, halfreal *gers,
	 halfreal *z__, integer *ldz, integer *isuppz, halfreal *work, 
	integer *iwork, integer *info)
{
    ...
    halfreal gl;
    integer im, in;
    halfreal gu, gap, eps, tau, tol, tmp;
    integer zto;
    halfreal ztz;
    integer iend, jblk;
    halfreal lgap;
    ...
    extern void  hlar1v_(integer *, integer *, integer *, 
	    halfreal *, halfreal *, halfreal *, halfreal *, 
	    halfreal *, halfreal *, halfreal *, halfreal *, logical *,
    ...
    logical needbs;
    integer indlld;
    halfreal sgndef, mingma;
    extern void  hlarrb_(integer *, halfreal *, halfreal *,
    ...
    halfreal spdiam;
    integer negcnt;
    extern void  hlarrf_(integer *, halfreal *, halfreal *,
...
/*     The width of the part of Z that is used */
    ...
    hlaset_("Full", n, &zusedw, &c_b5, &c_b5, &z__[zusedl * z_dim1 + 1], ldz);
...
/*        corresponding eigenvectors. */
	hcopy_(&im, &w[wbegin], &c__1, &work[wbegin], &c__1);
...
/*                       Get representation from the right end of Z array */
		    ...
		    hcopy_(&in, &z__[ibegin + j * z_dim1], &c__1, &d__[ibegin]
			    , &c__1);
		    i__3 = in - 1;
		    hcopy_(&i__3, &z__[ibegin + (j + 1) * z_dim1], &c__1, &l[
			    ibegin], &c__1);
		    sigma = z__[iend + (j + 1) * z_dim1];
/*                 Set the corresponding entries in Z to zero */
		    hlaset_("Full", &in, &c__2, &c_b5, &c_b5, &z__[ibegin + j 
			    * z_dim1], ldz);
		}
...
/*                 eigenvalues to the precision needed. */
		    hlarrb_(&in, &d__[ibegin], &work[indlld + ibegin - 1], &p,
...
/*                    as possible */
			...
			for (k = 1; k <= 2; ++k) {
			    ...
			    offset = indexw[wbegin] - 1;
			    hlarrb_(&in, &d__[ibegin], &work[indlld + ibegin 
...
/*                    DLARRF needs LWORK = 2*N */
			hlarrf_(&in, &d__[ibegin], &l[ibegin], &work[indld + 
...
/*                    Given LAMBDA, compute the eigenvector. */
			L__1 = ! usedbs;
			hlar1v_(&in, &c__1, &in, &lambda, &d__[ibegin], &l[
...
/*                          improve error angle by second step */
				L__1 = ! usedbs;
				hlar1v_(&in, &c__1, &in, &lambda, &d__[ibegin]
...
/* L123: */
			...
			i__4 = zto - zfrom + 1;
			hscal_(&i__4, &nrminv, &z__[zfrom + windex * z_dim1], 
				&c__1);
L125:
/*                    Update W */
