	...
	integer *ldz, quadcomplex *work, integer *lwork, integer *info)
{
    ...
    extern void  wlaqr3_(logical *, logical *, integer *, 
	    ...
	    , quadcomplex *, integer *), wlaqr4_(logical *, logical *, 
	    integer *, integer *, integer *, quadcomplex *, integer *, 
	    quadcomplex *, integer *, integer *, quadcomplex *, integer *,
	     quadcomplex *, integer *, integer *), wlaqr5_(logical *, 
	    logical *, integer *, integer *, integer *, integer *, integer *, 
	    quadcomplex *, quadcomplex *, integer *, integer *, integer *,
...
/*        ==== Workspace query call to ZLAQR3 ==== */
	...
	i__1 = nwr + 1;
	wlaqr3_(wantt, wantz, n, ilo, ihi, &i__1, &h__[h_offset], ldh, iloz, 
...
/*           ==== Aggressive early deflation ==== */
	    ...
	    wlaqr3_(wantt, wantz, n, &ktop, &kbot, &nw, &h__[h_offset], ldh, 
...
/*                 .    to fit an NS-by-NS scratch array.) ==== */
			...
			ks = kbot - ns + 1;
			kt = *n - ns + 1;
			wlacpy_("A", &ns, &ns, &h__[ks + ks * h_dim1], ldh, &
				h__[kt + h_dim1], ldh);
			if (ns > nmin) {
			    wlaqr4_(&c_false, &c_false, &ns, &c__1, &ns, &h__[
				    kt + h_dim1], ldh, &w[ks], &c__1, &c__1, 
				    zdum, &c__1, &work[1], lwork, &inf);
			} else {
			    wlahqr_(&c_false, &c_false, &ns, &c__1, &ns, &h__[
				    kt + h_dim1], ldh, &w[ks], &c__1, &c__1, 
				    zdum, &c__1, &inf);
			}
			ks += inf;
...
/*              ==== Small-bulge multi-shift QR sweep ==== */
		...
		wlaqr5_(wantt, wantz, &kacc22, n, &ktop, &kbot, &ns, &w[ks], &
