...
ment of largest absolute value of a doublereal symmetric tridiagonal matrix. */
...
/*  ===================================================================== */
halfreal hlanst_(char *norm, integer *n, halfreal *d__, halfreal *e)
{
    /* System generated locals */
    integer i__1;
    halfreal ret_val, d__1, d__2, d__3;
...
/*        Find normF(A). */
	...
	if (*n > 1) {
	    i__1 = *n - 1;
	    hlassq_(&i__1, &e[1], &c__1, &scale, &sum);
	    sum *= 2;
	}
