...
/*  ===================================================================== */
void  zhetri2x_(char *uplo, integer *n, doublecomplex *a, 
	...
	integer *info)
{
    ...
    /* Local variables */
    extern void  zheswapr_(char *, integer *, doublecomplex *, 
