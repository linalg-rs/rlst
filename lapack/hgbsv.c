...
/* > \verbatim */
/* > */
/* > DGBSV computes the solution to a doublereal system of linear equations */
...
/* > */
/*  ===================================================================== */
void  hgbsv_(integer *n, integer *kl, integer *ku, integer *
	nrhs, halfreal *ab, integer *ldab, integer *ipiv, halfreal *b, 
	integer *ldb, integer *info)
{
    ...
    /* Local variables */
    extern void  hgbtrf_(integer *, integer *, integer *, 
	    integer *, halfreal *, integer *, integer *, integer *), 
	    xerbla_(char *, integer *), hgbtrs_(char *, integer *, 
...
/*     Compute the LU factorization of the band matrix A. */
    ...
    hgbtrf_(n, n, kl, ku, &ab[ab_offset], ldab, &ipiv[1], info);
    if (*info == 0) {

/*        Solve the system A*X = B, overwriting B with X. */

	hgbtrs_("No transpose", n, kl, ku, nrhs, &ab[ab_offset], ldab, &ipiv[
