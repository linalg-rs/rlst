...
/* > \verbatim */
/* > */
/* > DORMRQ overwrites the general doublereal M-by-N matrix C with */
/* > */
/* >                 SIDE = 'L'     SIDE = 'R' */
/* > TRANS = 'N':      Q * C          C * Q */
/* > TRANS = 'T':      Q**T * C       C * Q**T */
...
/*  ===================================================================== */
void  qormrq_(char *side, char *trans, integer *m, integer *n, 
	...
	c__, integer *ldc, quadreal *work, integer *lwork, integer *info)
{
    ...
    integer nbmin, iinfo;
    extern void  qormr2_(char *, char *, integer *, integer *, 
...
/*        Use unblocked code */
	...
	qormr2_(side, trans, m, n, k, &a[a_offset], lda, &tau[1], &c__[
...
/*           H = H(i+ib-1) . . . H(i+1) H(i) */
	    ...
	    i__4 = nq - *k + i__ + ib - 1;
	    qlarft_("Backward", "Rowwise", &i__4, &ib, &a[i__ + a_dim1], lda, 
...
/*           Apply H or H**T */
	    ...
	    qlarfb_(side, transt, "Backward", "Rowwise", &mi, &ni, &ib, &a[
