...
/* > \verbatim */
/* > */
/* > DLARFX applies a doublereal elementary reflector H to a doublereal m by n */
...
/*  ===================================================================== */
void  qlarfx_(char *side, integer *m, integer *n, quadreal *
	v, quadreal *tau, quadreal *c__, integer *ldc, quadreal *work)
{
    ...
    /* Local variables */
    integer j;
    quadreal t1, t2, t3, t4, t5, t6, t7, t8, t9, v1, v2, v3, v4, v5, v6, v7,
	     v8, v9, t10, v10, sum;
...
/*        Code for general M */
	...
	qlarf_(side, m, n, &v[1], &c__1, tau, &c__[c_offset], ldc, &work[1]);
	goto L410;
L10:
