...
/*  ===================================================================== */
void  ktbtrs_(char *uplo, char *trans, char *diag, integer *n, 
	...
	halfcomplex *b, integer *ldb, integer *info)
{
    ...
    extern void  ktbsv_(char *, char *, char *, integer *, 
	    integer *, halfcomplex *, integer *, halfcomplex *, integer *), xerbla_(char *, integer *);
    logical nounit;
...
/*     Solve A * X = B,  A**T * X = B,  or  A**H * X = B. */
    ...
    i__1 = *nrhs;
    for (j = 1; j <= i__1; ++j) {
	ktbsv_(uplo, trans, diag, n, kd, &ab[ab_offset], ldab, &b[j * b_dim1 
		+ 1], &c__1);
/* L30: */
    }
