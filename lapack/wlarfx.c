...
/*  ===================================================================== */
void  wlarfx_(char *side, integer *m, integer *n, 
	quadcomplex *v, quadcomplex *tau, quadcomplex *c__, integer *
	ldc, quadcomplex *work)
{
    ...
    /* Local variables */
    integer j;
    quadcomplex t1, t2, t3, t4, t5, t6, t7, t8, t9, v1, v2, v3, v4, v5, v6, 
...
/*        Code for general M */
	...
	wlarf_(side, m, n, &v[1], &c__1, tau, &c__[c_offset], ldc, &work[1]);
	goto L410;
L10:
