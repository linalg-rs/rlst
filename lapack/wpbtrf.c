...
/*  ===================================================================== */
void  wpbtrf_(char *uplo, integer *n, integer *kd, 
	quadcomplex *ab, integer *ldab, integer *info)
{
    ...
    quadcomplex work[1056]	/* was [33][32] */;
    ...
    extern void  wgemm_(char *, char *, integer *, integer *, 
	    ...
	    integer *, quadreal *, quadcomplex *, integer *, quadreal *,
	     quadcomplex *, integer *), wtrsm_(char *, char 
	    *, char *, char *, integer *, integer *, quadcomplex *, 
	    quadcomplex *, integer *, quadcomplex *, integer *), wpbtf2_(char *, integer *, integer *, 
	    quadcomplex *, integer *, integer *), wpotf2_(char *, 
...
/*        Use unblocked code */
	...
	wpbtf2_(uplo, n, kd, &ab[ab_offset], ldab, info);
    } else {
...
/*              Factorize the diagonal block */
		...
		i__3 = *ldab - 1;
		wpotf2_(uplo, &ib, &ab[*kd + 1 + i__ * ab_dim1], &i__3, &ii);
		if (ii != 0) {
		    *info = i__ + ii - 1;
		    goto L150;
		}
...
/*                    Update A12 */
			...
			i__3 = *ldab - 1;
			i__4 = *ldab - 1;
			wtrsm_("Left", "Upper", "Conjugate transpose", "Non-"
...
/*                    Update A22 */
			...
			i__3 = *ldab - 1;
			i__4 = *ldab - 1;
			wherk_("Upper", "Conjugate transpose", &i2, &ib, &
...
/*                    Update A23 */
			...
			if (i2 > 0) {
			    ...
			    i__3 = *ldab - 1;
			    i__4 = *ldab - 1;
			    wgemm_("Conjugate transpose", "No transpose", &i2,
...
/*                    Update A33 */
			...
			i__3 = *ldab - 1;
			wherk_("Upper", "Conjugate transpose", &i3, &ib, &
...
/*              Factorize the diagonal block */
		...
		i__3 = *ldab - 1;
		wpotf2_(uplo, &ib, &ab[i__ * ab_dim1 + 1], &i__3, &ii);
		if (ii != 0) {
		    *info = i__ + ii - 1;
		    goto L150;
		}
...
/*                    Update A21 */
			...
			i__3 = *ldab - 1;
			i__4 = *ldab - 1;
			wtrsm_("Right", "Lower", "Conjugate transpose", "Non"
...
/*                    Update A22 */
			...
			i__3 = *ldab - 1;
			i__4 = *ldab - 1;
			wherk_("Lower", "No transpose", &i2, &ib, &c_b21, &ab[
...
/*                    Update A32 */
			...
			if (i2 > 0) {
			    ...
			    i__3 = *ldab - 1;
			    i__4 = *ldab - 1;
			    wgemm_("No transpose", "Conjugate transpose", &i3,
...
/*                    Update A33 */
			...
			i__3 = *ldab - 1;
			wherk_("Lower", "No transpose", &i3, &ib, &c_b21, 
