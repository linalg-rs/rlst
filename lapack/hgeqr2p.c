...
/* > */
/*  ===================================================================== */
void  hgeqr2p_(integer *m, integer *n, halfreal *a, integer *
	lda, halfreal *tau, halfreal *work, integer *info)
{
    ...
    extern void  hlarf_(char *, integer *, integer *, 
	    ...
	    hlarfgp_(integer *, halfreal *, halfreal *, integer *, 
	    halfreal *);
...
/* Computing MIN */
	i__3 = i__ + 1;
	hlarfgp_(&i__2, &a[i__ + i__ * a_dim1], &a[f2cmin(i__3,*m) + i__ * 
		a_dim1], &c__1, &tau[i__]);
	if (i__ < *n) {
...
/*           Apply H(i) to A(i:m,i+1:n) from the left */
	    ...
	    i__2 = *m - i__ + 1;
	    i__3 = *n - i__;
	    hlarf_("Left", &i__2, &i__3, &a[i__ + i__ * a_dim1], &c__1, &tau[
