...
/* > */
/*  ===================================================================== */
void  kggrqf_(integer *m, integer *p, integer *n, 
	halfcomplex *a, integer *lda, halfcomplex *taua, halfcomplex *b,
	 integer *ldb, halfcomplex *taub, halfcomplex *work, integer *
	lwork, integer *info)
{
    ...
    extern void  kgeqrf_(integer *, integer *, halfcomplex *,
	    ...
	    ), kgerqf_(integer *, integer *, halfcomplex *, integer *, 
	    halfcomplex *, halfcomplex *, integer *, integer *);
    integer lwkopt;
    logical lquery;
    extern void  kunmrq_(char *, char *, integer *, integer *, 
...
/*     RQ factorization of M-by-N matrix A: A = R*Q */
    ...
    kgerqf_(m, n, &a[a_offset], lda, &taua[1], &work[1], lwork, info);
...
/* Computing MAX */
    i__2 = 1, i__3 = *m - *n + 1;
    kunmrq_("Right", "Conjugate Transpose", p, n, &i__1, &a[f2cmax(i__2,i__3) + 
...
/*     QR factorization of P-by-N matrix B: B = Z*T */
    ...
    kgeqrf_(p, n, &b[b_offset], ldb, &taub[1], &work[1], lwork, info);
/* Computing MAX */
