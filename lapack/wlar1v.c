...
/*  ===================================================================== */
void  wlar1v_(integer *n, integer *b1, integer *bn, quadreal 
	*lambda, quadreal *d__, quadreal *l, quadreal *ld, quadreal *
	lld, quadreal *pivmin, quadreal *gaptol, quadcomplex *z__, 
	logical *wantnc, integer *negcnt, quadreal *ztz, quadreal *mingma,
	 integer *r__, integer *isuppz, quadreal *nrminv, quadreal *resid,
	 quadreal *rqcorr, quadreal *work)
{
