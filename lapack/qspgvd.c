...
/*  ===================================================================== */
void  qspgvd_(integer *itype, char *jobz, char *uplo, integer *
	n, quadreal *ap, quadreal *bp, quadreal *w, quadreal *z__, 
	...
	integer *liwork, integer *info)
{
    ...
    extern void  qtpmv_(char *, char *, char *, integer *, 
	    ...
	    qtpsv_(char *, char *, char *, integer *, quadreal *, 
	    quadreal *, integer *);
    logical wantz;
    extern void  xerbla_(char *, integer *), qspevd_(
	    char *, char *, integer *, quadreal *, quadreal *, quadreal 
	    *, integer *, quadreal *, integer *, integer *, integer *, 
	    integer *);
    integer liwmin;
    extern void  qpptrf_(char *, integer *, quadreal *, 
	    integer *), qspgst_(integer *, char *, integer *, 
	    quadreal *, quadreal *, integer *);
    logical lquery;
...
/*     Transform problem to standard eigenvalue problem and solve. */
    ...
    qspevd_(jobz, uplo, n, &ap[1], &w[1], &z__[z_offset], ldz, &work[1], 
...
/*           backtransform eigenvectors: x = inv(L)**T *y or inv(U)*y */
		...
		*(unsigned char *)trans = 'T';
	    ...
	    i__1 = neig;
	    for (j = 1; j <= i__1; ++j) {
		qtpsv_(uplo, trans, "Non-unit", n, &bp[1], &z__[j * z_dim1 + 
			1], &c__1);
/* L10: */
	    }
...
/*           backtransform eigenvectors: x = L*y or U**T *y */
		...
		*(unsigned char *)trans = 'N';
	    ...
	    i__1 = neig;
	    for (j = 1; j <= i__1; ++j) {
		qtpmv_(uplo, trans, "Non-unit", n, &bp[1], &z__[j * z_dim1 + 
			1], &c__1);
/* L20: */
	    }
	}
