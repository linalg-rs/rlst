...
/*  ===================================================================== */
void  wtrcon_(char *norm, char *uplo, char *diag, integer *n, 
	quadcomplex *a, integer *lda, quadreal *rcond, quadcomplex *
...
/*     Compute the norm of the triangular matrix A. */
    ...
    anorm = wlantr_(norm, uplo, diag, n, n, &a[a_offset], lda, &rwork[1]);
...
/*              Multiply by inv(A). */
		...
		wlatrs_(uplo, "No transpose", diag, normin, n, &a[a_offset], 
			lda, &work[1], &scale, &rwork[1], info);
	    } else {

/*              Multiply by inv(A**H). */

		wlatrs_(uplo, "Conjugate transpose", diag, normin, n, &a[
