...
/* > */
/*  ===================================================================== */
void  wggbak_(char *job, char *side, integer *n, integer *ilo, 
	integer *ihi, quadreal *lscale, quadreal *rscale, integer *m, 
	quadcomplex *v, integer *ldv, integer *info)
{
...
/*        Backward transformation on right eigenvectors */
	...
	if (rightv) {
		...
		wqscal_(m, &rscale[i__], &v[i__ + v_dim1], ldv);
/* L10: */
	    }
	}
...
/*        Backward transformation on left eigenvectors */
	...
	if (leftv) {
	    i__1 = *ihi;
	    for (i__ = *ilo; i__ <= i__1; ++i__) {
		wqscal_(m, &lscale[i__], &v[i__ + v_dim1], ldv);
/* L20: */
	    }
	}
    }
...
/*        Backward permutation on right eigenvectors */
	...
	if (rightv) {
		...
		wswap_(m, &v[i__ + v_dim1], ldv, &v[k + v_dim1], ldv);
L40:
		;
	    }
