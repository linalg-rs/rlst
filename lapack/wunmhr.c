...
/*  ===================================================================== */
void  wunmhr_(char *side, char *trans, integer *m, integer *n, 
	integer *ilo, integer *ihi, quadcomplex *a, integer *lda, 
	quadcomplex *tau, quadcomplex *c__, integer *ldc, quadcomplex *
...
/*     Quick return if possible */
    ...
    wunmqr_(side, trans, &mi, &ni, &nh, &a[*ilo + 1 + *ilo * a_dim1], lda, &
