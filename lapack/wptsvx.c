...
/*  ===================================================================== */
void  wptsvx_(char *fact, integer *n, integer *nrhs, 
	quadreal *d__, quadcomplex *e, quadreal *df, quadcomplex *ef, 
	...
	work, quadreal *rwork, integer *info)
{
    ...
    extern void  qcopy_(integer *, quadreal *, integer *, 
	    quadreal *, integer *), wcopy_(integer *, quadcomplex *, 
	    integer *, quadcomplex *, integer *);
    extern quadreal qlamch_(char *);
    logical nofact;
    extern void  xerbla_(char *, integer *);
    extern quadreal wlanht_(char *, integer *, quadreal *, quadcomplex *
	    );
    extern void  wlacpy_(char *, integer *, integer *, 
	    quadcomplex *, integer *, quadcomplex *, integer *), 
	    wptcon_(integer *, quadreal *, quadcomplex *, quadreal *, 
	    quadreal *, quadreal *, integer *), wptrfs_(char *, integer *,
	     integer *, quadreal *, quadcomplex *, quadreal *, 
	    quadcomplex *, quadcomplex *, integer *, quadcomplex *, 
	    integer *, quadreal *, quadreal *, quadcomplex *, 
	    quadreal *, integer *), wpttrf_(integer *, quadreal *,
	     quadcomplex *, integer *), wpttrs_(char *, integer *, integer *
	    , quadreal *, quadcomplex *, quadcomplex *, integer *, 
	    integer *);
...
/*        Compute the L*D*L**H (or U**H*D*U) factorization of A. */
	...
	qcopy_(n, &d__[1], &c__1, &df[1], &c__1);
	if (*n > 1) {
	    i__1 = *n - 1;
	    wcopy_(&i__1, &e[1], &c__1, &ef[1], &c__1);
	}
	wpttrf_(n, &df[1], &ef[1], info);
...
/*     Compute the norm of the matrix A. */
    ...
    anorm = wlanht_("1", n, &d__[1], &e[1]);

/*     Compute the reciprocal of the condition number of A. */

    wptcon_(n, &df[1], &ef[1], &anorm, rcond, &rwork[1], info);

/*     Compute the solution vectors X. */

    wlacpy_("Full", n, nrhs, &b[b_offset], ldb, &x[x_offset], ldx);
    wpttrs_("Lower", n, nrhs, &df[1], &ef[1], &x[x_offset], ldx, info);

/*     Use iterative refinement to improve the computed solutions and */
/*     compute error bounds and backward error estimates for them. */

    wptrfs_("Lower", n, nrhs, &d__[1], &e[1], &df[1], &ef[1], &b[b_offset], 
