...
/*  ===================================================================== */
void  hgbtrs_(char *trans, integer *n, integer *kl, integer *
	ku, integer *nrhs, halfreal *ab, integer *ldab, integer *ipiv, 
	halfreal *b, integer *ldb, integer *info)
{
    ...
    extern void  hgemv_(char *, integer *, integer *, 
	    ...
	    halfreal *, integer *, halfreal *, integer *), htbsv_(char *, 
...
/* Computing MIN */
		...
		l = ipiv[j];
		if (l != j) {
		    hswap_(nrhs, &b[l + b_dim1], ldb, &b[j + b_dim1], ldb);
		}
		hger_(&lm, nrhs, &c_b7, &ab[kd + 1 + j * ab_dim1], &c__1, &b[
...
/*           Solve U*X = B, overwriting B with X. */
	    ...
	    i__2 = *kl + *ku;
	    htbsv_("Upper", "No transpose", "Non-unit", n, &i__2, &ab[
...
/*           Solve U**T*X = B, overwriting B with X. */
	    ...
	    i__2 = *kl + *ku;
	    htbsv_("Upper", "Transpose", "Non-unit", n, &i__2, &ab[ab_offset],
...
/* Computing MIN */
		i__1 = *kl, i__2 = *n - j;
		lm = f2cmin(i__1,i__2);
		hgemv_("Transpose", &lm, nrhs, &c_b7, &b[j + 1 + b_dim1], ldb,
