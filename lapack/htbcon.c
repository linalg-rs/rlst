...
/*  ===================================================================== */
void  htbcon_(char *norm, char *uplo, char *diag, integer *n, 
	integer *kd, halfreal *ab, integer *ldab, halfreal *rcond, 
...
/*     Quick return if possible */
    ...
    *rcond = 0.;
    smlnum = hlamch_("Safe minimum") * (halfreal) f2cmax(1,*n);

/*     Compute the norm of the triangular matrix A. */

    anorm = hlantb_(norm, uplo, diag, n, kd, &ab[ab_offset], ldab, &work[1]);
...
/*              Multiply by inv(A). */
		...
		hlatbs_(uplo, "No transpose", diag, normin, n, kd, &ab[
...
/*              Multiply by inv(A**T). */
		...
		hlatbs_(uplo, "Transpose", diag, normin, n, kd, &ab[ab_offset]
