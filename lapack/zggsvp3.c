...
/* > */
/* ===================================================================== */
void  zggsvp3_(char *jobu, char *jobv, char *jobq, integer *m, 
	...
	integer *info)
{
    ...
    extern void  zgeqp3_(integer *, integer *, doublecomplex *,
	    ...
	    *, doublecomplex *, doublecomplex *, integer *, doublecomplex *, 
	    ...
	    integer *, integer *, doublecomplex *, integer *, doublecomplex *,
	     doublecomplex *, integer *, doublecomplex *, integer *), xerbla_(char *, integer *), zlacpy_(char *, 
	    integer *, integer *, doublecomplex *, integer *, doublecomplex *,
	     integer *);
    logical forwrd;
