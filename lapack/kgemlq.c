...
/* > \verbatim */
/* > */
/* >     ZGEMLQ overwrites the general doublereal M-by-N matrix C with */
/* > */
/* >                      SIDE = 'L'     SIDE = 'R' */
/* >      TRANS = 'N':      Q * C          C * Q */
/* >      TRANS = 'C':      Q**H * C       C * Q**H */
...
/* > */
/*  ===================================================================== */
void  kgemlq_(char *side, char *trans, integer *m, integer *n, 
	integer *k, halfcomplex *a, integer *lda, halfcomplex *t, integer 
	*tsize, halfcomplex *c__, integer *ldc, halfcomplex *work, 
	integer *lwork, integer *info)
{
    ...
    /* Local variables */
    extern void  klamswlq_(char *, char *, integer *, integer *
...
/* Computing MAX */
    ...
    if (left && *m <= *k || right && *n <= *k || nb <= *k || nb >= f2cmax(i__1,*
	    k)) {
	kgemlqt_(side, trans, m, n, k, &mb, &a[a_offset], lda, &t[6], &mb, &
		c__[c_offset], ldc, &work[1], info);
    } else {
	klamswlq_(side, trans, m, n, k, &mb, &nb, &a[a_offset], lda, &t[6], &
