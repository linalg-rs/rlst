...
/*  ===================================================================== */
void  qstegr_(char *jobz, char *range, integer *n, quadreal *
	...
	integer *lwork, integer *iwork, integer *liwork, integer *info)
{
    ...
    /* Local variables */
    extern void  qstemr_(char *, char *, integer *, quadreal 
...
/*  ===================================================================== */
    ...
    *info = 0;
    tryrac = FALSE_;
    qstemr_(jobz, range, n, &d__[1], &e[1], vl, vu, il, iu, m, &w[1], &z__[
