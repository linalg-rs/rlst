...
/* > */
/*  ===================================================================== */
void  klamtsqr_(char *side, char *trans, integer *m, integer *
	 ...
	 halfcomplex *work, integer *lwork, integer *info)
{
    ...
    /* Local variables */
    extern void  ktpmqrt_(char *, char *, integer *, integer *,
    ...
    extern void  kgemqrt_(char *, char *, integer *, integer *,
...
/* Computing MAX */
	...
	kgemqrt_(side, trans, m, n, k, nb, &a[a_offset], lda, &t[t_offset], 
...
/*         Multiply Q to the last block of C */
	...
	if (kk > 0) {
	    ii = *m - kk + 1;
	    ktpmqrt_("L", "N", &kk, n, k, &c__0, nb, &a[ii + a_dim1], lda, &t[
...
/*         Multiply Q to the current block of C (I:I+MB,1:N) */
	    ...
	    --ctr;
	    i__3 = *mb - *k;
	    ktpmqrt_("L", "N", &i__3, n, k, &c__0, nb, &a[i__ + a_dim1], lda, 
...
/*         Multiply Q to the first block of C (1:MB,1:N) */
	...
	kgemqrt_("L", "N", mb, n, k, nb, &a[a_dim1 + 1], lda, &t[t_offset], 
...
/*         Multiply Q to the first block of C */
	...
	ii = *m - kk + 1;
	ctr = 1;
	kgemqrt_("L", "C", mb, n, k, nb, &a[a_dim1 + 1], lda, &t[t_offset], 
		ldt, &c__[c_dim1 + 1], ldc, &work[1], info);
...
/*         Multiply Q to the current block of C (I:I+MB,1:N) */
	    ...
	    i__3 = *mb - *k;
	    ktpmqrt_("L", "C", &i__3, n, k, &c__0, nb, &a[i__ + a_dim1], lda, 
		    &t[(ctr * *k + 1) * t_dim1 + 1], ldt, &c__[c_dim1 + 1], 
		    ldc, &c__[i__ + c_dim1], ldc, &work[1], info);
	    ++ctr;
...
/*         Multiply Q to the last block of C */
	    ...
	    ktpmqrt_("L", "C", &kk, n, k, &c__0, nb, &a[ii + a_dim1], lda, &t[
		    (ctr * *k + 1) * t_dim1 + 1], ldt, &c__[c_dim1 + 1], ldc, 
		    &c__[ii + c_dim1], ldc, &work[1], info);
...
/*         Multiply Q to the last block of C */
	...
	if (kk > 0) {
	    ii = *n - kk + 1;
	    ktpmqrt_("R", "C", m, &kk, k, &c__0, nb, &a[ii + a_dim1], lda, &t[
		    (ctr * *k + 1) * t_dim1 + 1], ldt, &c__[c_dim1 + 1], ldc, 
...
/*         Multiply Q to the current block of C (1:M,I:I+MB) */
	    ...
	    --ctr;
	    i__3 = *mb - *k;
	    ktpmqrt_("R", "C", m, &i__3, k, &c__0, nb, &a[i__ + a_dim1], lda, 
		    &t[(ctr * *k + 1) * t_dim1 + 1], ldt, &c__[c_dim1 + 1], 
...
/*         Multiply Q to the first block of C (1:M,1:MB) */
	...
	kgemqrt_("R", "C", m, mb, k, nb, &a[a_dim1 + 1], lda, &t[t_offset], 
		ldt, &c__[c_dim1 + 1], ldc, &work[1], info);
...
/*         Multiply Q to the first block of C */
	...
	ii = *n - kk + 1;
	ctr = 1;
	kgemqrt_("R", "N", m, mb, k, nb, &a[a_dim1 + 1], lda, &t[t_offset], 
		ldt, &c__[c_dim1 + 1], ldc, &work[1], info);
...
/*         Multiply Q to the current block of C (1:M,I:I+MB) */
	    ...
	    i__3 = *mb - *k;
	    ktpmqrt_("R", "N", m, &i__3, k, &c__0, nb, &a[i__ + a_dim1], lda, 
		    &t[(ctr * *k + 1) * t_dim1 + 1], ldt, &c__[c_dim1 + 1], 
		    ldc, &c__[i__ * c_dim1 + 1], ldc, &work[1], info);
	    ++ctr;
...
/*         Multiply Q to the last block of C */
	    ...
	    ktpmqrt_("R", "N", m, &kk, k, &c__0, nb, &a[ii + a_dim1], lda, &t[
		    (ctr * *k + 1) * t_dim1 + 1], ldt, &c__[c_dim1 + 1], ldc, 
		    &c__[ii * c_dim1 + 1], ldc, &work[1], info);
