...
/*  ===================================================================== */
void  klarrv_(integer *n, halfreal *vl, halfreal *vu, 
	...
	halfreal *rtol1, halfreal *rtol2, halfreal *w, halfreal *werr,
	 ...
	 halfcomplex *z__, integer *ldz, integer *isuppz, halfreal *work, 
	integer *iwork, integer *info)
{
    ...
    logical stp2ii;
    extern void  klar1v_(integer *, integer *, integer *, 
	    halfreal *, halfreal *, halfreal *, halfreal *, 
	    halfreal *, halfreal *, halfreal *, halfcomplex *, 
	    logical *, integer *, halfreal *, halfreal *, integer *, 
...
/*     The width of the part of Z that is used */
    ...
    klaset_("Full", n, &zusedw, &c_b1, &c_b1, &z__[zusedl * z_dim1 + 1], ldz);
...
/*                 Set the corresponding entries in Z to zero */
		    klaset_("Full", &in, &c__2, &c_b1, &c_b1, &z__[ibegin + j 
			    * z_dim1], ldz);
		}
...
/*                    Given LAMBDA, compute the eigenvector. */
			L__1 = ! usedbs;
			klar1v_(&in, &c__1, &in, &lambda, &d__[ibegin], &l[
...
/*                          improve error angle by second step */
				L__1 = ! usedbs;
				klar1v_(&in, &c__1, &in, &lambda, &d__[ibegin]
...
/* L123: */
			...
			i__4 = zto - zfrom + 1;
			whscal_(&i__4, &nrminv, &z__[zfrom + windex * z_dim1],
				 &c__1);
L125:
/*                    Update W */
