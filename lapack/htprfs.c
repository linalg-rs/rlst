...
/*  ===================================================================== */
void  htprfs_(char *uplo, char *trans, char *diag, integer *n, 
	integer *nrhs, halfreal *ap, halfreal *b, integer *ldb, 
	...
	halfreal *work, integer *iwork, integer *info)
{
    ...
    extern void  hcopy_(integer *, halfreal *, integer *, 
	    ...
	    halfreal *, integer *, halfreal *, integer *), htpmv_(char *, 
	    char *, char *, integer *, halfreal *, halfreal *, integer *);
    logical upper;
...
/*        where op(A) = A or A**T, depending on TRANS. */
	...
	htpmv_(uplo, trans, diag, n, &ap[1], &work[*n + 1], &c__1);
...
/*              Multiply by diag(W)*inv(op(A)**T). */
		...
		htpsv_(uplo, transt, diag, n, &ap[1], &work[*n + 1], &c__1);
		i__2 = *n;
		for (i__ = 1; i__ <= i__2; ++i__) {
...
/* L230: */
		...
		htpsv_(uplo, trans, diag, n, &ap[1], &work[*n + 1], &c__1);
	    }
	    goto L210;
	}
