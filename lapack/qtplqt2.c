...
/* > \brief \b DTPLQT2 computes a LQ factorization of a doublereal or complex "triangular-pentagonal" matrix, which 
...
/* > \verbatim */
/* > */
/* > DTPLQT2 computes a LQ a factorization of a doublereal "triangular-pentagonal" */
...
/* > */
/*  ===================================================================== */
void  qtplqt2_(integer *m, integer *n, integer *l, quadreal *
	a, integer *lda, quadreal *b, integer *ldb, quadreal *t, integer *
	ldt, integer *info)
{
    ...
    extern void  qgemv_(char *, integer *, integer *, 
	    ...
	    quadreal *, quadreal *, integer *), qtrmv_(char *, 
	    char *, char *, integer *, quadreal *, integer *, quadreal *, 
	    integer *), qlarfg_(integer *, quadreal 
	    *, quadreal *, integer *, quadreal *), xerbla_(char *, 
	    integer *);
...
/*        Generate elementary reflector H(I) to annihilate B(I,:) */
	...
	p = *n - *l + f2cmin(*l,i__);
	i__2 = p + 1;
	qlarfg_(&i__2, &a[i__ + i__ * a_dim1], &b[i__ + b_dim1], ldb, &t[i__ *
		 t_dim1 + 1]);
	if (i__ < *m) {
...
/*           W(M-I:1) := C(I+1:M,I:N) * C(I,I:N) [use W = T(M,:)] */
	    ...
	    i__2 = *m - i__;
	    qgemv_("N", &i__2, &p, &c_b4, &b[i__ + 1 + b_dim1], ldb, &b[i__ + 
...
/*           C(I+1:M,I:N) = C(I+1:M,I:N) + alpha * C(I,I:N)*W(M-1:1)^H */
	    ...
	    i__2 = *m - i__;
	    qger_(&i__2, &p, &alpha, &t[*m + t_dim1], ldt, &b[i__ + b_dim1], 
...
/*        Triangular part of B2 */
	...
	qtrmv_("L", "N", "N", &p, &b[np * b_dim1 + 1], ldb, &t[i__ + t_dim1], 
		ldt);

/*        Rectangular part of B2 */

	i__2 = i__ - 1 - p;
	qgemv_("N", &i__2, l, &alpha, &b[mp + np * b_dim1], ldb, &b[i__ + np *
...
/*        B1 */
	...
	i__2 = i__ - 1;
	i__3 = *n - *l;
	qgemv_("N", &i__2, &i__3, &alpha, &b[b_offset], ldb, &b[i__ + b_dim1],
		 ldb, &c_b4, &t[i__ + t_dim1], ldt);

/*        T(1:I-1,I) := T(1:I-1,1:I-1) * T(I,1:I-1) */

	i__2 = i__ - 1;
	qtrmv_("L", "T", "N", &i__2, &t[t_offset], ldt, &t[i__ + t_dim1], ldt);
