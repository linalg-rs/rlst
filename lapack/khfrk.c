...
/* > */
/* > where alpha and beta are doublereal scalars, C is an n--by--n Hermitian */
...
/*  ===================================================================== */
void  khfrk_(char *transr, char *uplo, char *trans, integer *n,
	 integer *k, halfreal *alpha, halfcomplex *a, integer *lda, 
	halfreal *beta, halfcomplex *c__)
{
    ...
    extern void  kgemm_(char *, char *, integer *, integer *, 
	    ...
	    integer *), kherk_(char *, char *, integer *, 
	    integer *, halfreal *, halfcomplex *, integer *, halfreal *,
	     halfcomplex *, integer *);
    integer nrowa;
    logical lower;
    halfcomplex calpha;
...
/*                 N is odd, TRANSR = 'N', UPLO = 'L', and TRANS = 'N' */
		    ...
		    kherk_("L", "N", &n1, k, alpha, &a[a_dim1 + 1], lda, beta,
			     &c__[1], n);
		    kherk_("U", "N", &n2, k, alpha, &a[n1 + 1 + a_dim1], lda, 
			    beta, &c__[*n + 1], n);
		    kgemm_("N", "C", &n2, &n1, k, &calpha, &a[n1 + 1 + a_dim1]
...
/*                 N is odd, TRANSR = 'N', UPLO = 'L', and TRANS = 'C' */
		    ...
		    kherk_("L", "C", &n1, k, alpha, &a[a_dim1 + 1], lda, beta,
			     &c__[1], n);
		    kherk_("U", "C", &n2, k, alpha, &a[(n1 + 1) * a_dim1 + 1],
			     lda, beta, &c__[*n + 1], n)
			    ;
		    kgemm_("C", "N", &n2, &n1, k, &calpha, &a[(n1 + 1) * 
...
/*                 N is odd, TRANSR = 'N', UPLO = 'U', and TRANS = 'N' */
		    ...
		    kherk_("L", "N", &n1, k, alpha, &a[a_dim1 + 1], lda, beta,
			     &c__[n2 + 1], n);
		    kherk_("U", "N", &n2, k, alpha, &a[n2 + a_dim1], lda, 
			    beta, &c__[n1 + 1], n);
		    kgemm_("N", "C", &n1, &n2, k, &calpha, &a[a_dim1 + 1], 
...
/*                 N is odd, TRANSR = 'N', UPLO = 'U', and TRANS = 'C' */
		    ...
		    kherk_("L", "C", &n1, k, alpha, &a[a_dim1 + 1], lda, beta,
			     &c__[n2 + 1], n);
		    kherk_("U", "C", &n2, k, alpha, &a[n2 * a_dim1 + 1], lda, 
			    beta, &c__[n1 + 1], n);
		    kgemm_("C", "N", &n1, &n2, k, &calpha, &a[a_dim1 + 1], 
...
/*                 N is odd, TRANSR = 'C', UPLO = 'L', and TRANS = 'N' */
		    ...
		    kherk_("U", "N", &n1, k, alpha, &a[a_dim1 + 1], lda, beta,
			     &c__[1], &n1);
		    kherk_("L", "N", &n2, k, alpha, &a[n1 + 1 + a_dim1], lda, 
			    beta, &c__[2], &n1);
		    kgemm_("N", "C", &n1, &n2, k, &calpha, &a[a_dim1 + 1], 
...
/*                 N is odd, TRANSR = 'C', UPLO = 'L', and TRANS = 'C' */
		    ...
		    kherk_("U", "C", &n1, k, alpha, &a[a_dim1 + 1], lda, beta,
			     &c__[1], &n1);
		    kherk_("L", "C", &n2, k, alpha, &a[(n1 + 1) * a_dim1 + 1],
			     lda, beta, &c__[2], &n1);
		    kgemm_("C", "N", &n1, &n2, k, &calpha, &a[a_dim1 + 1], 
...
/*                 N is even, TRANSR = 'N', UPLO = 'L', and TRANS = 'N' */
		    ...
		    i__1 = *n + 1;
		    kherk_("L", "N", &nk, k, alpha, &a[a_dim1 + 1], lda, beta,
			     &c__[2], &i__1);
		    i__1 = *n + 1;
		    kherk_("U", "N", &nk, k, alpha, &a[nk + 1 + a_dim1], lda, 
			    beta, &c__[1], &i__1);
		    i__1 = *n + 1;
		    kgemm_("N", "C", &nk, &nk, k, &calpha, &a[nk + 1 + a_dim1]
...
/*                 N is even, TRANSR = 'N', UPLO = 'L', and TRANS = 'C' */
		    ...
		    i__1 = *n + 1;
		    kherk_("L", "C", &nk, k, alpha, &a[a_dim1 + 1], lda, beta,
			     &c__[2], &i__1);
		    i__1 = *n + 1;
		    kherk_("U", "C", &nk, k, alpha, &a[(nk + 1) * a_dim1 + 1],
			     lda, beta, &c__[1], &i__1);
		    i__1 = *n + 1;
		    kgemm_("C", "N", &nk, &nk, k, &calpha, &a[(nk + 1) * 
			    a_dim1 + 1], lda, &a[a_dim1 + 1], lda, &cbeta, &
			    c__[nk + 2], &i__1);
...
/*                 N is even, TRANSR = 'N', UPLO = 'U', and TRANS = 'N' */
		    ...
		    kherk_("U", "N", &nk, k, alpha, &a[nk + 1 + a_dim1], lda, 
			    beta, &c__[nk + 1], &i__1);
		    i__1 = *n + 1;
		    kgemm_("N", "C", &nk, &nk, k, &calpha, &a[a_dim1 + 1], 
...
/*                 N is even, TRANSR = 'N', UPLO = 'U', and TRANS = 'C' */
		    ...
		    i__1 = *n + 1;
		    kgemm_("C", "N", &nk, &nk, k, &calpha, &a[a_dim1 + 1], 
...
/*                 N is even, TRANSR = 'C', UPLO = 'L', and TRANS = 'N' */
		    ...
		    kherk_("U", "N", &nk, k, alpha, &a[a_dim1 + 1], lda, beta,
			     &c__[nk + 1], &nk);
		    kherk_("L", "N", &nk, k, alpha, &a[nk + 1 + a_dim1], lda, 
			    beta, &c__[1], &nk);
		    kgemm_("N", "C", &nk, &nk, k, &calpha, &a[a_dim1 + 1], 
...
/*                 N is even, TRANSR = 'C', UPLO = 'L', and TRANS = 'C' */
		    ...
		    kherk_("U", "C", &nk, k, alpha, &a[a_dim1 + 1], lda, beta,
			     &c__[nk + 1], &nk);
		    kherk_("L", "C", &nk, k, alpha, &a[(nk + 1) * a_dim1 + 1],
			     lda, beta, &c__[1], &nk);
		    kgemm_("C", "N", &nk, &nk, k, &calpha, &a[a_dim1 + 1], 
			    lda, &a[(nk + 1) * a_dim1 + 1], lda, &cbeta, &c__[
			    (nk + 1) * nk + 1], &nk);
