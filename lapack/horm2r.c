...
/* > \verbatim */
/* > */
/* > DORM2R overwrites the general doublereal m by n matrix C with */
/* > */
...
/*  ===================================================================== */
void  horm2r_(char *side, char *trans, integer *m, integer *n, 
	integer *k, halfreal *a, integer *lda, halfreal *tau, halfreal *
	c__, integer *ldc, halfreal *work, integer *info)
{
...
/*        Apply H(i) */
	...
	a[i__ + i__ * a_dim1] = 1.;
	hlarf_(side, &mi, &ni, &a[i__ + i__ * a_dim1], &c__1, &tau[i__], &c__[
