...
/*  ===================================================================== */
void  qporfs_(char *uplo, integer *n, integer *nrhs, 
	quadreal *a, integer *lda, quadreal *af, integer *ldaf, 
	...
	info)
{
    ...
    quadreal safmin;
    extern void  xerbla_(char *, integer *), qpotrs_(
...
/*           Update solution and try again. */
	    ...
	    qpotrs_(uplo, n, &c__1, &af[af_offset], ldaf, &work[*n + 1], n, 
		    info);
...
/*              Multiply by diag(W)*inv(A**T). */
		...
		qpotrs_(uplo, n, &c__1, &af[af_offset], ldaf, &work[*n + 1], 
			n, info);
		i__2 = *n;
		for (i__ = 1; i__ <= i__2; ++i__) {
