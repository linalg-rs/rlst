...
/* > */
/*  ===================================================================== */
void  qlasq4_(integer *i0, integer *n0, quadreal *z__, 
	integer *pp, integer *n0in, quadreal *dmin__, quadreal *dmin1, 
	quadreal *dmin2, quadreal *dn, quadreal *dn1, quadreal *dn2, 
	quadreal *tau, integer *ttype, quadreal *g)
{
...
/*        No eigenvalues deflated. */
	...
	if (*dmin__ == *dn || *dmin__ == *dn1) {
	    ...
	    b1 = M(sqrt)(z__[nn - 3]) * M(sqrt)(z__[nn - 5]);
	    b2 = M(sqrt)(z__[nn - 7]) * M(sqrt)(z__[nn - 9]);
...
/* Computing 2nd power */
	    ...
	    gap2 = z__[nn - 7] + z__[nn - 9] - M(sqrt)(z__[nn - 11]) * M(sqrt)(z__[
		    nn - 9]) - a2;
	    if (gap2 > 0. && gap2 > b2 * a2) {
/* Computing MAX */
		d__1 = s, d__2 = a2 * (1. - a2 * 1.01 * (b2 / gap2) * b2);
