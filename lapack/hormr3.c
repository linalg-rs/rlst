...
/* > \verbatim */
/* > */
/* > DORMR3 overwrites the general doublereal m by n matrix C with */
/* > */
...
/* > */
/*  ===================================================================== */
void  hormr3_(char *side, char *trans, integer *m, integer *n, 
	...
	halfreal *c__, integer *ldc, halfreal *work, integer *info)
{
    ...
    extern void  hlarz_(char *, integer *, integer *, integer *
...
/*        Apply H(i) or H(i)**T */
	...
	hlarz_(side, &mi, &ni, l, &a[i__ + ja * a_dim1], lda, &tau[i__], &c__[
