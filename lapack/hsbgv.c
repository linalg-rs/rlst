...
/*  ===================================================================== */
void  hsbgv_(char *jobz, char *uplo, integer *n, integer *ka, 
	...
	integer *info)
{
    ...
    integer iinfo;
    logical upper, wantz;
    extern void  xerbla_(char *, integer *), hpbstf_(
	    char *, integer *, integer *, halfreal *, integer *, integer *), hsbtrd_(char *, char *, integer *, integer *, halfreal 
...
/*     For eigenvalues only, call DSTERF.  For eigenvectors, call SSTEQR. */
	...
	hsteqr_(jobz, n, &w[1], &work[inde], &z__[z_offset], ldz, &work[
		indwrk], info);
    }
    return;
