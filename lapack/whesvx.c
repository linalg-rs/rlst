...
/*  ===================================================================== */
void  whesvx_(char *fact, char *uplo, integer *n, integer *
	...
	quadcomplex *work, integer *lwork, quadreal *rwork, integer *info)
{
    ...
    extern quadreal wlanhe_(char *, char *, integer *, quadcomplex *, 
	    integer *, quadreal *);
    extern void  whecon_(char *, integer *, quadcomplex *, 
	    integer *, integer *, quadreal *, quadreal *, quadcomplex *,
	     integer *), wherfs_(char *, integer *, integer *, 
	    ...
	    integer *), whetrf_(char *, integer *, quadcomplex *, 
	    integer *, integer *, quadcomplex *, integer *, integer *), wlacpy_(char *, integer *, integer *, quadcomplex *, 
	    integer *, quadcomplex *, integer *), whetrs_(char *, 
...
/*        Compute the factorization A = U*D*U**H or A = L*D*L**H. */
	...
	whetrf_(uplo, n, &af[af_offset], ldaf, &ipiv[1], &work[1], lwork, 
		info);
...
/*     Compute the norm of the matrix A. */
    ...
    anorm = wlanhe_("I", uplo, n, &a[a_offset], lda, &rwork[1]);

/*     Compute the reciprocal of the condition number of A. */

    whecon_(uplo, n, &af[af_offset], ldaf, &ipiv[1], &anorm, rcond, &work[1], 
	    info);

/*     Compute the solution vectors X. */

    wlacpy_("Full", n, nrhs, &b[b_offset], ldb, &x[x_offset], ldx);
    whetrs_(uplo, n, nrhs, &af[af_offset], ldaf, &ipiv[1], &x[x_offset], ldx, 
	    info);

/*     Use iterative refinement to improve the computed solutions and */
/*     compute error bounds and backward error estimates for them. */

    wherfs_(uplo, n, nrhs, &a[a_offset], lda, &af[af_offset], ldaf, &ipiv[1], 
