...
/*  ===================================================================== */
void  klapll_(integer *n, halfcomplex *x, integer *incx, 
	halfcomplex *y, integer *incy, halfreal *ssmin)
{
    ...
    /* Local variables */
    halfcomplex c__, a11, a12, a22, tau;
    ...
    extern void  kaxpy_(integer *, halfcomplex *, 
	    halfcomplex *, integer *, halfcomplex *, integer *), klarfg_(
...
/*     Compute the QR factorization of the N-by-2 matrix ( X Y ) */
    ...
    klarfg_(n, &x[1], &x[*incx + 1], incx, &tau);
    a11.r = x[1].r, a11.i = x[1].i;
    x[1].r = 1., x[1].i = 0.;

    d_cnjg(&z__3, &tau);
    z__2.r = -z__3.r, z__2.i = -z__3.i;
    whotc_(&z__4, n, &x[1], incx, &y[1], incy);
    z__1.r = z__2.r * z__4.r - z__2.i * z__4.i, z__1.i = z__2.r * z__4.i + 
	    z__2.i * z__4.r;
    c__.r = z__1.r, c__.i = z__1.i;
    kaxpy_(n, &c__, &x[1], incx, &y[1], incy);

    i__1 = *n - 1;
    klarfg_(&i__1, &y[*incy + 1], &y[(*incy << 1) + 1], incy, &tau);
...
/*     Compute the SVD of 2-by-2 Upper triangular matrix. */
    ...
    d__2 = z_abs(&a12);
    d__3 = z_abs(&a22);
    hlas2_(&d__1, &d__2, &d__3, ssmin, &ssmax);
