...
/*  ===================================================================== */
void  kggglm_(integer *n, integer *m, integer *p, 
	halfcomplex *a, integer *lda, halfcomplex *b, integer *ldb, 
	halfcomplex *d__, halfcomplex *x, halfcomplex *y, halfcomplex 
	*work, integer *lwork, integer *info)
{
    ...
    extern void  kggqrf_(integer *, integer *, integer *, 
...
/*     unitary. */
    ...
    i__1 = *lwork - *m - np;
    kggqrf_(n, m, p, &a[a_offset], lda, &work[1], &b[b_offset], ldb, &work[*m 
...
/*                                               ( d2 ) N-M */
    ...
    i__1 = f2cmax(1,*n);
    i__2 = *lwork - *m - np;
    kunmqr_("Left", "Conjugate transpose", n, &c__1, m, &a[a_offset], lda, &
...
/*     Solve T22*y2 = d2 for y2 */
	...
	i__1 = *n - *m;
	i__2 = *n - *m;
	ktrtrs_("Upper", "No transpose", "Non unit", &i__1, &c__1, &b[*m + 1 
	...
	i__1 = *n - *m;
	kcopy_(&i__1, &d__[*m + 1], &c__1, &y[*m + *p - *n + 1], &c__1);
    }
...
/*     Update d1 = d1 - T12*y2 */
    ...
    i__1 = *n - *m;
    z__1.r = -1., z__1.i = -0.;
    kgemv_("No transpose", m, &i__1, &z__1, &b[(*m + *p - *n + 1) * b_dim1 + 
	    1], ldb, &y[*m + *p - *n + 1], &c__1, &c_b2, &d__[1], &c__1);

/*     Solve triangular system: R11*x = d1 */

    if (*m > 0) {
	ktrtrs_("Upper", "No Transpose", "Non unit", m, &c__1, &a[a_offset], 
		lda, &d__[1], m, info);
...
/* Computing MAX */
    ...
    i__3 = f2cmax(1,*p);
    i__4 = *lwork - *m - np;
    kunmrq_("Left", "Conjugate transpose", p, &c__1, &np, &b[f2cmax(i__1,i__2) + 
