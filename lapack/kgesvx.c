...
/*  ===================================================================== */
void  kgesvx_(char *fact, char *trans, integer *n, integer *
	nrhs, halfcomplex *a, integer *lda, halfcomplex *af, integer *
	ldaf, integer *ipiv, char *equed, halfreal *r__, halfreal *c__, 
	halfcomplex *b, integer *ldb, halfcomplex *x, integer *ldx, 
	halfreal *rcond, halfreal *ferr, halfreal *berr, halfcomplex *
	work, halfreal *rwork, integer *info)
{
    ...
    extern halfreal klange_(char *, integer *, integer *, halfcomplex *, 
	    integer *, halfreal *);
    halfreal bignum;
    extern void  klaqge_(integer *, integer *, halfcomplex *,
	     integer *, halfreal *, halfreal *, halfreal *, halfreal *
	    , halfreal *, char *), kgecon_(char *, integer *, 
	    halfcomplex *, integer *, halfreal *, halfreal *, 
	    halfcomplex *, halfreal *, integer *);
    integer infequ;
    logical colequ;
    halfreal rowcnd;
    extern void  kgeequ_(integer *, integer *, halfcomplex *,
	     integer *, halfreal *, halfreal *, halfreal *, halfreal *
	    , halfreal *, integer *);
    logical notran;
    extern void  kgerfs_(char *, integer *, integer *, 
	    ...
	    integer *), kgetrf_(integer *, integer *, halfcomplex *,
	     integer *, integer *, integer *), klacpy_(char *, integer *, 
	    integer *, halfcomplex *, integer *, halfcomplex *, integer *);
    extern halfreal klantr_(char *, char *, char *, integer *, integer *, 
	    halfcomplex *, integer *, halfreal *);
    halfreal smlnum;
    extern void  kgetrs_(char *, integer *, integer *, 
...
/*        Compute row and column scalings to equilibrate the matrix A. */
	...
	kgeequ_(n, n, &a[a_offset], lda, &r__[1], &c__[1], &rowcnd, &colcnd, &
		amax, &infequ);
	if (infequ == 0) {

/*           Equilibrate the matrix. */

	    klaqge_(n, n, &a[a_offset], lda, &r__[1], &c__[1], &rowcnd, &
		    colcnd, &amax, equed);
	    rowequ = lsame_(equed, "R") || lsame_(equed,
		     "B");
	    colequ = lsame_(equed, "C") || lsame_(equed,
...
/*        Compute the LU factorization of A. */
	...
	klacpy_("Full", n, n, &a[a_offset], lda, &af[af_offset], ldaf);
	kgetrf_(n, n, &af[af_offset], ldaf, &ipiv[1], info);
...
/*           leading rank-deficient INFO columns of A. */
	    ...
	    rpvgrw = klantr_("M", "U", "N", info, info, &af[af_offset], ldaf, 
		    &rwork[1]);
	    if (rpvgrw == 0.) {
		rpvgrw = 1.;
	    } else {
		rpvgrw = klange_("M", n, info, &a[a_offset], lda, &rwork[1]) / rpvgrw;
	    }
	    rwork[1] = rpvgrw;
	    *rcond = 0.;
	    return;
...
/*     reciprocal pivot growth factor RPVGRW. */
	...
	*(unsigned char *)norm = 'I';
    ...
    anorm = klange_(norm, n, n, &a[a_offset], lda, &rwork[1]);
    rpvgrw = klantr_("M", "U", "N", n, n, &af[af_offset], ldaf, &rwork[1]);
    if (rpvgrw == 0.) {
	rpvgrw = 1.;
    } else {
	rpvgrw = klange_("M", n, n, &a[a_offset], lda, &rwork[1]) /
		 rpvgrw;
    }

/*     Compute the reciprocal of the condition number of A. */

    kgecon_(norm, n, &af[af_offset], ldaf, &anorm, rcond, &work[1], &rwork[1],
	     info);

/*     Compute the solution matrix X. */

    klacpy_("Full", n, nrhs, &b[b_offset], ldb, &x[x_offset], ldx);
    kgetrs_(trans, n, nrhs, &af[af_offset], ldaf, &ipiv[1], &x[x_offset], ldx,
	     info);

/*     Use iterative refinement to improve the computed solution and */
/*     compute error bounds and backward error estimates for it. */

    kgerfs_(trans, n, nrhs, &a[a_offset], lda, &af[af_offset], ldaf, &ipiv[1],
