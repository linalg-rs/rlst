...
/*  ===================================================================== */
void  wgesv_(integer *n, integer *nrhs, quadcomplex *a, 
	integer *lda, integer *ipiv, quadcomplex *b, integer *ldb, integer *
	info)
{
    ...
    /* Local variables */
    extern void  xerbla_(char *, integer *), wgetrf_(
	    integer *, integer *, quadcomplex *, integer *, integer *, 
	    integer *), wgetrs_(char *, integer *, integer *, quadcomplex *,
	     integer *, integer *, quadcomplex *, integer *, integer *);
...
/*        Solve the system A*X = B, overwriting B with X. */
	...
	wgetrs_("No transpose", n, nrhs, &a[a_offset], lda, &ipiv[1], &b[
		b_offset], ldb, info);
    }
    return;
