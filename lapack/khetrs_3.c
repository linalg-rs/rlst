...
/*  ===================================================================== */
void  zhetrs_3__(char *uplo, integer *n, integer *nrhs, 
	...
	halfcomplex *b, integer *ldb, integer *info)
{
    ...
    extern void  kswap_(integer *, halfcomplex *, integer *, 
	    ...
	    *, halfcomplex *, integer *), 
	    xerbla_(char *, integer *), whscal_(integer *, halfreal 
	    *, halfcomplex *, integer *);
...
/*        Compute D \ B -> B   [ D \ (U \P**T * B) ] */
	...
	while(i__ >= 1) {
		...
		i__1 = i__ + i__ * a_dim1;
		s = 1. / a[i__1].r;
		whscal_(nrhs, &s, &b[i__ + b_dim1], ldb);
	    } else if (i__ > 1) {
		i__1 = i__;
...
/*        Compute (U**H \ B) -> B   [ U**H \ (D \ (U \P**T * B) ) ] */
	...
	ktrsm_("L", "U", "C", "U", n, nrhs, &c_b1, &a[a_offset], lda, &b[
		b_offset], ldb);
...
/*        Compute (L**H \ B) -> B   [ L**H \ (D \ (L \P**T * B) ) ] */
	...
	ktrsm_("L", "L", "C", "U", n, nrhs, &c_b1, &a[a_offset], lda, &b[
		b_offset], ldb);
