...
/* > \verbatim */
/* > */
/* > DLATRZ factors the M-by-(M+L) doublereal upper trapezoidal matrix */
...
/* > */
/*  ===================================================================== */
void  qlatrz_(integer *m, integer *n, integer *l, quadreal *
	a, integer *lda, quadreal *tau, quadreal *work)
{
...
/*        [ A(i,i) A(i,n-l+1:n) ] */
	...
	i__1 = *l + 1;
	qlarfg_(&i__1, &a[i__ + i__ * a_dim1], &a[i__ + (*n - *l + 1) * 
		a_dim1], lda, &tau[i__]);
...
/*        Apply H(i) to A(1:i-1,i:n) from the right */
	...
	i__1 = i__ - 1;
	i__2 = *n - i__ + 1;
	qlarz_("Right", &i__1, &i__2, l, &a[i__ + (*n - *l + 1) * a_dim1], 
