...
/*  ===================================================================== */
void  kungrq_(integer *m, integer *n, integer *k, 
	...
	work, integer *lwork, integer *info)
{
    ...
    extern void  kungr2_(integer *, integer *, integer *, 
...
/*     Use unblocked code for the first or only block. */
    ...
    i__2 = *n - kk;
    i__3 = *k - kk;
    kungr2_(&i__1, &i__2, &i__3, &a[a_offset], lda, &tau[1], &work[1], &iinfo)
	    ;
...
/*              H = H(i+ib-1) . . . H(i+1) H(i) */
		...
		i__3 = *n - *k + i__ + ib - 1;
		klarft_("Backward", "Rowwise", &i__3, &ib, &a[ii + a_dim1], 
...
/*              Apply H**H to A(1:m-k+i-1,1:n-k+i+ib-1) from the right */
		...
		i__3 = ii - 1;
		i__4 = *n - *k + i__ + ib - 1;
		klarfb_("Right", "Conjugate transpose", "Backward", "Rowwise",
...
/*           Apply H**H to columns 1:n-k+i+ib-1 of current block */
	    ...
	    i__3 = *n - *k + i__ + ib - 1;
	    kungr2_(&ib, &i__3, &ib, &a[ii + a_dim1], lda, &tau[i__], &work[1]
		    , &iinfo);
