...
/*  ===================================================================== */
void  wlaed0_(integer *qsiz, integer *n, quadreal *d__, 
	quadreal *e, quadcomplex *q, integer *ldq, quadcomplex *qstore, 
	integer *ldqs, quadreal *rwork, integer *iwork, integer *info)
{
    ...
    extern void  wcopy_(integer *, quadcomplex *, integer *, 
	    quadcomplex *, integer *), wlaed7_(integer *, integer *, 
	    integer *, integer *, integer *, integer *, quadreal *, 
	    quadcomplex *, integer *, quadreal *, integer *, quadreal *,
	     integer *, integer *, integer *, integer *, integer *, 
	    quadreal *, quadcomplex *, quadreal *, integer *, integer *)
	    ;
    integer igivcl;
    extern void  xerbla_(char *, integer *);
    extern integer ilaenv_(integer *, char *, char *, integer *, integer *, 
	    integer *, integer *, ftnlen, ftnlen);
    extern void  wlacrm_(integer *, integer *, quadcomplex *,
...
/*     conquer tree. */
	...
	qsteqr_("I", &matsiz, &d__[submat], &e[submat], &rwork[ll], &matsiz, &
		rwork[1], info);
	wlacrm_(qsiz, &matsiz, &q[submat * q_dim1 + 1], ldq, &rwork[ll], &
...
/*     I am free to use Q as a valuable working space until Loop 150. */
	    ...
	    wlaed7_(&matsiz, &msd2, qsiz, &tlvls, &curlvl, &curprb, &d__[
...
/*     merge step. */
	...
	j = iwork[indxq + i__];
	rwork[i__] = d__[j];
	wcopy_(qsiz, &qstore[j * qstore_dim1 + 1], &c__1, &q[i__ * q_dim1 + 1]
		, &c__1);
/* L100: */
    }
    qcopy_(n, &rwork[1], &c__1, &d__[1], &c__1);
