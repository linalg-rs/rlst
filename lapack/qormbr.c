...
/* > \verbatim */
/* > */
/* > If VECT = 'Q', DORMBR overwrites the general doublereal M-by-N matrix C */
/* > with */
/* >                 SIDE = 'L'     SIDE = 'R' */
/* > TRANS = 'N':      Q * C          C * Q */
/* > TRANS = 'T':      Q**T * C       C * Q**T */
/* > */
/* > If VECT = 'P', DORMBR overwrites the general doublereal M-by-N matrix C */
/* > with */
/* >                 SIDE = 'L'     SIDE = 'R' */
/* > TRANS = 'N':      P * C          C * P */
/* > TRANS = 'T':      P**T * C       C * P**T */
...
/* > reducing a doublereal matrix A to bidiagonal form: A = Q * B * P**T. Q and */
...
/*  ===================================================================== */
void  qormbr_(char *vect, char *side, char *trans, integer *m, 
	integer *n, integer *k, quadreal *a, integer *lda, quadreal *tau, 
...
/*           Q was determined by a call to DGEBRD with nq >= k */
	    ...
	    qormqr_(side, trans, m, n, k, &a[a_offset], lda, &tau[1], &c__[
...
/*           Q was determined by a call to DGEBRD with nq < k */
	    ...
	    i__1 = nq - 1;
	    qormqr_(side, trans, &mi, &ni, &i__1, &a[a_dim1 + 2], lda, &tau[1]
...
/*           P was determined by a call to DGEBRD with nq > k */
	    ...
	    qormlq_(side, transt, m, n, k, &a[a_offset], lda, &tau[1], &c__[
		    c_offset], ldc, &work[1], lwork, &iinfo);
	} else if (nq > 1) {
...
/*           P was determined by a call to DGEBRD with nq <= k */
	    ...
	    i__1 = nq - 1;
	    qormlq_(side, transt, &mi, &ni, &i__1, &a[(a_dim1 << 1) + 1], lda,
