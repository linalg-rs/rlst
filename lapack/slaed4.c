...
/* > */
/*  ===================================================================== */
void  slaed4_(integer *n, integer *i__, real *d__, real *z__, 
	real *delta, real *rho, real *dlam, integer *info)
{
    ...
    integer niter;
    logical swtch;
    extern void  slaed5_(integer *, real *, real *, real *, 
...
/* L20: */
	...
	if (w <= 0.f) {
		...
		b = z__[*n] * z__[*n] * del;
		if (a < 0.f) {
		    tau = b * 2.f / (M(sqrt)(a * a + b * 4.f * c__) - a);
		} else {
		    tau = (a + M(sqrt)(a * a + b * 4.f * c__)) / (c__ * 2.f);
		}
	    }
...
/*           We choose d(i) as origin. */
	    ...
	    if (a > 0.f) {
		tau = b * 2.f / (a + M(sqrt)((r__1 = a * a - b * 4.f * c__, abs(
			r__1))));
	    } else {
		tau = (a - M(sqrt)((r__1 = a * a - b * 4.f * c__, abs(r__1)))) / 
			(c__ * 2.f);
	    }
	    dltlb = 0.f;
	    dltub = midpt;
