...
/*  ===================================================================== */
void  qgees_(char *jobvs, char *sort, L_fp select, integer *n, 
	quadreal *a, integer *lda, integer *sdim, quadreal *wr, 
	quadreal *wi, quadreal *vs, integer *ldvs, quadreal *work, 
	integer *lwork, logical *bwork, integer *info)
{
    ...
    extern void  qorghr_(integer *, integer *, integer *, 
	    ...
	    *, quadreal *, integer *, quadreal *, quadreal *, 
	    quadreal *, integer *, quadreal *, integer *, integer *), qtrsen_(char *, char *, logical *, integer *, 
...
/*        (Workspace: none needed) */
	...
	i__1 = *lwork - iwrk + 1;
	qtrsen_("N", jobvs, &bwork[1], n, &a[a_offset], lda, &vs[vs_offset], 
...
/* Computing MAX */
		...
		if (wi[i__] == 0.) {
			...
			if (wantvs) {
			    qswap_(n, &vs[i__ * vs_dim1 + 1], &c__1, &vs[(i__ 
				    + 1) * vs_dim1 + 1], &c__1);
			}
