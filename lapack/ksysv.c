...
/*  ===================================================================== */
void  ksysv_(char *uplo, integer *n, integer *nrhs, 
	...
	integer *ldb, halfcomplex *work, integer *lwork, integer *info)
{
    ...
    integer lwkopt;
    logical lquery;
    extern void  ksytrf_(char *, integer *, halfcomplex *, 
	    integer *, integer *, halfcomplex *, integer *, integer *), ksytrs_(char *, integer *, integer *, halfcomplex *, 
	    integer *, integer *, halfcomplex *, integer *, integer *), ksytrs2_(char *, integer *, integer *, halfcomplex *, 
...
/*     Test the input parameters. */
	...
	*info = -10;
	...
	if (*n == 0) {
	    ...
	    ksytrf_(uplo, n, &a[a_offset], lda, &ipiv[1], &work[1], &c_n1, 
		    info);
...
/*     Compute the factorization A = U*D*U**T or A = L*D*L**T. */
    ...
    ksytrf_(uplo, n, &a[a_offset], lda, &ipiv[1], &work[1], lwork, info);
    if (*info == 0) {
...
/*        Solve with TRS ( Use Level BLAS 2) */
	    ...
	    ksytrs_(uplo, n, nrhs, &a[a_offset], lda, &ipiv[1], &b[b_offset], 
		    ldb, info);
...
/*        Solve with TRS2 ( Use Level BLAS 3) */
	    ...
	    ksytrs2_(uplo, n, nrhs, &a[a_offset], lda, &ipiv[1], &b[b_offset],
		     ldb, &work[1], info);
