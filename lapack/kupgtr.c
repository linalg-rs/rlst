...
/*  ===================================================================== */
void  kupgtr_(char *uplo, integer *n, halfcomplex *ap, 
	halfcomplex *tau, halfcomplex *q, integer *ldq, halfcomplex *
	work, integer *info)
{
    ...
    integer iinfo;
    logical upper;
    extern void  kung2l_(integer *, integer *, integer *, 
	    halfcomplex *, integer *, halfcomplex *, halfcomplex *, 
	    integer *), kung2r_(integer *, integer *, integer *, 
	    halfcomplex *, integer *, halfcomplex *, halfcomplex *, 
...
/*        Generate Q(1:n-1,1:n-1) */
	...
	i__2 = *n - 1;
	i__3 = *n - 1;
	kung2l_(&i__1, &i__2, &i__3, &q[q_offset], ldq, &tau[1], &work[1], &
		iinfo);
...
/*           Generate Q(2:n,2:n) */
	    ...
	    i__2 = *n - 1;
	    i__3 = *n - 1;
	    kung2r_(&i__1, &i__2, &i__3, &q[(q_dim1 << 1) + 2], ldq, &tau[1], 
		    &work[1], &iinfo);
	}
    }
    return;
