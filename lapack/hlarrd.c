...
/*  ===================================================================== */
void  hlarrd_(char *range, char *order, integer *n, halfreal 
	*vl, halfreal *vu, integer *il, integer *iu, halfreal *gers, 
	halfreal *reltol, halfreal *d__, halfreal *e, halfreal *e2, 
	halfreal *pivmin, integer *nsplit, integer *isplit, integer *m, 
	halfreal *w, halfreal *werr, halfreal *wl, halfreal *wu, 
	integer *iblock, integer *indexw, halfreal *work, integer *iwork, 
	integer *info)
{
    ...
    halfreal atoli;
    integer iwoff, itmax;
    halfreal wkill, rtoli, uflow, tnorm;
    extern halfreal hlamch_(char *);
    integer ibegin;
    extern void  hlaebz_(integer *, integer *, integer *, 
...
/*        Gerschgorin bounds GL and GU is refined by DLAEBZ. */
	itmax = (integer) ((M(log)(tnorm + *pivmin) - M(log)(*pivmin)) / M(log)(2.)) + 
		2;
	work[*n + 1] = gl;
	work[*n + 2] = gl;
	work[*n + 3] = gu;
	...
	hlaebz_(&c__3, &itmax, n, &c__2, &c__2, &nb, &atoli, &rtoli, pivmin, &
...
/*           Find negcount of initial interval boundaries GL and GU */
	    work[*n + 1] = gl;
	    work[*n + in + 1] = gu;
	    hlaebz_(&c__1, &c__0, &in, &in, &c__1, &nb, &atoli, &rtoli, 
		...
		*info = iinfo;
	    ...
	    iwoff = *m - iwork[1];
/*           Compute Eigenvalues */
	    itmax = (integer) ((M(log)(gu - gl + *pivmin) - M(log)(*pivmin)) / M(log)(
		    2.)) + 2;
	    hlaebz_(&c__2, &itmax, &in, &in, &c__1, &nb, &atoli, &rtoli, 
		    pivmin, &d__[ibegin], &e[ibegin], &e2[ibegin], idumma, &
