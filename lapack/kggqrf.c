...
/* > */
/*  ===================================================================== */
void  kggqrf_(integer *n, integer *m, integer *p, 
...
/*     QR factorization of N-by-M matrix A: A = Q*R */
    ...
    kgeqrf_(n, m, &a[a_offset], lda, &taua[1], &work[1], lwork, info);
    lopt = (integer) work[1].r;

/*     Update B := Q**H*B. */

    i__1 = f2cmin(*n,*m);
    kunmqr_("Left", "Conjugate Transpose", n, p, &i__1, &a[a_offset], lda, &
...
/*     RQ factorization of N-by-P matrix B: B = T*Z. */
    ...
    kgerqf_(n, p, &b[b_offset], ldb, &taub[1], &work[1], lwork, info);
/* Computing MAX */
