...
/* > */
/*  ===================================================================== */
void  qlasd5_(integer *i__, quadreal *d__, quadreal *z__, 
	quadreal *delta, quadreal *rho, quadreal *dsigma, quadreal *
	work)
{
    ...
    /* Local variables */
    quadreal b, c__, w, del, tau, delsq;
...
/*           The following TAU is DSIGMA - D( 2 ) */
	    ...
	    tau /= d__[2] + M(sqrt)((d__1 = d__[2] * d__[2] + tau, abs(d__1)));
	    *dsigma = d__[2] + tau;
	    delta[1] = -(del + tau);
	    delta[2] = -tau;
