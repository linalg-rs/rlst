...
/* > \verbatim */
/* > */
/* > DGEHRD reduces a doublereal general matrix A to upper Hessenberg form H by */
...
/* > */
/*  ===================================================================== */
void  hgehrd_(integer *n, integer *ilo, integer *ihi, 
	...
	integer *lwork, integer *info)
{
    ...
    extern void  htrmm_(char *, char *, char *, char *, 
	    ...
	    halfreal *, integer *), haxpy_(
	    integer *, halfreal *, halfreal *, integer *, halfreal *, 
	    integer *), hgehd2_(integer *, integer *, integer *, halfreal *,
	     integer *, halfreal *, halfreal *, integer *), hlahr2_(
	    integer *, integer *, integer *, halfreal *, integer *, 
	    halfreal *, halfreal *, integer *, halfreal *, integer *), 
	    hlarfb_(char *, char *, char *, char *, integer *, integer *, 
	    integer *, halfreal *, integer *, halfreal *, integer *, 
	    halfreal *, integer *, halfreal *, integer *), xerbla_(char *, integer *);
...
/*           which performs the reduction, and also the matrix Y = A*V*T */
	    ...
	    hlahr2_(ihi, &i__, &ib, &a[i__ * a_dim1 + 1], lda, &tau[i__], &
...
/*           to 1 */
	    ...
	    i__3 = *ihi - i__ - ib + 1;
	    hgemm_("No transpose", "Transpose", ihi, &i__3, &ib, &c_b25, &
...
/*           right */
	    ...
	    i__3 = ib - 1;
	    htrmm_("Right", "Lower", "Transpose", "Unit", &i__, &i__3, &c_b26,
		     &a[i__ + 1 + i__ * a_dim1], lda, &work[1], &ldwork);
	    i__3 = ib - 2;
	    for (j = 0; j <= i__3; ++j) {
		haxpy_(&i__, &c_b25, &work[ldwork * j + 1], &c__1, &a[(i__ + 
			j + 1) * a_dim1 + 1], &c__1);
/* L30: */
	    }
...
/*           left */
	    ...
	    i__3 = *ihi - i__;
	    i__4 = *n - i__ - ib + 1;
	    hlarfb_("Left", "Transpose", "Forward", "Columnwise", &i__3, &
...
/*     Use unblocked code to reduce the rest of the matrix */
    ...
    hgehd2_(n, &i__, ihi, &a[a_offset], lda, &tau[1], &work[1], &iinfo);
    work[1] = (halfreal) lwkopt;
