...
/* > */
/*  ===================================================================== */
void  hbdsdc_(char *uplo, char *compq, integer *n, halfreal *
	d__, halfreal *e, halfreal *u, integer *ldu, halfreal *vt, 
	integer *ldvt, halfreal *q, integer *iq, halfreal *work, integer *
	iwork, integer *info)
{
    ...
    extern void  hlasr_(char *, char *, char *, integer *, 
	    integer *, halfreal *, halfreal *, halfreal *, integer *), hcopy_(integer *, halfreal *, integer *
	    , halfreal *, integer *), hswap_(integer *, halfreal *, 
	    integer *, halfreal *, integer *);
    integer poles, iuplo, nsize, start;
    extern void  hlasd0_(integer *, integer *, halfreal *, 
    ...
    extern void  hlasda_(integer *, integer *, integer *, 
	    ...
	    *, integer *, integer *, halfreal *, halfreal *, halfreal *,
	    ...
	    integer *, halfreal *, halfreal *, halfreal *, integer *), hlartg_(halfreal *, halfreal *, halfreal *, 
	    halfreal *, halfreal *);
...
/*     by applying Givens rotations on the left */
    ...
    qstart = 3;
    if (icompq == 1) {
	hcopy_(n, &d__[1], &c__1, &q[1], &c__1);
	i__1 = *n - 1;
	hcopy_(&i__1, &e[1], &c__1, &q[*n + 1], &c__1);
    }
    if (iuplo == 2) {
	qstart = 5;
	if (icompq == 2) {
...
/*        and adding them exceeds documented WORK size of 4*n. */
	hlasdq_("U", &c__0, n, &c__0, &c__0, &c__0, &d__[1], &e[1], &vt[
...
/*     the problem with another solver. */
    ...
    if (*n <= smlsiz) {
	if (icompq == 2) {
	    hlaset_("A", n, n, &c_b29, &c_b15, &u[u_offset], ldu);
	    hlaset_("A", n, n, &c_b29, &c_b15, &vt[vt_offset], ldvt);
	    hlasdq_("U", &c__0, n, n, n, &c__0, &d__[1], &e[1], &vt[vt_offset]
		    , ldvt, &u[u_offset], ldu, &u[u_offset], ldu, &work[
		    wstart], info);
	} else if (icompq == 1) {
	    iu = 1;
	    ivt = iu + *n;
	    hlaset_("A", n, n, &c_b29, &c_b15, &q[iu + (qstart - 1) * *n], n);
	    hlaset_("A", n, n, &c_b29, &c_b15, &q[ivt + (qstart - 1) * *n], n);
	    hlasdq_("U", &c__0, n, n, n, &c__0, &d__[1], &e[1], &q[ivt + (
...
/*     Scale. */
    ...
    hlascl_("G", &c__0, &c__0, &orgnrm, &c_b15, n, &c__1, &d__[1], n, &ierr);
    hlascl_("G", &c__0, &c__0, &orgnrm, &c_b15, &nm1, &c__1, &e[1], &nm1, &
	    ierr);

    eps = hlamch_("Epsilon") * .9;

    mlvl = (integer) (M(log)((halfreal) (*n) / (halfreal) (smlsiz + 1)) / 
	    M(log)(2.)) + 1;
    smlszp = smlsiz + 1;
...
/*              first. */
	    ...
	    if (icompq == 2) {
		hlasd0_(&nsize, &sqre, &d__[start], &e[start], &u[start + 
			start * u_dim1], ldu, &vt[start + start * vt_dim1], 
			ldvt, &smlsiz, &iwork[1], &work[wstart], info);
	    } else {
		hlasda_(&icompq, &smlsiz, &nsize, &sqre, &d__[start], &e[
...
/*     Unscale */
    ...
    hlascl_("G", &c__0, &c__0, &c_b15, &orgnrm, n, &c__1, &d__[1], n, &ierr);
L40:
...
/* L50: */
	...
	if (kk != i__) {
		...
		hswap_(n, &u[i__ * u_dim1 + 1], &c__1, &u[kk * u_dim1 + 1], &
			c__1);
		hswap_(n, &vt[i__ + vt_dim1], ldvt, &vt[kk + vt_dim1], ldvt);
	    }
	} else if (icompq == 1) {
	    iq[i__] = i__;
	}
...
/*     which rotated B to be upper bidiagonal */
    ...
    if (iuplo == 2 && icompq == 2) {
	hlasr_("L", "V", "B", n, n, &work[1], &work[*n], &u[u_offset], ldu);
    }
