...
/* > */
/*  ===================================================================== */
void  hlasq2_(integer *n, halfreal *z__, integer *info)
{
    ...
    halfreal dn;
    integer pp;
    halfreal dn1, dn2, dee, eps, tau, tol;
    integer ipn4;
    halfreal tol2;
    logical ieee;
    integer nbig;
    halfreal dmin__, emin, emax;
    integer kmin, ndiv, iter;
    halfreal qmin, temp, qmax, zmax;
    integer splt;
    halfreal dmin1, dmin2;
    integer nfail;
    halfreal desig, trace, sigma;
    integer iinfo;
    halfreal tempe, tempq;
    integer ttype;
    extern void  hlasq3_(integer *, integer *, halfreal *, 
...
/*           While submatrix unfinished take a good dqds step. */
	    ...
	    hlasq3_(&i0, &n0, &z__[1], &pp, &dmin__, &sigma, &desig, &qmax, &
...
/*     Store trace, sum(eigenvalues) and information on performance. */
    ...
    z__[(*n << 1) + 1] = trace;
    z__[(*n << 1) + 2] = e;
    z__[(*n << 1) + 3] = (halfreal) iter;
/* Computing 2nd power */
    i__1 = *n;
    z__[(*n << 1) + 4] = (halfreal) ndiv / (halfreal) (i__1 * i__1);
    z__[(*n << 1) + 5] = nfail * 100. / (halfreal) iter;
    return;
