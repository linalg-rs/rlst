...
/*  ===================================================================== */
void  hpteqr_(char *compz, integer *n, halfreal *d__, 
	...
	integer *info)
{
    ...
    /* Local variables */
    halfreal c__[1]	/* was [1][1] */;
    integer i__;
    halfreal vt[1]	/* was [1][1] */;
    integer nru;
    ...
    integer icompz;
    extern void  hpttrf_(integer *, halfreal *, halfreal *,
	     integer *);
...
/*     Quick return if possible */
    ...
    if (icompz == 2) {
	hlaset_("Full", n, n, &c_b7, &c_b8, &z__[z_offset], ldz);
    }
...
/*     bidiagonal factor. */
    ...
    hbdsqr_("Lower", n, &c__0, &nru, &c__0, &d__[1], &e[1], vt, &c__1, &z__[
