...
/* > */
/*  ===================================================================== */
void  qgerqf_(integer *m, integer *n, quadreal *a, integer *
	lda, quadreal *tau, quadreal *work, integer *lwork, integer *info)
{
    ...
    extern void  qgerq2_(integer *, integer *, quadreal *, 
...
/*           A(m-k+i:m-k+i+ib-1,1:n-k+i+ib-1) */
	    ...
	    i__3 = *n - k + i__ + ib - 1;
	    qgerq2_(&ib, &i__3, &a[*m - k + i__ + a_dim1], lda, &tau[i__], &
		    work[1], &iinfo);
	    if (*m - k + i__ > 1) {
...
/*              H = H(i+ib-1) . . . H(i+1) H(i) */
		...
		i__3 = *n - k + i__ + ib - 1;
		qlarft_("Backward", "Rowwise", &i__3, &ib, &a[*m - k + i__ + 
...
/*     Use unblocked code to factor the last or only block */
    ...
    if (mu > 0 && nu > 0) {
	qgerq2_(&mu, &nu, &a[a_offset], lda, &tau[1], &work[1], &iinfo);
    }
