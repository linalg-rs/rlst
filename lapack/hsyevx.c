...
/*  ===================================================================== */
void  hsyevx_(char *jobz, char *range, char *uplo, integer *n, 
	halfreal *a, integer *lda, halfreal *vl, halfreal *vu, integer *
	il, integer *iu, halfreal *abstol, integer *m, halfreal *w, 
	halfreal *z__, integer *ldz, halfreal *work, integer *lwork, 
	integer *iwork, integer *ifail, integer *info)
{
    ...
    extern void  horgtr_(char *, integer *, halfreal *, 
	    ...
	    halfreal *, integer *, halfreal *, integer *), 
	    hormtr_(char *, char *, char *, integer *, integer *, halfreal *
...
/*     some eigenvalue, then try DSTEBZ. */
	...
	if (! wantz) {
	    ...
	    hlacpy_("A", n, n, &a[a_offset], lda, &z__[z_offset], ldz);
	    horgtr_(uplo, n, &z__[z_offset], ldz, &work[indtau], &work[indwrk]
		    , &llwork, &iinfo);
	    i__1 = *n - 1;
	    hcopy_(&i__1, &work[inde], &c__1, &work[indee], &c__1);
