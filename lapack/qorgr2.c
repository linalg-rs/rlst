...
/* > \verbatim */
/* > */
/* > DORGR2 generates an m by n doublereal matrix Q with orthonormal rows, */
...
/*  ===================================================================== */
void  qorgr2_(integer *m, integer *n, integer *k, quadreal *
...
/*        Apply H(i) to A(1:m-k+i,1:n-k+i) from the right */
	...
	i__2 = ii - 1;
	i__3 = *n - *m + ii;
	qlarf_("Right", &i__2, &i__3, &a[ii + a_dim1], lda, &tau[i__], &a[
		a_offset], lda, &work[1]);
	i__2 = *n - *m + ii - 1;
	d__1 = -tau[i__];
	qscal_(&i__2, &d__1, &a[ii + a_dim1], lda);
