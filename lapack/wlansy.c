...
/*  ===================================================================== */
quadreal wlansy_(char *norm, char *uplo, integer *n, quadcomplex *a, 
	integer *lda, quadreal *work)
{
...
/* L110: */
	    ...
	    for (j = 1; j <= i__1; ++j) {
		i__2 = *n - j;
		wlassq_(&i__2, &a[j + 1 + j * a_dim1], &c__1, &scale, &sum);
/* L120: */
	    }
	}
	sum *= 2;
	i__1 = *lda + 1;
	wlassq_(n, &a[a_offset], &i__1, &scale, &sum);
