...
/* > */
/*  ===================================================================== */
void  qsyequb_(char *uplo, integer *n, quadreal *a, integer *
	lda, quadreal *s, quadreal *scond, quadreal *amax, quadreal *
	work, integer *info)
{
    ...
    quadreal d__;
    integer i__, j;
    quadreal t, u, c0, c1, c2, si;
    logical up;
    quadreal avg, std, tol, base;
    integer iter;
    quadreal smin, smax, scale;
...
/*        avg = s^T beta / n */
	...
	qlassq_(n, &work[*n + 1], &c__1, &scale, &sumsq);
