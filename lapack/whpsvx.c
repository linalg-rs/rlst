...
/* > */
/*  ===================================================================== */
void  whpsvx_(char *fact, char *uplo, integer *n, integer *
	...
	work, quadreal *rwork, integer *info)
{
    ...
    extern quadreal wlanhp_(char *, char *, integer *, quadcomplex *, 
	    quadreal *);
    extern void  whpcon_(char *, integer *, quadcomplex *, 
	    integer *, quadreal *, quadreal *, quadcomplex *, integer *), wlacpy_(char *, integer *, integer *, quadcomplex *, 
	    integer *, quadcomplex *, integer *), whprfs_(char *, 
	    ...
	    integer *), whptrf_(char *, integer *, quadcomplex *, 
	    integer *, integer *), whptrs_(char *, integer *, integer 
	    *, quadcomplex *, integer *, quadcomplex *, integer *, 
	    integer *);
...
/*        Compute the factorization A = U*D*U**H or A = L*D*L**H. */
	...
	whptrf_(uplo, n, &afp[1], &ipiv[1], info);
...
/*     Compute the reciprocal of the condition number of A. */
    ...
    whpcon_(uplo, n, &afp[1], &ipiv[1], &anorm, rcond, &work[1], info);

/*     Compute the solution vectors X. */

    wlacpy_("Full", n, nrhs, &b[b_offset], ldb, &x[x_offset], ldx);
    whptrs_(uplo, n, nrhs, &afp[1], &ipiv[1], &x[x_offset], ldx, info);

/*     Use iterative refinement to improve the computed solutions and */
/*     compute error bounds and backward error estimates for them. */

    whprfs_(uplo, n, nrhs, &ap[1], &afp[1], &ipiv[1], &b[b_offset], ldb, &x[
