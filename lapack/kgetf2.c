...
/*  ===================================================================== */
void  kgetf2_(integer *m, integer *n, halfcomplex *a, 
...
/*        Find pivot and test for singularity. */
	...
	i__2 = *m - j + 1;
	jp = j - 1 + ikamax_(&i__2, &a[j + j * a_dim1], &c__1);
	ipiv[j] = jp;
	i__2 = jp + j * a_dim1;
...
/*           Apply the interchange to columns 1:N. */
	    ...
	    if (jp != j) {
		kswap_(n, &a[j + a_dim1], lda, &a[jp + a_dim1], lda);
	    }
...
/*           Compute elements J+1:M of J-th column. */
		...
		if (z_abs(&a[j + j * a_dim1]) >= sfmin) {
		    ...
		    kscal_(&i__2, &z__1, &a[j + 1 + j * a_dim1], &c__1);
		} else {
		    i__2 = *m - j;
...
/*           Update trailing submatrix. */
	    ...
	    i__3 = *n - j;
	    z__1.r = -1., z__1.i = -0.;
	    kgeru_(&i__2, &i__3, &z__1, &a[j + 1 + j * a_dim1], &c__1, &a[j + 
