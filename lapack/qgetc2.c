...
/*  ===================================================================== */
void  qgetc2_(integer *n, quadreal *a, integer *lda, integer 
	*ipiv, integer *jpiv, integer *info)
{
    ...
    extern void  qswap_(integer *, quadreal *, integer *, 
	    quadreal *, integer *), qlabad_(quadreal *, quadreal *);
...
/*        Swap rows */
	...
	if (ipv != i__) {
	    qswap_(n, &a[ipv + a_dim1], lda, &a[i__ + a_dim1], lda);
	}
	ipiv[i__] = ipv;
...
/*        Swap columns */
	...
	if (jpv != i__) {
	    qswap_(n, &a[jpv * a_dim1 + 1], &c__1, &a[i__ * a_dim1 + 1], &
		    c__1);
	}
	jpiv[i__] = jpv;
...
/* L30: */
	...
	i__2 = *n - i__;
	i__3 = *n - i__;
	qger_(&i__2, &i__3, &c_b10, &a[i__ + 1 + i__ * a_dim1], &c__1, &a[i__ 
