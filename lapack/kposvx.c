...
/*  ===================================================================== */
void  kposvx_(char *fact, char *uplo, integer *n, integer *
	nrhs, halfcomplex *a, integer *lda, halfcomplex *af, integer *
	ldaf, char *equed, halfreal *s, halfcomplex *b, integer *ldb, 
	...
	info)
{
    ...
    extern halfreal klanhe_(char *, char *, integer *, halfcomplex *, 
	    integer *, halfreal *);
    extern void  klaqhe_(char *, integer *, halfcomplex *, 
	    integer *, halfreal *, halfreal *, halfreal *, char *);
    integer infequ;
    extern void  klacpy_(char *, integer *, integer *, 
	    halfcomplex *, integer *, halfcomplex *, integer *), 
	    kpocon_(char *, integer *, halfcomplex *, integer *, halfreal 
	    *, halfreal *, halfcomplex *, halfreal *, integer *)
	    ;
    halfreal smlnum;
    extern void  kpoequ_(integer *, halfcomplex *, integer *,
	     halfreal *, halfreal *, halfreal *, integer *), kporfs_(
	    char *, integer *, integer *, halfcomplex *, integer *, 
	    halfcomplex *, integer *, halfcomplex *, integer *, 
	    halfcomplex *, integer *, halfreal *, halfreal *, 
	    halfcomplex *, halfreal *, integer *), kpotrf_(char *,
	     integer *, halfcomplex *, integer *, integer *), 
	    kpotrs_(char *, integer *, integer *, halfcomplex *, integer *, 
...
/*        Compute row and column scalings to equilibrate the matrix A. */
	...
	kpoequ_(n, &a[a_offset], lda, &s[1], &scond, &amax, &infequ);
	if (infequ == 0) {

/*           Equilibrate the matrix. */

	    klaqhe_(uplo, n, &a[a_offset], lda, &s[1], &scond, &amax, equed);
	    rcequ = lsame_(equed, "Y");
	}
    }
...
/*        Compute the Cholesky factorization A = U**H *U or A = L*L**H. */
	...
	klacpy_(uplo, n, n, &a[a_offset], lda, &af[af_offset], ldaf);
	kpotrf_(uplo, n, &af[af_offset], ldaf, info);
...
/*     Compute the norm of the matrix A. */
    ...
    anorm = klanhe_("1", uplo, n, &a[a_offset], lda, &rwork[1]);

/*     Compute the reciprocal of the condition number of A. */

    kpocon_(uplo, n, &af[af_offset], ldaf, &anorm, rcond, &work[1], &rwork[1],
	     info);

/*     Compute the solution matrix X. */

    klacpy_("Full", n, nrhs, &b[b_offset], ldb, &x[x_offset], ldx);
    kpotrs_(uplo, n, nrhs, &af[af_offset], ldaf, &x[x_offset], ldx, info);

/*     Use iterative refinement to improve the computed solution and */
/*     compute error bounds and backward error estimates for it. */

    kporfs_(uplo, n, nrhs, &a[a_offset], lda, &af[af_offset], ldaf, &b[
