...
/* > */
/*  ===================================================================== */
void  wgelq_(integer *m, integer *n, quadcomplex *a, integer 
	...
	lwork, integer *info)
{
    ...
    extern void  wgelqt_(integer *, integer *, integer *, 
	    quadcomplex *, integer *, quadcomplex *, integer *, 
	    quadcomplex *, integer *);
    logical lminws, lquery;
    integer mintsz;
    extern void  wlaswlq_(integer *, integer *, integer *, 
...
/*     The LQ Decomposition */
    ...
    if (*n <= *m || nb <= *m || nb >= *n) {
	wgelqt_(m, n, &mb, &a[a_offset], lda, &t[6], &mb, &work[1], info);
    } else {
	wlaswlq_(m, n, &mb, &nb, &a[a_offset], lda, &t[6], &mb, &work[1], 
		lwork, info);
    }
