...
/*  ===================================================================== */
void  kpbtrf_(char *uplo, integer *n, integer *kd, 
	halfcomplex *ab, integer *ldab, integer *info)
{
    ...
    halfcomplex work[1056]	/* was [33][32] */;
    ...
    extern void  kgemm_(char *, char *, integer *, integer *, 
	    ...
	    integer *, halfreal *, halfcomplex *, integer *, halfreal *,
	     halfcomplex *, integer *), ktrsm_(char *, char 
	    *, char *, char *, integer *, integer *, halfcomplex *, 
	    halfcomplex *, integer *, halfcomplex *, integer *), kpbtf2_(char *, integer *, integer *, 
	    halfcomplex *, integer *, integer *), kpotf2_(char *, 
...
/*        Use unblocked code */
	...
	kpbtf2_(uplo, n, kd, &ab[ab_offset], ldab, info);
    } else {
...
/*              Factorize the diagonal block */
		...
		i__3 = *ldab - 1;
		kpotf2_(uplo, &ib, &ab[*kd + 1 + i__ * ab_dim1], &i__3, &ii);
		if (ii != 0) {
		    *info = i__ + ii - 1;
		    goto L150;
		}
...
/*                    Update A12 */
			...
			i__3 = *ldab - 1;
			i__4 = *ldab - 1;
			ktrsm_("Left", "Upper", "Conjugate transpose", "Non-"
...
/*                    Update A22 */
			...
			i__3 = *ldab - 1;
			i__4 = *ldab - 1;
			kherk_("Upper", "Conjugate transpose", &i2, &ib, &
...
/*                    Update A23 */
			...
			if (i2 > 0) {
			    ...
			    i__3 = *ldab - 1;
			    i__4 = *ldab - 1;
			    kgemm_("Conjugate transpose", "No transpose", &i2,
...
/*                    Update A33 */
			...
			i__3 = *ldab - 1;
			kherk_("Upper", "Conjugate transpose", &i3, &ib, &
...
/*              Factorize the diagonal block */
		...
		i__3 = *ldab - 1;
		kpotf2_(uplo, &ib, &ab[i__ * ab_dim1 + 1], &i__3, &ii);
		if (ii != 0) {
		    *info = i__ + ii - 1;
		    goto L150;
		}
...
/*                    Update A21 */
			...
			i__3 = *ldab - 1;
			i__4 = *ldab - 1;
			ktrsm_("Right", "Lower", "Conjugate transpose", "Non"
...
/*                    Update A22 */
			...
			i__3 = *ldab - 1;
			i__4 = *ldab - 1;
			kherk_("Lower", "No transpose", &i2, &ib, &c_b21, &ab[
...
/*                    Update A32 */
			...
			if (i2 > 0) {
			    ...
			    i__3 = *ldab - 1;
			    i__4 = *ldab - 1;
			    kgemm_("No transpose", "Conjugate transpose", &i3,
...
/*                    Update A33 */
			...
			i__3 = *ldab - 1;
			kherk_("Lower", "No transpose", &i3, &ib, &c_b21, 
