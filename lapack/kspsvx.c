...
/* > */
/*  ===================================================================== */
void  kspsvx_(char *fact, char *uplo, integer *n, integer *
	nrhs, halfcomplex *ap, halfcomplex *afp, integer *ipiv, 
	...
	work, halfreal *rwork, integer *info)
{
    ...
    logical nofact;
    extern void  xerbla_(char *, integer *), klacpy_(
	    char *, integer *, integer *, halfcomplex *, integer *, 
	    halfcomplex *, integer *);
    extern halfreal klansp_(char *, char *, integer *, halfcomplex *, 
	    halfreal *);
    extern void  kspcon_(char *, integer *, halfcomplex *, 
	    integer *, halfreal *, halfreal *, halfcomplex *, integer *), ksprfs_(char *, integer *, integer *, halfcomplex *, 
	    halfcomplex *, integer *, halfcomplex *, integer *, 
	    halfcomplex *, integer *, halfreal *, halfreal *, 
	    halfcomplex *, halfreal *, integer *), ksptrf_(char *,
	     integer *, halfcomplex *, integer *, integer *), 
	    ksptrs_(char *, integer *, integer *, halfcomplex *, integer *, 
...
/*        Compute the factorization A = U*D*U**T or A = L*D*L**T. */
	...
	ksptrf_(uplo, n, &afp[1], &ipiv[1], info);
...
/*     Compute the norm of the matrix A. */
    ...
    anorm = klansp_("I", uplo, n, &ap[1], &rwork[1]);

/*     Compute the reciprocal of the condition number of A. */

    kspcon_(uplo, n, &afp[1], &ipiv[1], &anorm, rcond, &work[1], info);

/*     Compute the solution vectors X. */

    klacpy_("Full", n, nrhs, &b[b_offset], ldb, &x[x_offset], ldx);
    ksptrs_(uplo, n, nrhs, &afp[1], &ipiv[1], &x[x_offset], ldx, info);

/*     Use iterative refinement to improve the computed solutions and */
/*     compute error bounds and backward error estimates for them. */

    ksprfs_(uplo, n, nrhs, &ap[1], &afp[1], &ipiv[1], &b[b_offset], ldb, &x[
