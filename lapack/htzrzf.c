...
/* > \verbatim */
/* > */
/* > DTZRZF reduces the M-by-N ( M<=N ) doublereal upper trapezoidal matrix A */
...
/* > */
/*  ===================================================================== */
void  htzrzf_(integer *m, integer *n, halfreal *a, integer *
...
/*           A(i:i+ib-1,i:n) */
	    ...
	    i__3 = *n - i__ + 1;
	    i__4 = *n - *m;
	    hlatrz_(&ib, &i__3, &i__4, &a[i__ + i__ * a_dim1], lda, &tau[i__],
		     &work[1]);
	    if (i__ > 1) {
...
/*              H = H(i+ib-1) . . . H(i+1) H(i) */
		...
		i__3 = *n - *m;
		hlarzt_("Backward", "Rowwise", &i__3, &ib, &a[i__ + m1 * 
...
/*              Apply H to A(1:i-1,i:n) from the right */
		...
		i__4 = *n - i__ + 1;
		i__5 = *n - *m;
		hlarzb_("Right", "No transpose", "Backward", "Rowwise", &i__3,
...
/*     Use unblocked code to factor the last or only block */
    ...
    if (mu > 0) {
	i__2 = *n - *m;
	hlatrz_(&mu, n, &i__2, &a[a_offset], lda, &tau[1], &work[1]);
    }
