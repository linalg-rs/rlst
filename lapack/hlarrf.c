...
/*  ===================================================================== */
void  hlarrf_(integer *n, halfreal *d__, halfreal *l, 
	halfreal *ld, integer *clstrt, integer *clend, halfreal *w, 
	halfreal *wgap, halfreal *werr, halfreal *spdiam, halfreal *
	clgapl, halfreal *clgapr, halfreal *pivmin, halfreal *sigma, 
	halfreal *dplus, halfreal *lplus, halfreal *work, integer *info)
{
    ...
    /* Local variables */
    integer i__;
    halfreal s, bestshift, smlgrowth, eps, tmp, max1, max2, rrr1, rrr2, 
	    znm2, growthbound, fail, fact, oldp;
    integer indx;
    halfreal prod;
    integer ktry;
    halfreal fail2, avgap, ldmax, rdmax;
    integer shift;
    ...
    halfreal ldelta;
    logical nofail;
    halfreal mingap, lsigma, rdelta;
    extern logical hisnan_(halfreal *);
    logical forcer;
    halfreal rsigma, clwdth;
...
/*     Compute the average gap length of the cluster */
    clwdth = (d__1 = w[*clend] - w[*clstrt], abs(d__1)) + werr[*clend] + werr[
	    *clstrt];
    avgap = clwdth / (halfreal) (*clend - *clstrt);
...
/*     Initialize the record of the best representation found */
    ...
    s = hlamch_("S");
    smlgrowth = 1. / s;
    fail = (halfreal) (*n - 1) * mingap / (*spdiam * eps);
    fail2 = (halfreal) (*n - 1) * mingap / (*spdiam * M(sqrt)(eps));
    bestshift = lsigma;
...
/*        store new L and D back into DPLUS, LPLUS */
	hcopy_(n, &work[1], &c__1, &dplus[1], &c__1);
	i__1 = *n - 1;
	hcopy_(&i__1, &work[*n + 1], &c__1, &lplus[1], &c__1);
    }
    return;
