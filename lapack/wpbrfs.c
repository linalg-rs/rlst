...
/*  ===================================================================== */
void  wpbrfs_(char *uplo, integer *n, integer *kd, integer *
	nrhs, quadcomplex *ab, integer *ldab, quadcomplex *afb, integer *
	ldafb, quadcomplex *b, integer *ldb, quadcomplex *x, integer *ldx,
	...
	rwork, integer *info)
{
    ...
    integer isave[3];
    extern void  whbmv_(char *, integer *, integer *, 
...
/*        Compute residual R = B - A * X */
	...
	z__1.r = -1., z__1.i = -0.;
	whbmv_(uplo, n, kd, &z__1, &ab[ab_offset], ldab, &x[j * x_dim1 + 1], &
...
/*           Update solution and try again. */
	    ...
	    wpbtrs_(uplo, n, kd, &c__1, &afb[afb_offset], ldafb, &work[1], n, 
		    info);
...
/*              Multiply by diag(W)*inv(A**H). */
		...
		wpbtrs_(uplo, n, kd, &c__1, &afb[afb_offset], ldafb, &work[1],
			 n, info);
		i__2 = *n;
		for (i__ = 1; i__ <= i__2; ++i__) {
		    i__5 = i__;
