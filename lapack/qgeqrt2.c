...
/* > */
/*  ===================================================================== */
void  qgeqrt2_(integer *m, integer *n, quadreal *a, integer *
...
/* Computing MIN */
	i__3 = i__ + 1;
	qlarfg_(&i__2, &a[i__ + i__ * a_dim1], &a[f2cmin(i__3,*m) + i__ * a_dim1]
		, &c__1, &t[i__ + t_dim1]);
	if (i__ < *n) {
...
/*           W(1:N-I) := A(I:M,I+1:N)^H * A(I:M,I) [W = T(:,N)] */
	    ...
	    i__2 = *m - i__ + 1;
	    i__3 = *n - i__;
	    qgemv_("T", &i__2, &i__3, &c_b5, &a[i__ + (i__ + 1) * a_dim1], 
...
/*           A(I:M,I+1:N) = A(I:m,I+1:N) + alpha*A(I:M,I)*W(1:N-1)^H */
	    ...
	    i__2 = *m - i__ + 1;
	    i__3 = *n - i__;
	    qger_(&i__2, &i__3, &alpha, &a[i__ + i__ * a_dim1], &c__1, &t[*n *
...
/*        T(1:I-1,I) := alpha * A(I:M,1:I-1)**T * A(I:M,I) */
	...
	i__2 = *m - i__ + 1;
	i__3 = i__ - 1;
	qgemv_("T", &i__2, &i__3, &alpha, &a[i__ + a_dim1], lda, &a[i__ + i__ 
