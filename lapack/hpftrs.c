...
/* > */
/*  ===================================================================== */
void  hpftrs_(char *transr, char *uplo, integer *n, integer *
	nrhs, halfreal *a, halfreal *b, integer *ldb, integer *info)
{
    ...
    extern void  htfsm_(char *, char *, char *, char *, char *,
...
/*     start execution: there are two triangular solves */
    ...
    if (lower) {
	htfsm_(transr, "L", uplo, "N", "N", n, nrhs, &c_b10, a, &b[b_offset], 
		ldb);
	htfsm_(transr, "L", uplo, "T", "N", n, nrhs, &c_b10, a, &b[b_offset], 
		ldb);
    } else {
	htfsm_(transr, "L", uplo, "T", "N", n, nrhs, &c_b10, a, &b[b_offset], 
		ldb);
