...
/*  ===================================================================== */
void  zsytrf_aa__(char *uplo, integer *n, quadcomplex *a, 
	...
	integer *info)
{
    ...
    /* Local variables */
    integer j;
    extern void  zlasyf_aa__(char *, integer *, integer *, 
...
/*        Panel factorization */
	...
	i__1 = 2 - k1;
	i__2 = *n - j;
	zlasyf_aa__(uplo, &i__1, &i__2, &jb, &a[f2cmax(1,j) + (j + 1) * a_dim1], 
...
/*                 Update (J2, J2) diagonal block with ZGEMV */
		    ...
		    for (mj = nj - 1; mj >= 1; --mj) {
			i__3 = jb + 1;
			wgemv_("No transpose", &mj, &i__3, &c_b19, &work[j3 - 
...
/*                 Update off-diagonal block of J2-th block row with ZGEMM */
		    ...
		    i__3 = *n - j3 + 1;
		    i__4 = jb + 1;
		    wgemm_("Transpose", "Transpose", &nj, &i__3, &i__4, &
...
/*        Panel factorization */
	...
	i__2 = 2 - k1;
	i__1 = *n - j;
	zlasyf_aa__(uplo, &i__2, &i__1, &jb, &a[j + 1 + f2cmax(1,j) * a_dim1], 
		lda, &ipiv[j + 1], &work[1], n, &work[*n * nb + 1])
		;
...
/*                 Update off-diagonal block in J2-th block column with ZGEMM */
		    ...
		    i__3 = *n - j3 + 1;
		    i__4 = jb + 1;
		    wgemm_("No transpose", "Transpose", &i__3, &nj, &i__4, &
