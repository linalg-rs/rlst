...
/*  ===================================================================== */
void  wunbdb6_(integer *m1, integer *m2, integer *n, 
	quadcomplex *x1, integer *incx1, quadcomplex *x2, integer *incx2, 
	quadcomplex *q1, integer *ldq1, quadcomplex *q2, integer *ldq2, 
	quadcomplex *work, integer *lwork, integer *info)
{
    ...
    extern void  wgemv_(char *, integer *, integer *, 
	    ...
	    xerbla_(char *, integer *), wlassq_(integer *, 
...
/*     space */
    ...
    scl1 = 0.;
    ssq1 = 1.;
    wlassq_(m1, &x1[1], incx1, &scl1, &ssq1);
    scl2 = 0.;
    ssq2 = 1.;
    wlassq_(m2, &x2[1], incx2, &scl2, &ssq2);
/* Computing 2nd power */
    d__1 = scl1;
/* Computing 2nd power */
    d__2 = scl2;
	...
	wgemv_("C", m1, n, &c_b2, &q1[q1_offset], ldq1, &x1[1], incx1, &c_b3, 
		&work[1], &c__1);
    }

    wgemv_("C", m2, n, &c_b2, &q2[q2_offset], ldq2, &x2[1], incx2, &c_b2, &
	    work[1], &c__1);

    wgemv_("N", m1, n, &c_b1, &q1[q1_offset], ldq1, &work[1], &c__1, &c_b2, &
	    x1[1], incx1);
    wgemv_("N", m2, n, &c_b1, &q2[q2_offset], ldq2, &work[1], &c__1, &c_b2, &
	    x2[1], incx2);
