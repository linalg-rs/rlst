...
/* > */
/*  ===================================================================== */
void  qlatsqr_(integer *m, integer *n, integer *mb, integer *
	nb, quadreal *a, integer *lda, quadreal *t, integer *ldt, 
	quadreal *work, integer *lwork, integer *info)
{
    ...
    extern void  xerbla_(char *, integer *), qgeqrt_(
	    integer *, integer *, integer *, quadreal *, integer *, 
	    quadreal *, integer *, quadreal *, integer *), qtpqrt_(
...
/*     The QR Decomposition */
    ...
    if (*mb <= *n || *mb >= *m) {
	qgeqrt_(m, n, nb, &a[a_offset], lda, &t[t_offset], ldt, &work[1], 
		info);
	return;
    }
...
/*      Compute the QR factorization of the first block A(1:MB,1:N) */
    ...
    qgeqrt_(mb, n, nb, &a[a_dim1 + 1], lda, &t[t_offset], ldt, &work[1], info)
	    ;
...
/*      Compute the QR factorization of the current block A(I:I+MB-N,1:N) */
	...
	i__3 = *mb - *n;
	qtpqrt_(&i__3, n, &c__0, nb, &a[a_dim1 + 1], lda, &a[i__ + a_dim1], 
...
/*      Compute the QR factorization of the last block A(II:M,1:N) */
    ...
    if (ii <= *m) {
	qtpqrt_(&kk, n, &c__0, nb, &a[a_dim1 + 1], lda, &a[ii + a_dim1], lda, 
		&t[(ctr * *n + 1) * t_dim1 + 1], ldt, &work[1], info);
    }

    work[1] = (quadreal) (*n * *nb);
    return;
