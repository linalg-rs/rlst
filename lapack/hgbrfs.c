...
/*  ===================================================================== */
void  hgbrfs_(char *trans, integer *n, integer *kl, integer *
	ku, integer *nrhs, halfreal *ab, integer *ldab, halfreal *afb, 
	integer *ldafb, integer *ipiv, halfreal *b, integer *ldb, 
	halfreal *x, integer *ldx, halfreal *ferr, halfreal *berr, 
	halfreal *work, integer *iwork, integer *info)
{
    ...
    extern void  hgbmv_(char *, integer *, integer *, integer *
    ...
    halfreal safmin;
    extern void  xerbla_(char *, integer *), hgbtrs_(
...
/*        where op(A) = A, A**T, or A**H, depending on TRANS. */
	...
	hgbmv_(trans, n, n, kl, ku, &c_b15, &ab[ab_offset], ldab, &x[j * 
...
/*           Update solution and try again. */
	    ...
	    hgbtrs_(trans, n, kl, ku, &c__1, &afb[afb_offset], ldafb, &ipiv[1]
		    , &work[*n + 1], n, info);
	    haxpy_(n, &c_b17, &work[*n + 1], &c__1, &x[j * x_dim1 + 1], &c__1)
		    ;
	    lstres = berr[j];
	    ++count;
	    goto L20;
...
/*              Multiply by diag(W)*inv(op(A)**T). */
		...
		hgbtrs_(transt, n, kl, ku, &c__1, &afb[afb_offset], ldafb, &
...
/* L120: */
		...
		hgbtrs_(trans, n, kl, ku, &c__1, &afb[afb_offset], ldafb, &
			ipiv[1], &work[*n + 1], n, info);
	    }
	    goto L100;
	}
