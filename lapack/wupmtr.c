...
/*  ===================================================================== */
void  wupmtr_(char *side, char *uplo, char *trans, integer *m, 
	integer *n, quadcomplex *ap, quadcomplex *tau, quadcomplex *c__,
	 integer *ldc, quadcomplex *work, integer *info)
{
...
/*           Apply H(i) or H(i)**H */
	    ...
	    wlarf_(side, &mi, &ni, &ap[ii - i__ + 1], &c__1, &taui, &c__[
		    c_offset], ldc, &work[1]);
	    i__3 = ii;
...
/*           Apply H(i) or H(i)**H */
	    ...
	    wlarf_(side, &mi, &ni, &ap[ii], &c__1, &taui, &c__[ic + jc * 
		    c_dim1], ldc, &work[1]);
	    i__3 = ii;
	    ap[i__3].r = aii.r, ap[i__3].i = aii.i;
