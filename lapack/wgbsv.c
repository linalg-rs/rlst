...
/* > */
/*  ===================================================================== */
void  wgbsv_(integer *n, integer *kl, integer *ku, integer *
	nrhs, quadcomplex *ab, integer *ldab, integer *ipiv, quadcomplex *
	b, integer *ldb, integer *info)
{
    ...
    /* Local variables */
    extern void  xerbla_(char *, integer *), wgbtrf_(
	    integer *, integer *, integer *, integer *, quadcomplex *, 
	    integer *, integer *, integer *), wgbtrs_(char *, integer *, 
...
/*     Compute the LU factorization of the band matrix A. */
    ...
    wgbtrf_(n, n, kl, ku, &ab[ab_offset], ldab, &ipiv[1], info);
    if (*info == 0) {

/*        Solve the system A*X = B, overwriting B with X. */

	wgbtrs_("No transpose", n, kl, ku, nrhs, &ab[ab_offset], ldab, &ipiv[
