...
/*  ===================================================================== */
void  khetrs_(char *uplo, integer *n, integer *nrhs, 
...
/*           stored in column K of A. */
	    ...
	    i__1 = k - 1;
	    z__1.r = -1., z__1.i = -0.;
	    kgeru_(&i__1, nrhs, &z__1, &a[k * a_dim1 + 1], &c__1, &b[k + 
...
/*           stored in columns K-1 and K of A. */
	    ...
	    i__1 = k - 2;
	    z__1.r = -1., z__1.i = -0.;
	    kgeru_(&i__1, nrhs, &z__1, &a[(k - 1) * a_dim1 + 1], &c__1, &b[k 
...
/*           stored in column K of A. */
		...
		i__1 = *n - k;
		z__1.r = -1., z__1.i = -0.;
		kgeru_(&i__1, nrhs, &z__1, &a[k + 1 + k * a_dim1], &c__1, &b[
...
/*           stored in columns K and K+1 of A. */
		...
		i__1 = *n - k - 1;
		z__1.r = -1., z__1.i = -0.;
		kgeru_(&i__1, nrhs, &z__1, &a[k + 2 + k * a_dim1], &c__1, &b[
			k + b_dim1], ldb, &b[k + 2 + b_dim1], ldb);
		i__1 = *n - k - 1;
		z__1.r = -1., z__1.i = -0.;
		kgeru_(&i__1, nrhs, &z__1, &a[k + 2 + (k + 1) * a_dim1], &
