...
/*  ===================================================================== */
void  hpotrs_(char *uplo, integer *n, integer *nrhs, 
...
/*        Solve U**T *X = B, overwriting B with X. */
	...
	htrsm_("Left", "Upper", "Transpose", "Non-unit", n, nrhs, &c_b9, &a[
		a_offset], lda, &b[b_offset], ldb);

/*        Solve U*X = B, overwriting B with X. */

	htrsm_("Left", "Upper", "No transpose", "Non-unit", n, nrhs, &c_b9, &
...
/*        Solve L*X = B, overwriting B with X. */
	...
	htrsm_("Left", "Lower", "No transpose", "Non-unit", n, nrhs, &c_b9, &
		a[a_offset], lda, &b[b_offset], ldb);

/*        Solve L**T *X = B, overwriting B with X. */

	htrsm_("Left", "Lower", "Transpose", "Non-unit", n, nrhs, &c_b9, &a[
		a_offset], lda, &b[b_offset], ldb);
    }
