...
/*  ===================================================================== */
void  qgesv_(integer *n, integer *nrhs, quadreal *a, integer 
	*lda, integer *ipiv, quadreal *b, integer *ldb, integer *info)
{
    /* System generated locals */
    integer a_dim1, a_offset, b_dim1, b_offset, i__1;

    /* Local variables */
    extern void  qgetrf_(integer *, integer *, quadreal *, 
	    integer *, integer *, integer *), xerbla_(char *, integer *), qgetrs_(char *, integer *, integer *, quadreal *, 
...
/*        Solve the system A*X = B, overwriting B with X. */
	...
	qgetrs_("No transpose", n, nrhs, &a[a_offset], lda, &ipiv[1], &b[
		b_offset], ldb, info);
    }
    return;
