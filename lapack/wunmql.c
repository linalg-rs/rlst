...
/*  ===================================================================== */
void  wunmql_(char *side, char *trans, integer *m, integer *n, 
	integer *k, quadcomplex *a, integer *lda, quadcomplex *tau, 
	 ...
	 integer *info)
{
    ...
    integer nbmin, iinfo;
    extern void  wunm2l_(char *, char *, integer *, integer *, 
    ...
    logical notran;
    integer ldwork;
    extern void  wlarft_(char *, char *, integer *, integer *, 
...
/*        Use unblocked code */
	...
	wunm2l_(side, trans, m, n, k, &a[a_offset], lda, &tau[1], &c__[
...
/*           H = H(i+ib-1) . . . H(i+1) H(i) */
	    ...
	    i__4 = nq - *k + i__ + ib - 1;
	    wlarft_("Backward", "Columnwise", &i__4, &ib, &a[i__ * a_dim1 + 1]
...
/*           Apply H or H**H */
	    ...
	    wlarfb_(side, trans, "Backward", "Columnwise", &mi, &ni, &ib, &a[
