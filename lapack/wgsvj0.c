...
/*  ===================================================================== */
void  wgsvj0_(char *jobv, integer *m, integer *n, 
	quadcomplex *a, integer *lda, quadcomplex *d__, quadreal *sva, 
	integer *mv, quadcomplex *v, integer *ldv, quadreal *eps, 
	quadreal *sfmin, quadreal *tol, integer *nsweep, quadcomplex *
...
/* Computing MAX */
			  ...
			  wrot_(&mvl, &v[p * v_dim1 + 1], &c__1, &v[q * 
				  v_dim1 + 1], &c__1, &cs, &z__1);
					...
					waxpy_(m, &z__1, &work[1], &c__1, &a[
						q * a_dim1 + 1], &c__1);
					wlascl_("G", &c__0, &c__0, &c_b27, &
