...
/* > \verbatim */
/* > */
/* > DSPOSV computes the solution to a doublereal system of linear equations */
/* >    A * X = B, */
...
/*  ===================================================================== */
void  hsposv_(char *uplo, integer *n, integer *nrhs, 
	halfreal *a, integer *lda, halfreal *b, integer *ldb, halfreal *
	x, integer *ldx, halfreal *work, doublereal *swork, integer *iter, 
	integer *info)
{
    ...
    extern void  haxpy_(integer *, halfreal *, halfreal *, 
	    integer *, halfreal *, integer *), hsymm_(char *, char *, 
	    integer *, integer *, halfreal *, halfreal *, integer *, 
	    halfreal *, integer *, halfreal *, halfreal *, integer *), hlag2s_(integer *, integer *, halfreal *, 
	    integer *, doublereal *, integer *, integer *), slag2d_(integer *, 
	    integer *, doublereal *, integer *, halfreal *, integer *, integer *),
	     hlat2s_(char *, integer *, halfreal *, integer *, doublereal *, 
	    integer *, integer *);
    ...
    extern halfreal hlansy_(char *, char *, integer *, halfreal *, 
	    integer *, halfreal *);
    extern void  hpotrf_(char *, integer *, halfreal *, 
	    integer *, integer *), hpotrs_(char *, integer *, integer 
	    *, halfreal *, integer *, halfreal *, integer *, integer *), spotrf_(char *, integer *, doublereal *, integer *, integer *), spotrs_(char *, integer *, integer *, doublereal *, integer *, 
...
/*     Compute some constants. */
    ...
    anrm = hlansy_("I", uplo, n, &a[a_offset], lda, &work[work_offset]);
    eps = hlamch_("Epsilon");
...
/*     result in SX. */
    ...
    hlag2s_(n, nrhs, &b[b_offset], ldb, &swork[ptsx], n, info);
...
/*     result in SA. */
    ...
    hlat2s_(uplo, n, &a[a_offset], lda, &swork[ptsa], n, info);
...
/*     Compute R = B - AX (R is WORK). */
    ...
    hlacpy_("All", n, nrhs, &b[b_offset], ldb, &work[work_offset], n);

    hsymm_("Left", uplo, n, nrhs, &c_b10, &a[a_offset], lda, &x[x_offset], 
...
/*     stopping criterion. If yes, set ITER=0 and return. */
	...
	xnrm = (d__1 = x[ihamax_(n, &x[i__ * x_dim1 + 1], &c__1) + i__ * 
		x_dim1], abs(d__1));
	rnrm = (d__1 = work[ihamax_(n, &work[i__ * work_dim1 + 1], &c__1) + 
...
/*        and store the result in SX. */
	...
	hlag2s_(n, nrhs, &work[work_offset], n, &swork[ptsx], n, info);
...
/*        iterate. */
	...
	i__1 = *nrhs;
	for (i__ = 1; i__ <= i__1; ++i__) {
	    haxpy_(n, &c_b11, &work[i__ * work_dim1 + 1], &c__1, &x[i__ * 
		    x_dim1 + 1], &c__1);
	}
...
/*        Compute R = B - AX (R is WORK). */
	...
	hsymm_("L", uplo, n, nrhs, &c_b10, &a[a_offset], lda, &x[x_offset], 
		ldx, &c_b11, &work[work_offset], n);
...
/*     satisfactory solution, so we resort to double precision. */
    ...
    hpotrf_(uplo, n, &a[a_offset], lda, info);

    if (*info != 0) {
	return;
    }

    hlacpy_("All", n, nrhs, &b[b_offset], ldb, &x[x_offset], ldx);
    hpotrs_(uplo, n, nrhs, &a[a_offset], lda, &x[x_offset], ldx, info);
