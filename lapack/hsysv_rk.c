...
/* > */
/* > \verbatim */
/* > DSYSV_RK computes the solution to a doublereal system of linear */
...
/* > */
/* > DSYTRF_RK is called to compute the factorization of a doublereal */
...
/*  ===================================================================== */
void  dsysv_rk__(char *uplo, integer *n, integer *nrhs, 
	halfreal *a, integer *lda, halfreal *e, integer *ipiv, halfreal 
	*b, integer *ldb, halfreal *work, integer *lwork, integer *info)
{
    /* System generated locals */
    integer a_dim1, a_offset, b_dim1, b_offset, i__1;

    /* Local variables */
    extern void  dsytrs_3__(char *, integer *, integer *, 
	    halfreal *, integer *, halfreal *, integer *, halfreal *, 
	    integer *, integer *), dsytrf_rk__(char *, integer *, 
	    halfreal *, integer *, halfreal *, integer *, halfreal *, 
	    integer *, integer *);
