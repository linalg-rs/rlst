...
/*  ===================================================================== */
void  whpgvd_(integer *itype, char *jobz, char *uplo, integer *
	n, quadcomplex *ap, quadcomplex *bp, quadreal *w, quadcomplex 
	*z__, integer *ldz, quadcomplex *work, integer *lwork, quadreal *
	...
	info)
{
    ...
    extern void  wtpmv_(char *, char *, char *, integer *, 
	    ...
	    char *, integer *);
    integer liwmin;
    extern void  whpevd_(char *, char *, integer *, 
	    quadcomplex *, quadreal *, quadcomplex *, integer *, 
	    quadcomplex *, integer *, quadreal *, integer *, integer *, 
	    integer *, integer *);
    integer lrwmin;
    extern void  whpgst_(integer *, char *, integer *, 
	    quadcomplex *, quadcomplex *, integer *);
    logical lquery;
    extern void  wpptrf_(char *, integer *, quadcomplex *, 
	    integer *);
...
/*     Transform problem to standard eigenvalue problem and solve. */
    ...
    whpevd_(jobz, uplo, n, &ap[1], &w[1], &z__[z_offset], ldz, &work[1], 
	    lwork, &rwork[1], lrwork, &iwork[1], liwork, info);
/* Computing MAX */
    d__1 = (quadreal) lwmin, d__2 = work[1].r;
    lwmin = (integer) f2cmax(d__1,d__2);
/* Computing MAX */
    d__1 = (quadreal) lrwmin;
    lrwmin = (integer) f2cmax(d__1,rwork[1]);
/* Computing MAX */
    d__1 = (quadreal) liwmin, d__2 = (quadreal) iwork[1];
