...
/* > */
/*  ===================================================================== */
void  qorbdb2_(integer *m, integer *p, integer *q, quadreal *
	x11, integer *ldx11, quadreal *x21, integer *ldx21, quadreal *
	theta, quadreal *phi, quadreal *taup1, quadreal *taup2, 
	quadreal *tauq1, quadreal *work, integer *lwork, integer *info)
{
...
/*     Reduce rows 1, ..., P of X11 and X21 */
	...
	if (i__ > 1) {
	    i__2 = *q - i__ + 1;
	    qrot_(&i__2, &x11[i__ + i__ * x11_dim1], ldx11, &x21[i__ - 1 + 
...
/* Computing 2nd power */
	...
	i__3 = *m - *p - i__ + 1;
/* Computing 2nd power */
	d__2 = qnrm2_(&i__3, &x21[i__ + i__ * x21_dim1], &c__1);
	...
	i__3 = *m - *p - i__ + 1;
	i__4 = *q - i__;
	qorbdb5_(&i__2, &i__3, &i__4, &x11[i__ + 1 + i__ * x11_dim1], &c__1, &
		x21[i__ + i__ * x21_dim1], &c__1, &x11[i__ + 1 + (i__ + 1) * 
		x11_dim1], ldx11, &x21[i__ + (i__ + 1) * x21_dim1], ldx21, &
		work[iorbdb5], &lorbdb5, &childinfo);
	i__2 = *p - i__;
	qscal_(&i__2, &c_b9, &x11[i__ + 1 + i__ * x11_dim1], &c__1);
	i__2 = *m - *p - i__ + 1;
	qlarfgp_(&i__2, &x21[i__ + i__ * x21_dim1], &x21[i__ + 1 + i__ * 
		x21_dim1], &c__1, &taup2[i__]);
	if (i__ < *p) {
	    i__2 = *p - i__;
	    qlarfgp_(&i__2, &x11[i__ + 1 + i__ * x11_dim1], &x11[i__ + 2 + 
	    ...
	    i__2 = *p - i__;
	    i__3 = *q - i__;
	    qlarf_("L", &i__2, &i__3, &x11[i__ + 1 + i__ * x11_dim1], &c__1, &
	...
	i__2 = *m - *p - i__ + 1;
	i__3 = *q - i__;
	qlarf_("L", &i__2, &i__3, &x21[i__ + i__ * x21_dim1], &c__1, &taup2[
