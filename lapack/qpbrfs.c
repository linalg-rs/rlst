...
/*  ===================================================================== */
void  qpbrfs_(char *uplo, integer *n, integer *kd, integer *
	nrhs, quadreal *ab, integer *ldab, quadreal *afb, integer *ldafb, 
	quadreal *b, integer *ldb, quadreal *x, integer *ldx, quadreal *
	ferr, quadreal *berr, quadreal *work, integer *iwork, integer *
	info)
{
    ...
    integer isave[3];
    extern void  qsbmv_(char *, integer *, integer *, 
    ...
    quadreal safmin;
    extern void  xerbla_(char *, integer *), qpbtrs_(
...
/*        Compute residual R = B - A * X */
	...
	qsbmv_(uplo, n, kd, &c_b12, &ab[ab_offset], ldab, &x[j * x_dim1 + 1], 
...
/*           Update solution and try again. */
	    ...
	    qpbtrs_(uplo, n, kd, &c__1, &afb[afb_offset], ldafb, &work[*n + 1]
		    , n, info);
...
/*              Multiply by diag(W)*inv(A**T). */
		...
		qpbtrs_(uplo, n, kd, &c__1, &afb[afb_offset], ldafb, &work[*n 
			+ 1], n, info);
		i__2 = *n;
		for (i__ = 1; i__ <= i__2; ++i__) {
		    work[*n + i__] *= work[i__];
