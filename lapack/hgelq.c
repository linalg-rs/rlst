...
/* > */
/*  ===================================================================== */
void  hgelq_(integer *m, integer *n, halfreal *a, integer *
	...
	integer *info)
{
    ...
    extern void  hgelqt_(integer *, integer *, integer *, 
	    halfreal *, integer *, halfreal *, integer *, halfreal *, 
	    integer *);
    logical lminws, lquery;
    integer mintsz;
    extern void  hlaswlq_(integer *, integer *, integer *, 
...
/*     The LQ Decomposition */
    ...
    if (*n <= *m || nb <= *m || nb >= *n) {
	hgelqt_(m, n, &mb, &a[a_offset], lda, &t[6], &mb, &work[1], info);
    } else {
	hlaswlq_(m, n, &mb, &nb, &a[a_offset], lda, &t[6], &mb, &work[1], 
		lwork, info);
    }
