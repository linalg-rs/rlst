...
/* > */
/*  ===================================================================== */
void  wlarft_(char *direct, char *storev, integer *n, integer *
	k, quadcomplex *v, integer *ldv, quadcomplex *tau, quadcomplex *
	t, integer *ldt)
{
    ...
    extern void  wtrmv_(char *, char *, char *, integer *, 
	    quadcomplex *, integer *, quadcomplex *, integer *), mecago_();
...
/*                 T(1:i-1,i) := - tau(i) * V(i:j,1:i-1)**H * V(i:j,i) */
		    ...
		    wgemv_("Conjugate transpose", &i__2, &i__3, &z__1, &v[i__ 
...
/*                 T(1:i-1,i) := - tau(i) * V(1:i-1,i:j) * V(i,i:j)**H */
		    ...
		    i__4 = i__;
		    z__1.r = -tau[i__4].r, z__1.i = -tau[i__4].i;
		    wgemm_("N", "C", &i__2, &c__1, &i__3, &z__1, &v[(i__ + 1) 
...
/*              T(1:i-1,i) := T(1:i-1,1:i-1) * T(1:i-1,i) */
		...
		i__2 = i__ - 1;
		wtrmv_("Upper", "No transpose", "Non-unit", &i__2, &t[
...
/*                    T(i+1:k,i) = -tau(i) * V(j:n-k+i,i+1:k)**H * V(j:n-k+i,i) */
			...
			wgemv_("Conjugate transpose", &i__1, &i__2, &z__1, &v[
...
/*                    T(i+1:k,i) = -tau(i) * V(i+1:k,j:n-k+i) * V(i,j:n-k+i)**H */
			...
			i__3 = i__;
			z__1.r = -tau[i__3].r, z__1.i = -tau[i__3].i;
			wgemm_("N", "C", &i__1, &c__1, &i__2, &z__1, &v[i__ + 
...
/*                 T(i+1:k,i) := T(i+1:k,i+1:k) * T(i+1:k,i) */
		    ...
		    i__1 = *k - i__;
		    wtrmv_("Lower", "No transpose", "Non-unit", &i__1, &t[i__ 
