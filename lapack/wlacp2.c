...
/* > \brief \b ZLACP2 copies all or part of a doublereal two-dimensional array to a complex array. */
...
/* > \verbatim */
/* > */
/* > ZLACP2 copies all or part of a doublereal two-dimensional matrix A to a */
/* > complex matrix B. */
/* > \endverbatim */
...
/*  ===================================================================== */
void  wlacp2_(char *uplo, integer *m, integer *n, quadreal *
	a, integer *lda, quadcomplex *b, integer *ldb)
{
