...
/*  ===================================================================== */
void  zhetf2_rook__(char *uplo, integer *n, quadcomplex *a, 
	integer *lda, integer *ipiv, integer *info)
{
    ...
    quadcomplex wk;
    quadreal tt;
    quadcomplex wkm1, wkp1;
    logical done;
    integer imax, jmax;
    extern void  wher_(char *, integer *, quadreal *, 
...
/*                       = A - W(k)*1/D(k)*W(k)**T */
			...
			i__1 = k - 1;
			d__1 = -d11;
			wher_(uplo, &i__1, &d__1, &a[k * a_dim1 + 1], &c__1, &
				a[a_offset], lda);

/*                    Store U(k) in column k */

			i__1 = k - 1;
			wqscal_(&i__1, &d11, &a[k * a_dim1 + 1], &c__1);
		    } else {
...
/*                       = A - W(k)*(1/D(k))*W(k)**T */
			...
			i__1 = *n - k;
			d__1 = -d11;
			wher_(uplo, &i__1, &d__1, &a[k + 1 + k * a_dim1], &
				c__1, &a[k + 1 + (k + 1) * a_dim1], lda);

/*                    Store L(k) in column k */

			i__1 = *n - k;
			wqscal_(&i__1, &d11, &a[k + 1 + k * a_dim1], &c__1);
		    } else {
