...
/*  ===================================================================== */
void  wgerfs_(char *trans, integer *n, integer *nrhs, 
	quadcomplex *a, integer *lda, quadcomplex *af, integer *ldaf, 
	integer *ipiv, quadcomplex *b, integer *ldb, quadcomplex *x, 
	integer *ldx, quadreal *ferr, quadreal *berr, quadcomplex *work,
	 quadreal *rwork, integer *info)
{
    ...
    extern void  wgemv_(char *, integer *, integer *, 
	    ...
	    integer *, quadcomplex *, integer *), wlacn2_(integer *, 
	    quadcomplex *, quadcomplex *, quadreal *, integer *, 
	    integer *);
...
/*        where op(A) = A, A**T, or A**H, depending on TRANS. */
	...
	z__1.r = -1., z__1.i = -0.;
	wgemv_(trans, n, n, &z__1, &a[a_offset], lda, &x[j * x_dim1 + 1], &
...
/*           Update solution and try again. */
	    ...
	    wgetrs_(trans, n, &c__1, &af[af_offset], ldaf, &ipiv[1], &work[1],
		     n, info);
...
/*              Multiply by diag(W)*inv(op(A)**H). */
		...
		wgetrs_(transt, n, &c__1, &af[af_offset], ldaf, &ipiv[1], &
			work[1], n, info);
		i__2 = *n;
		for (i__ = 1; i__ <= i__2; ++i__) {
		    i__3 = i__;
...
/* L120: */
		...
		wgetrs_(transn, n, &c__1, &af[af_offset], ldaf, &ipiv[1], &
			work[1], n, info);
	    }
	    goto L100;
	}
