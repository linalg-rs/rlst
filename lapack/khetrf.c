...
/* > */
/*  ===================================================================== */
void  khetrf_(char *uplo, integer *n, halfcomplex *a, 
	...
	integer *info)
{
    ...
    integer nbmin, iinfo;
    logical upper;
    extern void  khetf2_(char *, integer *, halfcomplex *, 
	    integer *, integer *, integer *), klahef_(char *, integer 
	    *, integer *, integer *, halfcomplex *, integer *, integer *, 
	    halfcomplex *, integer *, integer *), xerbla_(char *, 
	    integer *);
...
/*           update columns 1:k-kb */
	    ...
	    klahef_(uplo, &k, &nb, &kb, &a[a_offset], lda, &ipiv[1], &work[1],
		     n, &iinfo);
	} else {

/*           Use unblocked code to factorize columns 1:k of A */

	    khetf2_(uplo, &k, &a[a_offset], lda, &ipiv[1], &iinfo);
	    kb = k;
	}
...
/*           update columns k+kb:n */
	    ...
	    i__1 = *n - k + 1;
	    klahef_(uplo, &i__1, &nb, &kb, &a[k + k * a_dim1], lda, &ipiv[k], 
		    &work[1], n, &iinfo);
	} else {
...
/*           Use unblocked code to factorize columns k:n of A */
	    ...
	    i__1 = *n - k + 1;
	    khetf2_(uplo, &i__1, &a[k + k * a_dim1], lda, &ipiv[k], &iinfo);
	    kb = *n - k + 1;
	}
