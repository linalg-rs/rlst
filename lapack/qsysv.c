...
/*  ===================================================================== */
void  qsysv_(char *uplo, integer *n, integer *nrhs, quadreal 
	*a, integer *lda, integer *ipiv, quadreal *b, integer *ldb, 
	quadreal *work, integer *lwork, integer *info)
{
    ...
    extern void  xerbla_(char *, integer *), qsytrf_(
	    char *, integer *, quadreal *, integer *, integer *, quadreal 
	    *, integer *, integer *);
    integer lwkopt;
    logical lquery;
    extern void  qsytrs_(char *, integer *, integer *, 
	    quadreal *, integer *, integer *, quadreal *, integer *, 
	    integer *), qsytrs2_(char *, integer *, integer *, 
	    quadreal *, integer *, integer *, quadreal *, integer *, 
	    quadreal *, integer *);
...
/*     Test the input parameters. */
	...
	*info = -10;
	...
	if (*n == 0) {
	    ...
	    qsytrf_(uplo, n, &a[a_offset], lda, &ipiv[1], &work[1], &c_n1, 
		    info);
...
/*     Compute the factorization A = U*D*U**T or A = L*D*L**T. */
    ...
    qsytrf_(uplo, n, &a[a_offset], lda, &ipiv[1], &work[1], lwork, info);
    if (*info == 0) {
...
/*        Solve with TRS ( Use Level BLAS 2) */
	    ...
	    qsytrs_(uplo, n, nrhs, &a[a_offset], lda, &ipiv[1], &b[b_offset], 
		    ldb, info);
...
/*        Solve with TRS2 ( Use Level BLAS 3) */
	    ...
	    qsytrs2_(uplo, n, nrhs, &a[a_offset], lda, &ipiv[1], &b[b_offset],
		     ldb, &work[1], info);
