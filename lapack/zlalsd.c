...
/*  ===================================================================== */
void  zlalsd_(char *uplo, integer *smlsiz, integer *n, integer 
	...
	rwork, integer *iwork, integer *info)
{
    ...
    extern void  dlasdq_(char *, integer *, integer *, integer 
    ...
    extern void  zlalsa_(integer *, integer *, integer *, 
	    integer *, doublecomplex *, integer *, doublecomplex *, integer *,
...
/*     Book-keeping and setting up some constants. */
    ...
    nlvl = (integer) (M(log)((doublereal) (*n) / (doublereal) (*smlsiz + 1)) / 
	    M(log)(2.)) + 1;
