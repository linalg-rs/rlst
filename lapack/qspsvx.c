...
/* > */
/*  ===================================================================== */
void  qspsvx_(char *fact, char *uplo, integer *n, integer *
	nrhs, quadreal *ap, quadreal *afp, integer *ipiv, quadreal *b, 
	integer *ldb, quadreal *x, integer *ldx, quadreal *rcond, 
	quadreal *ferr, quadreal *berr, quadreal *work, integer *iwork, 
	integer *info)
{
    ...
    extern quadreal qlansp_(char *, char *, integer *, quadreal *, 
	    quadreal *);
    extern void  qspcon_(char *, integer *, quadreal *, 
	    integer *, quadreal *, quadreal *, quadreal *, integer *, 
	    integer *), qsprfs_(char *, integer *, integer *, 
	    quadreal *, quadreal *, integer *, quadreal *, integer *, 
	    quadreal *, integer *, quadreal *, quadreal *, quadreal *,
	     integer *, integer *), qsptrf_(char *, integer *, 
	    quadreal *, integer *, integer *), qsptrs_(char *, 
...
/*     Compute the solution vectors X. */
    ...
    qsptrs_(uplo, n, nrhs, &afp[1], &ipiv[1], &x[x_offset], ldx, info);

/*     Use iterative refinement to improve the computed solutions and */
/*     compute error bounds and backward error estimates for them. */

    qsprfs_(uplo, n, nrhs, &ap[1], &afp[1], &ipiv[1], &b[b_offset], ldb, &x[
