...
/* > */
/*  ===================================================================== */
void  wpbsv_(char *uplo, integer *n, integer *kd, integer *
	...
	ldb, integer *info)
{
    ...
    extern void  xerbla_(char *, integer *), wpbtrf_(
	    char *, integer *, integer *, quadcomplex *, integer *, integer 
	    *), wpbtrs_(char *, integer *, integer *, integer *, 
...
/*     Compute the Cholesky factorization A = U**H *U or A = L*L**H. */
    ...
    wpbtrf_(uplo, n, kd, &ab[ab_offset], ldab, info);
    if (*info == 0) {

/*        Solve the system A*X = B, overwriting B with X. */

	wpbtrs_(uplo, n, kd, nrhs, &ab[ab_offset], ldab, &b[b_offset], ldb, 
		info);
