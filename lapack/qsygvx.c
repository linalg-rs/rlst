...
/*  ===================================================================== */
void  qsygvx_(integer *itype, char *jobz, char *range, char *
	uplo, integer *n, quadreal *a, integer *lda, quadreal *b, integer 
	*ldb, quadreal *vl, quadreal *vu, integer *il, integer *iu, 
	...
	integer *ifail, integer *info)
{
    ...
    integer lwkopt;
    logical lquery;
    extern void  qsyevx_(char *, char *, char *, integer *, 
...
/*     Transform problem to standard eigenvalue problem and solve. */
    ...
    qsyevx_(jobz, range, uplo, n, &a[a_offset], lda, vl, vu, il, iu, abstol, 
...
/*           backtransform eigenvectors: x = inv(L)**T*y or inv(U)*y */
		...
		*(unsigned char *)trans = 'T';
	    ...
	    qtrsm_("Left", uplo, trans, "Non-unit", n, m, &c_b19, &b[b_offset]
...
/*           backtransform eigenvectors: x = L*y or U**T*y */
		...
		*(unsigned char *)trans = 'N';
	    ...
	    qtrmm_("Left", uplo, trans, "Non-unit", n, m, &c_b19, &b[b_offset]
		    , ldb, &z__[z_offset], ldz);
	}
    }
