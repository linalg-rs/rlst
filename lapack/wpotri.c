...
/*  ===================================================================== */
void  wpotri_(char *uplo, integer *n, quadcomplex *a, 
	integer *lda, integer *info)
{
    ...
    extern void  xerbla_(char *, integer *), wlauum_(
	    char *, integer *, quadcomplex *, integer *, integer *),
	     wtrtri_(char *, char *, integer *, quadcomplex *, integer *, 
	    integer *);
...
/*     Invert the triangular Cholesky factor U or L. */
    ...
    wtrtri_(uplo, "Non-unit", n, &a[a_offset], lda, info);
    if (*info > 0) {
	return;
    }
...
/*     Form inv(U) * inv(U)**H or inv(L)**H * inv(L). */
    ...
    wlauum_(uplo, n, &a[a_offset], lda, info);
