...
/* > */
/*  ===================================================================== */
void  klabrd_(integer *m, integer *n, integer *nb, 
	halfcomplex *a, integer *lda, halfreal *d__, halfreal *e, 
	halfcomplex *tauq, halfcomplex *taup, halfcomplex *x, integer *
	ldx, halfcomplex *y, integer *ldy)
{
    ...
    extern void  kscal_(integer *, halfcomplex *, 
	    ...
	    klarfg_(integer *, halfcomplex *, halfcomplex *, integer *, 
	    halfcomplex *), klacgv_(integer *, halfcomplex *, integer *);
...
/*           Update A(i:m,i) */
	    ...
	    i__3 = i__ - 1;
	    z__1.r = -1., z__1.i = -0.;
	    kgemv_("No transpose", &i__2, &i__3, &z__1, &x[i__ + x_dim1], ldx,
...
/* Computing MIN */
	    i__3 = i__ + 1;
	    klarfg_(&i__2, &alpha, &a[f2cmin(i__3,*m) + i__ * a_dim1], &c__1, &
		    tauq[i__]);
	    i__2 = i__;
	    d__[i__2] = alpha.r;
	    if (i__ < *n) {
...
/*              Compute Y(i+1:n,i) */
		...
		i__2 = *m - i__ + 1;
		i__3 = *n - i__;
		kgemv_("Conjugate transpose", &i__2, &i__3, &c_b2, &a[i__ + (
		...
		i__3 = i__ - 1;
		z__1.r = -1., z__1.i = -0.;
		kgemv_("No transpose", &i__2, &i__3, &z__1, &y[i__ + 1 + 
			y_dim1], ldy, &y[i__ * y_dim1 + 1], &c__1, &c_b2, &y[
			i__ + 1 + i__ * y_dim1], &c__1);
		i__2 = *m - i__ + 1;
		i__3 = i__ - 1;
		kgemv_("Conjugate transpose", &i__2, &i__3, &c_b2, &x[i__ + 
			x_dim1], ldx, &a[i__ + i__ * a_dim1], &c__1, &c_b1, &
			y[i__ * y_dim1 + 1], &c__1);
		i__2 = i__ - 1;
		i__3 = *n - i__;
		z__1.r = -1., z__1.i = -0.;
		kgemv_("Conjugate transpose", &i__2, &i__3, &z__1, &a[(i__ + 
			1) * a_dim1 + 1], lda, &y[i__ * y_dim1 + 1], &c__1, &
			c_b2, &y[i__ + 1 + i__ * y_dim1], &c__1);
		i__2 = *n - i__;
		kscal_(&i__2, &tauq[i__], &y[i__ + 1 + i__ * y_dim1], &c__1);

/*              Update A(i,i+1:n) */

		i__2 = *n - i__;
		klacgv_(&i__2, &a[i__ + (i__ + 1) * a_dim1], lda);
		klacgv_(&i__, &a[i__ + a_dim1], lda);
		i__2 = *n - i__;
		z__1.r = -1., z__1.i = -0.;
		kgemv_("No transpose", &i__2, &i__, &z__1, &y[i__ + 1 + 
			y_dim1], ldy, &a[i__ + a_dim1], lda, &c_b2, &a[i__ + (
			i__ + 1) * a_dim1], lda);
		klacgv_(&i__, &a[i__ + a_dim1], lda);
		i__2 = i__ - 1;
		klacgv_(&i__2, &x[i__ + x_dim1], ldx);
		i__2 = i__ - 1;
		i__3 = *n - i__;
		z__1.r = -1., z__1.i = -0.;
		kgemv_("Conjugate transpose", &i__2, &i__3, &z__1, &a[(i__ + 
...
/* Computing MIN */
		i__3 = i__ + 2;
		klarfg_(&i__2, &alpha, &a[i__ + f2cmin(i__3,*n) * a_dim1], lda, &
			taup[i__]);
		i__2 = i__;
		e[i__2] = alpha.r;
		i__2 = i__ + (i__ + 1) * a_dim1;
...
/*              Compute X(i+1:m,i) */
		...
		i__2 = *m - i__;
		i__3 = *n - i__;
		kgemv_("No transpose", &i__2, &i__3, &c_b2, &a[i__ + 1 + (i__ 
			+ 1) * a_dim1], lda, &a[i__ + (i__ + 1) * a_dim1], 
			lda, &c_b1, &x[i__ + 1 + i__ * x_dim1], &c__1);
		i__2 = *n - i__;
		kgemv_("Conjugate transpose", &i__2, &i__, &c_b2, &y[i__ + 1 
			+ y_dim1], ldy, &a[i__ + (i__ + 1) * a_dim1], lda, &
			c_b1, &x[i__ * x_dim1 + 1], &c__1);
		i__2 = *m - i__;
		z__1.r = -1., z__1.i = -0.;
		kgemv_("No transpose", &i__2, &i__, &z__1, &a[i__ + 1 + 
			a_dim1], lda, &x[i__ * x_dim1 + 1], &c__1, &c_b2, &x[
			i__ + 1 + i__ * x_dim1], &c__1);
		i__2 = i__ - 1;
		i__3 = *n - i__;
		kgemv_("No transpose", &i__2, &i__3, &c_b2, &a[(i__ + 1) * 
			a_dim1 + 1], lda, &a[i__ + (i__ + 1) * a_dim1], lda, &
			c_b1, &x[i__ * x_dim1 + 1], &c__1);
		i__2 = *m - i__;
		i__3 = i__ - 1;
		z__1.r = -1., z__1.i = -0.;
		kgemv_("No transpose", &i__2, &i__3, &z__1, &x[i__ + 1 + 
			x_dim1], ldx, &x[i__ * x_dim1 + 1], &c__1, &c_b2, &x[
			i__ + 1 + i__ * x_dim1], &c__1);
		i__2 = *m - i__;
		kscal_(&i__2, &taup[i__], &x[i__ + 1 + i__ * x_dim1], &c__1);
		i__2 = *n - i__;
		klacgv_(&i__2, &a[i__ + (i__ + 1) * a_dim1], lda);
	    }
/* L10: */
...
/*           Update A(i,i:n) */
	    ...
	    i__2 = *n - i__ + 1;
	    klacgv_(&i__2, &a[i__ + i__ * a_dim1], lda);
	    i__2 = i__ - 1;
	    klacgv_(&i__2, &a[i__ + a_dim1], lda);
	    i__2 = *n - i__ + 1;
	    i__3 = i__ - 1;
	    z__1.r = -1., z__1.i = -0.;
	    kgemv_("No transpose", &i__2, &i__3, &z__1, &y[i__ + y_dim1], ldy,
...
/*              Compute X(i+1:m,i) */
		...
		i__2 = *n - i__ + 1;
		i__3 = i__ - 1;
		kgemv_("Conjugate transpose", &i__2, &i__3, &c_b2, &y[i__ + 
		...
		i__2 = i__ - 1;
		i__3 = *n - i__ + 1;
		kgemv_("No transpose", &i__2, &i__3, &c_b2, &a[i__ * a_dim1 + 
...
/*              Update A(i+1:m,i) */
		...
		i__2 = *m - i__;
		z__1.r = -1., z__1.i = -0.;
		kgemv_("No transpose", &i__2, &i__, &z__1, &x[i__ + 1 + 
...
/*              Compute Y(i+1:n,i) */
		...
		kgemv_("No transpose", &i__2, &i__3, &z__1, &y[i__ + 1 + 
			...
			i__ + 1 + i__ * y_dim1], &c__1);
		i__2 = *m - i__;
		kgemv_("Conjugate transpose", &i__2, &i__, &c_b2, &x[i__ + 1 
			+ x_dim1], ldx, &a[i__ + 1 + i__ * a_dim1], &c__1, &
			c_b1, &y[i__ * y_dim1 + 1], &c__1);
		i__2 = *n - i__;
		z__1.r = -1., z__1.i = -0.;
		kgemv_("Conjugate transpose", &i__, &i__2, &z__1, &a[(i__ + 1)
