...
/*  ===================================================================== */
void  qgtcon_(char *norm, integer *n, quadreal *dl, 
	quadreal *d__, quadreal *du, quadreal *du2, integer *ipiv, 
	quadreal *anorm, quadreal *rcond, quadreal *work, integer *
	iwork, integer *info)
{
    ...
    extern void  qlacn2_(integer *, quadreal *, quadreal *,
	     integer *, quadreal *, integer *, integer *), xerbla_(char *, 
	    integer *);
    quadreal ainvnm;
    logical onenrm;
...
/*           Multiply by inv(U)*inv(L). */
	    ...
	    qgttrs_("No transpose", n, &c__1, &dl[1], &d__[1], &du[1], &du2[1]
		    , &ipiv[1], &work[1], n, info);
	} else {

/*           Multiply by inv(L**T)*inv(U**T). */

	    qgttrs_("Transpose", n, &c__1, &dl[1], &d__[1], &du[1], &du2[1], &
		    ipiv[1], &work[1], n, info);
	}
	goto L20;
    }
