...
/*  ===================================================================== */
void  wgglse_(integer *m, integer *n, integer *p, 
	quadcomplex *a, integer *lda, quadcomplex *b, integer *ldb, 
	quadcomplex *c__, quadcomplex *d__, quadcomplex *x, 
	quadcomplex *work, integer *lwork, integer *info)
{
    ...
    extern void  wgemv_(char *, integer *, integer *, 
	    ...
	    integer *, quadcomplex *, integer *), wtrmv_(char *, char *, 
	    char *, integer *, quadcomplex *, integer *, quadcomplex *, 
	    integer *), xerbla_(char *, integer *);
    extern integer ilaenv_(integer *, char *, char *, integer *, integer *, 
	    integer *, integer *, ftnlen, ftnlen);
    extern void  wggrqf_(integer *, integer *, integer *, 
    ...
    extern void  wunmqr_(char *, char *, integer *, integer *, 
	    ...
	    quadcomplex *, integer *, quadcomplex *, integer *, integer *), wunmrq_(char *, char *, integer *, integer *, 
	    integer *, quadcomplex *, integer *, quadcomplex *, 
...
/*     unitary. */
    ...
    i__1 = *lwork - *p - mn;
    wggrqf_(p, m, n, &b[b_offset], ldb, &work[1], &a[a_offset], lda, &work[*p 
...
/*                       ( c2 ) M+P-N */
    ...
    i__1 = f2cmax(1,*m);
    i__2 = *lwork - *p - mn;
    wunmqr_("Left", "Conjugate Transpose", m, &c__1, &mn, &a[a_offset], lda, &
...
/*     Solve T12*x2 = d for x2 */
    ...
    if (*p > 0) {
	wtrtrs_("Upper", "No transpose", "Non-unit", p, &c__1, &b[(*n - *p + 
...
/*        Put the solution in X */
	...
	wcopy_(p, &d__[1], &c__1, &x[*n - *p + 1], &c__1);

/*        Update c1 */

	i__1 = *n - *p;
	z__1.r = -1., z__1.i = -0.;
	wgemv_("No transpose", &i__1, p, &z__1, &a[(*n - *p + 1) * a_dim1 + 1]
...
/*     Solve R11*x1 = c1 for x1 */
	...
	i__1 = *n - *p;
	i__2 = *n - *p;
	wtrtrs_("Upper", "No transpose", "Non-unit", &i__1, &c__1, &a[
...
/*        Put the solutions in X */
	...
	i__1 = *n - *p;
	wcopy_(&i__1, &c__[1], &c__1, &x[1], &c__1);
    }
...
/*     Compute the residual vector: */
	...
	if (nr > 0) {
	    i__1 = *n - *m;
	    z__1.r = -1., z__1.i = -0.;
	    wgemv_("No transpose", &nr, &i__1, &z__1, &a[*n - *p + 1 + (*m + 
    ...
    if (nr > 0) {
	wtrmv_("Upper", "No transpose", "Non unit", &nr, &a[*n - *p + 1 + (*n 
		- *p + 1) * a_dim1], lda, &d__[1], &c__1);
	z__1.r = -1., z__1.i = -0.;
	waxpy_(&nr, &z__1, &d__[1], &c__1, &c__[*n - *p + 1], &c__1);
    }

/*     Backward transformation x = Q**H*x */

    i__1 = *lwork - *p - mn;
    wunmrq_("Left", "Conjugate Transpose", n, &c__1, p, &b[b_offset], ldb, &
