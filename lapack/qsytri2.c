...
/*  ===================================================================== */
void  qsytri2_(char *uplo, integer *n, quadreal *a, integer *
	lda, integer *ipiv, quadreal *work, integer *lwork, integer *info)
{
    ...
    /* Local variables */
    extern void  qsytri2x_(char *, integer *, quadreal *, 
    ...
    extern void  qsytri_(char *, integer *, quadreal *, 
...
/*     Quick return if possible */
    ...
    if (nbmax >= *n) {
	qsytri_(uplo, n, &a[a_offset], lda, &ipiv[1], &work[1], info);
    } else {
	qsytri2x_(uplo, n, &a[a_offset], lda, &ipiv[1], &work[1], &nbmax, 
		info);
    }
    return;
