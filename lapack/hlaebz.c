...
/* > \brief \b DLAEBZ computes the number of eigenvalues of a doublereal symmetric tridiagonal matrix which are less
...
/* > */
/*  ===================================================================== */
void  hlaebz_(integer *ijob, integer *nitmax, integer *n, 
	integer *mmax, integer *minp, integer *nbmin, halfreal *abstol, 
	halfreal *reltol, halfreal *pivmin, halfreal *d__, halfreal *
	e, halfreal *e2, integer *nval, halfreal *ab, halfreal *c__, 
	integer *mout, integer *nab, halfreal *work, integer *iwork, 
	integer *info)
{
