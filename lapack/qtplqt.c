...
/* > \verbatim */
/* > */
/* > DTPLQT computes a blocked LQ factorization of a doublereal */
...
/* > */
/*  ===================================================================== */
void  qtplqt_(integer *m, integer *n, integer *l, integer *mb, 
	quadreal *a, integer *lda, quadreal *b, integer *ldb, quadreal *
	t, integer *ldt, quadreal *work, integer *info)
{
...
/* Computing MIN */
	...
	qtplqt2_(&ib, &nb, &lb, &a[i__ + i__ * a_dim1], lda, &b[i__ + b_dim1],
...
/*     Update by applying H**T to B(I+IB:M,:) from the right */
	...
	if (i__ + ib <= *m) {
	    i__3 = *m - i__ - ib + 1;
	    i__4 = *m - i__ - ib + 1;
	    qtprfb_("R", "N", "F", "R", &i__3, &nb, &ib, &lb, &b[i__ + b_dim1]
