...
/*  ===================================================================== */
void  wgtrfs_(char *trans, integer *n, integer *nrhs, 
	...
	quadcomplex *work, quadreal *rwork, integer *info)
{
    ...
    quadreal safmin;
    extern void  xerbla_(char *, integer *), wlagtm_(
	    char *, integer *, integer *, quadreal *, quadcomplex *, 
...
/*        where op(A) = A, A**T, or A**H, depending on TRANS. */
	...
	wlagtm_(trans, n, &c__1, &c_b18, &dl[1], &d__[1], &du[1], &x[j * 
...
/*           Update solution and try again. */
	    ...
	    wgttrs_(trans, n, &c__1, &dlf[1], &df[1], &duf[1], &du2[1], &ipiv[
		    1], &work[1], n, info);
	    waxpy_(n, &c_b26, &work[1], &c__1, &x[j * x_dim1 + 1], &c__1);
	    lstres = berr[j];
	    ++count;
	    goto L20;
	}
...
/*              Multiply by diag(W)*inv(op(A)**H). */
		...
		wgttrs_(transt, n, &c__1, &dlf[1], &df[1], &duf[1], &du2[1], &
...
/* L90: */
		...
		wgttrs_(transn, n, &c__1, &dlf[1], &df[1], &duf[1], &du2[1], &
			ipiv[1], &work[1], n, info);
	    }
	    goto L70;
	}
