...
/*  ===================================================================== */
void  whbgv_(char *jobz, char *uplo, integer *n, integer *ka, 
	...
	quadcomplex *work, quadreal *rwork, integer *info)
{
    ...
    extern void  xerbla_(char *, integer *), qsterf_(
	    integer *, quadreal *, quadreal *, integer *), whbtrd_(char *,
    ...
    extern void  whbgst_(char *, char *, integer *, integer *, 
	    ...
	    integer *), wpbstf_(char *, integer *, integer *, 
	    quadcomplex *, integer *, integer *), wsteqr_(char *, 
...
/*     For eigenvalues only, call DSTERF.  For eigenvectors, call ZSTEQR. */
	...
	wsteqr_(jobz, n, &w[1], &rwork[inde], &z__[z_offset], ldz, &rwork[
		indwrk], info);
    }
    return;
