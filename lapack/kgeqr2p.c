...
/* > */
/*  ===================================================================== */
void  kgeqr2p_(integer *m, integer *n, halfcomplex *a, 
	integer *lda, halfcomplex *tau, halfcomplex *work, integer *info)
{
    ...
    extern void  klarf_(char *, integer *, integer *, 
	    ...
	    integer *, halfcomplex *), xerbla_(char *, integer *), klarfgp_(integer *, halfcomplex *, halfcomplex *, 
	    integer *, halfcomplex *);
...
/* Computing MIN */
	i__3 = i__ + 1;
	klarfgp_(&i__2, &a[i__ + i__ * a_dim1], &a[f2cmin(i__3,*m) + i__ * 
		a_dim1], &c__1, &tau[i__]);
	if (i__ < *n) {
...
/*           Apply H(i)**H to A(i:m,i+1:n) from the left */
	    ...
	    i__3 = *n - i__;
	    d_cnjg(&z__1, &tau[i__]);
	    klarf_("Left", &i__2, &i__3, &a[i__ + i__ * a_dim1], &c__1, &z__1,
