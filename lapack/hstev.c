...
/*  ===================================================================== */
void  hstev_(char *jobz, integer *n, halfreal *d__, 
	...
	integer *info)
{
    ...
    extern void  hsterf_(integer *, halfreal *, halfreal *,
	     integer *), hsteqr_(char *, integer *, halfreal *, halfreal *
...
/*     eigenvectors, call DSTEQR. */
	...
	hsteqr_("I", n, &d__[1], &e[1], &z__[z_offset], ldz, &work[1], info);
    }
