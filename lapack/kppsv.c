...
/* > */
/*  ===================================================================== */
void  kppsv_(char *uplo, integer *n, integer *nrhs, 
	halfcomplex *ap, halfcomplex *b, integer *ldb, integer *info)
{
    ...
    extern void  xerbla_(char *, integer *), kpptrf_(
	    char *, integer *, halfcomplex *, integer *), kpptrs_(
...
/*     Compute the Cholesky factorization A = U**H *U or A = L*L**H. */
    ...
    kpptrf_(uplo, n, &ap[1], info);
    if (*info == 0) {

/*        Solve the system A*X = B, overwriting B with X. */

	kpptrs_(uplo, n, nrhs, &ap[1], &b[b_offset], ldb, info);
