...
/*  ===================================================================== */
void  ksprfs_(char *uplo, integer *n, integer *nrhs, 
	...
	info)
{
    ...
    extern void  kcopy_(integer *, halfcomplex *, integer *, 
	    ...
	    halfcomplex *, integer *, halfcomplex *, integer *), kspmv_(
	    char *, integer *, halfcomplex *, halfcomplex *, 
	    halfcomplex *, integer *, halfcomplex *, halfcomplex *, 
	    integer *), klacn2_(integer *, halfcomplex *, 
	    halfcomplex *, halfreal *, integer *, integer *);
    extern halfreal hlamch_(char *);
    halfreal safmin;
    extern void  xerbla_(char *, integer *);
    halfreal lstres;
    extern void  ksptrs_(char *, integer *, integer *, 
...
/*        Compute residual R = B - A * X */
	...
	z__1.r = -1., z__1.i = -0.;
	kspmv_(uplo, n, &z__1, &ap[1], &x[j * x_dim1 + 1], &c__1, &c_b1, &
		work[1], &c__1);
...
/*           Update solution and try again. */
	    ...
	    ksptrs_(uplo, n, &c__1, &afp[1], &ipiv[1], &work[1], n, info);
