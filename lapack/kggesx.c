...
/*  ===================================================================== */
void  kggesx_(char *jobvsl, char *jobvsr, char *sort, L_fp 
	selctg, char *sense, integer *n, halfcomplex *a, integer *lda, 
	halfcomplex *b, integer *ldb, integer *sdim, halfcomplex *alpha, 
	halfcomplex *beta, halfcomplex *vsl, integer *ldvsl, 
	halfcomplex *vsr, integer *ldvsr, halfreal *rconde, halfreal *
	rcondv, halfcomplex *work, integer *lwork, halfreal *rwork, 
	integer *iwork, integer *liwork, logical *bwork, integer *info)
{
    ...
    integer minwrk;
    halfreal smlnum;
    extern void  khgeqz_(char *, char *, char *, integer *, 
	    integer *, integer *, halfcomplex *, integer *, halfcomplex *,
	     integer *, halfcomplex *, halfcomplex *, halfcomplex *, 
	    integer *, halfcomplex *, integer *, halfcomplex *, integer *,
	     halfreal *, integer *), klacpy_(char *,
	     integer *, integer *, halfcomplex *, integer *, halfcomplex *
	    , integer *), klaset_(char *, integer *, integer *, 
	    halfcomplex *, halfcomplex *, halfcomplex *, integer *);
    logical wantst, lquery, wantsv;
    extern void  ktgsen_(integer *, logical *, logical *, 
	    logical *, integer *, halfcomplex *, integer *, halfcomplex *,
	     integer *, halfcomplex *, halfcomplex *, halfcomplex *, 
	    integer *, halfcomplex *, integer *, integer *, halfreal *, 
...
/* Computing MAX */
	...
	work[1].r = (halfreal) lwrk, work[1].i = 0.;
	if (wantsn || *n == 0) {
	    liwmin = 1;
	} else {
	    liwmin = *n + 2;
...
/*     (Workspace: none needed) */
    ...
    kgghrd_(jobvsl, jobvsr, n, &ilo, &ihi, &a[a_offset], lda, &b[b_offset], 
...
/*                            otherwise, need 1 ) */
	...
	i__1 = *lwork - iwrk + 1;
	ktgsen_(&ijob, &ilvsl, &ilvsr, &bwork[1], n, &a[a_offset], lda, &b[
		b_offset], ldb, &alpha[1], &beta[1], &vsl[vsl_offset], ldvsl, 
