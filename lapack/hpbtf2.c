...
/* > \verbatim */
/* > */
/* > DPBTF2 computes the Cholesky factorization of a doublereal symmetric */
...
/* > */
/*  ===================================================================== */
void  hpbtf2_(char *uplo, integer *n, integer *kd, halfreal *
...
/* Computing MIN */
	    ...
	    if (kn > 0) {
		d__1 = 1. / ajj;
		hscal_(&kn, &d__1, &ab[*kd + (j + 1) * ab_dim1], &kld);
		hsyr_("Upper", &kn, &c_b8, &ab[*kd + (j + 1) * ab_dim1], &kld,
...
/* Computing MIN */
	    ...
	    if (kn > 0) {
		d__1 = 1. / ajj;
		hscal_(&kn, &d__1, &ab[j * ab_dim1 + 2], &c__1);
		hsyr_("Lower", &kn, &c_b8, &ab[j * ab_dim1 + 2], &c__1, &ab[(
			j + 1) * ab_dim1 + 1], &kld);
	    }
/* L20: */
	}
