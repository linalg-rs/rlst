...
/*  ===================================================================== */
void  qgbtrs_(char *trans, integer *n, integer *kl, integer *
	ku, integer *nrhs, quadreal *ab, integer *ldab, integer *ipiv, 
	quadreal *b, integer *ldb, integer *info)
{
    ...
    extern void  qgemv_(char *, integer *, integer *, 
	    ...
	    quadreal *, integer *, quadreal *, integer *), qtbsv_(char *, 
...
/* Computing MIN */
		...
		l = ipiv[j];
		if (l != j) {
		    qswap_(nrhs, &b[l + b_dim1], ldb, &b[j + b_dim1], ldb);
		}
		qger_(&lm, nrhs, &c_b7, &ab[kd + 1 + j * ab_dim1], &c__1, &b[
...
/*           Solve U*X = B, overwriting B with X. */
	    ...
	    i__2 = *kl + *ku;
	    qtbsv_("Upper", "No transpose", "Non-unit", n, &i__2, &ab[
...
/*           Solve U**T*X = B, overwriting B with X. */
	    ...
	    i__2 = *kl + *ku;
	    qtbsv_("Upper", "Transpose", "Non-unit", n, &i__2, &ab[ab_offset],
...
/* Computing MIN */
		i__1 = *kl, i__2 = *n - j;
		lm = f2cmin(i__1,i__2);
		qgemv_("Transpose", &lm, nrhs, &c_b7, &b[j + 1 + b_dim1], ldb,
