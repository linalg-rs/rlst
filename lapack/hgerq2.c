...
/* > \verbatim */
/* > */
/* > DGERQ2 computes an RQ factorization of a doublereal m by n matrix A: */
/* > A = R * Q. */
/* > \endverbatim */
...
/* > */
/*  ===================================================================== */
void  hgerq2_(integer *m, integer *n, halfreal *a, integer *
...
/*        A(m-k+i,1:n-k+i-1) */
	...
	i__1 = *n - k + i__;
	hlarfg_(&i__1, &a[*m - k + i__ + (*n - k + i__) * a_dim1], &a[*m - k 
...
/*        Apply H(i) to A(1:m-k+i-1,1:n-k+i) from the right */
	...
	i__1 = *m - k + i__ - 1;
	i__2 = *n - k + i__;
	hlarf_("Right", &i__1, &i__2, &a[*m - k + i__ + a_dim1], lda, &tau[
