...
/*  ===================================================================== */
void  hsptrs_(char *uplo, integer *n, integer *nrhs, 
	halfreal *ap, integer *ipiv, halfreal *b, integer *ldb, integer *
	info)
{
...
/*           stored in column K of A. */
	    ...
	    i__1 = k - 1;
	    hger_(&i__1, nrhs, &c_b7, &ap[kc], &c__1, &b[k + b_dim1], ldb, &b[
		    b_dim1 + 1], ldb);
...
/*           stored in columns K-1 and K of A. */
	    ...
	    hger_(&i__1, nrhs, &c_b7, &ap[kc], &c__1, &b[k + b_dim1], ldb, &b[
		    b_dim1 + 1], ldb);
	    i__1 = k - 2;
	    hger_(&i__1, nrhs, &c_b7, &ap[kc - (k - 1)], &c__1, &b[k - 1 + 
...
/*           stored in column K of A. */
	    ...
	    i__1 = k - 1;
	    hgemv_("Transpose", &i__1, nrhs, &c_b7, &b[b_offset], ldb, &ap[kc]
...
/*           stored in column K of A. */
	    ...
	    if (k < *n) {
		i__1 = *n - k;
		hger_(&i__1, nrhs, &c_b7, &ap[kc + 1], &c__1, &b[k + b_dim1], 
...
/*           stored in columns K and K+1 of A. */
	    ...
	    if (k < *n - 1) {
		i__1 = *n - k - 1;
		hger_(&i__1, nrhs, &c_b7, &ap[kc + 2], &c__1, &b[k + b_dim1], 
			ldb, &b[k + 2 + b_dim1], ldb);
		i__1 = *n - k - 1;
		hger_(&i__1, nrhs, &c_b7, &ap[kc + *n - k + 2], &c__1, &b[k + 
