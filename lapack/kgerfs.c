...
/*  ===================================================================== */
void  kgerfs_(char *trans, integer *n, integer *nrhs, 
	 ...
	 halfreal *rwork, integer *info)
{
    ...
    extern void  kgemv_(char *, integer *, integer *, 
	    ...
	    integer *, halfcomplex *, integer *), klacn2_(integer *, 
	    halfcomplex *, halfcomplex *, halfreal *, integer *, 
	    integer *);
...
/*        where op(A) = A, A**T, or A**H, depending on TRANS. */
	...
	z__1.r = -1., z__1.i = -0.;
	kgemv_(trans, n, n, &z__1, &a[a_offset], lda, &x[j * x_dim1 + 1], &
...
/*           Update solution and try again. */
	    ...
	    kgetrs_(trans, n, &c__1, &af[af_offset], ldaf, &ipiv[1], &work[1],
		     n, info);
...
/*              Multiply by diag(W)*inv(op(A)**H). */
		...
		kgetrs_(transt, n, &c__1, &af[af_offset], ldaf, &ipiv[1], &
			work[1], n, info);
		i__2 = *n;
		for (i__ = 1; i__ <= i__2; ++i__) {
		    i__3 = i__;
...
/* L120: */
		...
		kgetrs_(transn, n, &c__1, &af[af_offset], ldaf, &ipiv[1], &
			work[1], n, info);
	    }
	    goto L100;
	}
