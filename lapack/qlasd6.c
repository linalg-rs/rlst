...
/* > */
/*  ===================================================================== */
void  qlasd6_(integer *icompq, integer *nl, integer *nr, 
	integer *sqre, quadreal *d__, quadreal *vf, quadreal *vl, 
	quadreal *alpha, quadreal *beta, integer *idxq, integer *perm, 
	integer *givptr, integer *givcol, integer *ldgcol, quadreal *givnum,
	 integer *ldgnum, quadreal *poles, quadreal *difl, quadreal *
	difr, quadreal *z__, integer *k, quadreal *c__, quadreal *s, 
	quadreal *work, integer *iwork, integer *info)
{
    ...
    extern void  qcopy_(integer *, quadreal *, integer *, 
	    quadreal *, integer *), qlasd7_(integer *, integer *, integer *,
	     integer *, integer *, quadreal *, quadreal *, quadreal *, 
	    quadreal *, quadreal *, quadreal *, quadreal *, 
	    quadreal *, quadreal *, quadreal *, integer *, integer *, 
	    integer *, integer *, integer *, integer *, integer *, quadreal 
	    *, integer *, quadreal *, quadreal *, integer *), qlasd8_(
	    integer *, integer *, quadreal *, quadreal *, quadreal *, 
	    ...
	    integer *, integer *), qlamrg_(integer *, integer *, 
...
/* L10: */
    ...
    qlascl_("G", &c__0, &c__0, &orgnrm, &c_b7, &n, &c__1, &d__[1], &n, info);
    *alpha /= orgnrm;
    *beta /= orgnrm;

/*     Sort and Deflate singular values. */

    qlasd7_(icompq, nl, nr, sqre, k, &d__[1], &z__[1], &work[iw], &vf[1], &
...
/*     Solve Secular Equation, compute DIFL, DIFR, and update VF, VL. */
    ...
    qlasd8_(icompq, k, &d__[1], &z__[1], &vf[1], &vl[1], &difl[1], &difr[1], 
...
/*     Save the poles if ICOMPQ = 1. */
    ...
    if (*icompq == 1) {
	qcopy_(k, &d__[1], &c__1, &poles[poles_dim1 + 1], &c__1);
	qcopy_(k, &work[isigma], &c__1, &poles[(poles_dim1 << 1) + 1], &c__1);
    }

/*     Unscale. */

    qlascl_("G", &c__0, &c__0, &c_b7, &orgnrm, &n, &c__1, &d__[1], &n, info);

/*     Prepare the IDXQ sorting permutation. */

    n1 = *k;
    n2 = n - *k;
    qlamrg_(&n1, &n2, &d__[1], &c__1, &c_n1, &idxq[1]);
