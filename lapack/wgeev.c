...
/*  ===================================================================== */
void  wgeev_(char *jobvl, char *jobvr, integer *n, 
	quadcomplex *a, integer *lda, quadcomplex *w, quadcomplex *vl, 
	integer *ldvl, quadcomplex *vr, integer *ldvr, quadcomplex *work, 
	integer *lwork, quadreal *rwork, integer *info)
{
    ...
    extern void  whseqr_(char *, char *, integer *, integer *, 
	    ...
	    quadcomplex *, integer *, quadcomplex *, integer *, integer *), wunghr_(integer *, integer *, integer *, 
	    quadcomplex *, integer *, quadcomplex *, quadcomplex *, 
	    integer *, integer *);
...
/* Computing MAX */
		...
		whseqr_("E", "N", n, &c__1, n, &a[a_offset], lda, &w[1], &vr[
			vr_offset], ldvr, &work[1], &c_n1, info);
	    }
...
/*     (RWorkspace: need N) */
    ...
    ibal = 1;
    wgebal_("B", n, &a[a_offset], lda, &ilo, &ihi, &rwork[ibal], &ierr);
...
/*        (RWorkspace: none) */
	...
	iwrk = itau;
	i__1 = *lwork - iwrk + 1;
	whseqr_("E", "N", n, &ilo, &ihi, &a[a_offset], lda, &w[1], &vr[
		vr_offset], ldvr, &work[iwrk], &i__1, info);
    }
...
/*        (RWorkspace: need N) */
	...
	wgebak_("B", "L", n, &ilo, &ihi, &rwork[ibal], n, &vl[vl_offset], 
		ldvl, &ierr);
...
/*        (RWorkspace: need N) */
	...
	wgebak_("B", "R", n, &ilo, &ihi, &rwork[ibal], n, &vr[vr_offset], 
		ldvr, &ierr);
