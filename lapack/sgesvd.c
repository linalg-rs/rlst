...
/*  ===================================================================== */
void  sgesvd_(char *jobu, char *jobvt, integer *m, integer *n, 
	...
	integer *ldvt, real *work, integer *lwork, integer *info)
{
    ...
    integer bdspac;
    extern void  sgebrd_(integer *, integer *, real *, integer 
    ...
    integer lwork_sorgbr_p__, lwork_sorgbr_q__, lwork_sorglq_m__, 
