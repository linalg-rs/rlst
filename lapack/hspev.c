...
/* > doublereal symmetric matrix A in packed storage. */
/* > \endverbatim */
...
/*  ===================================================================== */
void  hspev_(char *jobz, char *uplo, integer *n, halfreal *
...
/*     DOPGTR to generate the orthogonal matrix, then call DSTEQR. */
	...
	indwrk = indtau + *n;
	hopgtr_(uplo, n, &ap[1], &work[indtau], &z__[z_offset], ldz, &work[
		indwrk], &iinfo);
