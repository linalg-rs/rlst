...
/*  ===================================================================== */
void  whpgv_(integer *itype, char *jobz, char *uplo, integer *
	n, quadcomplex *ap, quadcomplex *bp, quadreal *w, quadcomplex 
	*z__, integer *ldz, quadcomplex *work, quadreal *rwork, integer *
	info)
{
    ...
    char trans[1];
    logical upper;
    extern void  whpev_(char *, char *, integer *, 
    ...
    extern void  wtpmv_(char *, char *, char *, integer *, 
	    ...
	    char *, integer *), whpgst_(integer *, char *, integer *, 
	    quadcomplex *, quadcomplex *, integer *), wpptrf_(
	    char *, integer *, quadcomplex *, integer *);
...
/*     Transform problem to standard eigenvalue problem and solve. */
    ...
    whpev_(jobz, uplo, n, &ap[1], &w[1], &z__[z_offset], ldz, &work[1], &
	    rwork[1], info);
