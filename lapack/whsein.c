...
/* >          On exit, the doublereal parts of W may have been altered since */
...
/* > */
/*  ===================================================================== */
void  whsein_(char *side, char *eigsrc, char *initv, logical *
	select, integer *n, quadcomplex *h__, integer *ldh, quadcomplex *
	w, quadcomplex *vl, integer *ldvl, quadcomplex *vr, integer *ldvr,
	 integer *mm, integer *m, quadcomplex *work, quadreal *rwork, 
	integer *ifaill, integer *ifailr, integer *info)
{
    ...
    extern void  xerbla_(char *, integer *), wlaein_(
	    logical *, logical *, integer *, quadcomplex *, integer *, 
...
/*              has not ben computed before. */
		...
		i__2 = kr - kl + 1;
		hnorm = wlanhs_("I", &i__2, &h__[kl + kl * h_dim1], ldh, &
			rwork[1]);
		if (qisnan_(&hnorm)) {
		    *info = -6;
		    return;
...
/*              Compute left eigenvector. */
		...
		i__2 = *n - kl + 1;
		wlaein_(&c_false, &noinit, &i__2, &h__[kl + kl * h_dim1], ldh,
...
/*              Compute right eigenvector. */
		...
		wlaein_(&c_true, &noinit, &kr, &h__[h_offset], ldh, &wk, &vr[
