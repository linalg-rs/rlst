...
/* > \verbatim */
/* > */
/* > DORMR2 overwrites the general doublereal m by n matrix C with */
/* > */
...
/*  ===================================================================== */
void  qormr2_(char *side, char *trans, integer *m, integer *n, 
...
/*        Apply H(i) */
	...
	qlarf_(side, &mi, &ni, &a[i__ + a_dim1], lda, &tau[i__], &c__[
		c_offset], ldc, &work[1]);
