...
/* > \verbatim */
/* > */
/* > DORML2 overwrites the general doublereal m by n matrix C with */
/* > */
...
/*  ===================================================================== */
void  qorml2_(char *side, char *trans, integer *m, integer *n, 
...
/*        Apply H(i) */
	...
	a[i__ + i__ * a_dim1] = 1.;
	qlarf_(side, &mi, &ni, &a[i__ + i__ * a_dim1], lda, &tau[i__], &c__[
