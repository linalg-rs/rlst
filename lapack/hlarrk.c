...
/*  ===================================================================== */
void  hlarrk_(integer *n, integer *iw, halfreal *gl, 
	halfreal *gu, halfreal *d__, halfreal *e2, halfreal *pivmin, 
	halfreal *reltol, halfreal *w, halfreal *werr, integer *info)
{
    ...
    /* Local variables */
    integer i__, it;
    halfreal mid, eps, tmp1, tmp2, left, atoli, right;
    integer itmax;
    halfreal rtoli, tnorm;
