...
/*  ===================================================================== */
void  dsytri2x_(char *uplo, integer *n, doublereal *a, integer 
	*lda, integer *ipiv, doublereal *work, integer *nb, integer *info)
{
    ...
    /* Local variables */
    extern void  dsyswapr_(char *, integer *, doublereal *, 
    ...
    integer iinfo;
    extern void  dtrmm_(char *, char *, char *, char *, 
	    integer *, integer *, doublereal *, doublereal *, integer *, 
	    doublereal *, integer *);
    integer count;
    logical upper;
    doublereal u01_i_j__, u11_i_j__;
    extern void  xerbla_(char *, integer *), dtrtri_(
	    char *, char *, integer *, doublereal *, integer *, integer *), dsyconv_(char *, char *, integer *, doublereal *,
