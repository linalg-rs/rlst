...
/*  ===================================================================== */
void  qtrcon_(char *norm, char *uplo, char *diag, integer *n, 
	quadreal *a, integer *lda, quadreal *rcond, quadreal *work, 
...
/*     Compute the norm of the triangular matrix A. */
    ...
    anorm = qlantr_(norm, uplo, diag, n, n, &a[a_offset], lda, &work[1]);
...
/*              Multiply by inv(A). */
		...
		qlatrs_(uplo, "No transpose", diag, normin, n, &a[a_offset], 
			lda, &work[1], &scale, &work[(*n << 1) + 1], info);
	    } else {

/*              Multiply by inv(A**T). */

		qlatrs_(uplo, "Transpose", diag, normin, n, &a[a_offset], lda,
