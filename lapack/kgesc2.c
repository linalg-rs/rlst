...
/*  ===================================================================== */
void  kgesc2_(integer *n, halfcomplex *a, integer *lda, 
	halfcomplex *rhs, integer *ipiv, integer *jpiv, halfreal *scale)
{
...
/*     Apply permutations IPIV to RHS */
    ...
    i__1 = *n - 1;
    klaswp_(&c__1, &rhs[1], lda, &c__1, &i__1, &ipiv[1], &c__1);
...
/*     Apply permutations JPIV to the solution (RHS) */
    ...
    i__1 = *n - 1;
    klaswp_(&c__1, &rhs[1], lda, &c__1, &i__1, &jpiv[1], &c_n1);
    return;
