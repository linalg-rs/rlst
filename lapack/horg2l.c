...
/* > \verbatim */
/* > */
/* > DORG2L generates an m by n doublereal matrix Q with orthonormal columns, */
...
/*  ===================================================================== */
void  horg2l_(integer *m, integer *n, integer *k, halfreal *
...
/*        Apply H(i) to A(1:m-k+i,1:n-k+i) from the left */
	...
	i__2 = *m - *n + ii;
	i__3 = ii - 1;
	hlarf_("Left", &i__2, &i__3, &a[ii * a_dim1 + 1], &c__1, &tau[i__], &
		a[a_offset], lda, &work[1]);
	i__2 = *m - *n + ii - 1;
	d__1 = -tau[i__];
	hscal_(&i__2, &d__1, &a[ii * a_dim1 + 1], &c__1);
