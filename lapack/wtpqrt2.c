...
static quadcomplex c_b7 = {1.,0.};
static quadcomplex c_b13 = {0.,0.};
...
/* > */
/*  ===================================================================== */
void  wtpqrt2_(integer *m, integer *n, integer *l, 
	quadcomplex *a, integer *lda, quadcomplex *b, integer *ldb, 
	quadcomplex *t, integer *ldt, integer *info)
{
    ...
    extern void  wgerc_(integer *, integer *, quadcomplex *, 
	    ...
	    wtrmv_(char *, char *, char *, integer *, quadcomplex *, 
...
/*        Generate elementary reflector H(I) to annihilate B(:,I) */
	...
	p = *m - *l + f2cmin(*l,i__);
	i__2 = p + 1;
	wlarfg_(&i__2, &a[i__ + i__ * a_dim1], &b[i__ * b_dim1 + 1], &c__1, &
		t[i__ + t_dim1]);
	if (i__ < *n) {
...
/*           W(1:N-I) := C(I:M,I+1:N)**H * C(I:M,I) [use W = T(:,N)] */
	    ...
	    i__2 = *n - i__;
	    wgemv_("C", &p, &i__2, &c_b7, &b[(i__ + 1) * b_dim1 + 1], ldb, &b[
...
/*           C(I:M,I+1:N) = C(I:m,I+1:N) + alpha*C(I:M,I)*W(1:N-1)**H */
	    ...
	    i__2 = *n - i__;
	    wgerc_(&p, &i__2, &alpha, &b[i__ * b_dim1 + 1], &c__1, &t[*n * 
...
/*        Triangular part of B2 */
	...
	wtrmv_("U", "C", "N", &p, &b[mp + b_dim1], ldb, &t[i__ * t_dim1 + 1], 
		&c__1);

/*        Rectangular part of B2 */

	i__2 = i__ - 1 - p;
	wgemv_("C", l, &i__2, &alpha, &b[mp + np * b_dim1], ldb, &b[mp + i__ *
...
/*        B1 */
	...
	i__2 = *m - *l;
	i__3 = i__ - 1;
	wgemv_("C", &i__2, &i__3, &alpha, &b[b_offset], ldb, &b[i__ * b_dim1 
		+ 1], &c__1, &c_b7, &t[i__ * t_dim1 + 1], &c__1);

/*        T(1:I-1,I) := T(1:I-1,1:I-1) * T(1:I-1,I) */

	i__2 = i__ - 1;
	wtrmv_("U", "N", "N", &i__2, &t[t_offset], ldt, &t[i__ * t_dim1 + 1], 
		&c__1);
