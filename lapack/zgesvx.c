...
/*  ===================================================================== */
void  zgesvx_(char *fact, char *trans, integer *n, integer *
	...
	work, doublereal *rwork, integer *info)
{
    ...
    extern doublereal zlange_(char *, integer *, integer *, doublecomplex *, 
	    integer *, doublereal *);
    doublereal bignum;
    extern void  zlaqge_(integer *, integer *, doublecomplex *,
    ...
    logical colequ;
    doublereal rowcnd;
    extern void  zgeequ_(integer *, integer *, doublecomplex *,
	     integer *, doublereal *, doublereal *, doublereal *, doublereal *
	    , doublereal *, integer *);
    logical notran;
    extern void  zgerfs_(char *, integer *, integer *, 
    ...
    doublereal smlnum;
    extern void  zgetrs_(char *, integer *, integer *, 
