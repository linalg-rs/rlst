...
/* > */
/*  ===================================================================== */
void  zlaqr3_(logical *wantt, logical *wantz, integer *n, 
	...
	doublecomplex *work, integer *lwork)
{
    ...
    extern void  zlarf_(char *, integer *, integer *, 
    ...
    doublereal smlnum;
    extern void  ztrexc_(char *, integer *, doublecomplex *, 
	    integer *, doublecomplex *, integer *, integer *, integer *, 
	    integer *);
    integer lwkopt;
    extern void  zunmhr_(char *, char *, integer *, integer *, 
