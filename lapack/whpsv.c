...
/* > */
/*  ===================================================================== */
void  whpsv_(char *uplo, integer *n, integer *nrhs, 
	...
	integer *info)
{
    ...
    extern void  xerbla_(char *, integer *), whptrf_(
	    char *, integer *, quadcomplex *, integer *, integer *),
	     whptrs_(char *, integer *, integer *, quadcomplex *, integer *,
...
/*     Compute the factorization A = U*D*U**H or A = L*D*L**H. */
    ...
    whptrf_(uplo, n, &ap[1], &ipiv[1], info);
    if (*info == 0) {

/*        Solve the system A*X = B, overwriting B with X. */

	whptrs_(uplo, n, nrhs, &ap[1], &ipiv[1], &b[b_offset], ldb, info);
