...
/*  ===================================================================== */
void  hposvx_(char *fact, char *uplo, integer *n, integer *
	nrhs, halfreal *a, integer *lda, halfreal *af, integer *ldaf, 
	char *equed, halfreal *s, halfreal *b, integer *ldb, halfreal *
	x, integer *ldx, halfreal *rcond, halfreal *ferr, halfreal *
	berr, halfreal *work, integer *iwork, integer *info)
{
    ...
    halfreal bignum;
    extern void  hpocon_(char *, integer *, halfreal *, 
	    integer *, halfreal *, halfreal *, halfreal *, integer *, 
	    integer *);
    integer infequ;
    extern halfreal hlansy_(char *, char *, integer *, halfreal *, 
	    integer *, halfreal *);
    extern void  hlaqsy_(char *, integer *, halfreal *, 
	    integer *, halfreal *, halfreal *, halfreal *, char *), hpoequ_(integer *, halfreal *, integer *, 
	    halfreal *, halfreal *, halfreal *, integer *), hporfs_(
	    char *, integer *, integer *, halfreal *, integer *, halfreal 
	    *, integer *, halfreal *, integer *, halfreal *, integer *, 
	    halfreal *, halfreal *, halfreal *, integer *, integer *), hpotrf_(char *, integer *, halfreal *, integer *, 
	    integer *);
    halfreal smlnum;
    extern void  hpotrs_(char *, integer *, integer *, 
...
/*        Compute row and column scalings to equilibrate the matrix A. */
	...
	hpoequ_(n, &a[a_offset], lda, &s[1], &scond, &amax, &infequ);
	if (infequ == 0) {

/*           Equilibrate the matrix. */

	    hlaqsy_(uplo, n, &a[a_offset], lda, &s[1], &scond, &amax, equed);
	    rcequ = lsame_(equed, "Y");
	}
    }
...
/*        Compute the Cholesky factorization A = U**T *U or A = L*L**T. */
	...
	hlacpy_(uplo, n, n, &a[a_offset], lda, &af[af_offset], ldaf);
	hpotrf_(uplo, n, &af[af_offset], ldaf, info);
...
/*     Compute the norm of the matrix A. */
    ...
    anorm = hlansy_("1", uplo, n, &a[a_offset], lda, &work[1]);

/*     Compute the reciprocal of the condition number of A. */

    hpocon_(uplo, n, &af[af_offset], ldaf, &anorm, rcond, &work[1], &iwork[1],
	     info);

/*     Compute the solution matrix X. */

    hlacpy_("Full", n, nrhs, &b[b_offset], ldb, &x[x_offset], ldx);
    hpotrs_(uplo, n, nrhs, &af[af_offset], ldaf, &x[x_offset], ldx, info);

/*     Use iterative refinement to improve the computed solution and */
/*     compute error bounds and backward error estimates for it. */

    hporfs_(uplo, n, nrhs, &a[a_offset], lda, &af[af_offset], ldaf, &b[
