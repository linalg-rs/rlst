...
/*  ===================================================================== */
void  hormrq_(char *side, char *trans, integer *m, integer *n, 
	...
	c__, integer *ldc, halfreal *work, integer *lwork, integer *info)
{
    ...
    integer nbmin, iinfo;
    extern void  hormr2_(char *, char *, integer *, integer *, 
...
/*        Use unblocked code */
	...
	hormr2_(side, trans, m, n, k, &a[a_offset], lda, &tau[1], &c__[
...
/*           H = H(i+ib-1) . . . H(i+1) H(i) */
	    ...
	    i__4 = nq - *k + i__ + ib - 1;
	    hlarft_("Backward", "Rowwise", &i__4, &ib, &a[i__ + a_dim1], lda, 
...
/*           Apply H or H**T */
	    ...
	    hlarfb_(side, transt, "Backward", "Rowwise", &mi, &ni, &ib, &a[
