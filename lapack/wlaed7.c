...
/*  ===================================================================== */
void  wlaed7_(integer *n, integer *cutpnt, integer *qsiz, 
	integer *tlvls, integer *curlvl, integer *curpbm, quadreal *d__, 
	quadcomplex *q, integer *ldq, quadreal *rho, integer *indxq, 
	quadreal *qstore, integer *qptr, integer *prmptr, integer *perm, 
	integer *givptr, integer *givcol, quadreal *givnum, quadcomplex *
	work, quadreal *rwork, integer *iwork, integer *info)
{
...
/*     Sort and Deflate eigenvalues. */
    ...
    wlaed8_(&k, n, qsiz, &q[q_offset], ldq, &d__[1], rho, cutpnt, &rwork[iz], 
...
/*     Solve Secular Equation. */
    ...
    if (k != 0) {
	qlaed9_(&k, &c__1, &k, n, &d__[1], &rwork[iq], &k, rho, &rwork[idlmda]
		, &rwork[iw], &qstore[qptr[curr]], &k, info);
	wlacrm_(qsiz, &k, &work[1], qsiz, &qstore[qptr[curr]], &k, &q[
...
/*     Prepare the INDXQ sorting premutation. */
	...
	n1 = k;
	n2 = *n - k;
	qlamrg_(&n1, &n2, &d__[1], &c__1, &c_n1, &indxq[1]);
    } else {
