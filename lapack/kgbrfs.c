...
/*  ===================================================================== */
void  kgbrfs_(char *trans, integer *n, integer *kl, integer *
	ku, integer *nrhs, halfcomplex *ab, integer *ldab, halfcomplex *
	afb, integer *ldafb, integer *ipiv, halfcomplex *b, integer *ldb, 
	...
	halfcomplex *work, halfreal *rwork, integer *info)
{
    ...
    integer isave[3];
    extern void  kgbmv_(char *, integer *, integer *, integer *
...
/*        where op(A) = A, A**T, or A**H, depending on TRANS. */
	...
	z__1.r = -1., z__1.i = -0.;
	kgbmv_(trans, n, n, kl, ku, &z__1, &ab[ab_offset], ldab, &x[j * 
...
/*           Update solution and try again. */
	    ...
	    kgbtrs_(trans, n, kl, ku, &c__1, &afb[afb_offset], ldafb, &ipiv[1]
		    , &work[1], n, info);
...
/*              Multiply by diag(W)*inv(op(A)**H). */
		...
		kgbtrs_(transt, n, kl, ku, &c__1, &afb[afb_offset], ldafb, &
...
/* L120: */
		...
		kgbtrs_(transn, n, kl, ku, &c__1, &afb[afb_offset], ldafb, &
			ipiv[1], &work[1], n, info);
	    }
	    goto L100;
	}
