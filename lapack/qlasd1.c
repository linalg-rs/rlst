...
/* > */
/*  ===================================================================== */
void  qlasd1_(integer *nl, integer *nr, integer *sqre, 
	quadreal *d__, quadreal *alpha, quadreal *beta, quadreal *u, 
	integer *ldu, quadreal *vt, integer *ldvt, integer *idxq, integer *
	iwork, quadreal *work, integer *info)
{
    ...
    integer i__, k, m, n, n1, n2, iq, iz, iu2, ldq, idx, ldu2, ivt2, idxc, 
	    idxp, ldvt2;
    extern void  qlasd2_(integer *, integer *, integer *, 
	    ...
	    integer *, integer *, integer *, integer *, integer *), qlasd3_(
	    ...
	    integer *, integer *, quadreal *, integer *, integer *),
	     qlamrg_(integer *, integer *, quadreal *, integer *, integer *,
	     integer *);
    integer isigma;
...
/*     Deflate singular values. */
    ...
    qlasd2_(nl, nr, sqre, &k, &d__[1], &work[iz], alpha, beta, &u[u_offset], 
...
/*     Solve Secular Equation and update singular vectors. */
    ...
    ldq = k;
    qlasd3_(nl, nr, sqre, &k, &d__[1], &work[iq], &ldq, &work[isigma], &u[
