...
/*  ===================================================================== */
void  hlasq1_(integer *n, halfreal *d__, halfreal *e, 
	halfreal *work, integer *info)
{
    ...
    extern void  hlascl_(char *, integer *, integer *, 
	    ...
	    integer *, integer *);
    halfreal safmin;
    extern void  xerbla_(char *, integer *), hlasrt_(
	    char *, integer *, halfreal *, integer *);
...
/*  ===================================================================== */
	...
	*info = -1;
	...
	hlas2_(&d__[1], &e[1], &d__[2], &sigmn, &sigmx);
	d__[1] = sigmx;
	d__[2] = sigmn;
	return;
    }
...
/*     input data makes scaling by a power of the radix pointless). */
    ...
    hcopy_(n, &d__[1], &c__1, &work[1], &c__2);
    i__1 = *n - 1;
    hcopy_(&i__1, &e[1], &c__1, &work[2], &c__2);
    i__1 = (*n << 1) - 1;
    i__2 = (*n << 1) - 1;
    hlascl_("G", &c__0, &c__0, &sigmx, &scale, &i__1, &c__1, &work[1], &i__2, 
	    &iinfo);
...
/* L40: */
	...
	hlascl_("G", &c__0, &c__0, &scale, &sigmx, n, &c__1, &d__[1], n, &
		iinfo);
    } else if (*info == 2) {
...
/*     into D and E so the calling subroutine can try to finish */
	...
	hlascl_("G", &c__0, &c__0, &scale, &sigmx, n, &c__1, &d__[1], n, &
		iinfo);
	hlascl_("G", &c__0, &c__0, &scale, &sigmx, n, &c__1, &e[1], n, &iinfo);
    }
