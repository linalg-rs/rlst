...
/*  ===================================================================== */
void  zhpgvd_(integer *itype, char *jobz, char *uplo, integer *
	...
	info)
{
    ...
    logical lquery;
    extern void  zpptrf_(char *, integer *, doublecomplex *, 
	    integer *);
