...
/*  ===================================================================== */
void  qpbtrs_(char *uplo, integer *n, integer *kd, integer *
	nrhs, quadreal *ab, integer *ldab, quadreal *b, integer *ldb, 
	integer *info)
{
...
/*           Solve U**T *X = B, overwriting B with X. */
	    ...
	    qtbsv_("Upper", "Transpose", "Non-unit", n, kd, &ab[ab_offset], 
		    ldab, &b[j * b_dim1 + 1], &c__1);

/*           Solve U*X = B, overwriting B with X. */

	    qtbsv_("Upper", "No transpose", "Non-unit", n, kd, &ab[ab_offset],
		     ldab, &b[j * b_dim1 + 1], &c__1);
/* L10: */
	}
    } else {
...
/*           Solve L*X = B, overwriting B with X. */
	    ...
	    qtbsv_("Lower", "No transpose", "Non-unit", n, kd, &ab[ab_offset],
		     ldab, &b[j * b_dim1 + 1], &c__1);

/*           Solve L**T *X = B, overwriting B with X. */

	    qtbsv_("Lower", "Transpose", "Non-unit", n, kd, &ab[ab_offset], 
		    ldab, &b[j * b_dim1 + 1], &c__1);
/* L20: */
	}
    }
