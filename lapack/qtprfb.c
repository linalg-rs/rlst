...
/* > */
/*  ===================================================================== */
void  qtprfb_(char *side, char *trans, char *direct, char *
	storev, integer *m, integer *n, integer *k, integer *l, quadreal *v,
	 integer *ldv, quadreal *t, integer *ldt, quadreal *a, integer *
	lda, quadreal *b, integer *ldb, quadreal *work, integer *ldwork)
{
...
/* Computing MIN */
	...
	qtrmm_("L", "U", "T", "N", l, n, &c_b12, &v[mp + v_dim1], ldv, &work[
		work_offset], ldwork);
	i__1 = *m - *l;
	qgemm_("T", "N", l, n, &i__1, &c_b12, &v[v_offset], ldv, &b[b_offset],
		 ldb, &c_b12, &work[work_offset], ldwork);
	i__1 = *k - *l;
	qgemm_("T", "N", &i__1, n, m, &c_b12, &v[kp * v_dim1 + 1], ldv, &b[
	...
	qtrmm_("L", "U", trans, "N", k, n, &c_b12, &t[t_offset], ldt, &work[
		work_offset], ldwork);
	...
	i__1 = *m - *l;
	qgemm_("N", "N", &i__1, n, k, &c_b27, &v[v_offset], ldv, &work[
		work_offset], ldwork, &c_b12, &b[b_offset], ldb);
	i__1 = *k - *l;
	qgemm_("N", "N", l, n, &i__1, &c_b27, &v[mp + kp * v_dim1], ldv, &
		work[kp + work_dim1], ldwork, &c_b12, &b[mp + b_dim1], ldb);
	qtrmm_("L", "U", "N", "N", l, n, &c_b12, &v[mp + v_dim1], ldv, &work[
		work_offset], ldwork);
	i__1 = *n;
	for (j = 1; j <= i__1; ++j) {
	    i__2 = *l;
...
/* Computing MIN */
	...
	qtrmm_("R", "U", "N", "N", m, l, &c_b12, &v[np + v_dim1], ldv, &work[
		work_offset], ldwork);
	i__1 = *n - *l;
	qgemm_("N", "N", m, l, &i__1, &c_b12, &b[b_offset], ldb, &v[v_offset],
		 ldv, &c_b12, &work[work_offset], ldwork);
	i__1 = *k - *l;
	qgemm_("N", "N", m, &i__1, n, &c_b12, &b[b_offset], ldb, &v[kp * 
	...
	qtrmm_("R", "U", trans, "N", m, k, &c_b12, &t[t_offset], ldt, &work[
		work_offset], ldwork);
	...
	i__1 = *n - *l;
	qgemm_("N", "T", m, &i__1, k, &c_b27, &work[work_offset], ldwork, &v[
		v_offset], ldv, &c_b12, &b[b_offset], ldb);
	i__1 = *k - *l;
	qgemm_("N", "T", m, l, &i__1, &c_b27, &work[kp * work_dim1 + 1], 
		ldwork, &v[np + kp * v_dim1], ldv, &c_b12, &b[np * b_dim1 + 1]
		, ldb);
	qtrmm_("R", "U", "T", "N", m, l, &c_b12, &v[np + v_dim1], ldv, &work[
		work_offset], ldwork);
	i__1 = *l;
	for (j = 1; j <= i__1; ++j) {
	    i__2 = *m;
...
/* Computing MIN */
	...
	qtrmm_("L", "L", "T", "N", l, n, &c_b12, &v[kp * v_dim1 + 1], ldv, &
		work[kp + work_dim1], ldwork);
	i__1 = *m - *l;
	qgemm_("T", "N", l, n, &i__1, &c_b12, &v[mp + kp * v_dim1], ldv, &b[
		mp + b_dim1], ldb, &c_b12, &work[kp + work_dim1], ldwork);
	i__1 = *k - *l;
	qgemm_("T", "N", &i__1, n, m, &c_b12, &v[v_offset], ldv, &b[b_offset],
	...
	qtrmm_("L", "L", trans, "N", k, n, &c_b12, &t[t_offset], ldt, &work[
		work_offset], ldwork);
	...
	i__1 = *m - *l;
	qgemm_("N", "N", &i__1, n, k, &c_b27, &v[mp + v_dim1], ldv, &work[
		work_offset], ldwork, &c_b12, &b[mp + b_dim1], ldb);
	i__1 = *k - *l;
	qgemm_("N", "N", l, n, &i__1, &c_b27, &v[v_offset], ldv, &work[
		work_offset], ldwork, &c_b12, &b[b_offset], ldb);
	qtrmm_("L", "L", "N", "N", l, n, &c_b12, &v[kp * v_dim1 + 1], ldv, &
		work[kp + work_dim1], ldwork);
	i__1 = *n;
	for (j = 1; j <= i__1; ++j) {
	    i__2 = *l;
...
/* Computing MIN */
	...
	qtrmm_("R", "L", "N", "N", m, l, &c_b12, &v[kp * v_dim1 + 1], ldv, &
		work[kp * work_dim1 + 1], ldwork);
	i__1 = *n - *l;
	qgemm_("N", "N", m, l, &i__1, &c_b12, &b[np * b_dim1 + 1], ldb, &v[np 
		+ kp * v_dim1], ldv, &c_b12, &work[kp * work_dim1 + 1], 
		ldwork);
	i__1 = *k - *l;
	qgemm_("N", "N", m, &i__1, n, &c_b12, &b[b_offset], ldb, &v[v_offset],
	...
	qtrmm_("R", "L", trans, "N", m, k, &c_b12, &t[t_offset], ldt, &work[
		work_offset], ldwork);
	...
	i__1 = *k - *l;
	qgemm_("N", "T", m, l, &i__1, &c_b27, &work[work_offset], ldwork, &v[
		v_offset], ldv, &c_b12, &b[b_offset], ldb);
	qtrmm_("R", "L", "T", "N", m, l, &c_b12, &v[kp * v_dim1 + 1], ldv, &
		work[kp * work_dim1 + 1], ldwork);
	i__1 = *l;
	for (j = 1; j <= i__1; ++j) {
	    i__2 = *m;
...
/* Computing MIN */
	...
	qtrmm_("L", "L", "N", "N", l, n, &c_b12, &v[mp * v_dim1 + 1], ldv, &
		work[work_offset], ldb);
	i__1 = *m - *l;
	qgemm_("N", "N", l, n, &i__1, &c_b12, &v[v_offset], ldv, &b[b_offset],
		 ldb, &c_b12, &work[work_offset], ldwork);
	i__1 = *k - *l;
	qgemm_("N", "N", &i__1, n, m, &c_b12, &v[kp + v_dim1], ldv, &b[
		b_offset], ldb, &c_b20, &work[kp + work_dim1], ldwork);
	...
	i__1 = *m - *l;
	qgemm_("T", "N", &i__1, n, k, &c_b27, &v[v_offset], ldv, &work[
		work_offset], ldwork, &c_b12, &b[b_offset], ldb);
	i__1 = *k - *l;
	qgemm_("T", "N", l, n, &i__1, &c_b27, &v[kp + mp * v_dim1], ldv, &
		work[kp + work_dim1], ldwork, &c_b12, &b[mp + b_dim1], ldb);
	qtrmm_("L", "L", "T", "N", l, n, &c_b12, &v[mp * v_dim1 + 1], ldv, &
...
/* Computing MIN */
	...
	qtrmm_("R", "L", "T", "N", m, l, &c_b12, &v[np * v_dim1 + 1], ldv, &
		work[work_offset], ldwork);
	i__1 = *n - *l;
	qgemm_("N", "T", m, l, &i__1, &c_b12, &b[b_offset], ldb, &v[v_offset],
		 ldv, &c_b12, &work[work_offset], ldwork);
	i__1 = *k - *l;
	qgemm_("N", "T", m, &i__1, n, &c_b12, &b[b_offset], ldb, &v[kp + 
	...
	i__1 = *n - *l;
	qgemm_("N", "N", m, &i__1, k, &c_b27, &work[work_offset], ldwork, &v[
		v_offset], ldv, &c_b12, &b[b_offset], ldb);
	i__1 = *k - *l;
	qgemm_("N", "N", m, l, &i__1, &c_b27, &work[kp * work_dim1 + 1], 
		ldwork, &v[kp + np * v_dim1], ldv, &c_b12, &b[np * b_dim1 + 1]
		, ldb);
	qtrmm_("R", "L", "N", "N", m, l, &c_b12, &v[np * v_dim1 + 1], ldv, &
		work[work_offset], ldwork);
	i__1 = *l;
	for (j = 1; j <= i__1; ++j) {
	    i__2 = *m;
...
/* Computing MIN */
	...
	qtrmm_("L", "U", "N", "N", l, n, &c_b12, &v[kp + v_dim1], ldv, &work[
		kp + work_dim1], ldwork);
	i__1 = *m - *l;
	qgemm_("N", "N", l, n, &i__1, &c_b12, &v[kp + mp * v_dim1], ldv, &b[
		mp + b_dim1], ldb, &c_b12, &work[kp + work_dim1], ldwork);
	i__1 = *k - *l;
	qgemm_("N", "N", &i__1, n, m, &c_b12, &v[v_offset], ldv, &b[b_offset],
		 ldb, &c_b20, &work[work_offset], ldwork);
	...
	i__1 = *m - *l;
	qgemm_("T", "N", &i__1, n, k, &c_b27, &v[mp * v_dim1 + 1], ldv, &work[
		work_offset], ldwork, &c_b12, &b[mp + b_dim1], ldb);
	i__1 = *k - *l;
	qgemm_("T", "N", l, n, &i__1, &c_b27, &v[v_offset], ldv, &work[
		work_offset], ldwork, &c_b12, &b[b_offset], ldb);
	qtrmm_("L", "U", "T", "N", l, n, &c_b12, &v[kp + v_dim1], ldv, &work[
		kp + work_dim1], ldwork);
	i__1 = *n;
	for (j = 1; j <= i__1; ++j) {
	    i__2 = *l;
...
/* Computing MIN */
	...
	qtrmm_("R", "U", "T", "N", m, l, &c_b12, &v[kp + v_dim1], ldv, &work[
		kp * work_dim1 + 1], ldwork);
	i__1 = *n - *l;
	qgemm_("N", "T", m, l, &i__1, &c_b12, &b[np * b_dim1 + 1], ldb, &v[kp 
		+ np * v_dim1], ldv, &c_b12, &work[kp * work_dim1 + 1], 
		ldwork);
	i__1 = *k - *l;
	qgemm_("N", "T", m, &i__1, n, &c_b12, &b[b_offset], ldb, &v[v_offset],
		 ldv, &c_b20, &work[work_offset], ldwork);
	...
	i__1 = *k - *l;
	qgemm_("N", "N", m, l, &i__1, &c_b27, &work[work_offset], ldwork, &v[
		v_offset], ldv, &c_b12, &b[b_offset], ldb);
	qtrmm_("R", "U", "N", "N", m, l, &c_b12, &v[kp + v_dim1], ldv, &work[
		kp * work_dim1 + 1], ldwork);
	i__1 = *l;
	for (j = 1; j <= i__1; ++j) {
	    i__2 = *m;
