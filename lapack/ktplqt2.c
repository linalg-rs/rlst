...
/* > \brief \b ZTPLQT2 computes a LQ factorization of a doublereal or complex "triangular-pentagonal" matrix, which 
...
/* > */
/*  ===================================================================== */
void  ktplqt2_(integer *m, integer *n, integer *l, 
...
/*        Generate elementary reflector H(I) to annihilate B(I,:) */
	...
	p = *n - *l + f2cmin(*l,i__);
	i__2 = p + 1;
	klarfg_(&i__2, &a[i__ + i__ * a_dim1], &b[i__ + b_dim1], ldb, &t[i__ *
		 t_dim1 + 1]);
	i__2 = i__ * t_dim1 + 1;
...
/*           W(M-I:1) := C(I+1:M,I:N) * C(I,I:N) [use W = T(M,:)] */
	    ...
	    i__2 = *m - i__;
	    kgemv_("N", &i__2, &p, &c_b2, &b[i__ + 1 + b_dim1], ldb, &b[i__ + 
...
/*           C(I+1:M,I:N) = C(I+1:M,I:N) + alpha * C(I,I:N)*W(M-1:1)^H */
	    ...
	    kgerc_(&i__2, &p, &z__1, &t[*m + t_dim1], ldt, &b[i__ + b_dim1], 
...
/*        Triangular part of B2 */
	...
	ktrmv_("L", "N", "N", &p, &b[np * b_dim1 + 1], ldb, &t[i__ + t_dim1], 
		ldt);

/*        Rectangular part of B2 */

	i__2 = i__ - 1 - p;
	kgemv_("N", &i__2, l, &alpha, &b[mp + np * b_dim1], ldb, &b[i__ + np *
...
/*        B1 */
	...
	i__2 = i__ - 1;
	i__3 = *n - *l;
	kgemv_("N", &i__2, &i__3, &alpha, &b[b_offset], ldb, &b[i__ + b_dim1],
...
/*        T(1:I-1,I) := T(1:I-1,1:I-1) * T(I,1:I-1) */
	...
	i__2 = i__ - 1;
	ktrmv_("L", "C", "N", &i__2, &t[t_offset], ldt, &t[i__ + t_dim1], ldt);
	i__2 = i__ - 1;
	for (j = 1; j <= i__2; ++j) {
	    i__3 = i__ + j * t_dim1;
	    d_cnjg(&z__1, &t[i__ + j * t_dim1]);
