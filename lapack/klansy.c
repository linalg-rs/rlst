...
/*  ===================================================================== */
halfreal klansy_(char *norm, char *uplo, integer *n, halfcomplex *a, 
	integer *lda, halfreal *work)
{
...
/* L110: */
	    ...
	    for (j = 1; j <= i__1; ++j) {
		i__2 = *n - j;
		klassq_(&i__2, &a[j + 1 + j * a_dim1], &c__1, &scale, &sum);
/* L120: */
	    }
	}
	sum *= 2;
	i__1 = *lda + 1;
	klassq_(n, &a[a_offset], &i__1, &scale, &sum);
