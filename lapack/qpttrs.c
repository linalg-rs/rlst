...
/*  ===================================================================== */
void  qpttrs_(integer *n, integer *nrhs, quadreal *d__, 
	quadreal *e, quadreal *b, integer *ldb, integer *info)
{
    ...
    /* Local variables */
    integer j, jb, nb;
    extern void  qptts2_(integer *, integer *, quadreal *, 
...
/* Computing MAX */
    ...
    if (nb >= *nrhs) {
	qptts2_(n, nrhs, &d__[1], &e[1], &b[b_offset], ldb);
    } else {
	i__1 = *nrhs;
	i__2 = nb;
...
/* Computing MIN */
	    i__3 = *nrhs - j + 1;
	    jb = f2cmin(i__3,nb);
	    qptts2_(n, &jb, &d__[1], &e[1], &b[j * b_dim1 + 1], ldb);
/* L10: */
	}
    }
