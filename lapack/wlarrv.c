...
/*  ===================================================================== */
void  wlarrv_(integer *n, quadreal *vl, quadreal *vu, 
	...
	integer *iwork, integer *info)
{
    ...
    logical stp2ii;
    extern void  wlar1v_(integer *, integer *, integer *, 
	    quadreal *, quadreal *, quadreal *, quadreal *, 
	    quadreal *, quadreal *, quadreal *, quadcomplex *, 
	    logical *, integer *, quadreal *, quadreal *, integer *, 
...
/*     The width of the part of Z that is used */
    ...
    wlaset_("Full", n, &zusedw, &c_b1, &c_b1, &z__[zusedl * z_dim1 + 1], ldz);
...
/*                 Set the corresponding entries in Z to zero */
		    wlaset_("Full", &in, &c__2, &c_b1, &c_b1, &z__[ibegin + j 
			    * z_dim1], ldz);
		}
...
/*                    Given LAMBDA, compute the eigenvector. */
			L__1 = ! usedbs;
			wlar1v_(&in, &c__1, &in, &lambda, &d__[ibegin], &l[
...
/*                          improve error angle by second step */
				L__1 = ! usedbs;
				wlar1v_(&in, &c__1, &in, &lambda, &d__[ibegin]
...
/* L123: */
			...
			i__4 = zto - zfrom + 1;
			wqscal_(&i__4, &nrminv, &z__[zfrom + windex * z_dim1],
				 &c__1);
L125:
/*                    Update W */
