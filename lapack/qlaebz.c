...
/* > */
/*  ===================================================================== */
void  qlaebz_(integer *ijob, integer *nitmax, integer *n, 
	integer *mmax, integer *minp, integer *nbmin, quadreal *abstol, 
	quadreal *reltol, quadreal *pivmin, quadreal *d__, quadreal *
	e, quadreal *e2, integer *nval, quadreal *ab, quadreal *c__, 
	integer *mout, integer *nab, quadreal *work, integer *iwork, 
	integer *info)
{
