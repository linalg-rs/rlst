...
/* > of a doublereal symmetric matrix A in packed storage.  Eigenvalues/vectors */
...
/*  ===================================================================== */
void  hspevx_(char *jobz, char *range, char *uplo, integer *n, 
	halfreal *ap, halfreal *vl, halfreal *vu, integer *il, integer *
	iu, halfreal *abstol, integer *m, halfreal *w, halfreal *z__, 
	...
	integer *info)
{
    ...
    integer indwrk;
    extern void  hopgtr_(char *, integer *, halfreal *, 
	    halfreal *, halfreal *, integer *, halfreal *, integer *), hsptrd_(char *, integer *, halfreal *, halfreal *, 
	    halfreal *, halfreal *, integer *), hsteqr_(char *, 
	    integer *, halfreal *, halfreal *, halfreal *, integer *, 
	    halfreal *, integer *), hopmtr_(char *, char *, char *, 
...
/*     Scale matrix to allowable range, if necessary. */
    ...
    anrm = hlansp_("M", uplo, n, &ap[1], &work[1]);
    if (anrm > 0. && anrm < rmin) {
	iscale = 1;
	sigma = rmin / anrm;
    } else if (anrm > rmax) {
...
/*     Call DSPTRD to reduce symmetric packed matrix to tridiagonal form. */
    ...
    indd = inde + *n;
    indwrk = indd + *n;
    hsptrd_(uplo, n, &ap[1], &work[indd], &work[inde], &work[indtau], &iinfo);
...
/*     for some eigenvalue, then try DSTEBZ. */
	...
	if (! wantz) {
	    ...
	    hopgtr_(uplo, n, &ap[1], &work[indtau], &z__[z_offset], ldz, &
		    work[indwrk], &iinfo);
	    i__1 = *n - 1;
	    hcopy_(&i__1, &work[inde], &c__1, &work[indee], &c__1);
...
/*        form to eigenvectors returned by DSTEIN. */
	...
	hopmtr_("L", uplo, "N", n, m, &ap[1], &work[indtau], &z__[z_offset], 
