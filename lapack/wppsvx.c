...
/* > */
/*  ===================================================================== */
void  wppsvx_(char *fact, char *uplo, integer *n, integer *
	nrhs, quadcomplex *ap, quadcomplex *afp, char *equed, quadreal *
	s, quadcomplex *b, integer *ldb, quadcomplex *x, integer *ldx, 
	...
	work, quadreal *rwork, integer *info)
{
    ...
    quadreal bignum;
    integer infequ;
    extern quadreal wlanhp_(char *, char *, integer *, quadcomplex *, 
	    quadreal *);
    extern void  wlaqhp_(char *, integer *, quadcomplex *, 
	    quadreal *, quadreal *, quadreal *, char *),
	     wlacpy_(char *, integer *, integer *, quadcomplex *, integer *,
	     quadcomplex *, integer *), wppcon_(char *, integer *, 
	    quadcomplex *, quadreal *, quadreal *, quadcomplex *, 
	    quadreal *, integer *);
    quadreal smlnum;
    extern void  wppequ_(char *, integer *, quadcomplex *, 
	    quadreal *, quadreal *, quadreal *, integer *), 
	    wpprfs_(char *, integer *, integer *, quadcomplex *, 
	    quadcomplex *, quadcomplex *, integer *, quadcomplex *, 
	    integer *, quadreal *, quadreal *, quadcomplex *, 
	    quadreal *, integer *), wpptrf_(char *, integer *, 
	    quadcomplex *, integer *), wpptrs_(char *, integer *, 
...
/*        Compute row and column scalings to equilibrate the matrix A. */
	...
	wppequ_(uplo, n, &ap[1], &s[1], &scond, &amax, &infequ);
	if (infequ == 0) {

/*           Equilibrate the matrix. */

	    wlaqhp_(uplo, n, &ap[1], &s[1], &scond, &amax, equed);
	    rcequ = lsame_(equed, "Y");
	}
    }
...
/*        Compute the Cholesky factorization A = U**H * U or A = L * L**H. */
	...
	i__1 = *n * (*n + 1) / 2;
	wcopy_(&i__1, &ap[1], &c__1, &afp[1], &c__1);
	wpptrf_(uplo, n, &afp[1], info);
...
/*     Compute the norm of the matrix A. */
    ...
    anorm = wlanhp_("I", uplo, n, &ap[1], &rwork[1]);

/*     Compute the reciprocal of the condition number of A. */

    wppcon_(uplo, n, &afp[1], &anorm, rcond, &work[1], &rwork[1], info);

/*     Compute the solution matrix X. */

    wlacpy_("Full", n, nrhs, &b[b_offset], ldb, &x[x_offset], ldx);
    wpptrs_(uplo, n, nrhs, &afp[1], &x[x_offset], ldx, info);

/*     Use iterative refinement to improve the computed solution and */
/*     compute error bounds and backward error estimates for it. */

    wpprfs_(uplo, n, nrhs, &ap[1], &afp[1], &b[b_offset], ldb, &x[x_offset], 
