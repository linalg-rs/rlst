...
/*  ===================================================================== */
void  kgbequb_(integer *m, integer *n, integer *kl, integer *
	ku, halfcomplex *ab, integer *ldab, halfreal *r__, halfreal *
	c__, halfreal *rowcnd, halfreal *colcnd, halfreal *amax, 
	integer *info)
{
