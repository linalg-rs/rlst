...
/* > */
/*  ===================================================================== */
void  ktplqt_(integer *m, integer *n, integer *l, integer *mb, 
	...
	halfcomplex *t, integer *ldt, halfcomplex *work, integer *info)
{
    ...
    extern void  xerbla_(char *, integer *), ktprfb_(
	    ...
	    halfcomplex *, integer *), 
	    ktplqt2_(integer *, integer *, integer *, halfcomplex *, 
	    integer *, halfcomplex *, integer *, halfcomplex *, integer *,
	     integer *);
...
/* Computing MIN */
	...
	ktplqt2_(&ib, &nb, &lb, &a[i__ + i__ * a_dim1], lda, &b[i__ + b_dim1],
...
/*     Update by applying H**T to B(I+IB:M,:) from the right */
	...
	if (i__ + ib <= *m) {
	    i__3 = *m - i__ - ib + 1;
	    i__4 = *m - i__ - ib + 1;
	    ktprfb_("R", "N", "F", "R", &i__3, &nb, &ib, &lb, &b[i__ + b_dim1]
