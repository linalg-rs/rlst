...
/* > */
/*  ===================================================================== */
void  wlaqr4_(logical *wantt, logical *wantz, integer *n, 
	...
	integer *ldz, quadcomplex *work, integer *lwork, integer *info)
{
    ...
    extern void  wlaqr2_(logical *, logical *, integer *, 
	    ...
	    , quadcomplex *, integer *), wlaqr5_(logical *, logical *, 
...
/*        ==== Workspace query call to ZLAQR2 ==== */
	...
	i__1 = nwr + 1;
	wlaqr2_(wantt, wantz, n, ilo, ihi, &i__1, &h__[h_offset], ldh, iloz, 
...
/*           ==== Aggressive early deflation ==== */
	    ...
	    wlaqr2_(wantt, wantz, n, &ktop, &kbot, &nw, &h__[h_offset], ldh, 
...
/*                 .    to fit an NS-by-NS scratch array.) ==== */
			...
			wlacpy_("A", &ns, &ns, &h__[ks + ks * h_dim1], ldh, &
				h__[kt + h_dim1], ldh);
			wlahqr_(&c_false, &c_false, &ns, &c__1, &ns, &h__[kt 
