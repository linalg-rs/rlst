...
/*  ===================================================================== */
void  sgbsvx_(char *fact, char *trans, integer *n, integer *kl,
	 ...
	 real *berr, real *work, integer *iwork, integer *info)
{
    ...
    extern void  slaqgb_(integer *, integer *, integer *, 
	    integer *, real *, integer *, real *, real *, real *, real *, 
	    real *, char *);
    logical nofact;
    extern void  sgbcon_(char *, integer *, integer *, integer 
	    *, real *, integer *, integer *, real *, real *, real *, integer *
	    , integer *), xerbla_(char *, integer *);
    real bignum;
    extern real slantb_(char *, char *, char *, integer *, integer *, real *, 
	    integer *, real *);
    extern void  sgbequ_(integer *, integer *, integer *, 
	    integer *, real *, integer *, real *, real *, real *, real *, 
	    real *, integer *);
    integer infequ;
    logical colequ;
    extern void  sgbrfs_(char *, integer *, integer *, integer 
    ...
    real rowcnd;
    logical notran;
    extern void  sgbtrs_(char *, integer *, integer *, integer 
