...
/*  ===================================================================== */
void  hlarrj_(integer *n, halfreal *d__, halfreal *e2, 
	integer *ifirst, integer *ilast, halfreal *rtol, integer *offset, 
	halfreal *w, halfreal *werr, halfreal *work, integer *iwork, 
	halfreal *pivmin, halfreal *spdiam, integer *info)
{
