...
/*  ===================================================================== */
void  wlaesy_(quadcomplex *a, quadcomplex *b, 
	quadcomplex *c__, quadcomplex *rt1, quadcomplex *rt2, 
	quadcomplex *evscal, quadcomplex *cs1, quadcomplex *sn1)
{
