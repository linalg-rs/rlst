...
/*           stored in column K of A. */
	    ...
	    i__1 = k - 1;
	    qger_(&i__1, nrhs, &c_b7, &a[k * a_dim1 + 1], &c__1, &b[k + 
...
/*           stored in columns K-1 and K of A. */
		...
		qger_(&i__1, nrhs, &c_b7, &a[k * a_dim1 + 1], &c__1, &b[k + 
			b_dim1], ldb, &b[b_dim1 + 1], ldb);
		i__1 = k - 2;
		qger_(&i__1, nrhs, &c_b7, &a[(k - 1) * a_dim1 + 1], &c__1, &b[
...
/*           stored in column K of A. */
	    ...
	    if (k > 1) {
		i__1 = k - 1;
		qgemv_("Transpose", &i__1, nrhs, &c_b7, &b[b_offset], ldb, &a[
...
/*           stored in column K of A. */
	    ...
	    if (k < *n) {
		i__1 = *n - k;
		qger_(&i__1, nrhs, &c_b7, &a[k + 1 + k * a_dim1], &c__1, &b[k 
...
/*           stored in columns K and K+1 of A. */
	    ...
	    if (k < *n - 1) {
		i__1 = *n - k - 1;
		qger_(&i__1, nrhs, &c_b7, &a[k + 2 + k * a_dim1], &c__1, &b[k 
			+ b_dim1], ldb, &b[k + 2 + b_dim1], ldb);
		i__1 = *n - k - 1;
		qger_(&i__1, nrhs, &c_b7, &a[k + 2 + (k + 1) * a_dim1], &c__1,
