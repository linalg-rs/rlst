...
/* > */
/*  ===================================================================== */
void  dgelsy_(integer *m, integer *n, integer *nrhs, 
	...
	lwork, integer *info)
{
    ...
    doublereal wsize;
    extern void  dgeqp3_(integer *, integer *, doublereal *, 
	    integer *, integer *, doublereal *, doublereal *, integer *, 
    ...
    extern void  dormrz_(char *, char *, integer *, integer *, 
	    integer *, integer *, doublereal *, integer *, doublereal *, 
	    doublereal *, integer *, doublereal *, integer *, integer *);
    integer lwkopt;
    logical lquery;
    extern void  dtzrzf_(integer *, integer *, doublereal *, 
