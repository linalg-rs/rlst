...
/*  ===================================================================== */
void  wlalsa_(integer *icompq, integer *smlsiz, integer *n, 
	integer *nrhs, quadcomplex *b, integer *ldb, quadcomplex *bx, 
	integer *ldbx, quadreal *u, integer *ldu, quadreal *vt, integer *
	k, quadreal *difl, quadreal *difr, quadreal *z__, quadreal *
	...
	rwork, integer *iwork, integer *info)
{
    ...
    extern void  wcopy_(integer *, quadcomplex *, integer *, 
	    quadcomplex *, integer *), wlals0_(integer *, integer *, 
	    ...
	    quadreal *, quadreal *, integer *, quadreal *, quadreal *,
	     quadreal *, integer *), qlasdt_(integer *, integer *, integer *
...
/* L20: */
	...
	qgemm_("T", "N", &nl, nrhs, &nl, &c_b9, &u[nlf + u_dim1], ldu, &rwork[
...
/* L80: */
	...
	qgemm_("T", "N", &nr, nrhs, &nr, &c_b9, &u[nrf + u_dim1], ldu, &rwork[
...
/*     in the bidiagonal matrix to BX. */
	...
	wcopy_(nrhs, &b[ic + b_dim1], ldb, &bx[ic + bx_dim1], ldbx);
/* L140: */
    }
...
/*        the current level LVL */
	...
	for (i__ = lf; i__ <= i__1; ++i__) {
	    ...
	    nrf = ic + 1;
	    --j;
	    wlals0_(icompq, &nl, &nr, &sqre, nrhs, &bx[nlf + bx_dim1], ldbx, &
...
/*        the current level LVL. */
	...
	for (i__ = ll; i__ >= i__2; --i__) {
	    ...
	    ++j;
	    wlals0_(icompq, &nl, &nr, &sqre, nrhs, &b[nlf + b_dim1], ldb, &bx[
...
/*        performed in two steps (doublereal and imaginary parts). */
...
/* L210: */
	...
	qgemm_("T", "N", &nlp1, nrhs, &nlp1, &c_b9, &vt[nlf + vt_dim1], ldu, &
...
/* L270: */
	...
	qgemm_("T", "N", &nrp1, nrhs, &nrp1, &c_b9, &vt[nrf + vt_dim1], ldu, &
