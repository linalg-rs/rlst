...
/*  ===================================================================== */
void  wunmtr_(char *side, char *uplo, char *trans, integer *m, 
	integer *n, quadcomplex *a, integer *lda, quadcomplex *tau, 
	 ...
	 integer *info)
{
    ...
    integer lwkopt;
    logical lquery;
    extern void  wunmql_(char *, char *, integer *, integer *, 
...
/*        Q was determined by a call to ZHETRD with UPLO = 'U' */
	...
	i__2 = nq - 1;
	wunmql_(side, trans, &mi, &ni, &i__2, &a[(a_dim1 << 1) + 1], lda, &
...
/*        Q was determined by a call to ZHETRD with UPLO = 'L' */
	...
	i__2 = nq - 1;
	wunmqr_(side, trans, &mi, &ni, &i__2, &a[a_dim1 + 2], lda, &tau[1], &
