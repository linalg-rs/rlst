...
/* > \verbatim */
/* > */
/* > DLARFGP generates a doublereal elementary reflector H of order n, such */
/* > that */
/* > */
...
/* > an (n-1)-element doublereal vector.  H is represented in the form */
/* > */
/* >       H = I - tau * ( 1 ) * ( 1 v**T ) , */
/* >                     ( v ) */
/* > */
/* > where tau is a doublereal scalar and v is a doublereal (n-1)-element */
/* > vector. */
/* > */
...
/*  ===================================================================== */
void  hlarfgp_(integer *n, halfreal *alpha, halfreal *x, 
	integer *incx, halfreal *tau)
{
...
/*        general case */
	...
	d__1 = hlapy2_(alpha, &xnorm);
	beta = d_sign(&d__1, alpha);
	smlnum = hlamch_("S") / hlamch_("E");
	knt = 0;
	if (abs(beta) < smlnum) {
