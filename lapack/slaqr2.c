...
/* > */
/*  ===================================================================== */
void  slaqr2_(logical *wantt, logical *wantz, integer *n, 
	...
	work, integer *lwork)
{
    ...
    logical bulge;
    extern void  slarf_(char *, integer *, integer *, real *, 
    ...
    extern void  scopy_(integer *, real *, integer *, real *, 
	    integer *);
    integer kwtop;
    extern void  slanv2_(real *, real *, real *, real *, real *
	    , real *, real *, real *, real *, real *), slabad_(real *, real *)
	    ;
    extern real slamch_(char *);
    extern void  sgehrd_(integer *, integer *, integer *, real 
	    *, integer *, real *, real *, integer *, integer *);
    real safmin;
    extern void  slarfg_(integer *, real *, real *, integer *, 
	    real *);
    real safmax;
    extern void  slahqr_(logical *, logical *, integer *, 
	    ...
	    real *, integer *);
    logical sorted;
    extern void  strexc_(char *, integer *, real *, integer *, 
...
/*           ==== Complex conjugate pair ==== */
	    ...
	    foo = (r__3 = t[*ns + *ns * t_dim1], abs(r__3)) + M(sqrt)((r__1 = t[*
		    ns + (*ns - 1) * t_dim1], abs(r__1))) * M(sqrt)((r__2 = t[*
...
L40:
	if (k <= kend) {
		...
		evi = (r__3 = t[i__ + i__ * t_dim1], abs(r__3)) + M(sqrt)((r__1 =
			 t[i__ + 1 + i__ * t_dim1], abs(r__1))) * M(sqrt)((r__2 =
		...
		evk = (r__3 = t[k + k * t_dim1], abs(r__3)) + M(sqrt)((r__1 = t[
			k + 1 + k * t_dim1], abs(r__1))) * M(sqrt)((r__2 = t[k + 
			(k + 1) * t_dim1], abs(r__2)));
	    }
