...
/*  ===================================================================== */
void  hporfs_(char *uplo, integer *n, integer *nrhs, 
	halfreal *a, integer *lda, halfreal *af, integer *ldaf, 
	...
	info)
{
    ...
    halfreal safmin;
    extern void  xerbla_(char *, integer *), hpotrs_(
...
/*           Update solution and try again. */
	    ...
	    hpotrs_(uplo, n, &c__1, &af[af_offset], ldaf, &work[*n + 1], n, 
		    info);
...
/*              Multiply by diag(W)*inv(A**T). */
		...
		hpotrs_(uplo, n, &c__1, &af[af_offset], ldaf, &work[*n + 1], 
			n, info);
		i__2 = *n;
		for (i__ = 1; i__ <= i__2; ++i__) {
