...
/* > */
/*  ===================================================================== */
void  dgghd3_(char *compq, char *compz, integer *n, integer *
	...
	ldz, doublereal *work, integer *lwork, integer *info)
{
    ...
    integer nbmin;
    extern void  dorm22_(char *, char *, integer *, integer *, 
	    integer *, integer *, doublereal *, integer *, doublereal *, 
	    integer *, doublereal *, integer *, integer *);
    integer nblst;
    logical initq, wantq;
    extern void  dtrmv_(char *, char *, char *, integer *, 
	    doublereal *, integer *, doublereal *, integer *);
    logical initz, wantz;
    char compq2[1], compz2[1];
    extern void  dgghrd_(char *, char *, integer *, integer *, 
	    integer *, doublereal *, integer *, doublereal *, integer *, 
	    doublereal *, integer *, doublereal *, integer *, integer *), dlaset_(char *, integer *, integer *, doublereal 
	    *, doublereal *, doublereal *, integer *), dlartg_(
