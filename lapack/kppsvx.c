...
/* > */
/*  ===================================================================== */
void  kppsvx_(char *fact, char *uplo, integer *n, integer *
	nrhs, halfcomplex *ap, halfcomplex *afp, char *equed, halfreal *
	s, halfcomplex *b, integer *ldb, halfcomplex *x, integer *ldx, 
	...
	work, halfreal *rwork, integer *info)
{
    ...
    extern halfreal klanhp_(char *, char *, integer *, halfcomplex *, 
	    halfreal *);
    extern void  klaqhp_(char *, integer *, halfcomplex *, 
	    halfreal *, halfreal *, halfreal *, char *),
	     klacpy_(char *, integer *, integer *, halfcomplex *, integer *,
	     halfcomplex *, integer *), kppcon_(char *, integer *, 
	    halfcomplex *, halfreal *, halfreal *, halfcomplex *, 
	    halfreal *, integer *);
    halfreal smlnum;
    extern void  kppequ_(char *, integer *, halfcomplex *, 
	    halfreal *, halfreal *, halfreal *, integer *), 
	    kpprfs_(char *, integer *, integer *, halfcomplex *, 
	    halfcomplex *, halfcomplex *, integer *, halfcomplex *, 
	    integer *, halfreal *, halfreal *, halfcomplex *, 
	    halfreal *, integer *), kpptrf_(char *, integer *, 
	    halfcomplex *, integer *), kpptrs_(char *, integer *, 
...
/*        Compute row and column scalings to equilibrate the matrix A. */
	...
	kppequ_(uplo, n, &ap[1], &s[1], &scond, &amax, &infequ);
	if (infequ == 0) {

/*           Equilibrate the matrix. */

	    klaqhp_(uplo, n, &ap[1], &s[1], &scond, &amax, equed);
	    rcequ = lsame_(equed, "Y");
	}
    }
...
/*        Compute the Cholesky factorization A = U**H * U or A = L * L**H. */
	...
	i__1 = *n * (*n + 1) / 2;
	kcopy_(&i__1, &ap[1], &c__1, &afp[1], &c__1);
	kpptrf_(uplo, n, &afp[1], info);
...
/*     Compute the norm of the matrix A. */
    ...
    anorm = klanhp_("I", uplo, n, &ap[1], &rwork[1]);

/*     Compute the reciprocal of the condition number of A. */

    kppcon_(uplo, n, &afp[1], &anorm, rcond, &work[1], &rwork[1], info);

/*     Compute the solution matrix X. */

    klacpy_("Full", n, nrhs, &b[b_offset], ldb, &x[x_offset], ldx);
    kpptrs_(uplo, n, nrhs, &afp[1], &x[x_offset], ldx, info);

/*     Use iterative refinement to improve the computed solution and */
/*     compute error bounds and backward error estimates for it. */

    kpprfs_(uplo, n, nrhs, &ap[1], &afp[1], &b[b_offset], ldb, &x[x_offset], 
