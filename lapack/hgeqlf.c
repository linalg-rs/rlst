...
/* > \verbatim */
/* > */
/* > DGEQLF computes a QL factorization of a doublereal M-by-N matrix A: */
/* > A = Q * L. */
/* > \endverbatim */
...
/* > */
/*  ===================================================================== */
void  hgeqlf_(integer *m, integer *n, halfreal *a, integer *
	lda, halfreal *tau, halfreal *work, integer *lwork, integer *info)
{
    ...
    extern void  hgeql2_(integer *, integer *, halfreal *, 
...
/*           A(1:m-k+i+ib-1,n-k+i:n-k+i+ib-1) */
	    ...
	    i__3 = *m - k + i__ + ib - 1;
	    hgeql2_(&i__3, &ib, &a[(*n - k + i__) * a_dim1 + 1], lda, &tau[
		    i__], &work[1], &iinfo);
	    if (*n - k + i__ > 1) {
...
/*              H = H(i+ib-1) . . . H(i+1) H(i) */
		...
		i__3 = *m - k + i__ + ib - 1;
		hlarft_("Backward", "Columnwise", &i__3, &ib, &a[(*n - k + 
...
/*              Apply H**T to A(1:m-k+i+ib-1,1:n-k+i-1) from the left */
		...
		i__3 = *m - k + i__ + ib - 1;
		i__4 = *n - k + i__ - 1;
		hlarfb_("Left", "Transpose", "Backward", "Columnwise", &i__3, 
...
/*     Use unblocked code to factor the last or only block */
    ...
    if (mu > 0 && nu > 0) {
	hgeql2_(&mu, &nu, &a[a_offset], lda, &tau[1], &work[1], &iinfo);
    }
