...
/* > \brief \b DLASYF_RK computes a partial factorization of a doublereal symmetric indefinite matrix using bounded 
...
/* > */
/* > \verbatim */
/* > DLASYF_RK computes a partial factorization of a doublereal symmetric */
...
/*  ===================================================================== */
void  dlasyf_rk__(char *uplo, integer *n, integer *nb, integer 
	*kb, halfreal *a, integer *lda, halfreal *e, integer *ipiv, 
	halfreal *w, integer *ldw, integer *info)
{
