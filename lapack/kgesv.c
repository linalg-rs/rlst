...
/*  ===================================================================== */
void  kgesv_(integer *n, integer *nrhs, halfcomplex *a, 
	integer *lda, integer *ipiv, halfcomplex *b, integer *ldb, integer *
	info)
{
    ...
    /* Local variables */
    extern void  xerbla_(char *, integer *), kgetrf_(
	    integer *, integer *, halfcomplex *, integer *, integer *, 
	    integer *), kgetrs_(char *, integer *, integer *, halfcomplex *,
	     integer *, integer *, halfcomplex *, integer *, integer *);
...
/*        Solve the system A*X = B, overwriting B with X. */
	...
	kgetrs_("No transpose", n, nrhs, &a[a_offset], lda, &ipiv[1], &b[
		b_offset], ldb, info);
    }
    return;
