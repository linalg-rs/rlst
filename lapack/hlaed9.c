...
/*  ===================================================================== */
void  hlaed9_(integer *k, integer *kstart, integer *kstop, 
	integer *n, halfreal *d__, halfreal *q, integer *ldq, halfreal *
	rho, halfreal *dlamda, halfreal *w, halfreal *s, integer *lds, 
	integer *info)
{
    ...
    extern void  hcopy_(integer *, halfreal *, integer *, 
	    halfreal *, integer *), hlaed4_(integer *, integer *, 
...
/*     Compute updated W. */
    ...
    hcopy_(k, &w[1], &c__1, &s[s_offset], &c__1);
...
/* L90: */
	...
	temp = hnrm2_(k, &q[j * q_dim1 + 1], &c__1);
	i__2 = *k;
	for (i__ = 1; i__ <= i__2; ++i__) {
