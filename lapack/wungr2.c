...
/*  ===================================================================== */
void  wungr2_(integer *m, integer *n, integer *k, 
	...
	work, integer *info)
{
    ...
    extern void  wscal_(integer *, quadcomplex *, 
	    ...
	    integer *, quadcomplex *), xerbla_(char *, integer *), wlacgv_(integer *, quadcomplex *, integer *);
...
/*        Apply H(i)**H to A(1:m-k+i,1:n-k+i) from the right */
	...
	i__2 = *n - *m + ii - 1;
	wlacgv_(&i__2, &a[ii + a_dim1], lda);
	i__2 = ii + (*n - *m + ii) * a_dim1;
	a[i__2].r = 1., a[i__2].i = 0.;
	i__2 = ii - 1;
	i__3 = *n - *m + ii;
	d_cnjg(&z__1, &tau[i__]);
	wlarf_("Right", &i__2, &i__3, &a[ii + a_dim1], lda, &z__1, &a[
		a_offset], lda, &work[1]);
	i__2 = *n - *m + ii - 1;
	i__3 = i__;
	z__1.r = -tau[i__3].r, z__1.i = -tau[i__3].i;
	wscal_(&i__2, &z__1, &a[ii + a_dim1], lda);
	i__2 = *n - *m + ii - 1;
	wlacgv_(&i__2, &a[ii + a_dim1], lda);
	i__2 = ii + (*n - *m + ii) * a_dim1;
	d_cnjg(&z__2, &tau[i__]);
