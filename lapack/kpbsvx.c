...
/* > */
/*  ===================================================================== */
void  kpbsvx_(char *fact, char *uplo, integer *n, integer *kd, 
	integer *nrhs, halfcomplex *ab, integer *ldab, halfcomplex *afb, 
	integer *ldafb, char *equed, halfreal *s, halfcomplex *b, integer 
	*ldb, halfcomplex *x, integer *ldx, halfreal *rcond, halfreal *
	ferr, halfreal *berr, halfcomplex *work, halfreal *rwork, 
	integer *info)
{
    ...
    halfreal bignum;
    extern void  klaqhb_(char *, integer *, integer *, 
	    halfcomplex *, integer *, halfreal *, halfreal *, 
	    halfreal *, char *);
    integer infequ;
    extern void  kpbcon_(char *, integer *, integer *, 
	    halfcomplex *, integer *, halfreal *, halfreal *, 
	    halfcomplex *, halfreal *, integer *), klacpy_(char *,
	     integer *, integer *, halfcomplex *, integer *, halfcomplex *
	    , integer *), kpbequ_(char *, integer *, integer *, 
	    halfcomplex *, integer *, halfreal *, halfreal *, 
	    halfreal *, integer *), kpbrfs_(char *, integer *, 
	    integer *, integer *, halfcomplex *, integer *, halfcomplex *,
	     integer *, halfcomplex *, integer *, halfcomplex *, integer *
	    , halfreal *, halfreal *, halfcomplex *, halfreal *, 
	    integer *), kpbtrf_(char *, integer *, integer *, 
	    halfcomplex *, integer *, integer *);
    halfreal smlnum;
    extern void  kpbtrs_(char *, integer *, integer *, integer 
...
/*        Compute row and column scalings to equilibrate the matrix A. */
	...
	kpbequ_(uplo, n, kd, &ab[ab_offset], ldab, &s[1], &scond, &amax, &
		infequ);
	if (infequ == 0) {

/*           Equilibrate the matrix. */

	    klaqhb_(uplo, n, kd, &ab[ab_offset], ldab, &s[1], &scond, &amax, 
		    equed);
	    rcequ = lsame_(equed, "Y");
	}
    }
...
/* Computing MAX */
		...
		j1 = f2cmax(i__2,1);
		i__2 = j - j1 + 1;
		kcopy_(&i__2, &ab[*kd + 1 - j + j1 + j * ab_dim1], &c__1, &
...
/* Computing MIN */
		...
		j2 = f2cmin(i__2,*n);
		i__2 = j2 - j + 1;
		kcopy_(&i__2, &ab[j * ab_dim1 + 1], &c__1, &afb[j * afb_dim1 
			+ 1], &c__1);
/* L50: */
	    }
	}

	kpbtrf_(uplo, n, kd, &afb[afb_offset], ldafb, info);
...
/*     Compute the norm of the matrix A. */
    ...
    anorm = klanhb_("1", uplo, n, kd, &ab[ab_offset], ldab, &rwork[1]);

/*     Compute the reciprocal of the condition number of A. */

    kpbcon_(uplo, n, kd, &afb[afb_offset], ldafb, &anorm, rcond, &work[1], &
	    rwork[1], info);

/*     Compute the solution matrix X. */

    klacpy_("Full", n, nrhs, &b[b_offset], ldb, &x[x_offset], ldx);
    kpbtrs_(uplo, n, kd, nrhs, &afb[afb_offset], ldafb, &x[x_offset], ldx, 
	    info);

/*     Use iterative refinement to improve the computed solution and */
/*     compute error bounds and backward error estimates for it. */

    kpbrfs_(uplo, n, kd, nrhs, &ab[ab_offset], ldab, &afb[afb_offset], ldafb, 
