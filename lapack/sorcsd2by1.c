...
/*  ===================================================================== */
void  sorcsd2by1_(char *jobu1, char *jobu2, char *jobv1t, 
	...
	integer *iwork, integer *info)
{
    ...
    extern void  sbbcsd_(char *, char *, char *, char *, char *
	    , integer *, integer *, integer *, real *, real *, real *, 
	    integer *, real *, integer *, real *, integer *, real *, integer *
	    , real *, real *, real *, real *, real *, real *, real *, real *, 
	    real *, integer *, integer *);
    integer iorbdb, lorbdb;
    extern void  xerbla_(char *, integer *), slacpy_(
	    char *, integer *, integer *, real *, integer *, real *, integer *
	    );
    integer iorglq;
    extern void  slapmr_(logical *, integer *, integer *, real 
	    *, integer *, integer *);
    integer lorglq;
    extern void  slapmt_(logical *, integer *, integer *, real 
	    *, integer *, integer *);
    ...
    extern void  sorglq_(integer *, integer *, integer *, real 
	    *, integer *, real *, real *, integer *, integer *), sorgqr_(
	    ...
	    , integer *, integer *);
    logical lquery;
    extern void  sorbdb1_(integer *, integer *, integer *, 
