...
/* > \brief \b ZROT applies a plane rotation with doublereal cosine and complex sine to a pair of complex vectors. 
*/
...
/* > \verbatim */
/* > */
/* > ZROT   applies a plane rotation, where the M(cos) (C) is doublereal and the */
/* > M(sin) (S) is complex, and the vectors CX and CY are complex. */
/* > \endverbatim */
...
/*  ===================================================================== */
void  krot_(integer *n, halfcomplex *cx, integer *incx, 
	halfcomplex *cy, integer *incy, halfreal *c__, halfcomplex *s)
{
