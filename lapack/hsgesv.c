...
/*  ===================================================================== */
void  hsgesv_(integer *n, integer *nrhs, halfreal *a, 
	integer *lda, integer *ipiv, halfreal *b, integer *ldb, halfreal *
	...
	integer *info)
{
    ...
    extern void  haxpy_(integer *, halfreal *, halfreal *, 
	    integer *, halfreal *, integer *), hlag2s_(integer *, integer *,
	     halfreal *, integer *, doublereal *, integer *, integer *), slag2d_(
	    integer *, integer *, doublereal *, integer *, halfreal *, integer *, 
	    integer *);
    ...
    extern void  hlacpy_(char *, integer *, integer *, 
	    ...
	    integer *), xerbla_(char *, integer *), hgetrs_(char *, 
	    integer *, integer *, halfreal *, integer *, integer *, 
	    halfreal *, integer *, integer *), sgetrf_(integer *, 
...
/*     Compute some constants. */
    ...
    anrm = hlange_("I", n, n, &a[a_offset], lda, &work[work_offset]);
    eps = hlamch_("Epsilon");
...
/*     result in SA. */
    ...
    hlag2s_(n, n, &a[a_offset], lda, &swork[ptsa], n, info);
...
/*     Compute R = B - AX (R is WORK). */
    ...
    hgemm_("No Transpose", "No Transpose", n, nrhs, n, &c_b10, &a[a_offset], 
...
/*        Compute R = B - AX (R is WORK). */
	...
	hgemm_("No Transpose", "No Transpose", n, nrhs, n, &c_b10, &a[
...
/*     satisfactory solution, so we resort to double precision. */
    ...
    hgetrf_(n, n, &a[a_offset], lda, &ipiv[1], info);
    ...
    hgetrs_("No transpose", n, nrhs, &a[a_offset], lda, &ipiv[1], &x[x_offset]
	    , ldx, info);
