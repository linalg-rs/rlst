...
/*  ===================================================================== */
void  hpttrs_(integer *n, integer *nrhs, halfreal *d__, 
	halfreal *e, halfreal *b, integer *ldb, integer *info)
{
    ...
    /* Local variables */
    integer j, jb, nb;
    extern void  hptts2_(integer *, integer *, halfreal *, 
...
/* Computing MAX */
    ...
    if (nb >= *nrhs) {
	hptts2_(n, nrhs, &d__[1], &e[1], &b[b_offset], ldb);
    } else {
	i__1 = *nrhs;
	i__2 = nb;
...
/* Computing MIN */
	    i__3 = *nrhs - j + 1;
	    jb = f2cmin(i__3,nb);
	    hptts2_(n, &jb, &d__[1], &e[1], &b[j * b_dim1 + 1], ldb);
/* L10: */
	}
    }
