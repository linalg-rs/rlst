...
/*  ===================================================================== */
void  klarfgp_(integer *n, halfcomplex *alpha, halfcomplex 
	*x, integer *incx, halfcomplex *tau)
{
    ...
    extern halfreal hlapy2_(halfreal *, halfreal *), hlapy3_(halfreal 
	    *, halfreal *, halfreal *), hwnrm2_(integer *, halfcomplex *
	    , integer *), hlamch_(char *);
