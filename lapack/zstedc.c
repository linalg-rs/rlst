...
/*  ===================================================================== */
void  zstedc_(char *compz, integer *n, doublereal *d__, 
	...
	integer *liwork, integer *info)
{
    ...
    extern void  dsteqr_(char *, integer *, doublereal *, 
    ...
    logical lquery;
    integer smlsiz;
    extern void  zsteqr_(char *, integer *, doublereal *, 
...
/*        Compute the workspace requirements */
	...
	if (*n <= 1 || icompz == 0) {
	    ...
	    lgn = (integer) (M(log)((doublereal) (*n)) / M(log)(2.));
