...
/* > */
/*  ===================================================================== */
void  wgeqrfp_(integer *m, integer *n, quadcomplex *a, 
	 ...
	 integer *info)
{
    ...
    integer lwkopt;
    logical lquery;
    extern void  wgeqr2p_(integer *, integer *, quadcomplex *
...
/*           A(i:m,i:i+ib-1) */
	    ...
	    i__3 = *m - i__ + 1;
	    wgeqr2p_(&i__3, &ib, &a[i__ + i__ * a_dim1], lda, &tau[i__], &
		    work[1], &iinfo);
	    if (i__ + ib <= *n) {
...
/*              H = H(i) H(i+1) . . . H(i+ib-1) */
		...
		i__3 = *m - i__ + 1;
		wlarft_("Forward", "Columnwise", &i__3, &ib, &a[i__ + i__ * 
...
/*     Use unblocked code to factor the last or only block. */
	...
	i__2 = *m - i__ + 1;
	i__1 = *n - i__ + 1;
	wgeqr2p_(&i__2, &i__1, &a[i__ + i__ * a_dim1], lda, &tau[i__], &work[
		1], &iinfo);
    }
