...
/* > \verbatim */
/* > */
/* > DORM2L overwrites the general doublereal m by n matrix C with */
/* > */
...
/*  ===================================================================== */
void  qorm2l_(char *side, char *trans, integer *m, integer *n, 
...
/*        Apply H(i) */
	...
	qlarf_(side, &mi, &ni, &a[i__ * a_dim1 + 1], &c__1, &tau[i__], &c__[
		c_offset], ldc, &work[1]);
