...
/*  ===================================================================== */
void  khprfs_(char *uplo, integer *n, integer *nrhs, 
	halfcomplex *ap, halfcomplex *afp, integer *ipiv, halfcomplex *
	b, integer *ldb, halfcomplex *x, integer *ldx, halfreal *ferr, 
	...
	info)
{
    ...
    extern void  kcopy_(integer *, halfcomplex *, integer *, 
	    ...
	    halfcomplex *, halfcomplex *, integer *), kaxpy_(
    ...
    halfreal lstres;
    extern void  khptrs_(char *, integer *, integer *, 
...
/*        Compute residual R = B - A * X */
	...
	z__1.r = -1., z__1.i = -0.;
	khpmv_(uplo, n, &z__1, &ap[1], &x[j * x_dim1 + 1], &c__1, &c_b1, &
		work[1], &c__1);
...
/*           Update solution and try again. */
	    ...
	    khptrs_(uplo, n, &c__1, &afp[1], &ipiv[1], &work[1], n, info);
