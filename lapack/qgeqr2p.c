...
/* > \verbatim */
/* > */
/* > DGEQR2P computes a QR factorization of a doublereal m by n matrix A: */
...
/* > */
/*  ===================================================================== */
void  qgeqr2p_(integer *m, integer *n, quadreal *a, integer *
	lda, quadreal *tau, quadreal *work, integer *info)
{
    ...
    extern void  qlarf_(char *, integer *, integer *, 
	    ...
	    qlarfgp_(integer *, quadreal *, quadreal *, integer *, 
	    quadreal *);
...
/* Computing MIN */
	i__3 = i__ + 1;
	qlarfgp_(&i__2, &a[i__ + i__ * a_dim1], &a[f2cmin(i__3,*m) + i__ * 
		a_dim1], &c__1, &tau[i__]);
	if (i__ < *n) {
...
/*           Apply H(i) to A(i:m,i+1:n) from the left */
	    ...
	    i__2 = *m - i__ + 1;
	    i__3 = *n - i__;
	    qlarf_("Left", &i__2, &i__3, &a[i__ + i__ * a_dim1], &c__1, &tau[
