...
/* > */
/*  ===================================================================== */
void  qspsv_(char *uplo, integer *n, integer *nrhs, quadreal 
	*ap, integer *ipiv, quadreal *b, integer *ldb, integer *info)
{
    ...
    extern void  xerbla_(char *, integer *), qsptrf_(
	    char *, integer *, quadreal *, integer *, integer *), 
	    qsptrs_(char *, integer *, integer *, quadreal *, integer *, 
...
/*        Solve the system A*X = B, overwriting B with X. */
	...
	qsptrs_(uplo, n, nrhs, &ap[1], &ipiv[1], &b[b_offset], ldb, info);
