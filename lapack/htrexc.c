...
/*  ===================================================================== */
void  htrexc_(char *compq, integer *n, halfreal *t, integer *
	ldt, halfreal *q, integer *ldq, integer *ifst, integer *ilst, 
	halfreal *work, integer *info)
{
    ...
    logical wantq;
    extern void  hlaexc_(logical *, integer *, halfreal *, 
...
/*           Current block either 1 by 1 or 2 by 2 */
	    ...
	    hlaexc_(&wantq, n, &t[t_offset], ldt, &q[q_offset], ldq, &here, &
...
/*           must be swapped individually */
	    ...
	    i__1 = here + 1;
	    hlaexc_(&wantq, n, &t[t_offset], ldt, &q[q_offset], ldq, &i__1, &
...
/*              Swap two 1 by 1 blocks, no problems possible */
		...
		hlaexc_(&wantq, n, &t[t_offset], ldt, &q[q_offset], ldq, &
