...
/*  ===================================================================== */
void  wsyrfs_(char *uplo, integer *n, integer *nrhs, 
	 ...
	 quadreal *rwork, integer *info)
{
    ...
    extern void  wcopy_(integer *, quadcomplex *, integer *, 
	    ...
	    quadcomplex *, integer *, quadcomplex *, integer *), wsymv_(
	    char *, integer *, quadcomplex *, quadcomplex *, integer *, 
	    quadcomplex *, integer *, quadcomplex *, quadcomplex *, 
	    integer *), wlacn2_(integer *, quadcomplex *, 
	    quadcomplex *, quadreal *, integer *, integer *);
    extern quadreal qlamch_(char *);
    quadreal safmin;
    extern void  xerbla_(char *, integer *);
    quadreal lstres;
    extern void  wsytrs_(char *, integer *, integer *, 
...
/*        Compute residual R = B - A * X */
	...
	z__1.r = -1., z__1.i = -0.;
	wsymv_(uplo, n, &z__1, &a[a_offset], lda, &x[j * x_dim1 + 1], &c__1, &
		c_b1, &work[1], &c__1);
...
/*           Update solution and try again. */
	    ...
	    wsytrs_(uplo, n, &c__1, &af[af_offset], ldaf, &ipiv[1], &work[1], 
		    n, info);
...
/*              Multiply by diag(W)*inv(A**T). */
		...
		wsytrs_(uplo, n, &c__1, &af[af_offset], ldaf, &ipiv[1], &work[
			1], n, info);
		i__2 = *n;
		for (i__ = 1; i__ <= i__2; ++i__) {
		    i__3 = i__;
