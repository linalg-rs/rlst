...
/*  ===================================================================== */
void  hspgv_(integer *itype, char *jobz, char *uplo, integer *
	n, halfreal *ap, halfreal *bp, halfreal *w, halfreal *z__, 
	integer *ldz, halfreal *work, integer *info)
{
    ...
    extern void  hspev_(char *, char *, integer *, halfreal *
...
/*     Transform problem to standard eigenvalue problem and solve. */
    ...
    hspev_(jobz, uplo, n, &ap[1], &w[1], &z__[z_offset], ldz, &work[1], info);
