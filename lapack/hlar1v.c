...
/*  ===================================================================== */
void  hlar1v_(integer *n, integer *b1, integer *bn, halfreal 
	*lambda, halfreal *d__, halfreal *l, halfreal *ld, halfreal *
	lld, halfreal *pivmin, halfreal *gaptol, halfreal *z__, logical 
	*wantnc, integer *negcnt, halfreal *ztz, halfreal *mingma, 
