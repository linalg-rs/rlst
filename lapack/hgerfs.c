...
/*  ===================================================================== */
void  hgerfs_(char *trans, integer *n, integer *nrhs, 
	...
	integer *info)
{
    ...
    halfreal safmin;
    extern void  xerbla_(char *, integer *), hgetrs_(
	    char *, integer *, integer *, halfreal *, integer *, integer *, 
...
/*        where op(A) = A, A**T, or A**H, depending on TRANS. */
	...
	hgemv_(trans, n, n, &c_b15, &a[a_offset], lda, &x[j * x_dim1 + 1], &
...
/*           Update solution and try again. */
	    ...
	    hgetrs_(trans, n, &c__1, &af[af_offset], ldaf, &ipiv[1], &work[*n 
		    + 1], n, info);
...
/*              Multiply by diag(W)*inv(op(A)**T). */
		...
		hgetrs_(transt, n, &c__1, &af[af_offset], ldaf, &ipiv[1], &
			work[*n + 1], n, info);
		i__2 = *n;
		for (i__ = 1; i__ <= i__2; ++i__) {
...
/* L120: */
		...
		hgetrs_(trans, n, &c__1, &af[af_offset], ldaf, &ipiv[1], &
			work[*n + 1], n, info);
	    }
	    goto L100;
	}
