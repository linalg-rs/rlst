...
/* > \verbatim */
/* > */
/* > DLASR applies a sequence of plane rotations to a doublereal matrix A, */
...
/*  ===================================================================== */
void  hlasr_(char *side, char *pivot, char *direct, integer *m,
	 integer *n, halfreal *c__, halfreal *s, halfreal *a, integer *
	lda)
{
