...
/*  ===================================================================== */
void  wppcon_(char *uplo, integer *n, quadcomplex *ap, 
	quadreal *anorm, quadreal *rcond, quadcomplex *work, quadreal 
	*rwork, integer *info)
{
...
/*           Multiply by inv(U**H). */
	    ...
	    wlatps_("Upper", "Conjugate transpose", "Non-unit", normin, n, &
		    ap[1], &work[1], &scalel, &rwork[1], info);
	    *(unsigned char *)normin = 'Y';

/*           Multiply by inv(U). */

	    wlatps_("Upper", "No transpose", "Non-unit", normin, n, &ap[1], &
		    work[1], &scaleu, &rwork[1], info);
	} else {

/*           Multiply by inv(L). */

	    wlatps_("Lower", "No transpose", "Non-unit", normin, n, &ap[1], &
		    work[1], &scalel, &rwork[1], info);
	    *(unsigned char *)normin = 'Y';

/*           Multiply by inv(L**H). */

	    wlatps_("Lower", "Conjugate transpose", "Non-unit", normin, n, &
