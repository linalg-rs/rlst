...
/*  ===================================================================== */
void  kptsvx_(char *fact, integer *n, integer *nrhs, 
	halfreal *d__, halfcomplex *e, halfreal *df, halfcomplex *ef, 
	...
	work, halfreal *rwork, integer *info)
{
    ...
    extern void  hcopy_(integer *, halfreal *, integer *, 
	    halfreal *, integer *), kcopy_(integer *, halfcomplex *, 
	    integer *, halfcomplex *, integer *);
    extern halfreal hlamch_(char *);
    logical nofact;
    extern void  xerbla_(char *, integer *);
    extern halfreal klanht_(char *, integer *, halfreal *, halfcomplex *
	    );
    extern void  klacpy_(char *, integer *, integer *, 
	    halfcomplex *, integer *, halfcomplex *, integer *), 
	    kptcon_(integer *, halfreal *, halfcomplex *, halfreal *, 
	    halfreal *, halfreal *, integer *), kptrfs_(char *, integer *,
	     integer *, halfreal *, halfcomplex *, halfreal *, 
	    halfcomplex *, halfcomplex *, integer *, halfcomplex *, 
	    integer *, halfreal *, halfreal *, halfcomplex *, 
	    halfreal *, integer *), kpttrf_(integer *, halfreal *,
	     halfcomplex *, integer *), kpttrs_(char *, integer *, integer *
	    , halfreal *, halfcomplex *, halfcomplex *, integer *, 
	    integer *);
...
/*        Compute the L*D*L**H (or U**H*D*U) factorization of A. */
	...
	if (*n > 1) {
	    i__1 = *n - 1;
	    kcopy_(&i__1, &e[1], &c__1, &ef[1], &c__1);
	}
	kpttrf_(n, &df[1], &ef[1], info);
...
/*     Compute the norm of the matrix A. */
    ...
    anorm = klanht_("1", n, &d__[1], &e[1]);

/*     Compute the reciprocal of the condition number of A. */

    kptcon_(n, &df[1], &ef[1], &anorm, rcond, &rwork[1], info);

/*     Compute the solution vectors X. */

    klacpy_("Full", n, nrhs, &b[b_offset], ldb, &x[x_offset], ldx);
    kpttrs_("Lower", n, nrhs, &df[1], &ef[1], &x[x_offset], ldx, info);

/*     Use iterative refinement to improve the computed solutions and */
/*     compute error bounds and backward error estimates for them. */

    kptrfs_("Lower", n, nrhs, &d__[1], &e[1], &df[1], &ef[1], &b[b_offset], 
