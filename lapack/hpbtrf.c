...
/* > \verbatim */
/* > */
/* > DPBTRF computes the Cholesky factorization of a doublereal symmetric */
...
/*  ===================================================================== */
void  hpbtrf_(char *uplo, integer *n, integer *kd, halfreal *
	ab, integer *ldab, integer *info)
{
    ...
    extern void  htrsm_(char *, char *, char *, char *, 
	    ...
	    integer *, halfreal *, halfreal *, integer *),
	     hpbtf2_(char *, integer *, integer *, halfreal *, integer *, 
	    integer *), hpotf2_(char *, integer *, halfreal *, 
...
/*        Use unblocked code */
	...
	hpbtf2_(uplo, n, kd, &ab[ab_offset], ldab, info);
    } else {
...
/*              Factorize the diagonal block */
		...
		i__3 = *ldab - 1;
		hpotf2_(uplo, &ib, &ab[*kd + 1 + i__ * ab_dim1], &i__3, &ii);
		if (ii != 0) {
		    *info = i__ + ii - 1;
		    goto L150;
		}
...
/*                    Update A12 */
			...
			i__3 = *ldab - 1;
			i__4 = *ldab - 1;
			htrsm_("Left", "Upper", "Transpose", "Non-unit", &ib, 
...
/*                    Update A22 */
			...
			i__3 = *ldab - 1;
			i__4 = *ldab - 1;
			hsyrk_("Upper", "Transpose", &i2, &ib, &c_b21, &ab[*
...
/*                    Update A23 */
			...
			if (i2 > 0) {
			    i__3 = *ldab - 1;
			    i__4 = *ldab - 1;
			    hgemm_("Transpose", "No Transpose", &i2, &i3, &ib,
...
/*                    Update A33 */
			...
			i__3 = *ldab - 1;
			hsyrk_("Upper", "Transpose", &i3, &ib, &c_b21, work, &
...
/*              Factorize the diagonal block */
		...
		i__3 = *ldab - 1;
		hpotf2_(uplo, &ib, &ab[i__ * ab_dim1 + 1], &i__3, &ii);
		if (ii != 0) {
		    *info = i__ + ii - 1;
		    goto L150;
		}
...
/*                    Update A21 */
			...
			i__3 = *ldab - 1;
			i__4 = *ldab - 1;
			htrsm_("Right", "Lower", "Transpose", "Non-unit", &i2,
...
/*                    Update A22 */
			...
			i__3 = *ldab - 1;
			i__4 = *ldab - 1;
			hsyrk_("Lower", "No Transpose", &i2, &ib, &c_b21, &ab[
...
/*                    Update A31 (in the work array). */
			...
			i__3 = *ldab - 1;
			htrsm_("Right", "Lower", "Transpose", "Non-unit", &i3,
				 &ib, &c_b18, &ab[i__ * ab_dim1 + 1], &i__3, 
				work, &c__33);
...
/*                    Update A32 */
			...
			if (i2 > 0) {
			    i__3 = *ldab - 1;
			    i__4 = *ldab - 1;
			    hgemm_("No transpose", "Transpose", &i3, &i2, &ib,
...
/*                    Update A33 */
			...
			i__3 = *ldab - 1;
			hsyrk_("Lower", "No Transpose", &i3, &ib, &c_b21, 
