...
/*  ===================================================================== */
void  wgbequb_(integer *m, integer *n, integer *kl, integer *
	ku, quadcomplex *ab, integer *ldab, quadreal *r__, quadreal *
	c__, quadreal *rowcnd, quadreal *colcnd, quadreal *amax, 
	integer *info)
{
