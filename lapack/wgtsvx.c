...
/*  ===================================================================== */
void  wgtsvx_(char *fact, char *trans, integer *n, integer *
	nrhs, quadcomplex *dl, quadcomplex *d__, quadcomplex *du, 
	quadcomplex *dlf, quadcomplex *df, quadcomplex *duf, 
	...
	info)
{
    ...
    extern quadreal wlangt_(char *, integer *, quadcomplex *, 
	    quadcomplex *, quadcomplex *);
    logical notran;
    extern void  wlacpy_(char *, integer *, integer *, 
	    quadcomplex *, integer *, quadcomplex *, integer *), 
	    wgtcon_(char *, integer *, quadcomplex *, quadcomplex *, 
	    quadcomplex *, quadcomplex *, integer *, quadreal *, 
	    quadreal *, quadcomplex *, integer *), wgtrfs_(char *,
	     integer *, integer *, quadcomplex *, quadcomplex *, 
	    quadcomplex *, quadcomplex *, quadcomplex *, quadcomplex *
	    , quadcomplex *, integer *, quadcomplex *, integer *, 
	    quadcomplex *, integer *, quadreal *, quadreal *, 
	    quadcomplex *, quadreal *, integer *), wgttrf_(
	    integer *, quadcomplex *, quadcomplex *, quadcomplex *, 
	    quadcomplex *, integer *, integer *), wgttrs_(char *, integer *,
	     integer *, quadcomplex *, quadcomplex *, quadcomplex *, 
...
/*        Compute the LU factorization of A. */
	...
	wcopy_(n, &d__[1], &c__1, &df[1], &c__1);
	if (*n > 1) {
	    i__1 = *n - 1;
	    wcopy_(&i__1, &dl[1], &c__1, &dlf[1], &c__1);
	    i__1 = *n - 1;
	    wcopy_(&i__1, &du[1], &c__1, &duf[1], &c__1);
	}
	wgttrf_(n, &dlf[1], &df[1], &duf[1], &du2[1], &ipiv[1], info);
...
/*     Compute the norm of the matrix A. */
	...
	*(unsigned char *)norm = 'I';
    ...
    anorm = wlangt_(norm, n, &dl[1], &d__[1], &du[1]);

/*     Compute the reciprocal of the condition number of A. */

    wgtcon_(norm, n, &dlf[1], &df[1], &duf[1], &du2[1], &ipiv[1], &anorm, 
	    rcond, &work[1], info);

/*     Compute the solution vectors X. */

    wlacpy_("Full", n, nrhs, &b[b_offset], ldb, &x[x_offset], ldx);
    wgttrs_(trans, n, nrhs, &dlf[1], &df[1], &duf[1], &du2[1], &ipiv[1], &x[
	    x_offset], ldx, info);

/*     Use iterative refinement to improve the computed solutions and */
/*     compute error bounds and backward error estimates for them. */

    wgtrfs_(trans, n, nrhs, &dl[1], &d__[1], &du[1], &dlf[1], &df[1], &duf[1],
