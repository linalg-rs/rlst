...
/*  ===================================================================== */
void  khegst_(integer *itype, char *uplo, integer *n, 
	...
	integer *info)
{
    ...
    extern void  khemm_(char *, char *, integer *, integer *, 
    ...
    extern void  ktrmm_(char *, char *, char *, char *, 
	    integer *, integer *, halfcomplex *, halfcomplex *, integer *,
	     halfcomplex *, integer *), 
	    ktrsm_(char *, char *, char *, char *, integer *, integer *, 
	    halfcomplex *, halfcomplex *, integer *, halfcomplex *, 
	    integer *), khegs2_(integer *, 
	    char *, integer *, halfcomplex *, integer *, halfcomplex *, 
	    integer *, integer *), kher2k_(char *, char *, integer *, 
	    integer *, halfcomplex *, halfcomplex *, integer *, 
...
/*        Use unblocked code */
	...
	khegs2_(itype, uplo, n, &a[a_offset], lda, &b[b_offset], ldb, info);
    } else {
...
/*                 Update the upper triangle of A(k:n,k:n) */
		    ...
		    khegs2_(itype, uplo, &kb, &a[k + k * a_dim1], lda, &b[k + 
			    k * b_dim1], ldb, info);
		    if (k + kb <= *n) {
			i__3 = *n - k - kb + 1;
			ktrsm_("Left", uplo, "Conjugate transpose", "Non-unit"
				, &kb, &i__3, &c_b1, &b[k + k * b_dim1], ldb, 
				&a[k + (k + kb) * a_dim1], lda);
			i__3 = *n - k - kb + 1;
			z__1.r = -.5, z__1.i = -0.;
			khemm_("Left", uplo, &kb, &i__3, &z__1, &a[k + k * 
				a_dim1], lda, &b[k + (k + kb) * b_dim1], ldb, 
				&c_b1, &a[k + (k + kb) * a_dim1], lda);
			i__3 = *n - k - kb + 1;
			z__1.r = -1., z__1.i = -0.;
			kher2k_(uplo, "Conjugate transpose", &i__3, &kb, &
			...
			khemm_("Left", uplo, &kb, &i__3, &z__1, &a[k + k * 
				...
				&c_b1, &a[k + (k + kb) * a_dim1], lda);
			i__3 = *n - k - kb + 1;
			ktrsm_("Right", uplo, "No transpose", "Non-unit", &kb,
...
/*                 Update the lower triangle of A(k:n,k:n) */
		    ...
		    if (k + kb <= *n) {
			i__3 = *n - k - kb + 1;
			ktrsm_("Right", uplo, "Conjugate transpose", "Non-un"
				"it", &i__3, &kb, &c_b1, &b[k + k * b_dim1], 
				ldb, &a[k + kb + k * a_dim1], lda);
			i__3 = *n - k - kb + 1;
			z__1.r = -.5, z__1.i = -0.;
			khemm_("Right", uplo, &i__3, &kb, &z__1, &a[k + k * 
				a_dim1], lda, &b[k + kb + k * b_dim1], ldb, &
				c_b1, &a[k + kb + k * a_dim1], lda);
			i__3 = *n - k - kb + 1;
			z__1.r = -1., z__1.i = -0.;
			kher2k_(uplo, "No transpose", &i__3, &kb, &z__1, &a[k 
			...
			khemm_("Right", uplo, &i__3, &kb, &z__1, &a[k + k * 
				...
				c_b1, &a[k + kb + k * a_dim1], lda);
			i__3 = *n - k - kb + 1;
			ktrsm_("Left", uplo, "No transpose", "Non-unit", &
...
/*                 Update the upper triangle of A(1:k+kb-1,1:k+kb-1) */
		    ...
		    i__3 = k - 1;
		    ktrmm_("Left", uplo, "No transpose", "Non-unit", &i__3, &
			    kb, &c_b1, &b[b_offset], ldb, &a[k * a_dim1 + 1], 
			    lda);
		    i__3 = k - 1;
		    khemm_("Right", uplo, &i__3, &kb, &c_b2, &a[k + k * 
			    a_dim1], lda, &b[k * b_dim1 + 1], ldb, &c_b1, &a[
			    k * a_dim1 + 1], lda);
		    i__3 = k - 1;
		    kher2k_(uplo, "No transpose", &i__3, &kb, &c_b1, &a[k * 
		    ...
		    khemm_("Right", uplo, &i__3, &kb, &c_b2, &a[k + k * 
			    ...
			    k * a_dim1 + 1], lda);
		    i__3 = k - 1;
		    ktrmm_("Right", uplo, "Conjugate transpose", "Non-unit", &
...
/*                 Update the lower triangle of A(1:k+kb-1,1:k+kb-1) */
		    ...
		    i__3 = k - 1;
		    ktrmm_("Right", uplo, "No transpose", "Non-unit", &kb, &
			    i__3, &c_b1, &b[b_offset], ldb, &a[k + a_dim1], 
			    lda);
		    i__3 = k - 1;
		    khemm_("Left", uplo, &kb, &i__3, &c_b2, &a[k + k * a_dim1]
			    , lda, &b[k + b_dim1], ldb, &c_b1, &a[k + a_dim1],
			     lda);
		    i__3 = k - 1;
		    kher2k_(uplo, "Conjugate transpose", &i__3, &kb, &c_b1, &
		    ...
		    khemm_("Left", uplo, &kb, &i__3, &c_b2, &a[k + k * a_dim1]
			    , lda, &b[k + b_dim1], ldb, &c_b1, &a[k + a_dim1],
			     lda);
		    i__3 = k - 1;
		    ktrmm_("Left", uplo, "Conjugate transpose", "Non-unit", &
