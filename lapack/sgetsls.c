...
/*  ===================================================================== */
void  sgetsls_(char *trans, integer *m, integer *n, integer *
	...
	integer *lwork, integer *info)
{
    ...
    extern void  sgelq_(integer *, integer *, real *, integer *
	    , real *, integer *, real *, integer *, integer *);
    integer minmn, maxmn;
    extern void  sgeqr_(integer *, integer *, real *, integer *
	    , real *, integer *, real *, integer *, integer *);
    real workq[1];
    ...
    logical lquery;
    extern void  strtrs_(char *, char *, char *, integer *, 
