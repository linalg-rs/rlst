...
/* > */
/*  ===================================================================== */
void  qlasd0_(integer *n, integer *sqre, quadreal *d__, 
	quadreal *e, quadreal *u, integer *ldu, quadreal *vt, integer *
	ldvt, integer *smlsiz, integer *iwork, quadreal *work, integer *
	info)
{
    ...
    extern void  qlasd1_(integer *, integer *, integer *, 
...
/*     NRF: starting row of the right  subproblem */
	...
	nrf = ic + 1;
	sqrei = 1;
	qlasdq_("U", &sqrei, &nl, &nlp1, &nl, &ncc, &d__[nlf], &e[nlf], &vt[
...
/* L10: */
	...
	nrp1 = nr + sqrei;
	qlasdq_("U", &sqrei, &nr, &nrp1, &nr, &ncc, &d__[nrf], &e[nrf], &vt[
...
/*        current level LVL. */
	...
	for (i__ = lf; i__ <= i__1; ++i__) {
	    ...
	    alpha = d__[ic];
	    beta = e[ic];
	    qlasd1_(&nl, &nr, &sqrei, &d__[nlf], &alpha, &beta, &u[nlf + nlf *
