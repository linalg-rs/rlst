...
/* > */
/*  ===================================================================== */
void  hlaed1_(integer *n, halfreal *d__, halfreal *q, 
	integer *ldq, integer *indxq, halfreal *rho, integer *cutpnt, 
	halfreal *work, integer *iwork, integer *info)
{
    ...
    extern void  hcopy_(integer *, halfreal *, integer *, 
	    halfreal *, integer *);
    integer indxp;
    extern void  hlaed2_(integer *, integer *, integer *, 
	    halfreal *, halfreal *, integer *, integer *, halfreal *, 
	    halfreal *, halfreal *, halfreal *, halfreal *, integer *,
	     integer *, integer *, integer *, integer *), hlaed3_(integer *, 
...
/*     first row of Q_2. */
    ...
    hcopy_(cutpnt, &q[*cutpnt + q_dim1], ldq, &work[iz], &c__1);
    zpp1 = *cutpnt + 1;
    i__1 = *n - *cutpnt;
    hcopy_(&i__1, &q[zpp1 + zpp1 * q_dim1], ldq, &work[iz + *cutpnt], &c__1);

/*     Deflate eigenvalues. */

    hlaed2_(&k, n, cutpnt, &d__[1], &q[q_offset], ldq, &indxq[1], rho, &work[
...
/*     Solve Secular Equation. */
	...
	hlaed3_(&k, n, cutpnt, &d__[1], &q[q_offset], ldq, rho, &work[idlmda],
