...
/*  ===================================================================== */
void  wsysv_(char *uplo, integer *n, integer *nrhs, 
	...
	integer *ldb, quadcomplex *work, integer *lwork, integer *info)
{
    ...
    integer lwkopt;
    logical lquery;
    extern void  wsytrf_(char *, integer *, quadcomplex *, 
	    integer *, integer *, quadcomplex *, integer *, integer *), wsytrs_(char *, integer *, integer *, quadcomplex *, 
	    integer *, integer *, quadcomplex *, integer *, integer *), wsytrs2_(char *, integer *, integer *, quadcomplex *, 
...
/*     Test the input parameters. */
	...
	*info = -10;
	...
	if (*n == 0) {
	    ...
	    wsytrf_(uplo, n, &a[a_offset], lda, &ipiv[1], &work[1], &c_n1, 
		    info);
...
/*     Compute the factorization A = U*D*U**T or A = L*D*L**T. */
    ...
    wsytrf_(uplo, n, &a[a_offset], lda, &ipiv[1], &work[1], lwork, info);
    if (*info == 0) {
...
/*        Solve with TRS ( Use Level BLAS 2) */
	    ...
	    wsytrs_(uplo, n, nrhs, &a[a_offset], lda, &ipiv[1], &b[b_offset], 
		    ldb, info);
...
/*        Solve with TRS2 ( Use Level BLAS 3) */
	    ...
	    wsytrs2_(uplo, n, nrhs, &a[a_offset], lda, &ipiv[1], &b[b_offset],
		     ldb, &work[1], info);
