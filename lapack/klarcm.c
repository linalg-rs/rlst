...
/*  ===================================================================== */
void  klarcm_(integer *m, integer *n, halfreal *a, integer *
	lda, halfcomplex *b, integer *ldb, halfcomplex *c__, integer *ldc,
	 halfreal *rwork)
{
...
/* L20: */
    ...
    l = *m * *n + 1;
    hgemm_("N", "N", m, n, m, &c_b6, &a[a_offset], lda, &rwork[1], m, &c_b7, &
	    rwork[l], m);
    i__1 = *n;
    for (j = 1; j <= i__1; ++j) {
	i__2 = *m;
