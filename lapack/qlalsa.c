...
/*  ===================================================================== */
void  qlalsa_(integer *icompq, integer *smlsiz, integer *n, 
	integer *nrhs, quadreal *b, integer *ldb, quadreal *bx, integer *
	ldbx, quadreal *u, integer *ldu, quadreal *vt, integer *k, 
	quadreal *difl, quadreal *difr, quadreal *z__, quadreal *
	poles, integer *givptr, integer *givcol, integer *ldgcol, integer *
	perm, quadreal *givnum, quadreal *c__, quadreal *s, quadreal *
...
/*        NRF: starting row of the right  subproblem */
	...
	nlf = ic - nl;
	nrf = ic + 1;
	qgemm_("T", "N", &nl, nrhs, &nl, &c_b7, &u[nlf + u_dim1], ldu, &b[nlf 
		+ b_dim1], ldb, &c_b8, &bx[nlf + bx_dim1], ldbx);
	qgemm_("T", "N", &nr, nrhs, &nr, &c_b7, &u[nrf + u_dim1], ldu, &b[nrf 
...
/*     in the bidiagonal matrix to BX. */
	...
	qcopy_(nrhs, &b[ic + b_dim1], ldb, &bx[ic + bx_dim1], ldbx);
/* L20: */
    }
...
/*        the current level LVL */
	...
	for (i__ = lf; i__ <= i__1; ++i__) {
	    ...
	    nrf = ic + 1;
	    --j;
	    qlals0_(icompq, &nl, &nr, &sqre, nrhs, &bx[nlf + bx_dim1], ldbx, &
...
/*        the current level LVL. */
	...
	for (i__ = ll; i__ >= i__2; --i__) {
	    ...
	    ++j;
	    qlals0_(icompq, &nl, &nr, &sqre, nrhs, &b[nlf + b_dim1], ldb, &bx[
...
/*     matrices are in explicit form. Apply them back. */
	...
	nlf = ic - nl;
	nrf = ic + 1;
	qgemm_("T", "N", &nlp1, nrhs, &nlp1, &c_b7, &vt[nlf + vt_dim1], ldu, &
		b[nlf + b_dim1], ldb, &c_b8, &bx[nlf + bx_dim1], ldbx);
	qgemm_("T", "N", &nrp1, nrhs, &nrp1, &c_b7, &vt[nrf + vt_dim1], ldu, &
