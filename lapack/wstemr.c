...
/* > of a doublereal symmetric tridiagonal matrix T. Any such unreduced matrix has */
/* > a well defined set of pairwise different doublereal eigenvalues, the corresponding */
/* > doublereal eigenvectors are pairwise orthogonal. */
/* > */
...
/* > doublereal symmetric tridiagonal form. */
/* > */
/* > (Any complex Hermitean tridiagonal matrix has doublereal values on its diagonal */
/* > and potentially complex numbers on its off-diagonals. By applying a */
/* > similarity transform with an appropriate diagonal matrix */
/* > diag(1,e^{i \phy_1}, ... , e^{i \phy_{n-1}}), the complex Hermitean */
/* > matrix can be transformed into a doublereal symmetric matrix and complex */
/* > arithmetic can be entirely avoided.) */
/* > */
/* > While the eigenvectors of the doublereal symmetric tridiagonal matrix are doublereal, */
...
/*  ===================================================================== */
void  wstemr_(char *jobz, char *range, integer *n, quadreal *
	d__, quadreal *e, quadreal *vl, quadreal *vu, integer *il, 
	integer *iu, integer *m, quadreal *w, quadcomplex *z__, integer *
	ldz, integer *nzc, integer *isuppz, logical *tryrac, quadreal *work,
	 integer *lwork, integer *iwork, integer *liwork, integer *info)
{
    ...
    integer itmp;
    quadreal tnrm;
    extern void  qlae2_(quadreal *, quadreal *, quadreal 
	    *, quadreal *, quadreal *);
    integer inde2, itmp2;
    quadreal rtol1, rtol2;
    ...
    extern void  wswap_(integer *, quadcomplex *, integer *, 
	    quadcomplex *, integer *), qlaev2_(quadreal *, quadreal *, 
    ...
    integer iindbl;
    logical valeig;
    extern void  qlarrc_(char *, integer *, quadreal *, 
	    quadreal *, quadreal *, quadreal *, quadreal *, integer *,
	     integer *, integer *, integer *), qlarre_(char *, 
	    integer *, quadreal *, quadreal *, integer *, integer *, 
	    quadreal *, quadreal *, quadreal *, quadreal *, 
	    quadreal *, quadreal *, integer *, integer *, integer *, 
	    quadreal *, quadreal *, quadreal *, integer *, integer *, 
	    quadreal *, quadreal *, quadreal *, integer *, integer *);
    integer wbegin;
    quadreal safmin;
    extern void  qlarrj_(integer *, quadreal *, quadreal *,
    ...
    extern void  qlarrr_(integer *, quadreal *, quadreal *,
	     integer *), qlasrt_(char *, integer *, quadreal *, integer *);
    quadreal thresh;
    integer iinspl, indwrk, ifirst, liwmin, nzcmin;
    quadreal pivmin;
    integer nsplit;
    quadreal smlnum;
    extern void  wlarrv_(integer *, quadreal *, quadreal *,
	     quadreal *, quadreal *, quadreal *, integer *, integer *, 
	    integer *, integer *, quadreal *, quadreal *, quadreal *, 
	    quadreal *, quadreal *, quadreal *, integer *, integer *, 
	    quadreal *, quadcomplex *, integer *, integer *, quadreal *,
	     integer *, integer *);
...
/* Computing MIN */
	...
	if (wantz && alleig) {
	    ...
	    qlarrc_("T", n, vl, vu, &d__[1], &e[1], &safmin, &nzcmin, &itmp, &
		    itmp2, info);
...
/*           WANTZ .EQ. FALSE. */
	...
	if (zquery && *info == 0) {
	    i__1 = z_dim1 + 1;
	    z__[i__1].r = (quadreal) nzcmin, z__[i__1].i = 0.;
...
/*     Handle N = 0, 1, and 2 cases immediately */
    ...
    *m = 0;
    ...
    if (*n == 2) {
	if (! wantz) {
	    qlae2_(&d__[1], &e[1], &d__[2], &r1, &r2);
	} else if (wantz && ! zquery) {
	    qlaev2_(&d__[1], &e[1], &d__[2], &r1, &r2, &cs, &sn);
	}
...
/*        RMAX threshold. */
	...
	if (scale != 1.) {
	    qscal_(n, &scale, &d__[1], &c__1);
	    i__1 = *n - 1;
	    qscal_(&i__1, &scale, &e[1], &c__1);
	    tnrm *= scale;
	    if (valeig) {
...
/*           Copy original diagonal, needed to guarantee relative accuracy */
	    qcopy_(n, &d__[1], &c__1, &work[indd], &c__1);
	}
...
/*           Note: these settings do only affect the subset case and DLARRE */
	    rtol1 = M(sqrt)(eps);
/* Computing MAX */
	    d__1 = M(sqrt)(eps) * .005, d__2 = eps * 4.;
	    rtol2 = f2cmax(d__1,d__2);
	}
	qlarre_(range, n, &wl, &wu, &iil, &iiu, &d__[1], &e[1], &work[inde2], 
...
/*           eigenvalues */
	    ...
	    wlarrv_(n, &wl, &wu, &d__[1], &e[1], &pivmin, &iwork[iinspl], m, &
...
L36:
		...
		rtol2 = eps * 4.;
		qlarrj_(&in, &work[indd + ibegin - 1], &work[inde2 + ibegin - 
...
/* L50: */
		...
		if (i__ != 0) {
		    ...
		    w[j] = tmp;
		    if (wantz) {
			wswap_(n, &z__[i__ * z_dim1 + 1], &c__1, &z__[j * 
				z_dim1 + 1], &c__1);
			itmp = isuppz[(i__ << 1) - 1];
