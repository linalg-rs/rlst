...
/*  ===================================================================== */
void  hsycon_(char *uplo, integer *n, halfreal *a, integer *
	lda, integer *ipiv, halfreal *anorm, halfreal *rcond, halfreal *
...
/*        Multiply by inv(L*D*L**T) or inv(U*D*U**T). */
	...
	hsytrs_(uplo, n, &c__1, &a[a_offset], lda, &ipiv[1], &work[1], n, 
		info);
	goto L30;
    }
