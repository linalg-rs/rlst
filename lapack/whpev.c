...
/*  ===================================================================== */
void  whpev_(char *jobz, char *uplo, integer *n, quadcomplex 
	*ap, quadreal *w, quadcomplex *z__, integer *ldz, quadcomplex *
	work, quadreal *rwork, integer *info)
{
    ...
    extern void  whptrd_(char *, integer *, quadcomplex *, 
	    ...
	    wupgtr_(char *, integer *, quadcomplex *, quadcomplex *, 
...
/*     Call ZHPTRD to reduce Hermitian packed matrix to tridiagonal form. */
    ...
    inde = 1;
    indtau = 1;
    whptrd_(uplo, n, &ap[1], &w[1], &rwork[inde], &work[indtau], &iinfo);
...
/*     ZUPGTR to generate the orthogonal matrix, then call ZSTEQR. */
	...
	indwrk = indtau + *n;
	wupgtr_(uplo, n, &ap[1], &work[indtau], &z__[z_offset], ldz, &work[
		indwrk], &iinfo);
	indrwk = inde + *n;
