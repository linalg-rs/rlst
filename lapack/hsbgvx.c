...
/*  ===================================================================== */
void  hsbgvx_(char *jobz, char *range, char *uplo, integer *n, 
	integer *ka, integer *kb, halfreal *ab, integer *ldab, halfreal *
	bb, integer *ldbb, halfreal *q, integer *ldq, halfreal *vl, 
	halfreal *vu, integer *il, integer *iu, halfreal *abstol, integer 
	*m, halfreal *w, halfreal *z__, integer *ldz, halfreal *work, 
	integer *iwork, integer *ifail, integer *info)
{
    ...
    extern void  hlacpy_(char *, integer *, integer *, 
	    ...
	    xerbla_(char *, integer *), hpbstf_(char *, integer *, 
	    integer *, halfreal *, integer *, integer *), hsbtrd_(
	    char *, char *, integer *, integer *, halfreal *, integer *, 
	    halfreal *, halfreal *, halfreal *, integer *, halfreal *,
	     integer *);
    integer indisp;
    extern void  hsbgst_(char *, char *, integer *, integer *, 
	    integer *, halfreal *, integer *, halfreal *, integer *, 
	    halfreal *, integer *, halfreal *, integer *),
	     hstein_(integer *, halfreal *, halfreal *, integer *, 
...
/*     Form a split Cholesky factorization of B. */
    ...
    hpbstf_(uplo, n, kb, &bb[bb_offset], ldbb, info);
    if (*info != 0) {
	*info = *n + *info;
	return;
    }
...
/*     Transform problem to standard eigenvalue problem. */
    ...
    hsbgst_(jobz, uplo, n, ka, kb, &ab[ab_offset], ldab, &bb[bb_offset], ldbb,
...
/*     Reduce symmetric band matrix to tridiagonal form. */
	...
	*(unsigned char *)vect = 'N';
    ...
    hsbtrd_(vect, uplo, n, ka, &ab[ab_offset], ldab, &work[indd], &work[inde],
...
/*     call DSTEIN. */
	...
	*(unsigned char *)order = 'E';
    ...
    indisp = indibl + *n;
    indiwo = indisp + *n;
    hstebz_(range, order, n, vl, vu, il, iu, abstol, &work[indd], &work[inde],
...
/*        form to eigenvectors returned by DSTEIN. */
	...
	for (j = 1; j <= i__1; ++j) {
	    ...
	    hgemv_("N", n, n, &c_b25, &q[q_offset], ldq, &work[1], &c__1, &
