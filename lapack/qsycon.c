...
/* > 1-norm) of a doublereal symmetric matrix A using the factorization */
...
/*  ===================================================================== */
void  qsycon_(char *uplo, integer *n, quadreal *a, integer *
	lda, integer *ipiv, quadreal *anorm, quadreal *rcond, quadreal *
...
/*        Multiply by inv(L*D*L**T) or inv(U*D*U**T). */
	...
	qsytrs_(uplo, n, &c__1, &a[a_offset], lda, &ipiv[1], &work[1], n, 
		info);
	goto L30;
    }
