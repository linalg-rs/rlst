...
/*  ===================================================================== */
void  kptsv_(integer *n, integer *nrhs, halfreal *d__, 
	halfcomplex *e, halfcomplex *b, integer *ldb, integer *info)
{
    /* System generated locals */
    integer b_dim1, b_offset, i__1;

    /* Local variables */
    extern void  xerbla_(char *, integer *), kpttrf_(
	    integer *, halfreal *, halfcomplex *, integer *), kpttrs_(
...
/*     Compute the L*D*L**H (or U**H*D*U) factorization of A. */
    ...
    kpttrf_(n, &d__[1], &e[1], info);
    if (*info == 0) {

/*        Solve the system A*X = B, overwriting B with X. */

	kpttrs_("Lower", n, nrhs, &d__[1], &e[1], &b[b_offset], ldb, info);
    }
    return;
