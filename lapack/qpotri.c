...
/*  ===================================================================== */
void  qpotri_(char *uplo, integer *n, quadreal *a, integer *
	lda, integer *info)
{
    ...
    extern void  xerbla_(char *, integer *), qlauum_(
	    char *, integer *, quadreal *, integer *, integer *), 
	    qtrtri_(char *, char *, integer *, quadreal *, integer *, 
	    integer *);
...
/*     Invert the triangular Cholesky factor U or L. */
    ...
    qtrtri_(uplo, "Non-unit", n, &a[a_offset], lda, info);
    if (*info > 0) {
	return;
    }
...
/*     Form inv(U) * inv(U)**T or inv(L)**T * inv(L). */
    ...
    qlauum_(uplo, n, &a[a_offset], lda, info);
