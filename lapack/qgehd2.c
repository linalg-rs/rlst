...
/* > \verbatim */
/* > */
/* > DGEHD2 reduces a doublereal general matrix A to upper Hessenberg form H by */
...
/* > */
/*  ===================================================================== */
void  qgehd2_(integer *n, integer *ilo, integer *ihi, 
	quadreal *a, integer *lda, quadreal *tau, quadreal *work, 
	integer *info)
{
...
/*        Apply H(i) to A(1:ihi,i+1:ihi) from the right */
	...
	i__2 = *ihi - i__;
	qlarf_("Right", ihi, &i__2, &a[i__ + 1 + i__ * a_dim1], &c__1, &tau[
...
/*        Apply H(i) to A(i+1:ihi,i+1:n) from the left */
	...
	i__2 = *ihi - i__;
	i__3 = *n - i__;
	qlarf_("Left", &i__2, &i__3, &a[i__ + 1 + i__ * a_dim1], &c__1, &tau[
