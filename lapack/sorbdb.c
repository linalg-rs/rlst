...
/* > */
/*  ===================================================================== */
void  sorbdb_(char *trans, char *signs, integer *m, integer *p,
	...
	work, integer *lwork, integer *info)
{
    ...
    logical lquery;
    extern void  slarfgp_(integer *, real *, real *, integer *,
	     real *);
...
/*        Reduce columns 1, ..., Q of X11, X12, X21, and X22 */
	...
	for (i__ = 1; i__ <= i__1; ++i__) {
		...
		i__2 = *p - i__ + 1;
		r__1 = z1 * M(cos)(phi[i__ - 1]);
		sscal_(&i__2, &r__1, &x11[i__ + i__ * x11_dim1], &c__1);
		i__2 = *p - i__ + 1;
		r__1 = -z1 * z3 * z4 * M(sin)(phi[i__ - 1]);
		...
		i__2 = *m - *p - i__ + 1;
		r__1 = z2 * M(cos)(phi[i__ - 1]);
		sscal_(&i__2, &r__1, &x21[i__ + i__ * x21_dim1], &c__1);
		i__2 = *m - *p - i__ + 1;
		r__1 = -z2 * z3 * z4 * M(sin)(phi[i__ - 1]);
