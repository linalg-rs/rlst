...
/* > */
/*  ===================================================================== */
void  hsyequb_(char *uplo, integer *n, halfreal *a, integer *
	lda, halfreal *s, halfreal *scond, halfreal *amax, halfreal *
	work, integer *info)
{
    ...
    halfreal d__;
    integer i__, j;
    halfreal t, u, c0, c1, c2, si;
    logical up;
    halfreal avg, std, tol, base;
    integer iter;
    halfreal smin, smax, scale;
...
/*        avg = s^T beta / n */
	...
	hlassq_(n, &work[*n + 1], &c__1, &scale, &sumsq);
