...
/*  ===================================================================== */
void  qlaed7_(integer *icompq, integer *n, integer *qsiz, 
	integer *tlvls, integer *curlvl, integer *curpbm, quadreal *d__, 
	quadreal *q, integer *ldq, integer *indxq, quadreal *rho, integer 
	*cutpnt, quadreal *qstore, integer *qptr, integer *prmptr, integer *
	perm, integer *givptr, integer *givcol, quadreal *givnum, 
	quadreal *work, integer *iwork, integer *info)
{
    ...
    integer indxc, indxp;
    extern void  qlaed8_(integer *, integer *, integer *, 
	    ...
	    quadreal *, integer *, integer *, integer *), qlaed9_(integer *,
	     integer *, integer *, integer *, quadreal *, quadreal *, 
	    integer *, quadreal *, quadreal *, quadreal *, quadreal *,
	     integer *, integer *), qlaeda_(integer *, integer *, integer *, 
...
/*     Sort and Deflate eigenvalues. */
    ...
    qlaed8_(icompq, &k, n, qsiz, &d__[1], &q[q_offset], ldq, &indxq[1], rho, 
...
/*     Solve Secular Equation. */
    ...
    if (k != 0) {
	qlaed9_(&k, &c__1, &k, n, &d__[1], &work[is], &k, rho, &work[idlmda], 
