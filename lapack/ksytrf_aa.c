...
/*  ===================================================================== */
void  zsytrf_aa__(char *uplo, integer *n, halfcomplex *a, 
...
/*                 Update (J2, J2) diagonal block with ZGEMV */
		    ...
		    for (mj = nj - 1; mj >= 1; --mj) {
			i__3 = jb + 1;
			kgemv_("No transpose", &mj, &i__3, &c_b19, &work[j3 - 
...
/*                 Update off-diagonal block of J2-th block row with ZGEMM */
		    ...
		    i__3 = *n - j3 + 1;
		    i__4 = jb + 1;
		    kgemm_("Transpose", "Transpose", &nj, &i__3, &i__4, &
...
/*                 Update off-diagonal block in J2-th block column with ZGEMM */
		    ...
		    i__3 = *n - j3 + 1;
		    i__4 = jb + 1;
		    kgemm_("No transpose", "Transpose", &i__3, &nj, &i__4, &
