...
/*  ===================================================================== */
void  ksysvx_(char *fact, char *uplo, integer *n, integer *
	nrhs, halfcomplex *a, integer *lda, halfcomplex *af, integer *
	ldaf, integer *ipiv, halfcomplex *b, integer *ldb, halfcomplex *x,
	 integer *ldx, halfreal *rcond, halfreal *ferr, halfreal *berr, 
	halfcomplex *work, integer *lwork, halfreal *rwork, integer *info)
{
    ...
    extern halfreal klansy_(char *, char *, integer *, halfcomplex *, 
	    integer *, halfreal *);
    extern void  ksycon_(char *, integer *, halfcomplex *, 
	    integer *, integer *, halfreal *, halfreal *, halfcomplex *,
	     integer *), ksyrfs_(char *, integer *, integer *, 
	    halfcomplex *, integer *, halfcomplex *, integer *, integer *,
	     halfcomplex *, integer *, halfcomplex *, integer *, 
	    halfreal *, halfreal *, halfcomplex *, halfreal *, 
	    integer *), ksytrf_(char *, integer *, halfcomplex *, 
	    integer *, integer *, halfcomplex *, integer *, integer *), ksytrs_(char *, integer *, integer *, halfcomplex *, 
...
/*        Compute the factorization A = U*D*U**T or A = L*D*L**T. */
	...
	ksytrf_(uplo, n, &af[af_offset], ldaf, &ipiv[1], &work[1], lwork, 
		info);
...
/*     Compute the norm of the matrix A. */
    ...
    anorm = klansy_("I", uplo, n, &a[a_offset], lda, &rwork[1]);

/*     Compute the reciprocal of the condition number of A. */

    ksycon_(uplo, n, &af[af_offset], ldaf, &ipiv[1], &anorm, rcond, &work[1], 
	    info);

/*     Compute the solution vectors X. */

    klacpy_("Full", n, nrhs, &b[b_offset], ldb, &x[x_offset], ldx);
    ksytrs_(uplo, n, nrhs, &af[af_offset], ldaf, &ipiv[1], &x[x_offset], ldx, 
	    info);

/*     Use iterative refinement to improve the computed solutions and */
/*     compute error bounds and backward error estimates for them. */

    ksyrfs_(uplo, n, nrhs, &a[a_offset], lda, &af[af_offset], ldaf, &ipiv[1], 
