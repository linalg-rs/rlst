...
/*  ===================================================================== */
void  chetrf_aa__(char *uplo, integer *n, complex *a, integer *
	lda, integer *ipiv, complex *work, integer *lwork, integer *info)
{
    ...
    /* Local variables */
    extern void  clahef_aa__(char *, integer *, integer *, 
...
/*        Panel factorization */
	...
	i__1 = 2 - k1;
	i__2 = *n - j;
	clahef_aa__(uplo, &i__1, &i__2, &jb, &a[f2cmax(1,j) + (j + 1) * a_dim1], 
...
/*        Panel factorization */
	...
	i__2 = 2 - k1;
	i__1 = *n - j;
	clahef_aa__(uplo, &i__2, &i__1, &jb, &a[j + 1 + f2cmax(1,j) * a_dim1], 
		lda, &ipiv[j + 1], &work[1], n, &work[*n * nb + 1])
		;
