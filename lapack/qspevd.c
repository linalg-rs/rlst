...
/*  ===================================================================== */
void  qspevd_(char *jobz, char *uplo, integer *n, quadreal *
	ap, quadreal *w, quadreal *z__, integer *ldz, quadreal *work, 
	integer *lwork, integer *iwork, integer *liwork, integer *info)
{
    ...
    extern void  qsptrd_(char *, integer *, quadreal *, 
	    quadreal *, quadreal *, quadreal *, integer *), 
	    qopmtr_(char *, char *, char *, integer *, integer *, quadreal *
	    , quadreal *, quadreal *, integer *, quadreal *, integer *);
    integer llwork;
    quadreal smlnum;
    logical lquery;
...
/*     Householder transformations represented in AP. */
	...
	qstedc_("I", n, &w[1], &work[inde], &z__[z_offset], ldz, &work[indwrk]
		, &llwork, &iwork[1], liwork, info);
	qopmtr_("L", uplo, "N", n, n, &ap[1], &work[indtau], &z__[z_offset], 
