...
/*  ===================================================================== */
void  cgesvd_(char *jobu, char *jobvt, integer *m, integer *n, 
	...
	integer *info)
{
    ...
    extern void  cgebrd_(integer *, integer *, complex *, 
	    integer *, real *, real *, complex *, complex *, complex *, 
	    integer *, integer *);
    extern real clange_(char *, integer *, integer *, complex *, integer *, 
	    real *);
    extern void  cgelqf_(integer *, integer *, complex *, 
    ...
    extern void  cunmbr_(char *, char *, char *, integer *, 
    ...
    integer lwork_cungbr_p__, lwork_cungbr_q__, lwork_cunglq_m__, 
