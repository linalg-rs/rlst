...
/*  ===================================================================== */
void  kpotrs_(char *uplo, integer *n, integer *nrhs, 
...
/*        Solve U**H *X = B, overwriting B with X. */
	...
	ktrsm_("Left", "Upper", "Conjugate transpose", "Non-unit", n, nrhs, &
...
/*        Solve L*X = B, overwriting B with X. */
	...
	ktrsm_("Left", "Lower", "No transpose", "Non-unit", n, nrhs, &c_b1, &
		a[a_offset], lda, &b[b_offset], ldb);

/*        Solve L**H *X = B, overwriting B with X. */

	ktrsm_("Left", "Lower", "Conjugate transpose", "Non-unit", n, nrhs, &
		c_b1, &a[a_offset], lda, &b[b_offset], ldb);
    }
