...
/*  ===================================================================== */
void  kpotf2_(char *uplo, integer *n, halfcomplex *a, 
...
/*           Compute U(J,J) and test for non-positive-definiteness. */
	    ...
	    d__1 = a[i__2].r;
	    i__3 = j - 1;
	    whotc_(&z__2, &i__3, &a[j * a_dim1 + 1], &c__1, &a[j * a_dim1 + 1]
		    , &c__1);
...
/*           Compute elements J+1:N of row J. */
		...
		i__3 = *n - j;
		z__1.r = -1., z__1.i = -0.;
		kgemv_("Transpose", &i__2, &i__3, &z__1, &a[(j + 1) * a_dim1 
...
/*           Compute L(J,J) and test for non-positive-definiteness. */
	    ...
	    d__1 = a[i__2].r;
	    i__3 = j - 1;
	    whotc_(&z__2, &i__3, &a[j + a_dim1], lda, &a[j + a_dim1], lda);
	    z__1.r = d__1 - z__2.r, z__1.i = -z__2.i;
	    ajj = z__1.r;
	    if (ajj <= 0. || hisnan_(&ajj)) {
		i__2 = j + j * a_dim1;
...
/*           Compute elements J+1:N of column J. */
		...
		i__3 = j - 1;
		z__1.r = -1., z__1.i = -0.;
		kgemv_("No transpose", &i__2, &i__3, &z__1, &a[j + 1 + a_dim1]
