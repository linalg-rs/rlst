...
/* > */
/*  ===================================================================== */
void  hggesx_(char *jobvsl, char *jobvsr, char *sort, L_fp 
	selctg, char *sense, integer *n, halfreal *a, integer *lda, 
	halfreal *b, integer *ldb, integer *sdim, halfreal *alphar, 
	halfreal *alphai, halfreal *beta, halfreal *vsl, integer *ldvsl,
	 halfreal *vsr, integer *ldvsr, halfreal *rconde, halfreal *
	rcondv, halfreal *work, integer *lwork, integer *iwork, integer *
	liwork, logical *bwork, integer *info)
{
    ...
    extern void  htgsen_(integer *, logical *, logical *, 
...
/*     (Workspace: need N, prefer N*NB) */
    ...
    if (ilvsl) {
	hlaset_("Full", n, n, &c_b42, &c_b43, &vsl[vsl_offset], ldvsl);
	if (irows > 1) {
	    i__1 = irows - 1;
	    i__2 = irows - 1;
...
/*     Initialize VSR */
    ...
    if (ilvsr) {
	hlaset_("Full", n, n, &c_b42, &c_b43, &vsr[vsr_offset], ldvsr);
    }

/*     Reduce to generalized Hessenberg form */
/*     (Workspace: none needed) */

    hgghrd_(jobvsl, jobvsr, n, &ilo, &ihi, &a[a_offset], lda, &b[b_offset], 
...
/*        compute reciprocal condition numbers */
	...
	i__1 = *lwork - iwrk + 1;
	htgsen_(&ijob, &ilvsl, &ilvsr, &bwork[1], n, &a[a_offset], lda, &b[
