...
/* > */
/*  ===================================================================== */
void  qgebrd_(integer *m, integer *n, quadreal *a, integer *
	lda, quadreal *d__, quadreal *e, quadreal *tauq, quadreal *
	taup, quadreal *work, integer *lwork, integer *info)
{
    ...
    extern void  qgebd2_(integer *, integer *, quadreal *, 
	    integer *, quadreal *, quadreal *, quadreal *, quadreal *,
	     quadreal *, integer *), qlabrd_(integer *, integer *, integer *
...
/*        part of the matrix */
	...
	i__3 = *m - i__ + 1;
	i__4 = *n - i__ + 1;
	qlabrd_(&i__3, &i__4, &nb, &a[i__ + i__ * a_dim1], lda, &d__[i__], &e[
...
/*        of the form  A := A - V*Y**T - X*U**T */
	...
	i__3 = *m - i__ - nb + 1;
	i__4 = *n - i__ - nb + 1;
	qgemm_("No transpose", "Transpose", &i__3, &i__4, &nb, &c_b21, &a[i__ 
...
/*     Use unblocked code to reduce the remainder of the matrix */
    ...
    i__2 = *m - i__ + 1;
    i__1 = *n - i__ + 1;
    qgebd2_(&i__2, &i__1, &a[i__ + i__ * a_dim1], lda, &d__[i__], &e[i__], &
