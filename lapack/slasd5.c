...
/* > */
/*  ===================================================================== */
void  slasd5_(integer *i__, real *d__, real *z__, real *delta, 
...
/*           The following TAU is DSIGMA * DSIGMA - D( 1 ) * D( 1 ) */
	    ...
	    tau = c__ * 2.f / (b + M(sqrt)((r__1 = b * b - c__ * 4.f, abs(r__1)))
		    );

/*           The following TAU is DSIGMA - D( 1 ) */

	    tau /= d__[1] + M(sqrt)(d__[1] * d__[1] + tau);
	    *dsigma = d__[1] + tau;
	    delta[1] = -tau;
	    delta[2] = del - tau;
...
/*           The following TAU is DSIGMA * DSIGMA - D( 2 ) * D( 2 ) */
	    ...
	    if (b > 0.f) {
		tau = c__ * -2.f / (b + M(sqrt)(b * b + c__ * 4.f));
	    } else {
		tau = (b - M(sqrt)(b * b + c__ * 4.f)) / 2.f;
	    }

/*           The following TAU is DSIGMA - D( 2 ) */

	    tau /= d__[2] + M(sqrt)((r__1 = d__[2] * d__[2] + tau, abs(r__1)));
	    *dsigma = d__[2] + tau;
	    delta[1] = -(del + tau);
	    delta[2] = -tau;
...
/*        The following TAU is DSIGMA - D( 2 ) */
	...
	tau /= d__[2] + M(sqrt)(d__[2] * d__[2] + tau);
	*dsigma = d__[2] + tau;
	delta[1] = -(del + tau);
	delta[2] = -tau;
	work[1] = d__[1] + tau + d__[2];
