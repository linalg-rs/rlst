...
/*  ===================================================================== */
void  dgbsvx_(char *fact, char *trans, integer *n, integer *kl,
	...
	doublereal *berr, doublereal *work, integer *iwork, integer *info)
{
    ...
    extern void  dlaqgb_(integer *, integer *, integer *, 
    ...
    extern void  dgbequ_(integer *, integer *, integer *, 
	    integer *, doublereal *, integer *, doublereal *, doublereal *, 
    ...
    doublereal bignum;
    extern void  dgbtrs_(char *, integer *, integer *, integer 
	    *, integer *, doublereal *, integer *, integer *, doublereal *, 
	    integer *, integer *);
    integer infequ;
    logical colequ;
