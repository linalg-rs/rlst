...
/* > */
/*  ===================================================================== */
void  kpbsv_(char *uplo, integer *n, integer *kd, integer *
	nrhs, halfcomplex *ab, integer *ldab, halfcomplex *b, integer *
	ldb, integer *info)
{
    ...
    extern void  xerbla_(char *, integer *), kpbtrf_(
	    char *, integer *, integer *, halfcomplex *, integer *, integer 
	    *), kpbtrs_(char *, integer *, integer *, integer *, 
...
/*     Compute the Cholesky factorization A = U**H *U or A = L*L**H. */
    ...
    kpbtrf_(uplo, n, kd, &ab[ab_offset], ldab, info);
    if (*info == 0) {

/*        Solve the system A*X = B, overwriting B with X. */

	kpbtrs_(uplo, n, kd, nrhs, &ab[ab_offset], ldab, &b[b_offset], ldb, 
		info);
