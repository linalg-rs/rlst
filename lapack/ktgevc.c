...
/*  ===================================================================== */
void  ktgevc_(char *side, char *howmny, logical *select, 
	integer *n, halfcomplex *s, integer *lds, halfcomplex *p, integer 
	*ldp, halfcomplex *vl, integer *ldvl, halfcomplex *vr, integer *
	ldvr, integer *mm, integer *m, halfcomplex *work, halfreal *rwork,
	 integer *info)
{
...
/*              Back transform eigenvector if HOWMNY='B'. */
		...
		if (ilback) {
		    i__2 = *n + 1 - je;
		    kgemv_("N", n, &i__2, &c_b2, &vl[je * vl_dim1 + 1], ldvl, 
...
/*              Back transform eigenvector if HOWMNY='B'. */
		...
		if (ilback) {
		    kgemv_("N", n, &je, &c_b2, &vr[vr_offset], ldvr, &work[1],
