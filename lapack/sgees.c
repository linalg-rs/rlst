...
/*  ===================================================================== */
void  sgees_(char *jobvs, char *sort, L_fp select, integer *n, 
	...
	info)
{
    ...
    logical scalea;
    real cscale;
    extern void  sgebak_(char *, char *, integer *, integer *, 
    ...
    extern void  slascl_(char *, integer *, integer *, real *, 
	    ...
	    real *, integer *);
    logical lastsl;
    extern void  sorghr_(integer *, integer *, integer *, real 
    ...
    real smlnum;
    integer hswork;
    extern void  strsen_(char *, char *, logical *, integer *, 
