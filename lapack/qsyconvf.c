...
/* > \endverbatim */
/*  ===================================================================== */
void  qsyconvf_(char *uplo, char *way, integer *n, quadreal *
	a, integer *lda, quadreal *e, integer *ipiv, integer *info)
{
...
/*                 Swap rows i+1 and IPIV(i) in A(i:N,1:i-1) */
			...
			if (ip != i__ + 1) {
			    i__1 = i__ - 1;
			    qswap_(&i__1, &a[i__ + 1 + a_dim1], lda, &a[ip + 
				    a_dim1], lda);
			}
		    }
...
/*                 Swap rows i+1 and IPIV(i) in A(i:N,1:i-1) */
			...
			if (ip != i__ + 1) {
			    i__1 = i__ - 1;
			    qswap_(&i__1, &a[ip + a_dim1], lda, &a[i__ + 1 + 
				    a_dim1], lda);
			}
		    }
