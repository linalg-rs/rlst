...
/* > */
/*  ===================================================================== */
void  dgesvj_(char *joba, char *jobu, char *jobv, integer *m, 
	...
	integer *info)
{
    ...
    doublereal epsln;
    logical applv, rsvec;
    extern void  daxpy_(integer *, doublereal *, doublereal *, 
	    integer *, doublereal *, integer *);
    logical uctol;
    extern void  drotm_(integer *, doublereal *, integer *, 
	    doublereal *, integer *, doublereal *);
    logical lower, upper, rotok;
    extern void  dgsvj0_(char *, integer *, integer *, 
    ...
    extern void  dlaset_(char *, integer *, integer *, 
...
/*     BIG         = ONE    / SFMIN */
    rootbig = 1. / rootsfmin;
    large = big / M(sqrt)((doublereal) (*m * *n));
    bigtheta = 1. / rooteps;
...
/*     in A are detected, the procedure returns with INFO=-6. */
    ...
    skl = 1. / M(sqrt)((doublereal) (*m) * (doublereal) (*n));
    noscale = TRUE_;
    goscale = TRUE_;
...
/* Computing MIN */
	d__1 = sn / aaqq, d__2 = big / (aapp * M(sqrt)((doublereal) (*n)));
	temp1 = f2cmin(d__1,d__2);
/*         AAQQ  = AAQQ*TEMP1 */
/*         AAPP  = AAPP*TEMP1 */
    } else if (aaqq >= sn && aapp >= temp1) {
...
/* Computing MIN */
	d__1 = sn / aaqq, d__2 = big / (M(sqrt)((doublereal) (*n)) * aapp);
	temp1 = f2cmin(d__1,d__2);
/*         AAQQ  = AAQQ*TEMP1 */
/*         AAPP  = AAPP*TEMP1 */
    } else {
...
/*     Additional steering devices */
	...
	if (i__ > swband + 1 && mxaapq < M(sqrt)((doublereal) (*n)) * tol && (
