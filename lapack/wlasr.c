...
/* > \verbatim */
/* > */
/* > ZLASR applies a sequence of doublereal plane rotations to a complex matrix */
...
/*  ===================================================================== */
void  wlasr_(char *side, char *pivot, char *direct, integer *m,
	 integer *n, quadreal *c__, quadreal *s, quadcomplex *a, 
	integer *lda)
{
