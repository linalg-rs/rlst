...
/* > */
/*  ===================================================================== */
void  kgelq2_(integer *m, integer *n, halfcomplex *a, 
...
/* Computing MIN */
	i__3 = i__ + 1;
	klarfg_(&i__2, &alpha, &a[i__ + f2cmin(i__3,*n) * a_dim1], lda, &tau[i__]
		);
	if (i__ < *m) {
...
/*           Apply H(i) to A(i+1:m,i:n) from the right */
	    ...
	    i__2 = *m - i__;
	    i__3 = *n - i__ + 1;
	    klarf_("Right", &i__2, &i__3, &a[i__ + i__ * a_dim1], lda, &tau[
