...
/*  ===================================================================== */
void  wcgesv_(integer *n, integer *nrhs, quadcomplex *a, 
	integer *lda, integer *ipiv, quadcomplex *b, integer *ldb, 
	...
	quadreal *rwork, integer *iter, integer *info)
{
    ...
    extern void  wgemm_(char *, char *, integer *, integer *, 
	    ...
	    integer *), waxpy_(integer *, quadcomplex *, 
	    quadcomplex *, integer *, quadcomplex *, integer *), clag2z_(
	    integer *, integer *, complex *, integer *, quadcomplex *, 
	    integer *, integer *), wlag2c_(integer *, integer *, 
    ...
    extern void  wlacpy_(char *, integer *, integer *, 
	    ...
	    wgetrf_(integer *, integer *, quadcomplex *, integer *, integer 
	    *, integer *), wgetrs_(char *, integer *, integer *, 
...
/*     Compute some constants. */
    ...
    anrm = wlange_("I", n, n, &a[a_offset], lda, &rwork[1]);
    eps = qlamch_("Epsilon");
...
/*     result in SA. */
    ...
    wlag2c_(n, n, &a[a_offset], lda, &swork[ptsa], n, info);
...
/*     Compute R = B - AX (R is WORK). */
    ...
    wgemm_("No Transpose", "No Transpose", n, nrhs, n, &c_b1, &a[a_offset], 
...
/*     satisfactory solution, so we resort to double precision. */
    ...
    wgetrf_(n, n, &a[a_offset], lda, &ipiv[1], info);
    ...
    wgetrs_("No transpose", n, nrhs, &a[a_offset], lda, &ipiv[1], &x[x_offset]
	    , ldx, info);
