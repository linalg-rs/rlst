...
/*  ===================================================================== */
void  qstein_(integer *n, quadreal *d__, quadreal *e, 
	integer *m, quadreal *w, integer *iblock, integer *isplit, 
	quadreal *z__, integer *ldz, quadreal *work, integer *iwork, 
...
/*           close enough. */
		...
		for (i__ = gpind; i__ <= i__3; ++i__) {
		    ztr = -qdot_(&blksiz, &work[indrv1 + 1], &c__1, &z__[b1 + 
			    i__ * z_dim1], &c__1);
		    qaxpy_(&blksiz, &ztr, &z__[b1 + i__ * z_dim1], &c__1, &
			    work[indrv1 + 1], &c__1);
/* L80: */
		}
	    }
