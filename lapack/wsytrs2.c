...
/*  ===================================================================== */
void  wsytrs2_(char *uplo, integer *n, integer *nrhs, 
	...
	integer *ldb, quadcomplex *work, integer *info)
{
    ...
    extern void  wswap_(integer *, quadcomplex *, integer *, 
	    ...
	    *, quadcomplex *, integer *), 
	    xerbla_(char *, integer *), wsyconv_(char *, char *, 
...
/*  Compute D \ B -> B   [ D \ (U \P**T * B) ] */
	...
	while(i__ >= 1) {
		...
		wscal_(nrhs, &z__1, &b[i__ + b_dim1], ldb);
	    } else if (i__ > 1) {
...
/*      Compute (U**T \ B) -> B   [ U**T \ (D \ (U \P**T * B) ) ] */
	...
	wtrsm_("L", "U", "T", "U", n, nrhs, &c_b1, &a[a_offset], lda, &b[
		b_offset], ldb);
...
/*  Compute (L**T \ B) -> B   [ L**T \ (D \ (L \P**T * B) ) ] */
	...
	wtrsm_("L", "L", "T", "U", n, nrhs, &c_b1, &a[a_offset], lda, &b[
		b_offset], ldb);
