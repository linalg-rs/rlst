...
/* > */
/*  ===================================================================== */
void  zunbdb_(char *trans, char *signs, integer *m, integer *p,
	...
	info)
{
    ...
    extern void  zscal_(integer *, doublecomplex *, 
	    ...
	    integer *, doublecomplex *), zaxpy_(integer *, 
	    doublecomplex *, doublecomplex *, integer *, doublecomplex *, 
	    integer *);
    extern doublereal dznrm2_(integer *, doublecomplex *, integer *);
    extern void  xerbla_(char *, integer *), zlacgv_(
	    integer *, doublecomplex *, integer *);
    logical lquery;
    extern void  zlarfgp_(integer *, doublecomplex *, 
