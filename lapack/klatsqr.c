...
/* > */
/*  ===================================================================== */
void  klatsqr_(integer *m, integer *n, integer *mb, integer *
	...
	halfcomplex *work, integer *lwork, integer *info)
{
    ...
    extern void  xerbla_(char *, integer *), kgeqrt_(
	    integer *, integer *, integer *, halfcomplex *, integer *, 
	    halfcomplex *, integer *, halfcomplex *, integer *);
    logical lquery;
    extern void  ktpqrt_(integer *, integer *, integer *, 
...
/*     The QR Decomposition */
    ...
    if (*mb <= *n || *mb >= *m) {
	kgeqrt_(m, n, nb, &a[a_offset], lda, &t[t_offset], ldt, &work[1], 
		info);
	return;
    }
    kk = (*m - *n) % (*mb - *n);
...
/*      Compute the QR factorization of the first block A(1:MB,1:N) */
    ...
    kgeqrt_(mb, n, nb, &a[a_dim1 + 1], lda, &t[t_offset], ldt, &work[1], info)
	    ;
    ctr = 1;
...
/*      Compute the QR factorization of the current block A(I:I+MB-N,1:N) */
	...
	i__3 = *mb - *n;
	ktpqrt_(&i__3, n, &c__0, nb, &a[a_dim1 + 1], lda, &a[i__ + a_dim1], 
...
/*      Compute the QR factorization of the last block A(II:M,1:N) */
    ...
    if (ii <= *m) {
	ktpqrt_(&kk, n, &c__0, nb, &a[a_dim1 + 1], lda, &a[ii + a_dim1], lda, 
