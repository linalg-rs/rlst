...
/*  ===================================================================== */
void  khpgv_(integer *itype, char *jobz, char *uplo, integer *
	n, halfcomplex *ap, halfcomplex *bp, halfreal *w, halfcomplex 
	*z__, integer *ldz, halfcomplex *work, halfreal *rwork, integer *
	info)
{
    ...
    char trans[1];
    logical upper;
    extern void  khpev_(char *, char *, integer *, 
    ...
    extern void  ktpmv_(char *, char *, char *, integer *, 
	    ...
	    char *, integer *), khpgst_(integer *, char *, integer *, 
	    halfcomplex *, halfcomplex *, integer *), kpptrf_(
	    char *, integer *, halfcomplex *, integer *);
...
/*     Transform problem to standard eigenvalue problem and solve. */
    ...
    khpev_(jobz, uplo, n, &ap[1], &w[1], &z__[z_offset], ldz, &work[1], &
	    rwork[1], info);
