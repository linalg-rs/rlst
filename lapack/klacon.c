...
/* > */
/*  ===================================================================== */
void  klacon_(integer *n, halfcomplex *v, halfcomplex *x, 
	halfreal *est, integer *kase)
{
    ...
    static integer jump;
    static halfreal absxi;
    static integer jlast;
    extern void  kcopy_(integer *, halfcomplex *, integer *, 
	    halfcomplex *, integer *);
    extern integer ikmax1_(integer *, halfcomplex *, integer *);
    extern halfreal hwsum1_(integer *, halfcomplex *, integer *), hlamch_(
	    char *);
    static halfreal safmin, altsgn, estold;
...
L70:
    kcopy_(n, &x[1], &c__1, &v[1], &c__1);
    estold = *est;
    *est = hwsum1_(n, &v[1], &c__1);
...
L100:
    ...
    for (i__ = 1; i__ <= i__1; ++i__) {
	i__2 = i__;
	d__1 = altsgn * ((halfreal) (i__ - 1) / (halfreal) (*n - 1) + 1.);
	z__1.r = d__1, z__1.i = 0.;
	x[i__2].r = z__1.r, x[i__2].i = z__1.i;
	altsgn = -altsgn;
/* L110: */
...
L120:
    temp = hwsum1_(n, &x[1], &c__1) / (halfreal) (*n * 3) * 2.;
    if (temp > *est) {
	kcopy_(n, &x[1], &c__1, &v[1], &c__1);
	*est = temp;
    }
