...
/* > */
/*  ===================================================================== */
void  qlaqr4_(logical *wantt, logical *wantz, integer *n, 
	...
	integer *ldz, quadreal *work, integer *lwork, integer *info)
{
    ...
    extern void  qlaqr2_(logical *, logical *, integer *, 
	    ...
	    *, integer *, quadreal *, integer *, integer *, integer *, 
	    ...
	    quadreal *, integer *), qlanv2_(quadreal *, quadreal *, 
	    quadreal *, quadreal *, quadreal *, quadreal *, 
	    quadreal *, quadreal *, quadreal *, quadreal *), qlaqr5_(
...
/*        ==== Workspace query call to DLAQR2 ==== */
	...
	i__1 = nwr + 1;
	qlaqr2_(wantt, wantz, n, ilo, ihi, &i__1, &h__[h_offset], ldh, iloz, 
...
/*           ==== Aggressive early deflation ==== */
	    ...
	    qlaqr2_(wantt, wantz, n, &ktop, &kbot, &nw, &h__[h_offset], ldh, 
...
/*                 .    to fit an NS-by-NS scratch array.) ==== */
			...
			qlacpy_("A", &ns, &ns, &h__[ks + ks * h_dim1], ldh, &
				h__[kt + h_dim1], ldh);
			qlahqr_(&c_false, &c_false, &ns, &c__1, &ns, &h__[kt 
