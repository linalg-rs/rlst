...
/*  ===================================================================== */
void  chegv_(integer *itype, char *jobz, char *uplo, integer *
	...
	complex *work, integer *lwork, real *rwork, integer *info)
{
    ...
    /* Local variables */
    integer nb, neig;
    extern void  cheev_(char *, char *, integer *, complex *, 
    ...
    extern void  ctrsm_(char *, char *, char *, char *, 
	    ...
	    integer *);
    logical upper, wantz;
    extern void  chegst_(integer *, char *, integer *, complex 
	    *, integer *, complex *, integer *, integer *);
    extern integer ilaenv_(integer *, char *, char *, integer *, integer *, 
	    integer *, integer *, ftnlen, ftnlen);
    extern void  xerbla_(char *, integer *), cpotrf_(
