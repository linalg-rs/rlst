...
/*  ===================================================================== */
void  khesvx_(char *fact, char *uplo, integer *n, integer *
	...
	halfcomplex *work, integer *lwork, halfreal *rwork, integer *info)
{
    ...
    extern halfreal klanhe_(char *, char *, integer *, halfcomplex *, 
	    integer *, halfreal *);
    extern void  khecon_(char *, integer *, halfcomplex *, 
	    integer *, integer *, halfreal *, halfreal *, halfcomplex *,
	     integer *), kherfs_(char *, integer *, integer *, 
	    ...
	    integer *), khetrf_(char *, integer *, halfcomplex *, 
	    integer *, integer *, halfcomplex *, integer *, integer *), klacpy_(char *, integer *, integer *, halfcomplex *, 
	    integer *, halfcomplex *, integer *), khetrs_(char *, 
...
/*        Compute the factorization A = U*D*U**H or A = L*D*L**H. */
	...
	khetrf_(uplo, n, &af[af_offset], ldaf, &ipiv[1], &work[1], lwork, 
		info);
...
/*     Compute the norm of the matrix A. */
    ...
    anorm = klanhe_("I", uplo, n, &a[a_offset], lda, &rwork[1]);

/*     Compute the reciprocal of the condition number of A. */

    khecon_(uplo, n, &af[af_offset], ldaf, &ipiv[1], &anorm, rcond, &work[1], 
	    info);

/*     Compute the solution vectors X. */

    klacpy_("Full", n, nrhs, &b[b_offset], ldb, &x[x_offset], ldx);
    khetrs_(uplo, n, nrhs, &af[af_offset], ldaf, &ipiv[1], &x[x_offset], ldx, 
	    info);

/*     Use iterative refinement to improve the computed solutions and */
/*     compute error bounds and backward error estimates for them. */

    kherfs_(uplo, n, nrhs, &a[a_offset], lda, &af[af_offset], ldaf, &ipiv[1], 
