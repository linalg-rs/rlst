...
/*  ===================================================================== */
void  ssyevx_(char *jobz, char *range, char *uplo, integer *n, 
	...
	work, integer *lwork, integer *iwork, integer *ifail, integer *info)
{
    ...
    extern void  sstein_(integer *, real *, real *, integer *, 
    ...
    extern void  sstebz_(char *, char *, integer *, real *, 
	    real *, integer *, integer *, real *, real *, real *, integer *, 
	    integer *, real *, integer *, integer *, real *, integer *, 
	    integer *);
    integer lwkopt;
    logical lquery;
    extern void  sorgtr_(char *, integer *, real *, integer *, 
