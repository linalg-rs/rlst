...
/* > \verbatim */
/* > */
/* > DPBSV computes the solution to a doublereal system of linear equations */
/* >    A * X = B, */
...
/* > */
/*  ===================================================================== */
void  hpbsv_(char *uplo, integer *n, integer *kd, integer *
	nrhs, halfreal *ab, integer *ldab, halfreal *b, integer *ldb, 
	integer *info)
{
    ...
    extern void  xerbla_(char *, integer *), hpbtrf_(
	    char *, integer *, integer *, halfreal *, integer *, integer *), hpbtrs_(char *, integer *, integer *, integer *, 
...
/*     Compute the Cholesky factorization A = U**T*U or A = L*L**T. */
    ...
    hpbtrf_(uplo, n, kd, &ab[ab_offset], ldab, info);
    if (*info == 0) {

/*        Solve the system A*X = B, overwriting B with X. */

	hpbtrs_(uplo, n, kd, nrhs, &ab[ab_offset], ldab, &b[b_offset], ldb, 
		info);
