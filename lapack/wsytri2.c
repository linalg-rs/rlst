...
/*  ===================================================================== */
void  wsytri2_(char *uplo, integer *n, quadcomplex *a, 
	...
	integer *info)
{
    ...
    /* Local variables */
    extern void  wsytri2x_(char *, integer *, quadcomplex *, 
    ...
    logical lquery;
    extern void  wsytri_(char *, integer *, quadcomplex *, 
...
/*     Quick return if possible */
    ...
    if (nbmax >= *n) {
	wsytri_(uplo, n, &a[a_offset], lda, &ipiv[1], &work[1], info);
    } else {
	wsytri2x_(uplo, n, &a[a_offset], lda, &ipiv[1], &work[1], &nbmax, 
		info);
    }
    return;
