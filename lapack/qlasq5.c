...
/*  ===================================================================== */
void  qlasq5_(integer *i0, integer *n0, quadreal *z__, 
	integer *pp, quadreal *tau, quadreal *sigma, quadreal *dmin__, 
	quadreal *dmin1, quadreal *dmin2, quadreal *dn, quadreal *
	dnm1, quadreal *dnm2, logical *ieee, quadreal *eps)
{
