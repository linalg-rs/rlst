...
/*  ===================================================================== */
void  klalsa_(integer *icompq, integer *smlsiz, integer *n, 
	integer *nrhs, halfcomplex *b, integer *ldb, halfcomplex *bx, 
	integer *ldbx, halfreal *u, integer *ldu, halfreal *vt, integer *
	k, halfreal *difl, halfreal *difr, halfreal *z__, halfreal *
	...
	rwork, integer *iwork, integer *info)
{
    ...
    extern void  kcopy_(integer *, halfcomplex *, integer *, 
	    halfcomplex *, integer *), klals0_(integer *, integer *, 
	    ...
	    halfreal *, halfreal *, integer *, halfreal *, halfreal *,
	     halfreal *, integer *), hlasdt_(integer *, integer *, integer *
...
/* L20: */
	...
	hgemm_("T", "N", &nl, nrhs, &nl, &c_b9, &u[nlf + u_dim1], ldu, &rwork[
...
/* L80: */
	...
	hgemm_("T", "N", &nr, nrhs, &nr, &c_b9, &u[nrf + u_dim1], ldu, &rwork[
...
/*     in the bidiagonal matrix to BX. */
	...
	kcopy_(nrhs, &b[ic + b_dim1], ldb, &bx[ic + bx_dim1], ldbx);
/* L140: */
    }
...
/*        the current level LVL */
	...
	for (i__ = lf; i__ <= i__1; ++i__) {
	    ...
	    nrf = ic + 1;
	    --j;
	    klals0_(icompq, &nl, &nr, &sqre, nrhs, &bx[nlf + bx_dim1], ldbx, &
...
/*        the current level LVL. */
	...
	for (i__ = ll; i__ >= i__2; --i__) {
	    ...
	    ++j;
	    klals0_(icompq, &nl, &nr, &sqre, nrhs, &b[nlf + b_dim1], ldb, &bx[
...
/* L210: */
	...
	hgemm_("T", "N", &nlp1, nrhs, &nlp1, &c_b9, &vt[nlf + vt_dim1], ldu, &
...
/* L270: */
	...
	hgemm_("T", "N", &nrp1, nrhs, &nrp1, &c_b9, &vt[nrf + vt_dim1], ldu, &
