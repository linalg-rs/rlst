...
/*  ===================================================================== */
quadreal qlantb_(char *norm, char *uplo, char *diag, integer *n, integer *k,
	 quadreal *ab, integer *ldab, quadreal *work)
{
...
/* Computing MAX */
			i__2 = *k + 2 - j;
			qlassq_(&i__3, &ab[f2cmax(i__2,1) + j * ab_dim1], &c__1, 
				&scale, &sum);
/* L280: */
		    }
		}
...
/* Computing MAX */
		    i__5 = *k + 2 - j;
		    qlassq_(&i__3, &ab[f2cmax(i__5,1) + j * ab_dim1], &c__1, &
			    scale, &sum);
/* L290: */
		}
	    }
...
/* Computing MIN */
			i__4 = *n - j;
			i__3 = f2cmin(i__4,*k);
			qlassq_(&i__3, &ab[j * ab_dim1 + 2], &c__1, &scale, &
				sum);
/* L300: */
		    }
		}
...
/* Computing MIN */
		    i__4 = *n - j + 1, i__2 = *k + 1;
		    i__3 = f2cmin(i__4,i__2);
		    qlassq_(&i__3, &ab[j * ab_dim1 + 1], &c__1, &scale, &sum);
/* L310: */
		}
	    }
	}
