...
/* > eigenvectors of a doublereal upper Hessenberg matrix H. */
/* > */
...
/* >          doublereal eigenvector corresponding to a doublereal eigenvalue WR(j), */
...
/* > */
/* >          On entry, the doublereal and imaginary parts of the eigenvalues of */
...
/* >          stored in two consecutive columns, the first holding the doublereal */
...
/* >          store the eigenvectors; each selected doublereal eigenvector */
...
/* > */
/*  ===================================================================== */
void  qhsein_(char *side, char *eigsrc, char *initv, logical *
	select, integer *n, quadreal *h__, integer *ldh, quadreal *wr, 
	quadreal *wi, quadreal *vl, integer *ldvl, quadreal *vr, 
	integer *ldvr, integer *mm, integer *m, quadreal *work, integer *
	ifaill, integer *ifailr, integer *info)
{
    ...
    extern void  qlaein_(logical *, logical *, integer *, 
...
/*              has not ben computed before. */
		...
		i__2 = kr - kl + 1;
		hnorm = qlanhs_("I", &i__2, &h__[kl + kl * h_dim1], ldh, &
			work[1]);
		if (qisnan_(&hnorm)) {
		    *info = -6;
		    return;
...
/*              Compute left eigenvector. */
		...
		i__2 = *n - kl + 1;
		qlaein_(&c_false, &noinit, &i__2, &h__[kl + kl * h_dim1], ldh,
...
/*              Compute right eigenvector. */
		...
		qlaein_(&c_true, &noinit, &kr, &h__[h_offset], ldh, &wkr, &
