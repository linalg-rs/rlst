...
/* > doublereal symmetric tridiagonal form T by a unitary similarity */
...
/* > */
/*  ===================================================================== */
void  whptrd_(char *uplo, integer *n, quadcomplex *ap, 
	quadreal *d__, quadreal *e, quadcomplex *tau, integer *info)
{
    ...
    extern void  whpmv_(char *, integer *, quadcomplex *, 
	    ...
	    quadcomplex *, quadcomplex *, integer *, quadcomplex *, 
	    integer *), xerbla_(char *, integer *), wlarfg_(integer *,
	     quadcomplex *, quadcomplex *, integer *, quadcomplex *);
...
/*           to annihilate A(1:i-1,i+1) */
	    ...
	    wlarfg_(&i__, &alpha, &ap[i1], &c__1, &taui);
	    i__1 = i__;
	    e[i__1] = alpha.r;
...
/*              Compute  y := tau * A * v  storing y in TAU(1:i) */
		...
		whpmv_(uplo, &i__, &taui, &ap[1], &ap[i1], &c__1, &c_b2, &tau[
			1], &c__1);
...
/*              Compute  w := y - 1/2 * tau * (y**H *v) * v */
		...
		wqotc_(&z__4, &i__, &tau[1], &c__1, &ap[i1], &c__1);
		z__1.r = z__2.r * z__4.r - z__2.i * z__4.i, z__1.i = z__2.r * 
			z__4.i + z__2.i * z__4.r;
		alpha.r = z__1.r, alpha.i = z__1.i;
		waxpy_(&i__, &alpha, &ap[i1], &c__1, &tau[1], &c__1);

/*              Apply the transformation as a rank-2 update: */
/*                 A := A - v * w**H - w * v**H */

		z__1.r = -1., z__1.i = -0.;
		whpr2_(uplo, &i__, &z__1, &ap[i1], &c__1, &tau[1], &c__1, &ap[
			1]);
...
/*           to annihilate A(i+2:n,i) */
	    ...
	    i__2 = *n - i__;
	    wlarfg_(&i__2, &alpha, &ap[ii + 2], &c__1, &taui);
	    i__2 = i__;
	    e[i__2] = alpha.r;
...
/*              Compute  y := tau * A * v  storing y in TAU(i:n-1) */
		...
		i__2 = *n - i__;
		whpmv_(uplo, &i__2, &taui, &ap[i1i1], &ap[ii + 1], &c__1, &
			c_b2, &tau[i__], &c__1);
...
/*              Compute  w := y - 1/2 * tau * (y**H *v) * v */
		...
		z__2.r = z__3.r * taui.r - z__3.i * taui.i, z__2.i = z__3.r * 
			taui.i + z__3.i * taui.r;
		i__2 = *n - i__;
		wqotc_(&z__4, &i__2, &tau[i__], &c__1, &ap[ii + 1], &c__1);
		z__1.r = z__2.r * z__4.r - z__2.i * z__4.i, z__1.i = z__2.r * 
			z__4.i + z__2.i * z__4.r;
		alpha.r = z__1.r, alpha.i = z__1.i;
		i__2 = *n - i__;
		waxpy_(&i__2, &alpha, &ap[ii + 1], &c__1, &tau[i__], &c__1);
...
/*                 A := A - v * w**H - w * v**H */
		...
		i__2 = *n - i__;
		z__1.r = -1., z__1.i = -0.;
		whpr2_(uplo, &i__2, &z__1, &ap[ii + 1], &c__1, &tau[i__], &
			c__1, &ap[i1i1]);
