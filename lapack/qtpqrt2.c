...
/* > \brief \b DTPQRT2 computes a QR factorization of a doublereal or complex "triangular-pentagonal" matrix, which 
...
/* > \verbatim */
/* > */
/* > DTPQRT2 computes a QR factorization of a doublereal "triangular-pentagonal" */
...
/* > */
/*  ===================================================================== */
void  qtpqrt2_(integer *m, integer *n, integer *l, quadreal *
...
/*        Generate elementary reflector H(I) to annihilate B(:,I) */
	...
	p = *m - *l + f2cmin(*l,i__);
	i__2 = p + 1;
	qlarfg_(&i__2, &a[i__ + i__ * a_dim1], &b[i__ * b_dim1 + 1], &c__1, &
		t[i__ + t_dim1]);
	if (i__ < *n) {
...
/*           W(1:N-I) := C(I:M,I+1:N)^H * C(I:M,I) [use W = T(:,N)] */
	    ...
	    i__2 = *n - i__;
	    qgemv_("T", &p, &i__2, &c_b5, &b[(i__ + 1) * b_dim1 + 1], ldb, &b[
...
/*           C(I:M,I+1:N) = C(I:m,I+1:N) + alpha*C(I:M,I)*W(1:N-1)^H */
	    ...
	    i__2 = *n - i__;
	    qger_(&p, &i__2, &alpha, &b[i__ * b_dim1 + 1], &c__1, &t[*n * 
...
/*        Triangular part of B2 */
	...
	qtrmv_("U", "T", "N", &p, &b[mp + b_dim1], ldb, &t[i__ * t_dim1 + 1], 
		&c__1);

/*        Rectangular part of B2 */

	i__2 = i__ - 1 - p;
	qgemv_("T", l, &i__2, &alpha, &b[mp + np * b_dim1], ldb, &b[mp + i__ *
...
/*        B1 */
	...
	i__2 = *m - *l;
	i__3 = i__ - 1;
	qgemv_("T", &i__2, &i__3, &alpha, &b[b_offset], ldb, &b[i__ * b_dim1 
		+ 1], &c__1, &c_b5, &t[i__ * t_dim1 + 1], &c__1);

/*        T(1:I-1,I) := T(1:I-1,1:I-1) * T(1:I-1,I) */

	i__2 = i__ - 1;
	qtrmv_("U", "N", "N", &i__2, &t[t_offset], ldt, &t[i__ * t_dim1 + 1], 
		&c__1);
