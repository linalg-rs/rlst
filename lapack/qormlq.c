...
/* > \verbatim */
/* > */
/* > DORMLQ overwrites the general doublereal M-by-N matrix C with */
/* > */
/* >                 SIDE = 'L'     SIDE = 'R' */
/* > TRANS = 'N':      Q * C          C * Q */
/* > TRANS = 'T':      Q**T * C       C * Q**T */
...
/*  ===================================================================== */
void  qormlq_(char *side, char *trans, integer *m, integer *n, 
	...
	c__, integer *ldc, quadreal *work, integer *lwork, integer *info)
{
    ...
    integer nbmin, iinfo;
    extern void  qorml2_(char *, char *, integer *, integer *, 
...
/*        Use unblocked code */
	...
	qorml2_(side, trans, m, n, k, &a[a_offset], lda, &tau[1], &c__[
...
/*           H = H(i) H(i+1) . . . H(i+ib-1) */
	    ...
	    i__4 = nq - i__ + 1;
	    qlarft_("Forward", "Rowwise", &i__4, &ib, &a[i__ + i__ * a_dim1], 
...
/*           Apply H or H**T */
	    ...
	    qlarfb_(side, transt, "Forward", "Rowwise", &mi, &ni, &ib, &a[i__ 
