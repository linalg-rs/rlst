...
/*  ===================================================================== */
void  klaed7_(integer *n, integer *cutpnt, integer *qsiz, 
	integer *tlvls, integer *curlvl, integer *curpbm, halfreal *d__, 
	halfcomplex *q, integer *ldq, halfreal *rho, integer *indxq, 
	halfreal *qstore, integer *qptr, integer *prmptr, integer *perm, 
	integer *givptr, integer *givcol, halfreal *givnum, halfcomplex *
	work, halfreal *rwork, integer *iwork, integer *info)
{
...
/* L10: */
    ...
    curr = ptr + *curpbm;
    hlaeda_(n, tlvls, curlvl, curpbm, &prmptr[1], &perm[1], &givptr[1], &
...
/*     Sort and Deflate eigenvalues. */
    ...
    klaed8_(&k, n, qsiz, &q[q_offset], ldq, &d__[1], rho, cutpnt, &rwork[iz], 
...
/*     Solve Secular Equation. */
    ...
    if (k != 0) {
	hlaed9_(&k, &c__1, &k, n, &d__[1], &rwork[iq], &k, rho, &rwork[idlmda]
		, &rwork[iw], &qstore[qptr[curr]], &k, info);
	klacrm_(qsiz, &k, &work[1], qsiz, &qstore[qptr[curr]], &k, &q[
...
/*     Prepare the INDXQ sorting premutation. */
	...
	n1 = k;
	n2 = *n - k;
	hlamrg_(&n1, &n2, &d__[1], &c__1, &c_n1, &indxq[1]);
    } else {
