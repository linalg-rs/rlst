...
/*  ===================================================================== */
void  wlaed8_(integer *k, integer *n, integer *qsiz, 
	quadcomplex *q, integer *ldq, quadreal *d__, quadreal *rho, 
	integer *cutpnt, quadreal *z__, quadreal *dlamda, quadcomplex *
	q2, integer *ldq2, quadreal *w, integer *indxp, integer *indx, 
	integer *indxq, integer *perm, integer *givptr, integer *givcol, 
	quadreal *givnum, integer *info)
{
    ...
    extern void  qscal_(integer *, quadreal *, quadreal *, 
	    ...
	    *, integer *), wqrot_(integer *, quadcomplex *, integer *, 
    ...
    extern void  qlamrg_(integer *, integer *, quadreal *, 
	    integer *, integer *, integer *), xerbla_(char *, integer *), wlacpy_(char *, integer *, integer *, quadcomplex *, 
...
/*     elements in D. */
	...
	*k = 0;
	...
	for (j = 1; j <= i__1; ++j) {
	    perm[j] = indxq[indx[j]];
	    wcopy_(qsiz, &q[perm[j] * q_dim1 + 1], &c__1, &q2[j * q2_dim1 + 1]
		    , &c__1);
/* L50: */
	}
	wlacpy_("A", qsiz, n, &q2[q2_dim1 + 1], ldq2, &q[q_dim1 + 1], ldq);
	return;
    }
...
/*           Record the appropriate Givens rotation */
	    ...
	    givnum[(*givptr << 1) + 2] = s;
	    wqrot_(qsiz, &q[indxq[indx[jlam]] * q_dim1 + 1], &c__1, &q[indxq[
...
/*     into the last N - K slots of D and Q respectively. */
    ...
    if (*k < *n) {
	i__1 = *n - *k;
	qcopy_(&i__1, &dlamda[*k + 1], &c__1, &d__[*k + 1], &c__1);
	i__1 = *n - *k;
	wlacpy_("A", qsiz, &i__1, &q2[(*k + 1) * q2_dim1 + 1], ldq2, &q[(*k + 
		1) * q_dim1 + 1], ldq);
    }
