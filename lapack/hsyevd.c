...
/* > */
/*  ===================================================================== */
void  hsyevd_(char *jobz, char *uplo, integer *n, halfreal *
	a, integer *lda, halfreal *w, halfreal *work, integer *lwork, 
	integer *iwork, integer *liwork, integer *info)
{
    ...
    extern void  hlascl_(char *, integer *, integer *, 
	    ...
	    halfreal *, halfreal *, halfreal *, integer *, halfreal *,
	     integer *, integer *, integer *, integer *), hlacpy_(
    ...
    extern void  hormtr_(char *, char *, char *, integer *, 
	    ...
	    integer *, halfreal *, integer *, integer *), hsytrd_(char *, integer *, halfreal *, integer *, 
...
/*     Householder transformations stored in A. */
	...
	hormtr_("L", uplo, "N", n, n, &a[a_offset], lda, &work[indtau], &work[
		indwrk], n, &work[indwk2], &llwrk2, &iinfo);
	hlacpy_("A", n, n, &work[indwrk], n, &a[a_offset], lda);
    }
