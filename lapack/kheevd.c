...
/* > */
/*  ===================================================================== */
void  kheevd_(char *jobz, char *uplo, integer *n, 
	halfcomplex *a, integer *lda, halfreal *w, halfcomplex *work, 
	...
	integer *liwork, integer *info)
{
    ...
    extern void  hsterf_(integer *, halfreal *, halfreal *,
	    ...
	    integer *), kstedc_(char *, integer *, halfreal *, 
    ...
    extern void  khetrd_(char *, integer *, halfcomplex *, 
	    ...
	    halfcomplex *, integer *, integer *), klacpy_(char *, 
	    integer *, integer *, halfcomplex *, integer *, halfcomplex *,
	     integer *);
    integer lrwmin, llwork;
    halfreal smlnum;
    logical lquery;
    extern void  kunmtr_(char *, char *, char *, integer *, 
...
/*     A. */
	...
	kstedc_("I", n, &w[1], &rwork[inde], &work[indwrk], n, &work[indwk2], 
		&llwrk2, &rwork[indrwk], &llrwk, &iwork[1], liwork, info);
	kunmtr_("L", uplo, "N", n, n, &a[a_offset], lda, &work[indtau], &work[
		indwrk], n, &work[indwk2], &llwrk2, &iinfo);
	klacpy_("A", n, n, &work[indwrk], n, &a[a_offset], lda);
    }
