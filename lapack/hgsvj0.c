...
/*  ===================================================================== */
void  hgsvj0_(char *jobv, integer *m, integer *n, halfreal *
	a, integer *lda, halfreal *d__, halfreal *sva, integer *mv, 
	halfreal *v, integer *ldv, halfreal *eps, halfreal *sfmin, 
	halfreal *tol, integer *nsweep, halfreal *work, integer *lwork, 
	integer *info)
{
...
/* Computing MAX */
			  ...
			  if (d__[q] >= 1.) {
				  ...
				  if (rsvec) {
					...
					haxpy_(m, &temp1, &work[1], &c__1, &a[
						q * a_dim1 + 1], &c__1);
					hlascl_("G", &c__0, &c__0, &c_b42, &
