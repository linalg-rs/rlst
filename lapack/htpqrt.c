...
/* > \verbatim */
/* > */
/* > DTPQRT computes a blocked QR factorization of a doublereal */
...
/* > */
/*  ===================================================================== */
void  htpqrt_(integer *m, integer *n, integer *l, integer *nb, 
...
/* Computing MIN */
	...
	htpqrt2_(&mb, &ib, &lb, &a[i__ + i__ * a_dim1], lda, &b[i__ * b_dim1 
...
/*     Update by applying H**T to B(:,I+IB:N) from the left */
	...
	if (i__ + ib <= *n) {
	    i__3 = *n - i__ - ib + 1;
	    htprfb_("L", "T", "F", "C", &mb, &i__3, &ib, &lb, &b[i__ * b_dim1 
