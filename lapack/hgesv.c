...
/* > \verbatim */
/* > */
/* > DGESV computes the solution to a doublereal system of linear equations */
/* >    A * X = B, */
...
/*  ===================================================================== */
void  hgesv_(integer *n, integer *nrhs, halfreal *a, integer 
	*lda, integer *ipiv, halfreal *b, integer *ldb, integer *info)
{
    /* System generated locals */
    integer a_dim1, a_offset, b_dim1, b_offset, i__1;

    /* Local variables */
    extern void  hgetrf_(integer *, integer *, halfreal *, 
	    integer *, integer *, integer *), xerbla_(char *, integer *), hgetrs_(char *, integer *, integer *, halfreal *, 
...
/*        Solve the system A*X = B, overwriting B with X. */
	...
	hgetrs_("No transpose", n, nrhs, &a[a_offset], lda, &ipiv[1], &b[
		b_offset], ldb, info);
    }
    return;
