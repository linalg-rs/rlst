...
/*  ===================================================================== */
void  qlaed9_(integer *k, integer *kstart, integer *kstop, 
	integer *n, quadreal *d__, quadreal *q, integer *ldq, quadreal *
	rho, quadreal *dlamda, quadreal *w, quadreal *s, integer *lds, 
	integer *info)
{
    ...
    extern void  qcopy_(integer *, quadreal *, integer *, 
	    quadreal *, integer *), qlaed4_(integer *, integer *, 
...
/*     Compute updated W. */
    ...
    qcopy_(k, &w[1], &c__1, &s[s_offset], &c__1);
...
/* L90: */
	...
	temp = qnrm2_(k, &q[j * q_dim1 + 1], &c__1);
	i__2 = *k;
	for (i__ = 1; i__ <= i__2; ++i__) {
