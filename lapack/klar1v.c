...
/*  ===================================================================== */
void  klar1v_(integer *n, integer *b1, integer *bn, halfreal 
	*lambda, halfreal *d__, halfreal *l, halfreal *ld, halfreal *
	lld, halfreal *pivmin, halfreal *gaptol, halfcomplex *z__, 
	logical *wantnc, integer *negcnt, halfreal *ztz, halfreal *mingma,
	 integer *r__, integer *isuppz, halfreal *nrminv, halfreal *resid,
	 halfreal *rqcorr, halfreal *work)
{
