...
/* > \verbatim */
/* > */
/* > DGEQRF computes a QR factorization of a doublereal M-by-N matrix A: */
/* > A = Q * R. */
/* > \endverbatim */
...
/* > */
/*  ===================================================================== */
void  hgeqrf_(integer *m, integer *n, halfreal *a, integer *
	lda, halfreal *tau, halfreal *work, integer *lwork, integer *info)
{
    ...
    extern void  hgeqr2_(integer *, integer *, halfreal *, 
	    integer *, halfreal *, halfreal *, integer *), hlarfb_(char *,
...
/*           A(i:m,i:i+ib-1) */
	    ...
	    i__3 = *m - i__ + 1;
	    hgeqr2_(&i__3, &ib, &a[i__ + i__ * a_dim1], lda, &tau[i__], &work[
		    1], &iinfo);
	    if (i__ + ib <= *n) {
...
/*              H = H(i) H(i+1) . . . H(i+ib-1) */
		...
		i__3 = *m - i__ + 1;
		hlarft_("Forward", "Columnwise", &i__3, &ib, &a[i__ + i__ * 
...
/*     Use unblocked code to factor the last or only block. */
	...
	i__2 = *m - i__ + 1;
	i__1 = *n - i__ + 1;
	hgeqr2_(&i__2, &i__1, &a[i__ + i__ * a_dim1], lda, &tau[i__], &work[1]
		, &iinfo);
    }
