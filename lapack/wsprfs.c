...
/*  ===================================================================== */
void  wsprfs_(char *uplo, integer *n, integer *nrhs, 
	quadcomplex *ap, quadcomplex *afp, integer *ipiv, quadcomplex *
	b, integer *ldb, quadcomplex *x, integer *ldx, quadreal *ferr, 
	...
	info)
{
    ...
    extern void  wcopy_(integer *, quadcomplex *, integer *, 
	    ...
	    quadcomplex *, integer *, quadcomplex *, integer *), wspmv_(
	    char *, integer *, quadcomplex *, quadcomplex *, 
    ...
    quadreal lstres;
    extern void  wsptrs_(char *, integer *, integer *, 
...
/*        Compute residual R = B - A * X */
	...
	z__1.r = -1., z__1.i = -0.;
	wspmv_(uplo, n, &z__1, &ap[1], &x[j * x_dim1 + 1], &c__1, &c_b1, &
		work[1], &c__1);
...
/*           Update solution and try again. */
	    ...
	    wsptrs_(uplo, n, &c__1, &afp[1], &ipiv[1], &work[1], n, info);
