...
/*  ===================================================================== */
void  khpgvx_(integer *itype, char *jobz, char *range, char *
	uplo, integer *n, halfcomplex *ap, halfcomplex *bp, halfreal *
	vl, halfreal *vu, integer *il, integer *iu, halfreal *abstol, 
	integer *m, halfreal *w, halfcomplex *z__, integer *ldz, 
	...
	ifail, integer *info)
{
    ...
    char trans[1];
    logical upper, wantz;
    extern void  ktpmv_(char *, char *, char *, integer *, 
	    halfcomplex *, halfcomplex *, integer *), ktpsv_(char *, char *, char *, integer *, halfcomplex *
	    , halfcomplex *, integer *);
    logical alleig, indeig, valeig;
    extern void  xerbla_(char *, integer *), khpgst_(
	    integer *, char *, integer *, halfcomplex *, halfcomplex *, 
	    integer *), khpevx_(char *, char *, char *, integer *, 
	    halfcomplex *, halfreal *, halfreal *, integer *, integer *,
	     halfreal *, integer *, halfreal *, halfcomplex *, integer *
	    , halfcomplex *, halfreal *, integer *, integer *, integer *), kpptrf_(char *, integer *, halfcomplex 
	    *, integer *);
...
/*     Transform problem to standard eigenvalue problem and solve. */
    ...
    khpgst_(itype, uplo, n, &ap[1], &bp[1], info);
    khpevx_(jobz, range, uplo, n, &ap[1], vl, vu, il, iu, abstol, m, &w[1], &
...
/*           backtransform eigenvectors: x = inv(L)**H *y or inv(U)*y */
		...
		*(unsigned char *)trans = 'C';
	    ...
	    i__1 = *m;
	    for (j = 1; j <= i__1; ++j) {
		ktpsv_(uplo, trans, "Non-unit", n, &bp[1], &z__[j * z_dim1 + 
			1], &c__1);
/* L10: */
	    }
...
/*           backtransform eigenvectors: x = L*y or U**H *y */
		...
		*(unsigned char *)trans = 'N';
	    ...
	    i__1 = *m;
	    for (j = 1; j <= i__1; ++j) {
		ktpmv_(uplo, trans, "Non-unit", n, &bp[1], &z__[j * z_dim1 + 
			1], &c__1);
/* L20: */
	    }
	}
