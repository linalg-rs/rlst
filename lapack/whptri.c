...
/*  ===================================================================== */
void  whptri_(char *uplo, integer *n, quadcomplex *ap, 
	integer *ipiv, quadcomplex *work, integer *info)
{
    ...
    extern void  wcopy_(integer *, quadcomplex *, integer *, 
	    quadcomplex *, integer *), whpmv_(char *, integer *, 
	    quadcomplex *, quadcomplex *, quadcomplex *, integer *, 
	    quadcomplex *, quadcomplex *, integer *), wswap_(
...
/*           Compute column K of the inverse. */
		...
		i__1 = k - 1;
		z__1.r = -1., z__1.i = -0.;
		whpmv_(uplo, &i__1, &z__1, &ap[1], &work[1], &c__1, &c_b2, &
			ap[kc], &c__1);
		i__1 = kc + k - 1;
		i__2 = kc + k - 1;
		i__3 = k - 1;
		wqotc_(&z__2, &i__3, &work[1], &c__1, &ap[kc], &c__1);
		d__1 = z__2.r;
...
/*           Compute columns K and K+1 of the inverse. */
		...
		i__2 = kcnext + k - 1;
		i__3 = k - 1;
		wqotc_(&z__2, &i__3, &ap[kc], &c__1, &ap[kcnext], &c__1);
		...
		i__2 = kcnext + k;
		i__3 = k - 1;
		wqotc_(&z__2, &i__3, &work[1], &c__1, &ap[kcnext], &c__1);
		d__1 = z__2.r;
		z__1.r = ap[i__2].r - d__1, z__1.i = ap[i__2].i;
		ap[i__1].r = z__1.r, ap[i__1].i = z__1.i;
	    }
...
/*           Compute column K of the inverse. */
		...
		i__1 = *n - k;
		z__1.r = -1., z__1.i = -0.;
		whpmv_(uplo, &i__1, &z__1, &ap[kc + *n - k + 1], &work[1], &
			c__1, &c_b2, &ap[kc + 1], &c__1);
		i__1 = kc;
		i__2 = kc;
		i__3 = *n - k;
		wqotc_(&z__2, &i__3, &work[1], &c__1, &ap[kc + 1], &c__1);
		d__1 = z__2.r;
		z__1.r = ap[i__2].r - d__1, z__1.i = ap[i__2].i;
		ap[i__1].r = z__1.r, ap[i__1].i = z__1.i;
	    }
...
/*           Compute columns K-1 and K of the inverse. */
		...
		i__2 = kcnext + 1;
		i__3 = *n - k;
		wqotc_(&z__2, &i__3, &ap[kc + 1], &c__1, &ap[kcnext + 2], &
			c__1);
		z__1.r = ap[i__2].r - z__2.r, z__1.i = ap[i__2].i - z__2.i;
		ap[i__1].r = z__1.r, ap[i__1].i = z__1.i;
		i__1 = *n - k;
		...
		i__2 = kcnext;
		i__3 = *n - k;
		wqotc_(&z__2, &i__3, &work[1], &c__1, &ap[kcnext + 2], &c__1);
		d__1 = z__2.r;
		z__1.r = ap[i__2].r - d__1, z__1.i = ap[i__2].i;
		ap[i__1].r = z__1.r, ap[i__1].i = z__1.i;
	    }
