...
/* > */
/*  ===================================================================== */
void  qgelqf_(integer *m, integer *n, quadreal *a, integer *
	lda, quadreal *tau, quadreal *work, integer *lwork, integer *info)
{
    ...
    extern void  qgelq2_(integer *, integer *, quadreal *, 
...
/*           A(i:i+ib-1,i:n) */
	    ...
	    i__3 = *n - i__ + 1;
	    qgelq2_(&ib, &i__3, &a[i__ + i__ * a_dim1], lda, &tau[i__], &work[
		    1], &iinfo);
	    if (i__ + ib <= *m) {
...
/*              H = H(i) H(i+1) . . . H(i+ib-1) */
		...
		i__3 = *n - i__ + 1;
		qlarft_("Forward", "Rowwise", &i__3, &ib, &a[i__ + i__ * 
...
/*     Use unblocked code to factor the last or only block. */
	...
	i__2 = *m - i__ + 1;
	i__1 = *n - i__ + 1;
	qgelq2_(&i__2, &i__1, &a[i__ + i__ * a_dim1], lda, &tau[i__], &work[1]
		, &iinfo);
    }
