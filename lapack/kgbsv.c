...
/* > */
/*  ===================================================================== */
void  kgbsv_(integer *n, integer *kl, integer *ku, integer *
	nrhs, halfcomplex *ab, integer *ldab, integer *ipiv, halfcomplex *
	b, integer *ldb, integer *info)
{
    ...
    /* Local variables */
    extern void  xerbla_(char *, integer *), kgbtrf_(
	    integer *, integer *, integer *, integer *, halfcomplex *, 
	    integer *, integer *, integer *), kgbtrs_(char *, integer *, 
...
/*     Compute the LU factorization of the band matrix A. */
    ...
    kgbtrf_(n, n, kl, ku, &ab[ab_offset], ldab, &ipiv[1], info);
    if (*info == 0) {

/*        Solve the system A*X = B, overwriting B with X. */

	kgbtrs_("No transpose", n, kl, ku, nrhs, &ab[ab_offset], ldab, &ipiv[
