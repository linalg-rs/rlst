...
/*  ===================================================================== */
void  cposvx_(char *fact, char *uplo, integer *n, integer *
	...
	integer *info)
{
    ...
    extern real clanhe_(char *, char *, integer *, complex *, integer *, real 
	    *);
    extern void  claqhe_(char *, integer *, complex *, integer 
	    *, real *, real *, real *, char *);
    ...
    extern void  clacpy_(char *, integer *, integer *, complex 
	    *, integer *, complex *, integer *), xerbla_(char *, 
	    integer *);
    real bignum;
    extern void  cpocon_(char *, integer *, complex *, integer 
	    *, real *, real *, complex *, real *, integer *);
    integer infequ;
    extern void  cpoequ_(integer *, complex *, integer *, real 
