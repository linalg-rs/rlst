...
/* > of an M-by-N doublereal matrix A and P-by-N doublereal matrix B: */
/* > */
...
/* > */
/*  ===================================================================== */
void  qggsvd3_(char *jobu, char *jobv, char *jobq, integer *m, 
	integer *n, integer *p, integer *k, integer *l, quadreal *a, 
	integer *lda, quadreal *b, integer *ldb, quadreal *alpha, 
	quadreal *beta, quadreal *u, integer *ldu, quadreal *v, integer 
	*ldv, quadreal *q, integer *ldq, quadreal *work, integer *lwork, 
	integer *iwork, integer *info)
{
    ...
    extern void  qtgsja_(char *, char *, char *, integer *, 
    ...
    integer lwkopt;
    logical lquery;
    extern void  qggsvp3_(char *, char *, char *, integer *, 
...
/*     Compute workspace */
    ...
    if (*info == 0) {
	qggsvp3_(jobu, jobv, jobq, m, p, n, &a[a_offset], lda, &b[b_offset], 
...
/*     Compute the Frobenius norm of matrices A and B */
    ...
    anorm = qlange_("1", m, n, &a[a_offset], lda, &work[1]);
    bnorm = qlange_("1", p, n, &b[b_offset], ldb, &work[1]);
...
/*     Preprocessing */
    ...
    i__1 = *lwork - *n;
    qggsvp3_(jobu, jobv, jobq, m, p, n, &a[a_offset], lda, &b[b_offset], ldb, 
	    &tola, &tolb, k, l, &u[u_offset], ldu, &v[v_offset], ldv, &q[
	    q_offset], ldq, &iwork[1], &work[1], &work[*n + 1], &i__1, info);

/*     Compute the GSVD of two upper "triangular" matrices */

    qtgsja_(jobu, jobv, jobq, m, p, n, k, l, &a[a_offset], lda, &b[b_offset], 
...
/*     Copy ALPHA to WORK, then sort ALPHA in WORK */
    ...
    qcopy_(n, &alpha[1], &c__1, &work[1], &c__1);
/* Computing MIN */
    i__1 = *l, i__2 = *m - *k;
