...
/*  ===================================================================== */
void  zhesv_aa__(char *uplo, integer *n, integer *nrhs, 
	...
	integer *ldb, halfcomplex *work, integer *lwork, integer *info)
{
    ...
    /* Local variables */
    extern void  zhetrf_aa__(char *, integer *, halfcomplex *
	    , integer *, integer *, halfcomplex *, integer *, integer *), zhetrs_aa__(char *, integer *, integer *, halfcomplex *
