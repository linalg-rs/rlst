...
/*  ===================================================================== */
void  qsyev_(char *jobz, char *uplo, integer *n, quadreal *a,
	 integer *lda, quadreal *w, quadreal *work, integer *lwork, 
	integer *info)
{
    ...
    extern void  qorgtr_(char *, integer *, quadreal *, 
	    ...
	    qsytrd_(char *, integer *, quadreal *, integer *, quadreal *, 
...
/*     DORGTR to generate the orthogonal matrix, then call DSTEQR. */
	...
	qorgtr_(uplo, n, &a[a_offset], lda, &work[indtau], &work[indwrk], &
		llwork, &iinfo);
	qsteqr_(jobz, n, &w[1], &work[inde], &a[a_offset], lda, &work[indtau],
		 info);
    }
