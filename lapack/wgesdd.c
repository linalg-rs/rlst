...
/* > */
/*  ===================================================================== */
void  wgesdd_(char *jobz, integer *m, integer *n, 
	...
	integer *lwork, quadreal *rwork, integer *iwork, integer *info)
{
    ...
    extern void  wlacp2_(char *, integer *, integer *, 
	    quadreal *, integer *, quadcomplex *, integer *);
    ...
    extern void  wgelqf_(integer *, integer *, quadcomplex *,
	    ...
	    ), wlacrm_(integer *, integer *, quadcomplex *, integer *, 
	    quadreal *, integer *, quadcomplex *, integer *, quadreal *)
	    , wlarcm_(integer *, integer *, quadreal *, integer *, 
	    quadcomplex *, integer *, quadcomplex *, integer *, 
	    quadreal *), wlascl_(char *, integer *, integer *, quadreal *,
	     quadreal *, integer *, integer *, quadcomplex *, integer *, 
	    integer *), wgeqrf_(integer *, integer *, quadcomplex *,
	     integer *, quadcomplex *, quadcomplex *, integer *, integer *
	    );
    integer ldwrkl;
...
/*           Compute space preferred for each routine */
	    wgebrd_(m, n, cdum, m, dum, dum, cdum, cdum, cdum, &c_n1, &ierr);
	    lwork_zgebrd_mn__ = (integer) cdum[0].r;

	    wgebrd_(n, n, cdum, n, dum, dum, cdum, cdum, cdum, &c_n1, &ierr);
	    lwork_zgebrd_nn__ = (integer) cdum[0].r;

	    wgeqrf_(m, n, cdum, m, cdum, cdum, &c_n1, &ierr);
	    lwork_zgeqrf_mn__ = (integer) cdum[0].r;

	    wungbr_("P", n, n, n, cdum, n, cdum, cdum, &c_n1, &ierr);
	    lwork_zungbr_p_nn__ = (integer) cdum[0].r;

	    wungbr_("Q", m, m, n, cdum, m, cdum, cdum, &c_n1, &ierr);
	    lwork_zungbr_q_mm__ = (integer) cdum[0].r;

	    wungbr_("Q", m, n, n, cdum, m, cdum, cdum, &c_n1, &ierr);
	    lwork_zungbr_q_mn__ = (integer) cdum[0].r;

	    wungqr_(m, m, n, cdum, m, cdum, cdum, &c_n1, &ierr);
	    lwork_zungqr_mm__ = (integer) cdum[0].r;

	    wungqr_(m, n, n, cdum, m, cdum, cdum, &c_n1, &ierr);
	    lwork_zungqr_mn__ = (integer) cdum[0].r;

	    wunmbr_("P", "R", "C", n, n, n, cdum, n, cdum, cdum, n, cdum, &
		    c_n1, &ierr);
	    lwork_zunmbr_prc_nn__ = (integer) cdum[0].r;

	    wunmbr_("Q", "L", "N", m, m, n, cdum, m, cdum, cdum, m, cdum, &
		    c_n1, &ierr);
	    lwork_zunmbr_qln_mm__ = (integer) cdum[0].r;

	    wunmbr_("Q", "L", "N", m, n, n, cdum, m, cdum, cdum, m, cdum, &
		    c_n1, &ierr);
	    lwork_zunmbr_qln_mn__ = (integer) cdum[0].r;

	    wunmbr_("Q", "L", "N", n, n, n, cdum, n, cdum, cdum, n, cdum, &
		    c_n1, &ierr);
...
/*           Compute space preferred for each routine */
	    ...
	    wgebrd_(m, m, cdum, m, dum, dum, cdum, cdum, cdum, &c_n1, &ierr);
	    lwork_zgebrd_mm__ = (integer) cdum[0].r;

	    wgelqf_(m, n, cdum, m, cdum, cdum, &c_n1, &ierr);
	    lwork_zgelqf_mn__ = (integer) cdum[0].r;

	    wungbr_("P", m, n, m, cdum, m, cdum, cdum, &c_n1, &ierr);
	    lwork_zungbr_p_mn__ = (integer) cdum[0].r;

	    wungbr_("P", n, n, m, cdum, n, cdum, cdum, &c_n1, &ierr);
	    lwork_zungbr_p_nn__ = (integer) cdum[0].r;

	    wungbr_("Q", m, m, n, cdum, m, cdum, cdum, &c_n1, &ierr);
	    lwork_zungbr_q_mm__ = (integer) cdum[0].r;

	    wunglq_(m, n, m, cdum, m, cdum, cdum, &c_n1, &ierr);
	    lwork_zunglq_mn__ = (integer) cdum[0].r;

	    wunglq_(n, n, m, cdum, n, cdum, cdum, &c_n1, &ierr);
	    lwork_zunglq_nn__ = (integer) cdum[0].r;

	    wunmbr_("P", "R", "C", m, m, m, cdum, m, cdum, cdum, m, cdum, &
		    c_n1, &ierr);
	    lwork_zunmbr_prc_mm__ = (integer) cdum[0].r;

	    wunmbr_("P", "R", "C", m, n, m, cdum, m, cdum, cdum, m, cdum, &
		    c_n1, &ierr);
	    lwork_zunmbr_prc_mn__ = (integer) cdum[0].r;

	    wunmbr_("P", "R", "C", n, n, m, cdum, n, cdum, cdum, n, cdum, &
		    c_n1, &ierr);
	    lwork_zunmbr_prc_nn__ = (integer) cdum[0].r;

	    wunmbr_("Q", "L", "N", m, m, m, cdum, m, cdum, cdum, m, cdum, &
		    c_n1, &ierr);
	    lwork_zunmbr_qln_mm__ = (integer) cdum[0].r;
...
/*              RWorkspace: need   0 */
		...
		i__1 = *lwork - nwork + 1;
		wgeqrf_(m, n, &a[a_offset], lda, &work[itau], &work[nwork], &
			i__1, &ierr);
...
/*              RWorkspace: need   N [e] + BDSPAC */
		...
		qbdsdc_("U", "N", n, &s[1], &rwork[ie], dum, &c__1, dum, &
...
/*              Copy R to WORK( IR ), zeroing out below it */
		...
		i__1 = *n - 1;
		i__2 = *n - 1;
		wlaset_("L", &i__1, &i__2, &c_b1, &c_b1, &work[ir + 1], &
			ldwrkr);
...
/*              RWorkspace: need   0 */
		...
		i__1 = *lwork - nwork + 1;
		wungqr_(m, n, n, &a[a_offset], lda, &work[itau], &work[nwork],
			 &i__1, &ierr);
		ie = 1;
		itauq = itau;
		itaup = itauq + *n;
...
/*              RWorkspace: need   N [e] */
		...
		i__1 = *lwork - nwork + 1;
		wgebrd_(n, n, &work[ir], &ldwrkr, &s[1], &rwork[ie], &work[
			itauq], &work[itaup], &work[nwork], &i__1, &ierr);
...
/*              RWorkspace: need   N [e] + N*N [RU] + N*N [RVT] + BDSPAC */
		...
		irvt = iru + *n * *n;
		nrwork = irvt + *n * *n;
		qbdsdc_("U", "I", n, &s[1], &rwork[ie], &rwork[iru], n, &
...
/*              RWorkspace: need   0 */
		...
		wlacp2_("F", n, n, &rwork[iru], n, &work[iu], &ldwrku);
		i__1 = *lwork - nwork + 1;
		wunmbr_("Q", "L", "N", n, n, n, &work[ir], &ldwrkr, &work[
...
/*              RWorkspace: need   0 */
		...
		wlacp2_("F", n, n, &rwork[irvt], n, &vt[vt_offset], ldvt);
		i__1 = *lwork - nwork + 1;
		wunmbr_("P", "R", "C", n, n, n, &work[ir], &ldwrkr, &work[
...
/* Computing MIN */
		    ...
		    wgemm_("N", "N", &chunk, n, n, &c_b2, &a[i__ + a_dim1], 
			    ...
			    ldwrkr);
		    wlacpy_("F", &chunk, n, &work[ir], &ldwrkr, &a[i__ + 
			    a_dim1], lda);
/* L10: */
		}
...
/*              Copy R to WORK(IR), zeroing out below it */
		...
		i__2 = *n - 1;
		i__1 = *n - 1;
		wlaset_("L", &i__2, &i__1, &c_b1, &c_b1, &work[ir + 1], &
			ldwrkr);
...
/*              RWorkspace: need   0 */
		...
		wlacp2_("F", n, n, &rwork[iru], n, &u[u_offset], ldu);
		i__2 = *lwork - nwork + 1;
		wunmbr_("Q", "L", "N", n, n, n, &work[ir], &ldwrkr, &work[
...
/*              RWorkspace: need   0 */
		...
		wlacpy_("F", n, n, &u[u_offset], ldu, &work[ir], &ldwrkr);
		wgemm_("N", "N", m, n, n, &c_b2, &a[a_offset], lda, &work[ir],
...
/*              RWorkspace: need   0 */
		...
		i__2 = *lwork - nwork + 1;
		wungqr_(m, m, n, &u[u_offset], ldu, &work[itau], &work[nwork],
			 &i__2, &ierr);
...
/*              Produce R in A, zeroing out below it */
		...
		i__2 = *n - 1;
		i__1 = *n - 1;
		wlaset_("L", &i__2, &i__1, &c_b1, &c_b1, &a[a_dim1 + 2], lda);
		ie = 1;
		itauq = itau;
		itaup = itauq + *n;
		nwork = itaup + *n;
...
/*              RWorkspace: need   0 */
		...
		wlacp2_("F", n, n, &rwork[iru], n, &work[iu], &ldwrku);
		i__2 = *lwork - nwork + 1;
		wunmbr_("Q", "L", "N", n, n, n, &a[a_offset], lda, &work[
...
/*              RWorkspace: need   0 */
		...
		wlacp2_("F", n, n, &rwork[irvt], n, &vt[vt_offset], ldvt);
		i__2 = *lwork - nwork + 1;
		wunmbr_("P", "R", "C", n, n, n, &a[a_offset], lda, &work[
			itaup], &vt[vt_offset], ldvt, &work[nwork], &i__2, &
			ierr);
...
/*              RWorkspace: need   0 */
		...
		wgemm_("N", "N", m, n, n, &c_b2, &u[u_offset], ldu, &work[iu],
			 &ldwrku, &c_b1, &a[a_offset], lda);

/*              Copy left singular vectors of A from A to U */

		wlacpy_("F", m, n, &a[a_offset], lda, &u[u_offset], ldu);
...
/*              RWorkspace: need   N [e] + N*N [RU] + N*N [RVT] + 2*N*N [rwork] */
		...
		wlarcm_(n, n, &rwork[irvt], n, &vt[vt_offset], ldvt, &work[iu]
			, &ldwrku, &rwork[nrwork]);
		wlacpy_("F", n, n, &work[iu], &ldwrku, &vt[vt_offset], ldvt);
...
/* Computing MIN */
		    ...
		    wlacrm_(&chunk, n, &a[i__ + a_dim1], lda, &rwork[iru], n, 
...
/*              RWorkspace: need   0 */
		...
		wlacpy_("L", m, n, &a[a_offset], lda, &u[u_offset], ldu);
		i__1 = *lwork - nwork + 1;
		wungbr_("Q", m, n, n, &u[u_offset], ldu, &work[itauq], &work[
			nwork], &i__1, &ierr);
...
/*              RWorkspace: need   N [e] + N*N [RU] + N*N [RVT] + 2*N*N [rwork] */
		...
		wlarcm_(n, n, &rwork[irvt], n, &vt[vt_offset], ldvt, &a[
			a_offset], lda, &rwork[nrwork]);
		wlacpy_("F", n, n, &a[a_offset], lda, &vt[vt_offset], ldvt);
...
/*              RWorkspace: need   N [e] + N*N [RU] + 2*M*N [rwork] < N + 5*N*N since M < 2*N here */
		...
		nrwork = irvt;
		wlacrm_(m, n, &u[u_offset], ldu, &rwork[iru], n, &a[a_offset],
			 lda, &rwork[nrwork]);
		wlacpy_("F", m, n, &a[a_offset], lda, &u[u_offset], ldu);
	    } else {
...
/*                 RWorkspace: need   N [e] + N*N [RU] */
		    ...
		    wlaset_("F", m, n, &c_b1, &c_b1, &work[iu], &ldwrku);
		    wlacp2_("F", n, n, &rwork[iru], n, &work[iu], &ldwrku);
		    i__1 = *lwork - nwork + 1;
		    wunmbr_("Q", "L", "N", m, n, n, &a[a_offset], lda, &work[
			    itauq], &work[iu], &ldwrku, &work[nwork], &i__1, &
			    ierr);
		    wlacpy_("F", m, n, &work[iu], &ldwrku, &a[a_offset], lda);
		} else {
...
/* Computing MIN */
			i__3 = *m - i__ + 1;
			chunk = f2cmin(i__3,ldwrku);
			wlacrm_(&chunk, n, &a[i__ + a_dim1], lda, &rwork[iru],
...
/*              RWorkspace: need   N [e] + N*N [RU] + N*N [RVT] */
		...
		wlaset_("F", m, n, &c_b1, &c_b1, &u[u_offset], ldu)
			;
		wlacp2_("F", n, n, &rwork[iru], n, &u[u_offset], ldu);
		i__2 = *lwork - nwork + 1;
		wunmbr_("Q", "L", "N", m, n, n, &a[a_offset], lda, &work[
...
/*              Set the right corner of U to identity matrix */
		...
		wlaset_("F", m, m, &c_b1, &c_b1, &u[u_offset], ldu)
			;
		if (*m > *n) {
		    i__2 = *m - *n;
		    i__1 = *m - *n;
		    wlaset_("F", &i__2, &i__1, &c_b1, &c_b2, &u[*n + 1 + (*n 
			    + 1) * u_dim1], ldu);
		}
...
/*              RWorkspace: need   N [e] + N*N [RU] + N*N [RVT] */
		...
		wlacp2_("F", n, n, &rwork[iru], n, &u[u_offset], ldu);
		i__2 = *lwork - nwork + 1;
		wunmbr_("Q", "L", "N", m, m, n, &a[a_offset], lda, &work[
			itauq], &u[u_offset], ldu, &work[nwork], &i__2, &ierr);
...
/*              RWorkspace: need   0 */
		...
		i__2 = *lwork - nwork + 1;
		wgelqf_(m, n, &a[a_offset], lda, &work[itau], &work[nwork], &
			i__2, &ierr);
...
/*              Zero out above L */
		...
		i__2 = *m - 1;
		i__1 = *m - 1;
		wlaset_("U", &i__2, &i__1, &c_b1, &c_b1, &a[(a_dim1 << 1) + 1]
			, lda);
		ie = 1;
		itauq = 1;
		itaup = itauq + *m;
...
/*              RWorkspace: need   M [e] + BDSPAC */
		...
		qbdsdc_("U", "N", m, &s[1], &rwork[ie], dum, &c__1, dum, &
			c__1, dum, idum, &rwork[nrwork], &iwork[1], info);
...
/*              Copy L to WORK(IL), zeroing about above it */
		...
		wlacpy_("L", m, m, &a[a_offset], lda, &work[il], &ldwrkl);
		i__2 = *m - 1;
		i__1 = *m - 1;
		wlaset_("U", &i__2, &i__1, &c_b1, &c_b1, &work[il + ldwrkl], &
			ldwrkl);
...
/*              RWorkspace: need   0 */
		...
		i__2 = *lwork - nwork + 1;
		wunglq_(m, n, m, &a[a_offset], lda, &work[itau], &work[nwork],
			 &i__2, &ierr);
		ie = 1;
		itauq = itau;
		itaup = itauq + *m;
...
/*              RWorkspace: need   M [e] */
		...
		i__2 = *lwork - nwork + 1;
		wgebrd_(m, m, &work[il], &ldwrkl, &s[1], &rwork[ie], &work[
			itauq], &work[itaup], &work[nwork], &i__2, &ierr);
...
/*              RWorkspace: need   M [e] + M*M [RU] + M*M [RVT] + BDSPAC */
		...
		irvt = iru + *m * *m;
		nrwork = irvt + *m * *m;
		qbdsdc_("U", "I", m, &s[1], &rwork[ie], &rwork[iru], m, &
...
/*              RWorkspace: need   0 */
		...
		wlacp2_("F", m, m, &rwork[iru], m, &u[u_offset], ldu);
		i__2 = *lwork - nwork + 1;
		wunmbr_("Q", "L", "N", m, m, m, &work[il], &ldwrkl, &work[
			itauq], &u[u_offset], ldu, &work[nwork], &i__2, &ierr);
...
/*              RWorkspace: need   0 */
		...
		wlacp2_("F", m, m, &rwork[irvt], m, &work[ivt], &ldwkvt);
		i__2 = *lwork - nwork + 1;
		wunmbr_("P", "R", "C", m, m, m, &work[il], &ldwrkl, &work[
...
/* Computing MIN */
		    ...
		    wgemm_("N", "N", m, &blk, m, &c_b2, &work[ivt], m, &a[i__ 
			    * a_dim1 + 1], lda, &c_b1, &work[il], &ldwrkl);
		    wlacpy_("F", m, &blk, &work[il], &ldwrkl, &a[i__ * a_dim1 
			    + 1], lda);
/* L40: */
		}
...
/*              Copy L to WORK(IL), zeroing out above it */
		...
		i__1 = *m - 1;
		i__2 = *m - 1;
		wlaset_("U", &i__1, &i__2, &c_b1, &c_b1, &work[il + ldwrkl], &
			ldwrkl);
...
/*              RWorkspace: need   0 */
		...
		wlacp2_("F", m, m, &rwork[irvt], m, &vt[vt_offset], ldvt);
		i__1 = *lwork - nwork + 1;
		wunmbr_("P", "R", "C", m, m, m, &work[il], &ldwrkl, &work[
			itaup], &vt[vt_offset], ldvt, &work[nwork], &i__1, &
			ierr);
...
/*              RWorkspace: need   0 */
		...
		wlacpy_("F", m, m, &vt[vt_offset], ldvt, &work[il], &ldwrkl);
		wgemm_("N", "N", m, n, m, &c_b2, &work[il], &ldwrkl, &a[
...
/*              RWorkspace: need   0 */
		...
		i__1 = *lwork - nwork + 1;
		wunglq_(n, n, m, &vt[vt_offset], ldvt, &work[itau], &work[
			nwork], &i__1, &ierr);
...
/*              Produce L in A, zeroing out above it */
		...
		i__1 = *m - 1;
		i__2 = *m - 1;
		wlaset_("U", &i__1, &i__2, &c_b1, &c_b1, &a[(a_dim1 << 1) + 1]
			, lda);
		ie = 1;
		itauq = itau;
		itaup = itauq + *m;
...
/*              RWorkspace: need   0 */
		...
		wlacp2_("F", m, m, &rwork[iru], m, &u[u_offset], ldu);
		i__1 = *lwork - nwork + 1;
		wunmbr_("Q", "L", "N", m, m, m, &a[a_offset], lda, &work[
			itauq], &u[u_offset], ldu, &work[nwork], &i__1, &ierr);
...
/*              RWorkspace: need   0 */
		...
		wlacp2_("F", m, m, &rwork[irvt], m, &work[ivt], &ldwkvt);
		i__1 = *lwork - nwork + 1;
		wunmbr_("P", "R", "C", m, m, m, &a[a_offset], lda, &work[
...
/*              RWorkspace: need   0 */
		...
		wgemm_("N", "N", m, n, m, &c_b2, &work[ivt], &ldwkvt, &vt[
			vt_offset], ldvt, &c_b1, &a[a_offset], lda);

/*              Copy right singular vectors of A from A to VT */

		wlacpy_("F", m, n, &a[a_offset], lda, &vt[vt_offset], ldvt);
...
/*              RWorkspace: need   M [e] + BDSPAC */
		...
		qbdsdc_("L", "N", m, &s[1], &rwork[ie], dum, &c__1, dum, &
			c__1, dum, idum, &rwork[nrwork], &iwork[1], info);
	    } else if (wntqo) {
		irvt = nrwork;
		iru = irvt + *m * *m;
...
/*              RWorkspace: need   M [e] + M*M [RVT] + M*M [RU] + BDSPAC */
		...
		qbdsdc_("L", "I", m, &s[1], &rwork[ie], &rwork[iru], m, &
			rwork[irvt], m, dum, idum, &rwork[nrwork], &iwork[1], 
			info);
...
/*              RWorkspace: need   M [e] + M*M [RVT] + M*M [RU] + 2*M*M [rwork] */
		...
		wlacrm_(m, m, &u[u_offset], ldu, &rwork[iru], m, &work[ivt], &
			ldwkvt, &rwork[nrwork]);
		wlacpy_("F", m, m, &work[ivt], &ldwkvt, &u[u_offset], ldu);
...
/* Computing MIN */
		    i__3 = *n - i__ + 1;
		    blk = f2cmin(i__3,chunk);
		    wlarcm_(m, &blk, &rwork[irvt], m, &a[i__ * a_dim1 + 1], 
			    lda, &work[ivt], &ldwkvt, &rwork[nrwork]);
		    wlacpy_("F", m, &blk, &work[ivt], &ldwkvt, &a[i__ * 
			    a_dim1 + 1], lda);
/* L50: */
		}
	    } else if (wntqs) {
...
/*              RWorkspace: need   0 */
		...
		wlacpy_("U", m, n, &a[a_offset], lda, &vt[vt_offset], ldvt);
		i__2 = *lwork - nwork + 1;
		wungbr_("P", m, n, m, &vt[vt_offset], ldvt, &work[itaup], &
			work[nwork], &i__2, &ierr);
...
/*              RWorkspace: need   M [e] + M*M [RVT] + M*M [RU] + 2*M*M [rwork] */
		...
		wlacrm_(m, m, &u[u_offset], ldu, &rwork[iru], m, &a[a_offset],
			 lda, &rwork[nrwork]);
...
/*              RWorkspace: need   M [e] + M*M [RVT] + 2*M*N [rwork] < M + 5*M*M since N < 2*M here */
		...
		nrwork = iru;
		wlarcm_(m, n, &rwork[irvt], m, &vt[vt_offset], ldvt, &a[
			a_offset], lda, &rwork[nrwork]);
		wlacpy_("F", m, n, &a[a_offset], lda, &vt[vt_offset], ldvt);
	    } else {
...
/*              RWorkspace: need   0 */
		...
		wlacpy_("U", m, n, &a[a_offset], lda, &vt[vt_offset], ldvt);
		i__2 = *lwork - nwork + 1;
		wungbr_("P", n, n, m, &vt[vt_offset], ldvt, &work[itaup], &
			work[nwork], &i__2, &ierr);
...
/*                 WORK( IVT ) is M by N */
		    ...
		    wlaset_("F", m, n, &c_b1, &c_b1, &work[ivt], &ldwkvt);
		    nwork = ivt + ldwkvt * *n;
		} else {
...
/*                 RWorkspace: need   M [e] + M*M [RVT] */
		    ...
		    wlacp2_("F", m, m, &rwork[irvt], m, &work[ivt], &ldwkvt);
		    i__2 = *lwork - nwork + 1;
		    wunmbr_("P", "R", "C", m, n, m, &a[a_offset], lda, &work[
			    itaup], &work[ivt], &ldwkvt, &work[nwork], &i__2, 
			    &ierr);
		    wlacpy_("F", m, n, &work[ivt], &ldwkvt, &a[a_offset], lda);
		} else {
...
/*              RWorkspace: need   M [e] + M*M [RVT] */
		...
		wlaset_("F", m, n, &c_b1, &c_b1, &vt[vt_offset], ldvt);
		wlacp2_("F", m, m, &rwork[irvt], m, &vt[vt_offset], ldvt);
		i__1 = *lwork - nwork + 1;
		wunmbr_("P", "R", "C", m, n, m, &a[a_offset], lda, &work[
			itaup], &vt[vt_offset], ldvt, &work[nwork], &i__1, &
...
/*              Set all of VT to identity matrix */
		...
		wlaset_("F", n, n, &c_b1, &c_b2, &vt[vt_offset], ldvt);
...
/*              RWorkspace: need   M [e] + M*M [RVT] */
		...
		wlacp2_("F", m, m, &rwork[irvt], m, &vt[vt_offset], ldvt);
		i__1 = *lwork - nwork + 1;
		wunmbr_("P", "R", "C", n, n, m, &a[a_offset], lda, &work[
			itaup], &vt[vt_offset], ldvt, &work[nwork], &i__1, &
			ierr);
	    }
...
/*     Undo scaling if necessary */
	...
	if (*info != 0 && anrm > bignum) {
	    i__1 = minmn - 1;
	    qlascl_("G", &c__0, &c__0, &bignum, &anrm, &i__1, &c__1, &rwork[
		    ie], &minmn, &ierr);
	}
	if (anrm < smlnum) {
	...
	if (*info != 0 && anrm < smlnum) {
	    i__1 = minmn - 1;
	    qlascl_("G", &c__0, &c__0, &smlnum, &anrm, &i__1, &c__1, &rwork[
		    ie], &minmn, &ierr);
	}
    }
