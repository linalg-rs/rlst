...
/*  ===================================================================== */
void  whbevd_(char *jobz, char *uplo, integer *n, integer *kd, 
	quadcomplex *ab, integer *ldab, quadreal *w, quadcomplex *z__, 
	integer *ldz, quadcomplex *work, integer *lwork, quadreal *rwork, 
	integer *lrwork, integer *iwork, integer *liwork, integer *info)
{
    ...
    extern void  qsterf_(integer *, quadreal *, quadreal *,
	    ...
	    integer *), wstedc_(char *, integer *, quadreal *, 
	    quadreal *, quadcomplex *, integer *, quadcomplex *, 
	    integer *, quadreal *, integer *, integer *, integer *, integer 
	    *), whbtrd_(char *, char *, integer *, integer *, 
...
/*     Scale matrix to allowable range, if necessary. */
    ...
    if (iscale == 1) {
	if (lower) {
	    wlascl_("B", kd, kd, &c_b13, &sigma, n, n, &ab[ab_offset], ldab, 
		    info);
	} else {
	    wlascl_("Q", kd, kd, &c_b13, &sigma, n, n, &ab[ab_offset], ldab, 
		    info);
	}
    }
...
/*     Call ZHBTRD to reduce Hermitian band matrix to tridiagonal form. */
    ...
    whbtrd_(jobz, uplo, n, kd, &ab[ab_offset], ldab, &w[1], &rwork[inde], &
...
/*     For eigenvalues only, call DSTERF.  For eigenvectors, call ZSTEDC. */
	...
	wgemm_("N", "N", n, n, n, &c_b2, &z__[z_offset], ldz, &work[1], n, &
		c_b1, &work[indwk2], n);
