...
/* > A = L*D*L**T to compute the solution to a doublereal system of linear */
...
/* > */
/*  ===================================================================== */
void  hspsvx_(char *fact, char *uplo, integer *n, integer *
	nrhs, halfreal *ap, halfreal *afp, integer *ipiv, halfreal *b, 
	integer *ldb, halfreal *x, integer *ldx, halfreal *rcond, 
	...
	integer *info)
{
    ...
    extern halfreal hlansp_(char *, char *, integer *, halfreal *, 
	    halfreal *);
    extern void  hspcon_(char *, integer *, halfreal *, 
	    integer *, halfreal *, halfreal *, halfreal *, integer *, 
	    integer *), hsprfs_(char *, integer *, integer *, 
	    halfreal *, halfreal *, integer *, halfreal *, integer *, 
	    halfreal *, integer *, halfreal *, halfreal *, halfreal *,
	     integer *, integer *), hsptrf_(char *, integer *, 
	    halfreal *, integer *, integer *), hsptrs_(char *, 
...
/*        Compute the factorization A = U*D*U**T or A = L*D*L**T. */
	...
	hsptrf_(uplo, n, &afp[1], &ipiv[1], info);
...
/*     Compute the reciprocal of the condition number of A. */
    ...
    hspcon_(uplo, n, &afp[1], &ipiv[1], &anorm, rcond, &work[1], &iwork[1], 
	    info);

/*     Compute the solution vectors X. */

    hlacpy_("Full", n, nrhs, &b[b_offset], ldb, &x[x_offset], ldx);
    hsptrs_(uplo, n, nrhs, &afp[1], &ipiv[1], &x[x_offset], ldx, info);

/*     Use iterative refinement to improve the computed solutions and */
/*     compute error bounds and backward error estimates for them. */

    hsprfs_(uplo, n, nrhs, &ap[1], &afp[1], &ipiv[1], &b[b_offset], ldb, &x[
