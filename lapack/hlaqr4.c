...
/* > */
/*  ===================================================================== */
void  hlaqr4_(logical *wantt, logical *wantz, integer *n, 
	...
	integer *ldz, halfreal *work, integer *lwork, integer *info)
{
    ...
    extern void  hlaqr2_(logical *, logical *, integer *, 
	    ...
	    *, integer *, halfreal *, integer *, integer *, integer *, 
	    ...
	    halfreal *, integer *), hlanv2_(halfreal *, halfreal *, 
	    halfreal *, halfreal *, halfreal *, halfreal *, 
	    halfreal *, halfreal *, halfreal *, halfreal *), hlaqr5_(
...
/*        ==== Workspace query call to DLAQR2 ==== */
	...
	i__1 = nwr + 1;
	hlaqr2_(wantt, wantz, n, ilo, ihi, &i__1, &h__[h_offset], ldh, iloz, 
...
/*           ==== Aggressive early deflation ==== */
	    ...
	    hlaqr2_(wantt, wantz, n, &ktop, &kbot, &nw, &h__[h_offset], ldh, 
...
/*                 .    to fit an NS-by-NS scratch array.) ==== */
			...
			hlacpy_("A", &ns, &ns, &h__[ks + ks * h_dim1], ldh, &
				h__[kt + h_dim1], ldh);
			hlahqr_(&c_false, &c_false, &ns, &c__1, &ns, &h__[kt 
