...
/*  ===================================================================== */
void  ktrcon_(char *norm, char *uplo, char *diag, integer *n, 
	halfcomplex *a, integer *lda, halfreal *rcond, halfcomplex *
...
/*     Compute the norm of the triangular matrix A. */
    ...
    anorm = klantr_(norm, uplo, diag, n, n, &a[a_offset], lda, &rwork[1]);
...
/*              Multiply by inv(A). */
		...
		klatrs_(uplo, "No transpose", diag, normin, n, &a[a_offset], 
			lda, &work[1], &scale, &rwork[1], info);
	    } else {

/*              Multiply by inv(A**H). */

		klatrs_(uplo, "Conjugate transpose", diag, normin, n, &a[
