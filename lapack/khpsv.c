...
/* > */
/*  ===================================================================== */
void  khpsv_(char *uplo, integer *n, integer *nrhs, 
	...
	integer *info)
{
    ...
    extern void  xerbla_(char *, integer *), khptrf_(
	    char *, integer *, halfcomplex *, integer *, integer *),
	     khptrs_(char *, integer *, integer *, halfcomplex *, integer *,
...
/*     Compute the factorization A = U*D*U**H or A = L*D*L**H. */
    ...
    khptrf_(uplo, n, &ap[1], &ipiv[1], info);
    if (*info == 0) {

/*        Solve the system A*X = B, overwriting B with X. */

	khptrs_(uplo, n, nrhs, &ap[1], &ipiv[1], &b[b_offset], ldb, info);
