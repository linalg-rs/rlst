...
/*  ===================================================================== */
void  htptrs_(char *uplo, char *trans, char *diag, integer *n, 
	integer *nrhs, halfreal *ap, halfreal *b, integer *ldb, integer *
	info)
{
...
/*     Solve A * x = b  or  A**T * x = b. */
    ...
    i__1 = *nrhs;
    for (j = 1; j <= i__1; ++j) {
	htpsv_(uplo, trans, diag, n, &ap[1], &b[j * b_dim1 + 1], &c__1);
/* L30: */
    }
