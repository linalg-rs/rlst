...
/* > */
/*  ===================================================================== */
void  qpbstf_(char *uplo, integer *n, integer *kd, quadreal *
	ab, integer *ldab, integer *info)
{
    ...
    extern void  qsyr_(char *, integer *, quadreal *, 
	    quadreal *, integer *, quadreal *, integer *), qscal_(
...
/*           the leading submatrix within the band. */
	    ...
	    d__1 = 1. / ajj;
	    qscal_(&km, &d__1, &ab[*kd + 1 - km + j * ab_dim1], &c__1);
	    qsyr_("Upper", &km, &c_b9, &ab[*kd + 1 - km + j * ab_dim1], &c__1,
...
/*           trailing submatrix within the band. */
	    ...
	    if (km > 0) {
		d__1 = 1. / ajj;
		qscal_(&km, &d__1, &ab[*kd + (j + 1) * ab_dim1], &kld);
		qsyr_("Upper", &km, &c_b9, &ab[*kd + (j + 1) * ab_dim1], &kld,
...
/*           trailing submatrix within the band. */
	    ...
	    d__1 = 1. / ajj;
	    qscal_(&km, &d__1, &ab[km + 1 + (j - km) * ab_dim1], &kld);
	    qsyr_("Lower", &km, &c_b9, &ab[km + 1 + (j - km) * ab_dim1], &kld,
...
/*           trailing submatrix within the band. */
	    ...
	    if (km > 0) {
		d__1 = 1. / ajj;
		qscal_(&km, &d__1, &ab[j * ab_dim1 + 2], &c__1);
		qsyr_("Lower", &km, &c_b9, &ab[j * ab_dim1 + 2], &c__1, &ab[(
			j + 1) * ab_dim1 + 1], &kld);
	    }
/* L40: */
	}
