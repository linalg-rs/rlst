...
/* > */
/*  ===================================================================== */
void  qlamtsqr_(char *side, char *trans, integer *m, integer *
	n, integer *k, integer *mb, integer *nb, quadreal *a, integer *lda, 
	quadreal *t, integer *ldt, quadreal *c__, integer *ldc, 
	quadreal *work, integer *lwork, integer *info)
{
    ...
    extern void  qgemqrt_(char *, char *, integer *, integer *,
	     integer *, integer *, quadreal *, integer *, quadreal *, 
	    integer *, quadreal *, integer *, quadreal *, integer *), qtpmqrt_(char *, char *, integer *, integer *, 
...
/* Computing MAX */
	...
	qgemqrt_(side, trans, m, n, k, nb, &a[a_offset], lda, &t[t_offset], 
...
/*         Multiply Q to the last block of C */
	...
	if (kk > 0) {
	    ii = *m - kk + 1;
	    qtpmqrt_("L", "N", &kk, n, k, &c__0, nb, &a[ii + a_dim1], lda, &t[
...
/*         Multiply Q to the current block of C (I:I+MB,1:N) */
	    ...
	    --ctr;
	    i__3 = *mb - *k;
	    qtpmqrt_("L", "N", &i__3, n, k, &c__0, nb, &a[i__ + a_dim1], lda, 
...
/*         Multiply Q to the first block of C (1:MB,1:N) */
	...
	qgemqrt_("L", "N", mb, n, k, nb, &a[a_dim1 + 1], lda, &t[t_offset], 
...
/*         Multiply Q to the first block of C */
	...
	ii = *m - kk + 1;
	ctr = 1;
	qgemqrt_("L", "T", mb, n, k, nb, &a[a_dim1 + 1], lda, &t[t_offset], 
		ldt, &c__[c_dim1 + 1], ldc, &work[1], info);
...
/*         Multiply Q to the current block of C (I:I+MB,1:N) */
	    ...
	    i__3 = *mb - *k;
	    qtpmqrt_("L", "T", &i__3, n, k, &c__0, nb, &a[i__ + a_dim1], lda, 
		    &t[(ctr * *k + 1) * t_dim1 + 1], ldt, &c__[c_dim1 + 1], 
		    ldc, &c__[i__ + c_dim1], ldc, &work[1], info);
	    ++ctr;
...
/*         Multiply Q to the last block of C */
	    ...
	    qtpmqrt_("L", "T", &kk, n, k, &c__0, nb, &a[ii + a_dim1], lda, &t[
		    (ctr * *k + 1) * t_dim1 + 1], ldt, &c__[c_dim1 + 1], ldc, 
		    &c__[ii + c_dim1], ldc, &work[1], info);
...
/*         Multiply Q to the last block of C */
	...
	if (kk > 0) {
	    ii = *n - kk + 1;
	    qtpmqrt_("R", "T", m, &kk, k, &c__0, nb, &a[ii + a_dim1], lda, &t[
		    (ctr * *k + 1) * t_dim1 + 1], ldt, &c__[c_dim1 + 1], ldc, 
...
/*         Multiply Q to the current block of C (1:M,I:I+MB) */
	    ...
	    --ctr;
	    i__3 = *mb - *k;
	    qtpmqrt_("R", "T", m, &i__3, k, &c__0, nb, &a[i__ + a_dim1], lda, 
		    &t[(ctr * *k + 1) * t_dim1 + 1], ldt, &c__[c_dim1 + 1], 
...
/*         Multiply Q to the first block of C (1:M,1:MB) */
	...
	qgemqrt_("R", "T", m, mb, k, nb, &a[a_dim1 + 1], lda, &t[t_offset], 
		ldt, &c__[c_dim1 + 1], ldc, &work[1], info);
...
/*         Multiply Q to the first block of C */
	...
	ii = *n - kk + 1;
	ctr = 1;
	qgemqrt_("R", "N", m, mb, k, nb, &a[a_dim1 + 1], lda, &t[t_offset], 
		ldt, &c__[c_dim1 + 1], ldc, &work[1], info);
...
/*         Multiply Q to the current block of C (1:M,I:I+MB) */
	    ...
	    i__3 = *mb - *k;
	    qtpmqrt_("R", "N", m, &i__3, k, &c__0, nb, &a[i__ + a_dim1], lda, 
		    &t[(ctr * *k + 1) * t_dim1 + 1], ldt, &c__[c_dim1 + 1], 
		    ldc, &c__[i__ * c_dim1 + 1], ldc, &work[1], info);
	    ++ctr;
...
/*         Multiply Q to the last block of C */
	    ...
	    qtpmqrt_("R", "N", m, &kk, k, &c__0, nb, &a[ii + a_dim1], lda, &t[
		    (ctr * *k + 1) * t_dim1 + 1], ldt, &c__[c_dim1 + 1], ldc, 
		    &c__[ii * c_dim1 + 1], ldc, &work[1], info);
