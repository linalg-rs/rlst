...
/* > */
/*  ===================================================================== */
void  klarzt_(char *direct, char *storev, integer *n, integer *
	k, halfcomplex *v, integer *ldv, halfcomplex *tau, halfcomplex *
	t, integer *ldt)
{
...
/*              T(i+1:k,i) = - tau(i) * V(i+1:k,1:n) * V(i,1:n)**H */
		...
		klacgv_(n, &v[i__ + v_dim1], ldv);
		i__1 = *k - i__;
		i__2 = i__;
		z__1.r = -tau[i__2].r, z__1.i = -tau[i__2].i;
		kgemv_("No transpose", &i__1, n, &z__1, &v[i__ + 1 + v_dim1], 
...
/*              T(i+1:k,i) = T(i+1:k,i+1:k) * T(i+1:k,i) */
		...
		i__1 = *k - i__;
		ktrmv_("Lower", "No transpose", "Non-unit", &i__1, &t[i__ + 1 
