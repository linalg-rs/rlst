...
/*  ===================================================================== */
void  kcposv_(char *uplo, integer *n, integer *nrhs, 
	...
	halfreal *rwork, integer *iter, integer *info)
{
    ...
    extern void  khemm_(char *, char *, integer *, integer *, 
	    ...
	    integer *, halfcomplex *, halfcomplex *, integer *), kaxpy_(integer *, halfcomplex *, halfcomplex *, 
	    integer *, halfcomplex *, integer *), klag2c_(integer *, 
	    integer *, halfcomplex *, integer *, complex *, integer *, 
	    integer *), clag2z_(integer *, integer *, complex *, integer *, 
	    halfcomplex *, integer *, integer *), klat2c_(char *, integer *,
    ...
    extern void  cpotrf_(char *, integer *, complex *, integer 
	    *, integer *), klacpy_(char *, integer *, integer *, 
	    ...
	    complex *, integer *, integer *), kpotrf_(char *, integer 
	    *, halfcomplex *, integer *, integer *), kpotrs_(char *,
...
/*     Compute some constants. */
    ...
    anrm = klanhe_("I", uplo, n, &a[a_offset], lda, &rwork[1]);
    eps = hlamch_("Epsilon");
...
/*     result in SA. */
    ...
    klat2c_(uplo, n, &a[a_offset], lda, &swork[ptsa], n, info);
...
/*     Compute R = B - AX (R is WORK). */
    ...
    khemm_("Left", uplo, n, nrhs, &c_b1, &a[a_offset], lda, &x[x_offset], ldx,
...
/*        Compute R = B - AX (R is WORK). */
	...
	khemm_("L", uplo, n, nrhs, &c_b1, &a[a_offset], lda, &x[x_offset], 
...
/*     satisfactory solution, so we resort to double precision. */
    ...
    kpotrf_(uplo, n, &a[a_offset], lda, info);
    ...
    kpotrs_(uplo, n, nrhs, &a[a_offset], lda, &x[x_offset], ldx, info);
