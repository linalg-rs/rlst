...
/* > */
/*  ===================================================================== */
void  wtpmlqt_(char *side, char *trans, integer *m, integer *n,
	 integer *k, integer *l, integer *mb, quadcomplex *v, integer *ldv, 
	quadcomplex *t, integer *ldt, quadcomplex *a, integer *lda, 
	quadcomplex *b, integer *ldb, quadcomplex *work, integer *info)
{
    ...
    logical notran;
    extern void  wtprfb_(char *, char *, char *, char *, 
...
/* Computing MIN */
	    ...
	    wtprfb_("L", "C", "F", "R", &nb, n, &ib, &lb, &v[i__ + v_dim1], 
...
/* Computing MIN */
	    ...
	    wtprfb_("R", "N", "F", "R", m, &nb, &ib, &lb, &v[i__ + v_dim1], 
...
/* Computing MIN */
	    ...
	    wtprfb_("L", "N", "F", "R", &nb, n, &ib, &lb, &v[i__ + v_dim1], 
		    ldv, &t[i__ * t_dim1 + 1], ldt, &a[i__ + a_dim1], lda, &b[
		    b_offset], ldb, &work[1], &ib);
	}
...
/* Computing MIN */
	    ...
	    wtprfb_("R", "C", "F", "R", m, &nb, &ib, &lb, &v[i__ + v_dim1], 
		    ldv, &t[i__ * t_dim1 + 1], ldt, &a[i__ * a_dim1 + 1], lda,
		     &b[b_offset], ldb, &work[1], m);
	}
