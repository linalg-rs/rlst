...
/*  ===================================================================== */
void  klaic1_(integer *job, integer *j, halfcomplex *x, 
	halfreal *sest, halfcomplex *w, halfcomplex *gamma, halfreal *
	sestpr, halfcomplex *s, halfcomplex *c__)
{
...
/*  ===================================================================== */
    ...
    /* Function Body */
    eps = hlamch_("Epsilon");
    whotc_(&z__1, j, &x[1], &c__1, &w[1], &c__1);
