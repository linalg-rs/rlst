...
/*  ===================================================================== */
void  wheev_(char *jobz, char *uplo, integer *n, quadcomplex 
	*a, integer *lda, quadreal *w, quadcomplex *work, integer *lwork, 
...
/*     ZUNGTR to generate the unitary matrix, then call ZSTEQR. */
	...
	wungtr_(uplo, n, &a[a_offset], lda, &work[indtau], &work[indwrk], &
		llwork, &iinfo);
	indwrk = inde + *n;
	wsteqr_(jobz, n, &w[1], &rwork[inde], &a[a_offset], lda, &rwork[
		indwrk], info);
    }
