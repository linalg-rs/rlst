...
/* > */
/*  ===================================================================== */
void  ksptrf_(char *uplo, integer *n, halfcomplex *ap, 
	integer *ipiv, integer *info)
{
    ...
    integer imax, jmax;
    extern void  kspr_(char *, integer *, halfcomplex *, 
...
/*              A := A - U(k)*D(k)*U(k)**T = A - W(k)*1/D(k)*W(k)**T */
		...
		kspr_(uplo, &i__1, &z__1, &ap[kc], &c__1, &ap[1]);

/*              Store U(k) in column k */

		i__1 = k - 1;
		kscal_(&i__1, &r1, &ap[kc], &c__1);
	    } else {
...
/*                 A := A - L(k)*D(k)*L(k)**T = A - W(k)*(1/D(k))*W(k)**T */
		    ...
		    i__1 = *n - k;
		    z__1.r = -r1.r, z__1.i = -r1.i;
		    kspr_(uplo, &i__1, &z__1, &ap[kc + 1], &c__1, &ap[kc + *n 
			    - k + 1]);

/*                 Store L(k) in column K */

		    i__1 = *n - k;
		    kscal_(&i__1, &r1, &ap[kc + 1], &c__1);
		}
	    } else {
