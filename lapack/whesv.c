...
/*  ===================================================================== */
void  whesv_(char *uplo, integer *n, integer *nrhs, 
	...
	integer *ldb, quadcomplex *work, integer *lwork, integer *info)
{
    ...
    extern void  whetrf_(char *, integer *, quadcomplex *, 
	    integer *, integer *, quadcomplex *, integer *, integer *), whetrs_(char *, integer *, integer *, quadcomplex *, 
	    integer *, integer *, quadcomplex *, integer *, integer *);
    integer lwkopt;
    logical lquery;
    extern void  whetrs2_(char *, integer *, integer *, 
...
/*     Compute the factorization A = U*D*U**H or A = L*D*L**H. */
    ...
    whetrf_(uplo, n, &a[a_offset], lda, &ipiv[1], &work[1], lwork, info);
    if (*info == 0) {
...
/*        Solve with TRS ( Use Level BLAS 2) */
	    ...
	    whetrs_(uplo, n, nrhs, &a[a_offset], lda, &ipiv[1], &b[b_offset], 
		    ldb, info);
...
/*        Solve with TRS2 ( Use Level BLAS 3) */
	    ...
	    whetrs2_(uplo, n, nrhs, &a[a_offset], lda, &ipiv[1], &b[b_offset],
		     ldb, &work[1], info);
