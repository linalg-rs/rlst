...
/*  ===================================================================== */
void  dspgv_(integer *itype, char *jobz, char *uplo, integer *
	...
	integer *ldz, doublereal *work, integer *info)
{
    ...
    extern void  dspev_(char *, char *, integer *, doublereal *
	    , doublereal *, doublereal *, integer *, doublereal *, integer *);
    char trans[1];
    logical upper;
    extern void  dtpmv_(char *, char *, char *, integer *, 
	    doublereal *, doublereal *, integer *), 
	    dtpsv_(char *, char *, char *, integer *, doublereal *, 
	    doublereal *, integer *);
    logical wantz;
    extern void  xerbla_(char *, integer *), dpptrf_(
