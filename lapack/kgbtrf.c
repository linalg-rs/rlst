...
/* > */
/*  ===================================================================== */
void  kgbtrf_(integer *m, integer *n, integer *kl, integer *ku,
	 halfcomplex *ab, integer *ldab, integer *ipiv, integer *info)
{
    ...
    extern void  kscal_(integer *, halfcomplex *, 
	    ...
	    integer *);
    halfcomplex work13[4160]	/* was [65][64] */, work31[4160]	/* 
	    was [65][64] */;
    extern void  kgeru_(integer *, integer *, halfcomplex *, 
	    halfcomplex *, integer *, halfcomplex *, integer *, 
	    halfcomplex *, integer *), kcopy_(integer *, halfcomplex *, 
	    integer *, halfcomplex *, integer *), kswap_(integer *, 
	    halfcomplex *, integer *, halfcomplex *, integer *), ktrsm_(
	    char *, char *, char *, char *, integer *, integer *, 
	    halfcomplex *, halfcomplex *, integer *, halfcomplex *, 
	    integer *), kgbtf2_(integer *, 
	    integer *, integer *, integer *, halfcomplex *, integer *, 
	    integer *, integer *), xerbla_(char *, integer *);
    extern integer ilaenv_(integer *, char *, char *, integer *, integer *, 
	    integer *, integer *, ftnlen, ftnlen), ikamax_(integer *, 
	    halfcomplex *, integer *);
...
/*        Use unblocked code */
	...
	kgbtf2_(m, n, kl, ku, &ab[ab_offset], ldab, &ipiv[1], info);
    } else {
...
/* Computing MIN */
		...
		km = f2cmin(i__4,i__5);
		i__4 = km + 1;
		jp = ikamax_(&i__4, &ab[kv + 1 + jj * ab_dim1], &c__1);
		ipiv[jj] = jp + jj - j;
...
/*                    Apply interchange to columns J to J+JB-1 */
			...
			if (jp + jj - 1 < j + *kl) {
			    ...
			    i__4 = *ldab - 1;
			    i__5 = *ldab - 1;
			    kswap_(&jb, &ab[kv + 1 + jj - j + j * ab_dim1], &
...
/*                       which are stored in the work array WORK31 */
			    ...
			    i__4 = jj - j;
			    i__5 = *ldab - 1;
			    kswap_(&i__4, &ab[kv + 1 + jj - j + j * ab_dim1], 
				    &i__5, &work31[jp + jj - j - *kl - 1], &
				    c__65);
			    i__4 = j + jb - jj;
			    i__5 = *ldab - 1;
			    i__6 = *ldab - 1;
			    kswap_(&i__4, &ab[kv + 1 + jj * ab_dim1], &i__5, &
...
/*                 Compute multipliers */
		    ...
		    kscal_(&km, &z__1, &ab[kv + 2 + jj * ab_dim1], &c__1);
...
/* Computing MIN */
			...
			i__5 = *ldab - 1;
			i__6 = *ldab - 1;
			kgeru_(&km, &i__4, &z__1, &ab[kv + 2 + jj * ab_dim1], 
...
/* Computing MIN */
		...
		nw = f2cmin(i__4,i3);
		if (nw > 0) {
		    kcopy_(&nw, &ab[kv + *kl + 1 - jj + j + jj * ab_dim1], &
...
/*              A32. */
		...
		i__3 = *ldab - 1;
		klaswp_(&j2, &ab[kv + 1 - jb + (j + jb) * ab_dim1], &i__3, &
			c__1, &jb, &ipiv[j], &c__1);
...
/*                 Update A12 */
		    ...
		    i__3 = *ldab - 1;
		    i__4 = *ldab - 1;
		    ktrsm_("Left", "Lower", "No transpose", "Unit", &jb, &j2, 
...
/*                    Update A22 */
			...
			i__4 = *ldab - 1;
			i__5 = *ldab - 1;
			kgemm_("No transpose", "No transpose", &i2, &j2, &jb, 
...
/*                    Update A32 */
			...
			i__3 = *ldab - 1;
			i__4 = *ldab - 1;
			kgemm_("No transpose", "No transpose", &i3, &j2, &jb, 
...
/*                 Update A13 in the work array */
		    ...
		    i__3 = *ldab - 1;
		    ktrsm_("Left", "Lower", "No transpose", "Unit", &jb, &j3, 
...
/*                    Update A23 */
			...
			i__3 = *ldab - 1;
			i__4 = *ldab - 1;
			kgemm_("No transpose", "No transpose", &i2, &j3, &jb, 
				&z__1, &ab[kv + 1 + jb + j * ab_dim1], &i__3, 
...
/*                    Update A33 */
			...
			z__1.r = -1., z__1.i = -0.;
			i__3 = *ldab - 1;
			kgemm_("No transpose", "No transpose", &i3, &j3, &jb, 
...
/* Computing MIN */
		...
		nw = f2cmin(i__4,i__5);
		if (nw > 0) {
		    kcopy_(&nw, &work31[(jj - j + 1) * 65 - 65], &c__1, &ab[
