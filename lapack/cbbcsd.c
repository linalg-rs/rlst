...
/*  ===================================================================== */
void  cbbcsd_(char *jobu1, char *jobu2, char *jobv1t, char *
	...
	real *b22d, real *b22e, real *rwork, integer *lrwork, integer *info)
{
    ...
    extern void  clasr_(char *, char *, char *, integer *, 
    ...
    extern void  slartgp_(real *, real *, real *, real *, real 
...
/* Computing 2nd power */
	r__4 = b11bulge;
	theta[imin] = atan2(M(sqrt)(r__1 * r__1 + r__2 * r__2), M(sqrt)(r__3 * r__3 
		+ r__4 * r__4));
...
/* Computing 2nd power */
	    r__4 = y2;
	    phi[i__ - 1] = atan2(M(sqrt)(r__1 * r__1 + r__2 * r__2), M(sqrt)(r__3 * 
		    r__3 + r__4 * r__4));
...
/* Computing 2nd power */
	    r__4 = x2;
	    theta[i__] = atan2(M(sqrt)(r__1 * r__1 + r__2 * r__2), M(sqrt)(r__3 * 
		    r__3 + r__4 * r__4));
...
/* Computing 2nd power */
	r__2 = y2;
	phi[imax - 1] = atan2((abs(x1)), M(sqrt)(r__1 * r__1 + r__2 * r__2));
