...
/* > */
/*  ===================================================================== */
void  qlas2_(quadreal *f, quadreal *g, quadreal *h__, 
	quadreal *ssmin, quadreal *ssmax)
{
    /* System generated locals */
    quadreal d__1, d__2;

    /* Local variables */
    quadreal c__, fa, ga, ha, as, at, au, fhmn, fhmx;
...
/* Computing 2nd power */
	    ...
	    *ssmax = f2cmax(fhmx,ga) * M(sqrt)(d__1 * d__1 + 1.);
	}
    } else {
	if (ga < fhmx) {
	    as = fhmn / fhmx + 1.;
...
/* Computing 2nd power */
	    d__1 = ga / fhmx;
	    au = d__1 * d__1;
	    c__ = 2. / (M(sqrt)(as * as + au) + M(sqrt)(at * at + au));
	    *ssmin = fhmn * c__;
	    *ssmax = fhmx / c__;
	} else {
	    au = fhmx / ga;
...
/* Computing 2nd power */
		d__2 = at * au;
		c__ = 1. / (M(sqrt)(d__1 * d__1 + 1.) + M(sqrt)(d__2 * d__2 + 1.));
		*ssmin = fhmn * c__ * au;
		*ssmin += *ssmin;
		*ssmax = ga / (c__ + c__);
	    }
