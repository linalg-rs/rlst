...
static quadreal c_b16 = -.5;
static quadreal c_b19 = -1.;
static quadreal c_b52 = .5;
...
/*  ===================================================================== */
void  qsygst_(integer *itype, char *uplo, integer *n, 
	...
	info)
{
    ...
    extern void  qtrsm_(char *, char *, char *, char *, 
	    integer *, integer *, quadreal *, quadreal *, integer *, 
	    quadreal *, integer *), qsygs2_(
	    integer *, char *, integer *, quadreal *, integer *, quadreal 
	    *, integer *, integer *), qsyr2k_(char *, char *, integer 
...
/*        Use unblocked code */
	...
	qsygs2_(itype, uplo, n, &a[a_offset], lda, &b[b_offset], ldb, info);
    } else {
...
/*                 Update the upper triangle of A(k:n,k:n) */
		    ...
		    qsygs2_(itype, uplo, &kb, &a[k + k * a_dim1], lda, &b[k + 
			    k * b_dim1], ldb, info);
		    if (k + kb <= *n) {
			i__3 = *n - k - kb + 1;
			qtrsm_("Left", uplo, "Transpose", "Non-unit", &kb, &
				...
				(k + kb) * a_dim1], lda);
			i__3 = *n - k - kb + 1;
			qsymm_("Left", uplo, &kb, &i__3, &c_b16, &a[k + k * 
				a_dim1], lda, &b[k + (k + kb) * b_dim1], ldb, 
				&c_b14, &a[k + (k + kb) * a_dim1], lda);
			i__3 = *n - k - kb + 1;
			qsyr2k_(uplo, "Transpose", &i__3, &kb, &c_b19, &a[k + 
...
/*                 Update the lower triangle of A(k:n,k:n) */
			...
			qtrsm_("Right", uplo, "Transpose", "Non-unit", &i__3, 
				...
				kb + k * a_dim1], lda);
			i__3 = *n - k - kb + 1;
			qsymm_("Right", uplo, &i__3, &kb, &c_b16, &a[k + k * 
				a_dim1], lda, &b[k + kb + k * b_dim1], ldb, &
				c_b14, &a[k + kb + k * a_dim1], lda);
			i__3 = *n - k - kb + 1;
			qsyr2k_(uplo, "No transpose", &i__3, &kb, &c_b19, &a[
...
/*                 Update the upper triangle of A(1:k+kb-1,1:k+kb-1) */
		    ...
		    qtrmm_("Left", uplo, "No transpose", "Non-unit", &i__3, &
			    ...
			    ;
		    i__3 = k - 1;
		    qsymm_("Right", uplo, &i__3, &kb, &c_b52, &a[k + k * 
			    a_dim1], lda, &b[k * b_dim1 + 1], ldb, &c_b14, &a[
			    k * a_dim1 + 1], lda);
		    i__3 = k - 1;
		    qsyr2k_(uplo, "No transpose", &i__3, &kb, &c_b14, &a[k * 
...
/*                 Update the lower triangle of A(1:k+kb-1,1:k+kb-1) */
		    ...
		    qtrmm_("Right", uplo, "No transpose", "Non-unit", &kb, &
			    ...
			    lda);
		    i__3 = k - 1;
		    qsymm_("Left", uplo, &kb, &i__3, &c_b52, &a[k + k * 
			    a_dim1], lda, &b[k + b_dim1], ldb, &c_b14, &a[k + 
			    a_dim1], lda);
		    i__3 = k - 1;
		    qsyr2k_(uplo, "Transpose", &i__3, &kb, &c_b14, &a[k + 
