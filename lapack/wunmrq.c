...
/*  ===================================================================== */
void  wunmrq_(char *side, char *trans, integer *m, integer *n, 
	 ...
	 integer *info)
{
    ...
    integer nbmin, iinfo;
    extern void  wunmr2_(char *, char *, integer *, integer *, 
...
/*        Use unblocked code */
	...
	wunmr2_(side, trans, m, n, k, &a[a_offset], lda, &tau[1], &c__[
...
/*           H = H(i+ib-1) . . . H(i+1) H(i) */
	    ...
	    i__4 = nq - *k + i__ + ib - 1;
	    wlarft_("Backward", "Rowwise", &i__4, &ib, &a[i__ + a_dim1], lda, 
...
/*           Apply H or H**H */
	    ...
	    wlarfb_(side, transt, "Backward", "Rowwise", &mi, &ni, &ib, &a[
