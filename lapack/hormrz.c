...
/* > */
/*  ===================================================================== */
void  hormrz_(char *side, char *trans, integer *m, integer *n, 
	integer *k, integer *l, halfreal *a, integer *lda, halfreal *tau, 
	halfreal *c__, integer *ldc, halfreal *work, integer *lwork, 
	integer *info)
{
...
/*        Use unblocked code */
	...
	hormr3_(side, trans, m, n, k, l, &a[a_offset], lda, &tau[1], &c__[
...
/*           H = H(i+ib-1) . . . H(i+1) H(i) */
	    ...
	    hlarzt_("Backward", "Rowwise", l, &ib, &a[i__ + ja * a_dim1], lda,
...
/*           Apply H or H**T */
	    ...
	    hlarzb_(side, transt, "Backward", "Rowwise", &mi, &ni, &ib, l, &a[
