...
/* > */
/*  ===================================================================== */
void  wpbstf_(char *uplo, integer *n, integer *kd, 
...
/*           the leading submatrix within the band. */
	    ...
	    d__1 = 1. / ajj;
	    wqscal_(&km, &d__1, &ab[*kd + 1 - km + j * ab_dim1], &c__1);
	    wher_("Upper", &km, &c_b9, &ab[*kd + 1 - km + j * ab_dim1], &c__1,
...
/*           trailing submatrix within the band. */
	    ...
	    if (km > 0) {
		d__1 = 1. / ajj;
		wqscal_(&km, &d__1, &ab[*kd + (j + 1) * ab_dim1], &kld);
		wlacgv_(&km, &ab[*kd + (j + 1) * ab_dim1], &kld);
		wher_("Upper", &km, &c_b9, &ab[*kd + (j + 1) * ab_dim1], &kld,
...
/*           trailing submatrix within the band. */
	    ...
	    d__1 = 1. / ajj;
	    wqscal_(&km, &d__1, &ab[km + 1 + (j - km) * ab_dim1], &kld);
	    wlacgv_(&km, &ab[km + 1 + (j - km) * ab_dim1], &kld);
	    wher_("Lower", &km, &c_b9, &ab[km + 1 + (j - km) * ab_dim1], &kld,
...
/*           trailing submatrix within the band. */
	    ...
	    if (km > 0) {
		d__1 = 1. / ajj;
		wqscal_(&km, &d__1, &ab[j * ab_dim1 + 2], &c__1);
		wher_("Lower", &km, &c_b9, &ab[j * ab_dim1 + 2], &c__1, &ab[(
			j + 1) * ab_dim1 + 1], &kld);
	    }
/* L40: */
	}
