...
/* > */
/*  ===================================================================== */
void  wtplqt_(integer *m, integer *n, integer *l, integer *mb, 
	...
	quadcomplex *t, integer *ldt, quadcomplex *work, integer *info)
{
    ...
    extern void  xerbla_(char *, integer *), wtprfb_(
	    ...
	    quadcomplex *, integer *), 
	    wtplqt2_(integer *, integer *, integer *, quadcomplex *, 
	    integer *, quadcomplex *, integer *, quadcomplex *, integer *,
	     integer *);
...
/* Computing MIN */
	...
	wtplqt2_(&ib, &nb, &lb, &a[i__ + i__ * a_dim1], lda, &b[i__ + b_dim1],
...
/*     Update by applying H**T to B(I+IB:M,:) from the right */
	...
	if (i__ + ib <= *m) {
	    i__3 = *m - i__ - ib + 1;
	    i__4 = *m - i__ - ib + 1;
	    wtprfb_("R", "N", "F", "R", &i__3, &nb, &ib, &lb, &b[i__ + b_dim1]
