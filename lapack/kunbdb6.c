...
/*  ===================================================================== */
void  kunbdb6_(integer *m1, integer *m2, integer *n, 
	halfcomplex *x1, integer *incx1, halfcomplex *x2, integer *incx2, 
	halfcomplex *q1, integer *ldq1, halfcomplex *q2, integer *ldq2, 
	halfcomplex *work, integer *lwork, integer *info)
{
    ...
    extern void  kgemv_(char *, integer *, integer *, 
	    ...
	    xerbla_(char *, integer *), klassq_(integer *, 
...
/*     space */
    ...
    scl1 = 0.;
    ssq1 = 1.;
    klassq_(m1, &x1[1], incx1, &scl1, &ssq1);
    scl2 = 0.;
    ssq2 = 1.;
    klassq_(m2, &x2[1], incx2, &scl2, &ssq2);
/* Computing 2nd power */
    d__1 = scl1;
/* Computing 2nd power */
    d__2 = scl2;
	...
	kgemv_("C", m1, n, &c_b2, &q1[q1_offset], ldq1, &x1[1], incx1, &c_b3, 
		&work[1], &c__1);
    }

    kgemv_("C", m2, n, &c_b2, &q2[q2_offset], ldq2, &x2[1], incx2, &c_b2, &
	    work[1], &c__1);

    kgemv_("N", m1, n, &c_b1, &q1[q1_offset], ldq1, &work[1], &c__1, &c_b2, &
	    x1[1], incx1);
    kgemv_("N", m2, n, &c_b1, &q2[q2_offset], ldq2, &work[1], &c__1, &c_b2, &
	    x2[1], incx2);
