...
/* > */
/*  ===================================================================== */
void  hlaed6_(integer *kniter, logical *orgati, halfreal *
	rho, halfreal *d__, halfreal *z__, halfreal *finit, halfreal *
	tau, integer *info)
{
    ...
    halfreal a, b, c__, f;
    integer i__;
    halfreal fc, df, ddf, lbd, eta, ubd, eps, base;
    integer iter;
    halfreal temp, temp1, temp2, temp3, temp4;
    logical scale;
    integer niter;
    halfreal small1, small2, sminv1, sminv2;
    extern halfreal hlamch_(char *);
    halfreal dscale[3], sclfac, zscale[3], erretm, sclinv;
...
/*     others but recomputed at each call */
    ...
    eps = hlamch_("Epsilon");
    base = hlamch_("Base");
    i__1 = (integer) (M(log)(hlamch_("SafMin")) / M(log)(base) / 3.);
