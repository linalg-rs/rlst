...
/*  ===================================================================== */
void  whetri2_(char *uplo, integer *n, quadcomplex *a, 
	...
	integer *info)
{
    ...
    /* Local variables */
    extern void  whetri2x_(char *, integer *, quadcomplex *, 
    ...
    extern void  whetri_(char *, integer *, quadcomplex *, 
	    integer *, integer *, quadcomplex *, integer *);
    logical lquery;
    integer minsize;
...
/*     Quick return if possible */
	...
	work[1].r = (quadreal) minsize, work[1].i = 0.;
	return;
    }
    if (*n == 0) {
	return;
    ...
    if (nbmax >= *n) {
	whetri_(uplo, n, &a[a_offset], lda, &ipiv[1], &work[1], info);
    } else {
	whetri2x_(uplo, n, &a[a_offset], lda, &ipiv[1], &work[1], &nbmax, 
		info);
    }
    return;
