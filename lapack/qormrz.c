...
/* > \verbatim */
/* > */
/* > DORMRZ overwrites the general doublereal M-by-N matrix C with */
/* > */
/* >                 SIDE = 'L'     SIDE = 'R' */
/* > TRANS = 'N':      Q * C          C * Q */
/* > TRANS = 'T':      Q**T * C       C * Q**T */
...
/* > */
/*  ===================================================================== */
void  qormrz_(char *side, char *trans, integer *m, integer *n, 
	integer *k, integer *l, quadreal *a, integer *lda, quadreal *tau, 
	quadreal *c__, integer *ldc, quadreal *work, integer *lwork, 
	integer *info)
{
...
/*        Use unblocked code */
	...
	qormr3_(side, trans, m, n, k, l, &a[a_offset], lda, &tau[1], &c__[
...
/*           H = H(i+ib-1) . . . H(i+1) H(i) */
	    ...
	    qlarzt_("Backward", "Rowwise", l, &ib, &a[i__ + ja * a_dim1], lda,
...
/*           Apply H or H**T */
	    ...
	    qlarzb_(side, transt, "Backward", "Rowwise", &mi, &ni, &ib, l, &a[
