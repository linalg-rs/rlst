...
/*  ===================================================================== */
halfreal klansb_(char *norm, char *uplo, integer *n, integer *k, 
...
/* Computing MAX */
		    i__2 = *k + 2 - j;
		    klassq_(&i__4, &ab[f2cmax(i__2,1) + j * ab_dim1], &c__1, &
			    scale, &sum);
/* L110: */
		}
		l = *k + 1;
...
/* Computing MIN */
		    i__3 = *n - j;
		    i__4 = f2cmin(i__3,*k);
		    klassq_(&i__4, &ab[j * ab_dim1 + 2], &c__1, &scale, &sum);
/* L120: */
		}
		l = 1;
	    }
	...
	klassq_(n, &ab[l + ab_dim1], ldab, &scale, &sum);
