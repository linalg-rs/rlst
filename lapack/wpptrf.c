...
/* > */
/*  ===================================================================== */
void  wpptrf_(char *uplo, integer *n, quadcomplex *ap, 
	integer *info)
{
...
/*           Compute elements 1:J-1 of column J. */
	    ...
	    if (j > 1) {
		i__2 = j - 1;
		wtpsv_("Upper", "Conjugate transpose", "Non-unit", &i__2, &ap[
			1], &ap[jc], &c__1);
	    }
...
/*           Compute U(J,J) and test for non-positive-definiteness. */
	    ...
	    d__1 = ap[i__2].r;
	    i__3 = j - 1;
	    wqotc_(&z__2, &i__3, &ap[jc], &c__1, &ap[jc], &c__1);
...
/*           submatrix. */
		...
		i__2 = *n - j;
		d__1 = 1. / ajj;
		wqscal_(&i__2, &d__1, &ap[jj + 1], &c__1);
		i__2 = *n - j;
		whpr_("Lower", &i__2, &c_b16, &ap[jj + 1], &c__1, &ap[jj + *n 
			- j + 1]);
		jj = jj + *n - j + 1;
	    }
/* L20: */
