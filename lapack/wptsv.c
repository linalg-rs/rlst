...
/*  ===================================================================== */
void  wptsv_(integer *n, integer *nrhs, quadreal *d__, 
	quadcomplex *e, quadcomplex *b, integer *ldb, integer *info)
{
    /* System generated locals */
    integer b_dim1, b_offset, i__1;

    /* Local variables */
    extern void  xerbla_(char *, integer *), wpttrf_(
	    integer *, quadreal *, quadcomplex *, integer *), wpttrs_(
...
/*     Compute the L*D*L**H (or U**H*D*U) factorization of A. */
    ...
    wpttrf_(n, &d__[1], &e[1], info);
    if (*info == 0) {

/*        Solve the system A*X = B, overwriting B with X. */

	wpttrs_("Lower", n, nrhs, &d__[1], &e[1], &b[b_offset], ldb, info);
    }
    return;
