...
/* > */
/*  ===================================================================== */
void  khpsvx_(char *fact, char *uplo, integer *n, integer *
	...
	work, halfreal *rwork, integer *info)
{
    ...
    extern halfreal klanhp_(char *, char *, integer *, halfcomplex *, 
	    halfreal *);
    extern void  khpcon_(char *, integer *, halfcomplex *, 
	    integer *, halfreal *, halfreal *, halfcomplex *, integer *), klacpy_(char *, integer *, integer *, halfcomplex *, 
	    integer *, halfcomplex *, integer *), khprfs_(char *, 
	    ...
	    integer *), khptrf_(char *, integer *, halfcomplex *, 
	    integer *, integer *), khptrs_(char *, integer *, integer 
	    *, halfcomplex *, integer *, halfcomplex *, integer *, 
	    integer *);
...
/*        Compute the factorization A = U*D*U**H or A = L*D*L**H. */
	...
	khptrf_(uplo, n, &afp[1], &ipiv[1], info);
...
/*     Compute the reciprocal of the condition number of A. */
    ...
    khpcon_(uplo, n, &afp[1], &ipiv[1], &anorm, rcond, &work[1], info);

/*     Compute the solution vectors X. */

    klacpy_("Full", n, nrhs, &b[b_offset], ldb, &x[x_offset], ldx);
    khptrs_(uplo, n, nrhs, &afp[1], &ipiv[1], &x[x_offset], ldx, info);

/*     Use iterative refinement to improve the computed solutions and */
/*     compute error bounds and backward error estimates for them. */

    khprfs_(uplo, n, nrhs, &ap[1], &afp[1], &ipiv[1], &b[b_offset], ldb, &x[
