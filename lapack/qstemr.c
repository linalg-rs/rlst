...
/*  ===================================================================== */
void  qstemr_(char *jobz, char *range, integer *n, quadreal *
	d__, quadreal *e, quadreal *vl, quadreal *vu, integer *il, 
	integer *iu, integer *m, quadreal *w, quadreal *z__, integer *ldz,
	 integer *nzc, integer *isuppz, logical *tryrac, quadreal *work, 
	integer *lwork, integer *iwork, integer *liwork, integer *info)
{
    ...
    extern void  qlarrr_(integer *, quadreal *, quadreal *,
	     integer *), qlarrv_(integer *, quadreal *, quadreal *, 
	    quadreal *, quadreal *, quadreal *, integer *, integer *, 
	    integer *, integer *, quadreal *, quadreal *, quadreal *, 
	    quadreal *, quadreal *, quadreal *, integer *, integer *, 
	    quadreal *, quadreal *, integer *, integer *, quadreal *, 
	    integer *, integer *), qlasrt_(char *, integer *, quadreal *, 
	    integer *);
    quadreal thresh;
...
/*           eigenvalues */
	    ...
	    qlarrv_(n, &wl, &wu, &d__[1], &e[1], &pivmin, &iwork[iinspl], m, &
...
/* L50: */
		...
		if (i__ != 0) {
		    ...
		    w[j] = tmp;
		    if (wantz) {
			qswap_(n, &z__[i__ * z_dim1 + 1], &c__1, &z__[j * 
				z_dim1 + 1], &c__1);
			itmp = isuppz[(i__ << 1) - 1];
