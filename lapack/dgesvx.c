...
/*  ===================================================================== */
void  dgesvx_(char *fact, char *trans, integer *n, integer *
	...
	iwork, integer *info)
{
    ...
    extern void  dlaqge_(integer *, integer *, doublereal *, 
    ...
    doublereal colcnd;
    logical nofact;
    extern void  dgeequ_(integer *, integer *, doublereal *, 
	    integer *, doublereal *, doublereal *, doublereal *, doublereal *,
    ...
    integer infequ;
    logical colequ;
    extern void  dgetrs_(char *, integer *, integer *, 
