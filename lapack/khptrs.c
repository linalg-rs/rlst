...
/*  ===================================================================== */
void  khptrs_(char *uplo, integer *n, integer *nrhs, 
	halfcomplex *ap, integer *ipiv, halfcomplex *b, integer *ldb, 
	integer *info)
{
    ...
    extern void  kgeru_(integer *, integer *, halfcomplex *, 
	    ...
	    integer *, halfcomplex *, integer *), xerbla_(char *, integer *), whscal_(integer *, halfreal *, halfcomplex *, 
	    integer *), klacgv_(integer *, halfcomplex *, integer *);
...
/*           stored in column K of A. */
	    ...
	    i__1 = k - 1;
	    z__1.r = -1., z__1.i = -0.;
	    kgeru_(&i__1, nrhs, &z__1, &ap[kc], &c__1, &b[k + b_dim1], ldb, &
		    b[b_dim1 + 1], ldb);
...
/*           Interchange rows K-1 and -IPIV(K). */
	    ...
	    kp = -ipiv[k];
	    if (kp != k - 1) {
		kswap_(nrhs, &b[k - 1 + b_dim1], ldb, &b[kp + b_dim1], ldb);
	    }
...
/*           stored in columns K-1 and K of A. */
	    ...
	    i__1 = k - 2;
	    z__1.r = -1., z__1.i = -0.;
	    kgeru_(&i__1, nrhs, &z__1, &ap[kc - (k - 1)], &c__1, &b[k - 1 + 
...
/*           stored in column K of A. */
	    ...
	    if (k > 1) {
		klacgv_(nrhs, &b[k + b_dim1], ldb);
		i__1 = k - 1;
		z__1.r = -1., z__1.i = -0.;
		kgemv_("Conjugate transpose", &i__1, nrhs, &z__1, &b[b_offset]
...
/*           stored in column K of A. */
		...
		i__1 = *n - k;
		z__1.r = -1., z__1.i = -0.;
		kgeru_(&i__1, nrhs, &z__1, &ap[kc + 1], &c__1, &b[k + b_dim1],
...
/*           stored in columns K and K+1 of A. */
		...
		i__1 = *n - k - 1;
		z__1.r = -1., z__1.i = -0.;
		kgeru_(&i__1, nrhs, &z__1, &ap[kc + 2], &c__1, &b[k + b_dim1],
			 ldb, &b[k + 2 + b_dim1], ldb);
		i__1 = *n - k - 1;
		z__1.r = -1., z__1.i = -0.;
		kgeru_(&i__1, nrhs, &z__1, &ap[kc + *n - k + 2], &c__1, &b[k 
...
/*           stored in column K of A. */
		...
		i__1 = *n - k;
		z__1.r = -1., z__1.i = -0.;
		kgemv_("Conjugate transpose", &i__1, nrhs, &z__1, &b[k + 1 + 
