...
/* > */
/*  ===================================================================== */
void  hgebal_(char *job, integer *n, halfreal *a, integer *
	lda, integer *ilo, integer *ihi, halfreal *scale, integer *info)
{
    ...
    extern void  hswap_(integer *, halfreal *, integer *, 
	    halfreal *, integer *);
    halfreal sfmin1, sfmin2, sfmax1, sfmax2;
...
L20:
    ...
    i__1 = *n - k + 1;
    hswap_(&i__1, &a[j + k * a_dim1], lda, &a[m + k * a_dim1], lda);
...
L140:
	...
	i__2 = l - k + 1;
	c__ = hnrm2_(&i__2, &a[k + i__ * a_dim1], &c__1);
	i__2 = l - k + 1;
	r__ = hnrm2_(&i__2, &a[i__ + k * a_dim1], lda);
	ica = ihamax_(&l, &a[i__ * a_dim1 + 1], &c__1);
	ca = (d__1 = a[ica + i__ * a_dim1], abs(d__1));
	i__2 = *n - k + 1;
	ira = ihamax_(&i__2, &a[i__ + k * a_dim1], lda);
...
L190:
	...
	i__2 = *n - k + 1;
	hscal_(&i__2, &g, &a[i__ + k * a_dim1], lda);
	hscal_(&l, &f, &a[i__ * a_dim1 + 1], &c__1);
