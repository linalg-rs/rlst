...
/* > */
/*  ===================================================================== */
void  ctgsyl_(char *trans, integer *ijob, integer *m, integer *
	...
	integer *lwork, integer *iwork, integer *info)
{
    ...
    real scale2;
    extern void  ctgsy2_(char *, integer *, integer *, integer 
...
/*        Use unblocked Level 2 solver */
	...
	for (iround = 1; iround <= i__1; ++iround) {
	    ...
	    *scale = 1.f;
	    ...
	    if (dscale != 0.f) {
		if (*ijob == 1 || *ijob == 3) {
		    *dif = M(sqrt)((real) ((*m << 1) * *n)) / (dscale * M(sqrt)(
			    dsum));
		} else {
		    *dif = M(sqrt)((real) pq) / (dscale * M(sqrt)(dsum));
		}
	    }
