...
/*  ===================================================================== */
void  zsysv_rk__(char *uplo, integer *n, integer *nrhs, 
	halfcomplex *a, integer *lda, halfcomplex *e, integer *ipiv, 
	halfcomplex *b, integer *ldb, halfcomplex *work, integer *lwork, 
	integer *info)
{
    ...
    /* Local variables */
    extern void  zsytrs_3__(char *, integer *, integer *, 
	    halfcomplex *, integer *, halfcomplex *, integer *, 
	    halfcomplex *, integer *, integer *), zsytrf_rk__(char *
