...
/*  ===================================================================== */
void  hgetrf2_(integer *m, integer *n, halfreal *a, integer *
	lda, integer *ipiv, integer *info)
{
    ...
    extern void  xerbla_(char *, integer *), hlaswp_(
...
/*           Compute elements 2:M of the column */
		...
		i__1 = *m - 1;
		d__1 = 1. / a[a_dim1 + 1];
		hscal_(&i__1, &d__1, &a[a_dim1 + 2], &c__1);
	    } else {
		i__1 = *m - 1;
...
/*               [ A21 ] */
	...
	hgetrf2_(m, &n1, &a[a_offset], lda, &ipiv[1], &iinfo);
	if (*info == 0 && iinfo > 0) {
	    *info = iinfo;
	}
...
/*                              [ A22 ] */
	...
	hlaswp_(&n2, &a[(n1 + 1) * a_dim1 + 1], lda, &c__1, &n1, &ipiv[1], &
		c__1);

/*        Solve A12 */

	htrsm_("L", "L", "N", "U", &n1, &n2, &c_b13, &a[a_offset], lda, &a[(
		n1 + 1) * a_dim1 + 1], lda);

/*        Update A22 */

	i__1 = *m - n1;
	hgemm_("N", "N", &i__1, &n2, &n1, &c_b16, &a[n1 + 1 + a_dim1], lda, &
...
/*        Factor A22 */
	...
	i__1 = *m - n1;
	hgetrf2_(&i__1, &n2, &a[n1 + 1 + (n1 + 1) * a_dim1], lda, &ipiv[n1 + 
		1], &iinfo);
...
/*        Apply interchanges to A21 */
	...
	i__1 = n1 + 1;
	i__2 = f2cmin(*m,*n);
	hlaswp_(&n1, &a[a_dim1 + 1], lda, &i__1, &i__2, &ipiv[1], &c__1);
