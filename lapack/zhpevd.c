...
/*  ===================================================================== */
void  zhpevd_(char *jobz, char *uplo, integer *n, 
	...
	lrwork, integer *iwork, integer *liwork, integer *info)
{
    ...
    extern doublereal zlanhp_(char *, char *, integer *, doublecomplex *, 
	    doublereal *);
    extern void  zstedc_(char *, integer *, doublereal *, 
	    doublereal *, doublecomplex *, integer *, doublecomplex *, 
	    integer *, doublereal *, integer *, integer *, integer *, integer 
	    *);
    integer indrwk, indwrk, liwmin, lrwmin;
    doublereal smlnum;
    extern void  zhptrd_(char *, integer *, doublecomplex *, 
	    doublereal *, doublereal *, doublecomplex *, integer *);
    logical lquery;
    extern void  zupmtr_(char *, char *, char *, integer *, 
