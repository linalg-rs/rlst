...
/* > \verbatim */
/* > */
/* > DTREXC reorders the doublereal Schur factorization of a doublereal matrix */
/* > A = Q*T*Q**T, so that the diagonal block of T with row index IFST is */
/* > moved to row ILST. */
/* > */
/* > The doublereal Schur form T is reordered by an orthogonal similarity */
...
/*  ===================================================================== */
void  qtrexc_(char *compq, integer *n, quadreal *t, integer *
	ldt, quadreal *q, integer *ldq, integer *ifst, integer *ilst, 
	quadreal *work, integer *info)
{
    ...
    logical wantq;
    extern void  qlaexc_(logical *, integer *, quadreal *, 
...
/*           Current block either 1 by 1 or 2 by 2 */
	    ...
	    qlaexc_(&wantq, n, &t[t_offset], ldt, &q[q_offset], ldq, &here, &
...
/*           must be swapped individually */
	    ...
	    i__1 = here + 1;
	    qlaexc_(&wantq, n, &t[t_offset], ldt, &q[q_offset], ldq, &i__1, &
...
/*              Swap two 1 by 1 blocks, no problems possible */
		...
		qlaexc_(&wantq, n, &t[t_offset], ldt, &q[q_offset], ldq, &
