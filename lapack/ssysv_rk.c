...
/*  ===================================================================== */
void  ssysv_rk__(char *uplo, integer *n, integer *nrhs, real *
	...
	work, integer *lwork, integer *info)
{
    ...
    /* Local variables */
    extern void  ssytrs_3__(char *, integer *, integer *, real 
	    *, integer *, real *, integer *, real *, integer *, integer *), ssytrf_rk__(char *, integer *, real *, integer *, real *,
