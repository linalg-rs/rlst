...
/* > to a doublereal system of linear equations A*X = B, where A is an N-by-N */
...
/*  ===================================================================== */
void  hptsvx_(char *fact, integer *n, integer *nrhs, 
	halfreal *d__, halfreal *e, halfreal *df, halfreal *ef, 
	...
	info)
{
    ...
    extern void  hptcon_(integer *, halfreal *, halfreal *,
	     halfreal *, halfreal *, halfreal *, integer *), hptrfs_(
	    integer *, integer *, halfreal *, halfreal *, halfreal *, 
	    halfreal *, halfreal *, integer *, halfreal *, integer *, 
	    halfreal *, halfreal *, halfreal *, integer *), hpttrf_(
...
/*        Compute the L*D*L**T (or U**T*D*U) factorization of A. */
	...
	if (*n > 1) {
	    i__1 = *n - 1;
	    hcopy_(&i__1, &e[1], &c__1, &ef[1], &c__1);
	}
	hpttrf_(n, &df[1], &ef[1], info);
...
/*     Compute the norm of the matrix A. */
    ...
    anorm = hlanst_("1", n, &d__[1], &e[1]);

/*     Compute the reciprocal of the condition number of A. */

    hptcon_(n, &df[1], &ef[1], &anorm, rcond, &work[1], info);

/*     Compute the solution vectors X. */

    hlacpy_("Full", n, nrhs, &b[b_offset], ldb, &x[x_offset], ldx);
    hpttrs_(n, nrhs, &df[1], &ef[1], &x[x_offset], ldx, info);

/*     Use iterative refinement to improve the computed solutions and */
/*     compute error bounds and backward error estimates for them. */

    hptrfs_(n, nrhs, &d__[1], &e[1], &df[1], &ef[1], &b[b_offset], ldb, &x[
