...
/* > \verbatim */
/* > */
/* > DOPMTR overwrites the general doublereal M-by-N matrix C with */
/* > */
/* >                 SIDE = 'L'     SIDE = 'R' */
/* > TRANS = 'N':      Q * C          C * Q */
/* > TRANS = 'T':      Q**T * C       C * Q**T */
...
/*  ===================================================================== */
void  qopmtr_(char *side, char *uplo, char *trans, integer *m, 
	integer *n, quadreal *ap, quadreal *tau, quadreal *c__, integer 
...
/*           Apply H(i) */
	    ...
	    aii = ap[ii];
	    ap[ii] = 1.;
	    qlarf_(side, &mi, &ni, &ap[ii - i__ + 1], &c__1, &tau[i__], &c__[
		    c_offset], ldc, &work[1]);
	    ap[ii] = aii;
...
/*           Apply H(i) */
	    ...
	    qlarf_(side, &mi, &ni, &ap[ii], &c__1, &tau[i__], &c__[ic + jc * 
		    c_dim1], ldc, &work[1]);
	    ap[ii] = aii;
