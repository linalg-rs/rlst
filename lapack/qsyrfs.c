...
/*  ===================================================================== */
void  qsyrfs_(char *uplo, integer *n, integer *nrhs, 
	...
	integer *info)
{
    ...
    extern void  qsymv_(char *, integer *, quadreal *, 
	    ...
	    quadreal *, integer *), qlacn2_(integer *, quadreal *,
...
/*        Compute residual R = B - A * X */
	...
	qsymv_(uplo, n, &c_b12, &a[a_offset], lda, &x[j * x_dim1 + 1], &c__1, 
		&c_b14, &work[*n + 1], &c__1);
...
/*           Update solution and try again. */
	    ...
	    qsytrs_(uplo, n, &c__1, &af[af_offset], ldaf, &ipiv[1], &work[*n 
		    + 1], n, info);
...
/*              Multiply by diag(W)*inv(A**T). */
		...
		qsytrs_(uplo, n, &c__1, &af[af_offset], ldaf, &ipiv[1], &work[
			*n + 1], n, info);
		i__2 = *n;
		for (i__ = 1; i__ <= i__2; ++i__) {
