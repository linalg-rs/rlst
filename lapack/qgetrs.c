...
/*  ===================================================================== */
void  qgetrs_(char *trans, integer *n, integer *nrhs, 
	...
	ldb, integer *info)
{
    ...
    extern void  qtrsm_(char *, char *, char *, char *, 
	    ...
	    char *, integer *), qlaswp_(integer *, quadreal *, 
...
/*        Apply row interchanges to the right hand sides. */
	...
	qlaswp_(nrhs, &b[b_offset], ldb, &c__1, n, &ipiv[1], &c__1);

/*        Solve L*X = B, overwriting B with X. */

	qtrsm_("Left", "Lower", "No transpose", "Unit", n, nrhs, &c_b12, &a[
...
/*        Solve U**T *X = B, overwriting B with X. */
	...
	qtrsm_("Left", "Upper", "Transpose", "Non-unit", n, nrhs, &c_b12, &a[
		a_offset], lda, &b[b_offset], ldb);

/*        Solve L**T *X = B, overwriting B with X. */

	qtrsm_("Left", "Lower", "Transpose", "Unit", n, nrhs, &c_b12, &a[
		a_offset], lda, &b[b_offset], ldb);

/*        Apply row interchanges to the solution vectors. */

	qlaswp_(nrhs, &b[b_offset], ldb, &c__1, n, &ipiv[1], &c_n1);
    }
