...
/* > \verbatim */
/* > */
/* > DGTTRF computes an LU factorization of a doublereal tridiagonal matrix A */
...
/*  ===================================================================== */
void  qgttrf_(integer *n, quadreal *dl, quadreal *d__, 
	quadreal *du, quadreal *du2, integer *ipiv, integer *info)
{
